...
module NiosV_NiosV (
	...
	NiosV_NiosV_hart #(
		.RESET_VECTOR    (32'b00000000100000000000000000000000),
		.DBG_EXPN_VECTOR (32'b00000000100000100000000000000000),
	...
	NiosV_NiosV_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	NiosV_NiosV_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	NiosV_NiosV_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset

...
module NiosV_intel_niosv_g_0 (
		...
		input  wire [3:0]  lockstep_intf_silentmode,             //          lockstep_intf.silentmode
		output wire        lockstep_intf_intreq,                 //                       .intreq
		output wire [1:0]  lockstep_intf_oknok,                  //                       .oknok
		output wire [1:0]  lockstep_intf_error,                  //                       .error
		output wire [1:0]  lockstep_intf_warning,                //                       .warning
		output wire [1:0]  lockstep_intf_info,                   //                       .info
		input  wire [13:0] lockstep_configuration_address,       // lockstep_configuration.address
		input  wire [3:0]  lockstep_configuration_byteenable,    //                       .byteenable
		input  wire        lockstep_configuration_read,          //                       .read
		input  wire        lockstep_configuration_write,         //                       .write
		input  wire [31:0] lockstep_configuration_writedata,     //                       .writedata
		output wire [31:0] lockstep_configuration_readdata,      //                       .readdata
		output wire        lockstep_configuration_readdatavalid, //                       .readdatavalid
		output wire        lockstep_configuration_waitrequest    //                       .waitrequest
	);
	...
	NiosV_intel_niosv_g_0_hart #(
		.RESET_VECTOR             (32'b00000000000000000000000000000000),
		.DBG_EXPN_VECTOR          (32'b00000000000001000000000000000000),
		...
		.DBG_DATA_S_BASE          (32'b00000000000001000000000000000000),
		.TIMER_MSIP_DATA_S_BASE   (32'b00000000000000000000000000000000),
		.DTCM1_SIZE               (0),
		...
		.address          (lockstep_configuration_address),       // lockstep_configuration.address
		.byteenable       (lockstep_configuration_byteenable),    //                       .byteenable
		.read             (lockstep_configuration_read),          //                       .read
		.write            (lockstep_configuration_write),         //                       .write
		.writedata        (lockstep_configuration_writedata),     //                       .writedata
		.readdata         (lockstep_configuration_readdata),      //                       .readdata
		.readdatavalid    (lockstep_configuration_readdatavalid), //                       .readdatavalid
		.waitrequest      (lockstep_configuration_waitrequest),   //                       .waitrequest
		.silentmode       (lockstep_intf_silentmode),             //          lockstep_intf.silentmode
		.intreq           (lockstep_intf_intreq),                 //                       .intreq
		.fs_oknok         (lockstep_intf_oknok),                  //                       .oknok
		.fn_alarm_error   (lockstep_intf_error),                  //                       .error
		.fn_alarm_warning (lockstep_intf_warning),                //                       .warning
		.fn_alarm_info    (lockstep_intf_info),                   //                       .info
	...
	NiosV_intel_niosv_g_0_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	NiosV_intel_niosv_g_0_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	NiosV_intel_niosv_g_0_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset

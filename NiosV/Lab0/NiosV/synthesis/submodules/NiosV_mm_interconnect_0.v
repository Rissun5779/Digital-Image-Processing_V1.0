...
module NiosV_mm_interconnect_0 (
	...
	wire  [103:0] rsp_mux_src_data;                                           // rsp_mux:src_data -> NiosV_data_manager_agent:write_rp_data
	...
	wire  [103:0] rsp_mux_001_src_data;                                       // rsp_mux_001:src_data -> NiosV_data_manager_agent:read_rp_data
	...
	wire   [31:0] uart_avalon_jtag_slave_agent_m0_address;                    // UART_avalon_jtag_slave_agent:m0_address -> UART_avalon_jtag_slave_translator:uav_address
	...
	wire  [104:0] uart_avalon_jtag_slave_agent_rf_source_data;                // UART_avalon_jtag_slave_agent:rf_source_data -> UART_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] uart_avalon_jtag_slave_agent_rsp_fifo_out_data;             // UART_avalon_jtag_slave_agent_rsp_fifo:out_data -> UART_avalon_jtag_slave_agent:rf_sink_data
	...
	wire          uart_avalon_jtag_slave_agent_rdata_fifo_src_valid;          // UART_avalon_jtag_slave_agent:rdata_fifo_src_valid -> UART_avalon_jtag_slave_agent_rdata_fifo:in_valid
	wire   [33:0] uart_avalon_jtag_slave_agent_rdata_fifo_src_data;           // UART_avalon_jtag_slave_agent:rdata_fifo_src_data -> UART_avalon_jtag_slave_agent_rdata_fifo:in_data
	wire          uart_avalon_jtag_slave_agent_rdata_fifo_src_ready;          // UART_avalon_jtag_slave_agent_rdata_fifo:in_ready -> UART_avalon_jtag_slave_agent:rdata_fifo_src_ready
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> UART_avalon_jtag_slave_agent:cp_valid
	wire  [103:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> UART_avalon_jtag_slave_agent:cp_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                       // cmd_mux_001:src_data -> RAM_s1_agent:cp_data
	...
	wire  [104:0] pio_led_s1_agent_rf_source_data;                            // PIO_LED_s1_agent:rf_source_data -> PIO_LED_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] pio_led_s1_agent_rsp_fifo_out_data;                         // PIO_LED_s1_agent_rsp_fifo:out_data -> PIO_LED_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_002_src_data;                                       // cmd_mux_002:src_data -> PIO_LED_s1_agent:cp_data
	...
	wire  [104:0] pio_sw_s1_agent_rf_source_data;                             // PIO_SW_s1_agent:rf_source_data -> PIO_SW_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] pio_sw_s1_agent_rsp_fifo_out_data;                          // PIO_SW_s1_agent_rsp_fifo:out_data -> PIO_SW_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_003_src_data;                                       // cmd_mux_003:src_data -> PIO_SW_s1_agent:cp_data
	...
	wire  [103:0] niosv_data_manager_agent_write_cp_data;                     // NiosV_data_manager_agent:write_cp_data -> router:sink_data
	...
	wire  [103:0] niosv_data_manager_agent_read_cp_data;                      // NiosV_data_manager_agent:read_cp_data -> router_001:sink_data
	...
	wire  [103:0] niosv_instruction_manager_agent_write_cp_data;              // NiosV_instruction_manager_agent:write_cp_data -> router_002:sink_data
	...
	wire  [103:0] niosv_instruction_manager_agent_read_cp_data;               // NiosV_instruction_manager_agent:read_cp_data -> router_003:sink_data
	...
	wire  [103:0] uart_avalon_jtag_slave_agent_rp_data;                       // UART_avalon_jtag_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [103:0] pio_led_s1_agent_rp_data;                                   // PIO_LED_s1_agent:rp_data -> router_006:sink_data
	...
	wire          pio_sw_s1_agent_rp_valid;                                   // PIO_SW_s1_agent:rp_valid -> router_007:sink_valid
	wire  [103:0] pio_sw_s1_agent_rp_data;                                    // PIO_SW_s1_agent:rp_data -> router_007:sink_data
	wire          pio_sw_s1_agent_rp_ready;                                   // router_007:sink_ready -> PIO_SW_s1_agent:rp_ready
	wire          pio_sw_s1_agent_rp_startofpacket;                           // PIO_SW_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          pio_sw_s1_agent_rp_endofpacket;                             // PIO_SW_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [103:0] router_002_src_data;                                        // router_002:src_data -> NiosV_instruction_manager_wr_limiter:cmd_sink_data
	wire          router_002_src_ready;                                       // NiosV_instruction_manager_wr_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [3:0] router_002_src_channel;                                     // router_002:src_channel -> NiosV_instruction_manager_wr_limiter:cmd_sink_channel
	...
	wire  [103:0] niosv_instruction_manager_wr_limiter_cmd_src_data;          // NiosV_instruction_manager_wr_limiter:cmd_src_data -> cmd_demux_002:sink_data
	...
	wire    [3:0] niosv_instruction_manager_wr_limiter_cmd_src_channel;       // NiosV_instruction_manager_wr_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire  [103:0] rsp_mux_002_src_data;                                       // rsp_mux_002:src_data -> NiosV_instruction_manager_wr_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                      // NiosV_instruction_manager_wr_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [3:0] rsp_mux_002_src_channel;                                    // rsp_mux_002:src_channel -> NiosV_instruction_manager_wr_limiter:rsp_sink_channel
	...
	wire  [103:0] niosv_instruction_manager_wr_limiter_rsp_src_data;          // NiosV_instruction_manager_wr_limiter:rsp_src_data -> NiosV_instruction_manager_agent:write_rp_data
	...
	wire    [3:0] niosv_instruction_manager_wr_limiter_rsp_src_channel;       // NiosV_instruction_manager_wr_limiter:rsp_src_channel -> NiosV_instruction_manager_agent:write_rp_channel
	...
	wire  [103:0] router_003_src_data;                                        // router_003:src_data -> NiosV_instruction_manager_rd_limiter:cmd_sink_data
	wire          router_003_src_ready;                                       // NiosV_instruction_manager_rd_limiter:cmd_sink_ready -> router_003:src_ready
	wire    [3:0] router_003_src_channel;                                     // router_003:src_channel -> NiosV_instruction_manager_rd_limiter:cmd_sink_channel
	...
	wire  [103:0] niosv_instruction_manager_rd_limiter_cmd_src_data;          // NiosV_instruction_manager_rd_limiter:cmd_src_data -> cmd_demux_003:sink_data
	...
	wire    [3:0] niosv_instruction_manager_rd_limiter_cmd_src_channel;       // NiosV_instruction_manager_rd_limiter:cmd_src_channel -> cmd_demux_003:sink_channel
	...
	wire  [103:0] rsp_mux_003_src_data;                                       // rsp_mux_003:src_data -> NiosV_instruction_manager_rd_limiter:rsp_sink_data
	wire          rsp_mux_003_src_ready;                                      // NiosV_instruction_manager_rd_limiter:rsp_sink_ready -> rsp_mux_003:src_ready
	wire    [3:0] rsp_mux_003_src_channel;                                    // rsp_mux_003:src_channel -> NiosV_instruction_manager_rd_limiter:rsp_sink_channel
	...
	wire  [103:0] niosv_instruction_manager_rd_limiter_rsp_src_data;          // NiosV_instruction_manager_rd_limiter:rsp_src_data -> NiosV_instruction_manager_agent:read_rp_data
	...
	wire    [3:0] niosv_instruction_manager_rd_limiter_rsp_src_channel;       // NiosV_instruction_manager_rd_limiter:rsp_src_channel -> NiosV_instruction_manager_agent:read_rp_channel
	...
	wire  [103:0] cmd_demux_002_src1_data;                                    // cmd_demux_002:src1_data -> cmd_mux_001:sink2_data
	...
	wire  [103:0] cmd_demux_002_src2_data;                                    // cmd_demux_002:src2_data -> cmd_mux_002:sink2_data
	...
	wire  [103:0] cmd_demux_002_src3_data;                                    // cmd_demux_002:src3_data -> cmd_mux_003:sink2_data
	...
	wire  [103:0] cmd_demux_003_src1_data;                                    // cmd_demux_003:src1_data -> cmd_mux_001:sink3_data
	...
	wire  [103:0] cmd_demux_003_src2_data;                                    // cmd_demux_003:src2_data -> cmd_mux_002:sink3_data
	...
	wire  [103:0] cmd_demux_003_src3_data;                                    // cmd_demux_003:src3_data -> cmd_mux_003:sink3_data
	wire          cmd_demux_003_src3_ready;                                   // cmd_mux_003:sink3_ready -> cmd_demux_003:src3_ready
	wire    [3:0] cmd_demux_003_src3_channel;                                 // cmd_demux_003:src3_channel -> cmd_mux_003:sink3_channel
	...
	wire  [103:0] rsp_demux_001_src2_data;                                    // rsp_demux_001:src2_data -> rsp_mux_002:sink1_data
	...
	wire  [103:0] rsp_demux_001_src3_data;                                    // rsp_demux_001:src3_data -> rsp_mux_003:sink1_data
	...
	wire  [103:0] rsp_demux_002_src2_data;                                    // rsp_demux_002:src2_data -> rsp_mux_002:sink2_data
	...
	wire  [103:0] rsp_demux_002_src3_data;                                    // rsp_demux_002:src3_data -> rsp_mux_003:sink2_data
	...
	wire  [103:0] rsp_demux_003_src2_data;                                    // rsp_demux_003:src2_data -> rsp_mux_002:sink3_data
	...
	wire  [103:0] rsp_demux_003_src3_data;                                    // rsp_demux_003:src3_data -> rsp_mux_003:sink3_data
	wire          rsp_demux_003_src3_ready;                                   // rsp_mux_003:sink3_ready -> rsp_demux_003:src3_ready
	wire    [3:0] rsp_demux_003_src3_channel;                                 // rsp_demux_003:src3_channel -> rsp_mux_003:sink3_channel
	...
	wire    [3:0] niosv_instruction_manager_wr_limiter_cmd_valid_data;        // NiosV_instruction_manager_wr_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	wire    [3:0] niosv_instruction_manager_rd_limiter_cmd_valid_data;        // NiosV_instruction_manager_rd_limiter:cmd_src_valid -> cmd_demux_003:sink_valid
	wire          uart_avalon_jtag_slave_agent_rdata_fifo_out_valid;          // UART_avalon_jtag_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] uart_avalon_jtag_slave_agent_rdata_fifo_out_data;           // UART_avalon_jtag_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          uart_avalon_jtag_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter:in_0_ready -> UART_avalon_jtag_slave_agent_rdata_fifo:out_ready
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) uart_avalon_jtag_slave_agent_rdata_fifo (
		.clk               (CLK_clk_clk),                                       //       clk.clk
		.reset             (NiosV_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
		.in_data           (uart_avalon_jtag_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (uart_avalon_jtag_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (uart_avalon_jtag_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (uart_avalon_jtag_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (uart_avalon_jtag_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (uart_avalon_jtag_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	NiosV_mm_interconnect_0_router router_002 (
	...
	NiosV_mm_interconnect_0_router router_003 (
	...
	NiosV_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (CLK_clk_clk),                             //       clk.clk
		.reset              (NiosV_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosV_mm_interconnect_0_cmd_demux rsp_demux_003 (
		.clk                (CLK_clk_clk),                             //       clk.clk
		.reset              (NiosV_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosV_mm_interconnect_0_rsp_mux rsp_mux_002 (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (NiosV_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosV_mm_interconnect_0_rsp_mux rsp_mux_003 (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (NiosV_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosV_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (uart_avalon_jtag_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (uart_avalon_jtag_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (uart_avalon_jtag_slave_agent_rdata_fifo_out_ready), //         .ready

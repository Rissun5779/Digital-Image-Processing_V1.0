...
module test_env #(
  ...
  wire   [LOG_INTERNAL_WORDS*DUAL-1:0]   itx_num_valid;
  wire   [7:0]                           itx_chan;
  wire   [DUAL-1:0]                      itx_sop;
  wire   [3:0]                           itx_eopbits;
  wire   [DUAL-1:0]                      itx_sob;
  wire                                   itx_eob;
  ...
  wire   [LOG_INTERNAL_WORDS*DUAL-1:0]   irx_num_valid;
  // wire   [LOG_INTERNAL_WORDS-1:0]        irx_num_valid0;
  // wire   [LOG_INTERNAL_WORDS-1:0]        irx_num_valid1;
  wire   [DUAL-1:0]                      irx_sop;
  wire   [DUAL-1:0]                      irx_sob;
  wire                                   irx_eob;
  wire   [7:0]                           irx_chan;

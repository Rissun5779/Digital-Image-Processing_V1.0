...
module test_dut #(
  ...
  input  [LOG_INTERNAL_WORDS*DUAL-1:0]  itx_num_valid,
  input  [7:0]                          itx_chan,
  input  [DUAL-1:0]                     itx_sop,
  input  [3:0]                          itx_eopbits,
  input  [DUAL-1:0]                     itx_sob,
  input                                 itx_eob,
  ...
  output [INTERNAL_WORDS-1:0][63:0]     irx_dout_words,
  // output [LOG_INTERNAL_WORDS-1:0]       irx_num_valid0,
  // output [LOG_INTERNAL_WORDS-1:0]       irx_num_valid1,
  output [LOG_INTERNAL_WORDS*DUAL-1:0]  irx_num_valid,
  output [DUAL-1:0]                     irx_sop,
  output [DUAL-1:0]                     irx_sob,
  output                                irx_eob,
  output [7:0]                          irx_chan,
  ...
  assign    tx_serial_clk = {NUM_LANES{atxpll_serial_clk}}; 
    ...
    .itx_num_valid       (itx_num_valid),   //  input  [3:0]
    .itx_chan            (itx_chan),               //  input  [7:0]
    .itx_sop             (itx_sop),         //  input
    .itx_eopbits         (itx_eopbits),            //  input  [3:0]
    .itx_sob             (itx_sob),                //  input
    ...
    .irx_num_valid       (irx_num_valid),         //  output [3:0]
   ...
   always @ (posedge rx_usr_clk or negedge reset_n)
       if (reset_n) begin

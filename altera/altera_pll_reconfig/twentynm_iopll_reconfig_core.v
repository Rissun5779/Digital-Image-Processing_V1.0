...
// ------------------------------------------------------------------------------------------------------- 
   ...
   altera_std_synchronizer #(
    ...
    // Data FIFO
    twentynm_iopll_reconfig_core_fifo #(
        .FAMILY         (FAMILY),
        .NUM_WORDS      (8),
        .LOG2_NUM_WORDS (3),
        .WORD_WIDTH     (MAX_DATA)
    ...
    twentynm_iopll_reconfig_core_logical2physical #(
        .FAMILY   (FAMILY)
    ) c_index_translate (
    ...
    twentynm_iopll_reconfig_core_generic_fsm #(
        .FAMILY           (FAMILY),
    ...
    twentynm_iopll_reconfig_core_analog_fsm #(
        .FAMILY           (FAMILY),
...
module twentynm_iopll_reconfig_core_analog_fsm
#(
    parameter FAMILY              = "Arria 10",
 ...
 module twentynm_iopll_reconfig_core_fifo #(
    parameter FAMILY            = "Arria 10",
...
module twentynm_iopll_reconfig_core_generic_fsm
#(
    parameter FAMILY              = "Arria 10",
    parameter DPRIO_ADDR_WIDTH    = 9,
    parameter DPRIO_DATA_WIDTH    = 8
...
module twentynm_iopll_reconfig_core_logical2physical #(
    parameter FAMILY = "Arria 10"
) (

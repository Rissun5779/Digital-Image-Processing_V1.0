...
set_fileset_property synth   TOP_LEVEL altera_avalon_sc_fifo

add_fileset          sim     SIM_VERILOG   generate
set_fileset_property sim     TOP_LEVEL altera_avalon_sc_fifo

add_fileset          simvhdl SIM_VHDL      generate
set_fileset_property simvhdl TOP_LEVEL altera_avalon_sc_fifo

proc generate {output_name} {
    add_fileset_file altera_avalon_sc_fifo.v VERILOG PATH altera_avalon_sc_fifo.v
}
...
set_parameter_property USE_FILL_LEVEL      AFFECTS_GENERATION false
set_parameter_property USE_STORE_FORWARD   AFFECTS_GENERATION false
set_parameter_property EMPTY_LATENCY       AFFECTS_GENERATION false
set_parameter_property USE_MEMORY_BLOCKS   AFFECTS_GENERATION false
set_parameter_property USE_ALMOST_FULL_IF  AFFECTS_GENERATION false
set_parameter_property USE_ALMOST_EMPTY_IF AFFECTS_GENERATION false

...
set_module_property     "displayName"               "Avalon MM DDR Memory Half Rate Bridge Intel FPGA IP"
...
proc validate {} {
    ...
    # ------------------------------------------------------------------
    # Info messages for Quartus Standard only supported IP
    # ------------------------------------------------------------------
    send_message info "Avalon MM DDR Memory Half Rate Bridge will only be supported in Quartus Prime Standard Edition in the future release."
}

...
set_fileset_property synth   TOP_LEVEL altera_avalon_st_bytes_to_packets
...
set_fileset_property sim     TOP_LEVEL altera_avalon_st_bytes_to_packets
add_fileset_file altera_avalon_st_bytes_to_packets.v VERILOG PATH altera_avalon_st_bytes_to_packets.v

add_fileset          simvhdl SIM_VHDL
set_fileset_property simvhdl TOP_LEVEL altera_avalon_st_bytes_to_packets
add_fileset_file altera_avalon_st_bytes_to_packets.v VERILOG PATH altera_avalon_st_bytes_to_packets.v
# | 
# +-----------------------------------
...
add_interface_port out_packets_stream out_channel channel Output CHANNEL_WIDTH_DERIVED
...
proc check_maxchannel_callback { }  {
   ...
   if { $encoding_value == 0 } {
      ...
      set_interface_property out_packets_stream maxChannel $channel_max
   } else {
      ...
      if { $channel_w == 0 } {
         ...
         set_interface_property out_packets_stream maxChannel 0
      } else {
         set_port_property out_channel TERMINATION false

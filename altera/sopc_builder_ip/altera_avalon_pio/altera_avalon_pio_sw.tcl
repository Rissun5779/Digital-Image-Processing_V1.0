...
#
# altera_avalon_pio_driver.tcl
#

# Create a new driver
create_driver altera_avalon_pio_driver

# Associate it with some hardware known as "altera_avalon_pio"
...
# Include files
add_sw_property include_source inc/altera_avalon_pio_regs.h

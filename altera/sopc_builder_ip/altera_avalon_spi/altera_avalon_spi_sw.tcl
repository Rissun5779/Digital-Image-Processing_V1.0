...
#
# altera_avalon_spi_driver.tcl
#

# Create a new driver
create_driver altera_avalon_spi_driver

# Associate it with some hardware known as "altera_avalon_spi"
set_sw_property hw_class_name altera_avalon_spi

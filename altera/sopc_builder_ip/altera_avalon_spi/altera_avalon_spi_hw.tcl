...
set_module_property DISPLAY_NAME {SPI (3 Wire Serial) Intel FPGA IP}
...
set_parameter_property clockPhase DESCRIPTION {0:data latched on the leading edge of
sclk; 1:data latched on the trailing edge of sclk}
...
set_parameter_property clockPolarity DESCRIPTION {0, the idle state for sclk is low; 1, the idle state for sclk is high}
...
set_parameter_property dataWidth DESCRIPTION  {width of rxdata, txdata, and the receive and transmit shift registers.}
...
set_parameter_property insertDelayBetweenSlaveSelectAndSClk DESCRIPTION {Specify delay}
...
set_parameter_property insertSync DESCRIPTION {Insert Synchronizers}
...
set_parameter_property lsbOrderedFirst DESCRIPTION {false:MSB first; true:LSB first}
...
set_parameter_property masterSPI DESCRIPTION {true:Master; false:Slave}
...
set_parameter_property numberOfSlaves DESCRIPTION {Specifies the number of slaves the SPI master connects to.}
...
set_parameter_property syncRegDepth DESCRIPTION {Depth}
...
set_parameter_property targetClockRate DESCRIPTION {rate of the sclk signal that synchronizes data between master and slaves.}
...
set_parameter_property targetSlaveSelectToSClkDelay DESCRIPTION {Add a time delay between asserting the ss_n signal and shifting the first bit of data.}
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/sfo1400787952932/iga1401317569928

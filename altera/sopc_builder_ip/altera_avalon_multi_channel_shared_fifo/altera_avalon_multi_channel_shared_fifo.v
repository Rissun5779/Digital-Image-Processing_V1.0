...
(
    ...
    localparam EMPTY_PORT_WIDTH      = (EMPTY_WIDTH > 0) ? EMPTY_WIDTH : 1;
    localparam ERROR_PORT_WIDTH      = (ERROR_WIDTH > 0) ? ERROR_WIDTH : 1;
    localparam CHANNEL_PORT_WIDTH    = (CHANNEL_WIDTH > 0) ? CHANNEL_WIDTH : 1;
    ...
    input wire [EMPTY_PORT_WIDTH - 1 : 0] in_empty;
    input wire [ERROR_PORT_WIDTH - 1 : 0] in_error;
    input wire [CHANNEL_PORT_WIDTH - 1 : 0] in_channel;
    output reg in_ready;
    ...
    output wire [EMPTY_PORT_WIDTH - 1 : 0] out_empty;
    output wire [ERROR_PORT_WIDTH - 1 : 0] out_error;
    output reg  [CHANNEL_PORT_WIDTH - 1 : 0] out_channel;

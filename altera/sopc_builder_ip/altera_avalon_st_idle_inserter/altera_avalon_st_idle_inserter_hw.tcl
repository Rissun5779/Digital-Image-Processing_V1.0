...
set_fileset_property synth   TOP_LEVEL altera_avalon_st_idle_inserter
add_fileset_file altera_avalon_st_idle_inserter.v VERILOG PATH altera_avalon_st_idle_inserter.v

add_fileset          sim     SIM_VERILOG
set_fileset_property sim     TOP_LEVEL altera_avalon_st_idle_inserter
add_fileset_file altera_avalon_st_idle_inserter.v VERILOG PATH altera_avalon_st_idle_inserter.v

add_fileset          simvhdl SIM_VHDL
set_fileset_property simvhdl TOP_LEVEL altera_avalon_st_idle_inserter
add_fileset_file altera_avalon_st_idle_inserter.v VERILOG PATH altera_avalon_st_idle_inserter.v
# | 
# +-----------------------------------

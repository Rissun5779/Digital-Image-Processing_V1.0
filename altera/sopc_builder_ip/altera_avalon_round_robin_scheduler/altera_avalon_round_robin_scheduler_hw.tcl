...
set_module_property DESCRIPTION "Simple Round Robin Scheduler used with Multi-Channel Shared Memory FIFO and TSE"
...
set_fileset_property synth       TOP_LEVEL     altera_avalon_round_robin_scheduler

add_fileset          sim         SIM_VERILOG   {generate sim}
set_fileset_property sim         TOP_LEVEL     altera_avalon_round_robin_scheduler

add_fileset          simvhdl     SIM_VHDL      {generate sim}
set_fileset_property simvhdl     TOP_LEVEL     altera_avalon_round_robin_scheduler


proc generate {output_name} {
    add_fileset_file altera_avalon_round_robin_scheduler.v VERILOG PATH altera_avalon_round_robin_scheduler.v
}
# | 
# +-----------------------------------
...
# -----------------------------------------------------------------
   ...
   set_parameter_property MAX_CHANNELS DESCRIPTION "Number of channels Avalon-ST Round Robin Scheduler supports."
   ...
   set_parameter_property USE_ALMOST_FULL DESCRIPTION "Enables and exposes the Avalon-ST Almost Full Interface"
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/sfo1400787952932/iga1401398386813

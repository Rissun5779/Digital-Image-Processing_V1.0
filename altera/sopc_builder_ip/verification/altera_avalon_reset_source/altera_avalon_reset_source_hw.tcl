...
# $File: //acds/rel/18.1std/ip/sopc/components/verification/altera_avalon_reset_source/altera_avalon_reset_source_hw.tcl $
# $Author: psgswbuild $
# $Revision: #1 $
# $Date: 2018/07/18 $
#------------------------------------------------------------------------------
...
set_module_property DISPLAY_NAME                   "Reset Source BFM Intel FPGA IP"

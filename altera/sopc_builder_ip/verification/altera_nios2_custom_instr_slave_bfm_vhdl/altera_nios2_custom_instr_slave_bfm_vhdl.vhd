...
library work;
use work.all;
use work.altera_nios2_custom_instr_slave_bfm_vhdl_pkg.all;

entity altera_nios2_custom_instr_slave_bfm_vhdl is
   generic (
   ...
   port (
      ...
      ci_n              : in std_logic_vector (EXT_WIDTH - 1 downto 0);
      ci_a              : in std_logic_vector (4 downto 0);                    
      ci_b              : in std_logic_vector (4 downto 0);                    
      ci_c              : in std_logic_vector (4 downto 0);                    
      ci_readra         : in std_logic;
      ci_readrb         : in std_logic;
      ci_writerc        : in std_logic
   );
end altera_nios2_custom_instr_slave_bfm_vhdl;

architecture ci_slave_bfm_vhdl_a of altera_nios2_custom_instr_slave_bfm_vhdl is

   component altera_nios2_custom_instr_slave_bfm_vhdl_wrapper
      generic (
         NUM_OPERANDS      : integer := 2;
         USE_RESULT        : integer := 1;
         USE_MULTI_CYCLE   : integer := 0;
      ...
      port (
         ...
         req               : in std_logic_vector (CI_SLV_SET_CLOCK_ENABLE_TIMEOUT downto 0);
         ack               : out std_logic_vector (CI_SLV_SET_CLOCK_ENABLE_TIMEOUT downto 0);
         data_in0          : in integer;
         ...
         events            : out std_logic_vector (CI_SLV_EVENT_INSTRUCTION_UNCHANGED downto 0)
      );
   end component;
      
   -- VHDL request interface
   signal req              : std_logic_vector (CI_SLV_SET_CLOCK_ENABLE_TIMEOUT downto 0);
   signal ack              : std_logic_vector (CI_SLV_SET_CLOCK_ENABLE_TIMEOUT downto 0);
   ...
   signal events           : std_logic_vector (CI_SLV_EVENT_INSTRUCTION_UNCHANGED downto 0);
   ...
   ci_slave_vhdl_wrapper : altera_nios2_custom_instr_slave_bfm_vhdl_wrapper
      generic map (

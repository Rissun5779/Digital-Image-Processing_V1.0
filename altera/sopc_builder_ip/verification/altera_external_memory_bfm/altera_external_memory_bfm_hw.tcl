...
# $Id: //acds/rel/18.1std/ip/sopc/components/verification/altera_external_memory_bfm/altera_external_memory_bfm_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_module_property DISPLAY_NAME                 "External Memory BFM Intel FPGA IP"
...
proc sim_verilog {altera_external_memory_bfm} {
   set HDL_LIB_DIR "../lib"
   set INIT_FILE_NAME [get_parameter_value INIT_FILE]
   
   add_fileset_file altera_external_memory_bfm.sv SYSTEM_VERILOG PATH "altera_external_memory_bfm.sv"
   add_fileset_file $INIT_FILE_NAME HEX PATH "altera_external_memory_bfm.hex"
}

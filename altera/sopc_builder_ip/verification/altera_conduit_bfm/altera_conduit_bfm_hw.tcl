...
# $Id: //acds/rel/18.1std/ip/sopc/components/verification/altera_conduit_bfm/altera_conduit_bfm_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_module_property DISPLAY_NAME                                     "Conduit BFM Intel FPGA IP"
...
set_parameter_property SIGNAL_WIDTHS ALLOWED_RANGES 1:4096

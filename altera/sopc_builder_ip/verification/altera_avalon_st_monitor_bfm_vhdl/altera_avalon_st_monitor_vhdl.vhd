...
library work;
use work.all;
use work.altera_avalon_st_monitor_vhdl_pkg.all;

entity altera_avalon_st_monitor_vhdl is
   generic (
...
end altera_avalon_st_monitor_vhdl;

architecture st_monitor_bfm_vhdl_a of altera_avalon_st_monitor_vhdl is
   
   component altera_avalon_st_monitor_vhdl_wrapper
      generic (
         ST_SYMBOL_W          : integer := 8;
         ST_NUMSYMBOLS        : integer := 4;
         ST_CHANNEL_W         : integer := 1;
      ...
      port (
         ...
         req                  : in std_logic_vector (ST_MONITOR_GET_TRANSACTION_QUEUE_SIZE downto 0);
         ack                  : out std_logic_vector (ST_MONITOR_GET_TRANSACTION_QUEUE_SIZE downto 0);
         data_in0             : in integer;
         ...
         events               : out std_logic_vector (ST_MONITOR_EVENT_TRANSACTION_FIFO_OVERFLOW downto 0)
      );
   end component;
   
   -- VHDL request interface
   signal req        : std_logic_vector (ST_MONITOR_GET_TRANSACTION_QUEUE_SIZE downto 0);
   signal ack        : std_logic_vector (ST_MONITOR_GET_TRANSACTION_QUEUE_SIZE downto 0);
   ...
   signal events     : std_logic_vector (ST_MONITOR_EVENT_TRANSACTION_FIFO_OVERFLOW downto 0);
   ...
   st_monitor_vhdl_wrapper : altera_avalon_st_monitor_vhdl_wrapper
      generic map (

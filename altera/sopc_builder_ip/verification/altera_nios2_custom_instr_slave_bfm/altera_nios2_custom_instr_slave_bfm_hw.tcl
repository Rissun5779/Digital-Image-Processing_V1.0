...
# $Id: //acds/rel/18.1std/ip/sopc/components/verification/altera_nios2_custom_instr_slave_bfm/altera_nios2_custom_instr_slave_bfm_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_module_property DESCRIPTION    		            "Altera Nios II Custom Instruction Slave BFM"
set_module_property NAME           		            altera_nios2_custom_instr_slave_bfm
set_module_property VERSION        		            18.1
set_module_property GROUP          		            "Avalon Verification Suite"
set_module_property AUTHOR           	 	         "Altera Corporation"
set_module_property DISPLAY_NAME                   "Nios II Custom Instruction Slave BFM Intel FPGA IP"
set_module_property INSTANTIATE_IN_SYSTEM_MODULE   true
set_module_property EDITABLE                       false
set_module_property INTERNAL 			               false
set_module_property ELABORATION_CALLBACK           elaborate
set_module_property ANALYZE_HDL                    false
set_module_property PREFERRED_SIMULATION_LANGUAGE  none
...
set_fileset_property sim_verilog top_level altera_nios2_custom_instr_slave_bfm

add_fileset sim_vhdl SIM_VHDL sim_vhdl
set_fileset_property sim_vhdl top_level altera_nios2_custom_instr_slave_bfm_vhdl

# SIM_VERILOG generation callback procedure
proc sim_verilog {altera_nios2_custom_instr_slave_bfm} {
   set HDL_LIB_DIR "../lib"
   ...
   add_fileset_file altera_nios2_custom_instr_slave_bfm.sv SYSTEM_VERILOG PATH "altera_nios2_custom_instr_slave_bfm.sv" 
...
proc sim_vhdl {altera_nios2_custom_instr_slave_bfm_vhdl} {
   set HDL_LIB_DIR   "../lib"
   ...
   if {1} {
      ...
      add_fileset_file mentor/altera_nios2_custom_instr_slave_bfm.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_nios2_custom_instr_slave_bfm.sv" {MENTOR_SPECIFIC}
      add_fileset_file mentor/altera_nios2_custom_instr_slave_bfm_vhdl_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_nios2_custom_instr_slave_bfm_vhdl_wrapper.sv" {MENTOR_SPECIFIC}
   ...
   add_fileset_file altera_nios2_custom_instr_slave_bfm.sv SYSTEM_VERILOG_ENCRYPT PATH "altera_nios2_custom_instr_slave_bfm.sv" {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPSYS_SPECIFIC}
   add_fileset_file altera_nios2_custom_instr_slave_bfm_vhdl_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "altera_nios2_custom_instr_slave_bfm_vhdl_wrapper.sv" {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPSYS_SPECIFIC}
   
   set_fileset_file_attribute verbosity_pkg.sv           COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_verbosity_pkg
   set_fileset_file_attribute avalon_utilities_pkg.sv    COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_avalon_utilities_pkg
   
   add_fileset_file altera_nios2_custom_instr_slave_bfm_vhdl_pkg.vhd VHDL path "$VHDL_DIR/altera_nios2_custom_instr_slave_bfm_vhdl_pkg.vhd"
   add_fileset_file altera_nios2_custom_instr_slave_bfm_vhdl.vhd VHDL path "$VHDL_DIR/altera_nios2_custom_instr_slave_bfm_vhdl.vhd"
...
proc elaborate {} {
    ...
    #---------------------------------------------------------------------
    #  NiosII combination custom instruction slave connection point 
    #---------------------------------------------------------------------
    set CUSTOM_INSTR_INTERFACE "slave"
    add_interface $CUSTOM_INSTR_INTERFACE nios_custom_instruction slave

    set_interface_property $CUSTOM_INSTR_INTERFACE enabled true
    set_interface_property $CUSTOM_INSTR_INTERFACE operands        $NUM_OPERANDS_VALUE
    if { $USE_MULTI_CYCLE_VALUE == 0 } {
      set_interface_property $CUSTOM_INSTR_INTERFACE clockCycle      0
      set_interface_property $CUSTOM_INSTR_INTERFACE clockCycleType  "COMBINATORIAL"
    } elseif { $USE_DONE_VALUE == 1 } {
      set_interface_property $CUSTOM_INSTR_INTERFACE clockCycle      0
      set_interface_property $CUSTOM_INSTR_INTERFACE clockCycleType  "VARIABLE"
    } else {
      set_interface_property $CUSTOM_INSTR_INTERFACE clockCycle      $FIXED_LENGTH_VALUE
      set_interface_property $CUSTOM_INSTR_INTERFACE clockCycleType  "MULTICYCLE"
    }
#    set_interface_property $CUSTOM_INSTR_INTERFACE CIName          $INSTR_NAME_VALUE
#    set_interface_property $CUSTOM_INSTR_INTERFACE opcodeExtension $USE_EXTENSION_VALUE
#    set_interface_property $CUSTOM_INSTR_INTERFACE opcodeExtensionLocked ?
#    set_interface_property $CUSTOM_INSTR_INTERFACE opcodeExtensionLockedValue ?

    #---------------------------------------------------------------------
    # add ports to interface
    #---------------------------------------------------------------------    

    add_interface_port $CUSTOM_INSTR_INTERFACE ci_dataa   dataa      Input  32
    set_port_property ci_dataa VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_datab   datab      Input  32
    set_port_property ci_datab VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_result  result     Output 32
    set_port_property ci_result VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_clk     clk        Input  1
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_reset   reset      Input  1
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_clk_en  clk_en     Input  1
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_start   start      Input  1
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_done    done       Output 1
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_n       n          Input  $EXT_WIDTH_VALUE
    set_port_property ci_n VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_a       a          Input  5
    set_port_property ci_a VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_b       b          Input  5
    set_port_property ci_b VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_c       c          Input  5
    set_port_property ci_c VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_readra  readra     Input  1
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_readrb  readrb     Input  1
    add_interface_port $CUSTOM_INSTR_INTERFACE ci_writerc writerc    Input  1
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/nik1412471932581/nik1412471592433

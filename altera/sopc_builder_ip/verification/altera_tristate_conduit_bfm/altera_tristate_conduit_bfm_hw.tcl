...
# $File: //acds/rel/18.1std/ip/sopc/components/verification/altera_tristate_conduit_bfm/altera_tristate_conduit_bfm_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
# +-----------------------------------------------------------------------------
...
set_module_property DISPLAY_NAME                 "Tri-State Conduit BFM Intel FPGA IP"
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/nik1412471932581/nik1412471834211

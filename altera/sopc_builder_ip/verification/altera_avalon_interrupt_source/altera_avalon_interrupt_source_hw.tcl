...
# $File: //acds/rel/18.1std/ip/sopc/components/verification/altera_avalon_interrupt_source/altera_avalon_interrupt_source_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_module_property DISPLAY_NAME 		   "Avalon Interrupt Source Intel FPGA IP"

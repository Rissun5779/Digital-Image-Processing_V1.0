...
# $Id: //acds/rel/18.1std/ip/sopc/components/verification/altera_avalon_st_source_bfm/altera_avalon_st_source_bfm_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_module_property DISPLAY_NAME                 "Avalon-ST Source BFM Intel FPGA IP"
...
set_parameter_property $ST_CHANNEL_W ALLOWED_RANGES {1:128}
...
set_parameter_property $ST_MAX_CHANNELS ALLOWED_RANGES {0:255}
...
proc validate {} {
    ...
    set error_descriptors_size [llength $error_descriptors]

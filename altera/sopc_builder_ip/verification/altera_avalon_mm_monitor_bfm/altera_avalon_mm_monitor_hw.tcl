...
# $File: //acds/rel/18.1std/ip/sopc/components/verification/altera_avalon_mm_monitor_bfm/altera_avalon_mm_monitor_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#---------------------------------------------------------------------
...
set_module_property DESCRIPTION                  "Avalon-MM Monitor Intel FPGA IP"
...
set AV_ALWAYS_BURST_MAX_BURST       "AV_ALWAYS_BURST_MAX_BURST"
...
add_parameter $AV_ALWAYS_BURST_MAX_BURST Integer 0
set_parameter_property $AV_ALWAYS_BURST_MAX_BURST DISPLAY_NAME "Always Burst Max burst"
set_parameter_property $AV_ALWAYS_BURST_MAX_BURST AFFECTS_ELABORATION true
set_parameter_property $AV_ALWAYS_BURST_MAX_BURST HDL_PARAMETER false
set_parameter_property $AV_ALWAYS_BURST_MAX_BURST DESCRIPTION "This indicates that the interfaces bursting is such that bursts always begin on a burst boundary, and are always the size of a maximum burst."
set_parameter_property $AV_ALWAYS_BURST_MAX_BURST DISPLAY_HINT boolean
set_parameter_property $AV_ALWAYS_BURST_MAX_BURST GROUP "Burst Attributes"
...
proc elaborate {} {
    ...
    global AV_READ_WAIT_TIME   
    global AV_WRITE_WAIT_TIME 
    global AV_ALWAYS_BURST_MAX_BURST
    ...
    set AV_ALWAYS_BURST_MAX_BURST_VALUE        [ get_parameter $AV_ALWAYS_BURST_MAX_BURST ]
    ...
    #---------------------------------------------------------------------
    if { $AV_ALWAYS_BURST_MAX_BURST_VALUE > 0 } {
        set_interface_property $MASTER_INTERFACE alwaysBurstMaxBurst true
        set_interface_property $SLAVE_INTERFACE alwaysBurstMaxBurst true
    } else {
        set_interface_property $MASTER_INTERFACE alwaysBurstMaxBurst false
        set_interface_property $SLAVE_INTERFACE alwaysBurstMaxBurst false
    }

...
# $File: //acds/rel/18.1std/ip/sopc/components/verification/altera_avalon_mm_slave_bfm/altera_avalon_mm_slave_bfm_api_wrapper_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_fileset_property simulation_verilog top_level altera_avalon_mm_slave_bfm_api_wrapper
add_fileset simulation_vhdl SIM_VHDL sim_vhd
set_fileset_property simulation_vhdl top_level altera_avalon_mm_slave_bfm_api_wrapper
proc sim_ver {name} {
   set HDL_LIB_DIR "../lib"

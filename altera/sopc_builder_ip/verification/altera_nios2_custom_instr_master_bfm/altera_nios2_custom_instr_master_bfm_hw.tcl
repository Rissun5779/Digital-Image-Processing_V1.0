...
# $Id: //acds/rel/18.1std/ip/sopc/components/verification/altera_nios2_custom_instr_master_bfm/altera_nios2_custom_instr_master_bfm_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_module_property DISPLAY_NAME                   "Nios II Custom Instruction Master BFM Intel FPGA IP"

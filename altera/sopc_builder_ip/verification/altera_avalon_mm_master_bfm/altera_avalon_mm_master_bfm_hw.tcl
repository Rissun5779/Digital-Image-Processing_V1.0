...
# $File: //acds/rel/18.1std/ip/sopc/components/verification/altera_avalon_mm_master_bfm/altera_avalon_mm_master_bfm_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_module_property DISPLAY_NAME                 "Avalon-MM Master BFM Intel FPGA IP"
...
set_parameter_property $ASSERT_HIGH_RESET VISIBLE false
...
#    }
   ...
   # port termination for writeresponsevalid signal

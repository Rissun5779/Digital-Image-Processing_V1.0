...
module altera_hps_master_bfm (
   ...
   localparam ADDR_CH_DATA_W     = ADDR_W + ADDR_USER_W + 18;
  ...
  //--------------------------------------------------------------------------
   ...
   assign AWADDR  = aw_data[ADDR_W+ADDR_USER_W+17:ADDR_USER_W+18];
   assign AWUSER  = aw_data[ADDR_USER_W+17:18];
   ...
   assign ARADDR  = ar_data[ADDR_W+ADDR_USER_W+17:ADDR_USER_W+18];
   assign ARUSER  = ar_data[ADDR_USER_W+17:18];

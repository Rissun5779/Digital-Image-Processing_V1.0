...
set_module_property DISPLAY_NAME {Legacy EPCS/EPCQx1 Flash Controller Intel FPGA IP}
...
set_module_property SUPPORTED_DEVICE_FAMILIES {CYCLONEIVE CYCLONEIVGX CYCLONEV ARRIAIIGX ARRIAIIGZ ARRIAV ARRIAVGZ STRATIXIV STRATIXV}
...
add_documentation_link {User Guide} {https://documentation.altera.com/#/link/sfo1400787952932/iga1401316857291}
...
set_parameter_property autoSelectASMIAtom DISPLAY_NAME {Automatically select dedicated active serial interface}
set_parameter_property autoSelectASMIAtom DESCRIPTION {Automatically select dedicated active serial memory interface, if supported.}
...
set_parameter_property useASMIAtom DESCRIPTION {use dedicated active serial memory interface}
...
add_text_message  {DESCRIPTION}  "<html> The Active Serial Flash Controller core enables Nios II systems to access an Altera EPCS serial<br>\
...
when you pick a device that does not support dedicated AS interface, the Active Serial Flash Controller signals<br>\
...
proc validate {} {
	...
	set autoInitializationFileName [ get_parameter_value autoInitializationFileName ]
        ...
        send_message info "Legacy EPCS/EPCQx1 Flash Controller will only be supported in Quartus Prime Standard Edition in the future release."

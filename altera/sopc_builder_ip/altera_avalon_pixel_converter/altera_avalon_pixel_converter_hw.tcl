...
set_module_property displayName "Pixel Converter (BGR0 --> BGR) Intel FPGA IP"
...
proc elaborate {} {
   ...
   set_port_property empty_out VHDL_TYPE STD_LOGIC_VECTOR

        send_message info "Pixel Converter (BGR0 --> BGR) will only be supported in Quartus Prime Standard Edition in the future release."

...
set_module_property DISPLAY_NAME {Avalon Compact Flash Intel FPGA IP}
...
add_documentation_link {User Guide } {https://documentation.altera.com/#/link/sfo1400787952932/iga1401316271912}
...
proc elaborate {} {
	...
	add_interface_port ctl av_ctl_writedata writedata Input 4
        ...
        send_message info "Altera Avalon Compact Flash will only be supported in Quartus Prime Standard Edition in the future release."
}

...
set_module_property DISPLAY_NAME {Scatter-Gather DMA Controller Intel FPGA IP}
...
set_parameter_property avalonMMByteReorderMode DESCRIPTION {Avalon MM data master byte reorder mode. (0:no reordering; 1:byte swap)}
...
set_parameter_property enableBurstTransfers DESCRIPTION {Turning on this option enables burst reads and writes.}
...
set_parameter_property enableDescriptorReadMasterBurst DESCRIPTION {Enable the descriptor processor block uses Avalon-MM bursting when fetching descriptors and writing them back in memory.}
...
set_parameter_property enableUnalignedTransfers DESCRIPTION {Allows accesses to non-word-aligned addresses.}
...
set_parameter_property readBlockDataWidth DESCRIPTION {The data width in bits for the Avalon-MM read and write ports.}
...
set_parameter_property readBurstcountWidth DESCRIPTION {The width of the read burstcount signal.}
...
set_parameter_property sinkErrorWidth DESCRIPTION {The width of the error signal for the Avalon-ST sink port.}
...
set_parameter_property sourceErrorWidth DESCRIPTION {The width of the error signal for the Avalon-ST source port.}
...
set_parameter_property transferMode DESCRIPTION {Configuration of Transfer mode.}
...
set_parameter_property writeBurstcountWidth DESCRIPTION {The width of the write burstcount signal.}
...
proc validate {} {
	...
	if { !$enableUnalignedTransfers } {
        ...
        send_message info "Scatter-Gather DMA Controller will only be supported in Quartus Prime Standard Edition in the future release."
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/sfo1400787952932/iga1401397400525 

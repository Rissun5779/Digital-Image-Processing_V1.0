...
sub add_descriptor_writeback_ports {
  ...
  my @ports = (
    ...
    # Descriptor write busy indication
    [descriptor_write_busy=>1=>"output"],
    
    # Export the t_eop because control_status_slave takes that to generate interrupt
    [t_eop=>1=>"output"],
...
# This decoding is solely for the purpose of the control_slave_status block to find out what's been happening
# in the SGDMA.
...
# TODO : this is a common code that can be moved into a utilities folder.

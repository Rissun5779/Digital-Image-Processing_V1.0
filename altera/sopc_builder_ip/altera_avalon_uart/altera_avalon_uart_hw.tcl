...
set_module_property DISPLAY_NAME {UART (RS-232 Serial Port) Intel FPGA IP}
...
set_parameter_property baud DESCRIPTION {standard baud rates for RS-232 connections}
...
set_parameter_property dataBits DESCRIPTION {Determines the widths of the txdata, rxdata, and endofpacket registers.}
...
set_parameter_property parity DESCRIPTION {Determines whether the UART core transmits characters with parity checking.}
...
set_parameter_property stopBits DESCRIPTION {Use to terminates a
receive transaction at the first stop bit.}
...
set_parameter_property syncRegDepth DESCRIPTION {Synchronizer of stages}
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/sfo1400787952932/iga1401317331859 

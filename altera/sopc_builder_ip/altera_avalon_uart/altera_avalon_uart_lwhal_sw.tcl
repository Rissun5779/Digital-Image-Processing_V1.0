...
# Create a new driver
create_driver altera_avalon_uart_lwhal_driver
...
# C/C++ source files
add_sw_property c_source LWHAL/src/altera_avalon_uart_lwhal_putchar.c

# Include files
add_sw_property include_source LWHAL/inc/altera_avalon_uart_lwhal.h

...
#  o '#define' in driver code (and therefore string in generated
#     makefile): "ALTERA_AVALON_JTAG_UART_IGNORE_FIFO_FULL_ERROR", 
#     which means: "emit CPPFLAGS += 
#     ALTERA_AVALON_JTAG_UART_IGNORE_FIFO_FULL_ERROR in generated 
#     makefile
#  o Default value (if the user doesn't specify at BSP creation): false
#    (which means: 'do not emit above CPPFLAGS string in generated makefile)
#  o Description text
add_sw_setting boolean_define_only public_mk_define enable_jtag_uart_ignore_fifo_full_error ALTERA_AVALON_JTAG_UART_IGNORE_FIFO_FULL_ERROR false "Enable JTAG UART driver to recover when host is inactive causing buffer to full without returning error. Printf will not fail with this recovery."

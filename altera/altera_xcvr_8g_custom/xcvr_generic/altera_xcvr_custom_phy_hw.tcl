...
# | $Header: //acds/rel/18.1std/ip/altera_xcvr_8g_custom/xcvr_generic/altera_xcvr_custom_phy_hw.tcl#1 $
# | 
# +-----------------------------------
...
set_module_property DISPLAY_NAME "Custom PHY Intel FPGA IP"

...
# agreement for further details.
    ...
    foreach {language sim_language} $hdl {
        ...
        } elseif {![string compare $dut_device_family "Stratix V"]} {
            set dut_device_part "5SGXEA7N2F45C2"
        } elseif {![string compare $dut_device_family "Arria V GZ"]} {
            set dut_device_part "5AGZME7K3F40I4"
        }

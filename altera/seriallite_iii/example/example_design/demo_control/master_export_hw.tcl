...
proc my_elaboration_callback {} {
    ...
    add_interface_port master avm_address address Output [get_parameter_value address_width]
    ...
    add_interface_port slave avs_address address Input [get_parameter_value address_width]

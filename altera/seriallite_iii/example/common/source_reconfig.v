...
module source_reconfig #(
		...
		output wire [lanes*140-1:0] reconfig_to_xcvr,          //   reconfig_to_xcvr.reconfig_to_xcvr
		input  wire [lanes*92-1:0]  reconfig_from_xcvr         // reconfig_from_xcvr.reconfig_from_xcvr
	);

...
// agreement for further details.
      ...
      //   integer  lane_hold = 0;
         ...
         while (test_env.sink_inst.seriallite_iii_streaming_sink.sink_alignment.la_sm != test_env.sink_inst.seriallite_iii_streaming_sink.sink_alignment.LASM_TRIAL_CHECK) @(posedge test_env.snk_user_clock);
         ...
         force test_env.sink_inst.seriallite_iii_streaming_sink.sink_alignment.lane_sync_det= {{lanes-1{1'b0}}, {1'b1}} << test_lane;
    ...
    // end 
         ...
         release test_env.sink_inst.seriallite_iii_streaming_sink.sink_alignment.lane_sync_det;

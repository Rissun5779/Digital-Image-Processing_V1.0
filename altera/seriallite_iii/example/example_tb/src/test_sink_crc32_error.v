...
// agreement for further details.
      ...
      if (test_name == "sink_crc32_error") begin
         ...
         `ifdef DUPLEX_MODE         
         @(posedge test_env.duplex_inst.seriallite_iii_streaming.rx_clkout[0]);
         force test_env.duplex_inst.seriallite_iii_streaming.rx_crc32err = {lanes{1'b1}};         
         `else
         @(posedge test_env.sink_inst.seriallite_iii_streaming_sink.rx_clkout[0]);
         force test_env.sink_inst.seriallite_iii_streaming_sink.rx_crc32err = {lanes{1'b1}};
         `endif
         ...
         `ifdef DUPLEX_MODE
         release test_env.duplex_inst.seriallite_iii_streaming.rx_crc32err;
         `else
         release test_env.sink_inst.seriallite_iii_streaming_sink.rx_crc32err;
         `endif

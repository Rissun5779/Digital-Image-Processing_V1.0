...
if (test_name == "sink_underflow_error") begin
  ...
  `ifdef DUPLEX_MODE
    while (test_env.duplex_inst.seriallite_iii_streaming.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.rx_adapt_fifo_empty == {lanes{1'b1}}) @(posedge test_env.snk_user_clock);
    force test_env.duplex_inst.seriallite_iii_streaming.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.si_valid = {lanes{1'b0}};
  `else
    while (test_env.sink_inst.seriallite_iii_streaming_sink.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.rx_adapt_fifo_empty == {lanes{1'b1}}) @(posedge test_env.snk_user_clock);
    force test_env.sink_inst.seriallite_iii_streaming_sink.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.si_valid = {lanes{1'b0}};
  `endif
  $write("   \n");
  ...
  @(posedge test_env.snk_user_clock);
  `ifdef DUPLEX_MODE
  while (test_env.duplex_inst.seriallite_iii_streaming.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.rx_adapt_fifo_empty == {lanes{1'b0}}) @(posedge test_env.snk_user_clock);
  release test_env.duplex_inst.seriallite_iii_streaming.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.si_valid;

  force test_env.duplex_inst.seriallite_iii_streaming.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.rdreq = 1'b1;
  
  `else
  while (test_env.sink_inst.seriallite_iii_streaming_sink.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.rx_adapt_fifo_empty == {lanes{1'b0}}) @(posedge test_env.snk_user_clock);
  release test_env.sink_inst.seriallite_iii_streaming_sink.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.si_valid;

  force test_env.sink_inst.seriallite_iii_streaming_sink.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.rdreq = 1'b1;
  `endif
  ...
  `ifdef DUPLEX_MODE
  release test_env.duplex_inst.seriallite_iii_streaming.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.rx_valid;
  `else
  release test_env.sink_inst.seriallite_iii_streaming_sink.altera_sl3_sink_mac_inst.scm_sink.altera_sl3_sink_adaptation.rx_valid;
  `endif

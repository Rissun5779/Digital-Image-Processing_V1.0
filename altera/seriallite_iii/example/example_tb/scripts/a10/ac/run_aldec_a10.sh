...
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_source_adaptation.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_source_adaptation_ecc.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_source_application.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_source_control.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_source_csr.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_source_mac.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_dp_sync.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/source_absorber.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/control_word_decoder.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/aclr_filter.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/dcfifo_s5m20k.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/delay_regs.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/eq_5_ena.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/gray_cntr_5_sl.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/gray_to_bin_5.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/neq_5_ena.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/s5m20k_ecc_1r1w.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/sync_regs_aclr_m2.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/wys_lut.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING

// Sink Components
vlog -sv +incdir+../../src+../ $SNK_SIM_LOCATION/seriallite_iii_a10_160/sim/seriallite_iii_streaming_sink.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING -work sink_seriallite_iii
vlog -sv +incdir+../../src+../ $SNK_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_sink_mac.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SNK_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_sink_csr.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SNK_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_sink_application.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SNK_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_sink_alignment.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SNK_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_sink_adaptation.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SNK_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_sink_dcfifo.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING
vlog -sv +incdir+../../src+../ $SNK_SIM_LOCATION/seriallite_iii_a10_160/sim/aldec/altera_sl3_sink_dcfifo_fifo.v +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING

vlog -sv +incdir+../../src+../ -f seriallite_src_lst_rivr.txt +access +w +define+ALTERA +define+SIMULATION +define+SERIALLITE_III_FOR_A10  +define+ADVANCED_CLOCKING

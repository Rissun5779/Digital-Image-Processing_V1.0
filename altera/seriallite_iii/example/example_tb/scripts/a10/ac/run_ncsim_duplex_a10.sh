...
irun -compile -sv +define+DUPLEX_MODE +define+ADVANCED_CLOCKING +define+SERIALLITE_III_FOR_A10  +define+SIMULATION +incdir+../../src+../ -F seriallite_src_lst_ncsim.txt

# Run the simulation

ncelab -access +w+r+c +define+ADVANCED_CLOCKING +define+SERIALLITE_III_FOR_A10  test_env
ncsim -run +random_seed=123456 +define+SIMULATION +define+ADVANCED_CLOCKING +define+SERIALLITE_III_FOR_A10  +define+DUPLEX_MODE +test_name=data_forwarding test_env

...
ncvlog -compcnfg $SRC_SIM_LOCATION/seriallite_iii_a10_160/sim/native_ilk_wrapper_tx*.v
...
irun -compile -sv +define+ADVANCED_CLOCKING +define+SERIALLITE_III_FOR_A10  +define+SIMULATION +incdir+../../src+../ -F seriallite_src_lst_ncsim.txt

# Run the simulation

ncelab -access +w+r+c -namemap_mixgen +define+ADVANCED_CLOCKING +define+SERIALLITE_III_FOR_A10 test_env
ncsim -run +random_seed=123456 +define+SIMULATION +define+ADVANCED_CLOCKING +define+SERIALLITE_III_FOR_A10 +test_name=data_forwarding test_env

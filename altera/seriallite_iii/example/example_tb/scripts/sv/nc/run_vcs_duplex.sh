...
# SIM_LOCATION to where generated simulation files for Duplex Interface are located
###########################################################################################################
...
vcs -lca -sverilog +verilog2001ext+.v -timescale=1ps/1ps +define+ALTERA +define+SIMULATION \
  ...
  \"+incdir+$SIM_LOCATION/seriallite_iii_sv/\" $SIM_LOCATION/seriallite_iii_sv/seriallite_iii_streaming.v \

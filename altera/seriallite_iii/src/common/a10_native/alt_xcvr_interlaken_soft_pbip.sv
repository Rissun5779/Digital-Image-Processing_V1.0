...
module alt_xcvr_interlaken_soft_pbip
  #(
    ...
    output reg [LINKWIDTH-1:0] tx_force_fill = {LINKWIDTH{1'b0}}
   ...
   reg [LINKWIDTH-1:0] tx_fifo_full_reg = {LINKWIDTH{1'b0}};
   wire 		       clk_tx_common;
   wire 		       srst_tx_common;
   reg 			       tx_aligned = 1'b0;
  ...
  tx_fifo_full_reg <= tx_fifo_full;
	all_tx_full <= &tx_fifo_full_reg;
	any_tx_full <= |tx_fifo_full_reg;

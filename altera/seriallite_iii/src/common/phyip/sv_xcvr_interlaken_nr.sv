...
//    output [LINKWIDTH-1:0]     pll_locked,
    ...
    output 			tx_sync_done,
       ...
       // Reconfig interfaces
    (* altera_attribute="disable_da_rule=r102" *)  input   wire [get_interlaken_reconfig_to_width  ("Stratix V",PLEX,BONDED_GROUP_SIZE,LINKWIDTH)-1:0] reconfig_to_xcvr       ,
...
// Calibration busy signals
   ...
   wire tx_force_fill;
   reg  [LINKWIDTH-1:0]      tx_fifo_full_reg;
...
// End PCS bonding soft solution ip logic       
   ...
   localparam  RX_PER_CHANNEL = (BONDED_GROUP_SIZE > 1);
    ...
    #(
        ...
        .T_TX_DIGITALRESET      (1000           ),  // tx_digitalreset period (after pll_powerdown)

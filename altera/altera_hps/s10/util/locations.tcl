...
namespace eval locations {
    ...
    proc query_quartus_for_pad_to_pkg_map {part} {
        set quartus_script_path [file join $::env(QUARTUS_ROOTDIR) .. ip altera altera_hps s10 util quartus_locations_query.tcl]
        set cmd "advanced_device:source ${quartus_script_path};get_pad_to_pin_name $part "
        set pad_to_pkg_map [lindex [run_quartus_tcl_command $cmd] 0]
    ...
    proc query_quartus_for_location {part atom_name peripheral_index} {
        ...
        set pad_data [lindex [run_quartus_tcl_command $cmd] 0]
        return $pad_data
    }
    ...
    proc query_quartus_for_pinmux_data {part } {
        ...
        set pinmux_data [lindex [run_quartus_tcl_command $cmd] 0]
        return $pinmux_data
    }

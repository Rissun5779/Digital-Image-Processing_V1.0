...
proc load_pin_to_atom_map {peripheral_ports_ref} {
    ...
    set csv_file [file join $::env(QUARTUS_ROOTDIR) .. ip altera altera_hps s10 altera_hps_stratix_10 "pin_to_atom_mapping.csv"]
    set count 0
...
proc load_modes {modes_by_peripheral_ref pins_by_peripheral_mode_ref} {
    ...
    set csv_file [file join $::env(QUARTUS_ROOTDIR) .. ip altera altera_hps s10 altera_hps_stratix_10 "modes.csv"]

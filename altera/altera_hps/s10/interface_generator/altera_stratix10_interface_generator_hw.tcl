...
source [file join $env(QUARTUS_ROOTDIR) .. ip altera altera_hps s10 util isw.tcl]

set_module_property NAME altera_stratix10_interface_generator
...
proc synth { outputName } {
    ...
    set HPS_LIB_DIR    "$::env(QUARTUS_ROOTDIR)/../ip/altera/altera_hps/s10/altera_hps_stratix_10"

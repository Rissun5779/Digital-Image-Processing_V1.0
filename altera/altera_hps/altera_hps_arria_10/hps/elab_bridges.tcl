...
proc elab_F2H {device_family} {
	...
	if {$width > 0} {
		...
		fpga_interfaces::set_interface_property      $iface_name combinedAcceptanceCapability 8
...
proc elab_H2F {device_family} {
	...
	if {$width > 0} {
		...
		fpga_interfaces::set_interface_property      $iface_name combinedIssuingCapability 8
...
proc elab_F2SDRAM {device_family} {
	...
	if {$configuration_list == 4} {
		set wys_atom_name  twentynm_hps_rl_mode0_fpga2sdram
		if {$es_device} {
			set wys_atom_name  twentynm_hps_rl_mode0es_fpga2sdram
		}
	} elseif {$configuration_list == 5} {
		set wys_atom_name  twentynm_hps_rl_mode1_fpga2sdram
		if {$es_device} {
			set wys_atom_name  twentynm_hps_rl_mode1es_fpga2sdram
		}
	} elseif {$configuration_list == 6} {
		set wys_atom_name  twentynm_hps_rl_mode2_fpga2sdram
		if {$es_device} {
			set wys_atom_name  twentynm_hps_rl_mode0es_fpga2sdram
			set configuration_list 4		
		}		
	} elseif {$configuration_list == 7} {
		set wys_atom_name  twentynm_hps_rl_mode3_fpga2sdram
		if {$es_device} {
			set wys_atom_name  twentynm_hps_rl_mode0es_fpga2sdram
			set configuration_list 4
		}
	...
	if { $ready_latency_enabled } {
		set termination_value [ expr $configuration_list + 8 ]
		#set wys_atom_name [string map { "twentynm_hps_mode" "twentynm_hps_rl_mode"} $wys_atom_name]
		#send_message warning "wys_atom_name is now $wys_atom_name"
	} else {
		set termination_value $configuration_list
	}
	fpga_interfaces::add_module_instance $instance_name $wys_atom_name 
	fpga_interfaces::set_instance_port_termination $instance_name "fpga2sdram_port_size_config" 4 0 3:0 $termination_value
	fpga_interfaces::set_instance_parameter $instance_name mode [ expr $configuration_list - 3 ]
	...
	# f2sdram0 ############
 	if {$configuration_list == 7} {
		set data_width 128
		set strb_width 16
	}

	if {$f2sdram0_enabled} {
		F2SDRAM_wires         $instance_name 0 $data_width $strb_width $ready_latency_enabled $address_width
		fpga_interfaces::set_instance_parameter $instance_name DWIDTH0 $data_width 
	} else {
		F2SDRAM_tie_off_wires $instance_name 0 $data_width $strb_width $ready_latency_enabled
	}
	...
	if {$f2sdram1_enabled} {
		F2SDRAM_wires         $instance_name 1 $data_width $strb_width $ready_latency_enabled $address_width
		fpga_interfaces::set_instance_parameter $instance_name DWIDTH1 $data_width 
	} else {
		if {$configuration_list != 6} {
			F2SDRAM_tie_off_wires $instance_name 1 $data_width $strb_width $ready_latency_enabled
		}
	}
	...
	if {$f2sdram2_enabled} {
		F2SDRAM_wires         $instance_name 2 $data_width $strb_width $ready_latency_enabled $address_width
		fpga_interfaces::set_instance_parameter $instance_name DWIDTH2 $data_width
	} else {
		F2SDRAM_tie_off_wires $instance_name 2 $data_width $strb_width $ready_latency_enabled
	}
	
    set delay_depth [get_parameter_value F2SDRAM2_DELAY]
	
	fpga_interfaces::set_instance_parameter $instance_name DEPTH $delay_depth 
}
...
proc F2SDRAM_tie_off_wires {instance_name x dw aw ready_latency_enabled } {
	# this is the termination value. F2SDRAM port 0 in the ES device need to be set to 1
	
	foreach port_name { clk w_clk b_clk ar_clk r_clk aw_clk } {
		fpga_interfaces::set_instance_port_termination $instance_name "f2s_sdram${x}_${port_name}" 1 1 0:0 0
	}
	
	fpga_interfaces::set_instance_port_termination       $instance_name f2s_sdram${x}_rst_n      1 1  0:0 0
	
	set d [ expr { $dw - 1 }]
	set a [ expr { $aw - 1 }]
	
	set ta [format "%.0f" [ expr { pow(2 , $aw ) - 1 } ]]
	set td "4294967295"
	if { $dw == 64 } {
	 set td "18446744073709551615"
	}
	if { $dw == 128 } {
	 set td "340282366920938463463374607431768211455"
	}	
	
	if { $x == 0} {	
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_addr  32 1 31:0 4294967295
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_burst  2 1  1:0 3
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_cache  4 1  3:0 15
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_id     4 1  3:0 15
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_len    4 1  3:0 15
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_lock   2 1  1:0 3
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_prot   3 1  2:0 7
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_size   3 1  2:0 7
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_user   5 1  4:0 31
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_valid  1 1  0:0 1
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_addr  32 1 31:0 4294967295
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_burst  2 1  1:0 3
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_cache  4 1  3:0 15
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_id     4 1  3:0 15
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_len    4 1  3:0 15
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_lock   2 1  1:0 3
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_prot   3 1  2:0 7
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_size   3 1  2:0 7
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_user   5 1  4:0 31
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_valid  1 1  0:0 1
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_data  $dw 1 $d:0 $td
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_id      4 1  3:0 15
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_last    1 1  0:0 1
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_strb  $aw 1 $a:0 $ta
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_valid   1 1  0:0 1
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_b_ready   1 1  0:0 1
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_r_ready   1 1  0:0 1
	} else {
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_addr  32 1 31:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_burst  2 1  1:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_cache  4 1  3:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_id     4 1  3:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_len    4 1  3:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_lock   2 1  1:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_prot   3 1  2:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_size   3 1  2:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_user   5 1  4:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_ar_valid  1 1  0:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_addr  32 1 31:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_burst  2 1  1:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_cache  4 1  3:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_id     4 1  3:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_len    4 1  3:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_lock   2 1  1:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_prot   3 1  2:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_size   3 1  2:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_user   5 1  4:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_aw_valid  1 1  0:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_data  $dw 1 $d:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_id      4 1  3:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_last    1 1  0:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_strb  $aw 1 $a:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_w_valid   1 1  0:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_b_ready   1 1  0:0 0
		fpga_interfaces::set_instance_port_termination       $instance_name fpga2sdram${x}_r_ready   1 1  0:0 0

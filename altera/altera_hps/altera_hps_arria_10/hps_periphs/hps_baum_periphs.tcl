...
proc hps_instantiate_arm_gic_0 {num_a9s} {
    ...
    hps_utils_add_instance_clk_reset clk_0 arm_gic_0 arria10_arm_gic
...
proc hps_instantiate_i_clk_mgr_clkmgr {num_a9s} {
    ...
    #hps_utils_add_instance_clk_reset clk_0 baum_clkmgr baum_clkmgr
    add_instance baum_clkmgr baum_clkmgr 18.1
    add_connection clk_0.clk_reset baum_clkmgr.reset_sink
    add_connection cb_intosc_hs_div2_clk.clk baum_clkmgr.cb_intosc_hs_div2_clk clock
    add_connection cb_intosc_ls_clk.clk baum_clkmgr.cb_intosc_ls_clk clock
    add_connection f2s_free_clk.clk baum_clkmgr.f2s_free_clk clock
    add_connection eosc1.clk baum_clkmgr.eosc1 clock
    ...
    hps_utils_add_slave_interface arm_a9_0.altera_axi_master baum_clkmgr.axi_slave0 [hps_i_clk_mgr_clkmgr_base]

    if {$num_a9s > 1} {
        hps_utils_add_slave_interface arm_a9_1.altera_axi_master baum_clkmgr.axi_slave0 [hps_i_clk_mgr_clkmgr_base]
    }

    #hps_utils_add_gic_irq_connection arm_gic_0.irq_rx_offset_115 baum_clkmgr.interrupt_sender 6
...
proc hps_instantiate_i_i2c_emac_1_i2c {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_i2c_emac_1_i2c designware-i2c
...
proc hps_instantiate_i_spim_0_spim {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.spi_m_clk i_spim_0_spim spi
...
proc hps_instantiate_i_watchdog_0_l4wd {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sys_free_clk i_watchdog_0_l4wd dw_wd_timer
...
proc hps_instantiate_i_gpio_2_gpio {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_mp_clk i_gpio_2_gpio dw-gpio
...
proc hps_instantiate_i_timer_sp_1_timer {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_timer_sp_1_timer dw-apb-timer-sp
...
proc hps_instantiate_i_i2c_1_i2c {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_i2c_1_i2c designware-i2c
...
proc hps_instantiate_i_fpga_mgr_fpgamgrregs {num_a9s} {
    ...
    hps_utils_add_instance_clk_reset clk_0 i_fpga_mgr_fpgamgrregs altera_fpgamgr

    set_instance_parameter_value i_fpga_mgr_fpgamgrregs compatible {altr,socfpga-a10-fpga-mgr}
...
proc hps_instantiate_i_usbotg_1_globgrp {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.usb_clk i_usbotg_1_globgrp usb
...
proc hps_instantiate_i_usbotg_0_globgrp {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.usb_clk i_usbotg_0_globgrp usb
...
proc hps_instantiate_i_emac_emac2 {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.emac2_clk i_emac_emac2 stmmac

    hps_utils_set_swEnabled i_emac_emac2 $pinmux

    set_instance_parameter_value i_emac_emac2 rx_fifo_depth 16384
    set_instance_parameter_value i_emac_emac2 compatible {altr,socfpga-stmmac snps,dwmac-3.72a snps,dwmac}
...
proc hps_instantiate_i_emac_emac0 {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.emac0_clk i_emac_emac0 stmmac

    hps_utils_set_swEnabled i_emac_emac0 $pinmux

    set_instance_parameter_value i_emac_emac0 rx_fifo_depth 16384
    set_instance_parameter_value i_emac_emac0 compatible {altr,socfpga-stmmac snps,dwmac-3.72a snps,dwmac}
...
proc hps_instantiate_i_uart_0_uart {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_uart_0_uart snps_uart
...
proc hps_instantiate_i_i2c_emac_2_i2c {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_i2c_emac_2_i2c designware-i2c
...
proc hps_instantiate_i_spis_1_spis {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_mp_clk i_spis_1_spis spi
...
proc hps_instantiate_i_i2c_0_i2c {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_i2c_0_i2c designware-i2c
...
proc hps_instantiate_i_timer_sp_0_timer {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_timer_sp_0_timer dw-apb-timer-sp
...
proc hps_instantiate_i_sdmmc_sdmmc {num_a9s pinmux} {
    ...
    add_instance i_sdmmc_sdmmc sdmmc 18.1   
    add_connection clk_0.clk_reset i_sdmmc_sdmmc.reset_sink
    add_connection baum_clkmgr.l4_mp_clk i_sdmmc_sdmmc.biu clock
    add_connection baum_clkmgr.sdmmc_clk i_sdmmc_sdmmc.ciu clock
...
proc hps_instantiate_i_timer_sys_1_timer {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sys_free_clk i_timer_sys_1_timer dw_apb_timer_osc
...
proc hps_instantiate_i_i2c_emac_0_i2c {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_i2c_emac_0_i2c designware-i2c
...
proc hps_instantiate_i_gpio_1_gpio {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_mp_clk i_gpio_1_gpio dw-gpio
...
proc hps_instantiate_i_qspi_QSPIDATA {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_mp_clk i_qspi_QSPIDATA cadence_qspi
...
proc hps_instantiate_i_dma_DMASECURE {num_a9s} {
    ...
    add_instance i_dma_DMASECURE arm_pl330_dma 18.1
    add_connection clk_0.clk_reset i_dma_DMASECURE.reset_sink
    add_connection baum_clkmgr.l4_main_clk i_dma_DMASECURE.apb_pclk clock
...
proc hps_instantiate_i_emac_emac1 {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.emac1_clk i_emac_emac1 stmmac

    hps_utils_set_swEnabled i_emac_emac1 $pinmux

    set_instance_parameter_value i_emac_emac1 rx_fifo_depth 16384
    set_instance_parameter_value i_emac_emac1 compatible {altr,socfpga-stmmac snps,dwmac-3.72a snps,dwmac}
...
proc hps_instantiate_mpu_reg_l2_MPUL2 {num_a9s} {
    ...
    hps_utils_add_instance_clk_reset clk_0 mpu_reg_l2_MPUL2 arm_pl310_L2
...
proc hps_instantiate_i_nand_NANDDATA {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_mp_clk i_nand_NANDDATA denali_nand
...
proc hps_instantiate_i_spis_0_spis {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_mp_clk i_spis_0_spis spi
...
proc hps_instantiate_i_sys_mgr_core {num_a9s} {
    ...
    hps_utils_add_instance_clk_reset clk_0 i_sys_mgr_core altera_sysmgr

    set_instance_parameter_value i_sys_mgr_core cpu1_start_addr 0xffd06230
    if {$num_a9s == 0} {
...
proc hps_instantiate_i_gpio_0_gpio {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_mp_clk i_gpio_0_gpio dw-gpio
...
proc hps_instantiate_i_rst_mgr_rstmgr {num_a9s} {
    ...
    hps_utils_add_instance_clk_reset clk_0 i_rst_mgr_rstmgr altera_rstmgr

    set_instance_parameter_value i_rst_mgr_rstmgr offset 0x20
...
proc hps_instantiate_i_spim_1_spim {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.spi_m_clk i_spim_1_spim spi
...
proc hps_instantiate_i_watchdog_1_l4wd {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sys_free_clk i_watchdog_1_l4wd dw_wd_timer
...
proc hps_instantiate_i_timer_sys_0_timer {num_a9s} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sys_free_clk i_timer_sys_0_timer dw_apb_timer_osc
...
proc hps_instantiate_i_uart_1_uart {num_a9s pinmux} {
    ...
    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.l4_sp_clk i_uart_1_uart snps_uart
...
proc hps_instantiate_baum_timer {num_a9s} {

    hps_utils_add_instance_reset_clk clk_0 baum_clkmgr.mpu_periph_clk timer arm_internal_timer
...
proc hps_baum_scu_base {} {return 0xffffc000}
proc hps_instantiate_baum_scu {num_a9s} {
    ...
    hps_utils_add_slave_interface arm_a9_0.altera_axi_master scu.axi_slave0 [hps_baum_scu_base]
    
    if {$num_a9s > 1} {
    	hps_utils_add_slave_interface arm_a9_1.altera_axi_master scu.axi_slave0 [hps_baum_scu_base]
    }
}

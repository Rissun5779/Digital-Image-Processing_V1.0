...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL altera_vic_priority
add_fileset_file altera_vic_priority.sv SYSTEM_VERILOG PATH altera_vic_priority.sv
add_fileset_file altera_vic_compare2.sv SYSTEM_VERILOG PATH altera_vic_compare2.sv
add_fileset_file altera_vic_compare4.sv SYSTEM_VERILOG PATH altera_vic_compare4.sv

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL altera_vic_priority
add_fileset_file altera_vic_priority.sv SYSTEM_VERILOG PATH altera_vic_priority.sv
add_fileset_file altera_vic_compare2.sv SYSTEM_VERILOG PATH altera_vic_compare2.sv
add_fileset_file altera_vic_compare4.sv SYSTEM_VERILOG PATH altera_vic_compare4.sv

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL altera_vic_priority
add_fileset_file altera_vic_priority.sv SYSTEM_VERILOG PATH altera_vic_priority.sv
add_fileset_file altera_vic_compare2.sv SYSTEM_VERILOG PATH altera_vic_compare2.sv
add_fileset_file altera_vic_compare4.sv SYSTEM_VERILOG PATH altera_vic_compare4.sv
...
add_parameter PRIORITY_LATENCY INTEGER 3
set_parameter_property PRIORITY_LATENCY DISPLAY_NAME PRIORITY_LATENCY
set_parameter_property PRIORITY_LATENCY UNITS None
set_parameter_property PRIORITY_LATENCY ALLOWED_RANGES 0:3
set_parameter_property PRIORITY_LATENCY DISPLAY_HINT ""
set_parameter_property PRIORITY_LATENCY AFFECTS_GENERATION false
set_parameter_property PRIORITY_LATENCY IS_HDL_PARAMETER true

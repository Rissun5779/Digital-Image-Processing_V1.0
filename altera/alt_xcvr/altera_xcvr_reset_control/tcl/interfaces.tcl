...
namespace eval ::altera_xcvr_reset_control::interfaces:: {
  ...
  set interfaces {\
    ...
    {pll_locked         input     PLLS                pll_locked          l_terminate_tx        NOVAL             gui_split_interfaces  PLLS        1                   pll_locked          conduit     end             true    ::altera_xcvr_reset_control::interfaces::elaborate_direction  }\
    ...
    {pll_cal_busy       input     PLLS                pll_cal_busy        "!gui_pll_cal_busy || l_terminate_tx" NOVAL gui_split_interfaces PLLS     1                   pll_cal_busy        conduit     end             true    ::altera_xcvr_reset_control::interfaces::elaborate_direction  }\

...
package altera_xcvr_native_s10_functions_h;
    ...
    function [3:0] get_mcgb_location_alt_xcvr_native_s10(
      input integer pcs_bonding_master,
      input integer channel_index
    );
      integer distance;
      begin
        if (channel_index < pcs_bonding_master) begin
           ...
           get_mcgb_location_alt_xcvr_native_s10 = {1'b1,distance[2:0]};
        end else begin
           distance = channel_index-pcs_bonding_master;
           get_mcgb_location_alt_xcvr_native_s10 = {1'b0,distance[2:0]};
        end
      end
    endfunction

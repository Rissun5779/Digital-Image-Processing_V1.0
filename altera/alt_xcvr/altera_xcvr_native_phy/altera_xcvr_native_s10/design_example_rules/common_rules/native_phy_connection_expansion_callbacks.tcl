...
package provide altera_xcvr_native_s10::design_example_rules::common_rules::native_phy_connection_expansion_callbacks 18.1

package require alt_xcvr::de_tcl::de_api

namespace eval ::altera_xcvr_native_s10::design_example_rules::common_rules::native_phy_connection_expansion_callbacks:: {
...
##################################################################
proc ::altera_xcvr_native_s10::design_example_rules::common_rules::native_phy_connection_expansion_callbacks::ExpandCommon_UseSourceSuffix_UseTargetSuffix { connection_name } {
  ExpandCommon $connection_name 1 1
}
proc ::altera_xcvr_native_s10::design_example_rules::common_rules::native_phy_connection_expansion_callbacks::ExpandCommon_UseSourceSuffix_NoTargetSuffix  { connection_name } {
  ExpandCommon $connection_name 1 0
}
proc ::altera_xcvr_native_s10::design_example_rules::common_rules::native_phy_connection_expansion_callbacks::ExpandCommon_NoSourceSuffix_UseTargetSuffix  { connection_name } {
  ExpandCommon $connection_name 0 1
}
proc ::altera_xcvr_native_s10::design_example_rules::common_rules::native_phy_connection_expansion_callbacks::ExpandCommon_NoSourceSuffix_NoTargetSuffix   { connection_name } {
  ExpandCommon $connection_name 0 0
}

##################################################################
proc ::altera_xcvr_native_s10::design_example_rules::common_rules::native_phy_connection_expansion_callbacks::ExpandCommon { connection_name use_source_suffix use_target_suffix } {
...
##################################################################
proc ::altera_xcvr_native_s10::design_example_rules::common_rules::native_phy_connection_expansion_callbacks::GetSplittedConnections {source_connection target_connection number_of_channels source_suffix target_suffix use_source_suffix use_target_suffix} {

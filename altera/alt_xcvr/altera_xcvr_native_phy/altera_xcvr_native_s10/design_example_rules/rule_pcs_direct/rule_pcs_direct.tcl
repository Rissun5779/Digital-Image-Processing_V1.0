...
package provide altera_xcvr_native_s10::design_example_rules::rule_pcs_direct 18.1
...
package require altera_xcvr_native_s10::design_example_rules::common_rules::rule_x1x2_if_adapter_par
package require altera_xcvr_native_s10::design_example_rules::common_rules::rule_x1x2_if_adapter_con

package require altera_xcvr_native_s10::design_example_rules::common_rules::rule_export_interfaces

namespace eval ::altera_xcvr_native_s10::design_example_rules::rule_pcs_direct:: {
  namespace export declare_rule  
}


proc ::altera_xcvr_native_s10::design_example_rules::rule_pcs_direct::declare_rule { } {
  ...
  set instances {\
    ...
    { "x1x2_if_adapter_inst"          "alt_xcvr_x1x2_if_adapter"                                                                                                                                        "## EXPRESSION \"(native_phy_ref.enable_double_rate_transfer)\""            }\
  }
  ...
  set subRules {\
    ...
    { x1x2_if_adapter_inst_par_rule        ::altera_xcvr_native_s10::design_example_rules::common_rules::rule_x1x2_if_adapter_par      "## EXPRESSION \"(native_phy_ref.enable_double_rate_transfer)\"" {native_phy_ref "native_phy_ref"        x1x2_if_adapter_ref "x1x2_if_adapter_inst"} }\
      \
    ...
    { parl_clk_dist_con_rule               ::altera_xcvr_native_s10::design_example_rules::common_rules::rule_parl_clk_dist_con        1                                                                {tx_native_phy_ref "tx_native_phy_ref"  rx_native_phy_ref "rx_native_phy_ref"        data_generator_ref "data_generator_inst"   data_checker_ref "data_checker_inst"  protocol_tester_ref "protocol_tester_inst"        x1x2_if_adapter_ref "x1x2_if_adapter_inst"} }\
    ...
    { x1x2_if_adapter_inst_con_rule        ::altera_xcvr_native_s10::design_example_rules::common_rules::rule_x1x2_if_adapter_con      "## EXPRESSION \"(native_phy_ref.enable_double_rate_transfer)\"" {tx_native_phy_ref "tx_native_phy_ref"  rx_native_phy_ref "rx_native_phy_ref"   x1x2_if_adapter_ref "x1x2_if_adapter_inst"   data_generator_ref "data_generator_inst"        data_checker_ref "data_checker_inst"       protocol_tester_ref "protocol_tester_inst"      reset_controller_ref "rst_ctr_inst"     } }\
    { export_interfaces_rule               ::altera_xcvr_native_s10::design_example_rules::common_rules::rule_export_interfaces        1                                                                {tx_native_phy_ref "tx_native_phy_ref"  rx_native_phy_ref "rx_native_phy_ref"   pll_ref "pll_inst"                           reset_controller_ref "rst_ctr_inst"             reset_sync_ref "reset_sync_inst"           protocol_tester_ref "protocol_tester_inst"      frequency_checker_txclkout_ref "freq_check_txclkout_inst"  frequency_checker_rxclkout_ref "freq_check_rxclkout_inst" } }\
  }                 

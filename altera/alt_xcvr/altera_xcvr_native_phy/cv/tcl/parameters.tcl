...
package provide altera_xcvr_native_cv::parameters 18.1
...
namespace eval ::altera_xcvr_native_cv::parameters:: {
  ...
  set parameters {\
    ...
    \
    {std_rx_rmfifo_enable                   false   true          INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Rate Match FIFO"                         "Enable RX rate match FIFO"                             ::altera_xcvr_native_cv::parameters::validate_std_rx_rmfifo_enable                "Enables the RX rate match FIFO in the 'Standard PCS'.Rate match FIFO is valid in Standard PCS duplex mode so make sure to enable Standard PCS 'TX Datapath' and 'RX Datapath' options."}\
...
proc ::altera_xcvr_native_cv::parameters::validate_std_rx_rmfifo_enable {std_rx_rmfifo_enable l_enable_rx_std enable_std l_enable_tx_std std_protocol_hint std_pcs_pma_width std_rx_word_aligner_mode std_low_latency_bypass_enable} {

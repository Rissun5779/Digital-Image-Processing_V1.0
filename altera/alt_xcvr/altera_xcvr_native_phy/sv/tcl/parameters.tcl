...
package provide altera_xcvr_native_sv::parameters 18.1
...
namespace eval ::altera_xcvr_native_sv::parameters:: {
  ...
  set parameters {\
    ...
    {rx_clkslip_enable                      false   true          INTEGER   0                               NOVAL                                                                     rx_enable                           rx_enable                             boolean       NOVAL         "PMA Optional Ports"                          "Enable rx_clkslip port"                            NOVAL                                                                             NOVAL     "Enables the optional rx_clkslip control input port. The deserializer slips one clock edge each time this signal is asserted. This is an asynchronous input signal."}\
    ...
    \
    {std_rx_rmfifo_enable                   false   true          INTEGER   0                               NOVAL                                                                     l_enable_rx_std                     l_enable_rx_std                       boolean       NOVAL         "Rate Match FIFO"                             "Enable RX rate match FIFO"                             ::altera_xcvr_native_sv::parameters::validate_std_rx_rmfifo_enable                NOVAL     "Enables the RX rate match FIFO in the 'Standard PCS. Rate match FIFO is valid in Standard PCS duplex mode so make sure to enable Standard PCS 'TX Datapath' and 'RX Datapath' options."}\
    ...
    {enable_port_rx_std_signaldetect        false   false         INTEGER   0                               NOVAL                                                                     l_enable_rx_std                     l_enable_rx_std                       boolean       NOVAL         "Bit Reversal and Polarity Inversion"         "Enable rx_std_signaldetect port"                       NOVAL                                                                             NOVAL     "Enables the optional rx_std_signaldetect status output port. The assertion of this signal indicates that a signal has been detected on the receiver. The signal detect threshold can be specified through Quartus Prime QSF assignments."}\
    \
...
proc ::altera_xcvr_native_sv::parameters::validate_std_rx_rmfifo_enable {std_rx_rmfifo_enable l_enable_rx_std enable_std l_enable_tx_std std_protocol_hint std_pcs_pma_width std_rx_word_aligner_mode std_low_latency_bypass_enable} {

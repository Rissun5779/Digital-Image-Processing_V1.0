...
package provide altera_xcvr_native_av::fileset 18.1

package require alt_xcvr::utils::fileset
package require alt_xcvr::ip_tcl::ip_module

namespace eval ::altera_xcvr_native_av::fileset:: {
  ...
  set filesets {\
    ...
    { quartus_synth   QUARTUS_SYNTH   ::altera_xcvr_native_av::fileset::callback_quartus_synth  altera_xcvr_native_av }\
    { sim_verilog     SIM_VERILOG     ::altera_xcvr_native_av::fileset::callback_sim_verilog    altera_xcvr_native_av }\
    { sim_vhdl        SIM_VHDL        ::altera_xcvr_native_av::fileset::callback_sim_vhdl       altera_xcvr_native_av }\
  }

}

proc ::altera_xcvr_native_av::fileset::declare_filesets { } {
  variable filesets
...
proc ::altera_xcvr_native_av::fileset::declare_files {} {
  # AV Core files
...
proc ::altera_xcvr_native_av::fileset::callback_quartus_synth {name} {
  common_add_fileset_files {altera_xcvr_native_av A5 ALL_HDL} {PLAIN QIP}
}

proc ::altera_xcvr_native_av::fileset::callback_sim_verilog {name} {
  common_add_fileset_files {altera_xcvr_native_av A5 ALL_HDL} [concat PLAIN [common_fileset_tags_all_simulators]]
}

proc ::altera_xcvr_native_av::fileset::callback_sim_vhdl {name} {
  common_add_fileset_files {altera_xcvr_native_av A5 ALL_HDL} [concat PLAIN [common_fileset_tags_all_simulators]]
}

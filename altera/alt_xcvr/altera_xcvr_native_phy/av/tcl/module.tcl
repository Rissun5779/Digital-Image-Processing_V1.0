...
package provide altera_xcvr_native_av::module 18.1
...
namespace eval ::altera_xcvr_native_av::module:: {
  ...
  variable module {\
    ...
    {altera_xcvr_native_av  18.1  true      false       false     ::altera_xcvr_native_av::module::elaborate  ::altera_xcvr_native_av::parameters::upgrade  "Arria V Transceiver Native PHY Intel FPGA IP"  "Interface Protocols/Transceiver PHY" "Intel Corporation"  NOVAL       "http://www.altera.com/literature/ug/xcvr_user_guide.pdf" "Arria V Transceiver Native PHY."}\
  }
}

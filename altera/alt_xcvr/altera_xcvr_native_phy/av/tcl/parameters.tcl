...
package provide altera_xcvr_native_av::parameters 18.1
...
namespace eval ::altera_xcvr_native_av::parameters:: {
  ...
  set package_name "altera_xcvr_native_av::parameters"
  ...
  set parameters {\
    ...
    {show_advanced_features                 false   false         INTEGER   0                               NOVAL                                                        false                                  false                       boolean       NOVAL         NOVAL                                     "Show advanced features"                                ::altera_xcvr_native_av::parameters::validate_show_advanced_features              NOVAL}\
    \
    ...
    {rx_enable                              false   true          INTEGER   1                               NOVAL                                                        true                                   true                        boolean       NOVAL         "Datapath Options"                        "Enable RX datapath"                                   ::altera_xcvr_native_av::parameters::validate_rx_enable                           "When selected, the core includes the RX (receive) datapath"}\
    {enable_std                             false   true          INTEGER   0                               NOVAL                                                        true                                   true                        boolean       NOVAL         "Datapath Options"                        "Enable Standard PCS"                                   ::altera_xcvr_native_av::parameters::validate_enable_std                          "Enables the 'Standard PCS' datapath. This option must be enabled if you intend to statically use the 'Standard PCS'. The 'pma_direct' datapath cannot be used when this option is enabled and dynamic reconfiguration between 'pma_direct' and PCS modes is not supported by the device. Refer to the device handbook for details on features supported by the 'Standard PCS'."}\
    {set_data_path_select                   false   false         STRING    "standard"                      {standard}                                                   enable_std                             true                        NOVAL         NOVAL         "Datapath Options"                        "Initial PCS datapath selection"                        NOVAL                                                                             "Specifies the initial datapath for this configuration of the core.'standard':Selects the 'Standard PCS' as the initially selected datapath."}\
    {data_path_select                       true    true          STRING    "pma_direct"                    {pma_direct standard}                                        true                                   false                       NOVAL         NOVAL         "Datapath Options"                        NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_data_path_select                    NOVAL}\
    {channels                               false   true          INTEGER   1                               NOVAL                                                        true                                   true                        NOVAL         NOVAL         "Datapath Options"                        "Number of data channels"                               ::altera_xcvr_native_av::parameters::validate_channels                            "Specifies the total number of data channels."}\
    ...
    {enable_simple_interface                false   false         INTEGER   0                               NOVAL                                                        true                                   true                        boolean       NOVAL         "Datapath Options"                        "Enable simplified data interface"                      ::altera_xcvr_native_av::parameters::validate_enable_simple_interface             "When selected, the IP will present a simplified data and control interface between the FPGA and transceiver. When not selected, the IP will present the full raw data interface to the transceiver. You will need to understand the mapping of data and control signals within the interface. This option cannot be enabled if you want to perform dynamic interface reconfiguration as only a fixed subset of the data and control signals will be provided."}\
    \
    {set_data_rate                          false   false         STRING    "4000"                          NOVAL                                                        true                                   true                        "columns:10"  Mbps          "PMA"                                     "Data rate"                                             ::altera_xcvr_native_av::parameters::validate_set_data_rate                       "Specifies the transceiver data rate in units of Mbps (megabits per second)."}\
    {data_rate                              true    true          STRING    NOVAL                           NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_data_rate                           NOVAL}\
    {pma_width                              true    true          INTEGER   80                              NOVAL                                                        true                                   false                       NOVAL         NOVAL         "PMA"                                     "PCS / PMA interface width"                             ::altera_xcvr_native_av::parameters::validate_pma_width                           NOVAL}\
    {pma_direct_width                       false   false         INTEGER   80                              {8 10 16 20 64 80}                                           true                                   true                        NOVAL         NOVAL         "PMA"                                     "PMA direct interface width"                            ::altera_xcvr_native_av::parameters::validate_pma_direct_width                    "Specifies the width of the datapath that connects the FPGA fabric to the PMA for 'pma_direct' mode."}\
    ...
    {base_data_rate                         true    false         STRING    "4000"                          NOVAL                                                        tx_enable                              tx_enable                   "columns:10"  Mbps          "PMA"                                     "TX PLL base data rate"                                 ::altera_xcvr_native_av::parameters::validate_base_data_rate                      "The calculated PLL base data rate (Date rate * local clock division factor). The configured base data rate for the selected TX PLL must match this value."}\
    {pll_reconfig_enable                    false   true          INTEGER   0                               NOVAL                                                        tx_enable                              tx_enable                   boolean       NOVAL         "TX PMA"                                  "Enable TX PLL dynamic reconfiguration"                 ::altera_xcvr_native_av::parameters::validate_pll_reconfig_enable                 "Enabling this option has two effects: 1-The simulation model for the TX PLL will include support for dynamic reconfiguration. 2-Quartus will not merge the TX PLLs by default. Merging can be manually controlled through QSF assignments. Dynamic reconfiguration includes reference clock switching and data rate reconfiguration. Dynamic reconfiguration of ATX PLLs is not supported in the current release."}\
    ...
    {pll_data_rate                          true    true          STRING    "0 Mbps"                        NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_pll_data_rate                       NOVAL}\
    {pll_type                               true    true          STRING    "CMU"                           NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_pll_type                            NOVAL}\
    {pma_bonding_mode                       true    true          STRING    "x1"                            NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_pma_bonding_mode                    NOVAL       } \
    {plls                                   false   true          INTEGER   1                               {1 2 3 4}                                                    tx_enable                              tx_enable                   NOVAL         NOVAL         "TX PMA"                                  "Number of TX PLLs"                                     ::altera_xcvr_native_av::parameters::validate_plls                                "Specifies the desired number of TX PLLs to use for dynamic PLL switching. The number of logical TX PLLs created in the netlist depends on the number of channels and selected TX bonding method."}\
    {pll_select                             false   true          INTEGER   0                               {0}                                                          tx_enable                              tx_enable                   NOVAL         NOVAL         "TX PMA"                                  "Main TX PLL logical index"                             ::altera_xcvr_native_av::parameters::validate_pll_select                          "Specifies the initially selected TX PLL."}\
    {pll_refclk_cnt                         false   true          INTEGER   1                               {1 2 3 4 5}                                                  tx_enable                              tx_enable                   NOVAL         NOVAL         "TX PMA"                                  "Number of TX PLL reference clocks"                     ::altera_xcvr_native_av::parameters::validate_pll_refclk_cnt                      "Specifies the number of input reference clocks for the TX PLLs. The same bus of reference clocks will feed all TX PLLs in the netlist."}\
    {pll_refclk_select                      true    true          STRING    "0"                             NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_pll_refclk_select                   NOVAL}\
    {pll_refclk_freq                        true    true          STRING    "125.0 MHz"                     NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_pll_refclk_freq                     NOVAL}\
    ...
    {cdr_refclk_select                      false   true          INTEGER   0                               {0}                                                          rx_enable                              rx_enable                   NOVAL         NOVAL         "RX PMA"                                  "Selected CDR reference clock"                          ::altera_xcvr_native_av::parameters::validate_cdr_refclk_select                   "Specifies the initially selected reference clock input to the RX CDRs."}\
    {cdr_refclk_freq                        true    true          STRING    NOVAL                           NOVAL                                                        rx_enable                              false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_cdr_refclk_freq                     NOVAL}\
    {set_cdr_refclk_freq                    false   false         STRING    "125.0 MHz"                     NOVAL                                                        rx_enable                              rx_enable                   NOVAL         NOVAL         "RX PMA"                                  "Selected CDR reference clock frequency"                ::altera_xcvr_native_av::parameters::validate_set_cdr_refclk_freq                 "Specifies the frequency in Mbps of the selected reference clock input to the CDR."}\
    ...
    {rx_clkslip_enable                      false   true          INTEGER   0                               NOVAL                                                        rx_enable                              rx_enable                   boolean       NOVAL         "RX PMA"                                  "Enable rx_clkslip port"                            NOVAL                                                                             "Enables the optional rx_clkslip control input port. The deserializer slips one clock edge each time this signal is asserted. This is an asynchronous input signal."}\
    ...
    {enable_port_rx_seriallpbken            false   false         INTEGER   0                               NOVAL                                                        true                                   true                        boolean       NOVAL         "RX PMA"                                  "Enable rx_seriallpbken port"                           ::altera_xcvr_native_av::parameters::validate_enable_port_rx_seriallpbken         "When you enable this option, the rx_seriallpbken port is provided as an input. This signal enables the TX to RX serial loopback path within the transceiver. This is an asynchronous input signal."}\
    \
    ...
    {std_pcs_pma_width                      false   true          INTEGER   10                              {8 10 16 20}                                                 enable_std                             enable_std                  NOVAL         NOVAL         "Standard PCS"                            "Standard PCS / PMA interface width"                    ::altera_xcvr_native_av::parameters::validate_std_pcs_pma_width                   "Specifies the data interface width between the 'Standard PCS' and the transceiver PMA."}\
    {std_tx_pld_pcs_width                   true    false         INTEGER   NOVAL                           NOVAL                                                        l_enable_tx_std                        l_enable_tx_std             NOVAL         NOVAL         "Standard PCS"                            "FPGA fabric / Standard TX PCS interface width"         ::altera_xcvr_native_av::parameters::validate_std_tx_pld_pcs_width                "Indicates the data inerface width between the Standard TX PCS and the FPGA fabric. This value is determined by the current configuration of individual blocks within the Standard TX PCS."}\
    {std_rx_pld_pcs_width                   true    false         INTEGER   NOVAL                           NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             NOVAL         NOVAL         "Standard PCS"                            "FPGA fabric / Standard RX PCS interface width"         ::altera_xcvr_native_av::parameters::validate_std_rx_pld_pcs_width                "Indicates the data inerface width between the Standard RX PCS and the FPGA fabric. This value is determined by the current configuration of individual blocks within the Standard RX PCS."}\
    {std_low_latency_bypass_enable          false   true          INTEGER   0                               NOVAL                                                        enable_std                             enable_std                  boolean       NOVAL         "Standard PCS"                            "Enable 'Standard PCS' low latency mode"                ::altera_xcvr_native_av::parameters::validate_std_low_latency_bypass_enable       "Enables the low latency path for the 'Standard PCS'. Enabling this option will bypass the individual functional blocks within the 'Standard PCS' to provide the lowest latency datapath from the PMA through the 'Standard PCS'."}\
    \
    {std_tx_pcfifo_mode                     false   true          STRING    "low_latency"                   {low_latency register_fifo}                                  l_enable_tx_std                        l_enable_tx_std             NOVAL         NOVAL         "Phase Compensation FIFO"                 "TX FIFO mode"                                          ::altera_xcvr_native_av::parameters::validate_std_tx_pcfifo_mode                  "Specifies the mode for the 'Standard PCS' TX FIFO."}\
    {std_rx_pcfifo_mode                     false   true          STRING    "low_latency"                   {low_latency register_fifo}                                  l_enable_rx_std                        l_enable_rx_std             NOVAL         NOVAL         "Phase Compensation FIFO"                 "RX FIFO mode"                                          ::altera_xcvr_native_av::parameters::validate_std_rx_pcfifo_mode                  "Specifies the mode for the 'Standard PCS' RX FIFO."}\
    ...
    \
    {std_tx_byte_ser_enable                 false   true          INTEGER   0                               NOVAL                                                        l_enable_tx_std                        l_enable_tx_std             boolean       NOVAL         "Byte Serializer and Deserializer"        "Enable TX byte serializer"                             ::altera_xcvr_native_av::parameters::validate_std_tx_byte_ser_enable              "Enables the TX byte serializer in the 'Standard PCS'. The transceiver architecture allows the 'Standard PCS' to operate at double the data width of the PMA serializer. This allows the PCS to run at a lower internal clock frequency and accommodate a wider range of FPGA interface widths."}\
    {std_rx_byte_deser_enable               false   true          INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Byte Serializer and Deserializer"        "Enable RX byte deserializer"                           ::altera_xcvr_native_av::parameters::validate_std_rx_byte_deser_enable            "Enables the RX byte deserializer in the 'Standard PCS' The transceiver architecture allows the 'Standard PCS' to operate at double the data width of the PMA deserializer. This allows the PCS to run at a lower internal clock frequency and accommodate a wider range of FPGA interface widths."}\
    \
    {std_tx_8b10b_enable                    false   true          INTEGER   0                               NOVAL                                                        l_enable_tx_std                        l_enable_tx_std             boolean       NOVAL         "8B/10B Encoder and Decoder"              "Enable TX 8b/10b encoder"                               ::altera_xcvr_native_av::parameters::validate_std_tx_8b10b_enable                 "Enables the 8b10b encoder in the 'Standard PCS'."}\
    {std_tx_8b10b_disp_ctrl_enable          false   true          INTEGER   0                               NOVAL                                                        l_enable_tx_std                        l_enable_tx_std             boolean       NOVAL         "8B/10B Encoder and Decoder"              "Enable TX 8b/10b disparity control"                     ::altera_xcvr_native_av::parameters::validate_std_tx_8b10b_disp_ctrl_enable       "Enables disparity control for the 8b/10b encoder. This allows you to force the disparity of the 8b/10b encoder via the 'tx_forcedisp' control signal."}\
    {std_rx_8b10b_enable                    false   true          INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "8B/10B Encoder and Decoder"              "Enable RX 8b/10b decoder"                               ::altera_xcvr_native_av::parameters::validate_std_rx_8b10b_enable                 "Enables the 8b10b decoder in the 'Standard PCS'."}\
    \
    {std_rx_rmfifo_enable                   false   true          INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Rate Match FIFO"                         "Enable RX rate match FIFO"                             ::altera_xcvr_native_av::parameters::validate_std_rx_rmfifo_enable                "Enables the RX rate match FIFO in the 'Standard PCS'.Rate match FIFO is valid in Standard PCS duplex mode so make sure to enable Standard PCS 'TX Datapath' and 'RX Datapath' options."}\
    {std_rx_rmfifo_pattern_p                false   true          STRING    "00000"                         NOVAL                                                        std_rx_rmfifo_enable                   l_enable_rx_std             NOVAL         NOVAL         "Rate Match FIFO"                         "RX rate match insert/delete +ve pattern (hex)"         ::altera_xcvr_native_av::parameters::validate_std_rx_rmfifo_pattern_p             "Specifies the +ve (positive) disparity value for the RX rate match FIFO. The value is 20-bits and specified as a hexadecimal string."}\
    {std_rx_rmfifo_pattern_n                false   true          STRING    "00000"                         NOVAL                                                        std_rx_rmfifo_enable                   l_enable_rx_std             NOVAL         NOVAL         "Rate Match FIFO"                         "RX rate match insert/delete -ve pattern (hex)"         ::altera_xcvr_native_av::parameters::validate_std_rx_rmfifo_pattern_n             "Specifies the -ve (negative) disparity value for the RX rate match FIFO. The value is 20-bits and specified as a hexadecimal string."}\
    ...
    \
    {std_tx_bitslip_enable                  false   true          INTEGER   0                               NOVAL                                                        l_enable_tx_std                        l_enable_tx_std             boolean       NOVAL         "Word Aligner and Bitslip"                "Enable TX bitslip"                                     ::altera_xcvr_native_av::parameters::validate_std_tx_bitslip_enable               "Enable TX bitslip support. When enabled, the outgoing transmit data can be slipped a specific number of bits as specified by the 'tx_bitslipboundarysel' control signal."}\
    ...
    {std_rx_word_aligner_mode               false   true          STRING    "bit_slip"                      {bit_slip sync_sm manual}                                    l_enable_rx_std                        l_enable_rx_std             NOVAL         NOVAL         "Word Aligner and Bitslip"                "RX word aligner mode"                                  ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_mode            "Specifies the RX word aligner mode for the 'Standard PCS'."}\
    {std_rx_word_aligner_pattern_len        false   true          INTEGER   7                               {7 8 10 16 20 32 40}                                         l_enable_rx_std_word_aligner           l_enable_rx_std             NOVAL         NOVAL         "Word Aligner and Bitslip"                "RX word aligner pattern length"                        ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_pattern_len     "Specifies the RX word alignment pattern length."}\
    {std_rx_word_aligner_pattern            false   true          STRING    "0000000000"                    NOVAL                                                        l_enable_rx_std_word_aligner           l_enable_rx_std             NOVAL         NOVAL         "Word Aligner and Bitslip"                "RX word aligner pattern (hex)"                         ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_pattern         "Specifies the RX word alignment pattern."}\
    {std_rx_word_aligner_rknumber           false   true          INTEGER   3                               "0:255"                                                      l_enable_rx_std_word_aligner           l_enable_rx_std             NOVAL         NOVAL         "Word Aligner and Bitslip"                "Number of word alignment patterns to achieve sync."    ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_rknumber        "Specifies the number of valid word alignment patterns that must be received before the word aligner achieves sync lock."}\
    {std_rx_word_aligner_renumber           false   true          INTEGER   3                               "0:63"                                                       l_enable_rx_std_word_aligner           l_enable_rx_std             NOVAL         NOVAL         "Word Aligner and Bitslip"                "Number of invalid data words to lose sync."            ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_renumber        "Specifies the number of invalid data codes or disparity errors that must be received before the word aligner loses sync lock."}\
    {std_rx_word_aligner_rgnumber           false   true          INTEGER   3                               "0:255"                                                      l_enable_rx_std_word_aligner           l_enable_rx_std             NOVAL         NOVAL         "Word Aligner and Bitslip"                "Number of valid data words to decrement error count."  ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_rgnumber        "Specifies the number of valid data codes that must be received to decrement the error counter. If enough valid data codes are received to decrement the error count to zero, the word aligner will return to sync lock."}\
    {std_rx_run_length_val                  false   true          INTEGER   31                              "0:63"                                                       l_enable_rx_std_word_aligner           l_enable_rx_std             NOVAL         NOVAL         "Word Aligner and Bitslip"                "Run length detector word count"                        ::altera_xcvr_native_av::parameters::validate_std_rx_run_length_val               "Specifies the number of consecutive received words from the PMA containing no 1>0 or 0>1 transitions that will trigger a run length violation."}\
    ...
    {enable_port_rx_std_bitslip             false   false         INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Word Aligner and Bitslip"                "Enable rx_std_bitslip port"                            ::altera_xcvr_native_av::parameters::validate_enable_port_rx_std_bitslip          "Enables the optional rx_std_bitslip control input port. The rising-edge assertion of this port will cause a single bit slip in the received RX parallel data. The signal should be held high for at least three RX parallel clock cycles and must be deasserted before performing another bit slip. This signal has no effect when the PCS is configured in low latency mode."}\
    ...
    \
    {std_tx_bitrev_enable                   false   true          INTEGER   0                               NOVAL                                                        l_enable_tx_std                        l_enable_tx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable TX bit reversal"                                ::altera_xcvr_native_av::parameters::validate_std_tx_bitrev_enable                "Enables transmitter bit order reversal. When enabled the TX parallel data will be reversed before passing to the PMA for serialization. When bit reversal is activated, the transmitted TX data bit order flipped to MSB->LSB rather than the normal LSB->MSB. This is a static setting and can only be dynamically changed through dynamic reconfiguration."}\
    {std_rx_bitrev_enable                   false   true          INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable RX bit reversal"                                ::altera_xcvr_native_av::parameters::validate_std_rx_bitrev_enable                "Enables receiver bit order reversal. When enabled, the 'rx_std_bitrev_ena' control port controls bit reversal of the RX parallel data after passing from the PMA to the PCS. When bit reversal is activated, the received RX data bit order is flipped to MSB->LSB rather than the normal LSB->MSB"}\
    {std_tx_byterev_enable                  false   true          INTEGER   0                               NOVAL                                                        l_enable_tx_std                        l_enable_tx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable TX byte reversal"                               ::altera_xcvr_native_av::parameters::validate_std_tx_byterev_enable               "Enables transmitter byte order reversal. When the PCS / PMA interface width is 16 or 20 bits, the PCS can swap the ordering of the individual 8- or 10-bit words. This option is not allowed under all protocol modes."}\
    {std_rx_byterev_enable                  false   true          INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable RX byte reversal"                               ::altera_xcvr_native_av::parameters::validate_std_rx_byterev_enable               "Enables receiver byte order reversal. When the PCS / PMA interface width is 16 or 20 bits, the PCS can swap the ordering of the individual 8 or 10 bit words. This option is not allowed under all protocol modes."}\
    ...
    {enable_port_rx_std_bitrev_ena          false   false         INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable rx_std_bitrev_ena port"                         ::altera_xcvr_native_av::parameters::validate_enable_port_rx_std_bitrev_ena       "Enables the optional rx_std_bitrev_ena control input port. When receiver bit order reversal is enabled, the assertion of this signal will cause the received RX data bit order to be flipped to MSB->LSB rather than the normal LSB->MSB. This is an asynchronous input signal."}\
    {enable_port_rx_std_byterev_ena         false   false         INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable rx_std_byterev_ena port"                        ::altera_xcvr_native_av::parameters::validate_enable_port_rx_std_byterev_ena      "Enables the optional rx_std_byterev_ena control input port. When receiver byte order reversal is enabled, the assertion of this signal will swap the order of individual 8- or 10-bit words received from the PMA."}\
    {enable_port_tx_std_polinv              false   false         INTEGER   0                               NOVAL                                                        l_enable_tx_std                        l_enable_tx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable tx_std_polinv port"                             ::altera_xcvr_native_av::parameters::validate_enable_port_tx_std_polinv           "Enables the optional tx_std_polinv control input port. When TX bit polarity inversion is enabled, the assertion of this signal will cause the TX bit polarity to be inverted."}\
    {enable_port_rx_std_polinv              false   false         INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable rx_std_polinv port"                             ::altera_xcvr_native_av::parameters::validate_enable_port_rx_std_polinv           "Enables the optional rx_std_polinv control input port. When RX bit polarity inversion is enabled, the assertion of this signal will cause the RX bit polarity to be inverted."}\
    ...
    {enable_port_rx_std_signaldetect        false   false         INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Bit Reversal and Polarity Inversion"     "Enable rx_std_signaldetect port"                       NOVAL                                                                             "Enables the optional rx_std_signaldetect status output port. The assertion of this signal indicates that a signal has been detected on the receiver. The signal detect threshold can be specified through Quartus Prime QSF assignments."}\
    \
    {enable_port_rx_std_prbs_status         false   false         INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "PRBS Verifier"                           "Enable rx_std_prbs ports"                              NOVAL                                                                             "Enables the optional rx_std_prbs_err and rx_std_prbs_done status ports. PRBS can only be enabled through Dynamic Reconfiguration.  rx_std_prbs_done will assert after correctly receiving PRBS patterns, but it does not imply the test is complete. rx_std_prbs_err will pulse for each mismatch in the PRBS verifier.  Refer to the user guide for more details."}\
    \
    {l_pll_settings                         true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_pll_settings                      NOVAL}\
    {l_enable_tx_pma_direct                 true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_enable_tx_pma_direct              NOVAL}\
    {l_enable_rx_pma_direct                 true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_enable_rx_pma_direct              NOVAL}\
    {l_enable_tx_std                        true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_enable_tx_std                     NOVAL}\
    {l_enable_rx_std                        true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_enable_rx_std                     NOVAL}\
    {l_enable_rx_std_word_aligner           true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_enable_rx_std_word_aligner        NOVAL}\
    {l_netlist_plls                         true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_netlist_plls                      NOVAL}\
    {l_rcfg_interfaces                      true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_rcfg_interfaces                   NOVAL}\
    {l_rcfg_to_xcvr_width                   true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_rcfg_to_xcvr_width                NOVAL}\
    {l_rcfg_from_xcvr_width                 true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_rcfg_from_xcvr_width              NOVAL}\
    {l_pma_direct_word_count                true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_pma_direct_word_count             NOVAL}\
    {l_pma_direct_word_width                true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_pma_direct_word_width             NOVAL}\
    {l_std_tx_word_count                    true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_std_tx_word_count                 NOVAL}\
    {l_std_tx_word_width                    true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_std_tx_word_width                 NOVAL}\
    {l_std_tx_field_width                   true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_std_tx_field_width                NOVAL}\
    {l_std_rx_word_count                    true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_std_rx_word_count                 NOVAL}\
    {l_std_rx_word_width                    true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_std_rx_word_width                 NOVAL}\
    {l_std_rx_field_width                   true    false         INTEGER   0                               NOVAL                                                        true                                   false                       NOVAL         NOVAL         NOVAL                                     NOVAL                                                   ::altera_xcvr_native_av::parameters::validate_l_std_rx_field_width                NOVAL}\
  }
...
proc ::altera_xcvr_native_av::parameters::declare_parameters { {device_family "Arria V"} } {
  variable display_items
  variable parameters
...
proc ::altera_xcvr_native_av::parameters::validate {} {
  ::alt_xcvr::ip_tcl::messages::set_auto_message_level [ip_get "parameter.message_level.value"]
  ip_validate_parameters
}


proc ::altera_xcvr_native_av::parameters::upgrade {ip_name version old_params} {
  variable parameter_upgrade_map
...
proc ::altera_xcvr_native_av::parameters::validate_show_advanced_features { show_advanced_features } {
#  set visible false
...
proc ::altera_xcvr_native_av::parameters::validate_channels { device_family channels tx_enable bonded_mode pll_external_enable l_pll_settings pll_select } {
  set main_pll_type [::alt_xcvr::gui::pll_reconfig::get_pll_type $pll_select]
}


proc ::altera_xcvr_native_av::parameters::validate_rx_enable { tx_enable rx_enable } {
...
proc ::altera_xcvr_native_av::parameters::validate_enable_simple_interface { enable_simple_interface enable_std } {
...
proc ::altera_xcvr_native_av::parameters::validate_pma_bonding_mode { l_pll_settings } {
  ip_set "parameter.pma_bonding_mode.value" [::alt_xcvr::gui::pll_reconfig::get_clk_network_sel_string]
}


proc ::altera_xcvr_native_av::parameters::validate_set_data_rate { set_data_rate device_family device_speedgrade tx_enable rx_enable message_level data_path_select \
    pma_width \
  ...
  if { $data_path_select == "pma_direct" } {
    ...
    if { [expr $set_data_rate < 4000 && $pma_width == 80]} {
      ip_message error "The selected data rate \"$set_data_rate Mbps\" is invalid. The minimum data rate for PLD<->PMA interface width 80bits is 4000Mbps. Please choose a different data rate."
    } elseif { [expr $set_data_rate < 3200 && $pma_width == 64]} {
	  ip_message error "The selected data rate \"$set_data_rate Mbps\" is invalid. The minimum data rate for PLD<->PMA interface width 64bits is 3200Mbps. Please choose a different data rate."
    }  
  } else {
...
proc ::altera_xcvr_native_av::parameters::validate_data_rate { set_data_rate } {
  ip_set "parameter.data_rate.value" "${set_data_rate} Mbps"
}


proc ::altera_xcvr_native_av::parameters::validate_pma_width { data_path_select pma_direct_width std_pcs_pma_width } {
...
proc ::altera_xcvr_native_av::parameters::validate_pma_direct_width { data_path_select } {
  ip_set "parameter.pma_direct_width.visible" [expr {$data_path_select == "pma_direct"}]
}


proc ::altera_xcvr_native_av::parameters::validate_base_data_rate { set_data_rate tx_pma_clk_div } {
  if {[string is double $set_data_rate]} {
...
proc ::altera_xcvr_native_av::parameters::validate_pll_data_rate { l_pll_settings } {
  ip_set "parameter.pll_data_rate.value" [::alt_xcvr::gui::pll_reconfig::get_pll_data_rate_string]
}


proc ::altera_xcvr_native_av::parameters::validate_pll_type { l_pll_settings } {
  ip_set "parameter.pll_type.value" [::alt_xcvr::gui::pll_reconfig::get_pll_type_string]
}


proc ::altera_xcvr_native_av::parameters::validate_plls { tx_enable pll_external_enable bonded_mode plls } {
...
proc ::altera_xcvr_native_av::parameters::validate_pll_select { tx_enable plls pll_select } {
  set allowed_ranges {}
  if {!$tx_enable} {
...
proc ::altera_xcvr_native_av::parameters::validate_pll_reconfig_enable { pll_external_enable } {
  set enable true
...
proc ::altera_xcvr_native_av::parameters::validate_pll_refclk_cnt { pll_external_enable } {
  set visible true
  if {$pll_external_enable} {
     set visible false
  }
...
proc ::altera_xcvr_native_av::parameters::validate_pll_refclk_select { l_pll_settings } {
...
#
# @param l_pll_settings - Placed here merely to force validation of l_pll_settings before this
proc ::altera_xcvr_native_av::parameters::validate_pll_refclk_freq { l_pll_settings } {
...
proc ::altera_xcvr_native_av::parameters::validate_cdr_refclk_select { cdr_refclk_cnt } {
  set allowed_ranges {}
...
proc ::altera_xcvr_native_av::parameters::validate_cdr_refclk_freq { cdr_refclk_cnt cdr_refclk_select set_cdr_refclk_freq } {
  set value ""
  for {set i 0} {$i < $cdr_refclk_cnt} {incr i} {
    if { $i != 0 } {
      set value "${value},"
...
proc ::altera_xcvr_native_av::parameters::validate_set_cdr_refclk_freq { set_cdr_refclk_freq rx_enable device_family device_speedgrade data_rate } {
  set allowed_ranges {}
  if {$rx_enable} {
...
proc ::altera_xcvr_native_av::parameters::validate_enable_port_rx_seriallpbken { tx_enable rx_enable } {
  set enabled false
  if {$tx_enable && $rx_enable} {
    set enabled true    
  }
...
proc ::altera_xcvr_native_av::parameters::validate_l_pll_settings { device_family device_speedgrade tx_enable base_data_rate plls pll_external_enable pll_select pll_refclk_cnt bonded_mode} {
  if { $tx_enable } {
    set max_plls 4
  } else {
    set max_plls 0
...
proc ::altera_xcvr_native_av::parameters::validate_l_enable_tx_pma_direct { tx_enable data_path_select } {
  ip_set "parameter.l_enable_tx_pma_direct.value" [expr {$tx_enable && $data_path_select == "pma_direct"}]
}


proc ::altera_xcvr_native_av::parameters::validate_l_enable_rx_pma_direct { rx_enable data_path_select } {
...
proc ::altera_xcvr_native_av::parameters::validate_l_enable_tx_std { tx_enable enable_std } {
...
# @param rx_enable - Resolved value of the rx_enable parameter
# @param enable_std - Resolved value of the enable_std parameter
proc ::altera_xcvr_native_av::parameters::validate_l_enable_rx_std { rx_enable enable_std } {
  ip_set "parameter.l_enable_rx_std.value" [expr $rx_enable && $enable_std]
}


proc ::altera_xcvr_native_av::parameters::validate_l_enable_rx_std_word_aligner { l_enable_rx_std std_rx_word_aligner_mode } {
  ip_set "parameter.l_enable_rx_std_word_aligner.value" [expr {$l_enable_rx_std && ($std_rx_word_aligner_mode != "bit_slip")}]
}

###
#
proc ::altera_xcvr_native_av::parameters::validate_l_netlist_plls { bonded_mode plls channels } {
  if { $bonded_mode == "xN" } {
...
###
#
proc ::altera_xcvr_native_av::parameters::validate_l_rcfg_interfaces { device_family tx_enable pll_external_enable l_netlist_plls channels } {
...
###
# 
proc ::altera_xcvr_native_av::parameters::validate_l_rcfg_to_xcvr_width { device_family l_rcfg_interfaces } {
...
proc ::altera_xcvr_native_av::parameters::validate_l_rcfg_from_xcvr_width { device_family l_rcfg_interfaces } {
...
proc ::altera_xcvr_native_av::parameters::validate_l_pma_direct_word_count { pma_direct_width } {
...
proc ::altera_xcvr_native_av::parameters::validate_l_pma_direct_word_width { pma_direct_width } {
...
proc ::altera_xcvr_native_av::parameters::validate_l_std_tx_word_count { std_pcs_pma_width std_tx_byte_ser_enable } {
...
proc ::altera_xcvr_native_av::parameters::validate_l_std_tx_word_width { std_tx_pld_pcs_width l_std_tx_word_count } {
  ip_set "parameter.l_std_tx_word_width.value" [expr $std_tx_pld_pcs_width / $l_std_tx_word_count]
}


proc ::altera_xcvr_native_av::parameters::validate_l_std_tx_field_width { std_pcs_pma_width std_tx_byte_ser_enable } {
  set width 11
...
proc ::altera_xcvr_native_av::parameters::validate_l_std_rx_word_count { std_pcs_pma_width std_rx_byte_deser_enable } {
  set count [expr $std_pcs_pma_width <= 10 ? 1 : 2]
...
proc ::altera_xcvr_native_av::parameters::validate_l_std_rx_word_width { std_rx_pld_pcs_width l_std_rx_word_count } {
  ip_set "parameter.l_std_rx_word_width.value" [expr $std_rx_pld_pcs_width / $l_std_rx_word_count]
}


proc ::altera_xcvr_native_av::parameters::validate_l_std_rx_field_width { std_pcs_pma_width std_rx_byte_deser_enable } {
  set width 16
...
#
proc ::altera_xcvr_native_av::parameters::validate_enable_std { enable_std } {
  ip_set "display_item.Standard PCS.visible" [expr {$enable_std ? "true" : "false" }]
}


proc ::altera_xcvr_native_av::parameters::validate_data_path_select { set_data_path_select enable_std } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_pcs_pma_width { std_pcs_pma_width enable_std std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_tx_pld_pcs_width { std_pcs_pma_width std_tx_byte_ser_enable std_tx_8b10b_enable } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_pld_pcs_width { std_pcs_pma_width std_rx_byte_deser_enable std_rx_8b10b_enable } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_low_latency_bypass_enable { std_low_latency_bypass_enable enable_std std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_tx_pcfifo_mode { std_tx_pcfifo_mode l_enable_tx_std std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_pcfifo_mode {std_rx_pcfifo_mode l_enable_rx_std std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_tx_8b10b_enable { std_tx_8b10b_enable l_enable_tx_std std_pcs_pma_width std_low_latency_bypass_enable std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_tx_8b10b_disp_ctrl_enable { std_tx_8b10b_disp_ctrl_enable l_enable_tx_std std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_8b10b_enable { std_rx_8b10b_enable l_enable_rx_std std_pcs_pma_width std_low_latency_bypass_enable std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_rmfifo_enable {std_rx_rmfifo_enable l_enable_rx_std enable_std l_enable_tx_std std_protocol_hint std_pcs_pma_width std_rx_word_aligner_mode std_low_latency_bypass_enable} {
  ...
  auto_invalid_value_message auto std_rx_rmfifo_enable $std_rx_rmfifo_enable $legal_values {std_protocol_hint std_pcs_pma_width std_rx_word_aligner_mode std_low_latency_bypass_enable}
    ...
    if {$enable_std && $std_rx_rmfifo_enable} {
	if {$l_enable_rx_std != 1 || $l_enable_tx_std != 1} {
	    ip_message warning "Rate match FIFO is valid only in Standard PCS duplex mode, Standard PCS TX and RX Datapath must be enabled."
	}
    }
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_rmfifo_pattern_p {std_rx_rmfifo_pattern_p l_enable_rx_std std_protocol_hint std_rx_rmfifo_enable std_rx_word_aligner_mode} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_rmfifo_pattern_n {std_rx_rmfifo_pattern_n l_enable_rx_std std_protocol_hint std_rx_rmfifo_enable std_rx_word_aligner_mode} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_byte_order_enable {std_rx_byte_order_enable l_enable_rx_std std_rx_byte_deser_enable std_low_latency_bypass_enable std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_byte_order_mode {std_rx_byte_order_mode l_enable_rx_std std_rx_byte_order_enable std_rx_word_aligner_mode} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_byte_order_width {std_pcs_pma_width std_rx_8b10b_enable} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_byte_order_symbol_count {std_rx_byte_order_symbol_count l_enable_rx_std std_rx_byte_order_enable std_pcs_pma_width} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_byte_order_pattern {std_rx_byte_order_pattern l_enable_rx_std std_rx_byte_order_enable std_rx_byte_order_width std_rx_byte_order_symbol_count} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_byte_order_pad {std_rx_byte_order_pad l_enable_rx_std std_rx_byte_order_enable std_rx_byte_order_width} {
  if {$l_enable_rx_std && $std_rx_byte_order_enable} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_tx_byte_ser_enable { std_tx_byte_ser_enable l_enable_tx_std std_low_latency_bypass_enable std_pcs_pma_width } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_byte_deser_enable { std_rx_byte_deser_enable l_enable_rx_std std_low_latency_bypass_enable std_pcs_pma_width } {
   # While there is an RBC rule for this parameter, it is irrelevant as it only imposes a restriction for protocol modes that we do not
  # currently support in Native PHY (PIPE, XAUI, PRBS, etc). For the modes currently supported all values are legal.
  set legal_values {0 1}
...
proc ::altera_xcvr_native_av::parameters::validate_std_tx_bitslip_enable {std_tx_bitslip_enable l_enable_tx_std std_protocol_hint} {
...
proc altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_mode {std_rx_word_aligner_mode l_enable_rx_std std_low_latency_bypass_enable std_pcs_pma_width std_protocol_hint std_rx_byte_deser_enable std_rx_pld_pcs_width} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_pattern_len {std_rx_word_aligner_pattern_len l_enable_rx_std std_protocol_hint std_pcs_pma_width std_rx_word_aligner_mode} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_pattern {std_rx_word_aligner_pattern l_enable_rx_std std_rx_word_aligner_mode std_rx_word_aligner_pattern_len} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_rknumber {std_rx_word_aligner_rknumber l_enable_rx_std std_rx_word_aligner_mode std_protocol_hint} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_renumber {std_rx_word_aligner_renumber l_enable_rx_std std_rx_word_aligner_mode std_protocol_hint} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_word_aligner_rgnumber {std_rx_word_aligner_rgnumber l_enable_rx_std std_rx_word_aligner_mode std_protocol_hint} {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_run_length_val {std_rx_run_length_val l_enable_rx_std std_pcs_pma_width} {
...
proc ::altera_xcvr_native_av::parameters::validate_enable_port_rx_std_bitslip { l_enable_rx_std enable_port_rx_std_bitslip std_low_latency_bypass_enable } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_tx_bitrev_enable { std_tx_bitrev_enable l_enable_tx_std std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_bitrev_enable { std_rx_bitrev_enable l_enable_rx_std std_protocol_hint } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_tx_byterev_enable { std_tx_byterev_enable l_enable_tx_std std_protocol_hint std_pcs_pma_width } {
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_byterev_enable { std_rx_byterev_enable l_enable_rx_std std_protocol_hint std_pcs_pma_width } {
...
proc ::altera_xcvr_native_av::parameters::validate_enable_port_rx_std_bitrev_ena { l_enable_rx_std enable_port_rx_std_bitrev_ena std_rx_bitrev_enable } {
...
proc ::altera_xcvr_native_av::parameters::validate_enable_port_rx_std_byterev_ena { l_enable_rx_std enable_port_rx_std_byterev_ena std_rx_byterev_enable } {
...
proc ::altera_xcvr_native_av::parameters::validate_enable_port_tx_std_polinv { l_enable_tx_std enable_port_tx_std_polinv std_tx_polinv_enable } {
...
proc ::altera_xcvr_native_av::parameters::validate_enable_port_rx_std_polinv { l_enable_rx_std enable_port_rx_std_polinv std_rx_polinv_enable } {

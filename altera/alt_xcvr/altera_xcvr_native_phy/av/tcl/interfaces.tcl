...
package provide altera_xcvr_native_av::interfaces 18.1

package require alt_xcvr::ip_tcl::ip_module
package require alt_xcvr::ip_tcl::ip_interfaces
package require alt_xcvr::ip_tcl::messages

namespace eval ::altera_xcvr_native_av::interfaces:: {
  ...
  set interfaces {\
    ...
    {tx_pma_parallel_data         input     input        channels*80             tx_pma_parallel_data      !l_enable_tx_pma_direct                                      NOVAL             tx_pma_parallel_data        conduit     end             false   ::altera_xcvr_native_av::interfaces::elaborate_tx_pma_parallel_data}\
    {unused_tx_pma_parallel_data  input     input        NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_unused_tx_pma_parallel_data}\
    ...
    {rx_pma_parallel_data         output    output       channels*80             rx_pma_parallel_data      !l_enable_rx_pma_direct                                      NOVAL             rx_pma_parallel_data        conduit     end             false   ::altera_xcvr_native_av::interfaces::elaborate_rx_pma_parallel_data}\
    {unused_rx_pma_parallel_data  input     input        NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_unused_rx_pma_parallel_data}\
    ...
    \
    {tx_parallel_data             input     input        channels*44             tx_parallel_data          "!l_enable_tx_std"                                           NOVAL             tx_parallel_data            conduit     end             false   ::altera_xcvr_native_av::interfaces::elaborate_tx_parallel_data}\
    {tx_datak                     input     input        NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_tx_datak}\
    {tx_forcedisp                 input     input        NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_tx_forcedisp}\
    {tx_dispval                   input     input        NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_tx_dispval}\
    {unused_tx_parallel_data      input     input        NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_unused_tx_parallel_data}\
    {rx_parallel_data             output    output       channels*64             rx_parallel_data          "!l_enable_rx_std"                                           NOVAL             rx_parallel_data            conduit     end             false   ::altera_xcvr_native_av::interfaces::elaborate_rx_parallel_data}\
    {rx_datak                     output    output       NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_rx_datak}\
    {rx_errdetect                 output    output       NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_rx_errdetect}\
    {rx_disperr                   output    output       NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_rx_disperr}\
    {rx_runningdisp               output    output       NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_rx_runningdisp}\
    {rx_patterndetect             output    output       NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_rx_patterndetect}\
    {rx_syncstatus                output    output       NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_rx_syncstatus}\
    {rx_rmfifostatus              output    output       NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_rx_rmfifostatus}\
    {unused_rx_parallel_data      output    output       NOVAL                   NOVAL                     NOVAL                                                        NOVAL             NOVAL                       conduit     end             true    ::altera_xcvr_native_av::interfaces::elaborate_unused_rx_parallel_data}\
...
proc ::altera_xcvr_native_av::interfaces::declare_interfaces {} {
  variable interfaces
  ip_declare_interfaces $interfaces
}

proc ::altera_xcvr_native_av::interfaces::elaborate {} {
  ip_elaborate_interfaces
}


proc ::altera_xcvr_native_av::interfaces::elaborate_tx_pma_parallel_data { enable_simple_interface l_enable_tx_pma_direct channels pma_direct_width l_pma_direct_word_count l_pma_direct_word_width} {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_unused_tx_pma_parallel_data { enable_simple_interface l_enable_tx_pma_direct channels pma_direct_width l_pma_direct_word_count l_pma_direct_word_width} {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_pma_parallel_data { enable_simple_interface l_enable_rx_pma_direct channels pma_direct_width l_pma_direct_word_count l_pma_direct_word_width} {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_unused_rx_pma_parallel_data { enable_simple_interface l_enable_rx_pma_direct channels pma_direct_width l_pma_direct_word_count l_pma_direct_word_width} {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_tx_parallel_data { l_enable_tx_std data_path_select l_std_tx_word_width l_std_tx_word_count l_std_tx_field_width channels enable_simple_interface } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_tx_datak { l_enable_tx_std data_path_select l_std_tx_word_count l_std_tx_field_width enable_simple_interface channels std_tx_8b10b_enable } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_tx_forcedisp { l_enable_tx_std data_path_select l_std_tx_word_count l_std_tx_field_width enable_simple_interface channels std_tx_8b10b_enable std_tx_8b10b_disp_ctrl_enable } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_tx_dispval { l_enable_tx_std data_path_select l_std_tx_word_count l_std_tx_field_width enable_simple_interface channels std_tx_8b10b_enable std_tx_8b10b_disp_ctrl_enable } {
  if {$l_enable_tx_std && $data_path_select == "standard" && $std_tx_8b10b_enable && $std_tx_8b10b_disp_ctrl_enable} {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_unused_tx_parallel_data { l_enable_tx_std data_path_select l_std_tx_word_width l_std_tx_word_count l_std_tx_field_width enable_simple_interface channels std_tx_8b10b_enable std_tx_8b10b_disp_ctrl_enable } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_parallel_data { l_enable_rx_std data_path_select l_std_rx_word_width l_std_rx_word_count l_std_rx_field_width channels enable_simple_interface } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_datak { l_enable_rx_std data_path_select l_std_rx_word_count l_std_rx_field_width enable_simple_interface channels std_rx_8b10b_enable } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_errdetect { l_enable_rx_std data_path_select l_std_rx_word_count l_std_rx_field_width enable_simple_interface channels std_rx_8b10b_enable } {
  if {$l_enable_rx_std && $data_path_select == "standard" && $std_rx_8b10b_enable} {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_disperr { l_enable_rx_std data_path_select l_std_rx_word_count l_std_rx_field_width enable_simple_interface channels std_rx_8b10b_enable } {
  if {$l_enable_rx_std && $data_path_select == "standard" && $std_rx_8b10b_enable} {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_runningdisp { l_enable_rx_std data_path_select l_std_rx_word_count l_std_rx_field_width enable_simple_interface channels std_rx_8b10b_enable } {
  if {$l_enable_rx_std && $data_path_select == "standard" && $std_rx_8b10b_enable} {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_syncstatus { l_enable_rx_std data_path_select l_std_rx_word_count l_std_rx_field_width enable_simple_interface channels std_rx_word_aligner_mode } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_patterndetect { l_enable_rx_std data_path_select l_std_rx_word_count l_std_rx_field_width enable_simple_interface channels std_rx_word_aligner_mode } {
  if {$l_enable_rx_std && $data_path_select == "standard" && $std_rx_word_aligner_mode != "bit_slip" } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_rx_rmfifostatus { l_enable_rx_std data_path_select l_std_rx_word_count l_std_rx_field_width enable_simple_interface channels std_rx_rmfifo_enable } {
...
proc ::altera_xcvr_native_av::interfaces::elaborate_unused_rx_parallel_data { l_enable_rx_std data_path_select l_std_rx_word_width l_std_rx_word_count l_std_rx_field_width enable_simple_interface channels std_rx_8b10b_enable std_rx_word_aligner_mode std_rx_rmfifo_enable } {

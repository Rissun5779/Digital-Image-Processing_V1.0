...
package provide alt_xcvr::utils::reconfiguration_arria10 18.1
...
namespace eval ::alt_xcvr::utils::reconfiguration_arria10:: {
 ...
 set display_items_multi_profile {\
      ...
      {"Store configuration to selected profile"  "Configuration Profiles"   "rcfg_multi_enable&&enable_pll_reconfig"  true      action ::alt_xcvr::utils::reconfiguration_arria10::action_store_profile   }\
      {"Load configuration from selected profile" "Configuration Profiles"   "rcfg_multi_enable&&enable_pll_reconfig"  true      action ::alt_xcvr::utils::reconfiguration_arria10::action_load_profile    }\
      {"Clear selected profile"                   "Configuration Profiles"   "rcfg_multi_enable&&enable_pll_reconfig"  true      action ::alt_xcvr::utils::reconfiguration_arria10::action_clear_profile   }\
      {"Clear all profiles"                       "Configuration Profiles"   "rcfg_multi_enable&&enable_pll_reconfig"  true      action ::alt_xcvr::utils::reconfiguration_arria10::action_clear_profiles  }\
      {"Refresh selected profile"                 "Configuration Profiles"   "rcfg_multi_enable&&enable_pll_reconfig"  true      action ::alt_xcvr::utils::reconfiguration_arria10::action_refresh_profile }\
      {"Reconfiguration Parameters"               "Configuration Profiles"   "rcfg_multi_enable&&enable_pll_reconfig"  true      GROUP  TABLE }\
  }
 ...
 set rcfg_parameters_common {\
      ...
      {enable_pll_reconfig                  NOVAL      1                1                NOVAL                                                                           false   true            INTEGER      0                        NOVAL                                                 true                                                                         true                      BOOLEAN       NOVAL         "Dynamic Reconfiguration"    "Enable dynamic reconfiguration"            "Enables the dynamic reconfiguration interface." }\
      {enable_advanced_avmm_options         NOVAL      0                0                NOVAL                                                                           true    false           INTEGER      0                        { 0 1 }                                               true                                                                         false                     NOVAL         NOVAL         NOVAL                         NOVAL                                      NOVAL}\
      {rcfg_jtag_enable                     NOVAL      1                1                NOVAL                                                                           false   true            INTEGER      0                        NOVAL                                                 enable_pll_reconfig                                                          true                      BOOLEAN       NOVAL         "Dynamic Reconfiguration"    "Enable Altera Debug Master Endpoint"       "When enabled, the PLL IP includes an embedded Altera Debug Master Endpoint that connects internally Avalon-MM slave interface. The ADME can access the reconfiguration space of the transceiver. It can perform certain test and debug functions via JTAG using the System Console. This option requires you to enable the \"Share reconfiguration interface\" option for configurations using more than 1 channel and may also require that a jtag_debug link be included in the system."}\
      {rcfg_separate_avmm_busy              NOVAL      1                1                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_separate_avmm_busy    false   true            INTEGER      0                        NOVAL                                                 enable_pll_reconfig                                                          true                      BOOLEAN       NOVAL         "Dynamic Reconfiguration"    "Separate reconfig_waitrequest from the status of AVMM arbitration with PreSICE"          "When enabled, the reconfig_waitrequest will not indicate the status of AVMM arbitration with PreSICE.  The AVMM arbitration status will be reflected in a soft status register bit.  This feature requires that the \"Enable control and status registers\" feature under \"Optional Reconfiguration Logic\" be enabled.  For more information, please refer to the User Guide."}\
      {rcfg_enable_avmm_busy_port           NOVAL      1                1                NOVAL                                                                           false   false           INTEGER      0                        NOVAL                                                 enable_pll_reconfig                                                          enable_advanced_avmm_options BOOLEAN    NOVAL         "Dynamic Reconfiguration"    "Enable avmm_busy port"                     "Enable the port for avmm_busy"}\
      \
      {set_capability_reg_enable            NOVAL      1                1                NOVAL                                                                           false   false           INTEGER      0                        NOVAL                                                 enable_pll_reconfig                                                          true                      BOOLEAN       NOVAL         "Optional Reconfiguration Logic"    "Enable capability registers"         "Enables capability registers, which provide high level information about the transceiver PLL's configuration"}\
      {set_user_identifier                  NOVAL      1                1                NOVAL                                                                           false   false           INTEGER      0                        {0:255}                                               "enable_pll_reconfig&&set_capability_reg_enable"                             true                      NOVAL         NOVAL         "Optional Reconfiguration Logic"    "Set user-defined IP identifier"      "Sets a user-defined numeric identifier that can be read from the user_identifer offset when the capability registers are enabled"}\
      {set_csr_soft_logic_enable            NOVAL      1                1                NOVAL                                                                           false   false           INTEGER      0                        NOVAL                                                 enable_pll_reconfig                                                          true                      BOOLEAN       NOVAL         "Optional Reconfiguration Logic"    "Enable control and status registers" "Enables soft registers for reading status signals and writing control signals on the phy interface through the embedded debug. Available signals include pll_cal_busy, pll_locked and pll_powerdown.  For more details, please refer to the User Guide."}\
      \
      {dbg_embedded_debug_enable            NOVAL      1                1                ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_embedded_debug_enable  true    true            INTEGER      0                        NOVAL                                                 enable_pll_reconfig                                                          false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {dbg_capability_reg_enable            NOVAL      1                1                ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_capability_reg_enable  true    true            INTEGER      0                        NOVAL                                                 true                                                                         false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {dbg_user_identifier                  NOVAL      1                1                ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_user_identifier        true    true            INTEGER      0                        NOVAL                                                 true                                                                         false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {dbg_stat_soft_logic_enable           NOVAL      1                1                ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_stat_soft_logic_enable true    true            INTEGER      0                        NOVAL                                                 true                                                                         false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {dbg_ctrl_soft_logic_enable           NOVAL      1                1                ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_ctrl_soft_logic_enable true    true            INTEGER      0                        NOVAL                                                 true                                                                         false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      \
      {rcfg_file_prefix                     NOVAL      0                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_file_prefix           false   false           STRING       "altera_xcvr_rcfg_10"    NOVAL                                                 enable_pll_reconfig                                                          true                      NOVAL         NOVAL         "Configuration Files"        "Configuration file prefix"                 "Specifies the file prefix to use for generated configuration files when enabled. Each variant of the IP should use a unique prefix for configuration files."}\
  ...
  set rcfg_parameters_multi_profile {\
      {NAME                                 M_CONTEXT  M_USED_FOR_RCFG  M_SAME_FOR_RCFG  VALIDATION_CALLBACK                                                             DERIVED HDL_PARAMETER   TYPE         DEFAULT_VALUE            ALLOWED_RANGES                                        ENABLED                                                                      VISIBLE                   DISPLAY_HINT  DISPLAY_UNITS DISPLAY_ITEM                 DISPLAY_NAME                                DESCRIPTION }\
      {rcfg_multi_enable                    NOVAL      0                0                NOVAL                                                                           false   false           INTEGER      0                        NOVAL                                                 enable_pll_reconfig                                                          true                      BOOLEAN       NOVAL         "Configuration Profiles"     "Enable multiple reconfiguration profiles"  "When enabled, you can use the GUI to store multiple configurations. The IP will generate reconfiguration files for all of the stored profiles. The IP will also check your multiple reconfiguration profiles for consistency to ensure you can reconfigure between them."}\
      {set_rcfg_emb_strm_enable             NOVAL      0                0                NOVAL                                                                           false   false           INTEGER      0                        NOVAL                                                 "rcfg_multi_enable&&enable_pll_reconfig"                                     true                      BOOLEAN       NOVAL         "Configuration Profiles"     "Enable embedded reconfiguration streamer"  "Enables the embedded reconfiguration streamer, which automates the dynamic reconfiguration process between multiple predefined configuration profiles."}\
      {rcfg_emb_strm_enable                 NOVAL      0                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_emb_strm_enable       true    true            INTEGER      0                        NOVAL                                                 true                                                                         false                     NOVAL         NOVAL          NOVAL                        NOVAL                                       NOVAL}\
      {rcfg_reduced_files_enable            NOVAL      0                0                NOVAL                                                                           false   false           INTEGER      0                        NOVAL                                                 "rcfg_multi_enable&&enable_pll_reconfig"                                     true                      BOOLEAN       NOVAL         "Configuration Profiles"     "Generate reduced reconfiguration files"    "When enabled, The Native PHY generates reconfiguration report files containing only the attributes or RAM data that are different between the multiple configured profiles."}\
      {rcfg_profile_cnt                     NOVAL      0                0                NOVAL                                                                           false   true            INTEGER      2                        { 1 2 3 4 5 6 7 8 }                                   "rcfg_multi_enable&&enable_pll_reconfig"                                     true                      NOVAL         NOVAL         "Configuration Profiles"     "Number of reconfiguration profiles"        "Specifies the number of reconfiguration profiles to support when multiple reconfiguration profiles are enabled."}\
      {rcfg_profile_select                  NOVAL      0                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_profile_select        false   false           INTEGER      1                        { 1 }                                                 "rcfg_multi_enable&&enable_pll_reconfig"                                     true                      NOVAL         NOVAL         "Configuration Profiles"     "Store current configuration to profile:"   "Selects which reconfiguration profile to store when clicking the \"Store profile\" button."}\
      {rcfg_profile_data0                   NOVAL      0                0                NOVAL                                                                           false   false           STRING      ""                        NOVAL                                                 false                                                                        false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {rcfg_profile_data1                   NOVAL      0                0                NOVAL                                                                           false   false           STRING      ""                        NOVAL                                                 false                                                                        false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {rcfg_profile_data2                   NOVAL      0                0                NOVAL                                                                           false   false           STRING      ""                        NOVAL                                                 false                                                                        false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {rcfg_profile_data3                   NOVAL      0                0                NOVAL                                                                           false   false           STRING      ""                        NOVAL                                                 false                                                                        false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {rcfg_profile_data4                   NOVAL      0                0                NOVAL                                                                           false   false           STRING      ""                        NOVAL                                                 false                                                                        false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {rcfg_profile_data5                   NOVAL      0                0                NOVAL                                                                           false   false           STRING      ""                        NOVAL                                                 false                                                                        false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {rcfg_profile_data6                   NOVAL      0                0                NOVAL                                                                           false   false           STRING      ""                        NOVAL                                                 false                                                                        false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {rcfg_profile_data7                   NOVAL      0                0                NOVAL                                                                           false   false           STRING      ""                        NOVAL                                                 false                                                                        false                     NOVAL         NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      \
      {rcfg_params                          NOVAL      1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_params                true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         NOVAL                         NOVAL                                       NOVAL}\
      {rcfg_param_labels                    NOVAL      1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_labels          true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "IP Parameters"                             NOVAL}\
      {rcfg_param_vals0                     0          1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals            true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "Profile 0"                                 NOVAL}\
      {rcfg_param_vals1                     1          1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals            true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "Profile 1"                                 NOVAL}\
      {rcfg_param_vals2                     2          1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals            true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "Profile 2"                                 NOVAL}\
      {rcfg_param_vals3                     3          1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals            true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "Profile 3"                                 NOVAL}\
      {rcfg_param_vals4                     4          1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals            true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "Profile 4"                                 NOVAL}\
      {rcfg_param_vals5                     5          1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals            true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "Profile 5"                                 NOVAL}\
      {rcfg_param_vals6                     6          1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals            true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "Profile 6"                                 NOVAL}\
      {rcfg_param_vals7                     7          1                0                ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals            true    false           STRING_LIST  NOVAL                    NOVAL                                                 false                                                                        false                     FIXED_SIZE    NOVAL         "Reconfiguration Parameters"  "Profile 7"                                 NOVAL}\
    }
}


proc ::alt_xcvr::utils::reconfiguration_arria10::declare_parameters { {enable_multi_profile 0} } {
   variable rcfg_parameters_common
   variable rcfg_parameters_multi_profile
...
proc ::alt_xcvr::utils::reconfiguration_arria10::declare_display_items { group_value args_value {enable_multi_profile 0} } {
   variable display_items_rcfg
   variable display_items_multi_profile
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_file_prefix { rcfg_file_prefix enable_pll_reconfig rcfg_sv_file_enable } {
  ...
  if {${enable_pll_reconfig} && ${rcfg_sv_file_enable} && ${bad_file_name}} {
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_emb_strm_enable { enable_pll_reconfig rcfg_multi_enable set_csr_soft_logic_enable set_rcfg_emb_strm_enable } {

  if { $enable_pll_reconfig && $rcfg_multi_enable && $set_csr_soft_logic_enable} {
    ip_set "parameter.rcfg_emb_strm_enable.value" $set_rcfg_emb_strm_enable
  } elseif { $set_rcfg_emb_strm_enable && ($set_csr_soft_logic_enable == 0) } {
    ip_message error "Enabling the Embedded Streamer requires Optional Reconfiguration logic option for soft CSR being enabled"
  } else {
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_param_vals { PROP_NAME PROP_M_CONTEXT \
  enable_pll_reconfig rcfg_multi_enable rcfg_profile_cnt rcfg_params } {

  # Initialize the result list
  set rcfg_param_vals ""

  # For each profile we make sure the settings are consistent with the current profile.
  if {$enable_pll_reconfig && $rcfg_multi_enable && ($PROP_M_CONTEXT < $rcfg_profile_cnt)} {
    ...
    if {$rcfg_profile_data == ""} {
      ip_message warning "Multiple reconfiguration profile $PROP_M_CONTEXT is empty. The ATX PLL will use the current configuration for profile $PROP_M_CONTEXT"
    } else {
    ...
    foreach param $rcfg_params {
      ...
      if {$use_current_config} {
        ...
        if {[dict exist $rcfg_profile_data $param]} {
          ...
          ip_message warning "Reconfiguration profile $PROP_M_CONTEXT is missing a value for parameter [ip_get "parameter.${param}.display_name"] (${param}). Intel recommends that you refresh the profile."
        }
      }
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::action_store_profile { {profile NOVAL} } {
  if {$profile == "NOVAL"} {
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::action_load_profile { {profile NOVAL} } {
  if {$profile == "NOVAL"} {
    set profile [ip_get "parameter.rcfg_profile_select.value"]
  }
  set rcfg_profile_cnt [ip_get "parameter.rcfg_profile_cnt.value"]
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::action_clear_profile { {profile NOVAL} } {
  if {$profile == "NOVAL"} {
    set profile [ip_get "parameter.rcfg_profile_select.value"]
  }
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::action_refresh_profile { {profile NOVAL} } {
  if {$profile == "NOVAL"} {
    set profile [ip_get "parameter.rcfg_profile_select.value"]
  }
...
#
proc ::alt_xcvr::utils::reconfiguration_arria10::generate_config_files { ip_name ip_core fileset criteria regmap_list atom_list } {
  ...
  for {set index 0} {$index < $rcfg_profile_cnt} {incr index} {
    ...
    if {$rcfg_multi_enable} {
      ...
      #::alt_xcvr::ip_tcl::messages::issue_deferred_messages #Commented out because causes error ...
    }
  ...
  if {$rcfg_multi_enable && $ip_core eq "native_phy"} { 
  ...
  for {set index 0} {$index < $rcfg_profile_cnt} {incr index} {
    ...
    if { $rcfg_h_file_enable } {
      ...
      set file_contents [::alt_xcvr::utils::ipgen::create_c_param_header "arria10" ${this_file_prefix} $rcfg_file_prefix $ascii_data $ram_data]
...
proc ::alt_xcvr::utils::reconfiguration_arria10::reduce_ascii_config_data { config_data } {
...
#
# @return - The same dictionary as passed but with all redundant data removed.
proc ::alt_xcvr::utils::reconfiguration_arria10::reduce_ram_config_data { config_data } {
  set keys [dict keys $config_data]
  set config_cnt [llength $keys]
  if {$config_cnt < 2} {
    return $config_data
...
# 
proc ::alt_xcvr::utils::reconfiguration_arria10::generate_reconfig_settings {ip_name random_str rcfg_profile_cnt atom all_rcfg_data} {
  # terp reconfig file  
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_embedded_debug_enable { enable_pll_reconfig set_capability_reg_enable set_csr_soft_logic_enable} {
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_capability_reg_enable { enable_pll_reconfig set_capability_reg_enable} {
  if { $enable_pll_reconfig } {
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_user_identifier { enable_pll_reconfig dbg_capability_reg_enable set_user_identifier } {
  if { $enable_pll_reconfig && $dbg_capability_reg_enable } {
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_stat_soft_logic_enable { enable_pll_reconfig set_csr_soft_logic_enable } {
  if { $enable_pll_reconfig } {
...
##############################
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_dbg_ctrl_soft_logic_enable { enable_pll_reconfig set_csr_soft_logic_enable } {
  if { $enable_pll_reconfig } {
...
proc ::alt_xcvr::utils::reconfiguration_arria10::validate_rcfg_separate_avmm_busy { PROP_NAME PROP_VALUE enable_advanced_avmm_options set_csr_soft_logic_enable rcfg_enable_avmm_busy_port } {
  if {$PROP_VALUE} {
    if { $enable_advanced_avmm_options == 0 } {
      if { $set_csr_soft_logic_enable == 0 } {
        ip_message error "Enabling Separate AVMM Busy requires Optional Reconfiguration logic option for soft CSR being enabled"
      }
    ...
    # If the advanced avmm option is enabled
      ...
      # If neither the port is enabled or the soft logic
        ...
        ip_message error "Enabling Separate AVMM Busy requires either the AVMM Busy port to be enabled or the Optional Reconfiguration logic option for soft CSR"
      }
    }
  }
}

...
proc ::nf_atx_pll::parameters::intersect { param_values constraints } {
...
proc ::nf_atx_pll::parameters::exclude { param_values constraints } {
   if {[llength $param_values] == 0} {return {}}
   if {[llength $constraints] == 0} {return {}}
...
proc ::nf_atx_pll::parameters::split_range { value } {
...
proc ::nf_atx_pll::parameters::union { values } {
   if { [llength $values] > 1 } {
      set union_list {}
...
proc ::nf_atx_pll::parameters::compare_lt { legal_range_values constraint_value } {
   set new_list {}
...
proc ::nf_atx_pll::parameters::compare_le { legal_range_values constraint_value } {
   set new_list {}
...
proc ::nf_atx_pll::parameters::compare_gt { legal_range_values constraint_value } {
   set new_list {}
...
proc ::nf_atx_pll::parameters::compare_ge { legal_range_values constraint_value } {
   set new_list {}
...
proc ::nf_atx_pll::parameters::compare_eq { legal_range_values constraint_value } {
   set new_list {}
...
proc ::nf_atx_pll::parameters::compare_ne { legal_range_values constraint_value } {
   set new_list {}
...
proc ::nf_atx_pll::parameters::compare_inside { legal_range_values constraint_values } {
   set new_list {}
...
proc ::nf_atx_pll::parameters::get_base_device_user_string { BASE_DEVICE } {

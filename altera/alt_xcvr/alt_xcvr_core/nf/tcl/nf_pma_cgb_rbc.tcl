...
proc ::nf_xcvr_native::parameters::validate_pma_cgb_bitslip_enable { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_bitslip_enable pma_cgb_bonding_reset_enable pma_cgb_prot_mode pma_cgb_xn_clock_source_sel } {
   ...
   if { $PROP_M_AUTOSET } {
      ...
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_bitslip_enable.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_bitslip_enable $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_bitslip_enable $pma_cgb_bitslip_enable $legal_values { pma_cgb_bonding_reset_enable pma_cgb_prot_mode pma_cgb_xn_clock_source_sel }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_bonding_mode { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_bonding_mode pma_tx_buf_xtx_path_bonding_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_bonding_mode.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_bonding_mode $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_bonding_mode $pma_cgb_bonding_mode $legal_values { pma_tx_buf_xtx_path_bonding_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_bonding_reset_enable { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_bonding_reset_enable pma_cgb_bonding_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_bonding_reset_enable.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_bonding_reset_enable $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_bonding_reset_enable $pma_cgb_bonding_reset_enable $legal_values { pma_cgb_bonding_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_cgb_power_down { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_cgb_power_down pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_cgb_power_down.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_cgb_power_down $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_cgb_power_down $pma_cgb_cgb_power_down $legal_values { pma_cgb_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_datarate { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_datarate pma_tx_buf_xtx_path_datarate } {
   ...
   if { $PROP_M_AUTOSET } {
      ...
      if { $len > 0 } {
         ...
         ip_set "parameter.pma_cgb_datarate.value" "${min} bps"
         if { $min != $max && $PROP_M_AUTOWARN } {
            auto_legal_range_warning_message pma_cgb_datarate $legal_values
         }
      }
      if { $len != 1 && $PROP_M_AUTOWARN } {
         auto_legal_range_warning_message pma_cgb_datarate $legal_values
      ...
      auto_value_out_of_range_message auto pma_cgb_datarate $pma_cgb_datarate $legal_values { pma_tx_buf_xtx_path_datarate }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_dprio_cgb_vreg_boost { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_dprio_cgb_vreg_boost pma_tx_buf_power_mode pma_tx_buf_xtx_path_optimal pma_tx_buf_xtx_path_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_dprio_cgb_vreg_boost.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_dprio_cgb_vreg_boost $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_dprio_cgb_vreg_boost $pma_cgb_dprio_cgb_vreg_boost $legal_values { pma_tx_buf_power_mode pma_tx_buf_xtx_path_optimal pma_tx_buf_xtx_path_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_initial_settings { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_initial_settings pma_tx_buf_xtx_path_initial_settings } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_initial_settings.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_initial_settings $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_initial_settings $pma_cgb_initial_settings $legal_values { pma_tx_buf_xtx_path_initial_settings }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_observe_cgb_clocks { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_observe_cgb_clocks pma_cgb_prot_mode pma_cgb_sup_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_observe_cgb_clocks.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_observe_cgb_clocks $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_observe_cgb_clocks $pma_cgb_observe_cgb_clocks $legal_values { pma_cgb_prot_mode pma_cgb_sup_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_pcie_gen3_bitwidth { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_pcie_gen3_bitwidth pma_rx_buf_pm_tx_rx_pcie_gen_bitwidth } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_pcie_gen3_bitwidth.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_pcie_gen3_bitwidth $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_pcie_gen3_bitwidth $pma_cgb_pcie_gen3_bitwidth $legal_values { pma_rx_buf_pm_tx_rx_pcie_gen_bitwidth }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_prot_mode { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_prot_mode pma_tx_buf_xtx_path_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_prot_mode.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_prot_mode $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_prot_mode $pma_cgb_prot_mode $legal_values { pma_tx_buf_xtx_path_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_scratch0_x1_clock_src { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_scratch0_x1_clock_src pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_scratch0_x1_clock_src.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_scratch0_x1_clock_src $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_scratch0_x1_clock_src $pma_cgb_scratch0_x1_clock_src $legal_values { pma_cgb_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_scratch1_x1_clock_src { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_scratch1_x1_clock_src pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_scratch1_x1_clock_src.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_scratch1_x1_clock_src $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_scratch1_x1_clock_src $pma_cgb_scratch1_x1_clock_src $legal_values { pma_cgb_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_scratch2_x1_clock_src { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_scratch2_x1_clock_src pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_scratch2_x1_clock_src.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_scratch2_x1_clock_src $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_scratch2_x1_clock_src $pma_cgb_scratch2_x1_clock_src $legal_values { pma_cgb_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_scratch3_x1_clock_src { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_scratch3_x1_clock_src pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_scratch3_x1_clock_src.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_scratch3_x1_clock_src $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_scratch3_x1_clock_src $pma_cgb_scratch3_x1_clock_src $legal_values { pma_cgb_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_select_done_master_or_slave { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_select_done_master_or_slave pma_cgb_prot_mode pma_cgb_x1_clock_source_sel pma_cgb_xn_clock_source_sel } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_select_done_master_or_slave.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_select_done_master_or_slave $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_select_done_master_or_slave $pma_cgb_select_done_master_or_slave $legal_values { pma_cgb_prot_mode pma_cgb_x1_clock_source_sel pma_cgb_xn_clock_source_sel }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_ser_mode { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_ser_mode pma_cgb_prot_mode pma_tx_buf_xtx_path_datawidth } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_ser_mode.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_ser_mode $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_ser_mode $pma_cgb_ser_mode $legal_values { pma_cgb_prot_mode pma_tx_buf_xtx_path_datawidth }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_ser_powerdown { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_ser_powerdown pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_ser_powerdown.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_ser_powerdown $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_ser_powerdown $pma_cgb_ser_powerdown $legal_values { pma_cgb_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_sup_mode { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_sup_mode pma_tx_buf_xtx_path_sup_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_sup_mode.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_sup_mode $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_sup_mode $pma_cgb_sup_mode $legal_values { pma_tx_buf_xtx_path_sup_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_tx_ucontrol_en { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_tx_ucontrol_en pma_cgb_initial_settings pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_tx_ucontrol_en.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_tx_ucontrol_en $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_tx_ucontrol_en $pma_cgb_tx_ucontrol_en $legal_values { pma_cgb_initial_settings pma_cgb_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_tx_ucontrol_pcie { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_tx_ucontrol_pcie pma_cgb_initial_settings pma_cgb_tx_ucontrol_en pma_rx_buf_xrx_path_uc_pcie_sw } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_tx_ucontrol_pcie.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_tx_ucontrol_pcie $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_tx_ucontrol_pcie $pma_cgb_tx_ucontrol_pcie $legal_values { pma_cgb_initial_settings pma_cgb_tx_ucontrol_en pma_rx_buf_xrx_path_uc_pcie_sw }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_tx_ucontrol_reset { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_tx_ucontrol_reset pma_cgb_initial_settings pma_cgb_tx_ucontrol_en } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_tx_ucontrol_reset.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_tx_ucontrol_reset $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_tx_ucontrol_reset $pma_cgb_tx_ucontrol_reset $legal_values { pma_cgb_initial_settings pma_cgb_tx_ucontrol_en }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_vccdreg_output { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_vccdreg_output pma_cgb_initial_settings pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_vccdreg_output.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_vccdreg_output $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_vccdreg_output $pma_cgb_vccdreg_output $legal_values { pma_cgb_initial_settings pma_cgb_prot_mode }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_x1_clock_source_sel { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_x1_clock_source_sel cdr_pll_pcie_gen pma_cgb_bonding_mode pma_cgb_prot_mode pma_cgb_sup_mode pma_tx_buf_xtx_path_gt_enabled } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_x1_clock_source_sel.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_x1_clock_source_sel $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_x1_clock_source_sel $pma_cgb_x1_clock_source_sel $legal_values { cdr_pll_pcie_gen pma_cgb_bonding_mode pma_cgb_prot_mode pma_cgb_sup_mode pma_tx_buf_xtx_path_gt_enabled }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_x1_div_m_sel { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_x1_div_m_sel pma_cgb_prot_mode pma_cgb_x1_clock_source_sel pma_tx_buf_xtx_path_clock_divider_ratio } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_x1_div_m_sel.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_x1_div_m_sel $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_x1_div_m_sel $pma_cgb_x1_div_m_sel $legal_values { pma_cgb_prot_mode pma_cgb_x1_clock_source_sel pma_tx_buf_xtx_path_clock_divider_ratio }
   }
}

proc ::nf_xcvr_native::parameters::validate_pma_cgb_xn_clock_source_sel { PROP_M_AUTOSET PROP_M_AUTOWARN device_revision pma_cgb_xn_clock_source_sel pma_cgb_bonding_mode pma_cgb_prot_mode } {
   ...
   if { $PROP_M_AUTOSET } {
      set len [llength $legal_values]
      if { $len > 0 } {
         ip_set "parameter.pma_cgb_xn_clock_source_sel.value" [lindex $legal_values 0]
      }
      if { $len != 1 && $PROP_M_AUTOWARN} {
         auto_legal_value_warning_message pma_cgb_xn_clock_source_sel $legal_values
      }
   } else {
      auto_invalid_value_message auto pma_cgb_xn_clock_source_sel $pma_cgb_xn_clock_source_sel $legal_values { pma_cgb_bonding_mode pma_cgb_prot_mode }
   }
}

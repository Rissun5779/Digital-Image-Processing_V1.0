...
package provide altera_xcvr_cdr_pll_vi::fileset 18.1
...
namespace eval ::altera_xcvr_cdr_pll_vi::fileset:: {
  ...
  set filesets {\
    ...
    { quartus_synth   QUARTUS_SYNTH   ::altera_xcvr_cdr_pll_vi::fileset::callback_quartus_synth  altera_xcvr_cdr_pll_a10 }\
    { sim_verilog     SIM_VERILOG     ::altera_xcvr_cdr_pll_vi::fileset::callback_sim_verilog    altera_xcvr_cdr_pll_a10 }\
    { sim_vhdl        SIM_VHDL        ::altera_xcvr_cdr_pll_vi::fileset::callback_sim_vhdl       altera_xcvr_cdr_pll_a10 }\
  }

}

proc ::altera_xcvr_cdr_pll_vi::fileset::declare_filesets { } {
  variable filesets

  declare_files
  ip_declare_filesets $filesets
}
proc ::altera_xcvr_cdr_pll_vi::fileset::declare_files {} {
  #AV Core files
  ...
  # altera_xcvr_cdr_pll_sv files

  set path [::alt_xcvr::utils::fileset::get_alt_xcvr_path]
  set path "${path}/altera_xcvr_pll/altera_xcvr_cdr_pll_vi/source/"
  set path [::alt_xcvr::utils::fileset::abs_to_rel_path $path]
  ::alt_xcvr::utils::fileset::common_fileset_group_plain ./ $path {
...
proc ::altera_xcvr_cdr_pll_vi::fileset::callback_quartus_synth {ip_name} {
   callback_generate_files $ip_name QUARTUS_SYNTH
}
proc ::altera_xcvr_cdr_pll_vi::fileset::callback_sim_verilog {ip_name} {
callback_generate_files $ip_name SIM_VERILOG
}

proc ::altera_xcvr_cdr_pll_vi::fileset::callback_sim_vhdl {ip_name} {

 callback_generate_files $ip_name SIM_VHDL
 
}

proc ::altera_xcvr_cdr_pll_vi::fileset::build_opcodes {} {
...
proc ::altera_xcvr_cdr_pll_vi::fileset::callback_generate_files { ip_name fileset } {
  ...
  common_add_fileset_files {ALTERA_XCVR_CDR_PLL_VI} $tags

  # List of atoms
  # Setting list as empty because timing settings not required for PLL
  set cdr_pll_atom_list {}

  ::alt_xcvr::utils::reconfiguration_arria10::generate_config_files $ip_name $ip_core $fileset $rcfg_criteria $regmap_list $cdr_pll_atom_list

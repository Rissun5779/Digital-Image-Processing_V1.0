...
package provide altera_xcvr_cdr_pll_vi::module 18.1
...
namespace eval ::altera_xcvr_cdr_pll_vi::module:: {
  ...
  variable module {\
    ...
    {altera_xcvr_cdr_pll_a10  18.1        { "Arria VI" "Arria 10" }     false      false       false     ::altera_xcvr_cdr_pll_vi::module::elaborate   "Transceiver CMU PLL Intel Arria 10 FPGA IP"  "Interface Protocols/Transceiver PLL"    "Intel Corporation"  NOVAL       "http://www.altera.com/literature/hb/arria-10/ug_arria10_xcvr_phy.pdf"   "Arria 10 Transceiver CMU PLL."}\
  }
}

...
package provide altera_xcvr_pll_sv::parameters 12.0
...
namespace eval ::altera_xcvr_pll_sv::parameters:: {
  ...
  set parameters {\
    ...
    {device_family                          false   false         STRING    "Stratix V"   { "Stratix V" }         true        false   NOVAL         NOVAL         NOVAL         NOVAL                               NOVAL                                                                   NOVAL       }\
    {plls                                   true    true          INTEGER   1             NOVAL                   false       false   NOVAL         NOVAL         NOVAL         "Number of PLLs"                    NOVAL                                                                   "Number of PLLs"}\
    {pll_type                               true    true          STRING    "CMU"         NOVAL                   true        false   NOVAL         NOVAL         NOVAL         NOVAL                               ::altera_xcvr_pll_sv::parameters::validate_pll_type                     NOVAL       }\
    ...
    {reference_clock_frequency              true    true          STRING    "125.0 MHz"   NOVAL                   true        false   NOVAL         NOVAL         NOVAL         NOVAL                               ::altera_xcvr_pll_sv::parameters::validate_reference_clock_frequency    NOVAL       }\
    {reference_clock_select                 true    true          STRING    "0"           NOVAL                   true        false   NOVAL         NOVAL         NOVAL         NOVAL                               ::altera_xcvr_pll_sv::parameters::validate_reference_clock_select       NOVAL       }\
    {set_data_rate                          true    false         STRING    "0"           NOVAL                   true        false   NOVAL         NOVAL         NOVAL         "PLL output data rate"              ::altera_xcvr_pll_sv::parameters::validate_set_data_rate                NOVAL       }\
    {output_clock_datarate                  true    true          STRING    NOVAL         NOVAL                   true        false   NOVAL         NOVAL         NOVAL         NOVAL                               ::altera_xcvr_pll_sv::parameters::validate_output_clock_datarate        NOVAL       }\
    {output_clock_frequency                 true    true          STRING    "0 ps"        NOVAL                   false       false   NOVAL         NOVAL         NOVAL         NOVAL                               NOVAL                                                                   NOVAL       }\
    {feedback_clk                           false   true          STRING    "internal"    {"internal" "external"} true        true    NOVAL         NOVAL         NOVAL         "PLL feedback path"                 NOVAL                                                                   NOVAL       }\
    \
    ...
    \
    {enable_hclk                            true    true          STRING    "0"           NOVAL                   false       false   NOVAL         NOVAL         NOVAL         NOVAL                               NOVAL                                                                   NOVAL       }\
    ...
    {att_mode                               true    true          INTEGER   0             NOVAL                   false       false   NOVAL         NOVAL         NOVAL         NOVAL                               NOVAL                                                                   NOVAL       }\
    {enable_mux                             true    true          INTEGER   1             NOVAL                   false       false   NOVAL         NOVAL         NOVAL         NOVAL                               NOVAL                                                                   NOVAL       }\
    \
	{l_pll_settings                         true    false         INTEGER   0             NOVAL                   true        false   NOVAL         NOVAL         NOVAL         NOVAL                               ::altera_xcvr_pll_sv::parameters::validate_l_pll_settings               NOVAL       }\
    {l_rcfg_to_xcvr_width                   true    false         INTEGER   0             NOVAL                   true        false   NOVAL         NOVAL         NOVAL         NOVAL                               ::altera_xcvr_pll_sv::parameters::validate_l_rcfg_to_xcvr_width         NOVAL       }\
    {l_rcfg_from_xcvr_width                 true    false         INTEGER   0             NOVAL                   true        false   NOVAL         NOVAL         NOVAL         NOVAL                               ::altera_xcvr_pll_sv::parameters::validate_l_rcfg_from_xcvr_width       NOVAL       }\
  }
}

proc ::altera_xcvr_pll_sv::parameters::declare_parameters { {device_family "Stratix V"} } {
  variable parameters
...
proc ::altera_xcvr_pll_sv::parameters::validate {} {
...
proc ::altera_xcvr_pll_sv::parameters::validate_set_data_rate { set_data_rate } {
  ip_set "parameter.set_data_rate.value" [::alt_xcvr::gui::pll_reconfig::get_pll_data_rate_string]
}

proc ::altera_xcvr_pll_sv::parameters::validate_pll_type { l_pll_settings } {
  ip_set "parameter.pll_type.value" [::alt_xcvr::gui::pll_reconfig::get_pll_type_string]
}

proc ::altera_xcvr_pll_sv::parameters::validate_output_clock_datarate { set_data_rate } {
  ip_set "parameter.output_clock_datarate.value" $set_data_rate
}


proc ::altera_xcvr_pll_sv::parameters::validate_reference_clock_frequency { l_pll_settings } {
...
proc ::altera_xcvr_pll_sv::parameters::validate_reference_clock_select { l_pll_settings } {
...
proc ::altera_xcvr_pll_sv::parameters::validate_l_pll_settings { device_family set_data_rate refclks } {
...
proc ::altera_xcvr_pll_sv::parameters::validate_l_rcfg_to_xcvr_width { device_family } {
   ip_set "parameter.l_rcfg_to_xcvr_width.value" [::alt_xcvr::utils::device::get_reconfig_to_xcvr_total_width $device_family 1]
}


proc ::altera_xcvr_pll_sv::parameters::validate_l_rcfg_from_xcvr_width { device_family } {

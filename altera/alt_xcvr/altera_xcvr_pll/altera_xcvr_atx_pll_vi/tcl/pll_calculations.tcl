...
package provide altera_xcvr_atx_pll_vi::pll_calculations 18.1
...
namespace eval ::altera_xcvr_atx_pll_vi::pll_calculations:: {
   ...
   proc ::altera_xcvr_atx_pll_vi::pll_calculations::scrub_list_values { my_list } {
     set new_list {}
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::set_calc_constants { f_max_pfd f_min_pfd f_max_vco f_min_vco f_max_ref f_min_ref f_max_x1 f_max_tank_0 f_min_tank_0 f_max_tank_1 f_min_tank_1 f_max_tank_2 f_min_tank_2 m_list n_list l_list l_cascade_list} {
   global max_pfd
   global min_pfd
   global max_vco
   global min_vco
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::legality_check_auto { f_out l_enable cascade_enable device_revision find_ref ref_clk } {
   global l_cascade_counter_list
   global l_counter_list
   global n_counter_list
   global m_counter_list
...
# @return dictionary ---> {status good/bad} {"X.Y" {{param_name1 param_value1} {param_name2 param_value2}...}} {status good/bad} {"Z.T" {{param_name1 param_value1} {param_name2 param_value2}...}}... 
proc ::altera_xcvr_atx_pll_vi::pll_calculations::legality_check_fract { f_out f_ref cascade_enable device_revision} {
   global l_cascade_counter_list
   global l_counter_list
   global n_counter_list
   global m_counter_list
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::legality_check_manual { is_fractional f_ref l_value m_value n_value k_value l_cascade_value l_cascade_predivider cascade_enable device_revision} {
...
# @return dictionary ---> {status good/bad} {"X.Y" {{param_name1 param_value1} {param_name2 param_value2}...}} {status good/bad} {"Z.T" {{param_name1 param_value1} {param_name2 param_value2}...}}... 
proc ::altera_xcvr_atx_pll_vi::pll_calculations::legality_check_feedback_auto { f_out f_fb enable_fb_comp l_counter_list l_cascade_counter_list l_cascade_value cascade_enable device_revision} {
   global n_counter_list
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_max_pfd {} { 
    global max_pfd
	return $max_pfd 
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_min_pfd {} { 
	global min_pfd
	return $min_pfd
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_min_vco {} { 
	global min_vco
	return $min_vco
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_max_vco {} { 
	global max_vco
	return $max_vco
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_min_ref {} { 
    global min_ref
	return $min_ref
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_max_ref {} { 
    global max_ref
	return $max_ref
}


proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_max_x1  {} { 
	global max_x1
	return $max_x1
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_min_tank_0 {} { 
	global min_tank_0
	return $min_tank_0
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_max_tank_0 {} { 
	global max_tank_0
	return $max_tank_0
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_min_tank_1 {} { 
	global min_tank_1
	return $min_tank_1
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_max_tank_1 {} { 
	global max_tank_1
	return $max_tank_1
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_min_tank_2 {} { 
	global min_tank_2
	return $min_tank_2
}

proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_f_max_tank_2 {} { 
	global max_tank_2
	return $max_tank_2
}
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::find_values { f_ref f_out find_ref l_counter_list m_counter_list n_counter_list l_cascade_counter_list cascade_enable device_revision} {
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::find_fractional_counter_values { f_ref f_out l_counter_list m_counter_list n_counter_list l_cascade_counter_list cascade_enable device_revision} {
	...
	foreach l $l_counter_list_to_use_for_calcs {
		if { $cascade_enable } {
			set vco_divider [::altera_xcvr_atx_pll_vi::pll_calculations::get_vco_divider $l $f_out $device_revision]
			set f_vco [expr $f_out * $l * $vco_divider]
		} else {
			set f_vco [expr $f_out * $l]
			set vco_divider 1
			...
			foreach n $n_counter_list {
				...
				if {$f_pfd_calc <= [get_f_max_pfd] && $f_pfd_calc >= [get_f_min_pfd]} {
					...
					set m_value [find_m_for_fractional $l $n $f_out $f_ref]
            			...
            			set f_vco_int_calc [expr $f_pfd_calc * 2 * $m_value]
						set lowest_frac_m [expr $m - 3]
			            set twice_lowest_frac_m [expr $lowest_frac_m * 2]
			            set highest_frac_pfd_freq [expr $f_vco_int_calc / $twice_lowest_frac_m  ]
						if {$m > 0 && $highest_frac_pfd_freq <= [get_f_max_pfd] } {
							...
							if {$k > 0} {
								...
								set effective_m [expr $m_value + $base_k]
            					set f_vco_calc [expr $f_pfd_calc * 2 * $effective_m]
						        set f_ref_calc [expr $f_pfd_calc * $n]
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::find_m_for_fractional { l_counter n_counter out_freq refclk } {
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::find_fractional { l_counter n_counter m_counter out_freq refclk } {
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::verify_counter_settings_with_reference_clock { is_fractional f_ref l_value m_value n_value k_value l_cascade_value cascade_enable device_revision l_cascade_predivider} {
	# initialize return status as bad. don't forget to update the status to good once proper settings find
	dict set ret status bad
    dict set ret status_message ""
    ...
    if { $is_fractional } {
        if {$f_ref >= [get_f_min_ref] && $f_ref <= [get_f_max_ref]} {
            ...
            if {$f_pfd_calc >= [get_f_min_pfd] && $f_pfd_calc <= [get_f_max_pfd] && $highest_frac_pfd_freq <= [get_f_max_pfd]} {
				set base_k [expr {double($k_value)/4294967296}]
				set effective_m [expr $m_value + $base_k]
            	set f_vco_calc [expr $f_pfd_calc * 2 * $effective_m]
                ...
                if {$f_vco_calc >= [get_f_min_vco] && $f_vco_calc <= [get_f_max_vco]} {
                    dict set ret status good				
    				if { $cascade_enable } {
						::altera_xcvr_atx_pll_vi::pll_calculations::verify_l_cascade_predivider $device_revision $f_vco_calc $l_cascade_predivider
					...
					set f_min_vco_MHz [ expr [get_f_min_vco]/1000000]
                    set f_min_vco_MHz [format "%.6f" $f_min_vco_MHz]
					set f_max_vco_MHz [ expr [get_f_max_vco]/1000000]
                    set f_max_vco_MHz [format "%.6f" $f_max_vco_MHz]
                    set f_vco_calc_MHz [expr $f_vco_calc/1000000]
                    set f_vco_calc_MHz [format "%.6f" $f_vco_calc_MHz]
					if { $f_vco_calc < [get_f_min_vco] } {
#    					puts "The VCO frequency (Fvco) is too low.  Current configured Fvco: ${f_vco_calc_MHz} MHz is smaller than f_min_vco ($f_min_vco_MHz MHz).  Fvco = (Fref * 2 * M)/N"
    					dict set ret status_message "The VCO frequency (Fvco) is too low.  Current configured Fvco: ${f_vco_calc_MHz} MHz is smaller than f_min_vco ($f_min_vco_MHz MHz).  Fvco = (Fref * 2 * M)/N where Fref is the PLL reference clock frequency."
					} else {
#						puts "The VCO frequency (Fvco) is too high.  Current configured Fvco: ${f_vco_calc_MHz} MHz is greater than f_min_vco ($f_max_vco_MHz MHz).  Fvco = (Fref * 2 * M)/N"
						dict set ret status_message "The VCO frequency (Fvco) is too high.  Current configured Fvco: ${f_vco_calc_MHz} MHz is greater than f_max_vco ($f_max_vco_MHz MHz).  Fvco = (Fref * 2 * M)/N where Fref is the PLL reference clock frequency."
					}
	        	}
            } else {
				set f_min_pfd_MHz [ expr [get_f_min_pfd]/1000000]
                set f_min_pfd_MHz [format "%.6f" $f_min_pfd_MHz]
				set f_max_pfd_MHz [ expr [get_f_max_pfd]/1000000]
                set f_max_pfd_MHz [format "%.6f" $f_max_pfd_MHz]
                set f_pfd_calc_MHz [expr $f_pfd_calc/1000000]
                set f_pfd_calc_MHz [format "%.6f" $f_pfd_calc_MHz]
            	if { $f_pfd_calc < [get_f_min_pfd] } {
#					puts "The phase frequency detecter input frequency (Fpfd) is too low.  Current configured Fpfd: ${f_pfd_calc_MHz} MHz is lower than f_min_pfd ($f_min_pfd_MHz MHz).  Fpfd = Fref / N"
					dict set ret status_message "The phase frequency detecter input frequency (Fpfd) is too low.  Current configured Fpfd: ${f_pfd_calc_MHz} MHz is lower than f_min_pfd ($f_min_pfd_MHz MHz).  Fpfd = Fref / N where Fref is the PLL reference clock frequency."
				} elseif { $f_pfd_calc > [get_f_max_pfd] } {
#					puts "The phase frequency detector input frequency (Fpfd) is too high.  Current configured Fpfd: ${f_pfd_calc_MHz} MHz is higher than f_max_pfd ($f_max_pfd_MHz MHz).  Fpfd = Fref / N"
					dict set ret status_message "The phase frequency detector input frequency (Fpfd) is too high.  Current configured Fpfd: ${f_pfd_calc_MHz} MHz is higher than f_max_pfd ($f_max_pfd_MHz MHz).  Fpfd = Fref / N where Fref is the PLL reference clock frequency."
				} elseif { $highest_frac_pfd_freq > [get_f_max_pfd] } {
                	set highest_frac_pfd_freq_MHz [expr $highest_frac_pfd_freq/1000000]
                	set highest_frac_pfd_freq_MHz [format "%.6f" $highest_frac_pfd_freq_MHz]
#					puts "The delta sigma modulator frequency (Fdsm) is too high.  Current configured Fdsm: ${highest_frac_pfd_freq_MHz} MHz is higher than f_max_dsm ($f_max_pfd_MHz MHz).  Fdsm = (Fref * 2 * M)/ ((M-3) * N)"
					dict set ret status_message "The delta sigma modulator frequency (Fdsm) is too high.  Current configured Fdsm: ${highest_frac_pfd_freq_MHz} MHz is higher than f_max_dsm ($f_max_pfd_MHz MHz).  Fdsm = (Fref * 2 * M)/ ((M-3) * N) where Fref is the PLL reference clock frequency."
				}
	    	}
        } else {
            set f_min_ref_MHz [expr [get_f_min_ref]/1000000]
            set f_min_ref_MHz [format "%.6f" $f_min_ref_MHz]
            set f_max_ref_MHz [expr [get_f_max_ref]/1000000]
            set f_max_ref_MHz [format "%.6f" $f_max_ref_MHz]
            set f_ref_MHz [expr $f_ref/1000000]
            set f_ref_MHz [format "%.6f" $f_ref_MHz]
        	if { $f_ref < [get_f_min_ref] } {
				dict set ret status_message "The PLL reference clock frequency (Fref) is too low.  Current configured Fref: ${f_ref_MHz} MHz is lower than f_min_ref ($f_min_ref_MHz MHz)."
			} else {
				dict set ret status_message "The PLL reference clock frequency (Fref) is too high.  Current configured Fref: ${f_ref_MHz} MHz is lower than f_max_ref ($f_max_ref_MHz MHz)."
			}
		}
        return $ret
    } else {
        if {$f_ref >= [get_f_min_ref] && $f_ref <= [get_f_max_ref]} {
            ...
            if {$f_pfd_calc >= [get_f_min_pfd] && $f_pfd_calc <= [get_f_max_pfd]} {
                ...
                if {$f_vco_calc >= [get_f_min_vco] && $f_vco_calc <= [get_f_max_vco]} {
                    dict set ret status good				
    				if { $cascade_enable } {
#						set vco_divider [::altera_xcvr_atx_pll_vi::pll_calculations::get_vco_divider $l_counter_value_to_use_for_calcs $temp_out_freq $device_revision]
                        ::altera_xcvr_atx_pll_vi::pll_calculations::verify_l_cascade_predivider $device_revision $f_vco_calc l_cascade_predivider 
						set vco_divider $l_cascade_predivider
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::find_external_feedback_mode_values { f_out f_fb n_counter_list l_counter_list l_cascade_counter_list l_cascade_value cascade_enable device_revision} {
   #global l_counter_list
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::get_vco_divider { vco_freq device_revision } {
	set vco_divider 1
	set rbc_predivider [::nf_atx_pll::parameters::validate_atx_pll_fpll_refclk_selection 1 1 $device_revision "hssi_cascade" "basic_tx" $vco_freq ]
...
proc ::altera_xcvr_atx_pll_vi::pll_calculations::verify_l_cascade_predivider { device_revision vco_freq l_cascade_predivider } {
    regsub -nocase -all {\m(\D)} $vco_freq "" vco_freq
    set legal_values [::nf_atx_pll::parameters::validate_atx_pll_fpll_refclk_selection 0 0 $device_revision "hssi_cascade" "basic_tx" $vco_freq ]
...
#    auto_invalid_value_message error "l_cascade_predivider" $l_cascade_predivider $gui_legal_val { device_revision l_cascade_counter out_freq prot_mode_fnl set_l_cascade_predivider select_manual_config}
    ...
    ::altera_xcvr_atx_pll_vi::parameters::manual_value_out_of_range_message error "l_cascade_predivider" $l_cascade_predivider $gui_legal_val 
}

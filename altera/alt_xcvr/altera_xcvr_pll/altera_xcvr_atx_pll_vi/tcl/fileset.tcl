...
package provide altera_xcvr_atx_pll_vi::fileset 18.1
...
namespace eval ::altera_xcvr_atx_pll_vi::fileset:: {
   ...
   set filesets {\
      ...
      { quartus_synth   QUARTUS_SYNTH   ::altera_xcvr_atx_pll_vi::fileset::callback_quartus_synth }\
      { sim_verilog     SIM_VERILOG     ::altera_xcvr_atx_pll_vi::fileset::callback_sim_verilog   }\
      { sim_vhdl        SIM_VHDL        ::altera_xcvr_atx_pll_vi::fileset::callback_sim_vhdl      }\
   }         
}
...
proc ::altera_xcvr_atx_pll_vi::fileset::callback_quartus_synth {ip_name} {
   ...
   lappend list_of_unique_files_for_synth altera_xcvr_atx_pll_a10.sv.terp qsys_unique_name 
...
proc ::altera_xcvr_atx_pll_vi::fileset::callback_sim_verilog {ip_name} {
   ...
   lappend list_of_unique_files_for_sim_vlg altera_xcvr_atx_pll_a10.sv.terp qsys_unique_name 
...
proc ::altera_xcvr_atx_pll_vi::fileset::callback_sim_vhdl {ip_name} {
   ...
   lappend list_of_unique_files_for_sim_vhdl altera_xcvr_atx_pll_a10.sv.terp qsys_unique_name 
...
proc ::altera_xcvr_atx_pll_vi::fileset::callback_generate_files { ip_name fileset } {
  ...
  ::alt_xcvr::utils::reconfiguration_arria10::generate_config_files $ip_name $ip_core $fileset $rcfg_criteria $regmap_list $atx_atom_list
...
#
proc ::altera_xcvr_atx_pll_vi::fileset::generate_unique_files {qsys_output_name list_of_unique_files} {
  # terp files 
  # all terp files are in ${path}/altera_xcvr_native_phy/altera_xcvr_native_vi/terp/"
  # top level 
  set path [::alt_xcvr::utils::fileset::get_alt_xcvr_path]
  set path "${path}/altera_xcvr_native_phy/altera_xcvr_native_vi/terp/"
  set path [::alt_xcvr::utils::fileset::abs_to_rel_path $path]
   # split the qsys_output_name to extract the ip_module_name, ip_component_name and random str 
  set elements [::alt_xcvr::utils::common::wsplit $qsys_output_name "_altera_xcvr_atx_pll_a10_"] 

  set ip_name [lindex $elements 0]
  set release_number [lindex [split [lindex $elements 1] "_"] 0]
  set ip_component_name altera_xcvr_atx_pll_a10_${release_number} 
  ...
  foreach file [dict keys $list_of_unique_files] {
    ...
    # Check if the unique file is altera_xcvr_atx_pll_a10.sv.terp or alt_xcvr_atx_pll_rcfg_opt_logic.sv.terp which is specific to ATX PLL
    # Other unique files are from Native PHY
    if {$file eq "altera_xcvr_atx_pll_a10.sv.terp" || $file eq "alt_xcvr_atx_pll_rcfg_opt_logic.sv.terp"} {
      set path [::alt_xcvr::utils::fileset::get_alt_xcvr_path] 

...
namespace eval ::altera_xcvr_pll_avgz::module:: {
  ...
  variable module {\
    ...
    {altera_xcvr_pll_avgz  18.1  true      false       false     ::altera_xcvr_pll_avgz::module::elaborate  "Arria V GZ Transceiver PLL Intel FPGA IP"  "Interface Protocols/Transceiver PHY" "Intel Corporation"  NOVAL       "http://www.altera.com/literature/ug/xcvr_user_guide.pdf" }\
  }
}

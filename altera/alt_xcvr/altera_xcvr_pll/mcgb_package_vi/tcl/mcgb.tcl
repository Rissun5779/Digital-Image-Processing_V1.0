...
package provide mcgb_package_vi::mcgb 18.1
...
namespace eval ::mcgb_package_vi::mcgb:: {
   ...
   set mcgb_parameters {\
      ...
      {enable_mcgb                               NOVAL     1               1               false   true          INTEGER   0                     true                                   true    BOOLEAN      NOVAL         "MCGB"        "Include Master Clock Generation Block"                 NOVAL                                                  ::mcgb_package_vi::mcgb::validate_enable_mcgb                 "When enabled Master CGB will be included as part of the IP. PLL output will feed the Master CGB input."}\
      ...
      {mcgb_div_fnl                              NOVAL     0               0               true    false         INTEGER   1                     true                                   false   NOVAL        NOVAL         NOVAL         NOVAL                                                   { 1 2 4 8 }                                            ::mcgb_package_vi::mcgb::convert_mcgb_div                     NOVAL }\
      ...
      {enable_mcgb_pcie_clksw                    NOVAL     1               1               false   false         INTEGER   0                     enable_mcgb                            true    BOOLEAN      NOVAL         "MCGB"        "Enable PCIe clock switch interface"                    NOVAL                                                  ::mcgb_package_vi::mcgb::validate_enable_mcgb_pcie_clksw      "Enables the control signals for PCIe clock switch circuitry"}\
      {mcgb_aux_clkin_cnt                        NOVAL     1               1               false   false         INTEGER   0                     enable_mcgb                            true    NOVAL        NOVAL         "MCGB"        "Number of auxiliary MCGB clock input ports."            { 0 1 }                                               ::mcgb_package_vi::mcgb::update_mcgb_aux_clkin_cnt            "Auxiliary input is intended for PCIe Gen3, hence not available in FPLL"}\
      ...
      {enable_fb_comp_bonding                    NOVAL     1               1               false   false         INTEGER   0                     "enable_mcgb && enable_bonding_clks"   true    BOOLEAN      NOVAL         "Bonding"     "Enable feedback compensation bonding"                  NOVAL                                                  ::mcgb_package_vi::mcgb::validate_enable_fb_comp_bonding      "NOVAL"}\
      {mcgb_enable_iqtxrxclk                     NOVAL     0               0               true    false         STRING    "disable_iqtxrxclk"   "enable_mcgb && enable_bonding_clks"   false   NOVAL        NOVAL         NOVAL         NOVAL                                                   { "disable_iqtxrxclk" "enable_iqtxrxclk"}              ::mcgb_package_vi::mcgb::convert_enable_fb_comp_bonding       "NOVAL"}\
      ...
      {check_output_ports_mcgb                   NOVAL     0               0               true    false         INTEGER   0                     false                                  false   NOVAL        NOVAL         NOVAL         NOVAL                                                   NOVAL                                                  ::mcgb_package_vi::mcgb::validate_check_output_ports_mcgb     NOVAL}\
   }
...
# eventually fpll might need to the same
   set mcgb_atom_parameters {\
      ...
      { hssi_pma_cgb_master_prot_mode               "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      NOVAL                           true            false     false   ::mcgb_package_vi::mcgb::filter_prot_mode NOVAL }\
      ...
      { hssi_pma_cgb_master_ser_mode                "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      NOVAL                           true            false     false   ::mcgb_package_vi::mcgb::convert_mcgb_ser_mode      NOVAL }\
      { hssi_pma_cgb_master_datarate                "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      NOVAL                           true            false     false   ::mcgb_package_vi::mcgb::convert_mcgb_out_datarate  NOVAL }\
   }
...
#-----------------------------------------------------------------------------------------
# Changes found in p4: 4278541
# hssi_pma_cgb_master_input_select      - the default value is changed to "fpll_top"
...
#-----------------------------------------------------------------------------------------
   set mcgb_parameters_to_be_removed {\
      ...
      { hssi_pma_cgb_master_cgb_power_down                       "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      true            false     false     "normal_cgb"                 ::mcgb_package_vi::mcgb::set_to_default }\
      { hssi_pma_cgb_master_observe_cgb_clocks                   "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      true            false     false     "observe_nothing"            ::mcgb_package_vi::mcgb::set_to_default }\
      { hssi_pma_cgb_master_op_mode                              "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      true            false     false     "enabled"                    ::mcgb_package_vi::mcgb::set_to_default }\
      { hssi_pma_cgb_master_tx_ucontrol_reset_pcie               "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      true            false     false     "pcscorehip_controls_mcgb"   ::mcgb_package_vi::mcgb::set_to_default }\
      { hssi_pma_cgb_master_vccdreg_output                       "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      true            false     false     "vccdreg_nominal"            ::mcgb_package_vi::mcgb::set_to_default }\
      { hssi_pma_cgb_master_input_select                         "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      true            false     false     "fpll_top"                  ::mcgb_package_vi::mcgb::validate_input_select }\
      { hssi_pma_cgb_master_input_select_gen3                    "enable_mcgb && enable_mcgb_debug_ports_parameters"    STRING     true      true            false     false     "unused"                     ::mcgb_package_vi::mcgb::validate_input_select_gen3 }\
   }
...
proc ::mcgb_package_vi::mcgb::set_primary_pll_buffer_maps_from { mapsFrom } {
   variable pll_parameters_used_in_mcgb_validation_callbacks
...
proc ::mcgb_package_vi::mcgb::declare_mcgb_display_items {} {
   ...
   ip_message info "NOTE: Modified mcgb tcl package that enables ATX PLL Sharing"
}
...
proc ::mcgb_package_vi::mcgb::validate_check_output_ports_mcgb {enable_bonding_clks enable_hfreq_clk enable_mcgb} {
   if {$enable_mcgb} {
...
# ------------------------------
# Changes made with p4:4278541
# The mcgb_aux clock inputs are now legal in the fpll 
# ------------------------------
...
proc ::mcgb_package_vi::mcgb::convert_enable_fb_comp_bonding { enable_mcgb enable_bonding_clks enable_fb_comp_bonding } {
...
proc ::mcgb_package_vi::mcgb::validate_input_select { hssi_pma_cgb_master_prot_mode } {
...
# ------------------------------
#
proc ::mcgb_package_vi::mcgb::validate_input_select_gen3 { hssi_pma_cgb_master_prot_mode } {
...
proc ::mcgb_package_vi::mcgb::validate_enable_mcgb_pcie_clksw { PROP_VALUE enable_mcgb is_protocol_PCIe } {
...
proc ::mcgb_package_vi::mcgb::validate_enable_fb_comp_bonding { PROP_VALUE enable_mcgb enable_bonding_clks is_protocol_PCIe } {
...
proc ::mcgb_package_vi::mcgb::mega_to_base { val } { 
...
proc ::mcgb_package_vi::mcgb::convert_mcgb_out_datarate {PROP_NAME mcgb_out_datarate } {
   set temp "$mcgb_out_datarate Mbps"
   set temp [mega_to_base $temp]
   ip_set "parameter.${PROP_NAME}.value" "$temp bps"
}

##
# Convert recently added prot modes that are currently not represented in the MCGB atom map to basic_tx
# as this is sufficient from the perspective of the MCGB
proc ::mcgb_package_vi::mcgb::filter_prot_mode { PROP_NAME } {
   set temp_prot_mode [ip_get "parameter.hssi_pma_cgb_master_prot_mode.value"]
   if { [string first "atx" [ip_get "module.name"]] >=0 } {
       if {$temp_prot_mode == "upi_tx" || $temp_prot_mode == "sas_tx"} {
          ip_set "parameter.hssi_pma_cgb_master_prot_mode.value" "basic_tx"
       }
   } else {
       if {$temp_prot_mode == "sata_tx"} {
          ip_set "parameter.hssi_pma_cgb_master_prot_mode.value" "basic_tx"
       }
   }
}
...
proc ::mcgb_package_vi::mcgb::convert_mcgb_ser_mode {PROP_NAME enable_mcgb pma_width} {
   set temp $pma_width
   if {!$enable_mcgb} {
...
proc ::mcgb_package_vi::mcgb::convert_mcgb_div { PROP_NAME enable_mcgb mcgb_div } {
   set temp $mcgb_div
   if {!$enable_mcgb} {
      # do not propogate user selection if cgb not enabled
...
proc ::mcgb_package_vi::mcgb::validate_enable_mcgb {PROP_NAME PROP_VALUE mapped_primary_pll_buffer} {
   if { $PROP_VALUE } {
...
proc ::mcgb_package_vi::mcgb::update_mcgb_in_clk_freq { mapped_output_clock_frequency enable_mcgb} {
        # strip off MHz
...
proc ::mcgb_package_vi::mcgb::update_mcgb_out_datarate { mcgb_in_clk_freq mcgb_div_fnl} {

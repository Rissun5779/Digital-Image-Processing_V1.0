...
namespace eval ::altera_xcvr_atx_pll_s10::fileset:: {
   ...
   set filesets {\
      ...
      { quartus_synth   QUARTUS_SYNTH   ::altera_xcvr_atx_pll_s10::fileset::callback_quartus_synth }\
      { sim_verilog     SIM_VERILOG     ::altera_xcvr_atx_pll_s10::fileset::callback_sim_verilog   }\
      { sim_vhdl        SIM_VHDL        ::altera_xcvr_atx_pll_s10::fileset::callback_sim_vhdl      }\
   }         
}

proc ::altera_xcvr_atx_pll_s10::fileset::declare_filesets { } {
   variable filesets
   declare_files
   ip_declare_filesets $filesets
}

proc ::altera_xcvr_atx_pll_s10::fileset::declare_files {} {
...
#   } {ALTERA_XCVR_ATX_PLL_S10}
   ...
   set path [::alt_xcvr::utils::fileset::get_alt_xcvr_path]
   set path "${path}/altera_xcvr_pll/altera_xcvr_atx_pll_s10/source/"
   set path [::alt_xcvr::utils::fileset::abs_to_rel_path $path]
   ::alt_xcvr::utils::fileset::common_fileset_group_plain ./ $path {
...
proc ::altera_xcvr_atx_pll_s10::fileset::callback_quartus_synth {ip_name} {
   ...
   lappend list_of_unique_files_for_synth altera_xcvr_atx_pll_s10.sv.terp qsys_unique_name 
   ...
   if { [ip_get "parameter.rcfg_emb_strm_enable.value"] } {
     ...
     lappend list_of_unique_files_for_synth alt_xcvr_atx_pll_rcfg_opt_logic.sv.terp alt_xcvr_atx_pll_rcfg_opt_logic.sv
...
proc ::altera_xcvr_atx_pll_s10::fileset::callback_sim_verilog {ip_name} {
   ...
   lappend list_of_unique_files_for_sim_vlg altera_xcvr_atx_pll_s10.sv.terp qsys_unique_name 
   ...
   if { [ip_get "parameter.rcfg_emb_strm_enable.value"] } {
     ...
     lappend list_of_unique_files_for_sim_vlg alt_xcvr_atx_pll_rcfg_opt_logic.sv.terp alt_xcvr_atx_pll_rcfg_opt_logic.sv
...
proc ::altera_xcvr_atx_pll_s10::fileset::callback_sim_vhdl {ip_name} {
   ...
   lappend list_of_unique_files_for_sim_vhdl altera_xcvr_atx_pll_s10.sv.terp qsys_unique_name 
   ...
   if { [ip_get "parameter.rcfg_emb_strm_enable.value"] } {
     ...
     lappend list_of_unique_files_for_sim_vhdl alt_xcvr_atx_pll_rcfg_opt_logic.sv.terp alt_xcvr_atx_pll_rcfg_opt_logic.sv
...
proc ::altera_xcvr_atx_pll_s10::fileset::build_opcodes {} {
...
proc ::altera_xcvr_atx_pll_s10::fileset::callback_generate_files { ip_name fileset } {
  ...
  common_add_fileset_files {ALTERA_XCVR_ATX_PLL_S10} $tags
  ...
  ::alt_xcvr::utils::reconfiguration_stratix10::generate_config_files $ip_name $ip_core $fileset $rcfg_criteria $regmap_list $atx_atom_list $ip_params_for_timing
...
#
proc ::altera_xcvr_atx_pll_s10::fileset::generate_unique_files {qsys_output_name list_of_unique_files} {
  # terp files 
  ...
  set elements [::alt_xcvr::utils::common::wsplit $qsys_output_name "_altera_xcvr_atx_pll_s10_"] 
  ...
  foreach file [dict keys $list_of_unique_files] {
    ...
    # Check if the unique file is altera_xcvr_atx_pll_s10.sv.terp or alt_xcvr_atx_pll_rcfg_opt_logic.sv.terp which is specific to ATX PLL
    # Other unique files are from Native PHY
    if {$file eq "altera_xcvr_atx_pll_s10.sv.terp" || $file eq "alt_xcvr_atx_pll_rcfg_opt_logic.sv.terp"} {
      set path [::alt_xcvr::utils::fileset::get_alt_xcvr_path] 
      set path "${path}/altera_xcvr_pll/altera_xcvr_atx_pll_s10/source/terp/"
    } else {
      set path [::alt_xcvr::utils::fileset::get_alt_xcvr_path] 
      set path "${path}/altera_xcvr_native_phy/altera_xcvr_native_s10/terp/"
    }

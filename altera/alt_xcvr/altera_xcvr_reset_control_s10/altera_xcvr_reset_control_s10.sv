...
(* altera_attribute = "-name MERGE_TX_PLL_DRIVEN_BY_REGISTERS_WITH_SAME_CLEAR ON -to \"alt_xcvr_reset_counter_s10:g_pll.counter_pll_powerdown|r_reset\" " *)
...
#(
    ...
    parameter T_RX_DIGITALRESET = 4000, // rx_digitalreset period 
...
//***************************** TX Reset Logic ******************************
      ...
      wire [CHANNELS-1:0] tx_digitalreset_stat_sync; // tx_digitalreset_stat after synchronization
...
generate if(TX_ENABLE) begin: g_tx
  ...
  for (ig=0;ig<CHANNELS;ig=ig+1) begin : g_tx
    if(ig == 0 || TX_PER_CHANNEL == 1) begin : g_tx
      ...
      wire  lcl_tx_analogreset_stat;  // tx_analogreset_stat for this channel
//      wire  lcl_tx_digitalreset_stat; // tx_digitalreset_stat for this channel
      ...
      wire  tx_analogreset_stat_sync;  // tx_analogreset_stat after synchronization
//      wire  tx_digitalreset_stat_sync; // tx_digitalreset_stat after synchronization
...
//      wire  stat_tx_digitalreset;
      ...
      assign  lcl_tx_analogreset_stat  = TX_PER_CHANNEL ? tx_analogreset_stat[ig]  : |tx_analogreset_stat;
      assign  lcl_tx_digitalreset_stat = TX_PER_CHANNEL ? tx_digitalreset_stat[ig] : |tx_digitalreset_stat;
      ...
      alt_xcvr_resync_std #(
        ...
        .clk    (clock            ),
        .reset  (reset_sync       ),
        .d      ({lcl_tx_cal_busy , lcl_pll_cal_busy , lcl_pll_locked, lcl_tx_analogreset_stat , lcl_tx_digitalreset_stat}),
        .q      ({tx_cal_busy_sync, pll_cal_busy_sync, pll_locked_sync, tx_analogreset_stat_sync, tx_digitalreset_stat_sync[ig]})
      );
      ...
      // and for "T_TX_ANALOGRESET" ns thereafter
        alt_xcvr_reset_counter_s10 #(
          ...
          .clk        (clock                  ),
          .async_req  (reset_sync             ),  // asynchronous reset request
          .sync_req   (tx_or_pll_cal_busy_sync|(~tx_analogreset_stat_sync&stat_tx_analogreset)),  // synchronous reset request
      ...
      alt_xcvr_reset_counter_s10 #(
        ...
        .clk        (clock                      ),
        .async_req  (reset_sync                 ),  // asynchronous reset request
        .sync_req   (stat_tx_analogreset|~pll_locked_latch|tx_manual|tx_analogreset_stat_sync|(~tx_digitalreset_stat_sync[ig]&stat_tx_digitalreset[ig])),  // synchronous reset request
      ...
      alt_xcvr_reset_counter_s10 #(
        ...
        .clk        (clock                ),
        .async_req  (reset_sync           ),  // asynchronous reset request
        .sync_req   (stat_tx_digitalreset[ig] | tx_digitalreset_stat_sync[ig]),  // synchronous reset request
        .reset_or   (1'b0                 ),  // auxilliary reset override
        .reset      (/*unused*/           ),  // synchronous reset out
        .reset_n    (tx_ready[ig]         ),
      ...
      assign  tx_digitalreset_stat_sync[ig] = tx_digitalreset_stat_sync[0];
    end
  end
...
generate if (RX_ENABLE) begin : g_rx
  for (ig=0;ig<CHANNELS;ig=ig+1) begin : g_rx
    if(ig == 0 || RX_PER_CHANNEL == 1) begin : g_rx
      ...
      wire  lcl_rx_analogreset_stat;  // rx_analogreset_stat for this channel
      wire  lcl_rx_digitalreset_stat; // rx_digitalreset_stat for this channel
      ...
      wire  rx_analogreset_stat_sync;  // rx_analogreset_stat after synchronization
      wire  rx_digitalreset_stat_sync; // rx_digitalreset_stat after synchronization
      ...
      assign  lcl_rx_analogreset_stat  = RX_PER_CHANNEL ? rx_analogreset_stat[ig]  : |rx_analogreset_stat;
      assign  lcl_rx_digitalreset_stat = RX_PER_CHANNEL ? rx_digitalreset_stat[ig] : | rx_digitalreset_stat;
      ...
      alt_xcvr_resync_std #(
        ...
        .clk    (clock            ),
        .reset  (reset_sync       ),
        .d      ({lcl_rx_cal_busy , lcl_rx_is_lockedtodata  , lcl_rx_analogreset_stat , lcl_rx_digitalreset_stat }),
        .q      ({rx_cal_busy_sync, rx_is_lockedtodata_sync , rx_analogreset_stat_sync, rx_digitalreset_stat_sync})
      );
      ...
      alt_xcvr_reset_counter_s10 #(
        ...
        .clk        (clock              ),
        .async_req  (reset_sync         ),  // asynchronous reset request
        .sync_req   (rx_cal_busy_sync|(~rx_analogreset_stat_sync&stat_rx_analogreset)),  // synchronous reset request
        .reset_or   (1'b0               ),  // auxilliary reset override
      ...
      if (TX_ENABLE && ENABLE_DIGITAL_SEQ)
        alt_xcvr_reset_counter_s10 #(
          ...
          .clk        (clock                  ),
          .async_req  (reset_sync             ),  // asynchronous reset request
          .sync_req   (stat_rx_analogreset|rx_manual|rx_analogreset_stat_sync|(~rx_digitalreset_stat_sync&stat_rx_digitalreset)|tx_digitalreset_stat_sync[ig]|stat_tx_digitalreset[ig]),  // synchronous reset request
        ...
        alt_xcvr_reset_counter_s10 #(
          ...
          .clk        (clock                  ),
          .async_req  (reset_sync             ),  // asynchronous reset request
          .sync_req   (stat_rx_analogreset|rx_manual|rx_analogreset_stat_sync|(~rx_digitalreset_stat_sync&stat_rx_digitalreset)),  // synchronous reset request
          .reset_or   (lcl_rx_digitalreset_or ),  // auxilliary reset override
          .reset      (rx_digitalreset[ig]    ),  // synchronous reset out
          .reset_n    (/*unused*/             ),
          .reset_stat (stat_rx_digitalreset   )
      ...
      alt_xcvr_reset_counter_s10 #(
        ...
        .clk        (clock                ),
        .async_req  (reset_sync           ),  // asynchronous reset request
        .sync_req   (stat_rx_digitalreset | rx_digitalreset_stat_sync),  // synchronous reset request
        .reset_or   (1'b0                 ),  // auxilliary reset override
        .reset      (/*unused*/           ),  // synchronous reset out
        .reset_n    (rx_ready[ig]         ),
        .reset_stat (/*unused*/           )

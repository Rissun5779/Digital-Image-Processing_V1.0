...
// $File: //depot/ipd_tools/bin/clone $
// $Revision: #5 $
// $Date: 2013/06/25 $
// $Author: pscheidt $
//-------------------------------------------------------------------------------
// Cloned by //depot/ipd_tools/bin/clone#5 
// Source file: /data/opatki/bmain/p4/ip/altera_xcvr_generic/ctrl/altera_wait_generate.v
// Date: Tue May 31 10:28:20 2016
//-------------------------------------------------------------------------------
`timescale 1 ps / 1 ps
module alt_eth_altera_wait_generate
//#(
...
wire reset_sync;
alt_eth_resync_nocut #(.INIT_VALUE (1)) rst_sync (.clk(clk),.reset(rst),.d(1'b0),.q(reset_sync));

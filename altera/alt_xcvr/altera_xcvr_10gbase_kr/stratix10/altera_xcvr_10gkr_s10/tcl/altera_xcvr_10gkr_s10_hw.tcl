...
lappend auto_path $env(QUARTUS_ROOTDIR)/../ip/altera/alt_xcvr/altera_xcvr_10gbase_kr/stratix10
lappend auto_path $env(QUARTUS_ROOTDIR)/../ip/altera/alt_xcvr/altera_xcvr_native_phy/sv

package require -exact qsys 13.1

package require altera_xcvr_10gkr_s10::module

set_module_property ALLOW_GREYBOX_GENERATION true 

::altera_xcvr_10gkr_s10::module::declare_module

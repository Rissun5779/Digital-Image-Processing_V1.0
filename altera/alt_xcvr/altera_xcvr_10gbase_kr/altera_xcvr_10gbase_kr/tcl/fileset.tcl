...
proc ::altera_xcvr_10gbase_kr::fileset::declare_files {} {
  ...
  ::alt_xcvr::utils::fileset::common_fileset_group ./ "$path/../altera_xcvr_10gbase_kr/" SDC {
    altera_xcvr_10gbase_kr.sdc
  } {ALTERA_XCVR_10GBASE_KR} {QIP}
...
# Declare encrypted FEC KR files
  ...
  ::alt_xcvr::utils::fileset::common_fileset_group_plain  ./ "$path/../sv_fec" {
    hd_krfec_top_wrapper.ocp
  } {ALTERA_XCVR_10GBASE_KR}
...
# Declare encrypted SV Soft 10G PCS files
  ...
  ::alt_xcvr::utils::fileset::common_fileset_group_plain  ./ "$path/../sv_soft_10gbaser/sv_soft_pcs" {

...
set inst [get_registers -nowarn *seq_sm*pcs_mode*]
set inst_num [llength [query_collection -report -all $inst]]
if {$inst_num > 0} {
   set_false_path -from [get_registers *altera_xcvr_10gbase_kr:*|seq_sm:SEQ_GEN.SEQUENCER|pcs_mode_rc\[*\]*] -to [get_registers *altera_xcvr_10gbase_kr|tx_parallel_ctrl\[*\]*]
   set_false_path -from [get_registers *altera_xcvr_10gbase_kr:*|seq_sm:SEQ_GEN.SEQUENCER|pcs_mode_rc\[*\]*] -to [get_registers *altera_xcvr_10gbase_kr|tx_parallel_data\[*\]*]
}

net_constraint_proc *rx_10g_control_inter[*]    *csr_krtop:csr_krtop_inst|readdata[*] 1 1.5 3ns
net_constraint_proc *rx_parallel_data_native*   *csr_krtop:csr_krtop_inst|readdata[*] 1 1.5 3ns
net_constraint_proc *rx_10g_control_inter[*]    *csr_krtop:csr_krtop_inst|readdata[*] 1 1.5 3ns
...
set inst_num [llength [query_collection -report -all $inst]]
if {$inst_num > 0} {
  set_false_path -from [get_registers *altera_xcvr_10gbase_kr:*|seq_sm:SEQ_GEN.SEQUENCER|pcs_mode_rc\[*\]*] -to [get_registers *altera_xcvr_10gbase_kr:*|ultra_chnl:CHANNEL|tx_10g_data_valid_to_pcs]
}
...
set inst_num [llength [query_collection -report -all $inst]]
if {$inst_num > 0} {
   set_false_path -from [get_registers *altera_xcvr_10gbase_kr|rx_parallel_data_native\[*\]*] -to [get_registers *altera_xcvr_10gbase_kr|csr_krgige:GIGE_ENABLE.csr_krgige_inst|readdata\[*\]*]
}

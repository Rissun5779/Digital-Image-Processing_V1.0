...
proc compile_reconfig_bundle {} {
    ...
    vlog -sv -work work_reconfig ./sync_regs_m2.v
    vlog -sv -work work_reconfig ./reset_delay.v
    vlog -sv -work work_reconfig ./nios2_smg.v
    vlog -sv -work work_reconfig ./dfe_nios_top.v

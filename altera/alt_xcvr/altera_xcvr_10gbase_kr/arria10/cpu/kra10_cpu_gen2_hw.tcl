...
# _hw.tcl file for kra10_cpu_gen2
package require -exact qsys 16.0

# module properties
set_module_property NAME {kra10_cpu_gen2}
set_module_property DISPLAY_NAME {kra10_cpu_gen2}
...
proc compose { } {
    ...
    #set_instance_system_info_value dmem {DEVICE_FAMILY} {" "} {"Arria 10"}
    ...
    #set_instance_system_info_value imem DEVICE_FAMILY {" "} {"Arria 10"}
    #set_instance_parameter_value dmem {deviceFamily} {"Arria 10"}

...
# _hw.tcl file for kr_ecc_cpu
package require -exact qsys 14.0

# module properties
set_module_property NAME {kr_ecc_cpu}
set_module_property DISPLAY_NAME {kr_ecc_cpu}
...
proc compose { } {
    ...
    set_instance_parameter_value nios2_gen2_0 {breakSlave} {Absolute}
    ...
    set_instance_parameter_value nios2_gen2_0 {setting_ecc_present} {1}
    ...
    set_instance_parameter_value nios2_gen2_0 {debug_enabled} {0}
    ...
    add_connection nios2_gen2_0.data_master ber_in.s1 avalon
    set_connection_parameter_value nios2_gen2_0.data_master/ber_in.s1 arbitrationPriority {1}
    set_connection_parameter_value nios2_gen2_0.data_master/ber_in.s1 baseAddress {0x00090030}
    set_connection_parameter_value nios2_gen2_0.data_master/ber_in.s1 defaultConnection {0}

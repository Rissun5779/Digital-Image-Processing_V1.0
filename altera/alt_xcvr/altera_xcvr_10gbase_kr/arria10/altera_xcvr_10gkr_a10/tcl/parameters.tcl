...
package provide altera_xcvr_10gkr_a10::parameters 18.1
...
namespace eval ::altera_xcvr_10gkr_a10::parameters:: {
  ...
  set parameters {\
    ...
    {device                                 false   false         STRING    NOVAL                 NOVAL                                     true                      false           NOVAL         NOVAL           NOVAL                               NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::chk_dev_unkown                      NOVAL}\
    ...
    {UNHIDE_312                             true    false         STRING    "false"               NOVAL                                     true                      false           NOVAL         NOVAL           NOVAL                               NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::chk_ini_312                          NOVAL}\
    ...
    \
    {SYNTH_FEC                              false   true          INTEGER   0                     NOVAL                                     true                      true            boolean       NOVAL           "FEC Options"                       "Include FEC sublayer"                                         ::altera_xcvr_10gkr_a10::parameters::validate_synth_fec                  "This will include FEC logic -Clause 74 implementation. Applicable only for 10G mode."}\
    {SYNTH_AN                               false   true          INTEGER   0                     NOVAL                                     true                      true            boolean       NOVAL           "Auto-Negotiation"                  "Enable Auto-Negotiation"                                      ::altera_xcvr_10gkr_a10::parameters::validate_kr1588                     "This will include Auto-Negotiatiation for Backplane -Clause 73 implementation."}\
    ...
    {LFT_R_MSB                              true    true          INTEGER   78                    NOVAL                                     true                      false           NOVAL         NOVAL           "Speed Detection"                   NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_lft_msb_kr                 "Link Fail Timer MSB for BASE-R PCS."}\
    {LFT_R_LSB                              true    true          INTEGER   750                   NOVAL                                     true                      false           NOVAL         NOVAL           "Speed Detection"                   NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_lft_lsb_kr                 "Link Fail Timer lsb for BASE-R PCS."}\
    {LFT_X_MSB                              true    true          INTEGER   7                     NOVAL                                     true                      false           NOVAL         NOVAL           "Speed Detection"                   NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_lft_msb_kx                 "Link Fail Timer MSB for BASE-X PCS."}\
    ...
    {LTD_MSB                                true    true          INTEGER   100                   NOVAL                                     true                      false           NOVAL         NOVAL           "Speed Detection"                   NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_1ms_msb                    NOVAL}\
    ...
    {MAINTAPWIDTH                           true    true          INTEGER   5                     NOVAL                                     "SYNTH_LT"                false           "columns:10"  NOVAL           "Link Training"                     NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_main_tapwidth               "Width of the Main Tap control."}\
    ...
    {VMAXRULE                               false   true          INTEGER   30                    NOVAL                                     "SYNTH_LT"                true            "columns:10"  NOVAL           "PMA parameters"                    NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_vmaxrule                    "Specifies the maximum VOD. The default value is 30 which represents 1200 mV."}\
    {VMINRULE                               false   true          INTEGER   6                     NOVAL                                     "SYNTH_LT"                true            "columns:10"  NOVAL           "PMA parameters"                    NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_vminrule                    "Specifies the minimum VOD. The default value is 6 which represents 165 mV."}\
    {VODMINRULE                             false   true          INTEGER   14                    NOVAL                                     "SYNTH_LT"                true            "columns:10"  NOVAL           "PMA parameters"                    NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_vodrule                     "Specifies the minimum VOD for the first tap. The default value is 14 which represents 440mV."}\
    {VPOSTRULE                              false   true          INTEGER   25                    NOVAL                                     "SYNTH_LT"                true            "columns:10"  NOVAL           "PMA parameters"                    NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_vpostrule                   "Specifies the maximum value that the internal algorithm for pre-emphasis will ever test in determining the optimum post-tap setting. The default value is 25."}\
    {VPRERULE                               false   true          INTEGER   16                    NOVAL                                     "SYNTH_LT"                true            "columns:10"  NOVAL           "PMA parameters"                    NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_vprerule                    "Specifies the maximum value that the internal algorithm for pre-emphasis will ever test in determining the optimum pre-tap setting. The default value is 16."}\
    {PREMAINVAL                             false   true          INTEGER   30                    NOVAL                                     "SYNTH_LT"                true            "columns:10"  NOVAL           "PMA parameters"                    NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_premainrule                 "Specifies the Preset VOD Value. Set by the Preset command as defined in Clause 72.6.10.2.3.1 of the link training protocol. This is the value from which the algorithm starts. The default value is 60.Preset Main tap value."}\
    ...
    {INITMAINVAL                            false   true          INTEGER   25                    NOVAL                                     "SYNTH_LT"                true            "columns:10"  NOVAL           "PMA parameters"                    NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_initmainrule                "Specifies the Initial VOD Value. Set by the Initialize command in Clause 72.6.10.2.3.2 of the link training protocol. The default value is 25."}\
    ...
    {INITPREVAL                             false   true          INTEGER   3                     NOVAL                                     "SYNTH_LT"                true            "columns:10"  NOVAL           "PMA parameters"                    NOVAL                                                          ::altera_xcvr_10gkr_a10::parameters::validate_initprepostrule             "Specifies the Initial Pre-tap Value. The default value is 3."}\
    ...
    {REF_CLK_FREQ_10G                       false   true          STRING    "644.53125"           {"644.53125" "322.265625"}                true                      true            NOVAL         MHz             "10GBASE-R"                         "Reference clock frequency"                                    ::altera_xcvr_10gkr_a10::parameters::validate_312_clk                     "PLL Reference clock frequency for 10GbE PLL."}\
    ...
    {USE_ECC_CPU                            false   true          INTEGER   0                     NOVAL                                     true                      true            boolean       NOVAL           "General options"                   "Enable M20K block ECC protection"                             ::altera_xcvr_10gkr_a10::parameters::validate_ecc                         "Enables error correction code (ECC) support on the embedded Nios cpu system. Only valid for the Backplane variant."}\
    {OPTIONAL_TXPMA_CLK                     false   false         INTEGER   0                     NOVAL                                     true                      true            boolean       NOVAL           "General options"                   "Enable tx_pma_clkout port"                                    NOVAL                                                                     "Enables the tx_pma_clkout port. This clock port is common for 1GbE and 10GbE mode. Disabling it for 10GBASE-KR will also affect 1GbE mode. This port is not to be used to clock the data interface."}\
    {OPTIONAL_RXPMA_CLK                     false   false         INTEGER   0                     NOVAL                                     true                      true            boolean       NOVAL           "General options"                   "Enable rx_pma_clkout port"                                    NOVAL                                                                     "Enables the rx_pma_clkout port. This clock port is common for 1GbE and 10GbE mode. Disabling it for 10GBASE-KR will also affect 1GbE mode. This port is not to be used to clock the data interface."}\
...
proc ::altera_xcvr_10gkr_a10::parameters::upgrade {ip_name version old_params} {
  variable parameter_upgrade_map
...
proc ::altera_xcvr_10gkr_a10::parameters::chk_dev_unkown {part_trait_bd device} {
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_kr1588 {SYNTH_1588_ALL SYNTH_AN SYNTH_LT} {
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_1588 { SYNTH_1588_ALL  SYNTH_GIGE} {
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_ecc {USE_ECC_CPU SYNTH_LT} {	
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_synth_fec { SYNTH_FEC SYNTH_1588_ALL} {
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_time_kr  {LINK_TIMER_KR phy_mgmt_clk_freq phy_mgmt_clk_freq_valid LINK_TIMER_KR_valid SYNTH_SEQ}  {
if {$SYNTH_SEQ} {	
    set phy_mgmt_clk_freq_valid [check_if_double "phy_mgmt_clk_freq" $phy_mgmt_clk_freq "phy_mgmt_clk_freq_valid"]
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_time_kx  {LINK_TIMER_KX phy_mgmt_clk_freq phy_mgmt_clk_freq_valid LINK_TIMER_KX_valid SYNTH_SEQ}  {
if {$SYNTH_SEQ} {	
    set phy_mgmt_clk_freq_valid [check_if_double "phy_mgmt_clk_freq" $phy_mgmt_clk_freq "phy_mgmt_clk_freq_valid"]
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_1ms_msb  {phy_mgmt_clk_freq phy_mgmt_clk_freq_valid}  {
 set phy_mgmt_clk_freq_valid [check_if_double "phy_mgmt_clk_freq" $phy_mgmt_clk_freq "phy_mgmt_clk_freq_valid"]
 if {$phy_mgmt_clk_freq_valid} {
...
proc ::altera_xcvr_10gkr_a10::parameters::chk_ini_312 { }  {
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_312_clk {SYNTH_1588_10G REF_CLK_FREQ_10G}  {
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_vmaxrule { VMAXRULE SYNTH_LT }  {
  if {$SYNTH_LT} {	
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_vminrule { VMAXRULE VMINRULE SYNTH_LT }  {
  if {$SYNTH_LT} {	
   out_of_range_message  0   $VMAXRULE $VMINRULE  error  "VMINRULE" 1 "Current value of VMINRULE is not valid. 0 &lt; VMINRULE &lt; VMAXRULE &lt; 31."  
  }   
}    

proc ::altera_xcvr_10gkr_a10::parameters::validate_vodrule { VMAXRULE VMINRULE VODMINRULE SYNTH_LT }  {
  if {$SYNTH_LT} {	
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_vpostrule { VPOSTRULE SYNTH_LT }  {
  if {$SYNTH_LT} {	
   out_of_range_message 0 25 $VPOSTRULE  error  "VPOSTRULE" 0 ""  
  }   
}    

proc ::altera_xcvr_10gkr_a10::parameters::validate_vprerule { VPRERULE SYNTH_LT }  {
  if {$SYNTH_LT} {	
   out_of_range_message 0 16 $VPRERULE  error  "VPRERULE" 0 ""  
  }   
}    

proc ::altera_xcvr_10gkr_a10::parameters::validate_premainrule { VMAXRULE VODMINRULE PREMAINVAL SYNTH_LT }  {
  if {$SYNTH_LT} {	
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_prepostrule { VMINRULE PREMAINVAL PREPOSTVAL PREPREVAL SYNTH_LT }  {
  if {$SYNTH_LT} {	
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_initmainrule { VMAXRULE VODMINRULE INITMAINVAL SYNTH_LT }  {
  if {$SYNTH_LT} {	
...
proc ::altera_xcvr_10gkr_a10::parameters::validate_initprepostrule { VMINRULE VPOSTRULE INITMAINVAL INITPOSTVAL INITPREVAL SYNTH_LT }  {
  if {$SYNTH_LT} {	

...
set module {\
  ...
  {alt_xcvr_12_bus_split   16.1    true     alt_xcvr_12_bus_split_val_callback      alt_xcvr_12_bus_split_elab_callback     "Design Example 1:2 bus splitter (uneven)"    "Interface Protocols/Transceiver PHY"   "Altera Corporation" }\
}
...
set filesets {\
  ...
  {quartus_synth   QUARTUS_SYNTH   callback_quartus_synth  alt_xcvr_12_bus_split_top}\
  {sim_verilog     SIM_VERILOG     callback_sim_verilog    alt_xcvr_12_bus_split_top}\
  {sim_vhdl        SIM_VHDL        callback_sim_vhdl       alt_xcvr_12_bus_split_top}\
}
...
set parameters {\
  ...
  {DWIDTH_I1            integer  false   true           66            NOVAL        NOVAL          true          true  }\
  {DWIDTH_O1            integer  false   true           64            NOVAL        NOVAL          true          true  }\
  {DWIDTH_O2            integer  false   true           2             NOVAL        NOVAL          true          true  }\
...
set ports {\
 ...
 {data_out2                  output     CHANNELS*DWIDTH_O2         data_out2           data_out2            true     gui_split_interfaces    DWIDTH_O2         CHANNELS        conduit      end               false         NOVAL                   }\
}                                                                                          
...
proc alt_xcvr_12_bus_split_val_callback {} {
  ip_validate_parameters
}

proc alt_xcvr_12_bus_split_elab_callback {} {
  ip_elaborate_interfaces
}

proc callback_quartus_synth { entity } {
  add_fileset_file ./alt_xcvr_12_bus_split_top.v VERILOG PATH ./alt_xcvr_12_bus_split_top.sv
  add_fileset_file ./alt_xcvr_12_bus_split.v VERILOG PATH ./alt_xcvr_12_bus_split.sv
}

...
//---------------------------------------------------------------------
task avalon_write_extract_avalon;
  input integer address;
  input integer data;
...
begin
  ...
  reg_base_addr = temp_address;
  reg_burstcount = 6'b000001;
  reg_write_extract_avalon = 1'b1;
  reg_writedata = temp_data;
  reg_read_extract_avalon = 1'b0;

  @(posedge reg_clk);
  #1;

  break = 0;
  while (break < TB_AVALON_TIMEOUT && reg_waitrequest_extract_avalon == 1'b1) begin
    @(posedge reg_clk);
    #1;
    break = break + 1;
  end
      
  reg_write_extract_avalon = 0;
  reg_base_addr = 0;
  reg_writedata = 0;
...
begin
  ...
  reg_base_addr = temp_address;
  reg_burstcount = 6'b000001;
  reg_write_extract_avalon = 1'b0;
  reg_writedata = 0;
  reg_read_extract_avalon = 1'b1;
  @(posedge reg_clk);
  #1;
  reg_read_extract_avalon = 1'b0;
  @(posedge reg_clk);
...
//---------------------------------------------------------------------
task avalon_write_embed_avalon;
  input integer address;
  input integer data;
...
begin
  ...
  reg_base_addr = temp_address;
  reg_burstcount = 6'b000001;
  reg_write_embed_avalon = 1'b1;
  reg_writedata = temp_data;
  reg_read_embed_avalon = 1'b0;

  @(posedge reg_clk);
  #1;

  break = 0;
  while (break < TB_AVALON_TIMEOUT && reg_waitrequest_embed_avalon == 1'b1) begin
    @(posedge reg_clk);
    #1;
    break = break + 1;
  end
      
  reg_write_embed_avalon = 0;
  reg_base_addr = 0;
  reg_writedata = 0;
...
begin
  ...
  reg_base_addr = temp_address;
  reg_burstcount = 6'b000001;
  reg_write_embed_avalon = 1'b0;
  reg_writedata = 0;
  reg_read_embed_avalon = 1'b1;
  @(posedge reg_clk);
  #1;
  reg_read_embed_avalon = 1'b0;
  @(posedge reg_clk);
  #1;
  reg_base_addr = 0;
  data = reg_readdata_embed_avalon;
  #1;

...
//------------------------------------------------------------------------------
  ...
  assign aud_p_coverage = csb ^ aud_sample[7 ] ^ aud_sample[6 ] ^ 
           aud_clk48_d2   ^ aud_sample[3] ^ aud_sample[2] ^ aud_sample[1] ^ aud_sample[0] ^ aud_sample[6] ^ aud_sample[5] ^ aud_sample[4] ^
           aud_sample[3] ^ aud_sample[2] ^ aud_sample[1] ^ aud_sample[0] ^ aud_sample[11] ^ aud_sample[10] ^ aud_sample[9 ] ^ aud_sample[8 ] ^
           aud_sample[7 ] ^ aud_sample[6 ] ^ aud_sample[5 ] ^ aud_sample[4 ] ^ aud_sample[3 ] ^ aud_sample[2 ] ^ aud_sample[1 ] ^ aud_sample[0 ];

  //when G_COVERAGE=1 drive U and V to increase coverage
  assign aud_word = (G_COVERAGE==1) ? {aud_p_coverage , csb , aud_sample[7:6] , aud_clk48_d2 , aud_sample[6:0] , aud_sample[11:0] , aud_sample[3:0] , 2'b00 , (aud_z & ~ aud_clk48_d2) , aud_clk48_d2} : {aud_p , csb , 2'b00 , aud_clk48_d2 , aud_sample , aud_sample[3:0] , 2'b00 , (aud_z & ~ aud_clk48_d2) , aud_clk48_d2};

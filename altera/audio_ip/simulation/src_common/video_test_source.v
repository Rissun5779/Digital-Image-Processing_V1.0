...
module video_test_source (
  ...
  parameter G_VID_INTERFACE = 0;   //0=SD, 1=HD, 2=3GA, 3=3GB
  parameter G_VID_RESOLUTION = 0;  //0=SD, 1=720p, 2=1080i, 3=1080p (ignored for SD interface)
  parameter G_VID_FRAMERATE = 30;   //24/25/29/30/50,59,60
...
//------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------
  generate
  if (G_VID_INTERFACE == 0 ) begin : G_SD_TEST


    assign src_vid_std = (G_VID_FRAMERATE==25) ? {8'b10000001 , 8'b00000101 , 8'b00000000 , 8'b00000000} : {8'b10000001 , 8'b00000110 , 8'b00000000 , 8'b00000000};
  ...
  generate
  if (G_VID_INTERFACE == 1 ) begin : G_HD_TEST


    assign src_vid_std = (G_VID_RESOLUTION==1) ? {8'b10000100 , 8'b01001011 , 8'b10000000 , 8'b00000000} : {8'b10000101 , 8'b00000111 , 8'b10000000 , 8'b00000000};
  ...
  generate
  if (G_VID_INTERFACE == 2 ) begin : G_3GA_TEST


    assign src_vid_std = {8'b10001001 , 8'b11001010 , 8'b10000000 , 8'b00000000};
  ...
  generate
  if (G_VID_INTERFACE == 3 ) begin : G_3GB_TEST

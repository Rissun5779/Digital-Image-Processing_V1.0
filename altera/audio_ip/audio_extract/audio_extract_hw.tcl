...
set_module_property DISPLAY_NAME "Audio Extract Intel FPGA IP"
...
set_module_property SUPPORTED_DEVICE_FAMILIES {{Stratix} {Stratix GX} {Stratix II} {Stratix II GX} {Stratix III} {Stratix IV} {Stratix V} {Arria GX} {Arria II GX} {Arria II GZ}  {Arria V} {Arria V GZ} {HardCopy IV} {Cyclone} {Cyclone II} {Cyclone III} {Cyclone III LS} {Cyclone IV E} {Cyclone IV GX} {Cyclone V}}
# | 
# +-----------------------------------
...
proc my_elaboration_callback {} {
  ...
  if { $avalon_st > 0 } {
    ...
    add_interface_port conduit_audio aud_ready export Input 1
    add_interface_port conduit_audio aud_valid export Output 1
    add_interface_port conduit_audio aud_sop export Output 1
    add_interface_port conduit_audio aud_eop export Output 1
    add_interface_port conduit_audio aud_channel export Output 8
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/sam1425277356256/sam1425277101341
add_documentation_link "Release Notes" https://documentation.altera.com/#/link/hco1421698042087/hco1421697950421

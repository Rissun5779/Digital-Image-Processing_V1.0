...
set_module_property DISPLAY_NAME "Clocked Audio Output Intel FPGA IP"
...
proc my_elaboration_callback {} {
  ...
  add_interface_port control reg_address address Input 3
  ...
  if { $avalon_mm > 0 } {
    set_port_property reg_address termination false
    ...
    set_port_property reg_address termination true

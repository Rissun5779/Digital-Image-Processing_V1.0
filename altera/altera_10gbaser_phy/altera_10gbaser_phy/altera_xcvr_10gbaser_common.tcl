...
proc decl_fileset_groups { phy_root } {
    ...
    #
    # Avalon stuff
    common_fileset_group_plain ./ "$phy_root/soft_pcs/" altera_10gbaser_phy_clock_crosser.v {ALL_HDL}
    common_fileset_group_plain ./ "$phy_root/soft_pcs/" altera_10gbaser_phy_pipeline_stage.sv {ALL_HDL}
    common_fileset_group_plain ./ "$phy_root/soft_pcs/" altera_10gbaser_phy_pipeline_base.v {ALL_HDL}
    common_fileset_group_plain ./ "$phy_root/../primitives/altera_std_synchronizer/" altera_std_synchronizer_nocut.v {ALL_HDL}
    ...
    common_fileset_group_encrypted ./ "$phy_root/sv_soft_pcs/" {
	altera_10gbaser_phy_async_fifo.sv
	altera_10gbaser_phy_async_fifo_fpga.sv 
	altera_10gbaser_phy_rx_fifo.v
    } {S5SOFT}
    ...
    common_fileset_group ./ "$phy_root/sv_soft_pcs/" OTHER {
	alt_10gbaser_phy.sdc
    } {S5} {QENCRYPT}

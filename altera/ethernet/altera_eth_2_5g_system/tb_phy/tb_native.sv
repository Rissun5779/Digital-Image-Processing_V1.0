...
module tb;
   ...
   clock_divider U_tx_clk_divider(
	...
	.gmii_tx_en(tx_gmii_enable),       //   gmii_tx_enable.data
        .tx_serial_clk0(clk_1562p5),    //  tx_serial_clk.clk        
	.rx_cdr_refclk_clk(clk_125),          //          rx_cdr_refclk.clk
	...
	.rx_recovered_clk(rx_recovered_clk),                      //   rx_recovered_clk.clk
        .tx_analogreset_tx_analogreset(tx_analogreset),                   //          tx_analogreset.tx_analogreset
        .tx_digitalreset_tx_digitalreset(tx_digitalreset),                 //         tx_digitalreset.tx_digitalreset
        .rx_analogreset_rx_analogreset(rx_analogreset),                   //          rx_analogreset.rx_analogreset
        .rx_digitalreset_rx_digitalreset(rx_digitalreset),                 //         rx_digitalreset.rx_digitalreset
        .tx_cal_busy_tx_cal_busy(tx_cal_busy),                         //             tx_cal_busy.tx_cal_busy
        .rx_cal_busy_rx_cal_busy(rx_cal_busy),                         //             rx_cal_busy.rx_cal_busy
        .rx_is_lockedtoref_rx_is_lockedtoref(),             //       rx_is_lockedtoref.rx_is_lockedtoref
        .rx_is_lockedtodata_rx_is_lockedtodata(rx_is_lockedtodata),           //      rx_is_lockedtodata.rx_is_lockedtodata        
	...
	.reconfig_clk_clk(clk_125),                      //       reconfig_clk.clk
	.reconfig_reset_reset(reset),                  //     reconfig_reset.reset
	.reconfig_avmm_write(1'b0),                   //      reconfig_avmm.write
	.reconfig_avmm_read(1'b0),                    //                   .read
	.reconfig_avmm_address(10'b0),                 //                   .address
	.reconfig_avmm_writedata(32'b0),               //                   .writedata
	.reconfig_avmm_readdata(),                //                   .readdata
	.reconfig_avmm_waitrequest(),             //                   .waitrequest       

...
#set_parameter_property DEVICE_FAMILY ALLOWED_RANGES {"Arria II GX" "Stratix IV" "Arria V" "Arria V GZ" "Stratix V" "Cyclone V" "Arria 10"}
...
proc compose {} {
    ...
    # Arria 10 clock source
    add_interface tx_serial_clk conduit end
    set_interface_property tx_serial_clk EXPORT_OF eth_2_5G_phy.tx_serial_clk
    set_interface_property tx_serial_clk  PORT_NAME_MAP   {tx_serial_clk0 tx_serial_clk0}	

    add_interface rx_cdr_refclk conduit end
    set_interface_property rx_cdr_refclk EXPORT_OF eth_2_5G_phy.rx_cdr_refclk
    set_interface_property rx_cdr_refclk PORT_NAME_MAP   {rx_cdr_refclk rx_cdr_refclk}
    ...
    set_interface_property tx_ready EXPORT_OF eth_2_5G_phy.tx_ready
    set_interface_property tx_ready  PORT_NAME_MAP   {tx_ready tx_ready}

    add_interface rx_ready conduit end
    set_interface_property rx_ready EXPORT_OF eth_2_5G_phy.rx_ready
    set_interface_property rx_ready  PORT_NAME_MAP   {rx_ready rx_ready}
    ...
    foreach {phyip_conduit_interface} {
        ...
        set_interface_property $phyip_conduit_interface EXPORT_OF eth_2_5G_phy.$phyip_conduit_interface
    ...
    add_interface reconfig_reset conduit end
    set_interface_property reconfig_reset EXPORT_OF eth_2_5G_phy.reconfig_reset
      
    add_interface reconfig_avmm conduit end
    set_interface_property reconfig_avmm EXPORT_OF eth_2_5G_phy.reconfig_avmm
...
proc testbench_proc { none } {
    ...
    if {$configuration == "0"} {
      if {[_is_phy_ip] == "5"} {
        add_fileset_file tb.sv SYSTEM_VERILOG PATH $path/tb_native.sv 
        add_fileset_file nf_phyip_reset_model.v VERILOG PATH $path/nf_phyip_reset_model.v     
      } elseif {[_is_phy_ip] == "1" || [_is_phy_ip] == "2" || [_is_phy_ip] == "3" || [_is_phy_ip] == "4"} {
        add_fileset_file tb.sv SYSTEM_VERILOG PATH $path/tb_phy.sv 
      } else {
        add_fileset_file tb.sv SYSTEM_VERILOG PATH $path/tb.sv 
      }
      add_fileset_file avalon_bfm_wrapper.sv SYSTEM_VERILOG PATH $path/avalon_bfm_wrapper.sv 
      add_fileset_file avalon_checker.v VERILOG PATH $path/avalon_checker.v 
      add_fileset_file avalon_driver.sv VERILOG PATH $path/avalon_driver.sv 
      add_fileset_file avalon_gmii_converter.v VERILOG PATH $path/avalon_gmii_converter.v 
      add_fileset_file avalon_if_params_pkg.sv VERILOG PATH $path/avalon_if_params_pkg.sv 
      add_fileset_file avalon_st_eth_packet_monitor.sv VERILOG PATH $path/avalon_st_eth_packet_monitor.sv 
      add_fileset_file clock_divider.v VERILOG PATH $path/clock_divider.v 
      add_fileset_file eth_mac_frame.sv VERILOG PATH $path/eth_mac_frame.sv 
      add_fileset_file eth_register_map_params_pkg.sv VERILOG PATH $path/eth_register_map_params_pkg.sv 
      add_fileset_file gmii_to_avalon_convertor.v VERILOG PATH $path/gmii_to_avalon_convertor.v 
      add_fileset_file altera_tse_gmii_rx_aligner_16b.v VERILOG PATH $path/altera_tse_gmii_rx_aligner_16b.v
      add_fileset_file tb_run.tcl OTHER PATH $path/tb_run.tcl 
      add_fileset_file tb_ncsim_run.sh OTHER PATH $path/tb_ncsim_run.sh
      add_fileset_file tb_vcs_run.sh OTHER PATH $path/tb_vcs_run.sh
    } else {
      if {[_is_phy_ip] == "5"} {
        add_fileset_file tb.sv SYSTEM_VERILOG PATH $path/tb_native.sv 
        add_fileset_file nf_phyip_reset_model.v VERILOG PATH $path/nf_phyip_reset_model.v     
      ...
      add_fileset_file avalon_bfm_wrapper.sv VERILOG PATH $path/avalon_bfm_wrapper.sv
      add_fileset_file avalon_driver.sv VERILOG PATH $path/avalon_driver.sv
      add_fileset_file avalon_if_params_pkg.sv VERILOG PATH $path/avalon_if_params_pkg.sv
      add_fileset_file avalon_st_eth_packet_monitor.sv VERILOG PATH $path/avalon_st_eth_packet_monitor.sv
      add_fileset_file eth_mac_frame.sv VERILOG PATH $path/eth_mac_frame.sv

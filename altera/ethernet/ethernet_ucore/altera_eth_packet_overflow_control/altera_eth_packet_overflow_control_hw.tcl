...
# +-----------------------------------
# | module altera_eth_packet_overflow_control
# | 
set_module_property DESCRIPTION "Packet Ethernet Packet Overflow Control"
set_module_property NAME altera_eth_packet_overflow_control
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property GROUP "Interface Protocols/Ethernet/Submodules"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Ethernet Packet Overflow Control"
set_module_property TOP_LEVEL_HDL_FILE altera_eth_packet_overflow_control.v
set_module_property TOP_LEVEL_HDL_MODULE altera_eth_packet_overflow_control
...
set_fileset_property simulation_verilog TOP_LEVEL altera_eth_packet_overflow_control

proc sim_ver {name} {
    if {1} {
        add_fileset_file mentor/altera_eth_packet_overflow_control.v VERILOG_ENCRYPT PATH "mentor/altera_eth_packet_overflow_control.v" {MENTOR_SPECIFIC}
    }
    if {1} {
        add_fileset_file aldec/altera_eth_packet_overflow_control.v VERILOG_ENCRYPT PATH "aldec/altera_eth_packet_overflow_control.v" {ALDEC_SPECIFIC}
    }
    if {1} {
        add_fileset_file cadence/altera_eth_packet_overflow_control.v VERILOG_ENCRYPT PATH "cadence/altera_eth_packet_overflow_control.v" {CADENCE_SPECIFIC}
    }
    if {1} {
        add_fileset_file synopsys/altera_eth_packet_overflow_control.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_packet_overflow_control.v" {SYNOPSYS_SPECIFIC}
    }
}
...
# | files
# | 
add_file altera_eth_packet_overflow_control.v {SYNTHESIS}
add_file altera_eth_packet_overflow_control.ocp {SYNTHESIS}
# | 
# +-----------------------------------
...
add_parameter ERROR_WIDTH INTEGER 1 "ERROR_WIDTH refers to the width of the error bits at the sink interface"
...
set_parameter_property ERROR_WIDTH DESCRIPTION "ERROR_WIDTH refers to the width of the error bits at the sink interface"
...
add_interface_port avalon_streaming_source data_src_error error Output "(ERROR_WIDTH) - (0) + 1"
# | 
# +-----------------------------------

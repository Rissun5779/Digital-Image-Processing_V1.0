...
add_file altera_eth_timestamp_aligner_sc_fifo.v {SYNTHESIS}
# | 
# +-----------------------------------
...
proc sim_ver {name} {
    ...
    add_fileset_file altera_eth_timestamp_aligner_sc_fifo.v VERILOG PATH "altera_eth_timestamp_aligner_sc_fifo.v"
}

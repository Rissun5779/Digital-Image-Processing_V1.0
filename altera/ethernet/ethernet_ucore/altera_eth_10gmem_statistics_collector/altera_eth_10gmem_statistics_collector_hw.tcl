...
# | 
set_module_property NAME altera_eth_10gmem_statistics_collector
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property GROUP "Interface Protocols/Ethernet/Submodules"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Ethernet 10G Statistics Collector in Memory"
set_module_property DESCRIPTION "Altera Ethernet 10G Statistics Collector using Memory"
set_module_property TOP_LEVEL_HDL_FILE altera_eth_10gmem_statistics_collector.v
set_module_property TOP_LEVEL_HDL_MODULE altera_eth_10gmem_statistics_collector
...
set_fileset_property simulation_verilog TOP_LEVEL altera_eth_10gmem_statistics_collector

proc sim_ver {name} {
    if {1} {
        add_fileset_file mentor/altera_eth_10gmem_statistics_collector.v VERILOG_ENCRYPT PATH "mentor/altera_eth_10gmem_statistics_collector.v" {MENTOR_SPECIFIC}
    }
    if {1} {
        add_fileset_file aldec/altera_eth_10gmem_statistics_collector.v VERILOG_ENCRYPT PATH "aldec/altera_eth_10gmem_statistics_collector.v" {ALDEC_SPECIFIC}
    }
    if {1} {
        add_fileset_file cadence/altera_eth_10gmem_statistics_collector.v VERILOG_ENCRYPT PATH "cadence/altera_eth_10gmem_statistics_collector.v" {CADENCE_SPECIFIC}
    }
    if {1} {
        add_fileset_file synopsys/altera_eth_10gmem_statistics_collector.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_10gmem_statistics_collector.v" {SYNOPSYS_SPECIFIC}
    }
}
...
# | files
# | 
add_file altera_eth_10gmem_statistics_collector.v {SYNTHESIS}
add_file altera_eth_10gmem_statistics_collector.ocp {SYNTHESIS}
# | 
# +-----------------------------------
...
set_parameter_property STATUS_WIDTH DERIVED false

...
set_module_property TOP_LEVEL_HDL_FILE altera_eth_avst2gmii_converter.v
set_module_property TOP_LEVEL_HDL_MODULE altera_eth_avst2gmii_converter
...
# | files
# | 
add_file altera_eth_avst2gmii_converter.v {SYNTHESIS}
# | 
# +-----------------------------------
...
set_fileset_property simulation_verilog TOP_LEVEL altera_eth_avst2gmii_converter

proc sim_ver {name} {
    if {1} {
        add_fileset_file mentor/altera_eth_avst2gmii_converter.v VERILOG_ENCRYPT PATH "mentor/altera_eth_avst2gmii_converter.v" {MENTOR_SPECIFIC}
    }
    if {1} {
        add_fileset_file aldec/altera_eth_avst2gmii_converter.v VERILOG_ENCRYPT PATH "aldec/altera_eth_avst2gmii_converter.v" {ALDEC_SPECIFIC}
    }
    if {1} {
        add_fileset_file cadence/altera_eth_avst2gmii_converter.v VERILOG_ENCRYPT PATH "cadence/altera_eth_avst2gmii_converter.v" {CADENCE_SPECIFIC}
    }
    if {1} {
        add_fileset_file synopsys/altera_eth_avst2gmii_converter.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_avst2gmii_converter.v" {SYNOPSYS_SPECIFIC}
    }
}

...
# +-----------------------------------
# | module altera_eth_pad_inserter
# | 
set_module_property NAME altera_eth_pad_inserter
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property GROUP "Interface Protocols/Ethernet/Submodules"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Ethernet Pad Inserter"
set_module_property DESCRIPTION "Altera Ethernet Pad Inserter"
set_module_property TOP_LEVEL_HDL_FILE altera_eth_pad_inserter.v
set_module_property TOP_LEVEL_HDL_MODULE altera_eth_pad_inserter
...
set_fileset_property simulation_verilog TOP_LEVEL altera_eth_pad_inserter

proc sim_ver {name} {
    if {1} {
        add_fileset_file mentor/altera_eth_pad_inserter.v VERILOG_ENCRYPT PATH "mentor/altera_eth_pad_inserter.v" {MENTOR_SPECIFIC}
    }
    if {1} {
        add_fileset_file aldec/altera_eth_pad_inserter.v VERILOG_ENCRYPT PATH "aldec/altera_eth_pad_inserter.v" {ALDEC_SPECIFIC}
    }
    if {1} {
        add_fileset_file cadence/altera_eth_pad_inserter.v VERILOG_ENCRYPT PATH "cadence/altera_eth_pad_inserter.v" {CADENCE_SPECIFIC}
    }
    if {1} {
        add_fileset_file synopsys/altera_eth_pad_inserter.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_pad_inserter.v" {SYNOPSYS_SPECIFIC}
    }
}
...
proc elaborate {} {
  ...
  if {$empty_width > 0} {
    ...
    set_port_property data_sink_empty TERMINATION true
    set_port_property data_sink_empty TERMINATION_VALUE 0
  ...
  set_port_property csr_writedata VHDL_TYPE STD_LOGIC_VECTOR  
  set_port_property csr_readdata VHDL_TYPE STD_LOGIC_VECTOR
}

# +-----------------------------------
# | files
# | 
add_file altera_eth_pad_inserter.v {SYNTHESIS}
add_file altera_eth_pad_inserter.ocp {SYNTHESIS}
# | 
# +-----------------------------------
...
# | parameters
# | 
# BITSPERSYMBOL is disabled. User cannot modify this parameter. However it is still visible in the GUI.
...
set_parameter_property BITSPERSYMBOL IS_HDL_PARAMETER false

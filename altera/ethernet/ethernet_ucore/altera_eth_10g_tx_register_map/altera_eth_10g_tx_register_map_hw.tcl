...
# +-----------------------------------
# | module altera_eth_10g_tx_register_map
# | 
set_module_property DESCRIPTION "Altera Ethernet 10G MAC TX Register Map"
set_module_property NAME altera_eth_10g_tx_register_map
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property GROUP "Interface Protocols/Ethernet/Submodules"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Ethernet 10G MAC TX Register Map"
set_module_property TOP_LEVEL_HDL_FILE altera_eth_10g_tx_register_map.v
set_module_property TOP_LEVEL_HDL_MODULE altera_eth_10g_tx_register_map
...
set_fileset_property simulation_verilog TOP_LEVEL altera_eth_10g_tx_register_map

proc sim_ver {name} {
    if {1} {
        add_fileset_file mentor/altera_eth_10g_tx_register_map.v VERILOG_ENCRYPT PATH "mentor/altera_eth_10g_tx_register_map.v" {MENTOR_SPECIFIC}
    }
    if {1} {
        add_fileset_file aldec/altera_eth_10g_tx_register_map.v VERILOG_ENCRYPT PATH "aldec/altera_eth_10g_tx_register_map.v" {ALDEC_SPECIFIC}
    }
    if {1} {
        add_fileset_file cadence/altera_eth_10g_tx_register_map.v VERILOG_ENCRYPT PATH "cadence/altera_eth_10g_tx_register_map.v" {CADENCE_SPECIFIC}
    }
    if {1} {
        add_fileset_file synopsys/altera_eth_10g_tx_register_map.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_10g_tx_register_map.v" {SYNOPSYS_SPECIFIC}
    }
...
proc elaborate {} {
    if {[ get_parameter_value ENABLE_1G10G_MAC ] == 0} {
        set_interface_property tx_1g_clk ENABLED false
        set_interface_property tx_1g_reset ENABLED false
        
        set_port_property tx_1g_clk TERMINATION true
        set_port_property tx_1g_reset TERMINATION true
        
        set_port_property tx_1g_clk TERMINATION_VALUE 0
        set_port_property tx_1g_reset TERMINATION_VALUE 1
    }
...
# | files
# | 
add_file altera_eth_10g_tx_register_map.v {SYNTHESIS}
add_file altera_eth_10g_tx_register_map.ocp {SYNTHESIS}
...
# TX 10G
add_interface tx_10g_clk clock end
set_interface_property tx_10g_clk ENABLED true
add_interface_port tx_10g_clk tx_10g_clk clk Input 1

add_interface tx_10g_reset reset end
set_interface_property tx_10g_reset ENABLED true
set_interface_property tx_10g_reset associatedClock tx_10g_clk
add_interface_port tx_10g_reset tx_10g_reset reset Input 1

# TX 1G
add_interface tx_1g_clk clock end
set_interface_property tx_1g_clk ENABLED true
add_interface_port tx_1g_clk tx_1g_clk clk Input 1

add_interface tx_1g_reset reset end
set_interface_property tx_1g_reset ENABLED true
set_interface_property tx_1g_reset associatedClock tx_1g_clk
add_interface_port tx_1g_reset tx_1g_reset reset Input 1
...
set_interface_property tsu_period_ns_fns_10g_src associatedClock tx_10g_clk
set_interface_property tsu_period_ns_fns_10g_src associatedReset tx_10g_reset
...
set_interface_property tsu_adjust_ns_fns_10g_src associatedClock tx_10g_clk
set_interface_property tsu_adjust_ns_fns_10g_src associatedReset tx_10g_reset
...
set_interface_property tsu_period_ns_fns_1g_src associatedClock tx_1g_clk
set_interface_property tsu_period_ns_fns_1g_src associatedReset tx_1g_reset
...
set_interface_property tsu_adjust_ns_fns_1g_src associatedClock tx_1g_clk
set_interface_property tsu_adjust_ns_fns_1g_src associatedReset tx_1g_reset

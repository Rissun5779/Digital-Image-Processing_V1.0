...
add_file altera_eth_gmii_crc328generator.v {SYNTHESIS}
add_file altera_eth_gmii_crc32ctl8.v {SYNTHESIS}
add_file altera_eth_gmii_crc32galois8.v {SYNTHESIS}
...
proc sim_ver {name} {
    if {1} {
        ...
        add_fileset_file mentor/altera_eth_gmii_crc328generator.v VERILOG_ENCRYPT PATH "mentor/altera_eth_gmii_crc328generator.v" {MENTOR_SPECIFIC}
        add_fileset_file mentor/altera_eth_gmii_crc32ctl8.v VERILOG_ENCRYPT PATH "mentor/altera_eth_gmii_crc32ctl8.v" {MENTOR_SPECIFIC}
        add_fileset_file mentor/altera_eth_gmii_crc32galois8.v VERILOG_ENCRYPT PATH "mentor/altera_eth_gmii_crc32galois8.v" {MENTOR_SPECIFIC}
    }
    if {1} {
        add_fileset_file aldec/altera_eth_gmii_crc.v VERILOG_ENCRYPT PATH "aldec/altera_eth_gmii_crc.v" {ALDEC_SPECIFIC}
        add_fileset_file aldec/altera_eth_gmii_crc328generator.v VERILOG_ENCRYPT PATH "aldec/altera_eth_gmii_crc328generator.v" {ALDEC_SPECIFIC}
        add_fileset_file aldec/altera_eth_gmii_crc32ctl8.v VERILOG_ENCRYPT PATH "aldec/altera_eth_gmii_crc32ctl8.v" {ALDEC_SPECIFIC}
        add_fileset_file aldec/altera_eth_gmii_crc32galois8.v VERILOG_ENCRYPT PATH "aldec/altera_eth_gmii_crc32galois8.v" {ALDEC_SPECIFIC}
    }
    if {1} {
        add_fileset_file cadence/altera_eth_gmii_crc.v VERILOG_ENCRYPT PATH "cadence/altera_eth_gmii_crc.v" {CADENCE_SPECIFIC}
        add_fileset_file cadence/altera_eth_gmii_crc328generator.v VERILOG_ENCRYPT PATH "cadence/altera_eth_gmii_crc328generator.v" {CADENCE_SPECIFIC}
        add_fileset_file cadence/altera_eth_gmii_crc32ctl8.v VERILOG_ENCRYPT PATH "cadence/altera_eth_gmii_crc32ctl8.v" {CADENCE_SPECIFIC}
        add_fileset_file cadence/altera_eth_gmii_crc32galois8.v VERILOG_ENCRYPT PATH "cadence/altera_eth_gmii_crc32galois8.v" {CADENCE_SPECIFIC}
    }
    if {1} {
        add_fileset_file synopsys/altera_eth_gmii_crc.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_gmii_crc.v" {SYNOPSYS_SPECIFIC}
        add_fileset_file synopsys/altera_eth_gmii_crc328generator.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_gmii_crc328generator.v" {SYNOPSYS_SPECIFIC}
        add_fileset_file synopsys/altera_eth_gmii_crc32ctl8.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_gmii_crc32ctl8.v" {SYNOPSYS_SPECIFIC}
        add_fileset_file synopsys/altera_eth_gmii_crc32galois8.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_gmii_crc32galois8.v" {SYNOPSYS_SPECIFIC}
    }
}

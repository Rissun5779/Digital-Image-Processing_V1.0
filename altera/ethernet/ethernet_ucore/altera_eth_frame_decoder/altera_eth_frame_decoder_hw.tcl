...
proc sim_ver {name} {
    ...
    add_fileset_file altera_eth_frame_decoder_pipeline_stage.sv SYSTEM_VERILOG PATH altera_eth_frame_decoder_pipeline_stage.sv
    add_fileset_file altera_eth_frame_decoder_pipeline_base.v VERILOG PATH altera_eth_frame_decoder_pipeline_base.v
}

proc sim_vhd {name} {
   if {1} {
      add_fileset_file mentor/altera_eth_frame_decoder.v VERILOG_ENCRYPT PATH "mentor/altera_eth_frame_decoder.v" {MENTOR_SPECIFIC}
	add_fileset_file mentor/altera_eth_frame_decoder_pipeline_base.v VERILOG_ENCRYPT PATH "mentor/altera_eth_frame_decoder_pipeline_base.v" {MENTOR_SPECIFIC}
	add_fileset_file mentor/altera_eth_frame_decoder_pipeline_stage.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_eth_frame_decoder_pipeline_stage.sv" {MENTOR_SPECIFIC}
   }
   if {1} {
      add_fileset_file aldec/altera_eth_frame_decoder.v VERILOG_ENCRYPT PATH "aldec/altera_eth_frame_decoder.v" {ALDEC_SPECIFIC}
	add_fileset_file aldec/altera_eth_frame_decoder_pipeline_base.v VERILOG_ENCRYPT PATH "aldec/altera_eth_frame_decoder_pipeline_base.v" {ALDEC__SPECIFIC}
	add_fileset_file aldec/altera_eth_frame_decoder_pipeline_stage.sv SYSTEM_VERILOG_ENCRYPT PATH "aldec/altera_eth_frame_decoder_pipeline_stage.sv" {ALDEC__SPECIFIC}
   }
   if {1} {
      add_fileset_file cadence/altera_eth_frame_decoder.v VERILOG_ENCRYPT PATH "cadence/altera_eth_frame_decoder.v" {CADENCE_SPECIFIC}
	add_fileset_file cadence/altera_eth_frame_decoder_pipeline_base.v VERILOG_ENCRYPT PATH "cadence/altera_eth_frame_decoder_pipeline_base.v" {CADENCE_SPECIFIC}
	add_fileset_file cadence/altera_eth_frame_decoder_pipeline_stage.sv SYSTEM_VERILOG_ENCRYPT PATH "cadence/altera_eth_frame_decoder_pipeline_stage.sv" {CADENCE_SPECIFIC}
   }
   if {1} {
      add_fileset_file synopsys/altera_eth_frame_decoder.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_frame_decoder.v" {SYNOPSYS_SPECIFIC}
	add_fileset_file synopsys/altera_eth_frame_decoder_pipeline_base.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_frame_decoder_pipeline_base.v" {SYNOPSYS_SPECIFIC}   
	add_fileset_file synopsys/altera_eth_frame_decoder_pipeline_stage.sv SYSTEM_VERILOG_ENCRYPT PATH "synopsys/altera_eth_frame_decoder_pipeline_stage.sv" {SYNOPSYS_SPECIFIC}   
   }
}
...
add_file altera_eth_frame_decoder_pipeline_stage.sv {SYNTHESIS}
add_file altera_eth_frame_decoder_pipeline_base.v {SYNTHESIS}
# | 
# +-----------------------------------
...
add_interface_port avalom_mm_csr csr_address address Input 6

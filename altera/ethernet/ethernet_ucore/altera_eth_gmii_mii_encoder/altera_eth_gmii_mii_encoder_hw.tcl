...
proc q_synth {name} {
    ...
    add_fileset_file altera_eth_gmii_mii_encoder_dc_fifo.sdc SDC PATH altera_eth_gmii_mii_encoder_dc_fifo.sdc
    
    if {$enable_timestamping} {
        add_fileset_file altera_eth_gmii2avst_converter.v VERILOG PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii2avst_converter/altera_eth_gmii2avst_converter.v"
        add_fileset_file altera_eth_gmii_tsu.v VERILOG PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_tsu/altera_eth_gmii_tsu.v"
        add_fileset_file altera_eth_gmii_tsu.ocp OTHER PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_tsu/altera_eth_gmii_tsu.ocp"
    }
    
    if {$enable_ptp_1step} {
        add_fileset_file altera_eth_gmii_ptp_inserter.v VERILOG PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_ptp_inserter/altera_eth_gmii_ptp_inserter.v"
        add_fileset_file altera_eth_gmii_ptp_inserter.ocp OTHER PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_ptp_inserter/altera_eth_gmii_ptp_inserter.ocp"
        add_fileset_file altera_eth_gmii_crc328generator.v VERILOG PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/altera_eth_gmii_crc328generator.v"
        add_fileset_file altera_eth_gmii_crc32ctl8.v VERILOG PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/altera_eth_gmii_crc32ctl8.v"
        add_fileset_file altera_eth_gmii_crc32galois8.v VERILOG PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/altera_eth_gmii_crc32galois8.v"
        add_fileset_file altera_eth_gmii_crc.v VERILOG PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/altera_eth_gmii_crc.v"
        add_fileset_file altera_eth_gmii_crc.ocp OTHER PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/altera_eth_gmii_crc.ocp"
        add_fileset_file altera_eth_avst2gmii_converter.v VERILOG PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_avst2gmii_converter/altera_eth_avst2gmii_converter.v"
    }
}

add_fileset_file altera_eth_gmii_mii_encoder_dc_fifo.v VERILOG PATH altera_eth_gmii_mii_encoder_dc_fifo.v
add_fileset_file altera_eth_gmii_mii_encoder_dcfifo_synchronizer_bundle.v VERILOG PATH altera_eth_gmii_mii_encoder_dcfifo_synchronizer_bundle.v
...
proc sim_ver {name} {
    ...
    if {1} {
        ...
        if {$enable_timestamping} {
            add_fileset_file mentor/altera_eth_gmii2avst_converter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii2avst_converter/mentor/altera_eth_gmii2avst_converter.v" {MENTOR_SPECIFIC}
            add_fileset_file mentor/altera_eth_gmii_tsu.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_tsu/mentor/altera_eth_gmii_tsu.v" {MENTOR_SPECIFIC}
        }
        if {$enable_ptp_1step} {
            add_fileset_file mentor/altera_eth_gmii_ptp_inserter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_ptp_inserter/mentor/altera_eth_gmii_ptp_inserter.v" {MENTOR_SPECIFIC}
            add_fileset_file mentor/altera_eth_gmii_crc328generator.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/mentor/altera_eth_gmii_crc328generator.v" {MENTOR_SPECIFIC}
            add_fileset_file mentor/altera_eth_gmii_crc32ctl8.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/mentor/altera_eth_gmii_crc32ctl8.v" {MENTOR_SPECIFIC}
            add_fileset_file mentor/altera_eth_gmii_crc32galois8.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/mentor/altera_eth_gmii_crc32galois8.v" {MENTOR_SPECIFIC}
            add_fileset_file mentor/altera_eth_gmii_crc.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/mentor/altera_eth_gmii_crc.v" {MENTOR_SPECIFIC}
            add_fileset_file mentor/altera_eth_avst2gmii_converter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_avst2gmii_converter/mentor/altera_eth_avst2gmii_converter.v" {MENTOR_SPECIFIC}
        }
    }
    if {1} {                
        ...
        if {$enable_timestamping} {
            add_fileset_file aldec/altera_eth_gmii2avst_converter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii2avst_converter/aldec/altera_eth_gmii2avst_converter.v" {ALDEC_SPECIFIC}
            add_fileset_file aldec/altera_eth_gmii_tsu.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_tsu/aldec/altera_eth_gmii_tsu.v" {ALDEC_SPECIFIC}
        }
        if {$enable_ptp_1step} {
            add_fileset_file aldec/altera_eth_gmii_ptp_inserter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_ptp_inserter/aldec/altera_eth_gmii_ptp_inserter.v" {ALDEC_SPECIFIC}
            add_fileset_file aldec/altera_eth_gmii_crc328generator.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/aldec/altera_eth_gmii_crc328generator.v" {ALDEC_SPECIFIC}
            add_fileset_file aldec/altera_eth_gmii_crc32ctl8.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/aldec/altera_eth_gmii_crc32ctl8.v" {ALDEC_SPECIFIC}
            add_fileset_file aldec/altera_eth_gmii_crc32galois8.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/aldec/altera_eth_gmii_crc32galois8.v" {ALDEC_SPECIFIC}
            add_fileset_file aldec/altera_eth_gmii_crc.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/aldec/altera_eth_gmii_crc.v" {ALDEC_SPECIFIC}
            add_fileset_file aldec/altera_eth_avst2gmii_converter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_avst2gmii_converter/aldec/altera_eth_avst2gmii_converter.v" {ALDEC_SPECIFIC}
        }
    }
    if {1} {
        ...
        if {$enable_timestamping} {
            add_fileset_file cadence/altera_eth_gmii2avst_converter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii2avst_converter/cadence/altera_eth_gmii2avst_converter.v" {CADENCE_SPECIFIC}
            add_fileset_file cadence/altera_eth_gmii_tsu.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_tsu/cadence/altera_eth_gmii_tsu.v" {CADENCE_SPECIFIC}
        }
        if {$enable_ptp_1step} {
            add_fileset_file cadence/altera_eth_gmii_ptp_inserter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_ptp_inserter/cadence/altera_eth_gmii_ptp_inserter.v" {CADENCE_SPECIFIC}
            add_fileset_file cadence/altera_eth_gmii_crc328generator.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/cadence/altera_eth_gmii_crc328generator.v" {CADENCE_SPECIFIC}
            add_fileset_file cadence/altera_eth_gmii_crc32ctl8.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/cadence/altera_eth_gmii_crc32ctl8.v" {CADENCE_SPECIFIC}
            add_fileset_file cadence/altera_eth_gmii_crc32galois8.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/cadence/altera_eth_gmii_crc32galois8.v" {CADENCE_SPECIFIC}
            add_fileset_file cadence/altera_eth_gmii_crc.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/cadence/altera_eth_gmii_crc.v" {CADENCE_SPECIFIC}
            add_fileset_file cadence/altera_eth_avst2gmii_converter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_avst2gmii_converter/cadence/altera_eth_avst2gmii_converter.v" {CADENCE_SPECIFIC}
        }
    }
    if {1} {
        ...
        if {$enable_timestamping} {
            add_fileset_file synopsys/altera_eth_gmii2avst_converter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii2avst_converter/synopsys/altera_eth_gmii2avst_converter.v" {SYNOPSYS_SPECIFIC}
            add_fileset_file synopsys/altera_eth_gmii_tsu.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_tsu/synopsys/altera_eth_gmii_tsu.v" {SYNOPSYS_SPECIFIC}
        }
        if {$enable_ptp_1step} {
            add_fileset_file synopsys/altera_eth_gmii_ptp_inserter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_ptp_inserter/synopsys/altera_eth_gmii_ptp_inserter.v" {SYNOPSYS_SPECIFIC}
            add_fileset_file synopsys/altera_eth_gmii_crc328generator.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/synopsys/altera_eth_gmii_crc328generator.v" {SYNOPSYS_SPECIFIC}
            add_fileset_file synopsys/altera_eth_gmii_crc32ctl8.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/synopsys/altera_eth_gmii_crc32ctl8.v" {SYNOPSYS_SPECIFIC}
            add_fileset_file synopsys/altera_eth_gmii_crc32galois8.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/synopsys/altera_eth_gmii_crc32galois8.v" {SYNOPSYS_SPECIFIC}
            add_fileset_file synopsys/altera_eth_gmii_crc.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_gmii_crc/synopsys/altera_eth_gmii_crc.v" {SYNOPSYS_SPECIFIC}
            add_fileset_file synopsys/altera_eth_avst2gmii_converter.v VERILOG_ENCRYPT PATH "$::env(QUARTUS_ROOTDIR)/../ip/altera/ethernet/ethernet_ucore/altera_eth_avst2gmii_converter/synopsys/altera_eth_avst2gmii_converter.v" {SYNOPSYS_SPECIFIC}
        }
    }
    add_fileset_file altera_eth_gmii_mii_encoder_dc_fifo.v VERILOG PATH altera_eth_gmii_mii_encoder_dc_fifo.v
    add_fileset_file altera_eth_gmii_mii_encoder_dcfifo_synchronizer_bundle.v VERILOG PATH altera_eth_gmii_mii_encoder_dcfifo_synchronizer_bundle.v

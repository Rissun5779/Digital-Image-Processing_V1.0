...
proc sim_ver {name} {
    if {1} {
        ...
        add_fileset_file mentor/altera_eth_timestamp_req_ctrl_sc_fifo.v VERILOG_ENCRYPT PATH "mentor/altera_eth_timestamp_req_ctrl_sc_fifo.v" {MENTOR_SPECIFIC}
        add_fileset_file mentor/altera_eth_timestamp_req_ctrl_st_splitter.sv VERILOG_ENCRYPT PATH "mentor/altera_eth_timestamp_req_ctrl_st_splitter.sv" {MENTOR_SPECIFIC}
    }
    if {1} {
        ...
        add_fileset_file aldec/altera_eth_timestamp_req_ctrl_sc_fifo.v VERILOG_ENCRYPT PATH "aldec/altera_eth_timestamp_req_ctrl_sc_fifo.v" {ALDEC_SPECIFIC}
        add_fileset_file aldec/altera_eth_timestamp_req_ctrl_st_splitter.sv VERILOG_ENCRYPT PATH "aldec/altera_eth_timestamp_req_ctrl_st_splitter.sv" {ALDEC_SPECIFIC}
    }
    if {1} {
        ...
        add_fileset_file cadence/altera_eth_timestamp_req_ctrl_sc_fifo.v VERILOG_ENCRYPT PATH "cadence/altera_eth_timestamp_req_ctrl_sc_fifo.v" {CADENCE_SPECIFIC}
        add_fileset_file cadence/altera_eth_timestamp_req_ctrl_st_splitter.sv VERILOG_ENCRYPT PATH "cadence/altera_eth_timestamp_req_ctrl_st_splitter.sv" {CADENCE_SPECIFIC}
    }
    if {1} {
        ...
        add_fileset_file synopsys/altera_eth_timestamp_req_ctrl_sc_fifo.v VERILOG_ENCRYPT PATH "synopsys/altera_eth_timestamp_req_ctrl_sc_fifo.v" {SYNOPSYS_SPECIFIC}
        add_fileset_file synopsys/altera_eth_timestamp_req_ctrl_st_splitter.sv VERILOG_ENCRYPT PATH "synopsys/altera_eth_timestamp_req_ctrl_st_splitter.sv" {SYNOPSYS_SPECIFIC}
    }
...
add_file altera_eth_timestamp_req_ctrl_sc_fifo.v {SYNTHESIS}
...
add_file altera_eth_timestamp_req_ctrl_st_splitter.sv {SYNTHESIS}
# | 
# +-----------------------------------

...
//    v2.0 11/11/2013 - DFE/CTLE removed for ultra bundle

`timescale 1ps/ 1ps

module alt_aeu_40_arbiter  #(
    parameter CHANNELS  = 4,
    parameter CWIDTH    = clogb2(CHANNELS > 1 ? CHANNELS-1 : 1),
    parameter PRI_RR    = 1 // use round-robin priority
) (
  input 		  clk,
  input 		  reset,
  // Inputs from PHY
...
if (reset)
busy_gate <= 1'b0;
else if (!rcfg_busy & (rcfg_seq_start_rc | rcfg_lt_start_rc))
busy_gate <= 1'b1;

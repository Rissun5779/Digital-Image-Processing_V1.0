...
# _hw.tcl file for kr4a10_debug_cpu
package require -exact qsys 14.0

# module properties
set_module_property NAME {kr4a10_debug_cpu}
set_module_property DISPLAY_NAME {kr4a10_debug_cpu}
...
proc compose { } {
    ...
    set_instance_parameter_value cpu_nios {debug_level} {Level1}
    ...
    add_connection cpu_nios.data_master cpu_nios.jtag_debug_module avalon
    set_connection_parameter_value cpu_nios.data_master/cpu_nios.jtag_debug_module arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/cpu_nios.jtag_debug_module baseAddress {0x0100c800}
    set_connection_parameter_value cpu_nios.data_master/cpu_nios.jtag_debug_module defaultConnection {0}
    ...
    add_connection cpu_nios.instruction_master cpu_nios.jtag_debug_module avalon
    set_connection_parameter_value cpu_nios.instruction_master/cpu_nios.jtag_debug_module arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.instruction_master/cpu_nios.jtag_debug_module baseAddress {0x0100c800}
    set_connection_parameter_value cpu_nios.instruction_master/cpu_nios.jtag_debug_module defaultConnection {0}
    ...
    add_connection cpu_nios.jtag_debug_module_reset cpu_nios.reset_n reset

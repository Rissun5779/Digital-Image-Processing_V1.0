...
# _hw.tcl file for kr4a10_debug_cpu_gen2
package require -exact qsys 16.0

# module properties
set_module_property NAME {kr4a10_debug_cpu_gen2}
set_module_property DISPLAY_NAME {kr4a10_debug_cpu_gen2}
...
proc compose { } {
    ...
    add_instance ber_in_1 altera_avalon_pio 16.1
    set_instance_parameter_value ber_in_1 {bitClearingEdgeCapReg} {0}
    set_instance_parameter_value ber_in_1 {bitModifyingOutReg} {0}
    set_instance_parameter_value ber_in_1 {captureEdge} {0}
    set_instance_parameter_value ber_in_1 {direction} {Input}
    set_instance_parameter_value ber_in_1 {edgeType} {RISING}
    set_instance_parameter_value ber_in_1 {generateIRQ} {0}
    set_instance_parameter_value ber_in_1 {irqType} {LEVEL}
    set_instance_parameter_value ber_in_1 {resetValue} {0.0}
    set_instance_parameter_value ber_in_1 {simDoTestBenchWiring} {0}
    set_instance_parameter_value ber_in_1 {simDrivenValue} {0.0}
    set_instance_parameter_value ber_in_1 {width} {16}

    add_instance ber_in_2 altera_avalon_pio 16.1
    set_instance_parameter_value ber_in_2 {bitClearingEdgeCapReg} {0}
    set_instance_parameter_value ber_in_2 {bitModifyingOutReg} {0}
    set_instance_parameter_value ber_in_2 {captureEdge} {0}
    set_instance_parameter_value ber_in_2 {direction} {Input}
    set_instance_parameter_value ber_in_2 {edgeType} {RISING}
    set_instance_parameter_value ber_in_2 {generateIRQ} {0}
    set_instance_parameter_value ber_in_2 {irqType} {LEVEL}
    set_instance_parameter_value ber_in_2 {resetValue} {0.0}
    set_instance_parameter_value ber_in_2 {simDoTestBenchWiring} {0}
    set_instance_parameter_value ber_in_2 {simDrivenValue} {0.0}
    set_instance_parameter_value ber_in_2 {width} {16}

    add_instance ber_in_3 altera_avalon_pio 16.1
    set_instance_parameter_value ber_in_3 {bitClearingEdgeCapReg} {0}
    set_instance_parameter_value ber_in_3 {bitModifyingOutReg} {0}
    set_instance_parameter_value ber_in_3 {captureEdge} {0}
    set_instance_parameter_value ber_in_3 {direction} {Input}
    set_instance_parameter_value ber_in_3 {edgeType} {RISING}
    set_instance_parameter_value ber_in_3 {generateIRQ} {0}
    set_instance_parameter_value ber_in_3 {irqType} {LEVEL}
    set_instance_parameter_value ber_in_3 {resetValue} {0.0}
    set_instance_parameter_value ber_in_3 {simDoTestBenchWiring} {0}
    set_instance_parameter_value ber_in_3 {simDrivenValue} {0.0}
    set_instance_parameter_value ber_in_3 {width} {16}
    ...
    set_instance_parameter_value ber_zero {width} {4}
    ...
    set_instance_parameter_value bert_done {width} {4}
    ...
    set_instance_parameter_value clear_ber {width} {4}
    ...
    add_instance cpu_nios altera_nios2_gen2 16.1
    set_instance_parameter_value cpu_nios {tmr_enabled} {0}
    set_instance_parameter_value cpu_nios {setting_disable_tmr_inj} {0}
    ...
    set_instance_parameter_value cpu_nios {setting_exportdebuginfo} {0}
    ...
    set_instance_parameter_value cpu_nios {register_file_por} {0}
    set_instance_parameter_value cpu_nios {setting_asic_synopsys_translate_on_off} {0}
    set_instance_parameter_value cpu_nios {setting_asic_third_party_synthesis} {0}
    set_instance_parameter_value cpu_nios {setting_asic_add_scan_mode_input} {0}
    set_instance_parameter_value cpu_nios {setting_oci_version} {1}
    set_instance_parameter_value cpu_nios {setting_fast_register_read} {0}
    set_instance_parameter_value cpu_nios {setting_exportHostDebugPort} {0}
    ...
    set_instance_parameter_value cpu_nios {io_regionbase} {0}
    set_instance_parameter_value cpu_nios {io_regionsize} {0}
    set_instance_parameter_value cpu_nios {setting_support31bitdcachebypass} {1}
    set_instance_parameter_value cpu_nios {setting_activateTrace} {0}
    set_instance_parameter_value cpu_nios {setting_allow_break_inst} {0}
    ...
    set_instance_parameter_value cpu_nios {setting_disableocitrace} {0}
    ...
    set_instance_parameter_value cpu_nios {setting_tmr_output_disable} {0}
    ...
    set_instance_parameter_value cpu_nios {tracefilename} {}
    ...
    set_instance_parameter_value cpu_nios {breakSlave} {cpu_nios.jtag_debug_module}
    set_instance_parameter_value cpu_nios {setting_interruptControllerType} {Internal}
    set_instance_parameter_value cpu_nios {setting_branchpredictiontype} {Dynamic}
    set_instance_parameter_value cpu_nios {setting_bhtPtrSz} {8}
    set_instance_parameter_value cpu_nios {cpuArchRev} {1}
    set_instance_parameter_value cpu_nios {mul_shift_choice} {0}
    set_instance_parameter_value cpu_nios {mul_32_impl} {2}
    set_instance_parameter_value cpu_nios {mul_64_impl} {0}
    set_instance_parameter_value cpu_nios {shift_rot_impl} {1}
    set_instance_parameter_value cpu_nios {dividerType} {no_div}
    ...
    set_instance_parameter_value cpu_nios {fa_cache_line} {2}
    set_instance_parameter_value cpu_nios {fa_cache_linesize} {0}
    ...
    set_instance_parameter_value cpu_nios {setting_usedesignware} {0}
    ...
    set_instance_parameter_value cpu_nios {ocimem_ramInit} {0}
    ...
    set_instance_parameter_value cpu_nios {cdx_enabled} {0}
    set_instance_parameter_value cpu_nios {mpx_enabled} {0}
    set_instance_parameter_value cpu_nios {debug_enabled} {1}
    ...
    set_instance_parameter_value cpu_nios {debug_hwbreakpoint} {0}
    set_instance_parameter_value cpu_nios {debug_datatrigger} {0}
    set_instance_parameter_value cpu_nios {debug_traceType} {none}
    set_instance_parameter_value cpu_nios {debug_traceStorage} {onchip_trace}
    set_instance_parameter_value cpu_nios {master_addr_map} {0}
    set_instance_parameter_value cpu_nios {instruction_master_paddr_base} {0}
    set_instance_parameter_value cpu_nios {instruction_master_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {flash_instruction_master_paddr_base} {0}
    set_instance_parameter_value cpu_nios {flash_instruction_master_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {data_master_paddr_base} {0}
    set_instance_parameter_value cpu_nios {data_master_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {tightly_coupled_instruction_master_0_paddr_base} {0}
    set_instance_parameter_value cpu_nios {tightly_coupled_instruction_master_0_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {tightly_coupled_instruction_master_1_paddr_base} {0}
    set_instance_parameter_value cpu_nios {tightly_coupled_instruction_master_1_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {tightly_coupled_instruction_master_2_paddr_base} {0}
    set_instance_parameter_value cpu_nios {tightly_coupled_instruction_master_2_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {tightly_coupled_instruction_master_3_paddr_base} {0}
    set_instance_parameter_value cpu_nios {tightly_coupled_instruction_master_3_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {tightly_coupled_data_master_0_paddr_base} {0}
    set_instance_parameter_value cpu_nios {tightly_coupled_data_master_0_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {tightly_coupled_data_master_1_paddr_base} {0}
    set_instance_parameter_value cpu_nios {tightly_coupled_data_master_1_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {tightly_coupled_data_master_2_paddr_base} {0}
    set_instance_parameter_value cpu_nios {tightly_coupled_data_master_2_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {tightly_coupled_data_master_3_paddr_base} {0}
    set_instance_parameter_value cpu_nios {tightly_coupled_data_master_3_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {instruction_master_high_performance_paddr_base} {0}
    set_instance_parameter_value cpu_nios {instruction_master_high_performance_paddr_size} {0.0}
    set_instance_parameter_value cpu_nios {data_master_high_performance_paddr_base} {0}
    set_instance_parameter_value cpu_nios {data_master_high_performance_paddr_size} {0.0}
    ...
    set_instance_parameter_value dmem {enPRInitMode} {0}
    ...
    set_instance_parameter_value enable {width} {12}
    ...
    set_instance_parameter_value imem {enPRInitMode} {0}
    set_instance_parameter_value imem {instanceID} {NONE}
    set_instance_parameter_value imem {memorySize} {18432.0}
    ...
    set_instance_parameter_value rmt_cmd_new {width} {4}
    ...
    set_instance_parameter_value rmt_sts {width} {24}
    ...
    set_instance_parameter_value rmt_sts_new {width} {4}

    add_instance rxeq_sts_0 altera_avalon_pio 16.1
    set_instance_parameter_value rxeq_sts_0 {bitClearingEdgeCapReg} {0}
    set_instance_parameter_value rxeq_sts_0 {bitModifyingOutReg} {1}
    set_instance_parameter_value rxeq_sts_0 {captureEdge} {0}
    set_instance_parameter_value rxeq_sts_0 {direction} {Output}
    set_instance_parameter_value rxeq_sts_0 {edgeType} {RISING}
    set_instance_parameter_value rxeq_sts_0 {generateIRQ} {0}
    set_instance_parameter_value rxeq_sts_0 {irqType} {LEVEL}
    set_instance_parameter_value rxeq_sts_0 {resetValue} {0.0}
    set_instance_parameter_value rxeq_sts_0 {simDoTestBenchWiring} {0}
    set_instance_parameter_value rxeq_sts_0 {simDrivenValue} {0.0}
    set_instance_parameter_value rxeq_sts_0 {width} {9}

    add_instance rxeq_sts_1 altera_avalon_pio 16.1
    set_instance_parameter_value rxeq_sts_1 {bitClearingEdgeCapReg} {0}
    set_instance_parameter_value rxeq_sts_1 {bitModifyingOutReg} {1}
    set_instance_parameter_value rxeq_sts_1 {captureEdge} {0}
    set_instance_parameter_value rxeq_sts_1 {direction} {Output}
    set_instance_parameter_value rxeq_sts_1 {edgeType} {RISING}
    set_instance_parameter_value rxeq_sts_1 {generateIRQ} {0}
    set_instance_parameter_value rxeq_sts_1 {irqType} {LEVEL}
    set_instance_parameter_value rxeq_sts_1 {resetValue} {0.0}
    set_instance_parameter_value rxeq_sts_1 {simDoTestBenchWiring} {0}
    set_instance_parameter_value rxeq_sts_1 {simDrivenValue} {0.0}
    set_instance_parameter_value rxeq_sts_1 {width} {9}

    add_instance rxeq_sts_2 altera_avalon_pio 16.1
    set_instance_parameter_value rxeq_sts_2 {bitClearingEdgeCapReg} {0}
    set_instance_parameter_value rxeq_sts_2 {bitModifyingOutReg} {1}
    set_instance_parameter_value rxeq_sts_2 {captureEdge} {0}
    set_instance_parameter_value rxeq_sts_2 {direction} {Output}
    set_instance_parameter_value rxeq_sts_2 {edgeType} {RISING}
    set_instance_parameter_value rxeq_sts_2 {generateIRQ} {0}
    set_instance_parameter_value rxeq_sts_2 {irqType} {LEVEL}
    set_instance_parameter_value rxeq_sts_2 {resetValue} {0.0}
    set_instance_parameter_value rxeq_sts_2 {simDoTestBenchWiring} {0}
    set_instance_parameter_value rxeq_sts_2 {simDrivenValue} {0.0}
    set_instance_parameter_value rxeq_sts_2 {width} {9}

    add_instance rxeq_sts_3 altera_avalon_pio 16.1
    set_instance_parameter_value rxeq_sts_3 {bitClearingEdgeCapReg} {0}
    set_instance_parameter_value rxeq_sts_3 {bitModifyingOutReg} {1}
    set_instance_parameter_value rxeq_sts_3 {captureEdge} {0}
    set_instance_parameter_value rxeq_sts_3 {direction} {Output}
    set_instance_parameter_value rxeq_sts_3 {edgeType} {RISING}
    set_instance_parameter_value rxeq_sts_3 {generateIRQ} {0}
    set_instance_parameter_value rxeq_sts_3 {irqType} {LEVEL}
    set_instance_parameter_value rxeq_sts_3 {resetValue} {0.0}
    set_instance_parameter_value rxeq_sts_3 {simDoTestBenchWiring} {0}
    set_instance_parameter_value rxeq_sts_3 {simDrivenValue} {0.0}
    set_instance_parameter_value rxeq_sts_3 {width} {9}
    ...
    set_instance_parameter_value training_sts {width} {20}

    # connections and connection parameters
    add_connection cpu_nios.data_master jtag_uart_0.avalon_jtag_slave avalon
    set_connection_parameter_value cpu_nios.data_master/jtag_uart_0.avalon_jtag_slave arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/jtag_uart_0.avalon_jtag_slave baseAddress {0x0100d0a0}
    set_connection_parameter_value cpu_nios.data_master/jtag_uart_0.avalon_jtag_slave defaultConnection {0}

    add_connection cpu_nios.data_master cpu_nios.debug_mem_slave avalon
    set_connection_parameter_value cpu_nios.data_master/cpu_nios.debug_mem_slave arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/cpu_nios.debug_mem_slave baseAddress {0x0100c800}
    set_connection_parameter_value cpu_nios.data_master/cpu_nios.debug_mem_slave defaultConnection {0}
    ...
    add_connection cpu_nios.data_master ber_in_0.s1 avalon
    set_connection_parameter_value cpu_nios.data_master/ber_in_0.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/ber_in_0.s1 baseAddress {0x00090030}
    set_connection_parameter_value cpu_nios.data_master/ber_in_0.s1 defaultConnection {0}
    ...
    add_connection cpu_nios.data_master rxeq_sts_0.s1 avalon
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_0.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_0.s1 baseAddress {0x000a0060}
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_0.s1 defaultConnection {0}
    ...
    add_connection cpu_nios.data_master ber_in_1.s1 avalon
    set_connection_parameter_value cpu_nios.data_master/ber_in_1.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/ber_in_1.s1 baseAddress {0x00090050}
    set_connection_parameter_value cpu_nios.data_master/ber_in_1.s1 defaultConnection {0}

    add_connection cpu_nios.data_master ber_in_2.s1 avalon
    set_connection_parameter_value cpu_nios.data_master/ber_in_2.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/ber_in_2.s1 baseAddress {0x00090060}
    set_connection_parameter_value cpu_nios.data_master/ber_in_2.s1 defaultConnection {0}

    add_connection cpu_nios.data_master ber_in_3.s1 avalon
    set_connection_parameter_value cpu_nios.data_master/ber_in_3.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/ber_in_3.s1 baseAddress {0x00090070}
    set_connection_parameter_value cpu_nios.data_master/ber_in_3.s1 defaultConnection {0}

    add_connection cpu_nios.data_master rxeq_sts_1.s1 avalon
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_1.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_1.s1 baseAddress {0x000a00a0}
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_1.s1 defaultConnection {0}

    add_connection cpu_nios.data_master rxeq_sts_2.s1 avalon
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_2.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_2.s1 baseAddress {0x000a00c0}
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_2.s1 defaultConnection {0}

    add_connection cpu_nios.data_master rxeq_sts_3.s1 avalon
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_3.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_3.s1 baseAddress {0x000a00e0}
    set_connection_parameter_value cpu_nios.data_master/rxeq_sts_3.s1 defaultConnection {0}

    add_connection cpu_nios.instruction_master cpu_nios.debug_mem_slave avalon
    set_connection_parameter_value cpu_nios.instruction_master/cpu_nios.debug_mem_slave arbitrationPriority {1}
    set_connection_parameter_value cpu_nios.instruction_master/cpu_nios.debug_mem_slave baseAddress {0x0100c800}
    set_connection_parameter_value cpu_nios.instruction_master/cpu_nios.debug_mem_slave defaultConnection {0}
    ...
    add_connection clk_0.clk rxeq_sts_0.clk clock
    ...
    add_connection clk_0.clk ber_in_1.clk clock

    add_connection clk_0.clk ber_in_2.clk clock

    add_connection clk_0.clk ber_in_3.clk clock

    add_connection clk_0.clk rxeq_sts_1.clk clock

    add_connection clk_0.clk rxeq_sts_2.clk clock

    add_connection clk_0.clk rxeq_sts_3.clk clock
    ...
    add_connection clk_0.clk_reset rxeq_sts_0.reset reset
    ...
    add_connection clk_0.clk_reset ber_in_1.reset reset

    add_connection clk_0.clk_reset ber_in_2.reset reset

    add_connection clk_0.clk_reset ber_in_3.reset reset

    add_connection clk_0.clk_reset rxeq_sts_1.reset reset

    add_connection clk_0.clk_reset rxeq_sts_2.reset reset

    add_connection clk_0.clk_reset rxeq_sts_3.reset reset

    add_connection clk_0.clk_reset cpu_nios.reset reset

    add_connection clk_0.clk_reset imem.reset1 reset

    add_connection clk_0.clk_reset dmem.reset1 reset

    add_connection cpu_nios.debug_reset_request cpu_nios.reset reset

    # exported interfaces
    add_interface avmm avalon master
    set_interface_property avmm EXPORT_OF mm_bridge_0.m0
    add_interface ber_in_0 conduit end
    set_interface_property ber_in_0 EXPORT_OF ber_in_0.external_connection
    add_interface ber_in_1 conduit end
    set_interface_property ber_in_1 EXPORT_OF ber_in_1.external_connection
    add_interface ber_in_2 conduit end
    set_interface_property ber_in_2 EXPORT_OF ber_in_2.external_connection
    add_interface ber_in_3 conduit end
    set_interface_property ber_in_3 EXPORT_OF ber_in_3.external_connection
    ...
    add_interface rxeq_sts_0 conduit end
    set_interface_property rxeq_sts_0 EXPORT_OF rxeq_sts_0.external_connection
    add_interface rxeq_sts_1 conduit end
    set_interface_property rxeq_sts_1 EXPORT_OF rxeq_sts_1.external_connection
    add_interface rxeq_sts_2 conduit end
    set_interface_property rxeq_sts_2 EXPORT_OF rxeq_sts_2.external_connection
    add_interface rxeq_sts_3 conduit end
    set_interface_property rxeq_sts_3 EXPORT_OF rxeq_sts_3.external_connection

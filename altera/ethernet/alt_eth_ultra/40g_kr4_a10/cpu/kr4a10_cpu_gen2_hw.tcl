...
# _hw.tcl file for kr4a10_cpu_gen2
package require -exact qsys 16.0

# module properties
set_module_property NAME {kr4a10_cpu_gen2}
set_module_property DISPLAY_NAME {kr4a10_cpu_gen2}
...
proc compose { } {
    ...
    set_instance_parameter_value cpu_nios {debug_enabled} {0}
    ...
    set_instance_parameter_value dmem {memorySize} {8192.0}
    ...
    set_instance_parameter_value imem {memorySize} {8192.0}

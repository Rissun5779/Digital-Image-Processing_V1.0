...
/*   defparam dut.ENET_ENTITY_QMEGA_01312014_inst.FASTSIM 	      = 1;
   ...
   defparam dut.ENET_ENTITY_QMEGA_01312014_inst.FORCE_BPOS 	      = 'h33333333333333333333;
   defparam dut.ENET_ENTITY_QMEGA_01312014_inst.FORCE_WPOS 	      = 'h18c6318c6318c6318c6318c63;*/

   `ifdef ARRIA_10 
   // Arria 10 Coefficients
   // defparam dut.ENET_ENTITY_QMEGA_01312014_inst.FASTSIM 	      = 1;
   // defparam dut.ENET_ENTITY_QMEGA_01312014_inst.FORCE_RO_SELS 	      = 'hd8d8271eb18d111a223444688d8d8274bb1;    
   // defparam dut.ENET_ENTITY_QMEGA_01312014_inst.FORCE_BPOS 	          = 'h11111111111111111111;
   // defparam dut.ENET_ENTITY_QMEGA_01312014_inst.FORCE_WPOS 	          = 'h18c6318c6318c6318c6318c63;
   
   always begin
	tx_serial_clk <= {10{~tx_serial_clk[0]}};
	#97;
   end
   `endif
   ...
   initial begin
      ...
      $display("REQUIRED RO_SELS: %x", dut.ENET_ENTITY_QMEGA_01312014_inst.e100.phy.epa.rpcs.ro_sels);      
      $display("REQUIRED BPOS: %x",dut.ENET_ENTITY_QMEGA_01312014_inst.e100.phy.epa.rpcs.bpos);      
      $display("REQUIRED WPOS: %x",dut.ENET_ENTITY_QMEGA_01312014_inst.e100.phy.epa.rpcs.wpos);

...
wire txa_online_100;
sync_regs txa_online_sync(
        .clk(clk100),
        .din(txa_online),
        .dout(txa_online_100)      
);
defparam txa_online_sync .WIDTH = 1;

wire [3:0] eio_freq_lock_100;
sync_regs eio_freq_lock_sync(
        .clk(clk100),
        .din(eio_freq_lock),
        .dout(eio_freq_lock_100)      
);
defparam eio_freq_lock_sync .WIDTH = 4;

wire eio_tx_pll_locked_100;
sync_regs eio_tx_pll_locked_sync(
        .clk(clk100),
        .din(eio_tx_pll_locked),
        .dout(eio_tx_pll_locked_100)      
);
defparam eio_tx_pll_locked_sync .WIDTH = 1;

wire txp_lock_100;
sync_regs txp_lock_sync(
        .clk(clk100),
        .din(txp_lock),
        .dout(txp_lock_100)      
);
defparam txp_lock_sync .WIDTH = 1;

wire rxp_lock_100;
sync_regs rxp_lock_sync(
        .clk(clk100),
        .din(rxp_lock),
        .dout(rxp_lock_100)      
);
defparam rxp_lock_sync .WIDTH = 1;
    ...
    if (ss1_rd) begin
        ...
        case (ss1_addr)
            ...
            8'h13 : ss1_rdata <= 32'h0 | eio_sloop;
                        ...
                        8'h20 : ss1_rdata <= 32'h0 | eio_tx_pll_locked_100;
                        8'h21 : ss1_rdata <= 32'h0 | eio_freq_lock_100;
                        8'h22 : ss1_rdata <= 32'h0 | {rxp_lock_100,txp_lock_100,txa_online_100};

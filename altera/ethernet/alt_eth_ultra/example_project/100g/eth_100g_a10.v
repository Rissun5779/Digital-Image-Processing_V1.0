...
module eth_100g_a10 (
		...
		input  wire [13:0]  reconfig_address,      //     reconfig_address.reconfig_address
		...
		output wire [5:0]   l8_rx_error,           //         avalon_st_rx.l8_rx_error
...
wire pll_locked;
	...
	arria10_atx_pll atx (
		...
		.mcgb_rst(reset_async),        //        mcgb_rst.mcgb_rst
	...
	ex_100g ex_100g_inst (
		...
		.tx_serial_clk         ({10{serial_clk}}),         //        tx_serial_clk.tx_serial_clk

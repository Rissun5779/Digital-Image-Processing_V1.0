...
module eth_ex_100g_a10 (
    input clk50,
    input cpu_resetn,

    // 10G IO
    input wire clk_ref_r,
    input wire [9:0] rx_serial_r,
    output wire [9:0] tx_serial_r
...
`include "common/alt_aeuex_wide_l8if_functions.iv"
  ...
  assign l8_tx_empty         = alt_aeuex_wide_encode64to6(din_end_pos);
  ...
  assign dout_last_data      = l8_rx_endofpacket ? alt_aeuex_wide_decode6to64(l8_rx_empty) : 64'h0;

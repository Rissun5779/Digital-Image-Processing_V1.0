...
# +-----------------------------------
# | module altera_eth_tse_pcs_pma_nf_lvds
# |
set_module_property NAME altera_eth_tse_pcs_pma_nf_lvds
...
# Global parameter
#################################################################################################
array set lvdsio_port_list {
   tbi_rx_clk              {tbi_rx_clk                Input    1}
   tbi_rx_d_lvds           {tbi_rx_d_lvds             Input    10}
   tbi_tx_d_muxed          {tbi_tx_d_muxed            Output   10}
   rx_reset_sequence_done  {rx_reset_sequence_done    Input    1}
   rx_reset                {rx_reset                  Input    1}
   tx_reset                {tx_reset                  Input    1}
}
...
proc fileset_cb {entityname} {
   ...
   set top_level_file altera_eth_tse_pcs_pma_nf_lvds.v
...
proc sdc_file_gen {} {
   set sdc_template "altera_eth_tse_pcs_pma_nf_lvds.sdc"
   set sdc_out_file [create_temp_file altera_eth_tse_pcs_pma_nf_lvds.sdc]
   ...
   close $in
   close $out
   add_fileset_file altera_eth_tse_pcs_pma_nf_lvds.sdc SDC PATH $sdc_out_file {SYNTHESIS}
}
...
proc elaborate {} {
   ...
   set_fileset_property synthesis_fileset TOP_LEVEL "altera_eth_tse_pcs_pma_nf_lvds"
   set_fileset_property sim_ver_fileset TOP_LEVEL "altera_eth_tse_pcs_pma_nf_lvds"
   set_fileset_property sim_vhd_fileset TOP_LEVEL "altera_eth_tse_pcs_pma_nf_lvds"
...
proc build_interfaces {} {
   ...
   foreach {lvdsio_port} [array names lvdsio_port_list] {
      set role [lindex $lvdsio_port_list($lvdsio_port) 0]
      set direction [lindex $lvdsio_port_list($lvdsio_port) 1]
      set width [lindex $lvdsio_port_list($lvdsio_port) 2]

      add_interface $lvdsio_port conduit end
      add_interface_port $lvdsio_port $lvdsio_port $role $direction $width
   }
}

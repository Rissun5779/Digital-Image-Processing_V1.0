...
set_parameter_property use_mac_clken DISPLAY_NAME "Enable clock enable ports"
...
proc build_interfaces {} {
   ...
   # ECC status
   build_eccstatus_conduit_interface $WIRE_MAC_ECCSTATUS_CP_NAME
   ...
   build_mac_timestamp_interface $TX_EGRESS_TIMESTAMP_REQUEST $TX_ETSTAMP_INS_CTRL $TX_PATH_DELAY $RX_PATH_DELAY $TX_TIME_OF_DAY_96B $TX_TIME_OF_DAY_64B $RX_TIME_OF_DAY_96B $RX_TIME_OF_DAY_64B $TX_EGRESS_TIMESTAMP_96B $TX_EGRESS_TIMESTAMP_64B $RX_INGRESS_TIMESTAMP_96B $RX_INGRESS_TIMESTAMP_64B $TX_PTP_ALIGNMENT
   ...
   set_interface_property $WIRE_MAC_ECCSTATUS_CP_NAME ENABLED $ENABLE_ECC
...
proc build_mac_timestamp_interface {args} {
   ...
   set TX_PTP_ALIGNMENT [lindex $args 12]   
   ...
   if {$enable_timestamping} {
      ...
      add_interface_port terminate_1588_unused "tx_path_delay_data"    "data"    Input    22
      add_interface_port terminate_1588_unused "rx_path_delay_data"    "data"    Input    22
   ...
   if {$enable_timestamping && !$mac_only} {
      add_interface $TX_PTP_ALIGNMENT conduit end
      add_interface_port $TX_PTP_ALIGNMENT "tx_ptp_alignment"    "data"    Input    1    
   } else {
      add_interface terminate_ptp_alignment_unused conduit end
	  add_interface_port terminate_ptp_alignment_unused "tx_ptp_alignment"    "data"    Input    1      
      set_interface_property terminate_ptp_alignment_unused ENABLED 0 
   }
}
...
proc build_eccstatus_conduit_interface {args} {
   ...
   add_interface $WIRE_CP_NAME conduit end
   add_interface_port $WIRE_CP_NAME "mac_eccstatus" "mac_eccstatus" Output 2

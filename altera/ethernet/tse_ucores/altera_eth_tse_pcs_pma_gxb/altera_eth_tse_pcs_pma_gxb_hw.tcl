...
# |
set_module_property NAME altera_eth_tse_pcs_pma_gxb
...
array set pcs_pma_connection_ports {
   rx_analogreset_sqcnr          {Output  1}
   rx_digitalreset_sqcnr_rx_clk  {Output  1}
   sd_loopback                   {Output  1}
   tx_kchar                      {Output  1}
   tx_frame                      {Output  8}
   tx_digitalreset_sqcnr_tx_clk  {Output  1}
   pll_locked                    {Input   1}
   rx_freqlocked                 {Input   1}
   rx_kchar                      {Input   1}
   rx_pcs_clk                    {Input   1}
   rx_frame                      {Input   8}
   rx_disp_err                   {Input   1}
   ...
   tx_pcs_clk                    {Input   1}
   rx_rmfifodatadeleted          {Input   1}
   rx_rmfifodatainserted         {Input   1}
   rx_runningdisp                {Input   1}
   gxb_pwrdn_in_to_pcs           {Input   1}
   reconfig_busy_to_pcs          {Input   1}
   pcs_pwrdn_out_from_pcs        {Output  1}
}
...
proc fileset_cb {entityname} {
   ...
   set top_level_file altera_eth_tse_pcs_pma_gxb.v

   add_fileset_file $top_level_file VERILOG PATH $top_level_file  {SYNTEHSIS}
...
proc sdc_file_gen {} {
   set sdc_template "altera_eth_tse_pcs_pma_gxb.sdc"
   set sdc_out_file [create_temp_file altera_eth_tse_pcs_pma_gxb.sdc]
   ...
   close $in
   close $out
   add_fileset_file altera_eth_tse_pcs_pma_gxb.sdc SDC PATH $sdc_out_file {SYNTHESIS}
}
...
proc elaborate {} {
   ...
   set_fileset_property synthesis_fileset TOP_LEVEL "altera_eth_tse_pcs_pma_gxb"
   set_fileset_property sim_ver_fileset TOP_LEVEL "altera_eth_tse_pcs_pma_gxb"
   set_fileset_property sim_vhd_fileset TOP_LEVEL "altera_eth_tse_pcs_pma_gxb"

...
proc a10_1g_2_5g {synthesis_option device_part_value languaue_option part_number device_family family_tag} {

    global synth_sim_a10_1g_2_5g
    global ed_files_a10_1g_2_5g
    global qs_files_a10_1g_2_5g
    global hardware_a10_1g_2_5g
    global sim_a10_1g_2_5g
    global tb_a10_1g_2_5g
    ...
    foreach {from_folder file qsys_type} $ed_files_a10_1g_2_5g {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth" || $synthesis_option == "sim"} {
        foreach {type file} $synth_sim_a10_1g_2_5g {
...
#    }   
    ...
    if {$synthesis_option == "both" || $synthesis_option == "sim"} {       
        ...
        foreach {type file} $tb_a10_1g_2_5g {

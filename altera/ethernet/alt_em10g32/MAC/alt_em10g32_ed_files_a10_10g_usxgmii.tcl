...
set ed_files_a10_10g_usxgmii {

    rtl/mac                     alt_usxgmii_mac                     qsys_standalone
    rtl/phy                     alt_usxgmii_phy                     qsys_standalone
...
set synth_sim_a10_10g_usxgmii {

    VERILOG         alt_mge_channel.v
    SYSTEM_VERILOG  alt_mge_multi_channel.sv
    ...
    OTHER           ethernet_traffic_controller/eth_std_traffic_controller/crc32/crc32.qip
...
set qs_files_a10_10g_usxgmii {
    
    OTHER           altera_eth_top.qpf                     
    SDC             altera_eth_top.sdc                        
}

set tb_a10_10g_usxgmii {
    ...
    OTHER           ed_sim/cadence/ncsim_wave.svwf.txt
...
proc a10_10g_usxgmii {synthesis_option device_part_value languaue_option part_number device_family family_tag} {

    global synth_sim_a10_10g_usxgmii
    global ed_files_a10_10g_usxgmii
    global qs_files_a10_10g_usxgmii
    global hardware_a10_10g_usxgmii
    global sim_a10_10g_usxgmii
    global tb_a10_10g_usxgmii
    ...
    foreach {from_folder file qsys_type} $ed_files_a10_10g_usxgmii {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth" || $synthesis_option == "sim"} {
        foreach {type file} $synth_sim_a10_10g_usxgmii {
...
#    }   
    ...
    if {$synthesis_option == "both" || $synthesis_option == "sim"} {       
        ...
        foreach {type file} $tb_a10_10g_usxgmii {
            if {[string match "*.ucli.txt" $file] || [string match "*.svwf.txt" $file]} {

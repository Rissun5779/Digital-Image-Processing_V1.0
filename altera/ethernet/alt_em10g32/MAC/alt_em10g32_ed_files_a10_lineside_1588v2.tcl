...
set ed_files_a10_qse_lineside_1588v2 {
...
set synth_sim_a10_qse_lineside_1588v2 {
...
set hardware_a10_qse_lineside_1588v2 {
...
set qs_files_a10_qse_lineside_1588v2 {
...
set tb_a10_qse_lineside_1588v2 {
...
proc a10_qse_lineside_1588v2 {synthesis_option device_part_value languaue_option part_number device_family family_tag} {

    global synth_sim_a10_qse_lineside_1588v2
    global ed_files_a10_qse_lineside_1588v2
    global qs_files_a10_qse_lineside_1588v2
    global hardware_a10_qse_lineside_1588v2
    global sim_a10_qse_lineside_1588v2
    global tb_a10_qse_lineside_1588v2
    ...
    set variant "LL10G_LINESIDE_1588v2"
    ...
    foreach {from_folder file qsys_type} $ed_files_a10_qse_lineside_1588v2 {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth" || $synthesis_option == "sim"} {
        foreach {type file} $synth_sim_a10_qse_lineside_1588v2 {
...
#    }   
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth"} {
        ...
        foreach {type file} $qs_files_a10_qse_lineside_1588v2 {
            add_fileset_file $variant/$file $type PATH ../example_design/$variant/$file 
            
        } 
        
        # generate hardware debugging files
        foreach {type file} $hardware_a10_qse_lineside_1588v2 {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "sim"} {       
        ...
        foreach {type file} $tb_a10_qse_lineside_1588v2 {

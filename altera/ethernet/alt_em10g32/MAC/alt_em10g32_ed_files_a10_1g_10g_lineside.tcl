...
set ed_files_a10_1g_10g_lineside_wo_1588 {
    ...
    rtl/pll_mpll                pll                             qsys_standalone
...
set synth_sim_a10_1g_10g_lineside_wo_1588 {

    SDC             eth_traffic_controller/altera_avalon_dc_fifo.sdc                
    VERILOG         eth_traffic_controller/altera_avalon_dc_fifo.v                  
    VERILOG         eth_traffic_controller/altera_dcfifo_synchronizer_bundle.v      
    VERILOG         eth_traffic_controller/avalon_st_gen.v                          
    SYSTEM_VERILOG  eth_traffic_controller/avalon_st_loopback.sv                    
    VERILOG         eth_traffic_controller/avalon_st_mon.v                          
    VERILOG         eth_traffic_controller/avalon_st_prtmux.v                       
    OTHER           eth_traffic_controller/avalon_st_traffic_controller.qip         
    VERILOG         eth_traffic_controller/avalon_st_traffic_controller_top.v       
    VERILOG         eth_traffic_controller/avalon_st_traffic_controller.v           
    OTHER           eth_traffic_controller/shiftreg_ctrl.qip                        
    VERILOG         eth_traffic_controller/shiftreg_ctrl.v                          
    OTHER           eth_traffic_controller/shiftreg_data.qip                        
    VERILOG         eth_traffic_controller/shiftreg_data.v                          
    VERILOG         eth_traffic_controller/crc32/avalon_st_to_crc_if_bridge.v       
    VERILOG         eth_traffic_controller/crc32/bit_endian_converter.v             
    VERILOG         eth_traffic_controller/crc32/byte_endian_converter.v            
    VERILOG         eth_traffic_controller/crc32/crc32_calculator.v                 
    VERILOG         eth_traffic_controller/crc32/crc32_chk.v                        
    VERILOG         eth_traffic_controller/crc32/crc32_gen.v                        
    OTHER           eth_traffic_controller/crc32/crc32.qip                          
    SDC             eth_traffic_controller/crc32/crc32.sdc                          
    VERILOG         eth_traffic_controller/crc32/crc_checksum_aligner.v             
    VERILOG         eth_traffic_controller/crc32/crc_comparator.v                   
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat16.v            
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat24.v            
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat32_any_byte.v   
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat32.v            
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat40.v            
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat48.v            
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat56.v            
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat64_any_byte.v   
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat64.v            
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc32_dat8.v             
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc_ethernet.v           
    VERILOG         eth_traffic_controller/crc32/crc32_lib/crc_register.v           
    VERILOG         eth_traffic_controller/crc32/crc32_lib/xor6.v                   
    SDC             fifo_dcfifo/altera_avalon_dc_fifo.sdc                           
    VERILOG         fifo_dcfifo/altera_avalon_dc_fifo.v                             
    VERILOG         fifo_dcfifo/altera_dcfifo_synchronizer_bundle.v                 
    VERILOG         fifo_dcfifo/altera_std_synchronizer_nocut.v               
    VERILOG         fifo_scfifo/altera_avalon_sc_fifo.v                             
    VERILOG         fifo_stfifo/altera_eth_fifo.v                                   
    ...
    VERILOG         two_wire_serial_controller/two_wire_control_tb.sv               
    VERILOG         two_wire_serial_controller/two_wire_control.v                   
    VERILOG         two_wire_serial_controller/two_wire_iopad.v                     
    VERILOG         altera_eth_channel.sv                                           
    VERILOG         altera_eth_multi_channel.sv                                     
    

}

set hardware_a10_1g_10g_lineside_wo_1588 {
...
set qs_files_a10_1g_10g_lineside_wo_1588 {
...
set tb_a10_1g_10g_lineside_wo_1588 {
    ...
    SYSTEM_VERILOG              ed_sim/models/tb_testcase.sv
    SYSTEM_VERILOG              ed_sim/models/tb_top_n.sv
...
proc a10_1g_10g_lineside {synthesis_option device_part_value languaue_option part_number device_family family_tag} {

    global synth_sim_a10_1g_10g_lineside_wo_1588
    global ed_files_a10_1g_10g_lineside_wo_1588
    global qs_files_a10_1g_10g_lineside_wo_1588
    global hardware_a10_1g_10g_lineside_wo_1588
    global sim_a10_1g_10g_lineside_wo_1588
    global tb_a10_1g_10g_lineside_wo_1588
    ...
    set variant "LL10G_1G_10G_LINESIDE"
    ...
    foreach {from_folder file qsys_type} $ed_files_a10_1g_10g_lineside_wo_1588 {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth" || $synthesis_option == "sim"} {
        foreach {type file} $synth_sim_a10_1g_10g_lineside_wo_1588 {
...
#    }   
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth"} {
        ...
        foreach {type file} $qs_files_a10_1g_10g_lineside_wo_1588 {
            add_fileset_file $variant/$file $type PATH ../example_design/$variant/$file 
            
        } 
        
        # generate hardware debugging files
        foreach {type file} $hardware_a10_1g_10g_lineside_wo_1588 {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "sim"} {       
        ...
        foreach {type file} $tb_a10_1g_10g_lineside_wo_1588 {

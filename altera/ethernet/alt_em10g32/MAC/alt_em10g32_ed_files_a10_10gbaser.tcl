...
set ed_files_a10_10gbaser {

    rtl/phy                     altera_eth_10gbaser_phy    qsys_standalone
...
set synth_sim_a10_10gbaser {

    SYSTEM_VERILOG  rtl/altera_eth_10g_mac_base_r.sv                         
    VERILOG         rtl/altera_eth_10g_mac_base_r_wrap<family>.v                            
...
proc a10_10gbaser {synthesis_option device_part_value languaue_option part_number device_family family_tag} {

    global synth_sim_a10_10gbaser
    global ed_files_a10_10gbaser
    global qs_files_a10_10gbaser
    global hardware_a10_10gbaser
    global tb_a10_10gbaser
    ...
    foreach {from_folder file qsys_type} $ed_files_a10_10gbaser {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth" || $synthesis_option == "sim"} {
        foreach {type file} $synth_sim_a10_10gbaser {
            ...
            add_fileset_file $variant/$file_dest $type PATH ../example_design/$variant/$file_source 
        }  
    }
...
#    }   
    ...
    if {$synthesis_option == "both" || $synthesis_option == "sim"} {       
        ...
        foreach {type file} $tb_a10_10gbaser {
        ...
        # modify tb parameter     
        mod_top_and_tb_terp  ../example_design/$variant/simulation $variant ./simulation/ed_sim/models default_test_params_pkg.sv SYSTEM_VERILOG
    }

...
proc get_timing_info {} {
	...
	set to_path {{*alt_em10g32_clock_crosser:*|out_data_toggle_sync_reg[0]} {*alt_em10g32_clock_crosser:*|in_data_toggle_returned_sync_reg[0]} {*alt_em10g32_clock_crosser:*|out_data_buffer*}}

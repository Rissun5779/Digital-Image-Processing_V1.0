...
set ed_files_a10_qse_lineside_wo_1588 {
...
set synth_sim_a10_qse_lineside_wo_1588 {
...
set hardware_a10_qse_lineside_wo_1588 {
...
set qs_files_a10_qse_lineside_wo_1588 {
...
set tb_a10_qse_lineside_wo_1588 {
...
proc a10_qse_lineside {synthesis_option device_part_value languaue_option part_number device_family family_tag} {

    global synth_sim_a10_qse_lineside_wo_1588
    global ed_files_a10_qse_lineside_wo_1588
    global qs_files_a10_qse_lineside_wo_1588
    global hardware_a10_qse_lineside_wo_1588
    global sim_a10_qse_lineside_wo_1588
    global tb_a10_qse_lineside_wo_1588
    ...
    foreach {from_folder file qsys_type} $ed_files_a10_qse_lineside_wo_1588 {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth" || $synthesis_option == "sim"} {
        foreach {type file} $synth_sim_a10_qse_lineside_wo_1588 {
...
#    }   
    ...
    if {$synthesis_option == "both" || $synthesis_option == "synth"} {
        ...
        foreach {type file} $qs_files_a10_qse_lineside_wo_1588 {
            add_fileset_file $variant/$file $type PATH ../example_design/$variant/$file 
            
        } 
        
        # generate hardware debugging files
        foreach {type file} $hardware_a10_qse_lineside_wo_1588 {
    ...
    if {$synthesis_option == "both" || $synthesis_option == "sim"} {       
        ...
        foreach {type file} $tb_a10_qse_lineside_wo_1588 {

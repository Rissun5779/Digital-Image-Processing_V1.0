...
proc CONFIG_TSU {} {
    ...
    set PERIOD_1G_NSECOND          0xF
    set PERIOD_1G_FNSECOND         0xFFFF
    ...
    reg_write $10GMAC_BASE_ADDR $rx_10g_period_addr 0x33333
    ...
    reg_write $10GMAC_BASE_ADDR $tx_10g_period_addr 0x33333
    ...
    puts "\t Configure Period and Adjustment RX GMII TSU for 1G"
    reg_write $10GMAC_BASE_ADDR $rx_1g_period_addr 0xFFFFF
    ...
    puts "\t Configure Period and Adjustment TX GMII TSU for 1G"
    reg_write $10GMAC_BASE_ADDR $tx_1g_period_addr 0xFFFFF
 ...
 proc CONFIG_TSU_2P5G {} {
    ...
    global RX_ADJUST_10G_NSECOND
    global RX_ADJUST_10G_FNSECOND
    global RX_ADJUST_2P5G_NSECOND
    global RX_ADJUST_2P5G_FNSECOND
     
    global TX_ADJUST_10G_NSECOND
    global TX_ADJUST_10G_FNSECOND
    global TX_ADJUST_2P5G_NSECOND
    global TX_ADJUST_2P5G_FNSECOND
    ...
    # TX GMII TSU & RX GMII TSU
    puts "\t Configure Period and Adjustment RX GMII TSU for 2.5G"
    reg_write $10GMAC_BASE_ADDR $rx_1g_period_addr 0xFFFFF
    reg_write $10GMAC_BASE_ADDR $rx_1g_adjust_fns_addr $RX_ADJUST_2P5G_FNSECOND
    reg_write $10GMAC_BASE_ADDR $rx_1g_adjust_ns_addr  $RX_ADJUST_2P5G_NSECOND 
      
    puts "\t Configure Period and Adjustment TX GMII TSU for 2.5G"
    reg_write $10GMAC_BASE_ADDR $tx_1g_period_addr 0xFFFFF
    reg_write $10GMAC_BASE_ADDR $tx_1g_adjust_fns_addr $TX_ADJUST_2P5G_FNSECOND
    reg_write $10GMAC_BASE_ADDR $tx_1g_adjust_ns_addr  $TX_ADJUST_2P5G_NSECOND 
 }

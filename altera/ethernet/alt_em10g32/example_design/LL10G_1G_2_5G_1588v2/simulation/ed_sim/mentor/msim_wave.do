...
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_egress_timestamp_request_in_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_egress_timestamp_request_in_fingerprint}
add wave -noupdate -divider {TX Ingress Timestamp}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_etstamp_ins_ctrl_in_residence_time_update}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_etstamp_ins_ctrl_in_ingress_timestamp_96b}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_etstamp_ins_ctrl_in_ingress_timestamp_64b}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_etstamp_ins_ctrl_in_residence_time_calc_format}
add wave -noupdate -divider {TX Egress Timestamp}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_egress_timestamp_96b_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_egress_timestamp_96b_data}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_egress_timestamp_96b_fingerprint}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_egress_timestamp_64b_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_egress_timestamp_64b_data}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/tx_egress_timestamp_64b_fingerprint}
add wave -noupdate -divider {RX Ingress Timestamp}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/rx_ingress_timestamp_96b_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/rx_ingress_timestamp_96b_data}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/rx_ingress_timestamp_64b_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/rx_ingress_timestamp_64b_data}
...
add wave -noupdate -divider {TX Egress Timestamp Request}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_egress_timestamp_request_in_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_egress_timestamp_request_in_fingerprint}
add wave -noupdate -divider {TX Ingress Timestamp}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_etstamp_ins_ctrl_in_residence_time_update}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_etstamp_ins_ctrl_in_ingress_timestamp_96b}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_etstamp_ins_ctrl_in_ingress_timestamp_64b}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_etstamp_ins_ctrl_in_residence_time_calc_format}
add wave -noupdate -divider {TX Egress Timestamp}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_egress_timestamp_96b_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_egress_timestamp_96b_data}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_egress_timestamp_96b_fingerprint}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_egress_timestamp_64b_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_egress_timestamp_64b_data}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/tx_egress_timestamp_64b_fingerprint}
add wave -noupdate -divider {RX Ingress Timestamp}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/rx_ingress_timestamp_96b_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/rx_ingress_timestamp_96b_data}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/rx_ingress_timestamp_64b_valid}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/rx_ingress_timestamp_64b_data}

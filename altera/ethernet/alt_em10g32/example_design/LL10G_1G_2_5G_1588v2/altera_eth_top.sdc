...
#**************************************************************
# Set False Path for pseudostatic signal
#**************************************************************
set_false_path -from [get_registers *alt_mge_rcfg_a10:*|mode_selected*] -to [get_registers *alt_em10g32_gmii16b_tsu:*|ts_point_*]

...
module alt_mge_rcfg_a10_txpll_switch #(
    // Avalon-MM interface
...
assign {logical_pll_src_upper, logical_pll_src_lower} = reconfig_readdata_r[7:0];
    ...
    if(~rst_n) begin
        ...
        case(state)
            ...
            STM_WRITE_HIP_DATA: begin
                ...
                reconfig_read_r         <= 1'b0;
                reconfig_writedata_r    <= logical_pll_src_encoded;

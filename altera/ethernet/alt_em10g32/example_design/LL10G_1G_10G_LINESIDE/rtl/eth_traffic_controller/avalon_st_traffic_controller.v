...
// __________________________________________________________________________
 ...
 //  traffic generator
	...
	wire[11:0] avl_mm_address = {2'b00, avl_mm_baddress[11:2]}; // byte to word address
	wire[31:0] avl_mm_readdata_gen, avl_mm_readdata_mon, avl_mm_readdata_loopback;
	wire  blk_sel_gen = (avl_mm_address[11:8] == 4'h0);
	wire  blk_sel_mon = (avl_mm_address[11:8] == 4'h1);
	wire  blk_sel_loopback = (avl_mm_address[11:8] == 4'h2);		//jier added for avalon st loopback

...
USER_DEFINED_MACRO="+define+MIF_1G_FILE=\\\"../../../../rtl/reconfig/alt_mge_rcfg_a10_xcvr_1g.mif\\\"\ \\
+define+MIF_2p5G_FILE=\\\"../../../../rtl/reconfig/alt_mge_rcfg_a10_xcvr_2p5g.mif\\\"\ \\"

. $SETUP_SCRIPTS TOP_LEVEL_NAME="tb_top" SKIP_ELAB=1 SKIP_SIM=1 QUARTUS_INSTALL_DIR="$QUARTUS_INSTALL_DIR" QSYS_SIMDIR="./.." USER_DEFINED_SIM_OPTIONS="$USER_DEFINED_SIM_OPTIONS" USER_DEFINED_ELAB_OPTIONS="$USER_DEFINED_MACRO -debug_all\ -l\ compilation.log\ $USER_DEFINED_ELAB_OPTIONS"

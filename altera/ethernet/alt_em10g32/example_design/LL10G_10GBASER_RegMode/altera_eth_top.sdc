...
create_clock -period "100 MHz" -name csr_clk [get_ports csr_clk]
create_clock -period "50 MHz" -name debug_clk [get_ports debug_clk]
...
set_false_path -from [get_clocks {csr_clk}] -to [get_clocks {debug_clk}]
set_false_path -from [get_clocks {dut_inst|wrapper_inst|baser_inst|xcvr_native_a10_0|g_xcvr_native_insts[0].twentynm_xcvr_native_inst|inst_twentynm_pma|ch[0].inst_twentynm_pma_ch|gen_twentynm_hssi_pma_rx_deser.inst_twentynm_hssi_pma_rx_deser|clkdiv}] -to [get_clocks {debug_clk}]
set_false_path -from [get_clocks {dut_inst|wrapper_inst|baser_inst|xcvr_native_a10_0|g_xcvr_native_insts[0].twentynm_xcvr_native_inst|inst_twentynm_pma|ch[0].inst_twentynm_pma_ch|gen_twentynm_hssi_pma_rx_deser.inst_twentynm_hssi_pma_rx_deser|clkdiv}] -to [get_clocks {debug_clk}]

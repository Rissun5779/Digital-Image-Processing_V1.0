...
proc CMD_LIST {} {
		...
		puts "\n\n"
 		...
 		puts "\t\t	- Loopback Point \t: \tSFPP, ALTPMA, XGMII, AVALON_ST_LOOPBACK \n"
 		...
 		puts "\t\t	- Burtst Size and Iteration Is Not Available When Loopback Point is AVALON_ST_LOOPBACK \n"
		...
		puts "\t\t	- Option \t\t: \tBASE_ADDR, GEN_MAP, MON_MAP, 10G_MAC_MAP, PHY_IP_MAP AVALON_ST_LOOPBACK\n"
...
proc MEM_MAP {memory_map} {
	...
	if {$memory_map == "BASE_ADDR"} {
		puts "\n\n"
 		...
 		puts "\t	3. AVALON_ST_LOOPBACK_BASE_ADDR \t : \t $AVALON_ST_LOOPBACK_BASE_ADDR	\n"
	...
	} elseif {$memory_map == "AVALON_ST_LOOPBACK"} {
		puts "\n\n"
  		puts "\t 	==================================================================================== "
 		puts "\t\t	                    == Avalon ST Loopback Register Register Address ==				"
 		puts "\t\t	                    == Avalon ST Loopback Base Address = $AVALON_ST_LOOPBACK_BASE_ADDR ==" 		 		
 		puts "\t 	==================================================================================== "	

 		puts "\n"
 		puts "\t	1. AVALON_ST_LOOPBACK_ENA \t : \t [format "%#x" [expr $AVALON_ST_LOOPBACK_BASE_ADDR + $AVALON_ST_LOOPBACK_ENA]]	\n"	

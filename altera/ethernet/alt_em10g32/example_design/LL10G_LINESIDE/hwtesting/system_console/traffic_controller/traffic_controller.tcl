...
proc SET_TRAFFIC_CONTROLLER_STD_CHANNEL_BASE_ADDR {channel_id} {
	...
	global TRAFFIC_CONTROLLER_BASE_ADDR_CHANNEL_10
	global TRAFFIC_CONTROLLER_BASE_ADDR_CHANNEL_11
	...
	} elseif {$channel_id == 10} {
		set TRAFFIC_CONTROLLER_BASE_ADDR $TRAFFIC_CONTROLLER_BASE_ADDR_CHANNEL_10
	} elseif {$channel_id == 11} {
		set TRAFFIC_CONTROLLER_BASE_ADDR $TRAFFIC_CONTROLLER_BASE_ADDR_CHANNEL_11
	}	

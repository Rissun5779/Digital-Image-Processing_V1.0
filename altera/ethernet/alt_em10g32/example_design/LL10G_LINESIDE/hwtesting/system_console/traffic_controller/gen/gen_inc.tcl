...
proc SET_1588_GO_MASTER {} {
     ...
     puts "\t 			Master 1588 start 1 step operation "
	  ...
	  reg_write $TRAFFIC_CONTROLLER_BASE_ADDR $GO_MASTER 0x00000001
...
proc	SET_1588_START_TOD_SYNC {} {
     ...
     puts "\t 			Start TOD synchronization "
	  reg_write $TRAFFIC_CONTROLLER_BASE_ADDR $START_TOD_SYNC 0x03
}
...
proc CHKGEN_CONFIG {} {
	...
	puts $LOGFILE "\t		| GENERATOR CONFIGURATION AND STATUS             		"
 	...
 	puts $LOGFILE "\t 	    | Generator Start value	= [reg_read $GEN_BASE_ADDR $GEN_START] "
   }

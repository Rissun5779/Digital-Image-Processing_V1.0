...
proc SET_CHANNEL_BASE_ADDR {channel_id} {
	...
	set MDIO_BASE_ADDR			[expr {$BASE_ADDR + 0x9500}]					
	set XGMII_LB_BASE_ADDR		[expr {$BASE_ADDR + 0x9900}] 				
	set 10G_RX_FIFO_BASE_ADDR	[expr {$BASE_ADDR + 0x9700}]			
	set 10G_TX_FIFO_BASE_ADDR	[expr {$BASE_ADDR + 0x9600}]		

	set TOD_10G_ADDR		 	 [expr {$BASE_ADDR + 0x7800}]
	set TOD_1G_ADDR		  	 [expr {$BASE_ADDR + 0x7900}]	

}


#default value for base address

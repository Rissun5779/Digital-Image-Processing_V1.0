...
add wave -noupdate /tb_top/DUT/u_xcvr_atx_pll_10g/pll_powerdown
...
add wave -noupdate /tb_top/DUT/u_xcvr_atx_pll_10g/mcgb_rst
...
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/xgmii_tx_control}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/xgmii_tx_data}
add wave -noupdate -divider {XGMII RX}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/xgmii_rx_control}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/xgmii_rx_data}
...
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/rx_pma_clkout}
add wave -noupdate -divider {PHY Status}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[0]/u_channel/rx_block_lock}
...
add wave -noupdate -divider {XGMII TX}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/xgmii_tx_control}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/xgmii_tx_data}
add wave -noupdate -divider {XGMII RX}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/xgmii_rx_control}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/xgmii_rx_data}
add wave -noupdate -divider {GMII 16b TX}
...
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/rx_pma_clkout}
add wave -noupdate -divider {PHY Status}
add wave -noupdate {/tb_top/DUT/CHANNEL_GEN[1]/u_channel/rx_block_lock}

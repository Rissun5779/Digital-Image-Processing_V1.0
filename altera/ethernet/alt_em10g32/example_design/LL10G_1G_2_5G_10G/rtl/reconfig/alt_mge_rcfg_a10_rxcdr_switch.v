...
module alt_mge_rcfg_a10_rxcdr_switch #(
    // Avalon-MM interface
...
//
// State definition
localparam STM_IDLE                 = 4'b001;
localparam STM_READ_HIP_DATA        = 4'b010;
localparam STM_WRITE_HIP_DATA       = 4'b100;

// XCVR address offset
localparam CDR_REFCLK_0_LOGICAL_ADDR    = 10'h16A;
localparam CDR_REFCLK_1_LOGICAL_ADDR    = 10'h16B;
localparam CDR_REFCLK_SELECT_MUX_ADDR   = 10'h141;
...
// Logical PLL
wire  [7:0]                         logical_pll_src_selected;
...
assign logical_pll_src_selected = reconfig_readdata_r[7:0];
    ...
    if(~rst_n) begin
        ...
        case(state)
            ...
            STM_WRITE_HIP_DATA: begin
                ...
                reconfig_read_r         <= 1'b0;
                reconfig_writedata_r    <= logical_pll_src_selected;

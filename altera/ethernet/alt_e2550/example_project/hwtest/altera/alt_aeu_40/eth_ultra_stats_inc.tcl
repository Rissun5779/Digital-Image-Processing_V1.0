...
# agreement for further details.
 ...
 set  REG_PAYLOAD_OCTETS_OK  0x60
 set  REG_FRAME_OCTETS_OK    0x62
...
proc check_stats {reg_base t} {
     ...
     global REG_PAYLOAD_OCTETS_OK
     global REG_FRAME_OCTETS_OK
    ...
    puts  "Payload Octets OK                : [expr [stats_read $BASE_STATS     $REG_PAYLOAD_OCTETS_OK  ]] "
    puts  "Frame Octets OK                  : [expr [stats_read $BASE_STATS     $REG_FRAME_OCTETS_OK    ]] "

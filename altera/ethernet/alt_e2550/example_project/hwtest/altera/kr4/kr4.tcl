...
proc kr_defaults {{nomwt 1}} {
  global BASE_KR4
  global ADDR_KR4_LTCTRL
#todo
  reg_write   $BASE_KR4 $ADDR_KR4_LTCTRL [expr 0x00305111 | ($nomwt << 1)]
}

proc kr_defaults_man {{ctle 15} {nomwt 1}} {
  global BASE_KR4
  global ADDR_KR4_LTCTRL
#todo
  reg_write   $BASE_KR4 $ADDR_KR4_LTCTRL [expr 0x00405111 | ($ctle << 24) | ($nomwt << 1)]
}
...
proc chan_stat_csv {chan {usefec 0}} {
    ...
    reconfig_write $chan 0x14c 28
    set vref [expr [reconfig_read $chan 0x177] & 0x1f]
    ...
    set CDRfix [expr ([reconfig_read $chan 0x134] & 0x40) >> 2]
    set CDRfix [expr $CDRfix | ([reconfig_read $chan 0x136] & 0xf)]
    
    set CDRdyn [expr ([reconfig_read $chan 0x137] >> 2) & 0x1f]
    
    set Ipd [expr ([reconfig_read $chan 0x139] >> 3) & 0x7]
    set Rpd [expr ([reconfig_read $chan 0x135] >> 2) & 0x3]
    ...
    puts -nonewline "$dfe_man, $tap1, $tap2, $tap3, $tap4, $tap5, $tap6, $tap7, \t$CDRfix, $CDRdyn, $Ipd, $Rpd, "
...
proc run_test_meas {t} {
    ...
    puts "GLOBAL,reg 0xB0  ,reg 0xB1  ,reg 0xC1  ,reg 0xD0  ,reg 0xD1  ,reg 0xD2  ,\tTX Starts,RX Starts,RX FCS Err,\tFlags"
    ...
    puts ""
    puts -nonewline "LANE#\tvod, post, pre,\tvod_rd, post_rd, pre_rd, dcg, VREF, CTLEm, CTLE, VGAm, VGA, DFEm, DFE1, DFE2, DFE3, DFE4, DFE5, DFE6, DFE7, \tCDRfix, CDRdyn, Ipd, Rpd, "

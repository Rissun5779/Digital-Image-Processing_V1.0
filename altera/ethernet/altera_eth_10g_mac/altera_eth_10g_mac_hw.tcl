...
set_module_property DISPLAY_NAME "Ethernet 10G MAC Intel FPGA IP"
set_module_property DESCRIPTION "Ethernet 10G MAC Intel FPGA IP"
...
set_module_property SUPPORTED_DEVICE_FAMILIES {{Arria II GX} {Arria II GZ} {Cyclone IV GX} {Stratix IV} {Stratix V} {Arria V} {Cyclone V} {Arria V GZ}}
# |
# +-----------------------------------
...
proc compose {} {
    ...
    set unidirectional_ena [get_parameter_value ENABLE_UNIDIRECTIONAL]
    ...
    if { [expr ($datapath_option & 0x3)] } {
        ...
        set_instance_parameter csr_clk_module clockFrequencyKnown "false"
    ...
    if { [expr ($datapath_option & 0x1)] } {
        ...
        #Default Slave
        add_instance tx_eth_default_slave altera_eth_default_slave
        
        add_connection tx_bridge.m0 tx_eth_default_slave.csr
        set_connection_parameter_value tx_bridge.m0/tx_eth_default_slave.csr defaultConnection "1"
    
        #Clock Connections
        add_connection tx_clk_module.clk/tx_eth_default_slave.clock_reset
        add_connection csr_clk_module.clk_reset/tx_eth_default_slave.csr_reset
        }
        ...
        # Compose MAC TX
        if {[_get_device_type]} {
        compose_eth_10g_mac_tx tx_clk_module.clk tx_clk_module.clk_reset csr_clk_module.clk_reset $tx_1g_clock_src $tx_1g_reset_src merlin_master_translator.avalon_universal_master_0 $stat_ena $reg_stat $crc_tx $preamble_mode $pfc_ena $pfc_priority_num $timestamp_ena $ptp_1step_ena $tstamp_fp_width $mac_1g10g_ena $unidirectional_ena
        
        
        } else {
        compose_eth_10g_mac_tx tx_clk_module.clk tx_clk_module.clk_reset csr_clk_module.clk_reset $tx_1g_clock_src $tx_1g_reset_src tx_bridge.m0 $stat_ena $reg_stat $crc_tx $preamble_mode $pfc_ena $pfc_priority_num $timestamp_ena $ptp_1step_ena $tstamp_fp_width $mac_1g10g_ena $unidirectional_ena
        ...
        # Export of Unidirectional Status
        if {$unidirectional_ena == 1} {
            add_interface unidirectional_en conduit end
            set_interface_property unidirectional_en export_of tx_eth_link_fault_generation.unidirectional_en
            set_interface_property unidirectional_en PORT_NAME_MAP "unidirectional_en unidirectional_en"
            
            add_interface unidirectional_remote_fault_dis conduit end
            set_interface_property unidirectional_remote_fault_dis export_of tx_eth_link_fault_generation.unidirectional_remote_fault_dis
            set_interface_property unidirectional_remote_fault_dis PORT_NAME_MAP "unidirectional_remote_fault_dis unidirectional_remote_fault_dis"
            
            add_interface unidirectional_force_remote_fault conduit end
            set_interface_property unidirectional_force_remote_fault export_of tx_eth_link_fault_generation.unidirectional_force_remote_fault
            set_interface_property unidirectional_force_remote_fault PORT_NAME_MAP "unidirectional_force_remote_fault unidirectional_force_remote_fault"
        }
    }
    ...
    if { [expr ($datapath_option & 0x2)] } {
        ...
        if {[_get_device_type]} {
        #Default Slave
        add_instance eth_default_slave altera_eth_default_slave
        
        add_connection merlin_master_translator.avalon_universal_master_0 eth_default_slave.csr
        set_connection_parameter_value merlin_master_translator.avalon_universal_master_0/eth_default_slave.csr defaultConnection "1"
    
        #Clock Connections
        add_connection rx_clk_module.clk_reset/eth_default_slave.csr_reset
        add_connection csr_clk_module.clk/eth_default_slave.clock_reset
        ...
        #Default Slave
        add_instance rx_eth_default_slave altera_eth_default_slave
        
        add_connection rx_bridge.m0 rx_eth_default_slave.csr
        set_connection_parameter_value rx_bridge.m0/rx_eth_default_slave.csr defaultConnection "1"
    
        #Clock Connections
        add_connection rx_clk_module.clk/rx_eth_default_slave.clock_reset
        add_connection csr_clk_module.clk_reset/rx_eth_default_slave.csr_reset
        }
...
proc compose_eth_10g_mac_tx {tx_clock_src tx_reset_src csr_reset tx_1g_clock_src tx_1g_reset_src tx_csr_master stat_ena reg_stat crc_tx preamble_mode pfc_ena pfc_priority_num timestamp_ena ptp_1step_ena tstamp_fp_width mac_1g10g_ena unidirectional_ena} {
    ...
    compose_eth_mac_tx $tx_clock_src $tx_reset_src $csr_reset $tx_1g_clock_src $tx_1g_reset_src $tx_csr_master $stat_ena $reg_stat $crc_tx $preamble_mode $pfc_ena $pfc_priority_num $timestamp_ena $ptp_1step_ena $tstamp_fp_width $mac_1g10g_ena $unidirectional_ena
    ...
    compose_eth_xgmii_tx $tx_clock_src $tx_reset_src $tx_csr_master $crc_tx $preamble_mode $timestamp_ena $ptp_1step_ena $unidirectional_ena
}
...
proc compose_eth_mac_rx {rx_clock_src rx_reset_src csr_reset rx_1g_clock_src rx_1g_reset_src rx_csr_master stat_ena reg_stat supp_addr_ena preamble_mode pfc_ena pfc_priority_num timestamp_ena mac_1g10g_ena} {
    if {$timestamp_ena == 1} {
        ...
        set_instance_parameter rx_st_timing_adapter_timestamp_aligner_in inUseEmptyPort "NO"
...
proc compose_eth_mac_tx {tx_clock_src tx_reset_src csr_reset tx_1g_clock_src tx_1g_reset_src tx_csr_master stat_ena reg_stat crc_tx preamble_mode pfc_ena pfc_priority_num timestamp_ena ptp_1step_ena tstamp_fp_width mac_1g10g_ena unidirectional_ena} {
    ...
    if {$unidirectional_ena == 1} {
        add_connection ${csr_reset}/tx_eth_link_fault_generation.csr_reset
    }
    ...
    if {$unidirectional_ena == 1} {
        add_connection ${tx_csr_master}/tx_eth_link_fault_generation.csr
        set_connection_parameter_value ${tx_csr_master}/tx_eth_link_fault_generation.csr arbitrationPriority "1"
        if {[_get_device_type]} {
        set_connection_parameter_value ${tx_csr_master}/tx_eth_link_fault_generation.csr baseAddress "0x4480"
        } else {
        set_connection_parameter_value ${tx_csr_master}/tx_eth_link_fault_generation.csr baseAddress "0x0480"
        }
    }
}

proc compose_eth_xgmii_tx {tx_clock_src tx_reset_src tx_csr_master crc_tx preamble_mode timestamp_ena ptp_1step_ena unidirectional_ena} {
    ...
    if {$unidirectional_ena == 1} {
        add_instance tx_eth_link_fault_generation altera_eth_link_fault_generation_unidirectional
    } else {
    ...
    if {$timestamp_ena == 1} {
        ...
        if {$unidirectional_ena == 1} {
            set_instance_parameter tx_eth_xgmii_tsu INTERNAL_PATH_DELAY_CYCLE "2"
        } else {
        ...
        if {$ptp_1step_ena == 1} {          
            ...
            if {$unidirectional_ena == 1} {
                set_instance_parameter tx_eth_xgmii_tsu INTERNAL_PATH_DELAY_CYCLE "12"
            } else {
...
add_documentation_link "User Guide" https://www.altera.com/en_US/pdfs/literature/ug/10gbps_mac.pdf
add_documentation_link "Release Notes" https://documentation.altera.com/#/link/hco1421698042087/hco1421697696565

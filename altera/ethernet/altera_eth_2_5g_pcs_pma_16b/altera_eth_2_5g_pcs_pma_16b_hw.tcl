...
proc compose {} {
    ...
    if {[_is_phy_ip] == "5" } {
        ...
        set_instance_parameter xcvr_native  tx_pma_clk_div 1
        set_instance_parameter xcvr_native  set_cdr_refclk_freq "125.000000"
        set_instance_parameter xcvr_native  protocol_mode "gige"
        set_instance_parameter xcvr_native  enable_port_rx_pma_div_clkout 1
        set_instance_parameter xcvr_native  rx_pma_div_clkout_divider 1        
        set_instance_parameter xcvr_native  std_pcs_pma_width 10
        set_instance_parameter xcvr_native  std_tx_byte_ser_mode "Serialize x2"
        set_instance_parameter xcvr_native  std_rx_byte_deser_mode "Deserialize x2"
        ...
        set_instance_parameter xcvr_native  std_rx_word_aligner_pattern_len "7"
        set_instance_parameter xcvr_native  std_rx_word_aligner_pattern "7'b1111100"
        set_instance_parameter xcvr_native  rcfg_enable "1"
        set_instance_parameter xcvr_native  std_rx_word_aligner_rknumber "3"
        set_instance_parameter xcvr_native  std_rx_word_aligner_renumber "3"
        set_instance_parameter xcvr_native  std_rx_word_aligner_rgnumber "3"
        set_instance_parameter xcvr_native  rx_ppm_detect_threshold "100"
        set_instance_property  xcvr_native  SUPPRESS_ALL_WARNINGS true
        ...
        set_instance_parameter xcvr_phy word_aligner_pattern_length "7"
        set_instance_parameter xcvr_phy word_align_pattern "1111100"
    ...
    if {[_is_phy_ip] == "5" } {
        ...
        set_interface_property tx_ready EXPORT_OF eth_2_5g_pcs_16b.tx_ready
        set_interface_property tx_ready  PORT_NAME_MAP   {tx_ready tx_ready}

        add_interface rx_ready conduit end
        set_interface_property rx_ready EXPORT_OF eth_2_5g_pcs_16b.rx_ready
        ...
        set_interface_property reconfig_clk  EXPORT_OF xcvr_native.reconfig_clk
      
        add_interface reconfig_reset conduit end
        set_interface_property reconfig_reset EXPORT_OF xcvr_native.reconfig_reset
      
        add_interface reconfig_avmm conduit end
        set_interface_property reconfig_avmm EXPORT_OF xcvr_native.reconfig_avmm
        
        # loopback to phy rx_coreclkin
        add_connection eth_2_5g_pcs_16b.tx_clkout_lb/xcvr_native.tx_coreclkin
        add_connection eth_2_5g_pcs_16b.rx_clkout_lb/xcvr_native.rx_coreclkin
        ...
        add_connection xcvr_native.rx_pma_div_clkout/eth_2_5g_pcs_16b.rx_recovered_clk_in
        ...
        add_connection eth_2_5g_pcs_16b.unused_tx_parallel_data/xcvr_native.unused_tx_parallel_data        
        add_connection xcvr_native.unused_rx_parallel_data/eth_2_5g_pcs_16b.unused_rx_parallel_data
	...
	add_interface ref_clk clock end
        ...
        # unused port - feed to pcs and do nothing
        add_connection xcvr_phy.rx_bitslipboundaryselectout/eth_2_5g_pcs_16b.rx_bitslipboundaryselectout

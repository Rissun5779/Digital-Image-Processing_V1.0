...
module altera_eth_2_5g_pcs_pma_16b (
	...
	output [1:0]   tx_datak;
    output [109:0] unused_tx_parallel_data;
    output         rx_recovered_clk;

    input  [95:0]  unused_rx_parallel_data;
    ...
    input  [3:0]   rx_rmfifostatus;
	input  [15:0]  rx_parallel_data;
	input  [1:0]   rx_datak;
    input          rx_recovered_clk_in;
    ...
    assign rx_clkout_lb = rx_clkout;
    assign tx_clkout_lb = tx_clkout;
    assign rx_rmfifodatainserted = rx_rmfifostatus[3:2];
    assign rx_rmfifodatadeleted = rx_rmfifostatus[1:0];
    assign unused_tx_parallel_data = 110'b0;
    assign rx_recovered_clk = rx_recovered_clk_in;
	...
	defparam
		...
		altera_tse_pcs_pma_gige_inst.DEV_VERSION = DEV_VERSION,

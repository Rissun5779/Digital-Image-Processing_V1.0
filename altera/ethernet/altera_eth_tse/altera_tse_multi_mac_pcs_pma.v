...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 0)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_0(
         .clk(ref_clk), // INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_0_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 1)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_1(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_1_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 2)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_2(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_2_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 3)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_3(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_3_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 4)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_4(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_4_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 5)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_5(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_5_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 6)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_6(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_6_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 7)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_7(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_7_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 8)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_8(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_8_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 9)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_9(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_9_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 10)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_10(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_10_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 11)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_11(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_11_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 12)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_12(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_12_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 13)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_13(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_13_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 14)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_14(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_14_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 15)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_15(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_15_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 16)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_16(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_16_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 17)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_17(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_17_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 18)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_18(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_18_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 19)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_19(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_19_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 20)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_20(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_20_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 21)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_21(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_21_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 22)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_22(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_22_U_SYNC_RX_RESET_SEQUENCE_DONE(
...
generate if (DEVICE_FAMILY != "ARRIAGX" && TRANSCEIVER_OPTION == 1 && MAX_CHANNELS > 23)
    ...
    begin
      ...
      altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_REV_LOOPBACK_TX_23(
         .clk(ref_clk), // INPUT
         .reset_n(~reset_ref_clk_int), //INPUT
    ...
    altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) ch_23_U_SYNC_RX_RESET_SEQUENCE_DONE(

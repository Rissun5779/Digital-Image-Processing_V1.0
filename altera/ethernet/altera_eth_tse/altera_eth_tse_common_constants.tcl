...
set WIRE_MAC_ECCSTATUS_CP_NAME mac_eccstatus_connection
set WIRE_PCS_ECCSTATUS_CP_NAME pcs_eccstatus_connection
...
set TX_PTP_ALIGNMENT                   tx_ptp_alignment
...
set common_rtl_files {
   ...
   altera_eth_tse_std_synchronizer_bundle.v VERILOG
   altera_eth_tse_ptp_std_synchronizer.v  VERILOG
   ...
   altera_tse_ecc_dec_x10.v               VERILOG
   altera_tse_ecc_enc_x10.v               VERILOG
   altera_tse_ecc_enc_x10_wrapper.v       VERILOG
   altera_tse_ecc_dec_x14.v               VERILOG
   altera_tse_ecc_enc_x14.v               VERILOG
   altera_tse_ecc_enc_x14_wrapper.v       VERILOG
   altera_tse_ecc_dec_x2.v                VERILOG
   altera_tse_ecc_enc_x2.v                VERILOG
   altera_tse_ecc_enc_x2_wrapper.v        VERILOG
   altera_tse_ecc_dec_x23.v               VERILOG
   altera_tse_ecc_enc_x23.v               VERILOG
   altera_tse_ecc_enc_x23_wrapper.v       VERILOG
   altera_tse_ecc_dec_x36.v               VERILOG
   altera_tse_ecc_enc_x36.v               VERILOG
   altera_tse_ecc_enc_x36_wrapper.v       VERILOG
   altera_tse_ecc_dec_x40.v               VERILOG
   altera_tse_ecc_enc_x40.v               VERILOG
   altera_tse_ecc_enc_x40_wrapper.v       VERILOG
   altera_tse_ecc_dec_x30.v               VERILOG
   altera_tse_ecc_enc_x30.v               VERILOG
   altera_tse_ecc_enc_x30_wrapper.v       VERILOG
   altera_tse_ecc_status_crosser.v        VERILOG
}
...
set mac_rtl_files {
   ...
   altera_tse_dpram_ecc_16x32.v           VERILOG

...
set_module_property GROUP "Interface Protocols/Ethernet/1G Multi-rate Ethernet"
set_module_property DISPLAY_NAME "Triple-Speed Ethernet Intel FPGA IP"
set_module_property DESCRIPTION "Triple Speed Ethernet Intel FPGA IP"
set_module_property DATASHEET_URL "https://www.intel.com/content/dam/altera-www/global/en_US/pdfs/literature/ug/ug_ethernet.pdf"
...
proc compose_mac {} {
   ...
   global WIRE_MAC_ECCSTATUS_CP_NAME
   ...
   set isUseMAC [get_parameter_value isUseMAC]
   set isUsePCS [get_parameter_value isUsePCS]
   set use_mac_clken [get_parameter_value use_mac_clken]
   ...
   if {$isUsePCS} {
      ...
      set_instance_parameter $mac_instance use_mac_clken 0 
      ...
      set_interface_property $AVALON_CP_NAME PORT_NAME_MAP "reg_rd reg_rd reg_wr reg_wr 
      reg_data_in reg_data_in reg_data_out reg_data_out reg_busy reg_busy reg_addr reg_addr"
      ...
      set_instance_parameter $mac_instance use_mac_clken $use_mac_clken

      if {$use_mac_clken} {
         add_interface $WIRE_CLKENA_CP_NAME conduit end
         set_interface_property $WIRE_CLKENA_CP_NAME EXPORT_OF $mac_instance\.$WIRE_CLKENA_CP_NAME
         compose_rename_and_register_ports $mac_instance $WIRE_CLKENA_CP_NAME
      }
   ...
   if {$enable_ecc} {
      add_interface $WIRE_MAC_ECCSTATUS_CP_NAME conduit end
      set_interface_property $WIRE_MAC_ECCSTATUS_CP_NAME EXPORT_OF $mac_instance\.$WIRE_MAC_ECCSTATUS_CP_NAME
      compose_rename_and_register_ports $mac_instance $WIRE_MAC_ECCSTATUS_CP_NAME
   }
   ...
   # Special handling for RGMII interface for MAX 10 device
   # since altera_gpio_lite is used as replacement for altddio_in and altddio_out
   if {[expr {"$deviceFamily" == "MAX10"}] && [expr {"$ifGMII" == "RGMII"}]} {
      create_and_connect_altera_gpio_lite_instances 0 $mac_instance
   }
...
proc compose_fifoless_mac {} {
   ...
   if { $enable_sgmii &&
      ...
      set enable_timestamping [get_parameter_value enable_timestamping]  
   } elseif {[expr {"$core_variation" == "MAC_ONLY"}] &&
      [expr {"$enable_use_internal_fifo" == "false"}] &&
   ...
   for {set index 0} { $index < $max_channels} {incr index} {
     ...
     # Export timestamp port
      ...
      if {$enable_ecc} {
         add_interface $WIRE_MAC_ECCSTATUS_CP_NAME\_$index  conduit end
         set_interface_property $WIRE_MAC_ECCSTATUS_CP_NAME\_$index  EXPORT_OF $instance_name\.$WIRE_MAC_ECCSTATUS_CP_NAME
         compose_rename_and_register_ports $instance_name $WIRE_MAC_ECCSTATUS_CP_NAME $index
      }

      # Special handling for RGMII interface for Arria 10 device
      # since altera_gpio is used as replacement for altddio_in and altddio_out
      if {[expr {"$deviceFamily" == "ARRIA10"}] && [expr {"$ifGMII" == "RGMII"}]} {
         create_and_connect_altera_gpio_instances $index $instance_name
      }

      # Special handling for RGMII interface for MAX 10 device
      # since altera_gpio_lite is used as replacement for altddio_in and altddio_out
      if {[expr {"$deviceFamily" == "MAX10"}] && [expr {"$ifGMII" == "RGMII"}]} {
         create_and_connect_altera_gpio_lite_instances $index $instance_name
      }

      if {$isUsePCS} {
         set_instance_parameter $instance_name use_mac_clken 0

         # We will connect the MAC to PCS during the PCS instantiation process later.
      } else {
         set_instance_parameter $instance_name use_mac_clken $use_mac_clken

         if {$use_mac_clken} {
            add_interface $WIRE_CLKENA_CP_NAME\_$index conduit end
            set_interface_property $WIRE_CLKENA_CP_NAME\_$index EXPORT_OF $instance_name\.$WIRE_CLKENA_CP_NAME
            compose_rename_and_register_ports $instance_name $WIRE_CLKENA_CP_NAME $index
         }
...
proc compose_pcs {} {
   ...
   for {set index 0} { $index < $pcs_max_channels} {incr index} {
      ...
      set_instance_parameter $the_pcs_instance enable_use_internal_fifo $enable_use_internal_fifo
      set_instance_parameter $the_pcs_instance enable_hd_logic $enable_hd_logic
      ...
      if {$isUseMAC} {
         ...
         if {$enable_use_internal_fifo} {
            ...
            if {$enable_ecc} {
               add_interface $WIRE_PCS_ECCSTATUS_CP_NAME conduit end
               set_interface_property $WIRE_PCS_ECCSTATUS_CP_NAME EXPORT_OF $the_pcs_instance\.$WIRE_PCS_ECCSTATUS_CP_NAME
               compose_rename_and_register_ports $the_pcs_instance $WIRE_PCS_ECCSTATUS_CP_NAME
            }
            ...
            if {$enable_ecc} {
               add_interface $WIRE_PCS_ECCSTATUS_CP_NAME\_$index  conduit end
               set_interface_property $WIRE_PCS_ECCSTATUS_CP_NAME\_$index  EXPORT_OF $the_pcs_instance\.$WIRE_PCS_ECCSTATUS_CP_NAME
               compose_rename_and_register_ports $the_pcs_instance $WIRE_PCS_ECCSTATUS_CP_NAME $index 
            }
         }
...
proc compose_pcs_pma_lvds {} {
   ...
   #addressing fb case 181750
   set qip_strings [list ]
   set set_inst_asgmnt "set_instance_assignment -entity \"altera_eth_tse_pcs_pma_lvds\" -library \"%libraryName%\""
   lappend qip_strings "${set_inst_asgmnt} -name MESSAGE_DISABLE 14320"
   ...
   for {set index 0} { $index < $pcs_max_channels} {incr index} {
      ...
      if {$isUseMAC} {
         ...
         # Connect PCS TX/RX latency adj and tx ptp alignment port to MAC
         if {$enable_timestamping} {
            ...
            add_connection $the_pcs_instance.$TX_PTP_ALIGNMENT $the_mac_instance.$TX_PTP_ALIGNMENT
         } 
...
proc compose_pcs_pma_nf_lvds {} {
   ...
   set nf_lvds_iopll_num_channels [get_parameter_value nf_lvds_iopll_num_channels]
   
   #addressing fb case 181750
  # set qip_strings [list ]
  # set set_inst_asgmnt "set_instance_assignment -entity \"altera_eth_tse_pcs_pma_nf_lvds\" -library \"%libraryName%\""
  # lappend qip_strings "${set_inst_asgmnt} -name MESSAGE_DISABLE 14320"
  # lappend qip_strings "set_instance_assignment -entity \"%entityName%\" -library \"%libraryName%\" -name MESSAGE_DISABLE 18694 -to \"*altera_lvds_core20_iopll\""

   send_message warning "To prevent potential performance issues, please ensure the reference clock to the LVDS uses the dedicated reference clock input within the same I/O bank directly.  Manual reference clock promotion is not recommended"
   ...
   if {$isUseMAC} {
      if {$enable_use_internal_fifo} {
         set pcs_max_channels 1
         set nf_lvds_iopll_num_channels_final 1
      } else {
         set pcs_max_channels $max_channels
         set nf_lvds_iopll_num_channels_final $nf_lvds_iopll_num_channels
      }
   } else {
      set pcs_max_channels 1
      set nf_lvds_iopll_num_channels_final 1
   ...
   # Common reg_clk and reset bridge for PCS_ONLY variants that connects to PCS and LVDS IO terminator
   if {$isUseMAC} {} else {
      add_instance reg_clk_module altera_clock_bridge
      add_instance reg_rst_module altera_reset_bridge
   ...
   for {set index 0} { $index < $pcs_max_channels} {incr index} {
      ...
      if {[expr (($index + $nf_lvds_iopll_num_channels_final) % $nf_lvds_iopll_num_channels_final)] == 0} {
         ...
         update_lvdsio_rx_instance_param $index $nf_lvds_iopll_num_channels_final
         update_lvdsio_tx_instance_param $index $nf_lvds_iopll_num_channels_final
   
         add_instance $the_lvdsio_terminator_instance altera_eth_tse_nf_lvds_terminator
         set_instance_parameter $the_lvdsio_terminator_instance NUM_CHANNELS $nf_lvds_iopll_num_channels_final
         set_instance_parameter $the_lvdsio_terminator_instance SYNCHRONIZER_DEPTH [get_parameter_value synchronizer_depth]

         # Connect the ref_clk and reset to terminator
         add_connection ref_clk_module.out_clk $the_lvdsio_terminator_instance.lvds_inclock
         add_connection reg_rst_module.out_reset $the_lvdsio_terminator_instance.reset_in

         # Connect terminator and LVDS IO together
         ...
         add_connection $the_lvdsio_terminator_instance.rx_dpa_locked $the_lvdsio_rx_instance.rx_dpa_locked
         add_connection $the_lvdsio_terminator_instance.rx_divfwdclk $the_lvdsio_rx_instance.rx_divfwdclk
         add_connection $the_lvdsio_terminator_instance.rx_coreclock $the_lvdsio_rx_instance.rx_coreclock
         add_connection $the_lvdsio_terminator_instance.pll_locked_rx $the_lvdsio_rx_instance.pll_locked
         add_connection $the_lvdsio_terminator_instance.pll_areset_rx $the_lvdsio_rx_instance.pll_areset
         ...
         add_connection $the_lvdsio_terminator_instance.pll_locked_tx $the_lvdsio_tx_instance.pll_locked
         add_connection $the_lvdsio_terminator_instance.pll_areset_tx $the_lvdsio_tx_instance.pll_areset

         if {$isUseMAC} {
            if {$enable_use_internal_fifo} {
               # Export the PMA serial connection point from LVDS IO terminator
               add_interface $PMA_SERIAL_CP_NAME  conduit end
               set_interface_property $PMA_SERIAL_CP_NAME EXPORT_OF $the_lvdsio_terminator_instance\.$PMA_SERIAL_CP_NAME\_0
   
               set port_map_list {}
               lappend port_map_list txp txp_0
               lappend port_map_list rxp rxp_0
               set_interface_property $PMA_SERIAL_CP_NAME PORT_NAME_MAP $port_map_list
            } else {
               for {set serial_cp_index 0} { $serial_cp_index < $nf_lvds_iopll_num_channels_final} {incr serial_cp_index} {
                  set top_serial_cp_index [expr $index + $serial_cp_index]
   
                  # Export the PMA serial connection point from LVDS IO terminator
                  add_interface $PMA_SERIAL_CP_NAME\_$top_serial_cp_index conduit end
                  set_interface_property $PMA_SERIAL_CP_NAME\_$top_serial_cp_index EXPORT_OF \
                     $the_lvdsio_terminator_instance\.$PMA_SERIAL_CP_NAME\_$serial_cp_index
   
                  set port_map_list {}
                  lappend port_map_list txp_$top_serial_cp_index txp_$serial_cp_index
                  lappend port_map_list rxp_$top_serial_cp_index rxp_$serial_cp_index
                  set_interface_property $PMA_SERIAL_CP_NAME\_$top_serial_cp_index PORT_NAME_MAP $port_map_list
               }
            }
         } else {
            # Export the PMA serial connection point from LVDS IO terminator
      ...
      # Connect PCS and LVDS IO terminator together
      set lvdsio_terminator_port_index [expr ($index+ $nf_lvds_iopll_num_channels_final) % $nf_lvds_iopll_num_channels_final]

      add_connection $the_pcs_instance.tbi_tx_d_muxed $the_lvdsio_terminator_instance.tbi_tx_d_muxed_$lvdsio_terminator_port_index
      add_connection $the_pcs_instance.tbi_rx_d_lvds $the_lvdsio_terminator_instance.tbi_rx_d_lvds_$lvdsio_terminator_port_index
      add_connection $the_pcs_instance.tbi_rx_clk $the_lvdsio_terminator_instance.tbi_rx_clk_$lvdsio_terminator_port_index

      add_connection $the_pcs_instance.rx_reset_sequence_done $the_lvdsio_terminator_instance.rx_reset_sequence_done_$lvdsio_terminator_port_index
      add_connection $the_pcs_instance.rx_reset $the_lvdsio_terminator_instance.rx_reset_$lvdsio_terminator_port_index
      add_connection $the_pcs_instance.tx_reset $the_lvdsio_terminator_instance.tx_reset_$lvdsio_terminator_port_index
      ...
      if {$isUseMAC} {
         ...
         # Connect clock and reset connection points to PCS instance
         add_connection reg_clk_module.out_clk $the_pcs_instance.$AVALON_CLOCK_CP_NAME
         add_connection reg_rst_module.out_reset $the_pcs_instance.$AVALON_RESET_CP_NAME
...
proc update_lvdsio_rx_instance_param {args} {
   set index [lindex $args 0]
   set num_channels [lindex $args 1]
   ...
   set_instance_parameter $the_lvdsio_rx_instance RX_USE_BITSLIP "false"
   set_instance_parameter $the_lvdsio_rx_instance RX_INCLOCK_PHASE_SHIFT "0"
   set_instance_parameter $the_lvdsio_rx_instance RX_BITSLIP_USE_RESET "false"
   ...
   set_instance_parameter $the_lvdsio_rx_instance TX_OUTCLOCK_DIVISION "2"
   ...
   set_instance_parameter $the_lvdsio_rx_instance NUM_CHANNELS $num_channels
}
...
proc update_lvdsio_tx_instance_param {args} {
   ...
   set_instance_parameter $the_lvdsio_tx_instance TX_OUTCLOCK_DIVISION "2" 
   set_instance_parameter $the_lvdsio_tx_instance TX_EXPORT_CORECLOCK "false" 
   set_instance_parameter $the_lvdsio_tx_instance TX_REGISTER_CLOCK "inclock"
   set_instance_parameter $the_lvdsio_tx_instance PLL_CORECLOCK_RESOURCE "Auto" 
   set_instance_parameter $the_lvdsio_tx_instance PLL_USE_RESET "true" 
   set_instance_parameter $the_lvdsio_tx_instance NUM_CHANNELS $num_channels
}
...
#   set_instance_parameter $the_phyip_instance byte_order_mode "none"
   ...
   set_instance_parameter $the_phyip_instance data_rate "1250 Mbps"
   ...
   # Set the TX PLL base data rate
   set_instance_parameter $the_phyip_instance gui_base_data_rate $phyip_pll_base_data_rate
...
proc update_nf_phyip_instance_param {args} {
   ...
   # We prefer the clocks to be modeled as clocks instead of conduits for Native PHYIP
   set_instance_parameter $the_phyip_instance DESIGN_ENVIRONMENT "QSYS"
   ...
   if {$nf_phyip_rcfg_enable} {
      ...
      set_instance_parameter $the_phyip_instance rcfg_jtag_enable $xcvr_rcfg_jtag_enable
      set_instance_parameter $the_phyip_instance set_capability_reg_enable $xcvr_set_capability_reg_enable
      set_instance_parameter $the_phyip_instance set_user_identifier $xcvr_set_user_identifier
      set_instance_parameter $the_phyip_instance set_csr_soft_logic_enable $xcvr_set_csr_soft_logic_enable
      set_instance_parameter $the_phyip_instance set_prbs_soft_logic_enable $xcvr_set_prbs_soft_logic_enable
   } else {
      set_instance_parameter $the_phyip_instance rcfg_enable 0
      set_instance_parameter $the_phyip_instance rcfg_jtag_enable 0
      set_instance_parameter $the_phyip_instance set_capability_reg_enable 0
      set_instance_parameter $the_phyip_instance set_user_identifier 0
      set_instance_parameter $the_phyip_instance set_csr_soft_logic_enable 0
      set_instance_parameter $the_phyip_instance set_prbs_soft_logic_enable 0
   }

   
   set_instance_parameter $the_phyip_instance rx_ppm_detect_threshold "100"
...
# Create and connect altera_gpio_lite instances to MAC with RGMII interface
proc create_and_connect_altera_gpio_lite_instances {args} {
   set index [lindex $args 0]
   set mac_instance [lindex $args 1]

   add_instance rgmii_in4_$index altera_gpio_lite
   set_instance_parameter rgmii_in4_$index SIZE 4
   set_instance_parameter rgmii_in4_$index PIN_TYPE "input"
   set_instance_parameter rgmii_in4_$index gui_io_reg_mode "ddr"
   
   add_instance rgmii_in1_$index altera_gpio_lite
   set_instance_parameter rgmii_in1_$index SIZE 1
   set_instance_parameter rgmii_in1_$index PIN_TYPE "input"
   set_instance_parameter rgmii_in1_$index gui_io_reg_mode "ddr"
   
   add_instance rgmii_out4_$index altera_gpio_lite
   set_instance_parameter rgmii_out4_$index SIZE 4
   set_instance_parameter rgmii_out4_$index PIN_TYPE "output"
   set_instance_parameter rgmii_out4_$index gui_io_reg_mode "ddr"
   set_instance_parameter rgmii_out4_$index gui_enable_aclr_port "true"
   
   add_instance rgmii_out1_$index altera_gpio_lite
   set_instance_parameter rgmii_out1_$index SIZE 1
   set_instance_parameter rgmii_out1_$index PIN_TYPE "output"
   set_instance_parameter rgmii_out1_$index gui_io_reg_mode "ddr"
   set_instance_parameter rgmii_out1_$index gui_enable_aclr_port "true"

   add_connection rgmii_in4_$index.pad_in $mac_instance.rgmii_in4_pad
   add_connection rgmii_in4_$index.dout $mac_instance.rgmii_in4_dout
   add_connection rgmii_in4_$index.inclock $mac_instance.rgmii_in4_ck
   
   add_connection rgmii_in1_$index.pad_in $mac_instance.rgmii_in1_pad
   add_connection rgmii_in1_$index.dout $mac_instance.rgmii_in1_dout
   add_connection rgmii_in1_$index.inclock $mac_instance.rgmii_in1_ck
   
   add_connection rgmii_out4_$index.pad_out $mac_instance.rgmii_out4_pad
   add_connection rgmii_out4_$index.din $mac_instance.rgmii_out4_din
   add_connection rgmii_out4_$index.outclock $mac_instance.rgmii_out4_ck
   add_connection rgmii_out4_$index.aclr $mac_instance.rgmii_out4_aclr
   
   add_connection rgmii_out1_$index.pad_out $mac_instance.rgmii_out1_pad
   add_connection rgmii_out1_$index.din $mac_instance.rgmii_out1_din
   add_connection rgmii_out1_$index.outclock $mac_instance.rgmii_out1_ck
   add_connection rgmii_out1_$index.aclr $mac_instance.rgmii_out1_aclr
}
...
proc create_and_connect_altera_gpio_instances {args} {
   ...
   set_instance_parameter rgmii_out1_$index SIZE 1
   set_instance_parameter rgmii_out1_$index PIN_TYPE_GUI "Output"
   ...
   add_connection rgmii_in4_$index.pad_in $mac_instance.rgmii_in4_pad
   add_connection rgmii_in4_$index.dout $mac_instance.rgmii_in4_dout
   add_connection rgmii_in4_$index.ck $mac_instance.rgmii_in4_ck
   
   add_connection rgmii_in1_$index.pad_in $mac_instance.rgmii_in1_pad
   add_connection rgmii_in1_$index.dout $mac_instance.rgmii_in1_dout
   add_connection rgmii_in1_$index.ck $mac_instance.rgmii_in1_ck
   
   add_connection rgmii_out4_$index.pad_out $mac_instance.rgmii_out4_pad
   add_connection rgmii_out4_$index.din $mac_instance.rgmii_out4_din
   add_connection rgmii_out4_$index.ck $mac_instance.rgmii_out4_ck
   add_connection rgmii_out4_$index.aclr $mac_instance.rgmii_out4_aclr
   
   add_connection rgmii_out1_$index.pad_out $mac_instance.rgmii_out1_pad
   add_connection rgmii_out1_$index.din $mac_instance.rgmii_out1_din
   add_connection rgmii_out1_$index.ck $mac_instance.rgmii_out1_ck
   add_connection rgmii_out1_$index.aclr $mac_instance.rgmii_out1_aclr
}
...
add_documentation_link "User Guide" https://www.intel.com/content/www/us/en/programmable/documentation/bhc1410932355850.html
add_documentation_link "Release Notes" https://www.intel.com/content/www/us/en/programmable/documentation/hco1421697984525.html

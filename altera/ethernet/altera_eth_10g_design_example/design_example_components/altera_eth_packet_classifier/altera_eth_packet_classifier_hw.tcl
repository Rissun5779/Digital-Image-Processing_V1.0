...
set_module_property DISPLAY_NAME "Ethernet Packet Classifier Intel FPGA IP"
...
proc elaborate {} {
	...
	} elseif {$SYMBOLSPERBEAT == 4} {
		add_interface_port data_sink data_sink_empty empty Input 2
		add_interface_port data_src data_src_empty empty Output 2
	
		set empty_width [ expr int(ceil(log($SYMBOLSPERBEAT) / log(2))) ]
		set_port_property data_sink_empty WIDTH $empty_width
		set_port_property data_src_empty WIDTH $empty_width	
	} elseif {$SYMBOLSPERBEAT == 1} {
		add_interface_port data_sink data_sink_empty empty Input 1
	
	    set_port_property data_sink_empty DRIVEN_BY 0
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/nfa1453869442912/nfa1453883305293

...
set_module_property GROUP "Interface Protocols/Ethernet/Reference Designs/Reference Design Components"
...
proc validate {} {
    ...
    # Hide unidirectional feature
    set_parameter_property ENABLE_UNIDIRECTIONAL VISIBLE false

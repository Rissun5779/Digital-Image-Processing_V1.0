...
module tb_top;
	...
	tse_1588_top dut(
			...
			.mac_tx_clock_connection_0_clk(tx_clk),                                                //                              tx_clock_connection_0.clk
			.mac_rx_clock_connection_0_clk(rx_clk),                                                //                              rx_clock_connection_0.clk

			.serial_connection_0_txp(serial_tx_data),                                               //                                                   .txp_0
			.serial_connection_0_rxp(serial_rx_data),                                               //                                                   .rxp_0

			.mac_misc_connection_0_magic_sleep_n(1'b1),                                       //                                                       .magic_sleep_n
			.mac_misc_connection_0_tx_crc_fwd(1'b0),                                          //                                                       .tx_crc_fwd
			...
			.rx_ingress_timestamp_96b_0_valid(rx_ingress_timestamp_96b_valid),                 // triple_speed_ethernet_0_rx_ingress_timestamp_96b_0.valid
			.rx_ingress_timestamp_96b_0_data(rx_ingress_timestamp_96b_data),                  //                                                   .data
			.rx_ingress_timestamp_64b_0_valid(rx_ingress_timestamp_64b_valid),                 // triple_speed_ethernet_0_rx_ingress_timestamp_64b_0.valid
			.rx_ingress_timestamp_64b_0_data(rx_ingress_timestamp_64b_data),                  //                                                   .data
			
			.tx_egress_timestamp_96b_0_valid(tx_egress_timestamp_96b_valid),                  //  triple_speed_ethernet_0_tx_egress_timestamp_96b_0.valid
			.tx_egress_timestamp_96b_0_data(tx_egress_timestamp_96b_data),                   //                                                   .data
			.tx_egress_timestamp_96b_0_fingerprint(tx_egress_timestamp_96b_fingerprint),            //                                                   .fingerprint
			.tx_egress_timestamp_64b_0_valid(tx_egress_timestamp_64b_valid),                  //  triple_speed_ethernet_0_tx_egress_timestamp_64b_0.valid
			.tx_egress_timestamp_64b_0_data(tx_egress_timestamp_64b_data),                   //                                                   .data
			.tx_egress_timestamp_64b_0_fingerprint(tx_egress_timestamp_64b_fingerprint),             //                                                   .fingerprint

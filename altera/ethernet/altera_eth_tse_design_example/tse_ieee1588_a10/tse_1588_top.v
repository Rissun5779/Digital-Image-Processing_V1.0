...
module tse_1588_top(
	...
	tse_1588 xtse_1588(
			...
			.receive_fifo_status_clock_connection_clk(ref_clk),                                  //                   receive_fifo_status_clock_connection.clk
			.clk_50_clk(clk_50_clk),                                                                //                                                 clk_50.clk
			.reset_50_reset_n(reset_50_reset_n),                                                          //                                               reset_50.reset_n
			.pcs_ref_clk_clock_connection_clk(ref_clk),                                          //                           pcs_ref_clk_clock_connection.clk
			.status_led_connection_0_crs(status_led_connection_0_crs),                                               //                                status_led_connection_0.crs
			.status_led_connection_0_link(status_led_connection_0_link),                                              //                                                       .link
			.status_led_connection_0_col(status_led_connection_0_col),                                               //                                                       .col
			.status_led_connection_0_an(status_led_connection_0_an),                                                //                                                       .an
			.status_led_connection_0_char_err(status_led_connection_0_char_err),                                          //                                                       .char_err
			.status_led_connection_0_disp_err(status_led_connection_0_disp_err),                                          //                                                       .disp_err
			.serial_connection_0_rxp(serial_connection_0_rxp),                                                   //                                    serial_connection_0.rxp
			.serial_connection_0_txp(serial_connection_0_txp),                                                   //                                                       .txp
			.serdes_control_connection_0_export(serdes_control_connection_0_rx_recovclkout),                                        //                            serdes_control_connection_0.export
			.mac_misc_connection_0_xon_gen(mac_misc_connection_0_xon_gen),                                             //                                  mac_misc_connection_0.xon_gen
			.mac_misc_connection_0_xoff_gen(mac_misc_connection_0_xoff_gen),                                            //                                                       .xoff_gen
			.mac_misc_connection_0_tx_crc_fwd(mac_misc_connection_0_tx_crc_fwd),                                          //                                                       .tx_crc_fwd
			.receive_fifo_status_data(receive_fifo_status_data),                                                  //                                    receive_fifo_status.data
			.receive_fifo_status_valid(receive_fifo_status_valid),                                                 //                                                       .valid
			.receive_fifo_status_channel(receive_fifo_status_channel),                                               //                                                       .channel
			.rx_ingress_timestamp_96b_0_valid(rx_ingress_timestamp_96b_0_valid),                                          //                             rx_ingress_timestamp_96b_0.valid
			.rx_ingress_timestamp_96b_0_data(rx_ingress_timestamp_96b_0_data),                                           //                                                       .data
			.rx_ingress_timestamp_64b_0_valid(rx_ingress_timestamp_64b_0_valid),                                          //                             rx_ingress_timestamp_64b_0.valid
			.rx_ingress_timestamp_64b_0_data(rx_ingress_timestamp_64b_0_data),                                           //                                                       .data
			.tx_egress_timestamp_96b_0_valid(tx_egress_timestamp_96b_0_valid),                                           //                              tx_egress_timestamp_96b_0.valid
			...
			.tx_egress_timestamp_64b_0_valid(tx_egress_timestamp_64b_0_valid),                                           //                              tx_egress_timestamp_64b_0.valid
			...
			.mac_rx_clock_connection_0_clk(mac_rx_clock_connection_0_clk),                                             //                              mac_rx_clock_connection_0.clk
			.mac_tx_clock_connection_0_clk(mac_tx_clock_connection_0_clk),                                             //                              mac_tx_clock_connection_0.clk
			.tod_period_clock_clk(tod_period_clock_clk),                                                      //                                       tod_period_clock.clk
			.tod_period_clock_reset_reset_n(reset_n),                                            //                                 tod_period_clock_reset.reset_n
			...
			.tod_time_of_day_64b_load_valid(tod_time_of_day_64b_load_valid),                                            //                                                       .valid
			.tod_time_of_day_96b_data(tod_time_of_day_96b_data),                                                  //                                    tod_time_of_day_96b.data
			.tod_time_of_day_64b_data(tod_time_of_day_64b_data),                                                  //                                    tod_time_of_day_64b.data
			.rx_time_of_day_96b_0_data(tod_time_of_day_96b_data),                                                 //                                   rx_time_of_day_96b_0.data
			.rx_time_of_day_64b_0_data(tod_time_of_day_64b_data),                                                 //                                   rx_time_of_day_64b_0.data
			.tx_time_of_day_96b_0_data(tod_time_of_day_96b_data),                                                 //                                   tx_time_of_day_96b_0.data
			.tx_time_of_day_64b_0_data(tod_time_of_day_64b_data),                                                  //                                   tx_time_of_day_64b_0.data

			//packet classifier signals
			.eth_packet_classifier_0_clock_reset_clk(ref_clk),                                   //                    eth_packet_classifier_0_clock_reset.clk
			.eth_packet_classifier_0_clock_reset_reset_reset(~reset_n),                           //              eth_packet_classifier_0_clock_reset_reset.reset
			.eth_packet_classifier_0_data_sink_startofpacket(transmit_0_startofpacket),                           //                      eth_packet_classifier_0_data_sink.startofpacket
			.eth_packet_classifier_0_data_sink_endofpacket(transmit_0_endofpacket),                             //                                                       .endofpacket
			.eth_packet_classifier_0_data_sink_valid(transmit_0_valid),                                   //                                                       .valid
			.eth_packet_classifier_0_data_sink_ready(transmit_0_ready),                                   //                                                       .ready
			.eth_packet_classifier_0_data_sink_data(transmit_0_data),                                    //                                                       .data
			.eth_packet_classifier_0_data_sink_error(transmit_0_error),                                   //                                                       .error
			.eth_packet_classifier_0_clock_operation_mode_mode(eth_packet_classifier_0_clock_operation_mode_mode),                         //           eth_packet_classifier_0_clock_operation_mode.mode
			.eth_packet_classifier_0_pkt_with_crc_mode(eth_packet_classifier_0_pkt_with_crc_mode),                                 //                   eth_packet_classifier_0_pkt_with_crc.mode
			.eth_packet_classifier_0_tx_egress_timestamp_request_in_valid(eth_packet_classifier_0_tx_egress_timestamp_request_in_valid),              // eth_packet_classifier_0_tx_egress_timestamp_request_in.valid
			.eth_packet_classifier_0_tx_egress_timestamp_request_in_fingerprint(eth_packet_classifier_0_tx_egress_timestamp_request_in_fingerprint),        //                                                       .fingerprint
			.eth_packet_classifier_0_tx_etstamp_ins_ctrl_in_residence_time_update(eth_packet_classifier_0_tx_etstamp_ins_ctrl_in_residence_time_update),      //         eth_packet_classifier_0_tx_etstamp_ins_ctrl_in.residence_time_update
			.eth_packet_classifier_0_tx_etstamp_ins_ctrl_in_ingress_timestamp_96b(eth_packet_classifier_0_tx_etstamp_ins_ctrl_in_ingress_timestamp_96b),      //                                                       .ingress_timestamp_96b
			.eth_packet_classifier_0_tx_etstamp_ins_ctrl_in_ingress_timestamp_64b(eth_packet_classifier_0_tx_etstamp_ins_ctrl_in_ingress_timestamp_64b),      //                                                       .ingress_timestamp_64b
			.eth_packet_classifier_0_tx_etstamp_ins_ctrl_in_residence_time_calc_format(eth_packet_classifier_0_tx_etstamp_ins_ctrl_in_residence_time_calc_format), //                                                       .residence_time_calc_format

			//port for reset control and atx pll
			.reset_control_0_clock_clk(ref_clk),                                                 //                                  reset_control_0_clock.clk
			.rx_set_locktodata_0_rx_set_locktodata(1'b0),                                     //                                    rx_set_locktodata_0.rx_set_locktodata
			.rx_set_locktoref_0_rx_set_locktoref(1'b0),                                       //                                     rx_set_locktoref_0.rx_set_locktoref
			//.rx_is_lockedtoref_0_rx_is_lockedtoref(),                                     //                                    rx_is_lockedtoref_0.rx_is_lockedtoref
			//.tx_ready_tx_ready(),                                                         //                                               tx_ready.tx_ready
			.pll_select_pll_select(1'b0),                                                     //                                             pll_select.pll_select
			//.rx_ready_rx_ready(),                                                         //                                               rx_ready.rx_ready
			.pll_refclk0_clk(ref_clk),                                                           //                                            pll_refclk0.clk
			.tx_serial_clk_clk(tx_serial_clk),                                                         //                                          tx_serial_clk.clk
			.tx_serial_clk_0_clk(tx_serial_clk),                                                       //                                        tx_serial_clk_0.clk
			.rx_cdr_refclk_0_clk(ref_clk),                                                       //                                        rx_cdr_refclk_0.clk
			.reset_control_0_reset_reset(~reset_n)                                               //                                  reset_control_0_reset.reset

...
module mr_rx_compare_sv #(
    ...
    output wire [7:0]  eye_mon
);

localparam [23:0]
    RX_THRESHOLD_0  =  290000,
    RX_THRESHOLD_1  =  310000,
    RX_THRESHOLD_2  =  510000,
    RX_THRESHOLD_3  =  610000,
    RX_THRESHOLD_4  = 1050000,
    RX_THRESHOLD_5  = 1450000, 
    RX_THRESHOLD_6  = 1550000,
    RX_THRESHOLD_7  = 2550000,
    RX_THRESHOLD_8  = 3150000,
    RX_THRESHOLD_9  = 4050000,
    RX_THRESHOLD_10 = 6050000; 
	 
localparam [3:0]
    RX_PIX_RATE_LESS_THAN_29MHZ_OR_145MHZ = 0,
    RX_PIX_RATE_LESS_THAN_31MHZ_OR_155MHZ = 1,
    RX_PIX_RATE_LESS_THAN_51MHZ_OR_255MHZ = 2,
    RX_PIX_RATE_LESS_THAN_61MHZ_OR_315MHZ = 3,
    RX_PIX_RATE_LESS_THAN_105MHZ          = 4,
    RX_PIX_RATE_LESS_THAN_405MHZ          = 5,
...
begin
    case (loops)
        0: begin // <29MHz
            ...
            range_r1 = RX_PIX_RATE_LESS_THAN_29MHZ_OR_145MHZ; // 0
            os_r1 = 1'b1;
            m_sel_r1 = 2'b00;
            m_r1 = 4'b0011;
            lpfd_r1 = 2'b11;
            lpd_r1 = 2'b11;
            pfd_bwctrl_r1 = 2'b01;
            eye_mon_r1 = 8'b0101_0010;
        end
       
        1: begin // <31MHz
            threshold = RX_THRESHOLD_1; 
            range_r1 = RX_PIX_RATE_LESS_THAN_31MHZ_OR_155MHZ; // 1
            os_r1 = 1'b1;
            m_sel_r1 = 2'b00;
            m_r1 = 4'b0101;
            lpfd_r1 = 2'b10;
        ...
        2: begin // <51MHz
            ...
            range_r1 = RX_PIX_RATE_LESS_THAN_51MHZ_OR_255MHZ; // 2
            os_r1 = 1'b1;
            m_sel_r1 = 2'b00;
            m_r1 = 4'b0101;
            lpfd_r1 = 2'b01;
        ...
        3: begin // <61MHz
            ...
            range_r1 = RX_PIX_RATE_LESS_THAN_61MHZ_OR_315MHZ; // 3
            os_r1 = 1'b1;
            m_sel_r1 = 2'b00;
            m_r1 = 4'b0101;
            lpfd_r1 = 2'b01;
            lpd_r1 = 2'b10;
            pfd_bwctrl_r1 = 2'b01;
            eye_mon_r1 = 8'b1001_0010;
        end
      
        4: begin // <105MHz
            threshold = RX_THRESHOLD_4; 
            range_r1 = RX_PIX_RATE_LESS_THAN_105MHZ; // 4
            os_r1 = 1'b0;
            m_sel_r1 = 2'b00;
            m_r1 = 4'b0011;
            lpfd_r1 = 2'b11;
        ...
        9: begin // <405MHz
            ...
            range_r1 = RX_PIX_RATE_LESS_THAN_405MHZ; // 5
            os_r1 = 1'b0;
            m_sel_r1 = 2'b00;
            m_r1 = 4'b0101;
            lpfd_r1 = 2'b00;

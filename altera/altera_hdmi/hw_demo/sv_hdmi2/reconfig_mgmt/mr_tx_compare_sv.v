...
module mr_tx_compare_sv #(
    parameter [3:0] TX_DEFAULT_RANGE = 0
) (
    input  wire        clock,
    input  wire        reset,
...
localparam [23:0]
    TX_THRESHOLD_0 =  610000,
    TX_THRESHOLD_1 = 1050000,
    TX_THRESHOLD_2 = 3050000,
    TX_THRESHOLD_3 = 3750000;

localparam [3:0]
    TX_PIX_RATE_LESS_THAN_61MHZ_OR_305MHZ = 0,
    TX_PIX_RATE_LESS_THAN_105MHZ          = 1,
    TX_PIX_RATE_LESS_THAN_375MHZ          = 2;
...
begin
    case (loops)
        0: begin // <61MHz
            ...
            range_r1 = TX_PIX_RATE_LESS_THAN_61MHZ_OR_305MHZ; // 0
            slew_r1 = 3'b010; 
        end

        1: begin // <105MHz
            threshold = TX_THRESHOLD_1; 
            range_r1 = TX_PIX_RATE_LESS_THAN_105MHZ; // 1
            slew_r1 = 3'b001; 
        end
        ...
        3: begin // <375MHz
            ...
            range_r1 = TX_PIX_RATE_LESS_THAN_375MHZ; // 2
            slew_r1 = 3'b011;
        end

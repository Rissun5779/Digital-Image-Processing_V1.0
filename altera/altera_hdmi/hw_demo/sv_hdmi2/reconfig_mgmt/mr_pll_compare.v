...
module mr_pll_compare #(
    parameter [3:0] PLL_DEFAULT_RANGE = 2
) (
    input  wire        clock,
    input  wire        reset,
...
localparam [3:0]
    ...
    PLL_PIX_RATE_LESS_THAN_600MHZ = 4;
...
begin
    case (loops)
        ...
        1: begin // <60MHz
            ...
            range_r1     = PLL_PIX_RATE_LESS_THAN_60MHZ; // 1
            m_r1[17:16]  = 2'b00;
        ...
        2: begin // <160MHz
            ...
            range_r1     = PLL_PIX_RATE_LESS_THAN_160MHZ; // 2
            m_r1[17:16]  = 2'b00;
        ...
        3: begin // <340MHz
            ...
            range_r1     = PLL_PIX_RATE_LESS_THAN_340MHZ; // 3
            m_r1[17:16]  = 2'b00;
        ...
        4: begin // <600MHz
            ...
            range_r1     = PLL_PIX_RATE_LESS_THAN_600MHZ; // 4
            m_r1[17:16]  = 2'b00;
            m_r1[15:8]   = 8'b00000100; // 4
            m_r1[7:0]    = 8'b00000100; // 4
            n_r1[17:16]  = 2'b01;       //bypassed
            n_r1[15:8]   = 8'b00000000; // 0
            n_r1[7:0]    = 8'b00000000; // 0
            c0_r1[22:18] = 5'b00000;    // C0
            c0_r1[17:16] = 2'b00;
            ...
            c1_r1[22:18] = 5'b00001;    // C1
            c1_r1[17:16] = 2'b00;
            c1_r1[15:8]  = 8'b00000010; // 2
            c1_r1[7:0]   = 8'b00000010; // 2
            c2_r1[22:18] = 5'b00010;    // C2
            c2_r1[17:16] = 2'b00;
            c2_r1[15:8]  = bpc == 4'b0100 ? 8'b00000010 : // 2
                           bpc == 4'b0101 ? 8'b00000010 : // 2
                           bpc == 4'b0110 ? 8'b00000011 : // 3
                           bpc == 4'b0111 ? 8'b00000100 : // 4
   			                    8'b00000010;  // 2
            c2_r1[7:0 ]  = bpc == 4'b0100 ? 8'b00000010 : // 2
                           bpc == 4'b0101 ? 8'b00000011 : // 3
                           bpc == 4'b0110 ? 8'b00000011 : // 3
                           bpc == 4'b0111 ? 8'b00000100 : // 4
                                   	    8'b00000010;  // 2
            cp_r1[1:0]   = 2'b10;
...
begin
    if (reset) begin
        ...
        c1_r2 <= 23'b00001_00_00000010_00000010;
        c2_r2 <= 23'b00010_00_00000010_00000010;
        cp_r2 <= 2'b10;
        bw_r2 <= 7'b0001000;        
    end else begin

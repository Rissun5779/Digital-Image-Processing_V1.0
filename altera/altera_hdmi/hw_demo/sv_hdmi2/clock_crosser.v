...
generate
  ...
  begin
    ...
    (* altera_attribute = "-name SYNCHRONIZER_IDENTIFICATION FORCED_IF_ASYNCHRONOUS; -name DONT_MERGE_REGISTER ON; -name PRESERVE_REGISTER ON; -name SDC_STATEMENT \"set_false_path -to [get_keepers {*clock_crosser:*|data_out_sync0}]\" " *) reg data_out_sync0 /* synopsys translate_off */ = 0 /* synopsys translate_on */;
    (* altera_attribute = "-name SYNCHRONIZER_IDENTIFICATION FORCED_IF_ASYNCHRONOUS; -name DONT_MERGE_REGISTER ON; -name PRESERVE_REGISTER ON" *) reg data_out_sync1 /* synopsys translate_off */ = 0 /* synopsys translate_on */;
  ...
  begin
    ...
    (* altera_attribute = {"-name SYNCHRONIZER_IDENTIFICATION FORCED_IF_ASYNCHRONOUS; -name DONT_MERGE_REGISTER ON; -name PRESERVE_REGISTER ON; -name SDC_STATEMENT \"set_false_path -from [get_keepers {*clock_crosser:*|in_ready}] -to [all_registers]\" "} *) reg in_ready /* synopsys translate_off */ = 0 /* synopsys translate_on */;
    (* altera_attribute = {"-name SYNCHRONIZER_IDENTIFICATION FORCED_IF_ASYNCHRONOUS; -name DONT_MERGE_REGISTER ON; -name PRESERVE_REGISTER ON; -name SDC_STATEMENT \"set_false_path -from [get_keepers {*clock_crosser:*|in_ack}] -to [all_registers]\" "} *) reg in_ack /* synopsys translate_off */ = 0 /* synopsys translate_on */;

...
reset_controller u_rx_clk0_rst_sync (.reset_in0_reset(reset),.reset_in1_reset(1'b0),.reset_in2_reset(1'b0),.clk_clk(rx_clk[0]),.reset_out_reset(reset_rxclk[0]));
reset_controller u_rx_clk1_rst_sync (.reset_in0_reset(reset),.reset_in1_reset(1'b0),.reset_in2_reset(1'b0),.clk_clk(rx_clk[1]),.reset_out_reset(reset_rxclk[1]));
reset_controller u_rx_clk2_rst_sync (.reset_in0_reset(reset),.reset_in1_reset(1'b0),.reset_in2_reset(1'b0),.clk_clk(rx_clk[2]),.reset_out_reset(reset_rxclk[2]));

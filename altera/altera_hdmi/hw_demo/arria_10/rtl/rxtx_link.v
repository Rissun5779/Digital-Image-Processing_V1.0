...
reset_controller u_hdmi_tx_ls_clk_reset_sync (
		/* I */ .clk_clk          (hdmi_tx_ls_clk),
		/* I */ .reset_in0_reset  (reset), 
		/* I */ .reset_in1_reset  (1'b0),
    /* I */ .reset_in2_reset  (1'b0),
		/* O */ .reset_out_reset  (hdmi_tx_ls_clk_reset_sync) 
	);

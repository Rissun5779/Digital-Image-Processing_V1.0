...
int TXCHN_COMPARE (int PIX_RATE)
{
    ...
    if      (PIX_RATE <  590000) txchn_range = 0;
    else if (PIX_RATE <  610000) txchn_range = 1;
    else if (PIX_RATE < 1000000) txchn_range = 2;
    else if (PIX_RATE < 2950000) txchn_range = 3;
    else if (PIX_RATE < 3750000) txchn_range = 4;
...
int TXPLL_COMPARE (int PIX_RATE)
{
    ...
    else if (PIX_RATE <  900000) txpll_range = 2;
    else if (PIX_RATE < 1900000) txpll_range = 3;
    else if (PIX_RATE < 3750000) txpll_range = 4;
...
void GPLL_RECONFIG(int GPLL_RANGE, int BPC)
{
	...
	switch (GPLL_RANGE)
	{
		...
		case 1: // <60MHz
			...
			else if (BPC == 1) GPLL_RCFG_WRITE(0x5, 0x081919);  // pll_c2 50 (10pc)
		...
		case 3: // <340MHz
			...
			else if (BPC == 1) GPLL_RCFG_WRITE(0x5, 0x080505);  // pll_c2 10 (10pc)

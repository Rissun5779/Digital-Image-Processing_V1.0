...
# video pipeline clock is async to all other clocks
set_clock_groups -exclusive \
     -group [get_clocks {u_pll_sys|pll_sys_50_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}]
	  
# cpu clk is async to all other clocks
set_clock_groups -exclusive \
     -group [get_clocks {u_pll_sys|pll_sys_50_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]

# i2c clk is async to all other clocks
set_clock_groups -exclusive \
     -group [get_clocks {u_pll_sys|pll_sys_50_inst|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}]

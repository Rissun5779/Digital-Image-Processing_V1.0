...
# Compile the project
quartus_map av_sk_demo
quartus_sta -t ./qsys_vip_passthrough/synthesis/submodules/qsys_vip_passthrough_ddr3_p0_pin_assignments.tcl av_sk_demo
quartus_fit av_sk_demo
quartus_sta av_sk_demo
quartus_asm av_sk_demo

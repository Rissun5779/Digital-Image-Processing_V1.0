...
localparam SYMBOLS_PER_CLOCK = 4;
...
//
// Generate 75MHz for system (CPU/reconfig/I2C master) controllers
// Generate 50MHz for I2C slave
// 
pll_sys u_pll_sys (
   /* I */ .refclk (clk100),
   /* I */ .rst (reset),
...
gxb_rx_reconfig u_gxb_reconfig (
...
defparam
   ...
   u_vid_bypass_fifo.lpm_width = 204,

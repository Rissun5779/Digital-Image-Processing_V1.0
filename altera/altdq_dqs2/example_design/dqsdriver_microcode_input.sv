...
localparam CALIB_VALUE = (HALF_RATE_CIRCUITRY == "true")? 4'h5 : 4'h7;
...
reg [15:0] microcode [0 : _MICROCODE_DEPTH - 1] = '{
	...
	`_NOP,
	{ 4'h5 , {5{`_ZERO}} , `_W_SIDE , `_W_RAND , `_WRITE }, 
	`_NOP,
	`_NOP,
	{ 4'h2 , {5{`_ZERO}} , `_R_SIDE , `_R_CMP_DO , `_ZERO , `_READ }, 
	`_NOP,
	{ 4'h4 , {5{`_ZERO}} , `_W_SIDE , `_W_RAND , `_WRITE }, 
	`_NOP,
	`_NOP,
	{ 4'h7 , {5{`_ZERO}} , `_R_DQS , `_R_CMP_DO , `_ZERO , `_READ }, 
	`_NOP,
	`_NOP,
	`_NOP,
	`_NOP,

...
static const char * get_devices_supported(void) { 
	return "STRATIX,STRATIXGX,STRATIXII,STRATIXIIGX,STRATIXIIGXLITE,STRATIXIII,STRATIXIV,STRATIXV,CYCLONEII,CYCLONEIII,HARDCOPYII,TARPON,ARRIAII,ARRIAIIGZ,ARRIAV,ARRIAVGZ,HARDCOPYIII,HARDCOPYIV,STINGRAY,CYCLONEIVE,CYCLONEV,MAX10FPGA";
}

static const char * get_version(void){
#ifdef BETA_IP
	return "13.1;13.1-BETA;13.1-BETA Build 625";
#else
	return "13.1;13.1;13.1 Build 625";
#endif
}

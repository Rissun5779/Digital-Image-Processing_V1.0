...
set_module_property DESCRIPTION "RLDRAMII RTL Sequencer"
set_module_property NAME altera_mem_if_rldramii_rseq
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_sequencers_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "RLDRAMII RTL Sequencer"
...
proc generate_verilog_fileset {name tmpdir fileset {include_sim_vhdl_files 0}} {
	...
	set new_inhdl_dir "${qdir}/../ip/altera/alt_mem_if/altera_mem_if_rseq/altera_mem_if_rldramii_rseq"
	...
	set toplevel_inhdl_files_list [list altera_mem_if_rldramii_rseq_top.sv]
...
proc ip_elaborate {} {
	...
	::alt_mem_if::gen::uniphy_interfaces::phy_manager "RLDRAMII" "sequencer" 0 "disable_fr_shift_calibration"

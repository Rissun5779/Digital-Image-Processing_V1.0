...
localparam INIT_COUNT_WIDTH		= 15; // QDRII spec requires 20us cycles of power up wait time, the memory is in operation mode after that
...
output	  [AFI_CONTROL_WIDTH-1:0]  afi_doff_n;
...
sequencer #(
	...
	.seq_mux_wps_n(afi_wps_n),
	.seq_mux_rps_n(afi_rps_n),
	.seq_mux_doff_n(afi_doff_n),
	.seq_mux_wdata(afi_wdata),
	.seq_mux_wdata_valid(afi_wdata_valid),
	.seq_mux_dm(afi_bws_n),

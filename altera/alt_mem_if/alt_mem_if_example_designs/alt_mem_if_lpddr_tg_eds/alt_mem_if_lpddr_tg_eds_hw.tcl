...
set_module_property DESCRIPTION "Altera LPDDR SDRAM External Memory Interface Example Design Simulation"
set_module_property NAME alt_mem_if_lpddr_tg_eds
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::example_designs_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera LPDDR SDRAM External Memory Interface Example Design Simulation"
...
proc ip_compose {} {
	...
	set ED e0
	add_instance $ED alt_mem_if_lpddr_tg_ed
	...
	for {set i 0} {$i < $num_emif} {incr i} {
		set MEM_MODEL "m${i}"
		add_instance $MEM_MODEL altera_mem_if_lpddr_mem_model
		...
		if {[string compare -nocase [get_parameter_value INCLUDE_BOARD_DELAY_MODEL] "true"] == 0} {
			...
			add_instance $BOARD_DELAY_MODEL altera_lpddr_board_delay_model

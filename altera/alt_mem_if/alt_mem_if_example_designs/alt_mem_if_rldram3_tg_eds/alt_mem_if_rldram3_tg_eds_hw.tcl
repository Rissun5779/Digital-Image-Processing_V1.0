...
set_module_property DESCRIPTION "Altera RLDRAM 3 External Memory Interface Example Design Simulation"
set_module_property NAME alt_mem_if_rldram3_tg_eds
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::example_designs_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera RLDRAM 3 External Memory Interface Example Design Simulation"
...
proc ip_compose {} {
	...
	set ED e0
	add_instance $ED alt_mem_if_rldram3_tg_ed
	...
	for {set i 0} {$i < $num_emif} {incr i} {
		if {[string compare -nocase [get_parameter_value INCLUDE_BOARD_DELAY_MODEL] "true"] == 0} {
			...
			add_instance $BOARD_DELAY_MODEL_BRIDGE altera_rldram3_board_delay_model_bridge
			...
			for {set rank_i 0} {$rank_i < $num_rank} {incr rank_i} {
				...
				add_instance $MEM_MODEL altera_mem_if_rldram3_mem_model
				
				set BOARD_DELAY_MODEL "dly${i}_r${rank_i}"
				add_instance $BOARD_DELAY_MODEL altera_rldram3_board_delay_model
	...
	set count 0
	foreach ii $interface_suffixes {
		::alt_mem_if::gen::uniphy_interfaces::export_rldramx_controller_sideband_interfaces "RLDRAM3" "${ED}" "$ii" "$ii" [expr {$count==0}]
		incr count
	}

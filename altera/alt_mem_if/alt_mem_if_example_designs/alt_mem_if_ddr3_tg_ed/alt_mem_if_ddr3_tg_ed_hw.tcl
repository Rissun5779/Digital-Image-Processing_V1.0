...
proc ip_compose {} {
	...
	if {[string compare -nocase [get_parameter_value PHY_ONLY] "true"] == 0} {
		...
		if {[string compare -nocase [get_parameter_value PINGPONGPHY_EN] "true"] == 0} {
			...
			::alt_mem_if::gen::uniphy_interfaces::export_ddrx_controller_sideband_interfaces "${CONTROLLER0_EMIF0}" {} "_${CONTROLLER0_EMIF0}"
         ::alt_mem_if::gen::uniphy_interfaces::export_ddrx_controller_sideband_interfaces "${CONTROLLER1_EMIF0}" {} "_${CONTROLLER1_EMIF0}"
		...
		if {$num_emif == 2} {
			...
			if {[string compare -nocase [get_parameter_value PINGPONGPHY_EN] "true"] == 0} {
			    ...
			    ::alt_mem_if::gen::uniphy_interfaces::export_ddrx_controller_sideband_interfaces "${CONTROLLER0_EMIF1}" {} "_${CONTROLLER0_EMIF1}"
			    ::alt_mem_if::gen::uniphy_interfaces::export_ddrx_controller_sideband_interfaces "${CONTROLLER1_EMIF1}" {} "_${CONTROLLER1_EMIF1}"

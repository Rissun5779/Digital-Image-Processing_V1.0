...
set_module_property DESCRIPTION "RW Manager QDRII (11.0)"
set_module_property NAME sequencer_rw_mgr_qdrii_110
...
set_module_property DISPLAY_NAME "UniPHY QDRII Read/Write Manager (11.0 Version)"
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property ANALYZE_HDL TRUE

add_fileset sim_vhdl SIM_VHDL generate_vhdl_sim
set_fileset_property sim_vhdl TOP_LEVEL rw_manager_qdrii

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL rw_manager_qdrii

add_fileset quartus_synth QUARTUS_SYNTH generate_synth
set_fileset_property quartus_synth TOP_LEVEL rw_manager_qdrii
...
add_parameter VIRTUAL_MEM_READ_DQS_WIDTH INTEGER 1
set_parameter_property VIRTUAL_MEM_READ_DQS_WIDTH DISPLAY_NAME VIRTUAL_MEM_READ_DQS_WIDTH
set_parameter_property VIRTUAL_MEM_READ_DQS_WIDTH AFFECTS_ELABORATION true
set_parameter_property VIRTUAL_MEM_READ_DQS_WIDTH HDL_PARAMETER true
set_parameter_property VIRTUAL_MEM_READ_DQS_WIDTH ALLOWED_RANGES {1:1024}
...
add_parameter VIRTUAL_MEM_WRITE_DQS_WIDTH INTEGER 1
set_parameter_property VIRTUAL_MEM_WRITE_DQS_WIDTH DISPLAY_NAME MEM_WRITE_DQS_WIDTH
set_parameter_property VIRTUAL_MEM_WRITE_DQS_WIDTH AFFECTS_ELABORATION true
set_parameter_property VIRTUAL_MEM_WRITE_DQS_WIDTH HDL_PARAMETER true
set_parameter_property VIRTUAL_MEM_WRITE_DQS_WIDTH ALLOWED_RANGES {1:1024}
...
proc ip_elaborate {} {
	...
	add_interface_port afi afi_wps_n afi_wps_n Output [expr {[get_parameter_value MEM_CHIP_SELECT_WIDTH] * [get_parameter_value AFI_RATIO]} ]
	add_interface_port afi afi_rps_n afi_rps_n Output [expr {[get_parameter_value MEM_CHIP_SELECT_WIDTH] * [get_parameter_value AFI_RATIO]} ]
	add_interface_port afi afi_doff_n afi_doff_n Output [expr {[get_parameter_value MEM_CONTROL_WIDTH] * [get_parameter_value AFI_RATIO]} ]
	...
	add_interface_port afi afi_bws_n afi_bws_n Output [expr {[get_parameter_value MEM_DM_WIDTH] * 2 * [get_parameter_value AFI_RATIO]} ]

...
set_module_property DESCRIPTION "RW Manager LPDDR2 (11.0)"
set_module_property NAME sequencer_rw_mgr_lpddr2_110
...
set_module_property DISPLAY_NAME "UniPHY LPDDR2 Read/Write Manager (11.0 Version)"
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property ANALYZE_HDL TRUE

add_fileset sim_vhdl SIM_VHDL generate_vhdl_sim
set_fileset_property sim_vhdl TOP_LEVEL rw_manager_lpddr2

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL rw_manager_lpddr2

add_fileset quartus_synth QUARTUS_SYNTH generate_synth
set_fileset_property quartus_synth TOP_LEVEL rw_manager_lpddr2
...
proc ip_elaborate {} {
	...
	add_interface_port afi afi_addr afi_addr Output [expr {[get_parameter_value MEM_ADDRESS_WIDTH] * 2 * [get_parameter_value AFI_RATIO]} ]

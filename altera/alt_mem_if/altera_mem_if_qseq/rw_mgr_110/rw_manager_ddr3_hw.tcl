...
proc generate_verilog_fileset {} {
	...
	} elseif {[string compare -nocase [get_parameter_value DEVICE_FAMILY] MAX10] == 0} {
	} else {
...
set_parameter_property AVL_CLK_PS HDL_PARAMETER true

add_parameter AFI_CLK_PS INTEGER  1000
set_parameter_property AFI_CLK_PS HDL_PARAMETER true

add_parameter ENABLE_NON_DES_CAL boolean true
set_parameter_property ENABLE_NON_DES_CAL HDL_PARAMETER true

add_parameter TREFI integer 35100
set_parameter_property TREFI HDL_PARAMETER true

add_parameter REFRESH_INTERVAL integer 28000
set_parameter_property REFRESH_INTERVAL HDL_PARAMETER true

...
add_parameter AP_MODE_EN STD_LOGIC_VECTOR 0
set_parameter_property AP_MODE_EN WIDTH 2



add_parameter MAX10_RTL_SEQ boolean false
set_parameter_property MAX10_RTL_SEQ DISPLAY_NAME MAX10_RTL_SEQ




add_parameter AVL_CLK_PS INTEGER 1000
add_parameter AFI_CLK_PS INTEGER 1000

add_parameter AC_ROM_USER_ADD_0 string "0_0000_0000_0000"
set_parameter_property AC_ROM_USER_ADD_0 VISIBLE false

add_parameter AC_ROM_USER_ADD_1 string "0_0000_0000_1000"
set_parameter_property AC_ROM_USER_ADD_1 VISIBLE false

add_parameter ENABLE_NON_DES_CAL boolean true
set_parameter_property ENABLE_NON_DES_CAL VISIBLE false

add_parameter ENABLE_NON_DES_CAL_TEST boolean false
set_parameter_property ENABLE_NON_DES_CAL_TEST VISIBLE false

add_parameter TREFI integer 35100
set_parameter_property TREFI VISIBLE false

add_parameter REFRESH_INTERVAL integer 28000
set_parameter_property REFRESH_INTERVAL VISIBLE false

add_parameter TRFC integer 350
set_parameter_property TRFC VISIBLE false
...
proc do_compose {} {
	...
	if {[string compare -nocase [get_parameter_value HHP_HPS] "TRUE"] == 0} {
	    ...
	    if {[string compare -nocase [get_parameter_value MAX10_RTL_SEQ] "true"] == 0} {
	        add_instance cpu_inst sequencer_m10
	        
	        add_interface phase_detector conduit end
	        set_interface_property phase_detector ENABLED true
	        set_interface_property phase_detector export_of cpu_inst.phase_detector
	        alt_mem_if::util::hwtcl_utils::rename_exported_interface_ports cpu_inst phase_detector phase_detector
	    } elseif {[::alt_mem_if::util::qini::cfg_is_on alt_mem_if_use_nios_cpu]} {
	...
	if {[string compare -nocase [get_parameter_value HARD_PHY] "false"] == 0} {
		...
		if {[string compare -nocase $protocol "DDR3"] == 0 } {
			set_instance_parameter_value sequencer_rw_mgr_inst AVL_CLK_PS [get_parameter_value AVL_CLK_PS]
			set_instance_parameter_value sequencer_rw_mgr_inst AFI_CLK_PS [get_parameter_value AFI_CLK_PS]
			set_instance_parameter_value sequencer_rw_mgr_inst ENABLE_NON_DES_CAL [get_parameter_value ENABLE_NON_DES_CAL]

			set_instance_parameter_value sequencer_rw_mgr_inst AP_MODE_EN [get_parameter_value AP_MODE_EN]

			set_instance_parameter_value sequencer_rw_mgr_inst TREFI [get_parameter_value TREFI]
			set_instance_parameter_value sequencer_rw_mgr_inst REFRESH_INTERVAL [get_parameter_value REFRESH_INTERVAL]
			set_instance_parameter_value sequencer_rw_mgr_inst TRFC [get_parameter_value TRFC]
		}
	...
	if {[string compare -nocase [get_parameter_value USE_DQS_TRACKING] "TRUE"] == 0} {
		if {[check_device_family_equivalence $device_family {"MAX10"}]} {
		    add_instance sequencer_trk_mgr_inst m10_trk_mgr
		} else {
	...
	if {[string compare -nocase [get_parameter_value USE_SEQUENCER_BFM] "true"] != 0 &&
	    ...
	    [string compare -nocase [get_parameter_value MAX10_RTL_SEQ] "true"] != 0} {
	...
	if {([check_device_family_equivalence $device_family {"MAX10"}] != 1)} {
	    ...
	    add_interface afi_init_cal_req conduit end
	    set_interface_property afi_init_cal_req ENABLED true
	    set_interface_property afi_init_cal_req export_of sequencer_pll_mgr_inst.afi_init_cal_req
	    alt_mem_if::util::hwtcl_utils::rename_exported_interface_ports sequencer_pll_mgr_inst afi_init_cal_req afi_init_cal_req
	}
	...
	if {[string compare -nocase [get_parameter_value USE_DQS_TRACKING] "TRUE"] == 0} {
		...
		if {[check_device_family_equivalence $device_family {"MAX10"}]} {
		    add_interface tracking_strobe conduit end
	        set_interface_property tracking_strobe ENABLED true
	        set_interface_property tracking_strobe export_of sequencer_trk_mgr_inst.tracking_strobe
	        alt_mem_if::util::hwtcl_utils::rename_exported_interface_ports sequencer_trk_mgr_inst tracking_strobe tracking_strobe
	    }
	}
	...
	if {[string compare -nocase [get_parameter_value USE_DQS_TRACKING] "TRUE"] == 0} {
	    if {[check_device_family_equivalence $device_family {"MAX10"}]} {
		    ...
		    set_instance_parameter_value sequencer_trk_mgr_inst MEM_IF_READ_DQS_WIDTH [get_parameter_value MEM_IF_READ_DQS_WIDTH]
		    ...
		    set_instance_parameter_value sequencer_trk_mgr_inst PLL_MGR_BASE $SEQUENCER_TRK_PLL_MGR_BASE
		} else {
		    set_instance_parameter_value sequencer_trk_mgr_inst AVL_DATA_WIDTH [get_parameter_value AVL_DATA_WIDTH]
	...
	} elseif {[string compare -nocase [get_parameter_value MAX10_RTL_SEQ] "true"] == 0} {
	    set_instance_parameter_value cpu_inst AVL_ADDR_WIDTH    "20"
		set_instance_parameter_value cpu_inst AVL_DATA_WIDTH	"32"
	    set_instance_parameter_value cpu_inst READ_VALID_FIFO_SIZE [get_parameter_value READ_VALID_FIFO_SIZE]
		set_instance_parameter_value cpu_inst HPS_PROTOCOL [get_parameter_value HPS_PROTOCOL]
	    set_instance_parameter_value cpu_inst PHY_MGR_BASE $PHY_MGR_BASE_ADDRESS
		set_instance_parameter_value cpu_inst RW_MGR_BASE $RW_MGR_BASE_ADDRESS
		set_instance_parameter_value cpu_inst PLL_MGR_BASE $PLL_MGR_BASE_ADDRESS
		set_instance_parameter_value cpu_inst MEM_DQ_WIDTH [get_parameter_value MEM_IF_DQ_WIDTH]
	} else {

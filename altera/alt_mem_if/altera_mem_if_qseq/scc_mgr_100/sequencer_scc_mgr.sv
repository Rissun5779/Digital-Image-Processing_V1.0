...
module sequencer_scc_mgr (
	...
	// go signal coming from AVL side.
	...
	always_comb begin
		...
		if (sel_scc & avl_write) begin
			case (avl_address[AVL_ADDR_WIDTH - 1:AVL_ADDR_WIDTH - 3])

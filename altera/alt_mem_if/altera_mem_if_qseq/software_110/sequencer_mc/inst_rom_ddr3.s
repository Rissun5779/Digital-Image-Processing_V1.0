...
`if NON_DES_CAL
LABEL IDLE cmd_ret | jump_0 | jump_reg_0 | ac_init_reset_1_cke_0 | do_0 | dm_0 # IDLE
`else
...
LABEL REFRESH_DELAY cmd_def | jump_1 | jump_reg_1 | ac_des | do_0 | dm_0 # inner loop delay (loops to self)
LABEL __NL cmd_def | jump_1 | jump_reg_0 | ac_des | do_0 | dm_0 # NOP and outer loop refresh repetition
LABEL __NL cmd_ret | jump_0 | jump_reg_0 | ac_des | do_0 | dm_0 # return
...
`if AP_MODE
LABEL __NL cmd_def | jump_0 | jump_reg_0 | ac_write_bank_1_col_1 | do_5 | dm_0
`else
...
`if AP_MODE
LABEL __NL cmd_rdp | jump_0 | jump_reg_0 | ac_read_bank_1_1 | do_5 | dm_0
`else
LABEL __NL cmd_rdp | jump_0 | jump_reg_0 | ac_read_bank_0_1 | do_5 | dm_0
`endif
`if HALF_RATE
...
`endif
`if AP_MODE
LABEL __NL cmd_rdp | jump_0 | jump_reg_0 | ac_read_bank_1_0 | do_A | dm_0
`else
...
LABEL __NL cmd_def | jump_1 | jump_reg_2 | ac_init_reset_0_cke_0 | do_0 | dm_0 # reg_2 jnz
...
LABEL __NL cmd_def | jump_1 | jump_reg_2 | ac_init_reset_1_cke_0 | do_0 | dm_0 # reg_2 jnz

...
`endif
`if AP_MODE
DEFINE add add_0 0_0000_0010_0000
DEFINE add add_1 0_0000_1011_0000
DEFINE add add_0_act 0_0000_0000_0000
`else
DEFINE add add_0 AC_ROM_USER_ADD_0
DEFINE add add_1 AC_ROM_USER_ADD_1
`endif
...
`if AP_MODE
LABEL ac_mrs3 cke_1 | reset_1 | cs_on | cmd_mrs | ba_3_init | add_mrs3 | odt_0 | wdata_valid_0 | dqs_ena_0 | rdata_en_0
`else
...
`if AP_MODE
LABEL ac_act_0 cke_1 | reset_1 | cs_on | cmd_act | ba_0 | add_0_act | odt_0 | wdata_valid_0 | dqs_ena_0 | rdata_en_0
LABEL ac_act_1 cke_1 | reset_1 | cs_on | cmd_act | ba_3 | add_0_act | odt_0 | wdata_valid_0 | dqs_ena_0 | rdata_en_0
`else

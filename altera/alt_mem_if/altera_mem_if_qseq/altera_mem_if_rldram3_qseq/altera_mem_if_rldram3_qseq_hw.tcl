...
set_module_property DESCRIPTION "RLDRAM 3 Qsys Sequencer"
set_module_property NAME altera_mem_if_rldram3_qseq
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_sequencers_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "RLDRAM 3 Qsys Sequencer"
...
proc generate_vhdl_sim {name} {
	...
	if {[::alt_mem_if::util::qini::cfg_is_on alt_mem_if_use_verilog_sequencer]} {
		set seq_gen_files [alt_mem_if::gen::uniphy_gen::generate_sequencer_files $name "RLDRAM3" $tmpdir SIM_VERILOG]
	} else {
		set seq_gen_files [alt_mem_if::gen::uniphy_gen::generate_sequencer_files $name "RLDRAM3" $tmpdir SIM_VHDL]
	}
...
proc generate_verilog_sim {name} {
	...
	foreach generated_file [alt_mem_if::gen::uniphy_gen::generate_sequencer_files $name "RLDRAM3" $tmpdir SIM_VERILOG] {
		set file_name [file tail $generated_file]
...
proc generate_synth {name} {
	...
	foreach generated_file [alt_mem_if::gen::uniphy_gen::generate_sequencer_files $name "RLDRAM3" $tmpdir QUARTUS_SYNTH] {
		set file_name [file tail $generated_file]
		_dprint 1 "Preparing to add $generated_file as $file_name"
		add_fileset_file $file_name [::alt_mem_if::util::hwtcl_utils::get_file_type $file_name 0] PATH $generated_file
	}
...
proc ip_elaborate {} {
	...
	if {[string compare -nocase [get_parameter_value HARD_PHY] "false"] == 0} {
		...
		::alt_mem_if::gen::uniphy_interfaces::phy_manager "RLDRAM3" "sequencer" 1 "disable_fr_shift_calibration"
		...
		::alt_mem_if::gen::uniphy_interfaces::afi "RLDRAM3" "controller" "afi" 0 0

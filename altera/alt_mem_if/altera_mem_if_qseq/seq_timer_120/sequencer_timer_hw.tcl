...
# | 
set_module_property DESCRIPTION "Sequencer Timer (12.0)"
set_module_property NAME sequencer_timer_120
...
set_module_property DISPLAY_NAME "UniPHY Sequencer Timer (12.0 Version)"
...
set_fileset_property sim_vhdl TOP_LEVEL sequencer_timer

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL sequencer_timer

add_fileset quartus_synth QUARTUS_SYNTH generate_synth
set_fileset_property quartus_synth TOP_LEVEL sequencer_timer
...
add_parameter AVL_SYMBOL_WIDTH INTEGER 32
...
proc ip_elaborate {} {
	...
	# Create the clock, reset, and Avalon-MM interface

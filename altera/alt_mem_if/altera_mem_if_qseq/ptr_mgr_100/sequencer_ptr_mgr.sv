...
// -------------------
//
// This component allows a way for JTAG debug master to figure out where
// data transfer arrays are placed in memory. NIOS code will place the
// pointer to the array in a register, and the JTAG debug master picks it
// up from there.
//

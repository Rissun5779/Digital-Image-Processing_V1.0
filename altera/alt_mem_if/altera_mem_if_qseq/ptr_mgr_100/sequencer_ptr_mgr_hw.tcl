...
set_module_property NAME sequencer_ptr_mgr_100
...
set_module_property DISPLAY_NAME "UniPHY Pointer Manager (10.0 Version)"
...
set_fileset_property sim_vhdl TOP_LEVEL sequencer_ptr_mgr

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL sequencer_ptr_mgr

add_fileset quartus_synth QUARTUS_SYNTH generate_synth
set_fileset_property quartus_synth TOP_LEVEL sequencer_ptr_mgr


proc generate_verilog_fileset {} {
	set file_list [list \
		sequencer_ptr_mgr.sv \
	]

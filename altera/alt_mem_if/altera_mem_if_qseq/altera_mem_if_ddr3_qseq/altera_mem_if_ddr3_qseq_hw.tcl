...
set_module_property DESCRIPTION "DDR3 SDRAM Qsys Sequencer"
set_module_property NAME altera_mem_if_ddr3_qseq
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_sequencers_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "DDR3 SDRAM Qsys Sequencer"
...
proc generate_vhdl_sim {name} {
	...
	if {[::alt_mem_if::util::qini::cfg_is_on alt_mem_if_use_verilog_sequencer]} {
		set seq_gen_files [alt_mem_if::gen::uniphy_gen::generate_sequencer_files $name "DDR3" $tmpdir SIM_VERILOG]
	} else {
		set seq_gen_files [alt_mem_if::gen::uniphy_gen::generate_sequencer_files $name "DDR3" $tmpdir SIM_VHDL]
	}
...
proc ip_elaborate {} {
	...
	if {[string compare -nocase [get_parameter_value HARD_PHY] "false"] == 0} {
		...
		::alt_mem_if::gen::uniphy_interfaces::phy_manager "DDR3" "sequencer"
		...
		::alt_mem_if::gen::uniphy_interfaces::afi "DDR3" "controller" "afi" 0 0

		if {[get_parameter_value MRS_MIRROR_PING_PONG_ATSO]} {
			set_port_property afi_cs_n WIDTH_EXPR [expr {2 * [get_parameter_value AFI_CS_WIDTH]}]
		}

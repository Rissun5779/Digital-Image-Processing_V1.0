...
set_module_property DESCRIPTION "Data Manager"
set_module_property NAME sequencer_data_mgr_110
...
set_module_property DISPLAY_NAME "UniPHY Data Manager (11.0 Version)"
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property ANALYZE_HDL TRUE

add_fileset sim_vhdl SIM_VHDL generate_vhdl_sim
set_fileset_property sim_vhdl TOP_LEVEL sequencer_data_mgr

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL sequencer_data_mgr

add_fileset quartus_synth QUARTUS_SYNTH generate_synth
set_fileset_property quartus_synth TOP_LEVEL sequencer_data_mgr



proc generate_verilog_fileset {} {
	set file_list [list \
		sequencer_data_mgr.sv \
	]
...
add_parameter AFI_MAX_WRITE_LATENCY_COUNT_WIDTH INTEGER 32
...
add_parameter CALIB_SKIP_STEPS_WIDTH INTEGER 8
set_parameter_property CALIB_SKIP_STEPS_WIDTH DISPLAY_NAME CALIB_SKIP_STEPS_WIDTH
set_parameter_property CALIB_SKIP_STEPS_WIDTH ALLOWED_RANGES 1:1024
set_parameter_property CALIB_SKIP_STEPS_WIDTH HDL_PARAMETER true
...
set_parameter_property SEQUENCER_VERSION HDL_PARAMETER true

...
(* altera_attribute = "-name IP_TOOL_NAME altera_mem_if_rldram3_afi_driver; -name IP_TOOL_VERSION 18.1; -name FITTER_ADJUST_HC_SHORT_PATH_GUARDBAND 100" *)
...
assign afi_ref_n = ( MEM_IF_CS_WIDTH > 1 ) ? ~afi_cs_per_rank : '1;
assign afi_rst_n = '1;
assign afi_dm = '0;

...
module sequencer_mux_bridge_qdrii (
	seq_clk,
	reset_n_seq_clk,
	afi_clk,
	afi_reset_n,
...
input	[SEQ_CONTROL_WIDTH-1:0]		seq_wps_n;
input	[SEQ_CONTROL_WIDTH-1:0]		seq_rps_n;
...
output	[AFI_CONTROL_WIDTH-1:0]		mux_wps_n;
output	[AFI_CONTROL_WIDTH-1:0]		mux_rps_n;
...
wire	[AFI_CONTROL_WIDTH-1:0]		seq_wps_n_h;
wire	[AFI_CONTROL_WIDTH-1:0]		seq_wps_n_l;
wire	[AFI_CONTROL_WIDTH-1:0]		seq_rps_n_h;
wire	[AFI_CONTROL_WIDTH-1:0]		seq_rps_n_l;
...
assign	seq_wps_n_h			= seq_wps_n[SEQ_CONTROL_WIDTH-1:AFI_CONTROL_WIDTH];
assign	seq_wps_n_l			= seq_wps_n[AFI_CONTROL_WIDTH-1:0];
assign	seq_rps_n_h			= seq_rps_n[SEQ_CONTROL_WIDTH-1:AFI_CONTROL_WIDTH];
assign	seq_rps_n_l			= seq_rps_n[AFI_CONTROL_WIDTH-1:0];
...
reg		[AFI_CONTROL_WIDTH-1:0]		seq_wps_n_h_r;
reg		[AFI_CONTROL_WIDTH-1:0]		seq_rps_n_h_r;
...
begin
	...
	begin
		...
		seq_wps_n_h_r		<= seq_wps_n_h;
		seq_rps_n_h_r		<= seq_rps_n_h;
...
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_wps_n_h;
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_wps_n_l;
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_rps_n_h;
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_rps_n_l;
wire								ddr_rdata_en_h;
wire								ddr_rdata_en_l;
...
assign	ddr_wps_n_h		= shift_addr_cmd ? seq_wps_n_l		: seq_wps_n_h;
assign	ddr_wps_n_l		= shift_addr_cmd ? seq_wps_n_h_r	: seq_wps_n_l;
assign	ddr_rps_n_h		= shift_addr_cmd ? seq_rps_n_l		: seq_rps_n_h;
assign	ddr_rps_n_l		= shift_addr_cmd ? seq_rps_n_h_r	: seq_rps_n_l;
...
reg		[AFI_CONTROL_WIDTH-1:0]		ddr_wps_n_h_r;
reg		[AFI_CONTROL_WIDTH-1:0]		ddr_wps_n_l_r;
reg		[AFI_CONTROL_WIDTH-1:0]		ddr_rps_n_h_r;
reg		[AFI_CONTROL_WIDTH-1:0]		ddr_rps_n_l_r;
...
begin
	...
	ddr_wps_n_h_r		<= ddr_wps_n_h;
	ddr_wps_n_l_r		<= ddr_wps_n_l;
	ddr_rps_n_h_r		<= ddr_rps_n_h;
	ddr_rps_n_l_r		<= ddr_rps_n_l;
...
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_wps_n;
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_rps_n;
...
assign	ddr_wps_n					= seq_clk ? ddr_wps_n_l_r				: ddr_wps_n_h_r;
assign	ddr_rps_n					= seq_clk ? ddr_rps_n_l_r				: ddr_rps_n_h_r;
...
assign	mux_wps_n					= enable_conversion ? ddr_wps_n						: seq_wps_n;
assign	mux_rps_n					= enable_conversion ? ddr_rps_n						: seq_rps_n;

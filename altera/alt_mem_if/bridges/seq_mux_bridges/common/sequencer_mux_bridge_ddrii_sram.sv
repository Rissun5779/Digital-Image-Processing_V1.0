...
module sequencer_mux_bridge_ddrii_sram (
	seq_clk,
	reset_n_seq_clk,
	afi_clk,
	afi_reset_n,
...
input	[SEQ_CONTROL_WIDTH-1:0]		seq_ld_n;
input	[SEQ_CONTROL_WIDTH-1:0]		seq_rw_n;
...
output	[AFI_CONTROL_WIDTH-1:0]		mux_ld_n;
output	[AFI_CONTROL_WIDTH-1:0]		mux_rw_n;
...
wire	[AFI_CONTROL_WIDTH-1:0]		seq_ld_n_h;
wire	[AFI_CONTROL_WIDTH-1:0]		seq_ld_n_l;
wire	[AFI_CONTROL_WIDTH-1:0]		seq_rw_n_h;
wire	[AFI_CONTROL_WIDTH-1:0]		seq_rw_n_l;
...
assign	seq_ld_n_h			= seq_ld_n[SEQ_CONTROL_WIDTH-1:AFI_CONTROL_WIDTH];
assign	seq_ld_n_l			= seq_ld_n[AFI_CONTROL_WIDTH-1:0];
assign	seq_rw_n_h			= seq_rw_n[SEQ_CONTROL_WIDTH-1:AFI_CONTROL_WIDTH];
assign	seq_rw_n_l			= seq_rw_n[AFI_CONTROL_WIDTH-1:0];
...
reg		[AFI_CONTROL_WIDTH-1:0]		seq_ld_n_h_r;
reg		[AFI_CONTROL_WIDTH-1:0]		seq_rw_n_h_r;
...
begin
	...
	begin
		...
		seq_ld_n_h_r		<= seq_ld_n_h;
		seq_rw_n_h_r		<= seq_rw_n_h;
...
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_ld_n_h;
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_ld_n_l;
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_rw_n_h;
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_rw_n_l;
wire								ddr_rdata_en_h;
wire								ddr_rdata_en_l;
...
assign	ddr_ld_n_h		= shift_addr_cmd ? seq_ld_n_l		: seq_ld_n_h;
assign	ddr_ld_n_l		= shift_addr_cmd ? seq_ld_n_h_r		: seq_ld_n_l;
assign	ddr_rw_n_h		= shift_addr_cmd ? seq_rw_n_l		: seq_rw_n_h;
assign	ddr_rw_n_l		= shift_addr_cmd ? seq_rw_n_h_r		: seq_rw_n_l;
...
reg		[AFI_CONTROL_WIDTH-1:0]		ddr_ld_n_h_r;
reg		[AFI_CONTROL_WIDTH-1:0]		ddr_ld_n_l_r;
reg		[AFI_CONTROL_WIDTH-1:0]		ddr_rw_n_h_r;
reg		[AFI_CONTROL_WIDTH-1:0]		ddr_rw_n_l_r;
...
begin
	...
	ddr_ld_n_h_r		<= ddr_ld_n_h;
	ddr_ld_n_l_r		<= ddr_ld_n_l;
	ddr_rw_n_h_r		<= ddr_rw_n_h;
	ddr_rw_n_l_r		<= ddr_rw_n_l;
...
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_ld_n;
wire	[AFI_CONTROL_WIDTH-1:0]		ddr_rw_n;
...
assign	ddr_ld_n					= seq_clk ? ddr_ld_n_l_r				: ddr_ld_n_h_r;
assign	ddr_rw_n					= seq_clk ? ddr_rw_n_l_r				: ddr_rw_n_h_r;
...
assign	mux_ld_n					= enable_conversion ? ddr_ld_n						: seq_ld_n;
assign	mux_rw_n					= enable_conversion ? ddr_rw_n						: seq_rw_n;

...
set_module_property DESCRIPTION "Altera DDR3 Sequencer Mux Bridge"
set_module_property NAME altera_mem_if_ddr3_seq_mux_bridge
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_afi_mux_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera DDR3 Sequencer Mux Bridge"
...
proc ip_elaborate {} {
	...
	::alt_mem_if::gen::uniphy_interfaces::afi "DDR3" "phy" "seq" 1 0
	::alt_mem_if::gen::uniphy_interfaces::afi "DDR3" "controller" "mux" 1 0

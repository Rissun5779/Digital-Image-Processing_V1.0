...
set_module_property DESCRIPTION "Altera DDR2 Sequencer Mux Bridge"
set_module_property NAME altera_mem_if_ddr2_seq_mux_bridge
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_afi_mux_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera DDR2 Sequencer Mux Bridge"
...
proc solve_core_params {} {
	...
	lappend core_params_list "DDR_FLOP"
...
proc generate_vhdl_sim {name} {
	...
	set generated_file [alt_mem_if::util::iptclgen::generate_outfile_name "sequencer_mux_bridge.sv" [solve_core_params]]
...
proc ip_elaborate {} {
	...
	::alt_mem_if::gen::uniphy_interfaces::afi "DDR2" "phy" "afi_seq" 1 0
	::alt_mem_if::gen::uniphy_interfaces::afi "DDR2" "controller" "afi_mux" 1 0


	::alt_mem_if::gen::uniphy_interfaces::sequencer_mux_bridge_control "bridge"

	set_port_property enable_conversion termination true
	set_port_property enable_conversion termination_value 0
	set_port_property shift_addr_cmd termination true
	set_port_property shift_addr_cmd termination_value 0

	foreach fset_name [list SIM_VERILOG SIM_VHDL QUARTUS_SYNTH] {
		set_fileset_property [string tolower $fset_name] TOP_LEVEL [alt_mem_if::util::iptclgen::generate_outfile_name "sequencer_mux_bridge.sv" [solve_core_params] 1]
	}

...
set_module_property DESCRIPTION "Altera DDR3 AFI Multiplexer"
set_module_property NAME altera_mem_if_ddr3_afi_mux
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_afi_mux_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera DDR3 AFI Multiplexer"
...
proc create_hdl_parameters {} {
	...
	set_parameter_property MRS_MIRROR_PING_PONG_ATSO HDL_PARAMETER true
}
...
proc ip_elaborate {} {
	...
	::alt_mem_if::gen::uniphy_interfaces::afi "DDR3" "phy" "afi" 1 1
	::alt_mem_if::gen::uniphy_interfaces::afi "DDR3" "controller" "phy_mux" 1 1
	if {[string compare -nocase [get_parameter_value PINGPONGPHY_EN] "true"] == 0} {
		::alt_mem_if::gen::uniphy_interfaces::afi "DDR3" "phy" "seq_mux" 1 0 0 3
	} else {
		::alt_mem_if::gen::uniphy_interfaces::afi "DDR3" "phy" "seq_mux" 1 0
	}

	::alt_mem_if::gen::uniphy_interfaces::mux_selector "afi_mux"

	if {[string compare -nocase [get_parameter_value PINGPONGPHY_EN] "true"] == 0} {
		add_interface phy_mux_sel conduit end
		set_interface_property phy_mux_sel ENABLED true
		add_interface_port phy_mux_sel phy_mux_sel mux_sel Output 1
	}

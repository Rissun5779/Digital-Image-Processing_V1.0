...
set_module_property DESCRIPTION "UniPHY DDR2 AFI Splitter"
set_module_property NAME altera_mem_if_ddr2_afi_splitter
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_afi_mux_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "UniPHY DDR2 AFI Splitter"
...
proc ip_elaborate {} {
	...
	if {[string compare -nocase [get_parameter_value HARD_EMIF] "false"] == 0} {
		...
		if {[string compare -nocase [get_parameter_value HHP_HPS] "true"] == 0 &&
		    [string compare -nocase [get_parameter_value USE_DQS_TRACKING] "true"] == 0} {
	...
	if {[string compare -nocase [get_parameter_value HARD_EMIF] "false"] == 0} {
		::alt_mem_if::gen::uniphy_interfaces::afi "DDR2" "controller" "mux_afi" 1 1
	} else {
	...
	if {[string compare -nocase [get_parameter_value HHP_HPS] "true"] == 0 &&
	    [string compare -nocase [get_parameter_value USE_DQS_TRACKING] "true"] == 0} {
		lappend split_ports afi_seq_busy afi_ctl_refresh_done afi_ctl_long_idle
	}

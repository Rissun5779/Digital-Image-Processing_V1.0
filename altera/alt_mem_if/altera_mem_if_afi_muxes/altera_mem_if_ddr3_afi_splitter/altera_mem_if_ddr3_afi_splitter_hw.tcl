...
set_module_property DESCRIPTION "UniPHY DDR3 AFI Splitter"
set_module_property NAME altera_mem_if_ddr3_afi_splitter
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_afi_mux_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "UniPHY DDR3 AFI Splitter"
...
proc ip_elaborate {} {
	...
	if {[string compare -nocase [get_parameter_value HARD_EMIF] "false"] == 0} {
		...
		add_interface_port afi afi_ba afi_ba input [get_parameter_value AFI_BANKADDR_WIDTH]
		add_interface_port afi afi_cke afi_cke input [get_parameter_value AFI_CLK_EN_WIDTH]
		add_interface_port afi afi_cs_n afi_cs_n input [get_parameter_value AFI_CS_WIDTH]
		add_interface_port afi afi_ras_n afi_ras_n input [get_parameter_value AFI_CONTROL_WIDTH]
		add_interface_port afi afi_we_n afi_we_n input [get_parameter_value AFI_CONTROL_WIDTH]
		add_interface_port afi afi_cas_n afi_cas_n input [get_parameter_value AFI_CONTROL_WIDTH]
		add_interface_port afi afi_rst_n afi_rst_n input [get_parameter_value AFI_CONTROL_WIDTH]
		add_interface_port afi afi_odt afi_odt input [get_parameter_value AFI_ODT_WIDTH]
		...
		if {[string compare -nocase [get_parameter_value PINGPONGPHY_EN] "true"] == 0} {
			add_interface_port afi afi_rdata_en_1t afi_rdata_en_1t input [get_parameter_value AFI_RATE_RATIO]
			add_interface_port afi afi_rdata_en_full_1t afi_rdata_en_full_1t input [get_parameter_value AFI_RATE_RATIO]
			add_interface_port afi afi_rdata_valid_1t afi_rdata_valid_1t output [get_parameter_value AFI_RATE_RATIO]
		}
		if {[string compare -nocase [get_parameter_value USE_DQS_TRACKING] "true"] == 0} {
			add_interface_port afi afi_seq_busy afi_seq_busy output [get_parameter_value MEM_IF_NUMBER_OF_RANKS]
			add_interface_port afi afi_ctl_refresh_done afi_ctl_refresh_done input [get_parameter_value MEM_IF_NUMBER_OF_RANKS]
			add_interface_port afi afi_ctl_long_idle afi_ctl_long_idle input [get_parameter_value MEM_IF_NUMBER_OF_RANKS]
		}
		if {[string compare -nocase [get_parameter_value USE_SHADOW_REGS] "true"] == 0} {
			add_interface_port afi afi_rrank afi_rrank input [get_parameter_value AFI_RRANK_WIDTH]
			add_interface_port afi afi_wrank afi_wrank input [get_parameter_value AFI_WRANK_WIDTH]
		}
	...
	if {[string compare -nocase [get_parameter_value HARD_EMIF] "false"] == 0} {
		::alt_mem_if::gen::uniphy_interfaces::afi "DDR3" "controller" "mux_afi" 1 1
	} else {
	...
	if {[string compare -nocase [get_parameter_value PINGPONGPHY_EN] "true"] == 0} {
		...
		add_interface_port pingpong_1t phy_afi_rdata_en_1t afi_rdata_en_1t output [get_parameter_value AFI_RATE_RATIO]
		add_interface_port pingpong_1t phy_afi_rdata_en_full_1t afi_rdata_en_full_1t output [get_parameter_value AFI_RATE_RATIO]
		add_interface_port pingpong_1t phy_afi_rdata_valid_1t afi_rdata_valid_1t input [get_parameter_value AFI_RATE_RATIO]

		set_port_property phy_afi_rdata_en_1t DRIVEN_BY afi_rdata_en_1t
		set_port_property phy_afi_rdata_en_full_1t DRIVEN_BY afi_rdata_en_full_1t
		set_port_property afi_rdata_valid_1t DRIVEN_BY phy_afi_rdata_valid_1t
	}
	...
	if {[string compare -nocase [get_parameter_value USE_DQS_TRACKING] "true"] == 0} {
		...
		add_interface_port tracking seq_afi_seq_busy afi_seq_busy Input [get_parameter_value MEM_IF_NUMBER_OF_RANKS]
		add_interface_port tracking seq_afi_ctl_refresh_done afi_ctl_refresh_done Output [get_parameter_value MEM_IF_NUMBER_OF_RANKS]
		add_interface_port tracking seq_afi_ctl_long_idle afi_ctl_long_idle Output [get_parameter_value MEM_IF_NUMBER_OF_RANKS]

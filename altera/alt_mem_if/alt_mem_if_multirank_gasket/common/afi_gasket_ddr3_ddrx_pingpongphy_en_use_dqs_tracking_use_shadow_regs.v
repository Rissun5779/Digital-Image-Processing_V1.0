...
module afi_gasket_ddr3_ddrx_pingpongphy_en_use_dqs_tracking_use_shadow_regs (
    ...
    afi_ctlr_wrank,
    afi_ctlr_rrank,
    afi_ctlr_ctl_refresh_done,
    afi_ctlr_seq_busy,
    afi_ctlr_ctl_long_idle,
    afi_ctlr_dqs_burst,
...
input             [AFI_CTLR_WRANK_WIDTH-1:0]  afi_ctlr_wrank;
input             [AFI_CTLR_RRANK_WIDTH-1:0]  afi_ctlr_rrank;
input           [MEM_IF_NUMBER_OF_RANKS-1:0]  afi_ctlr_ctl_refresh_done;
output          [MEM_IF_NUMBER_OF_RANKS-1:0]  afi_ctlr_seq_busy;
input           [MEM_IF_NUMBER_OF_RANKS-1:0]  afi_ctlr_ctl_long_idle;
...
output            [AFI_MUX_WRANK_WIDTH-1:0]   afi_wrank;
output            [AFI_MUX_RRANK_WIDTH-1:0]   afi_rrank;
output         [MEM_IF_NUMBER_OF_RANKS-1:0]   afi_ctl_refresh_done;
input          [MEM_IF_NUMBER_OF_RANKS-1:0]   afi_seq_busy;
output         [MEM_IF_NUMBER_OF_RANKS-1:0]   afi_ctl_long_idle;
...
assign afi_wrank[AFI_MUX_WRANK_WIDTH-1:0]                               = afi_ctlr_wrank[AFI_CTLR_WRANK_WIDTH-1:0];
assign afi_rrank[AFI_MUX_RRANK_WIDTH-1:0]                               = afi_ctlr_rrank[AFI_CTLR_RRANK_WIDTH-1:0];
assign afi_ctl_refresh_done[MEM_IF_NUMBER_OF_RANKS-1:0]                 = afi_ctlr_ctl_refresh_done[MEM_IF_NUMBER_OF_RANKS-1:0];
assign afi_ctl_long_idle[MEM_IF_NUMBER_OF_RANKS-1:0]                    = afi_ctlr_ctl_long_idle[MEM_IF_NUMBER_OF_RANKS-1:0];
assign afi_ctlr_seq_busy[MEM_IF_NUMBER_OF_RANKS-1:0]                    = afi_seq_busy[MEM_IF_NUMBER_OF_RANKS-1:0];

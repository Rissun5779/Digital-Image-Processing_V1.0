...
(* altera_attribute = "-name IP_TOOL_NAME altera_mem_if_lpddr_hard_phy_core; -name IP_TOOL_VERSION 18.1; -name FITTER_ADJUST_HC_SHORT_PATH_GUARDBAND 100" *)
...
parameter IS_HHP_HPS = "IPTCL_HHP_HPS";
...
parameter AC_ROM_INIT_FILE_NAME = "IPTCL_AC_ROM_INIT_FILE_NAME";
parameter INST_ROM_INIT_FILE_NAME = "IPTCL_INST_ROM_INIT_FILE_NAME";
...
// Status interface
`ifdef USE_DQS_TRACKING
input   [MEM_IF_CS_WIDTH-1:0] afi_ctl_refresh_done;
input   [MEM_IF_CS_WIDTH-1:0] afi_ctl_long_idle;
output  [MEM_IF_CS_WIDTH-1:0] afi_seq_busy;
`endif
...
output   [5:0]  io_intafirlat;
output   [4:0]  io_intafiwlat;

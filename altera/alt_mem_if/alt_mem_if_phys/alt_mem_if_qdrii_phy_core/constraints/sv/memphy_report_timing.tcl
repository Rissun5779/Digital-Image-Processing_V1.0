...
`endif
	...
	foreach opc $opcs {
		...
		memphy_perform_flexible_read_capture_timing_analysis $opcs $opcname $inst $family scale_factors $io_std $interface_type $max_package_skew $dqs_phase $period $all_q_pins pins t summary MP IP board fpga

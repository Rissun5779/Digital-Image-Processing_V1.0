...
#############################################################
proc memphy_perform_flexible_write_launch_timing_analysis {opcs opcname inst family scale_factors_name interface_type max_package_skew period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
...
proc memphy_perform_ac_analyses {opcs opcname inst scale_factors_name pin_array_name timing_parameters_array_name summary_name IP_name} {
	...
	foreach ck_pin $pins(ck_pins) {
		set clk_clk_phase_select_node [memphy_traverse_to_ddio_out_periphery_clock $ck_pin msg_list]
	...
	foreach ac_pin $ac_pins {
		...
		set ac_clk_phase_select_node [memphy_traverse_to_ddio_out_periphery_clock $ac_pin msg_list]
	...
	foreach dqs_pin $pins(dqs_pins) {
		...
		set dqs_pin_setup_slack [memphy_min_in_collection_to_name $dqs_paths_setup "slack" $dqs_pin]
		set dqs_pin_hold_slack  [memphy_min_in_collection_to_name $dqs_paths_hold  "slack" $dqs_pin]
		
		set dqs_clk_phase_select_node [memphy_traverse_to_ddio_out_periphery_clock $dqs_pin msg_list]
		...
		set dqs_max  [memphy_max_in_collection [get_path -rise_from $pll_clock -rise_to $dqs_periphery_node] "arrival_time"]
		if {$dqs_max <= 0} {set dqs_max -9999}
		set dqs_min  [memphy_max_in_collection [get_path -rise_from $pll_clock -rise_to $dqs_periphery_node -min_path] "arrival_time"]
		if {$dqs_min <= 0} {set dqs_min 9999}

		set extra_ccpr [memphy_round_3dp [expr ($clk_max - $clk_min + $dqs_max - $dqs_min)/2.0]]
	...
	lappend dqs_summary [list "  Standard DQS vs CK" [memphy_format_3dp $default_dqs_setup_slack] [memphy_format_3dp $default_dqs_hold_slack]]
	lappend dqs_summary [list "  Extra common clock pessimism removal" [memphy_format_3dp [expr $dqs_setup_slack - $default_dqs_setup_slack]] [memphy_format_3dp [expr $dqs_hold_slack - $default_dqs_hold_slack]]]
	...
	set fcolour [memphy_get_colours $dqs_setup_slack $dqs_hold_slack] 
	add_row_to_table -id $dqs_panel_id [list "DQS vs CK" [memphy_format_3dp $dqs_setup_slack] [memphy_format_3dp $dqs_hold_slack]] -fcolor $fcolour
	lappend summary [list $opcname 0 "DQS vs CK ($opcname)" [memphy_format_3dp $dqs_setup_slack] [memphy_format_3dp $dqs_hold_slack]]
...
proc memphy_perform_flexible_bus_turnaround_time_analysis {opcs opcname instname family period interface_type tJITper tDCD pll_steps pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
...
proc memphy_perform_flexible_read_capture_non_dqs_timing_analysis {opcs opcname inst family period all_dq_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
	...
	set DQ_max [expr [memphy_max_in_collection $DQ_paths_setup "arrival_time"] - [memphy_max_in_collection $DQ_paths_setup "launch_time"] - [memphy_min_in_collection $DQ_paths_setup "required_time"] + [memphy_min_in_collection $DQ_paths_setup "latch_time"]]
	set DQ_min [expr [memphy_min_in_collection $DQ_paths_hold  "arrival_time"] - [memphy_min_in_collection $DQ_paths_hold  "launch_time"] - [memphy_max_in_collection $DQ_paths_hold "required_time"]  + [memphy_max_in_collection $DQ_paths_hold  "latch_time"]]
	...
	set clock_max [memphy_max_in_collection $clock_max_paths "arrival_time"]
	set clock_min [memphy_min_in_collection $clock_min_paths "arrival_time"]
	...
	set fcolour [memphy_get_colours $setup_slack $hold_slack]
	lappend rc_summary [list "  Ideal Read Capture" [memphy_format_3dp [expr $period/4]] [memphy_format_3dp [expr $period/4]]] 
	lappend rc_summary [list "  MinMax DQ variation" [memphy_format_3dp [expr 0-$minmax_DQ_variation/2]] [memphy_format_3dp [expr 0-$minmax_DQ_variation/2]]] 
	lappend rc_summary [list "  MinMax clock variation" [memphy_format_3dp [expr 0-$minmax_clock_variation/2]] [memphy_format_3dp [expr 0-$minmax_clock_variation/2]]] 
	lappend rc_summary [list "  Memory uncertainty" [memphy_format_3dp [expr 0-$tAC]] [memphy_format_3dp [expr 0-$tAC]]] 
	lappend rc_summary [list "  PLL Quantization error" [memphy_format_3dp [expr 0-$phy_uncertainty]] [memphy_format_3dp [expr 0-$phy_uncertainty]]]
	lappend rc_summary [list "  Calibration uncertainty" [memphy_format_3dp [expr 0-$calibration_uncertainty]] [memphy_format_3dp [expr 0-$calibration_uncertainty]]]
	lappend rc_summary [list "  DCD" [memphy_format_3dp [expr 0-$tDCD_time]] [memphy_format_3dp [expr 0-$tDCD_time]]] 
	lappend rc_summary [list "  Jitters" [memphy_format_3dp [expr 0-$total_setup_jitter]] [memphy_format_3dp [expr 0-$total_hold_jitter]]] 
	lappend rc_summary [list "  SSN Effect" [memphy_format_3dp [expr 0-$total_ssi/2]] [memphy_format_3dp [expr 0-$total_ssi/2 ]]] 
	lappend rc_summary [list "  Board Skew" [memphy_format_3dp [expr 0-$board(intra_DQS_group_skew)/2]] [memphy_format_3dp [expr 0-$board(intra_DQS_group_skew)/2]]] 

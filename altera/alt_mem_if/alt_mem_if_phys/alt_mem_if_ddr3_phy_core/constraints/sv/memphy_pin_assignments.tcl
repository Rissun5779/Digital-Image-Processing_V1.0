...
foreach inst $instances {
	...
	if { ! [ string compare $::GLOBAL_io_standard "SSTL-135" ] } {
	...
	`else
			set_instance_assignment -name INPUT_TERMINATION "PARALLEL 40 OHM WITH CALIBRATION" -to $dq_pin -tag __$::GLOBAL_corename
	`endif
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITH CALIBRATION" -to $dq_pin -tag __$::GLOBAL_corename
		}
		...
		foreach dqs_pin [ concat $pins(dqs_pins) $pins(dqsn_pins) ] {
			...
			set_instance_assignment -name INPUT_TERMINATION "PARALLEL 40 OHM WITH CALIBRATION" -to $dqs_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITH CALIBRATION" -to $dqs_pin -tag __$::GLOBAL_corename
		}
		...
		foreach ck_pin [ concat $pins(ck_pins) $pins(ckn_pins) ] {
			...
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITHOUT CALIBRATION" -to $ck_pin -tag __$::GLOBAL_corename
		}
		...
		foreach ac_pin $pins(ac_wo_reset_pins) {
			...
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITHOUT CALIBRATION" -to $ac_pin -tag __$::GLOBAL_corename
		}
		
		foreach reset_pin $pins(reset_pins) {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_io_standard" -to $reset_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name BOARD_MODEL_FAR_PULLUP_R OPEN -to $reset_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name BOARD_MODEL_NEAR_PULLUP_R OPEN -to $reset_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name BOARD_MODEL_FAR_PULLDOWN_R OPEN -to $reset_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name BOARD_MODEL_NEAR_PULLDOWN_R OPEN -to $reset_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITH CALIBRATION" -to $reset_pin -tag __$::GLOBAL_corename
		} 
	`ifdef IPTCL_DUPLICATE_AC
	`ifdef IPTCL_STRATIXV

		foreach ck_1_pin [ concat $pins(ck_1_pins) $pins(ckn_1_pins) ] {
			set_instance_assignment -name IO_STANDARD "DIFFERENTIAL $::GLOBAL_io_standard_differential" -to $ck_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITHOUT CALIBRATION" -to $ck_1_pin -tag __$::GLOBAL_corename
		}

		foreach ac_1_pin $pins(ac_1_wo_reset_pins) {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_io_standard" -to $ac_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITHOUT CALIBRATION" -to $ac_1_pin -tag __$::GLOBAL_corename
		}
		
		foreach reset_1_pin $pins(reset_1_pins) {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_io_standard" -to $reset_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name BOARD_MODEL_FAR_PULLUP_R OPEN -to $reset_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name BOARD_MODEL_NEAR_PULLUP_R OPEN -to $reset_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name BOARD_MODEL_FAR_PULLDOWN_R OPEN -to $reset_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name BOARD_MODEL_NEAR_PULLDOWN_R OPEN -to $reset_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITH CALIBRATION" -to $reset_1_pin -tag __$::GLOBAL_corename
		} 
	`endif
	`endif
		...
		foreach dm_pin $pins(dm_pins) {
			...
			set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITH CALIBRATION" -to $dm_pin -tag __$::GLOBAL_corename
		}
	} else {
		...
		foreach dq_pin $pins(all_dq_pins) {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_io_standard $class_type" -to $dq_pin -tag __$::GLOBAL_corename
	`ifdef IPTCL_NO_PARALLEL_TERMINATION
	`else
	...
	`endif
		...
		foreach dqs_pin [ concat $pins(dqs_pins) $pins(dqsn_pins) ] {
			set_instance_assignment -name IO_STANDARD "DIFFERENTIAL $::GLOBAL_io_standard_differential $class_type" -to $dqs_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION" -to $dqs_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name OUTPUT_TERMINATION "$output_termination" -to $dqs_pin -tag __$::GLOBAL_corename
		}

		foreach ck_pin [ concat $pins(ck_pins) $pins(ckn_pins) ] {
			set_instance_assignment -name IO_STANDARD "DIFFERENTIAL $::GLOBAL_io_standard_differential $class_type" -to $ck_pin -tag __$::GLOBAL_corename
		...
		if { [ llength $blocks ] == 0 } {
			...
			foreach ck_pin $pins(ck_pins) {
				set_instance_assignment -name TERMINATION_CONTROL_BLOCK $block -to $ck_pin -tag __$::GLOBAL_corename
			}

			foreach ckn_pin $pins(ckn_pins) {
				set_instance_assignment -name TERMINATION_CONTROL_BLOCK $block -to $ckn_pin -tag __$::GLOBAL_corename
			}
		}
	...
	`endif
		...
		foreach ac_pin $pins(ac_wo_reset_pins) {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_io_standard $class_type" -to $ac_pin -tag __$::GLOBAL_corename
	...
	`ifdef IPTCL_STRATIXV
		...
		foreach ck_1_pin [ concat $pins(ck_1_pins) $pins(ckn_1_pins) ] {
			set_instance_assignment -name IO_STANDARD "DIFFERENTIAL $::GLOBAL_io_standard_differential $class_type" -to $ck_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name OUTPUT_TERMINATION "$output_termination" -to $ck_1_pin -tag __$::GLOBAL_corename
	...
	`endif
		...
		foreach ac_1_pin $pins(ac_1_wo_reset_pins) {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_io_standard $class_type" -to $ac_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name CURRENT_STRENGTH_NEW "MAXIMUM CURRENT" -to $ac_1_pin -tag __$::GLOBAL_corename
		}
		
		foreach reset_1_pin $pins(reset_1_pins) {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_io_standard_cmos" -to $reset_1_pin -tag __$::GLOBAL_corename
			set_instance_assignment -name CURRENT_STRENGTH_NEW "MAXIMUM CURRENT" -to $reset_1_pin -tag __$::GLOBAL_corename
		}
	`endif
	`endif
		foreach dm_pin $pins(dm_pins) {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_io_standard $class_type" -to $dm_pin -tag __$::GLOBAL_corename
...
`ifdef IPTCL_AC_PACKAGE_DESKEW
	...
	`ifdef IPTCL_DUPLICATE_AC
	`ifdef IPTCL_STRATIXV
	foreach ac_1_pin $pins(ac_1_pins) {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION ON -to $ac_1_pin -tag __$::GLOBAL_corename
	}
	foreach ck_1_pin [ concat $pins(ck_1_pins) $pins(ckn_1_pins) ] {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION ON -to $ck_1_pin -tag __$::GLOBAL_corename
	}
	`endif
	`endif
`else
	...
	`ifdef IPTCL_STRATIXV
	foreach ac_1_pin $pins(ac_1_pins) {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION OFF -to $ac_1_pin -tag __$::GLOBAL_corename
	}
	foreach ck_1_pin [ concat $pins(ck_1_pins) $pins(ckn_1_pins) ] {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION OFF -to $ck_1_pin -tag __$::GLOBAL_corename
	}
	`endif
	`endif
`endif
...
`ifdef IPTCL_PHY_CSR_ENABLED
	    set_instance_assignment -name GLOBAL_SIGNAL OFF -to "${inst}|rst_controller|alt_rst_sync_uq1|altera_reset_synchronizer_int_chain_out" -tag __$::GLOBAL_corename
	    set_instance_assignment -name GLOBAL_SIGNAL OFF -to "${inst}|if_csr_m0|rst_controller|alt_rst_sync_uq1|altera_reset_synchronizer_int_chain_out" -tag __$::GLOBAL_corename
`endif

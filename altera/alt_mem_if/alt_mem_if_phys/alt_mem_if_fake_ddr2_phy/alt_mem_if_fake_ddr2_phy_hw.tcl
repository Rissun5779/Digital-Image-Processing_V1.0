...
set_module_property DESCRIPTION "Fake DDR2 SDRAM External Memory PHY"
set_module_property NAME altera_mem_if_fake_ddr2_phy
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_phys_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Fake DDR2 SDRAM External Memory PHY"
...
proc generate_verilog_fileset {name tmpdir fileset {include_sim_vhdl_files 0}} {
	...
	set new_inhdl_dir "${qdir}/../ip/altera/alt_mem_if/alt_mem_if_phys/alt_mem_if_fake_ddr2_phy"
	...
	set toplevel_inhdl_files_list [list alt_mem_if_fake_ddr2_phy_top.sv]
	...
	alt_mem_if::util::iptclgen::sub_strings_params [file join $tmpdir [lindex $parsed_toplevel_file_list 0]] [file join $tmpdir $toplevel_file_name] \
		[list VARIANT_OUTPUT_NAME $variant_name SIM_FILESET $simulation_fileset "FAST_SIM_MODEL_DEFAULT" 0 TB_PROTOCOL "DDR2"]
...
proc generate_synth {name} {
	...
	foreach tcl_file [::alt_mem_if::gen::uniphy_gen::generate_fake_pin_assignments_file $name "DDR2" $constraints_dir $tmpdir] {

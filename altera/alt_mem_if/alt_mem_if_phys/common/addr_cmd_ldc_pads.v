...
output                              phy_mem_reset_n;
    ...
    `ifdef STRATIXV
    	`ifdef DUPLICATE_AC
output  [MEM_ADDRESS_WIDTH-1:0]     phy_mem_1_address;
output  [MEM_BANK_WIDTH-1:0]        phy_mem_1_bank;
output  [MEM_CHIP_SELECT_WIDTH-1:0] phy_mem_1_cs_n;
output  [MEM_CLK_EN_WIDTH-1:0]      phy_mem_1_cke;
    	`ifndef LPDDR1
output  [MEM_ODT_WIDTH-1:0]         phy_mem_1_odt;
    	`endif
output  [MEM_CONTROL_WIDTH-1:0]     phy_mem_1_we_n;
output  [MEM_CONTROL_WIDTH-1:0]     phy_mem_1_ras_n;
output  [MEM_CONTROL_WIDTH-1:0]     phy_mem_1_cas_n;
output                              phy_mem_1_reset_n;
output  [MEM_CK_WIDTH-1:0]          phy_mem_1_ck;
output  [MEM_CK_WIDTH-1:0]          phy_mem_1_ck_n;
    	`endif
    `endif
...
`ifdef STRATIXV
// *****************************************************************
// Instantiate CK_1/CK_1# generation circuitry if needed
genvar clock_1_width;
generate
    for (clock_1_width = 0; clock_1_width < MEM_CK_WIDTH; clock_1_width = clock_1_width + 1)
    begin: clock_1_gen
        wire [MEM_CK_WIDTH-1:0] mem_1_ck_ddio_out;	
        wire [3:0] delayed_clks_1;
        wire leveling_clk_1;
	...
	`ifdef ENABLE_LDC_MEM_CK_ADJUSTMENT
        stratixv_clk_phase_select # (
            ...
            .clkin  (delayed_clks_1),
            .clkout (leveling_clk_1),
            .phasectrlin(),
            .phaseinvertctrl(),
            .powerdown()
        );
	...
	`endif
        ...
        altddio_out # (
            ...
            .aset       (1'b0),
`ifdef ENABLE_LDC_MEM_CK_ADJUSTMENT
            .datain_h   (enable_mem_clk[clock_1_width]),  
            .datain_l   (1'b0),
`else
            .datain_h   (1'b0),  
            .datain_l   (enable_mem_clk[clock_1_width]),
`endif
            .dataout    (mem_1_ck_ddio_out[clock_1_width]),
            .oe         (1'b1),
            .outclock   (leveling_clk_1),
            .outclocken (1'b1),
            .sset       (),
            .sclr       (),
            .oe_out     ()
        ...
        clock_pair_generator uclk_1_generator (
            .datain     (mem_1_ck_ddio_out[clock_1_width]),            
            .dataout    (phy_mem_1_ck[clock_1_width]),
            .dataout_b  (phy_mem_1_ck_n[clock_1_width])            
        );
    end
endgenerate
`endif 

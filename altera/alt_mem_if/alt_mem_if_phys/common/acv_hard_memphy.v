...
`ifdef USE_NEG_EDGE_AC_TRANSFER_FOR_HPHY
...
`endif
			...
			.seq_fom_in(8'b0),
			.seq_fom_out(8'b0),
			.cal_init_failing_stage(8'b0),
			.cal_init_failing_group(8'b0)
		);
`endif
...
iss_probe #(
	...
	.probe_input(io_intaficalsuccess)
);

iss_probe #(
	.WIDTH(1)
) afi_cal_fail_probe (
	.probe_input(io_intaficalfail)
);

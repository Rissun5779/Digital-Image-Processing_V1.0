...
`ifdef STRATIXV
`ifdef DUPLICATE_AC
output  [MEM_ADDRESS_WIDTH-1:0] mem_1_a;
output  [MEM_BANK_WIDTH-1:0]    mem_1_ba;
output  [MEM_CK_WIDTH-1:0]	mem_1_ck;
output  [MEM_CK_WIDTH-1:0]	mem_1_ck_n;
output  [MEM_CLK_EN_WIDTH-1:0] mem_1_cke;
output  [MEM_CHIP_SELECT_WIDTH-1:0] mem_1_cs_n;
`ifndef LPDDR1
output  [MEM_ODT_WIDTH-1:0] mem_1_odt;
`endif
output  [MEM_CONTROL_WIDTH-1:0] mem_1_ras_n;
output  [MEM_CONTROL_WIDTH-1:0] mem_1_cas_n;
output  [MEM_CONTROL_WIDTH-1:0] mem_1_we_n;
...
`ifdef DUPLICATE_AC
		...
		.phy_mem_1_address    	(mem_1_a),
		.phy_mem_1_bank	    	(mem_1_ba),
		.phy_mem_1_cs_n	    	(mem_1_cs_n),
		.phy_mem_1_cke	    	(mem_1_cke),
`ifndef LPDDR1
		.phy_mem_1_odt	    	(mem_1_odt),
`endif
		.phy_mem_1_we_n	    	(mem_1_we_n),
		.phy_mem_1_ras_n	(mem_1_ras_n),
		.phy_mem_1_cas_n	(mem_1_cas_n),
		.phy_mem_1_reset_n	(mem_1_reset_n),
		.phy_mem_1_ck	    	(mem_1_ck),
		.phy_mem_1_ck_n	    	(mem_1_ck_n),

...
`ifndef LPDDR2
    ...
    `endif
`else
    assign phy_ddio_address_lh      = phy_ddio_address[2*MEM_ADDRESS_WIDTH-1:MEM_ADDRESS_WIDTH];
    assign phy_ddio_address_ll      = phy_ddio_address[MEM_ADDRESS_WIDTH-1:0];
`endif
...
`ifndef LPDDR2
    ...
    `endif
`else
    assign phy_ddio_address_hh      = phy_ddio_address[4*MEM_ADDRESS_WIDTH-1:3*MEM_ADDRESS_WIDTH];
    assign phy_ddio_address_hl      = phy_ddio_address[3*MEM_ADDRESS_WIDTH-1:2*MEM_ADDRESS_WIDTH];
`endif
...
//therefore, phy_ddio_*_h is mapped to datain_l and phy_ddio_*_l is mapped to datain_h for all the altddio_out in this file
    ...
    begin :address_gen
        ...
        `ifdef LPDDR2
            ...
            .datain_hi          ({phy_ddio_address_hl[i], phy_ddio_address_ll[i]}),
            .datain_lo          ({phy_ddio_address_hh[i], phy_ddio_address_lh[i]}),

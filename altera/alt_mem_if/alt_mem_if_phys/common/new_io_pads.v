...
`ifdef DUPLICATE_AC
		...
		.phy_mem_1_address		(phy_mem_1_address),
		.phy_mem_1_bank			(phy_mem_1_bank),
		.phy_mem_1_cs_n			(phy_mem_1_cs_n),
		.phy_mem_1_cke			(phy_mem_1_cke),
`ifndef LPDDR1
		.phy_mem_1_odt			(phy_mem_1_odt),
`endif
		.phy_mem_1_we_n			(phy_mem_1_we_n),
		.phy_mem_1_ras_n			(phy_mem_1_ras_n),
		.phy_mem_1_cas_n			(phy_mem_1_cas_n),
		.phy_mem_1_reset_n		(phy_mem_1_reset_n),
		.phy_mem_1_ck				(phy_mem_1_ck),
		.phy_mem_1_ck_n			(phy_mem_1_ck_n),

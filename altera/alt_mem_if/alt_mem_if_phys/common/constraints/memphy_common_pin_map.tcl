...
`endif
			if {[array size results_array] == 1} {
				...
				if {[array size pll_clk_results_array] == 1} {
					...
					memphy_traverse_fanin_up_to_depth $pll_inclk_id memphy_is_node_type_pin clock results_array 20
					if {[array size results_array] == 1} {
						set pin_id [lindex [array names results_array] 0]
						set result $pin_id
					} else {
...
proc memphy_get_acv_read_offset { period dqs_phase dqs_period } {

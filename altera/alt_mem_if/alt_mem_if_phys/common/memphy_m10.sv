...
`ifdef USE_DQS_TRACKING
wire    [MEM_READ_DQS_WIDTH-1:0]                read_capture_clk_hr_dqs;
wire    [MEM_READ_DQS_WIDTH-1:0]                ddio_phy_dqs_tracking;
`endif
...
//  ******************************************************************************************************************************** 
    ...
    write_datapath_m10    uwrite_datapath(
        .pll_afi_clk                   (pll_afi_clk),
...
//  ******************************************************************************************************************************** 
    ...
    read_datapath_m10    uread_datapath(
        ...
        .seq_read_latency_counter   (phy_read_latency_counter),
                `ifdef USE_DQS_TRACKING
        .read_capture_clk_hr_dqs    (read_capture_clk_hr_dqs),
        .ddio_phy_dqs_tracking      (ddio_phy_dqs_tracking),
...
`ifdef LPDDR2
        assign addr_cmd_clk = pll_write_clk_ddio;
        localparam INVERT_OUTPUT_CLOCK = "false";
`else
        assign addr_cmd_clk = pll_mem_clk_ddio;
        localparam INVERT_OUTPUT_CLOCK = "true";
`endif

    addr_cmd_pads_m10 uaddr_cmd_pads(
    ...
    begin: dq_ddio
        ...
        dqdqs_pads_m10 ubidir_dq_dqs (
            ...
            `ifdef USE_DQS_TRACKING
            .read_capture_clk_hr_dqs (read_capture_clk_hr_dqs[i]), // to read datapath
            .dqs_capture_clk        (pll_capture1_clk_ddio),
            .ddio_phy_dqs_tracking  (ddio_phy_dqs_tracking[i]),
            `endif

...
set_module_property DESCRIPTION "DDR3 SDRAM External Memory Hard PHY Core"
set_module_property NAME altera_mem_if_ddr3_hard_phy_core
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_phys_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "DDR3 SDRAM External Memory Hard PHY Core"
...
proc generate_verilog_fileset {name tmpdir fileset {include_sim_vhdl_files 0}} {
	...
	set new_inhdl_dir "${qdir}/../ip/altera/alt_mem_if/alt_mem_if_phys/alt_mem_if_ddr3_hard_phy_core"
	...
	set toplevel_inhdl_files_list [list altera_mem_if_ddr3_hard_phy_core_top.sv]
...
proc generate_synth {name} {
	...
	set qdir $::env(QUARTUS_ROOTDIR)
	set inhdl_dir "${qdir}/../ip/altera/alt_mem_if/alt_mem_if_phys/alt_mem_if_ddr3_hard_phy_core"
	set soft_inhdl_dir "${qdir}/../ip/altera/alt_mem_if/alt_mem_if_phys/alt_mem_if_ddr3_phy_core"

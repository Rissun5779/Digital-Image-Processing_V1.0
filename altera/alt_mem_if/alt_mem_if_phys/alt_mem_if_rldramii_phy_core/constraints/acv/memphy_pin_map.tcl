...
`ifdef IPTCL_USE_LDC_AS_LOW_SKEW_CLOCK
		...
		set patterns "${instname}|p0|umemphy|uio_pads|dq_ddio[$dq_ddio_index].ubidir_dq_dqs|altdq_dqs2_inst|dqs_select*|clkout"
		lappend dk_leveling_pins [ memphy_get_names_in_collection [ get_pins $patterns ] ]
`endif
...
`ifdef IPTCL_USE_LDC_AS_LOW_SKEW_CLOCK	
	set patterns [ list "${instname}|p0|umemphy|uio_pads|uaddr_cmd_pads|*|*cps|clkout" \
						"${instname}|p0|umemphy|uio_pads|uaddr_cmd_pads|*cps|clkout" ]

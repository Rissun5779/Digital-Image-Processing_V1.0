...
`ifdef IPTCL_HHP_HPS
	        set_instance_assignment -name D5_DELAY 4 -to $ck_pin -tag __$::GLOBAL_corename
`else
 		if {$is_av_soc_device} {
         if {$is_speedgrade_i3} {
            set_instance_assignment -name D5_DELAY 6 -to $ck_pin -tag __$::GLOBAL_corename
         } else {
            set_instance_assignment -name D5_DELAY 7 -to $ck_pin -tag __$::GLOBAL_corename
         }
      } else {
	      set_instance_assignment -name D5_DELAY 4 -to $ck_pin -tag __$::GLOBAL_corename
	   } 

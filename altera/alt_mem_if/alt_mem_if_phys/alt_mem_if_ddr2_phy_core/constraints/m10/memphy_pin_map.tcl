...
proc memphy_traverse_to_ddio_out_periphery_clock {pin msg_list_name} {
...
`else
                set dqs_string ${instname}|p0|umemphy|dq_ddio\[$i\].ubidir_dq_dqs|dqs_ddio_io|gpio_one_bit.i_loop\[0\].altgpio_bit_i|output_buf.obuf|o
		set dqs_local_pins [ memphy_get_names_in_collection [ get_fanouts $dqs_string ] ]

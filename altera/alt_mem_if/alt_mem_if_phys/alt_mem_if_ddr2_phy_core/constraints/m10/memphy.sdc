...
set ac_min_delay [ memphy_round_3dp [ expr - $t(ac_output_min_delay_external) - $t(ac_output_min_delay_internal)]]
...
set ac_max_delay [ memphy_round_3dp [ expr $t(ac_output_max_delay_external) + $t(ac_output_max_delay_internal)]]

...
`ifdef IPTCL_MAKE_FIFOS_IN_ALTDQDQS
	set pins(afi_ck_pins) ${instname}|p0|umemphy|uio_pads|afi_rdata_valid[0]
`else
...
`ifdef IPTCL_USE_2X_FF
		post_message -type critical_warning "dut_if0_p0_pin_map.tcl: Failed to find PLL clock for pins $pins(write_ck_ddioout)"
`else

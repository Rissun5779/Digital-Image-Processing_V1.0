...
`endif
	...
	set controller_rpath_m20k_rst_pins [get_pins -compatibility *if0|c0|ng0|alt_mem_ddrx_controller_top_inst|controller_inst|rdata_path_inst|gen_rdata_return_inorder.in_order_buffer_inst|altsyncram_component|auto_generated|ram_block*|clr0]
	set controller_wpath_m20k_rst_pins [get_pins -compatibility *if0|c0|ng0|alt_mem_ddrx_controller_top_inst|controller_inst|wdata_path_inst|wdata_buffer_per_dwidth_ratio[*].wdata_buffer_per_dqs_group[*].wdatap_buffer_data_inst|altsyncram_component|auto_generated|ram_block*|clr0]

...
module altera_mem_if_dll_rtl_calib_stratixv (
	clk,
...
output  [DLL_DELAY_CTRL_WIDTH-1:0]   dll_offsetctrlout;
input  [DLL_DELAY_CTRL_WIDTH-1:0]    dll_offset_ctrl_a_offset;
...
stratixv_dll_offset_ctrl   dll_ctr_a_wys
	(
		.clk(wire_dll_wys_m_offsetdelayctrlclkout),
		.offsetdelayctrlin(wire_dll_wys_m_offsetdelayctrlout),
		.offset(dll_offset_ctrl_a_offset),
		.addnsub(dll_offset_ctrl_a_addnsub),
		.aload(1'b0),
	...
	defparam dll_ctr_a_wys.use_pvt_compensation = "false";
	defparam dll_ctr_a_wys.lpm_type = "stratixv_dll_offset_ctrl";

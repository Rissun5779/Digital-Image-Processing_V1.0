...
module altera_mem_if_dll_hcx_compat_mode_stratixiv (
	clk,
...
assign dll_aload = ~dll_pll_locked; 
	...
	stratixiv_dll_offset_ctrl dll_ctr_a_wys( 
	...
	defparam dll_ctr_a_wys.lpm_type = "stratixiv_dll_offset_ctrl";

	stratixiv_dll_offset_ctrl dll_ctr_b_wys( 
		.addnsub(hc_dll_config_dll_offset_ctrl_addnsub),
		.clk(wire_dll_wys_m_offsetdelayctrlclkout),
		.aload(dll_aload),
		.offset(hc_dll_config_dll_offset_ctrl_offset),
	...
	defparam dll_ctr_b_wys.lpm_type = "stratixiv_dll_offset_ctrl";

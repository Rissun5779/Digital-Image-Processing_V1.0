...
`timescale 1 ps / 1 ps
module alt_ddrx_controller_wrapper (
    ctl_clk,
    ctl_reset_n,
    ctl_half_clk,
    ...
    parameter   MEM_IF_ROW_WIDTH               = 13;
    parameter   MEM_IF_COL_WIDTH               = 10;
    ...
    parameter   MEM_IF_CS_PER_DIMM             = 2;

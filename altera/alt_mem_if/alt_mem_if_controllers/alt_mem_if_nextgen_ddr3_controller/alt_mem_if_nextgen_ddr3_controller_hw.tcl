...
set_module_property DESCRIPTION "Altera DDR3 Nextgen Memory Controller"
set_module_property NAME altera_mem_if_nextgen_ddr3_controller
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_controller_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera DDR3 Nextgen Memory Controller"
...
proc ip_compose {} {
	...
	add_instance $CONTROLLER_CORE altera_mem_if_nextgen_ddr3_controller_core
	...
	if {[string compare -nocase [get_parameter_value CTL_ZQCAL_EN] "true"] == 0} {
		...
		set_interface_property user_zqcal export_of "${CONTROLLER_CORE}.user_zqcal"
		alt_mem_if::util::hwtcl_utils::rename_exported_interface_ports $CONTROLLER_CORE user_zqcal user_zqcal
	}
	...
	if {[::alt_mem_if::util::qini::cfg_is_on alt_mem_if_enable_refctrl] && 
		...
		set_interface_property refctrl export_of "${CONTROLLER_CORE}.refctrl" 
	}

...
set_module_property DESCRIPTION "Altera DDR2 Nextgen Memory Controller Core"
set_module_property NAME altera_mem_if_nextgen_ddr2_controller_core
...
set_module_property DISPLAY_NAME "Altera DDR2 Nextgen Memory Controller Core"
...
set_fileset_property sim_vhdl TOP_LEVEL alt_mem_if_nextgen_ddr2_controller_core

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL alt_mem_if_nextgen_ddr2_controller_core

add_fileset synth QUARTUS_SYNTH generate_synth
set_fileset_property synth TOP_LEVEL alt_mem_if_nextgen_ddr2_controller_core
...
proc generate_vhdl_sim {name} {
	...
	add_fileset_file [file join mentor alt_mem_if_nextgen_ddr2_controller_core.sv] SYSTEM_VERILOG_ENCRYPT PATH [file join mentor alt_mem_if_nextgen_ddr2_controller_core.sv] {MENTOR_SPECIFIC}
	add_fileset_file alt_mem_if_nextgen_ddr2_controller_core.sv SYSTEM_VERILOG PATH alt_mem_if_nextgen_ddr2_controller_core.sv $non_encryp_simulators
...
proc generate_verilog_sim {name} {
	...
	add_fileset_file alt_mem_if_nextgen_ddr2_controller_core.sv SYSTEM_VERILOG PATH alt_mem_if_nextgen_ddr2_controller_core.sv
...
proc generate_synth {name} {
	...
	foreach file_name [generate_verilog_fileset] {
		_dprint 1 "Preparing to add $file_name"
		add_fileset_file [file tail $file_name] [::alt_mem_if::util::hwtcl_utils::get_file_type $file_name 0] PATH [file join .. alt_mem_if_nextgen_ddr_controller_110 rtl $file_name]
	}
...
proc create_hdl_parameters {} {
	...
	_dprint 1 "Defining HDL parameters for DDR2 Nextgen controller"	
	...
	set_parameter_property MAX10_CFG HDL_PARAMETER true
}

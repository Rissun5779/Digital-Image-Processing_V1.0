...
(* altera_attribute = "-name IP_TOOL_NAME altera_mem_if_qdrii_controller; -name IP_TOOL_VERSION 18.1; -name FITTER_ADJUST_HC_SHORT_PATH_GUARDBAND 100" *)
module alt_qdr_controller_top_avl_use_be_dec_lat_fr_bl2_use_nws (
	afi_clk,
	afi_reset_n,
	avl_w_ready,
	avl_w_write_req,
...
alt_qdr_controller_avl_use_be_dec_lat_fr_bl2_use_nws # (

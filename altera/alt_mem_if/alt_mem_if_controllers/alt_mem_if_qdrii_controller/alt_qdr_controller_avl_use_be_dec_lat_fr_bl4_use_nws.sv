...
module alt_qdr_controller_avl_use_be_dec_lat_fr_bl4_use_nws (
	afi_clk,
	afi_reset_n,
	avl_w_ready,
	avl_w_write_req,
...
input	[AVL_BE_WIDTH-1:0]		avl_w_be;
...
wire	[AVL_BE_WIDTH-1:0]		data_if_be;
...
memctl_data_if_avl_use_be_ctl_bl_is_one_dec_lat_qdrii data_if_r (
	.clk					(afi_clk),
...
alt_qdr_fsm_fr_bl4 fsm_pop_req (
	.clk			(afi_clk),
...
alt_qdr_afi_avl_use_be_fr_bl4_use_nws afi (
	.clk				(afi_clk),
...
defparam afi.CTL_BE_WIDTH	= AVL_BE_WIDTH;

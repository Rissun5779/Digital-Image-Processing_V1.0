...
module alt_qdr_controller_dec_lat_fr_bl4 (
	afi_clk,
	afi_reset_n,
	avl_w_ready,
	avl_w_write_req,
...
memctl_data_if_ctl_bl_is_one_dec_lat_qdrii data_if_r (
	.clk					(afi_clk),
...
memctl_data_if_ctl_bl_is_one_dec_lat_qdrii data_if_w (
	.clk					(afi_clk),

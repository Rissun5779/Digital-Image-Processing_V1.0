...
# +-----------------------------------
# |
# | altera_mem_if_lpddr_hard_memory_controller "Altera LPDDR Hard Memory Controller" v1.0
# | Altera Corporation 2010.10.07.16:58:41
# | Altera LPDDR Hard Memory Controller
# |
# |
# +-----------------------------------
...
# +-----------------------------------
# |
set_module_property DESCRIPTION "Altera LPDDR Hard Memory Controller"
set_module_property NAME altera_mem_if_lpddr_hard_memory_controller
...
set_module_property DISPLAY_NAME "Altera LPDDR Hard Memory Controller"
...
proc create_hdl_parameters {} {
	...
	set_parameter_property ENUM_MEM_AUTO_PD_CYCLES HDL_PARAMETER true
...
proc ip_elaborate {} {
	...
	for {set port_id 0} {$port_id != [::alt_mem_if::gui::ddrx_controller::get_NUM_OF_PORTS]} {incr port_id} {
		...
		if {[string compare -nocase [get_parameter_value ENABLE_CTRL_AVALON_INTERFACE] "true"] == 0} {
			...
			set_interface_property avl_${port_id} associatedClock afi_clk
			set_interface_property avl_${port_id} associatedReset afi_reset
		...
		add_interface_port avl_${port_id} avl_addr_${port_id} address Input [get_parameter_value AVL_ADDR_WIDTH]

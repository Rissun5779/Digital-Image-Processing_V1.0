...
(* altera_attribute = "-name IP_TOOL_NAME altera_mem_if_ddr2_controller; -name IP_TOOL_VERSION 18.1; -name FITTER_ADJUST_HC_SHORT_PATH_GUARDBAND 100" *)
module alt_mem_if_ddr2_controller_top (
    afi_clk,
    afi_reset_n,
    afi_half_clk,

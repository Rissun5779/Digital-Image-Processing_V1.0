...
module alt_rld_controller_dec_lat_err_det_par_urfsh (
	afi_clk,
	afi_reset_n,
	avl_ready,
	avl_write_req,
...
memctl_data_if_dec_lat_rldramii data_if (
	.clk					(afi_clk),
...
// Main state machine
alt_rld_fsm_no_ifdef_params fsm (
	.clk					(afi_clk),
...
// User-controlled refresh signals
assign aref_req = ref_req;
assign aref_req_bank_addr = ref_ba;
assign ref_ack = do_aref;


// AFI 2.0 interface module
alt_rld_afi_no_ifdef_params afi (
	.clk				(afi_clk),

...
(* altera_attribute = "-name IP_TOOL_NAME altera_mem_if_rldram3_controller; -name IP_TOOL_VERSION 18.1; -name FITTER_ADJUST_HC_SHORT_PATH_GUARDBAND 100" *)
module alt_rld3_controller_top_ctl_bl_is_one_dec_lat_err_det_par_urfsh (
	afi_clk,
	afi_reset_n,
	avl_ready,
	avl_write_req,

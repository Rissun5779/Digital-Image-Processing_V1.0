...
set_module_property DESCRIPTION "Altera DDR3 Memory Controller"
set_module_property NAME altera_mem_if_ddr3_controller
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_controller_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera DDR3 Memory Controller"
...
set_fileset_property sim_vhdl TOP_LEVEL alt_mem_if_ddr3_controller_top

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL alt_mem_if_ddr3_controller_top

add_fileset synth QUARTUS_SYNTH generate_synth
set_fileset_property synth TOP_LEVEL alt_mem_if_ddr3_controller_top
...
proc generate_verilog_fileset {} {
	...
	set source_files_list [list \
		...
		alt_mem_if_ddr3_controller_top.sv \
	]
...
proc create_hdl_parameters {} {
	...
	_dprint 1 "Defining HDL parameters for DDR3 controller"	

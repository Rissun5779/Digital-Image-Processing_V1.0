...
# +-----------------------------------
# | 
# | alt_mem_if_nextgen_lpddr2_controller "Altera LPDDR2 Nextgen Memory Controller" v1.0
...
# +-----------------------------------
# | 
set_module_property DESCRIPTION "Altera LPDDR2 Nextgen Memory Controller Core"
set_module_property NAME altera_mem_if_nextgen_lpddr2_controller_core
set_module_property VERSION 18.1
set_module_property supported_device_families {{arria v} {cyclone v} {max10}}
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_controller_components_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera LPDDR2 Nextgen Memory Controller Core"
...
set_fileset_property sim_vhdl TOP_LEVEL alt_mem_if_nextgen_lpddr2_controller_core

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL alt_mem_if_nextgen_lpddr2_controller_core

add_fileset synth QUARTUS_SYNTH generate_synth
set_fileset_property synth TOP_LEVEL alt_mem_if_nextgen_lpddr2_controller_core
...
proc generate_vhdl_sim {name} {
	...
	# Add the toplevel
	add_fileset_file [file join mentor alt_mem_if_nextgen_lpddr2_controller_core.sv] SYSTEM_VERILOG_ENCRYPT PATH [file join mentor alt_mem_if_nextgen_lpddr2_controller_core.sv] {MENTOR_SPECIFIC}
	add_fileset_file alt_mem_if_nextgen_lpddr2_controller_core.sv SYSTEM_VERILOG PATH alt_mem_if_nextgen_lpddr2_controller_core.sv $non_encryp_simulators
...
proc generate_verilog_sim {name} {
	...
	# Add the toplevel
	add_fileset_file alt_mem_if_nextgen_lpddr2_controller_core.sv SYSTEM_VERILOG PATH alt_mem_if_nextgen_lpddr2_controller_core.sv
...
proc create_hdl_parameters {} {
	...
	_dprint 1 "Defining HDL parameters for LPDDR2 Nextgen controller"	
...
proc ip_elaborate {} {
	...
	# Add AFI interface
	::alt_mem_if::gen::uniphy_interfaces::afi "LPDDR2" "controller" "afi" 1 1 1

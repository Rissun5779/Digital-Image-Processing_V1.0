...
input rpsbar;
input [MEM_READ_DQS_WIDTH-1:0] c;
input [MEM_READ_DQS_WIDTH-1:0] cbar;
...
initial
    $qdr_ssram_access(a,d,wpsbar,bwsbar,k,kbar,den_q,rpsbar,c,cbar,den_cq,den_cqbar,doffbar);

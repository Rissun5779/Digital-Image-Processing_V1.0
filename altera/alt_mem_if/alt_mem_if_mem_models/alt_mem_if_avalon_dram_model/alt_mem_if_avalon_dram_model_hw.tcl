...
add_parameter USE_MEM_VERBOSE BOOLEAN true
set_parameter_property USE_MEM_VERBOSE DISPLAY_NAME "Enable Verbose Output"
set_parameter_property USE_MEM_VERBOSE HDL_PARAMETER true

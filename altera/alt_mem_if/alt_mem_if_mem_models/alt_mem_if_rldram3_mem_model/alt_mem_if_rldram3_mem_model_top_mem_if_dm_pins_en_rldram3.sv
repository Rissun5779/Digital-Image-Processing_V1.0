...
module alt_mem_if_rldram3_mem_model_top #(
	...
	MEM_DENALI_SOMA_FILE = "rldram3.soma",
...
begin : depth_gen
	...
	begin : width_gen
		...
		if (MEM_USE_DENALI_MODEL == 1)
			...
			begin : generic_model
				alt_mem_if_common_rldram_mem_model_mem_if_dm_pins_en_rldram3 mem (
					.mem_a		(mem_a),
					.mem_ba		(mem_ba),
					.mem_ck		(mem_ck),
					.mem_ck_n	(mem_ck_n),
				...
				defparam mem.MEM_IF_CS_WIDTH	= MEM_IF_CS_WIDTH;

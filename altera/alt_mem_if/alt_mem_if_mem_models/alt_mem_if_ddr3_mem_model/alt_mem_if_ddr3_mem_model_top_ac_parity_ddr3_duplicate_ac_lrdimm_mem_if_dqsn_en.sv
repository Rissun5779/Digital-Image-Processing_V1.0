...
module alt_mem_if_ddr3_mem_model_top_ac_parity_ddr3_duplicate_ac_lrdimm_mem_if_dqsn_en 
...
begin : depth_gen
	...
	begin : width_gen
			...
			alt_mem_if_common_ddr_mem_model_ac_parity_ddr3_duplicate_ac_lrdimm_mem_if_dqsn_en #(

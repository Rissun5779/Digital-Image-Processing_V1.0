...
proc create_hdl_parameters {} {
	...
	set_parameter_property MEM_IF_LRDIMM_RM HDL_PARAMETER true
	...
	set_parameter_property AP_MODE_EN HDL_PARAMETER true
...
proc ip_elaborate {} {
	...
	if {[string compare -nocase [get_parameter_value DUPLICATE_AC] "true"] == 0 && [string compare -nocase [get_parameter_value PARSE_FRIENDLY_DEVICE_FAMILY] "STRATIXV"] == 0} {
		if {[string compare -nocase [get_parameter_value ALTMEMPHY_COMPATIBLE_MODE] "true"] == 0} {
                	add_interface_port memory mem_1_a mem_1_addr Input [get_parameter_value MEM_IF_ADDR_WIDTH]
        	} else {
                	add_interface_port memory mem_1_a mem_1_a Input [get_parameter_value MEM_IF_ADDR_WIDTH]
        	}
		add_interface_port memory mem_1_ba mem_1_ba Input [get_parameter_value MEM_IF_BANKADDR_WIDTH]
		if {[string compare -nocase [get_parameter_value ALTMEMPHY_COMPATIBLE_MODE] "true"] == 0} {
			add_interface_port memory mem_1_ck mem_1_clk Bidir [get_parameter_value MEM_IF_CK_WIDTH]
			add_interface_port memory mem_1_ck_n mem_1_clk_n Bidir [get_parameter_value MEM_IF_CK_WIDTH]
		} else {
			add_interface_port memory mem_1_ck mem_1_ck Input [get_parameter_value MEM_IF_CK_WIDTH]
			add_interface_port memory mem_1_ck_n mem_1_ck_n Input [get_parameter_value MEM_IF_CK_WIDTH]
		}
		add_interface_port memory mem_1_cke mem_1_cke Input [get_parameter_value MEM_IF_CLK_EN_WIDTH]
		add_interface_port memory mem_1_cs_n mem_1_cs_n Input [get_parameter_value MEM_IF_CS_WIDTH]
		add_interface_port memory mem_1_ras_n mem_1_ras_n Input [get_parameter_value MEM_IF_CONTROL_WIDTH]
		add_interface_port memory mem_1_cas_n mem_1_cas_n Input [get_parameter_value MEM_IF_CONTROL_WIDTH]
		add_interface_port memory mem_1_we_n mem_1_we_n Input [get_parameter_value MEM_IF_CONTROL_WIDTH]
		add_interface_port memory mem_1_reset_n mem_1_reset_n Input 1
		add_interface_port memory mem_1_odt mem_1_odt Input [get_parameter_value MEM_IF_ODT_WIDTH]
	}

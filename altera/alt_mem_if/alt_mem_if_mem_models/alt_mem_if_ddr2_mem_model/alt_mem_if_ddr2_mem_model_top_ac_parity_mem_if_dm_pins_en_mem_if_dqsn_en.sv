...
module alt_mem_if_ddr2_mem_model_top_ac_parity_mem_if_dm_pins_en_mem_if_dqsn_en 
...
begin : depth_gen
	...
	begin : width_gen
					...
					alt_mem_if_common_ddr_mem_model_ac_parity_mem_if_dm_pins_en_mem_if_dqsn_en #(

...
set_module_property DESCRIPTION "Altera DDR2 Memory Model for UniPHY"
set_module_property NAME altera_mem_if_ddr2_mem_model
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_models_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera DDR2 Memory Model for UniPHY"
...
proc generate_vhdl_sim {name} {
	...
	set generated_file [alt_mem_if::util::iptclgen::generate_outfile_name "alt_mem_if_ddr2_mem_model_top.sv" [solve_core_params]]
...
proc create_hdl_parameters {} {
	...
	_dprint 1 "Defining HDL parameters for alt_mem_if_ddr2_mem_model"	
...
proc ip_elaborate {} {
	...
	foreach fset_name [list SIM_VERILOG SIM_VHDL QUARTUS_SYNTH] {
		set_fileset_property [string tolower $fset_name] TOP_LEVEL [alt_mem_if::util::iptclgen::generate_outfile_name "alt_mem_if_ddr2_mem_model_top.sv" [solve_core_params] 1]
	}

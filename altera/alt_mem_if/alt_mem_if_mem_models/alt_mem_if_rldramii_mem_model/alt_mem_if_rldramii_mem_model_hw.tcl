...
set_module_property DESCRIPTION "Altera RLDRAM II Memory Model for UniPHY"
set_module_property NAME altera_mem_if_rldramii_mem_model
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_models_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera RLDRAM II Memory Model for UniPHY"
...
set_fileset_property sim_vhdl TOP_LEVEL alt_mem_if_rldramii_mem_model_top

add_fileset sim_verilog SIM_VERILOG generate_verilog_sim
set_fileset_property sim_verilog TOP_LEVEL alt_mem_if_rldramii_mem_model_top

add_fileset synth QUARTUS_SYNTH generate_synth
set_fileset_property synth TOP_LEVEL alt_mem_if_rldramii_mem_model_top
...
proc generate_vhdl_sim {name} {
	...
	add_fileset_file [file join mentor alt_mem_if_rldramii_mem_model_top.sv] SYSTEM_VERILOG_ENCRYPT PATH [file join mentor alt_mem_if_rldramii_mem_model_top.sv] {MENTOR_SPECIFIC}
	add_fileset_file alt_mem_if_rldramii_mem_model_top.sv SYSTEM_VERILOG PATH alt_mem_if_rldramii_mem_model_top.sv $non_encryp_simulators
...
proc generate_verilog_sim {name} {
	...
	add_fileset_file alt_mem_if_rldramii_mem_model_top.sv SYSTEM_VERILOG PATH alt_mem_if_rldramii_mem_model_top.sv 
	...
	if {[string compare -nocase [get_parameter_value MEM_USE_DENALI_MODEL] "false"] == 0} {
		...
		add_fileset_file denali_rldramii_mem_model.sv SYSTEM_VERILOG PATH denali_rldramii_mem_model.sv 
	}
}
...
proc create_hdl_parameters {} {
	...
	_dprint 1 "Defining HDL parameters for alt_mem_if_rldramii_mem_model"	

...
module altera_mem_if_pp_mem_model_bridge_top_ac_parity_mem_if_dm_pins_en (
	mem_in_mem_a,
	mem_in_mem_ba,
	mem_in_mem_ck,
	mem_in_mem_ck_n,
...
input	[MEM_IF_DM_WIDTH - 1:0]				mem_in_mem_dm;
...
output	[MEM_IF_DM_WIDTH/2 - 1:0]			mem_lhs_mem_dm;
...
output	[MEM_IF_DM_WIDTH/2 - 1:0]			mem_rhs_mem_dm;
...
assign mem_lhs_mem_dm = mem_in_mem_dm [MEM_IF_DM_WIDTH/2 - 1 : 0];
...
assign mem_rhs_mem_dm = mem_in_mem_dm [MEM_IF_DM_WIDTH -1 : MEM_IF_DM_WIDTH/2];

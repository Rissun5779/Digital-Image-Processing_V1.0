...
module altera_ddr3_board_delay_model_top_ac_parity_mem_if_dm_pins_en_mem_if_dqsn_en 
...
input 					tomem_mem_ac_parity;
output 					tomem_mem_err_out_n;
input 					tomem_mem_parity_error_n;

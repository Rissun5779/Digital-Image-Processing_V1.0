...
set_module_property DESCRIPTION "Altera DDR3 Board Delay Model"
set_module_property NAME altera_ddr3_board_delay_model
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Board Delay Models"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Altera DDR3 Board Delay Model"
...
proc generate_verilog_sim {name} {
	...
	set generated_file [alt_mem_if::util::iptclgen::generate_outfile_name "altera_ddr3_board_delay_model_top.sv" [solve_core_params]]
...
proc create_hdl_parameters {} {
	...
	_dprint 1 "Defining HDL parameters for altera_ddr3_board_delay_model"	
...
proc ip_elaborate {} {
	...
	add_interface_port board_to_phy tophy_mem_ras_n mem_ras_n Input [get_parameter_value MEM_IF_CONTROL_WIDTH]
	add_interface_port board_to_phy tophy_mem_cas_n mem_cas_n Input [get_parameter_value MEM_IF_CONTROL_WIDTH]
	add_interface_port board_to_phy tophy_mem_we_n mem_we_n Input [get_parameter_value MEM_IF_CONTROL_WIDTH]
	...
	add_interface_port board_to_phy tophy_mem_odt mem_odt Input [get_parameter_value MEM_IF_ODT_WIDTH]
	...
	add_interface_port board_to_mem tomem_mem_ras_n mem_ras_n Output [get_parameter_value MEM_IF_CONTROL_WIDTH]
	add_interface_port board_to_mem tomem_mem_cas_n mem_cas_n Output [get_parameter_value MEM_IF_CONTROL_WIDTH]
	add_interface_port board_to_mem tomem_mem_we_n mem_we_n Output [get_parameter_value MEM_IF_CONTROL_WIDTH]
	...
	add_interface_port board_to_mem tomem_mem_odt mem_odt Output [get_parameter_value MEM_IF_ODT_WIDTH]
	...
	set_fileset_property [string tolower SIM_VERILOG] TOP_LEVEL \
	    [alt_mem_if::util::iptclgen::generate_outfile_name "altera_ddr3_board_delay_model_top.sv" [solve_core_params] 1]

...
proc ::alt_mem_if::gui::diagnostics::_create_diagnostics_parameters {} {
	...
	set_parameter_property ENABLE_EXPORT_SEQ_DEBUG_BRIDGE DISPLAY_NAME "Enable EMIF On-Chip Debug Port"
	...
	set_parameter_property CORE_DEBUG_CONNECTION DISPLAY_NAME "EMIF On-Chip Debug Port interface type"

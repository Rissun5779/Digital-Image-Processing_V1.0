...
proc ::alt_mem_if::gui::uniphy_phy::_derive_phy_parameters {} {
	...
	if {[::alt_mem_if::util::qini::cfg_is_on alt_mem_if_program_rdimm_control_word]} {
		set_parameter_value USE_USER_RDIMM_VALUE true
	}
...
proc ::alt_mem_if::gui::uniphy_phy::_create_phy_parameters {} {
	...
	set_parameter_property ENABLE_NON_DESTRUCTIVE_CALIB DISPLAY_HINT boolean
        ...
        ::alt_mem_if::util::hwtcl_utils::_add_parameter FIX_READ_LATENCY INTEGER 8
        set_parameter_property FIX_READ_LATENCY DISPLAY_NAME "Fixed Read Latency"
	set_parameter_property FIX_READ_LATENCY VISIBLE false
	
	::alt_mem_if::util::hwtcl_utils::_add_parameter USE_USER_RDIMM_VALUE Boolean false
	set_parameter_property USE_USER_RDIMM_VALUE VISIBLE false
	set_parameter_property USE_USER_RDIMM_VALUE DERIVED true

	::alt_mem_if::util::hwtcl_utils::_add_parameter ENABLE_DELAY_CHAIN_WRITE boolean false
	set_parameter_property ENABLE_DELAY_CHAIN_WRITE VISIBLE false
	...
	::alt_mem_if::util::hwtcl_utils::_add_parameter AC_ROM_USER_ADD_0 string "0_0000_0000_0000"
	set_parameter_property AC_ROM_USER_ADD_0 DISPLAY_NAME "Calibration Address 1"
	set_parameter_property AC_ROM_USER_ADD_0 DESCRIPTION "Lower 13 bits of scratch space 1 used during calibration.  Data at this address will be destroyed."


	::alt_mem_if::util::hwtcl_utils::_add_parameter AC_ROM_USER_ADD_1 string "0_0000_0000_1000"
	set_parameter_property AC_ROM_USER_ADD_1 DISPLAY_NAME "Calibration Address 2"
	set_parameter_property AC_ROM_USER_ADD_1 DESCRIPTION "Lower 13 bits of scratch space 2 used during calibration.  Data at this address will be destroyed."




	::alt_mem_if::util::hwtcl_utils::_add_parameter TREFI integer 35100
	set_parameter_property TREFI DISPLAY_NAME  "Trefi x 9"
	set_parameter_property TREFI DESCRIPTION  "The device specified Trefi x 9.  Used to detect if a refresh was missed."
	set_parameter_property TREFI Units Nanoseconds


	::alt_mem_if::util::hwtcl_utils::_add_parameter REFRESH_INTERVAL integer 15000
	set_parameter_property REFRESH_INTERVAL DISPLAY_NAME  "Refresh Interval"
	set_parameter_property REFRESH_INTERVAL DESCRIPTION  "The time between scheduled refreshes.  Increasing this value above the default can result in refreshes that miss the violate the required Refresh Interval"
	set_parameter_property REFRESH_INTERVAL Units Nanoseconds

	::alt_mem_if::util::hwtcl_utils::_add_parameter ENABLE_NON_DES_CAL_TEST boolean false
	set_parameter_property ENABLE_NON_DES_CAL_TEST VISIBLE false

	::alt_mem_if::util::hwtcl_utils::_add_parameter TRFC integer 350
	set_parameter_property TRFC DISPLAY_NAME  "Trfc"
	set_parameter_property TRFC Units Nanoseconds

	if {[::alt_mem_if::util::qini::cfg_is_on enable_non_des_cal]} {
		set_parameter_property AC_ROM_USER_ADD_0 VISIBLE true
		set_parameter_property AC_ROM_USER_ADD_1 VISIBLE true
		set_parameter_property TREFI VISIBLE true
		set_parameter_property REFRESH_INTERVAL VISIBLE true
		set_parameter_property TRFC VISIBLE true

		::alt_mem_if::util::hwtcl_utils::_add_parameter ENABLE_NON_DES_CAL boolean true
		set_parameter_property ENABLE_NON_DES_CAL DISPLAY_NAME  "Enable non-destructive memory init and refresh engine"
		set_parameter_property ENABLE_NON_DES_CAL VISIBLE true
		...
		::alt_mem_if::util::hwtcl_utils::_add_parameter ENABLE_NON_DES_CAL boolean false
...
proc ::alt_mem_if::gui::uniphy_phy::create_ifdef_parameters {ifdef_array} {
	...
	set ifdef_db_array(IFDEF_DUPLICATE_AC) false
...
proc ::alt_mem_if::gui::uniphy_phy::derive_ifdef_parameters {ifdef_array} {
	...
	if {[string compare -nocase [get_parameter_value DUPLICATE_AC] "true"] == 0} {
		set ifdef_DB_array(IFDEF_DUPLICATE_AC) true
	} else {
		set ifdef_DB_array(IFDEF_DUPLICATE_AC) false
	}
	...
	set ifdef_DB_array(IFDEF_ARRIAV) false
	set ifdef_DB_array(IFDEF_CYCLONEV) false
	set ifdef_DB_array(IFDEF_MAX10) false
	...
	if {[string compare -nocase [get_parameter_value PARSE_FRIENDLY_DEVICE_FAMILY] "ARRIAIIGX"] == 0} {
		...
		set ifdef_DB_array(IFDEF_MAX10) true
	}

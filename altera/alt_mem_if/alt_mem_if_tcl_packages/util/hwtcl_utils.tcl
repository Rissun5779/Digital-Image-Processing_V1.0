...
namespace eval ::alt_mem_if::util::hwtcl_utils:: {
	...
	variable COMPONENT_ROOT_FOLDER "Memory Interfaces and Controllers/Memory Interfaces with UniPHY"
	variable INTERNAL_COMPONENT_ROOT_FOLDER "$COMPONENT_ROOT_FOLDER/Internal Components"
	variable VERIFICATION_ROOT_FOLDER "Basic Functions/Simulation; Debug and Verification/Verification"
	variable INTERNAL_VERIFICATION_ROOT_FOLDER "$VERIFICATION_ROOT_FOLDER/Internal Components"
...
proc ::alt_mem_if::util::hwtcl_utils::memory_models_group_name {} {
	...
	return "${INTERNAL_COMPONENT_ROOT_FOLDER}/Memory Models"
}

proc ::alt_mem_if::util::hwtcl_utils::memory_perf_monitors_group_name {} {
	variable VERIFICATION_ROOT_FOLDER
	variable INTERNAL_VERIFICATION_ROOT_FOLDER
	
	return "${VERIFICATION_ROOT_FOLDER}"
}
...
proc ::alt_mem_if::util::hwtcl_utils::memory_perf_monitor_components_group_name {} {
	...
	return "${INTERNAL_VERIFICATION_ROOT_FOLDER}/Performance Monitor Components"
}
...
proc ::alt_mem_if::util::hwtcl_utils::memory_pattern_gen_components_group_name {} {
	...
	return "${INTERNAL_VERIFICATION_ROOT_FOLDER}/Pattern Generator Components"
}

...
set_module_property DESCRIPTION "DDR3 SDRAM Controller with UniPHY Intel FPGA IP"
set_module_property NAME altera_mem_if_ddr3_emif
set_module_property VERSION 18.1
set_module_property SUPPORTED_DEVICE_FAMILIES {"STRATIX V" "STRATIX IV" "STRATIX III" "ARRIA II GZ" "ARRIA V" "ARRIA V GZ" "CYCLONE V" "MAX10"}
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "[::alt_mem_if::util::hwtcl_utils::mem_ifs_group_name]"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "DDR3 SDRAM Controller with UniPHY Intel FPGA IP"
...
proc ip_compose {} {
	...
	if {[string compare -nocase [get_parameter_value MEM_FORMAT] "REGISTERED"] == 0 ||
		...
		foreach param_name [get_instance_parameters $AFI_GASKET] {
            ...
            _dprint 1 "LRDIMM: AFI_Gasket setting parameter $param_name to [get_parameter_value $param_name]"
			}
		}
                   ...
                   if {[string compare -nocase [get_parameter_value PARSE_FRIENDLY_DEVICE_FAMILY] "CYCLONEV"] == 0} {
                       ...
                       for {set fifo_id 0} {$fifo_id < 4} {incr fifo_id} {
                         ...
                         if {[string compare -nocase [get_parameter_value ADD_EFFICIENCY_MONITOR] "true"] == 0} {
							      ...
							      ::alt_mem_if::gen::uniphy_gen::instantiate_efficiency_monitor "DDR3" $CONTROLLER "avl_${port_id}" "avl_${port_id}" "mp_cmd_clk_${port_id}.out_clk" "mp_cmd_reset_n_${port_id}.out_reset" 1

...
set_module_property DESCRIPTION "LPDDR2 SDRAM External Memory PLL/DLL/OCT block"
set_module_property NAME altera_mem_if_lpddr2_pll
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_phys_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "LPDDR2 SDRAM External Memory PLL/DLL/OCT block"
...
proc generate_verilog_fileset {name tmpdir fileset {include_sim_vhdl_files 0}} {
	...
	if {[string compare -nocase $device_family "STRATIXV"] == 0 || [string compare -nocase $device_family "ARRIAVGZ"] == 0} {
		...
		set new_inhdl_dir [file join $new_inhdl_dir m10]
	} else {
...
proc ip_elaborate {} {
	...
	::alt_mem_if::gen::uniphy_interfaces::pll_manager_reconfig "pll"

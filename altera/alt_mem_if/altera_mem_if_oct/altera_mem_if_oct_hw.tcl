...
set_module_property DESCRIPTION "External Memory OCT block"
set_module_property NAME altera_mem_if_oct
set_module_property VERSION 18.1
::alt_mem_if::util::hwtcl_utils::set_module_internal_mode
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP [::alt_mem_if::util::hwtcl_utils::memory_phys_group_name]
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "External Memory OCT block"
...
proc generate_vhdl_sim {name} {
	...
	set generated_file [alt_mem_if::util::iptclgen::generate_outfile_name "altera_mem_if_oct.sv" [solve_core_params]]
...
proc create_hdl_parameters {} {
	...
	set_parameter_property OCT_TERM_CONTROL_WIDTH HDL_PARAMETER true
}
...
proc ip_elaborate {} {
	...
	::alt_mem_if::gen::uniphy_interfaces::oct
	::alt_mem_if::gen::uniphy_interfaces::oct_sharing "source"


	foreach fset_name [list SIM_VERILOG SIM_VHDL QUARTUS_SYNTH] {
		set_fileset_property [string tolower $fset_name] TOP_LEVEL [alt_mem_if::util::iptclgen::generate_outfile_name "altera_mem_if_oct.sv" [solve_core_params] 1]
	}

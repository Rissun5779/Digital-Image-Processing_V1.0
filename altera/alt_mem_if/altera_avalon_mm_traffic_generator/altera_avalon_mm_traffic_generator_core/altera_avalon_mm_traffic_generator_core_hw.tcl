...
set_module_property DESCRIPTION "Traffic Generator and BIST Engine Core"
set_module_property NAME altera_avalon_mm_traffic_generator_core
...
set_module_property DISPLAY_NAME "Traffic Generator and BIST Engine Core"
...
proc generate_verilog_fileset {name tmpdir} {
	...
	set inhdl_dir "${qdir}/../ip/altera/altera_avalon_mm_traffic_generator/altera_avalon_mm_traffic_generator_core"

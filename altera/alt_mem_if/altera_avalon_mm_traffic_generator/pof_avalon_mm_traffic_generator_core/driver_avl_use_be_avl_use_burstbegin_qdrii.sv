...
module driver_avl_use_be_avl_use_burstbegin_qdrii (
	clk,
	reset_n,
	avl_ready,
	avl_ready_w,
...
driver_fsm_avl_use_be_avl_use_burstbegin_qdrii driver_fsm_inst (
...
avalon_traffic_gen_avl_use_be_avl_use_burstbegin_qdrii avalon_traffic_gen_inst (
...
// Read compare module
//AVL_USE_BE,AVL_USE_BURSTBEGIN,QDRII
read_compare_avl_use_be_avl_use_burstbegin_qdrii read_compare_inst (

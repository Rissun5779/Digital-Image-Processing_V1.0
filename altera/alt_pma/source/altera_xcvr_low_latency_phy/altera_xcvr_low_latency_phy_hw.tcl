...
# | $Header: //acds/rel/18.1std/ip/alt_pma/source/altera_xcvr_low_latency_phy/altera_xcvr_low_latency_phy_hw.tcl#1 $
# | 
# +-----------------------------------
...
set_module_property DISPLAY_NAME "Low Latency PHY Intel FPGA IP"
...
add_display_item "Analog Options" analog_message_text1 TEXT "Transceiver analog options may be set using the Quartus Prime Assignment Editor, Pin Planner, or QSF assignments."

...
if { [lsearch $auto_path $env(QUARTUS_ROOTDIR)/../ip/altera/alt_xcvr/altera_xcvr_native_phy/altera_xcvr_native_vi ] == -1 } {
    lappend auto_path $env(QUARTUS_ROOTDIR)/../ip/altera/alt_xcvr/altera_xcvr_native_phy/altera_xcvr_native_vi
}
if { [lsearch $auto_path $env(QUARTUS_ROOTDIR)/../ip/altera/alt_xcvr/alt_xcvr_core/nf ] == -1 } {
    lappend auto_path $env(QUARTUS_ROOTDIR)/../ip/altera/alt_xcvr/alt_xcvr_core/nf
}
if { [lsearch $auto_path $env(QUARTUS_ROOTDIR)/../ip/altera/altera_xcvr_pll/altera_xcvr_cdr_pll_vi ] == -1 } {
...
proc custom_decl_fileset_groups { phy_root reconfig_root } {
  ...
  common_fileset_group_plain ./ "$phy_root/../primitives/altera_std_synchronizer/" {
  ...
  # A10 specific files
  #::altera_xcvr_native_vi::fileset::declare_files
...
#  set pll_type        [get_parameter_value xaui_pll_type]
  ...
  if { [has_s4_style_hssi $device_family] } {
    if {($if_type == "Soft XAUI")} {
      common_add_fileset_files {SOFT S4 S4_1 S4_SOFT ALL_HDL ALL_HDL_1 ALL_HDL_2} $tool
    } elseif {($if_type == "DDR XAUI")} {
      common_add_fileset_files {DXAUI ALL_HDL S4 ALL_HDL_2} $tool
        if {($pll_type == "CMU")} {
      ...
      common_add_fileset_files {S4_HARD S4 S4_1 ALL_HDL ALL_HDL_1 ALL_HDL_2} $tool
    }
    ...
    common_add_fileset_files {SOFT C5 ALL_HDL ALL_HDL_1 ALTERA_XCVR_RESET_CONTROL} $tool
          ...
          # Cyclone IV GX
    common_add_fileset_files {C4 ALL_HDL ALL_HDL_1 ALL_HDL_2} $tool
  } elseif { $device_family == "Arria 10" } {
    #common_add_fileset_files {SOFT A10 ALL_HDL ALL_HDL_1 ALTERA_XCVR_RESET_CONTROL ALTERA_XCVR_NATIVE_NF} $tool
    common_add_fileset_files {SOFT A10 ALL_HDL ALL_HDL_1 ALTERA_XCVR_RESET_CONTROL} $tool
    #TBD
  }  else {
          # Unknown family
...
proc common_add_parameters_for_native_phy {} {
 ...
 # adding SyncE option- expose CDR clock
  ...
  set_parameter_property en_synce_support DESCRIPTION \
    "Exposes separate reference clock for CDR PLL and TX PLL."
...
Arria II GX and Stratix IV GX devices."
  ...
  add_param_int dyn_reconf 0 {0:1} "Advanced Options"
  set_parameter_property dyn_reconf DESCRIPTION \
    "Enable dynamic reconfiguration"
  set_parameter_property dyn_reconf DISPLAY_NAME \
    "Enable dynamic reconfiguration"
  set_parameter_property dyn_reconf DISPLAY_HINT "Boolean"
  set_parameter_property dyn_reconf VISIBLE false
  set_parameter_property dyn_reconf HDL_PARAMETER false
...
"Invert the second post-tap polarity setting"
  ...
  # Only for AV
  add_param_int pll_external_enable 0 {0:1} "General Options"
  set_parameter_property pll_external_enable VISIBLE false
  set_parameter_property pll_external_enable HDL_PARAMETER true
  set_parameter_property pll_external_enable ENABLED false

  # Only for A10
  add_param_int en_dual_fifo 0 {0:1} "Advanced Options"
  set_parameter_property en_dual_fifo DESCRIPTION \
    "Enable phase compensation FIFO"
  set_parameter_property en_dual_fifo DISPLAY_NAME \
    "Enable phase compensation FIFO"
  set_parameter_property en_dual_fifo DISPLAY_HINT "Boolean"
  set_parameter_property en_dual_fifo VISIBLE false

  # Only for SV
  add_param_int enable_rx_coreclkin 0 {0:1} "Advanced Options"
  set_parameter_property enable_rx_coreclkin DESCRIPTION \
    "Enable rx_coreclkin port"
  set_parameter_property enable_rx_coreclkin DISPLAY_NAME \
    "Enable rx_coreclkin port"
  set_parameter_property enable_rx_coreclkin DISPLAY_HINT "Boolean"
  set_parameter_property enable_rx_coreclkin VISIBLE false
  set_parameter_property enable_rx_coreclkin HDL_PARAMETER true
  set_parameter_property enable_rx_coreclkin ENABLED false

  # For TQ2
  add_param_int disable_embedded_sdc 1 {0:1} "Advanced Options"
  set_parameter_property disable_embedded_sdc DISPLAY_HINT "Boolean"
  set_parameter_property disable_embedded_sdc VISIBLE false
 
  # Only for A10 Reconfig & ADME
  add_display_item "Advanced Options" "Optional Reconfiguration Logic" Group

  add_param_int xcvr_rcfg_jtag_enable 0 {0:1} "Optional Reconfiguration Logic"
  set_parameter_property xcvr_rcfg_jtag_enable DESCRIPTION "Enable Altera Debug Master Endpoint"
  ...
  set_parameter_property xcvr_rcfg_jtag_enable VISIBLE false
  ...
  add_param_int xcvr_set_capability_reg_enable 0 {0:1} "Optional Reconfiguration Logic"
  set_parameter_property xcvr_set_capability_reg_enable DESCRIPTION "Enable capability registers"
  ...
  set_parameter_property xcvr_set_capability_reg_enable VISIBLE false
  ...
  add_param_int xcvr_set_user_identifier 0 {0:255} "Optional Reconfiguration Logic"
  set_parameter_property xcvr_set_user_identifier DESCRIPTION "Set user-defined IP identifier"
  ...
  add_param_int xcvr_set_csr_soft_logic_enable 0 {0:1} "Optional Reconfiguration Logic"
  set_parameter_property xcvr_set_csr_soft_logic_enable DESCRIPTION "Enable debug control and status registers"
  set_parameter_property xcvr_set_csr_soft_logic_enable DISPLAY_NAME "Enable debug control and status registers"
  set_parameter_property xcvr_set_csr_soft_logic_enable DISPLAY_HINT "Boolean"
  set_parameter_property xcvr_set_csr_soft_logic_enable VISIBLE false
  ...
  add_param_int xcvr_set_prbs_soft_logic_enable 0 {0:1} "Optional Reconfiguration Logic"
  set_parameter_property xcvr_set_prbs_soft_logic_enable DESCRIPTION "Enable PRBS soft accumulators"
  ...
  set_parameter_property xcvr_set_prbs_soft_logic_enable VISIBLE false
...
#    send_message info "Only Soft XAUI is supported for Stratix V and Arria V GZ"
    ...
    set_parameter_property enable_rx_coreclkin ENABLED true
...
#    send_message info "Only Soft XAUI is supported for Cyclone V"
    ...
    # General Tab: Interface type is visible 
    #    send_message info "Only Soft XAUI is supported for Arria 10"
    set_parameter_property interface_type ALLOWED_RANGES {"Soft XAUI"}
    ...
    # base data rate .. derived from data rate
	set_parameter_property GUI_BASE_DATA_RATE VISIBLE false
    set_parameter_value data_rate "3125 Mbps"
    #::altera_xcvr_native_vi::parameters::validate_set_data_rate $dr $dev_family "fastest" "duplex"]
	set_parameter_value BASE_DATA_RATE [get_parameter_value data_rate]
    ...
    # Advanced Tab: All parameters are visible 
    set_parameter_property external_pma_ctrl_reconf VISIBLE false
    set_parameter_property dyn_reconf VISIBLE true
    set_parameter_property en_dual_fifo VISIBLE true
...
proc common_clock_interfaces { } {
  ...
  if { $rcvr_out } {
    if { $device_family == "Arria 10" } {
        common_add_optional_conduit rx_recovered_clk output 4 true
    } else {
...
proc common_xaui_interface_ports {shared} {
  ...
  if { $device_family == "Arria 10" } {
    common_add_optional_conduit xgmii_rx_dc output 72 true
    common_add_optional_conduit xgmii_tx_dc input  72 true
  } else {
...
proc add_xgmii_rx_inclk_port {} {
  common_add_clock  xgmii_rx_inclk  input 1
}	

proc terminate_xgmii_rx_inclk_port {} {
  my_terminate_port xgmii_rx_inclk     0 input   1
}	
...
proc terminate_reconfig_ports { } {
    ...
    if { $dev_family == "Arria 10" } {
        my_terminate_port reconfig_from_xcvr 0 output 2
        my_terminate_port reconfig_to_xcvr 0 input 2
    } else {
...
proc add_tx_bonding_clk_port {} {
    common_add_optional_conduit tx_bonding_clocks input 6 true
    common_add_optional_conduit pll_powerdown_o output 1 true
    common_add_optional_conduit pll_cal_busy_i input 1 true
}

proc terminate_tx_bonding_clk_port {} {
    my_terminate_port tx_bonding_clocks 0 input 6
    my_terminate_port pll_powerdown_o 0 output 1
    my_terminate_port pll_cal_busy_i 0 input 1
}

proc add_ext_pll_clk_port {} {
    common_add_optional_conduit ext_pll_clk input 4 true
}

proc terminate_ext_pll_clk_port {} {
    my_terminate_port ext_pll_clk 0 input 4
}

proc add_rx_coreclkin_port {} {
    common_add_optional_conduit rx_coreclkin input 1 true
}

proc terminate_rx_coreclkin_port {} {
    my_terminate_port rx_coreclkin 0 input 1
}

proc add_pll_ports { } {
    common_add_optional_conduit pll_locked_i input 1 true
}

proc terminate_pll_ports { } {
    my_terminate_port pll_locked_i 0 input 1
}

proc add_dyn_reconfig_ports { } {
  # +-----------------------------------
  # | connection point reconfig
  # | 
  common_add_clock  reconfig_clk  input 1
  add_interface_port reconfig_clk reconfig_reset reset Input 1

  # +-----------------------------------
  # | connection point reconfig
  # | 
  add_interface reconfig avalon end
  set_interface_property reconfig addressAlignment DYNAMIC
  set_interface_property reconfig burstOnBurstBoundariesOnly false
  set_interface_property reconfig explicitAddressSpan 0
  set_interface_property reconfig holdTime 0
  set_interface_property reconfig isMemoryDevice false
  set_interface_property reconfig isNonVolatileStorage false
  set_interface_property reconfig linewrapBursts false
  set_interface_property reconfig maximumPendingReadTransactions 0
  set_interface_property reconfig printableDevice false
  set_interface_property reconfig readLatency 0
  set_interface_property reconfig readWaitStates 0
  set_interface_property reconfig readWaitTime 0
  set_interface_property reconfig setupTime 0
  set_interface_property reconfig timingUnits Cycles
  set_interface_property reconfig writeWaitTime 0
  set_interface_property reconfig ASSOCIATED_CLOCK reconfig_clk
  set_interface_property reconfig ENABLED true
    
  add_interface_port reconfig reconfig_address address Input 12
  add_interface_port reconfig reconfig_read read Input 1
  add_interface_port reconfig reconfig_readdata readdata Output 32
  add_interface_port reconfig reconfig_write write Input 1
  add_interface_port reconfig reconfig_writedata writedata Input 32
  add_interface_port reconfig reconfig_waitrequest waitrequest Output 1
   
}

proc terminate_dyn_reconfig_ports { } {
    my_terminate_port reconfig_clk 0 input 1
    my_terminate_port reconfig_reset 0 input 1
    my_terminate_port reconfig_address 0 input 12
    my_terminate_port reconfig_read 0 input 1
    my_terminate_port reconfig_write 0 input 1
    my_terminate_port reconfig_writedata 0 input 32
    my_terminate_port reconfig_readdata 0 output 32
    my_terminate_port reconfig_waitrequest 0 output 1
}

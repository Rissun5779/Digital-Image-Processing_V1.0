...
module av_xcvr_low_latency_phy_nr #(
  ...
  parameter ser_words               = 2,          // legal values: 1,2,4
  parameter data_rate               = "3125 Mbps",
  parameter base_data_rate          = "3125 Mbps",   // (PLL Rate) - must be (data_rate * 1,2,4,or8)
  ...
  input   wire  [lanes-1:0]           tx_coreclk,
  input   wire  [lanes-1:0]           rx_coreclk,
  ...
  //optional ports
  input   wire  [lanes*5-1:0]         tx_bitslip,
  ...
  av_xcvr_custom_native #(
    ...
    .rx_enabyteord              (/*unused*/                     ),
    .rx_bitslip                 (rx_bitslip                     ),
    //MM ports
    .tx_forceelecidle           (/*unused*/                     ),
    .tx_invpolarity             (/*unused*/                     ),
    .tx_bitslipboundaryselect   (tx_bitslip                     ),
    .rx_invpolarity             (/*unused*/             		),
    .rx_seriallpbken            (csr_phy_loopback_serial        ),
    .rx_set_locktodata          (csr_rx_set_locktodata          ),
    .rx_set_locktoref           (csr_rx_set_locktoref           ),
    .rx_enapatternalign         (/*unused*/				        ),
    .rx_bitreversalenable       (/*unused*/				        ),
    .rx_bytereversalenable      (/*unused*/				        ),
    .rx_a1a2size                (/*unused*/				        ),
    .rx_rlv                     (/*unused*/				        ),
    ...
    assign pll_locked = pll_external_enable? pll_locked_i : phy_pll_locked;
  ...
  // Note: This block is being replaced by the hxaui_csr
  /* 
  alt_xcvr_csr_pcs8g #(
    .lanes  (lanes    ),
    .words  (ser_words)
 ...
 */ 
  ...
  assign mgmt_readdata = mgmt_readdata_common;

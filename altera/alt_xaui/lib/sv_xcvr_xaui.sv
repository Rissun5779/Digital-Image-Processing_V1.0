...
module sv_xcvr_xaui #(
  ...
  parameter enable_rx_coreclkin          = 0
) (
  ...
  generate
    if (interface_type == "Soft XAUI") begin
      sxaui #(
        ...
        .enable_rx_coreclkin (enable_rx_coreclkin)
      ) sxaui_0 (
        ...
        .tx_out_clk         (enable_rx_coreclkin? {4{rx_coreclkin}} : alt_pma_0_tx_out_clk_clk),          // tx_out_clk.clk

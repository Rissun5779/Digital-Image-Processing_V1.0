...
module altera_emif_avl_tg_2_tb();
   ...
   `define TG_BFM(INDEX) altera_emif_avl_tg_2_tb.ed_sim_inst.tg_cfg_bfm``INDEX
...
\
   ...
   initial begin
      ...
      for (i = 0; i < num_data_generators; i = i + 1) begin
         ...
         tg_send_cfg_write_0(TG_DATA_MODE + i, 32'h1);   // Select the data generation mode (0 -> pseudo random data generation using the initial value as a seed, 1 -> static, uses initial value as data)
      end

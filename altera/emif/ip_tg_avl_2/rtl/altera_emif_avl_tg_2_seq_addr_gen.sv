...
module altera_emif_avl_tg_2_seq_addr_gen # (
   ...
   assign word_addr_divisible_by = (ADDR_WIDTH > 32) ? {(ADDR_WIDTH){1'b0}} | AMM_WORD_ADDRESS_DIVISIBLE_BY[MAX_PARAM_WIDTH-1:0] : AMM_WORD_ADDRESS_DIVISIBLE_BY[ADDR_WIDTH-1:0];

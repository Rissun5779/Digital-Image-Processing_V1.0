...
package require altera_emif::ip_ecc::ip_core_nf::main
...
set_module_property NAME altera_emif_ecc_nf
...
set_module_property ELABORATION_CALLBACK ::altera_emif::ip_ecc::ip_core_nf::main::elaboration_callback

add_fileset sim_vhdl SIM_VHDL ::altera_emif::ip_ecc::ip_core_nf::main::sim_vhdl_fileset_callback
set_fileset_property sim_vhdl TOP_LEVEL altera_emif_ecc_core

add_fileset sim_verilog SIM_VERILOG ::altera_emif::ip_ecc::ip_core_nf::main::sim_verilog_fileset_callback
set_fileset_property sim_verilog TOP_LEVEL altera_emif_ecc_core

add_fileset quartus_synth QUARTUS_SYNTH ::altera_emif::ip_ecc::ip_core_nf::main::quartus_synth_fileset_callback
set_fileset_property quartus_synth TOP_LEVEL altera_emif_ecc_core

::altera_emif::ip_ecc::ip_core_nf::main::create_parameters

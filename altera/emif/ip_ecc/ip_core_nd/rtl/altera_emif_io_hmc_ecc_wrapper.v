...
reg                                                    internal_master_wr_data_ready;
reg  [CFG_ECC_BE_WIDTH                        - 1 : 0] internal_master_wr_data_byte_enable;
...
reg  [CFG_LOCAL_DATA_PTR_WIDTH                - 1 : 0] internal_master_wr_data_ptr_in;
...
begin
    ...
    begin
        ...
        internal_master_cmd_data  <= {CFG_CMD_DATA_WIDTH{1'b0}};
        internal_master_cmd_valid <= 1'b0;
        internal_master_cmd_info  <= {CFG_CMD_INFO_WIDTH{1'b0}};
    end
    else
    begin
        internal_master_cmd_ready <= master_cmd_ready;
        internal_master_cmd_data  <= int_master_cmd_data;
        internal_master_cmd_valid <= int_master_cmd_valid & int_master_cmd_ready;
...
assign master_cmd_valid     = (CFG_REGISTER_CMD_PATH == 1) ? internal_master_cmd_valid : (int_master_cmd_valid & int_master_cmd_ready);

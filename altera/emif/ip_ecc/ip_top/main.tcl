...
package provide altera_emif::ip_ecc::ip_top::main 0.1
...
namespace eval ::altera_emif::ip_ecc::ip_top::main:: {
...
proc ::altera_emif::ip_ecc::ip_top::main::composition_callback {} {
...
proc ::altera_emif::ip_ecc::ip_top::main::_validate {} {
...
proc ::altera_emif::ip_ecc::ip_top::main::_compose {} {

   set family_enum [::altera_emif::util::device_family::get_device_family_enum]

   if {$family_enum == "" || $family_enum == "FAMILY_INVALID"} {
      emif_ie "No device family info available"
   }

   set core_name "core"
   
   add_instance $core_name [enum_data $family_enum ECC_COMPONENT]
...
proc ::altera_emif::ip_ecc::ip_top::main::_init {} {
}

::altera_emif::ip_ecc::ip_top::main::_init

...
package require altera_emif::ip_tg_avl::main
...
set_module_property NAME altera_emif_tg_avl
...
set_module_property ELABORATION_CALLBACK ::altera_emif::ip_tg_avl::main::elaboration_callback

add_fileset sim_vhdl SIM_VHDL ::altera_emif::ip_tg_avl::main::sim_vhdl_fileset_callback
set_fileset_property sim_vhdl TOP_LEVEL altera_emif_avl_tg_top

add_fileset sim_verilog SIM_VERILOG ::altera_emif::ip_tg_avl::main::sim_verilog_fileset_callback
set_fileset_property sim_verilog TOP_LEVEL altera_emif_avl_tg_top

add_fileset quartus_synth QUARTUS_SYNTH ::altera_emif::ip_tg_avl::main::quartus_synth_fileset_callback
set_fileset_property quartus_synth TOP_LEVEL altera_emif_avl_tg_top

::altera_emif::ip_tg_avl::main::create_parameters

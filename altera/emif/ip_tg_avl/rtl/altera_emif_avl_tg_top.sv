...
`endif
   ...
   assign reset_n_int = emif_usr_reset_n & issp_reset_n;
   assign reset_n_int_sec = emif_usr_reset_n_sec & issp_reset_n;
            ...
            if (i < NUM_OF_CTRL_PORTS) begin
               if (USE_SIMPLE_TG) begin : simple
                  altera_emif_avl_tg_driver_simple # (
                     ...
                     .reset_n                                ((PHY_PING_PONG_EN && (i == 1)) ? reset_n_int_sec : reset_n_int),

...
package provide altera_emif::ip_cal_slave::ip_core_nd::main 0.1
...
namespace eval ::altera_emif::ip_cal_slave::ip_core_nd::main:: {
...
proc ::altera_emif::ip_cal_slave::ip_core_nd::main::create_parameters {} {
...
proc ::altera_emif::ip_cal_slave::ip_core_nd::main::composition_callback {} {
   ...
   set iossm_master_clk_source "${clk_bridge}.out_clk"
   set iossm_master_rst_source "${rst_bridge}.out_reset"

   set AVL_BRIDGE "iossm_master_bridge"
   ...
   add_connection "$iossm_master_clk_source/${AVL_BRIDGE}.clk"
   add_connection "$iossm_master_rst_source/${AVL_BRIDGE}.reset"
   ...
   if {$jtag_uart_en} {
      ...
      add_connection "$iossm_master_clk_source" "${jtag_uart}.clk"

      add_connection "$iossm_master_rst_source" "${jtag_uart}.reset"
   }

   if {$soft_ram_en} {
      set onchip_memory "iossm_soft_ram"
      ...
      add_connection "$iossm_master_clk_source"   "${onchip_memory}.clk1"

      add_connection "$iossm_master_rst_source" "${onchip_memory}.reset1"
   }
...
proc ::altera_emif::ip_cal_slave::ip_core_nd::main::_init {} {
}

::altera_emif::ip_cal_slave::ip_core_nd::main::_init

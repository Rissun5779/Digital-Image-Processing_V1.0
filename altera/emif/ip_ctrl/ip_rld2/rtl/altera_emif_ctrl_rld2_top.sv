...
///////////////////////////////////////////////////////////////////////////////
// Top-level wrapper of RLD2 soft memory controller
//
...
//
///////////////////////////////////////////////////////////////////////////////
module altera_emif_ctrl_rld2_top # (
   ...
   altera_emif_ctrl_rld2_controller # (
      ...
      .avl_ready(amm_ready_0),
      .avl_write_req(amm_write_0),
      .avl_read_req(amm_read_0),
      .avl_addr(amm_address_0),
      .avl_size(amm_burstcount_0),
      .avl_wdata(amm_writedata_0),
      .avl_rdata_valid(amm_readdatavalid_0),
      .avl_rdata(amm_readdata_0),
      .local_init_done()
   );
   ...
   // The following AFI signals aren't applicable to RLD2
   assign afi_bg                = '0;
   assign afi_c                 = '0;
   assign afi_cke               = '0;
   assign afi_rm                = '0;
   ...
   // The following AMM signals aren't applicable to RLD2

...
package provide altera_emif::ip_ctrl::ip_rld3::main 0.1
...
package require altera_emif::ip_ctrl::ip_rld3::ctrl_expert_exports
package require altera_emif::ip_ctrl::ip_rld3::enum_defs

namespace eval ::altera_emif::ip_ctrl::ip_rld3::main:: {
...
proc ::altera_emif::ip_ctrl::ip_rld3::main::create_parameters {} {
...
proc ::altera_emif::ip_ctrl::ip_rld3::main::elaboration_callback {} {
   ...
   set if_ports_names [altera_emif::ip_ctrl::util::register_ctrl_interfaces CTRL_RLD3_IF]
...
proc ::altera_emif::ip_ctrl::ip_rld3::main::sim_vhdl_fileset_callback {top_level} {
   ::altera_emif::ip_ctrl::util::sim_vhdl_fileset_callback $top_level [_generate_verilog_fileset]
}

proc ::altera_emif::ip_ctrl::ip_rld3::main::sim_verilog_fileset_callback {top_level} {
   ::altera_emif::ip_ctrl::util::sim_verilog_fileset_callback $top_level [_generate_verilog_fileset]
}

proc ::altera_emif::ip_ctrl::ip_rld3::main::quartus_synth_fileset_callback {top_level} {
   ::altera_emif::ip_ctrl::util::quartus_synth_fileset_callback $top_level [_generate_verilog_fileset]
}


proc ::altera_emif::ip_ctrl::ip_rld3::main::_generate_verilog_fileset {} {
   
   set qdir $::env(QUARTUS_ROOTDIR)
	set common_dir "${qdir}/../ip/altera/emif/ip_ctrl/common/rtl"
   
   set file_list [list \
      rtl/altera_emif_ctrl_rld3_top.sv
   ]
 
   return $file_list
}

proc ::altera_emif::ip_ctrl::ip_rld3::main::_init {} {
}

::altera_emif::ip_ctrl::ip_rld3::main::_init

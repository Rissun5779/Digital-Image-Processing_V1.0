...
package provide altera_emif::ip_ctrl::ip_qdr4::ctrl_expert_exports 0.1
...
namespace eval ::altera_emif::ip_ctrl::ip_qdr4::ctrl_expert_exports:: {
...
proc ::altera_emif::ip_ctrl::ip_qdr4::ctrl_expert_exports::get_num_of_interfaces_used {if_enum} {
   switch $if_enum {
      IF_AFI -
      IF_AFI_RESET -
      IF_AFI_CLK -
...
proc ::altera_emif::ip_ctrl::ip_qdr4::ctrl_expert_exports::get_interface_ports {if_enum} {
   set ports [list]
   ...
   switch $if_enum {
      ...
      IF_CTRL_AMM {
         ...
         set be_en         [dict get $props USE_BYTE_ENABLE]
         ...
         lappend ports {*}[create_port  $be_en      PORT_CTRL_AMM_BYTEEN        $be_width        ]
...
proc ::altera_emif::ip_ctrl::ip_qdr4::ctrl_expert_exports::get_interface_properties {if_enum} {
   ...
   switch $if_enum {
      IF_CTRL_AMM {
         ...
         set data_per_port       [get_parameter_value MEM_QDR4_DQ_PER_PORT_WIDTH]
         set data_width          [expr {$data_per_port * 2}]
         set addr_width          [get_parameter_value MEM_QDR4_ADDR_WIDTH]
         
         set symbol_width        [get_parameter_value CTRL_QDR4_AVL_SYMBOL_WIDTH]
         set enable_power_of_two [get_parameter_value CTRL_QDR4_AVL_ENABLE_POWER_OF_TWO_BUS]
         set max_burst_count     [get_parameter_value CTRL_QDR4_AVL_MAX_BURST_COUNT]
...
proc ::altera_emif::ip_ctrl::ip_qdr4::ctrl_expert_exports::_init {} {
}

::altera_emif::ip_ctrl::ip_qdr4::ctrl_expert_exports::_init

...
package provide altera_emif::ip_mem_model::ip_core_lpddr3::main 0.1
...
package require altera_emif::ip_mem_model::ip_core_lpddr3::util

namespace eval ::altera_emif::ip_mem_model::ip_core_lpddr3::main:: {
   ...
   namespace import ::altera_emif::ip_mem_model::ip_core_lpddr3::util::*
...
proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::create_parameters {} {
   ...
   add_derived_hdl_param      MEM_INIT_MRS1                    integer            0x03
   add_derived_hdl_param      MEM_INIT_MRS2                    integer            0x18
   add_derived_hdl_param      MEM_INIT_MRS3                    integer            0x02

   return 1
}

proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::elaboration_callback {} {
...
proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::sim_vhdl_fileset_callback {top_level} {
...
proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::sim_verilog_fileset_callback {top_level} {
...
proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::quartus_synth_fileset_callback {top_level} {
...
proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::_generate_common_fileset {} {
   set file_list [list]
   return $file_list   
}

proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::_generate_verilog_fileset {} {
   set file_list [list \
...
proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::_derive_port_width_parameters {ports} {
   ::altera_emif::util::hwtcl_utils::derive_port_width_parameters $ports
}

proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::_derive_mem_model_parameters {} {
   ...
   foreach mem_model_param $mem_model_param_list {
      set_parameter_value "MEM_${mem_model_param}"  [get_parameter_value "MEM_LPDDR3_${mem_model_param}"]   
   }

   set_parameter_value "MEM_TRCD" [get_parameter_value "MEM_LPDDR3_TRCD_CYC"]
   set_parameter_value "MEM_TRTP" [get_parameter_value "MEM_LPDDR3_TRTP_CYC"]
}

proc ::altera_emif::ip_mem_model::ip_core_lpddr3::main::_init {} {
}

::altera_emif::ip_mem_model::ip_core_lpddr3::main::_init

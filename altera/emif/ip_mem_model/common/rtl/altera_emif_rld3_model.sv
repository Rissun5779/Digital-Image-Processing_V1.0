...
module altera_emif_rld3_model # ( 
   ...
   localparam DM_PER_DEVICE = (MEM_DM_EN == 1) ? PORT_MEM_DM_WIDTH/MEM_DEVICE_WIDTH : 1;
   
generate
genvar width;
for (width = 0; width < MEM_DEVICE_WIDTH; width = width + 1)
begin : width_gen
		altera_emif_rld3_model_per_device #(
         ...
         .PORT_MEM_DK_WIDTH                           (PORT_MEM_DK_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_DK_N_WIDTH                         (PORT_MEM_DK_N_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_QK_WIDTH                           (PORT_MEM_QK_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_QK_N_WIDTH                         (PORT_MEM_QK_N_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_DQ_WIDTH                           (PORT_MEM_DQ_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_WE_N_WIDTH                         (PORT_MEM_WE_N_WIDTH),		
         .PORT_MEM_DM_WIDTH                           (DM_PER_DEVICE),
         ...
         .MEM_DM_EN                                   (MEM_DM_EN)
			...
			.mem_ck_n	(mem_ck_n),
			.mem_cs_n	(mem_cs_n),
			.mem_dk		(mem_dk[PORT_MEM_DK_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DK_WIDTH/MEM_DEVICE_WIDTH*width]),
			.mem_dk_n	(mem_dk_n[PORT_MEM_DK_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DK_WIDTH/MEM_DEVICE_WIDTH*width]),
			.mem_dm		(mem_dm[((MEM_DM_EN == 1) ? (PORT_MEM_DM_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1) : 0) : ((MEM_DM_EN == 1) ? (PORT_MEM_DM_WIDTH/MEM_DEVICE_WIDTH*width) : 0)]),
			.mem_dq		(mem_dq[PORT_MEM_DQ_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DQ_WIDTH/MEM_DEVICE_WIDTH*width]),
			.mem_qk		(mem_qk[PORT_MEM_QK_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_QK_WIDTH/MEM_DEVICE_WIDTH*width]),
			.mem_qk_n	(mem_qk_n[PORT_MEM_QK_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_QK_WIDTH/MEM_DEVICE_WIDTH*width]),
			.mem_ref_n	(mem_ref_n),
			.mem_we_n	(mem_we_n),

...
//
///////////////////////////////////////////////////////////////////////////////
module altera_emif_rld3_model_per_device #(
   ...
   wire logic [PORT_MEM_QK_WIDTH-1:0] local_mem_qk [PORT_MEM_CS_N_WIDTH-1:0]; 
   wire logic [PORT_MEM_QK_WIDTH-1:0] local_mem_qk_n [PORT_MEM_CS_N_WIDTH-1:0]; 
   ...
   generate
   genvar rank;
   for (rank = 0; rank < PORT_MEM_CS_N_WIDTH; rank = rank + 1)
   begin : rank_gen
     altera_emif_rld3_model_rank # (

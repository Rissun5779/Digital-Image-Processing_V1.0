...
module altera_emif_qdr2_model # (
   ...
   begin : width_gen
      ...
      altera_emif_qdr2_model_per_device #(
                
         .PORT_MEM_A_WIDTH                            (PORT_MEM_A_WIDTH),
         .PORT_MEM_BWS_N_WIDTH                        (PORT_MEM_BWS_N_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_K_WIDTH                            (PORT_MEM_K_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_CQ_WIDTH                           (PORT_MEM_CQ_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_D_WIDTH                            (PORT_MEM_D_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_Q_WIDTH                            (PORT_MEM_Q_WIDTH/MEM_DEVICE_WIDTH),
         ...
         .mem_a                                    (mem_a),
         .mem_bws_n                                (mem_bws_n[PORT_MEM_BWS_N_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_BWS_N_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_rps_n                                (mem_rps_n),
         .mem_wps_n                                (mem_wps_n),
         .mem_doff_n                               (mem_doff_n),
         .mem_k                                    (mem_k[PORT_MEM_K_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_K_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_k_n                                  (mem_k_n[PORT_MEM_K_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_K_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_cq                                   (mem_cq[PORT_MEM_CQ_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_CQ_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_cq_n                                 (mem_cq_n[PORT_MEM_CQ_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_CQ_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_d                                    (mem_d[PORT_MEM_D_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_D_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_q                                    (mem_q[PORT_MEM_Q_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_Q_WIDTH/MEM_DEVICE_WIDTH*width])

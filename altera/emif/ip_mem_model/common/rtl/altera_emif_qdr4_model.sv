...
//
///////////////////////////////////////////////////////////////////////////////
module altera_emif_qdr4_model # (

   parameter PROTOCOL_ENUM                           = "PROTOCOL_QDR4",
   ...
   localparam DINVA_PER_MEM_DEVICE_WIDTH = (MEM_DATA_INV_ENA == 1) ? PORT_MEM_DINVA_WIDTH/MEM_DEVICE_WIDTH : 1;
   localparam DINVB_PER_MEM_DEVICE_WIDTH = (MEM_DATA_INV_ENA == 1) ? PORT_MEM_DINVB_WIDTH/MEM_DEVICE_WIDTH : 1;
   
   generate
   genvar width;
   for (width = 0; width < MEM_DEVICE_WIDTH; width = width + 1) 
   begin : width_gen
      
      altera_emif_qdr4_model_per_device #(
                
         .PORT_MEM_A_WIDTH                            (PORT_MEM_A_WIDTH),
         .PORT_MEM_DKA_WIDTH                          (PORT_MEM_DKA_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_DKA_N_WIDTH                        (PORT_MEM_DKA_N_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_DKB_WIDTH                          (PORT_MEM_DKB_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_DKB_N_WIDTH                        (PORT_MEM_DKB_N_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_QKA_WIDTH                          (PORT_MEM_QKA_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_QKA_N_WIDTH                        (PORT_MEM_QKA_N_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_QKB_WIDTH                          (PORT_MEM_QKB_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_QKB_N_WIDTH                        (PORT_MEM_QKB_N_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_DQA_WIDTH                          (PORT_MEM_DQA_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_DQB_WIDTH                          (PORT_MEM_DQB_WIDTH/MEM_DEVICE_WIDTH),
         .PORT_MEM_DINVA_WIDTH                        (DINVA_PER_MEM_DEVICE_WIDTH),
         .PORT_MEM_DINVB_WIDTH                        (DINVB_PER_MEM_DEVICE_WIDTH),
         ...
         .mem_dka                                  (mem_dka[PORT_MEM_DKA_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DKA_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_dka_n                                (mem_dka_n[PORT_MEM_DKA_N_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DKA_N_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_dkb                                  (mem_dkb[PORT_MEM_DKB_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DKB_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_dkb_n                                (mem_dkb_n[PORT_MEM_DKB_N_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DKB_N_WIDTH/MEM_DEVICE_WIDTH*width]),
         
         .mem_qka                                  (mem_qka[PORT_MEM_QKA_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_QKA_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_qka_n                                (mem_qka_n[PORT_MEM_QKA_N_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_QKA_N_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_qkb                                  (mem_qkb[PORT_MEM_QKB_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_QKB_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_qkb_n                                (mem_qkb_n[PORT_MEM_QKB_N_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_QKB_N_WIDTH/MEM_DEVICE_WIDTH*width]),
         
         .mem_dqa                                  (mem_dqa[PORT_MEM_DQA_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DQA_WIDTH/MEM_DEVICE_WIDTH*width]),
         .mem_dqb                                  (mem_dqb[PORT_MEM_DQB_WIDTH/MEM_DEVICE_WIDTH*(width+1)-1:PORT_MEM_DQB_WIDTH/MEM_DEVICE_WIDTH*width]),
         
         .mem_dinva                                (mem_dinva[ ((MEM_DATA_INV_ENA == 1) ? (DINVA_PER_MEM_DEVICE_WIDTH*(width+1)-1) : 0) : ((MEM_DATA_INV_ENA == 1) ? (DINVA_PER_MEM_DEVICE_WIDTH*width) : 0) ]),
         .mem_dinvb                                (mem_dinvb[ ((MEM_DATA_INV_ENA == 1) ? (DINVB_PER_MEM_DEVICE_WIDTH*(width+1)-1) : 0) : ((MEM_DATA_INV_ENA == 1) ? (DINVB_PER_MEM_DEVICE_WIDTH*width) : 0) ]),

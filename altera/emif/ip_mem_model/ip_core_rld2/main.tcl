...
package provide altera_emif::ip_mem_model::ip_core_rld2::main 0.1
...
package require altera_emif::ip_mem_model::ip_core_rld2::util

namespace eval ::altera_emif::ip_mem_model::ip_core_rld2::main:: {
   ...
   namespace import ::altera_emif::ip_mem_model::ip_core_rld2::util::*

}


proc ::altera_emif::ip_mem_model::ip_core_rld2::main::create_parameters {} {
...
proc ::altera_emif::ip_mem_model::ip_core_rld2::main::elaboration_callback {} {
...
proc ::altera_emif::ip_mem_model::ip_core_rld2::main::sim_vhdl_fileset_callback {top_level} {
   set rtl_only 1
   set encrypted 1   
...
proc ::altera_emif::ip_mem_model::ip_core_rld2::main::sim_verilog_fileset_callback {top_level} {
...
proc ::altera_emif::ip_mem_model::ip_core_rld2::main::quartus_synth_fileset_callback {top_level} {
...
proc ::altera_emif::ip_mem_model::ip_core_rld2::main::_generate_common_fileset {} {
   set file_list [list]
   return $file_list   
}

proc ::altera_emif::ip_mem_model::ip_core_rld2::main::_generate_verilog_fileset {} {
   set qdir $::env(QUARTUS_ROOTDIR)
	set common_dir "${qdir}/../ip/altera/emif/ip_mem_model/common/rtl"
   set file_list [list \
      ${common_dir}/altera_emif_rld2_model.sv \
      ${common_dir}/altera_emif_rld2_model_per_device.sv \
      ${common_dir}/altera_emif_rld2_model_rank.sv 
   ]
   return $file_list
}

proc ::altera_emif::ip_mem_model::ip_core_rld2::main::_derive_port_width_parameters {ports} {
   ::altera_emif::util::hwtcl_utils::derive_port_width_parameters $ports
}

proc ::altera_emif::ip_mem_model::ip_core_rld2::main::_derive_mem_model_parameters {} {
   set mem_model_param_list [list \
                       DEVICE_WIDTH
                    ]

   foreach mem_model_param $mem_model_param_list {
      set_parameter_value "MEM_${mem_model_param}"  [get_parameter_value "MEM_RLD2_${mem_model_param}"]   
   }
}

proc ::altera_emif::ip_mem_model::ip_core_rld2::main::_init {} {
}

::altera_emif::ip_mem_model::ip_core_rld2::main::_init

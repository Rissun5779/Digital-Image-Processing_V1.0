...
package provide altera_emif::ip_arch_nf::doc_gen 0.1
...
namespace eval ::altera_emif::ip_arch_nf::doc_gen:: {
...
proc ::altera_emif::ip_arch_nf::doc_gen::add_readme {docs_varname if_ports} {
   ...
   _add_howto_onchip_debug       docs "readme.txt" "Using the On-Chip Debug Interface"
   _add_ip_settings              docs "readme.txt" "IP Settings"
   _add_howto_cfg_tg2            docs "readme.txt" "Configuring the Traffic Generator"
}


proc ::altera_emif::ip_arch_nf::doc_gen::_add_readme_desc {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_filesets_desc {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_howto_inst_ip_qii {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_early_io_timing_desc {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_io_asgmts_desc {docs_varname filename title if_ports} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_pin_locs_desc {docs_varname filename title if_ports} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_howto_share_core_clks {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_howto_share_pll_ref_clk {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_ifs_desc {docs_varname filename if_ports} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_howto_inst_ip_sim {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_cal_mode_desc {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_howto_onchip_debug {docs_varname filename title} {
   ...
   set lines [list \
      "The On-Chip Debug Interface is an Avalon-MM slave on the EMIF IP, which allows core logic" \
      "to access calibration debug data (such as margins observed during calibration) and read/write" \
      "access to PHY settings adjusted during calibration.  This interface can be accessed using a" \
      "Nios processor in the FPGA core.  Example software is provided in the following files:" \
      "" \
      " emif_export.c/h : These files define the data structures and functions that can be used" \
      "                   to access calibration data and settings." \
      " main.c          : This is an example program making use of the functions in emif_export.h." \
      "                   It demonstrates how to read basic information about the memory interface" \
      "                   from the parameter table, as well as debug data reports showing calibration" \
      "                   results.  It also demonstrates how to send a command to the interface" \
      "                   (e.g. how to request recalibration).  Finally, it shows how various settings" \
      "                   can be read and modified, such as input/output delays on pins." \
      " Makefile        : Running \"make\" builds the example software.  Prior to building the software," \
      "                   the SOPCINFO variable must be set to the SOPCINFO file containing the " \
      "                   On-Chip Debug Nios.  The software can be downloaded to the Nios after the" \
      "                   interface has completed calibration, using the command \"make prog\"." \
      "                   The software will print diagnostic information via JTAG UART."
   ]
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_ip_settings {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_add_howto_cfg_tg2 {docs_varname filename title} {
...
proc ::altera_emif::ip_arch_nf::doc_gen::_init {} {
}

::altera_emif::ip_arch_nf::doc_gen::_init

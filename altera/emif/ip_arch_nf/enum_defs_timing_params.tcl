...
package provide altera_emif::ip_arch_nf::enum_defs_timing_params 0.1

package require altera_emif::util::enums

namespace eval ::altera_emif::ip_arch_nf::enum_defs_timing_params:: {
...
proc ::altera_emif::ip_arch_nf::enum_defs_timing_params::def_enums {} {
   ...
   def_enum      TPARAM          TPARAM_TERMINATION_LESS_THAN_120  [list "TERMINATION_LESS_THAN_120"]
   def_enum      TPARAM          TPARAM_IS_COMPONENT          [list "IS_COMPONENT"                ]
   ...
   def_enum      TPARAM_HWTCL    _AUTO_GEN_                   [list PHY_USERMODE_OCT              ]
   def_enum      TPARAM_HWTCL    _AUTO_GEN_                   [list PHY_PERIODIC_OCT_RECAL        ]
...
proc ::altera_emif::ip_arch_nf::enum_defs_timing_params::_init {} {
   ::altera_emif::ip_arch_nf::enum_defs_timing_params::def_enums
}

::altera_emif::ip_arch_nf::enum_defs_timing_params::_init

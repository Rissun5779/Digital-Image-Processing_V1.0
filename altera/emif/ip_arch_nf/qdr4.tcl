...
package provide altera_emif::ip_arch_nf::qdr4 0.1
...
namespace eval ::altera_emif::ip_arch_nf::qdr4:: {
...
proc ::altera_emif::ip_arch_nf::qdr4::get_dqs_bus_mode {} {
...
proc ::altera_emif::ip_arch_nf::qdr4::get_interface_ports {if_enum} {
   switch $if_enum {
      IF_MEM {
...
proc ::altera_emif::ip_arch_nf::qdr4::is_ctrl_sideband_interface_enabled {if_enum} {
   return 0
}

proc ::altera_emif::ip_arch_nf::qdr4::get_interface_properties {if_enum} {
   emif_ie "Interface type $if_enum not supported by [info level 0]"
   return 0
}

proc ::altera_emif::ip_arch_nf::qdr4::get_ac_pin_map_scheme {} {
   ...
   if {[::altera_emif::util::qini::ini_is_on "emif_use_swap_pinout_atso9"]} {
      if {$use_addr_parity || $addr_width > 22} {
         dict set retval ENUM "QDR4_AC_PM_0_1_2_3_SWAP"
      } else {
         dict set retval ENUM "QDR4_AC_PM_0_1_2_SWAP"
      }
   } else {
      if {$use_addr_parity || $addr_width > 22} {
...
proc ::altera_emif::ip_arch_nf::qdr4::get_resource_consumption {} {
...
proc ::altera_emif::ip_arch_nf::qdr4::alloc_mem_pins {mem_ports_name} {
...
proc ::altera_emif::ip_arch_nf::qdr4::assign_io_settings {ports_name} {
...
proc ::altera_emif::ip_arch_nf::qdr4::get_clk_ratios {} {
...
proc ::altera_emif::ip_arch_nf::qdr4::get_num_and_type_of_hmc_ports {} {
   set num_of_ports 0
...
proc ::altera_emif::ip_arch_nf::qdr4::get_hmc_cfgs {hmc_inst} {
   set retval [dict create]
...
proc ::altera_emif::ip_arch_nf::qdr4::get_lane_cfgs {} {
   set retval [dict create]
...
proc ::altera_emif::ip_arch_nf::qdr4::derive_seq_param_tbl {seq_pt_enums} {
...
proc ::altera_emif::ip_arch_nf::qdr4::get_timing_params {} {
   ...
   foreach tparam_enum [enums_of_type TPARAM] {
      ...
      switch $tparam_enum {
         ...
         TPARAM_TERMINATION_LESS_THAN_120 {
            set data_in_ohm   [enum_data [get_parameter_value PHY_QDR4_DATA_IN_MODE_ENUM] OHM]
...
proc ::altera_emif::ip_arch_nf::qdr4::is_phy_tracking_enabled {} {
   return [::altera_emif::ip_arch_nf::qdrx::is_phy_tracking_enabled]
}

proc ::altera_emif::ip_arch_nf::qdr4::is_phy_shadow_register_disabled {} {
   return 0
}


proc ::altera_emif::ip_arch_nf::qdr4::_get_mem_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nf::qdr4::_get_afi_ports {} {
...
::altera_emif::ip_arch_nf::qdr4::_init

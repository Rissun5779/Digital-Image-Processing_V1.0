...
package provide altera_emif::ip_arch_nf::timing 0.1
...
package require altera_emif::ip_arch_nf::enum_defs_timing_params
package require altera_emif::ip_arch_nf::protocol_expert
package require altera_emif::ip_arch_nf::util


namespace eval ::altera_emif::ip_arch_nf::timing:: {
...
proc ::altera_emif::ip_arch_nf::timing::generate_files {top_level if_ports} {

   set module $top_level
   set ofile_prefix $top_level
   
   set tparams [::altera_emif::ip_arch_nf::protocol_expert::get_timing_params]
...
proc ::altera_emif::ip_arch_nf::timing::_init {} {
}

::altera_emif::ip_arch_nf::timing::_init

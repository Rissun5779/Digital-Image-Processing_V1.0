...
proc ::altera_emif::ip_arch_nf::pll::_get_pll_settings {\
   mem_clk_freq_mhz \
   ref_clk_freq_mhz \
   clk_ratios \
   vco_to_mem_clk_freq_ratio \
   ...
   dict set retval PLL_COMPENSATION_MODE [_get_pll_comp_mode]
...
proc ::altera_emif::ip_arch_nf::pll::_get_legal_pll_ref_clk_freqs_mhz {
   max_entries \
   pfd_fmax_mhz \
   pfd_fmin_mhz \
   min_vco_div \
...
proc ::altera_emif::ip_arch_nf::pll::_get_legal_mem_clk_freqs_mhz {
   ref_clk_freq_mhz \
   clk_ratios \
   vco_to_mem_clk_freq_ratio \
   pll_comp_mode
...
proc ::altera_emif::ip_arch_nf::pll::_init {} {
   ...
   if {[emif_utest_enabled]} {   
      ...
      set ref_clk_freqs_mhz            [_get_legal_pll_ref_clk_freqs_mhz 5 325 10 4 $mem_clk_freq_mhz $clk_ratios $vco_to_mem_clk_freq_ratio "direct"]

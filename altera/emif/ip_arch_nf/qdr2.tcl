...
package provide altera_emif::ip_arch_nf::qdr2 0.1
...
package require altera_emif::ip_arch_nf::qdrx

namespace eval ::altera_emif::ip_arch_nf::qdr2:: {
...
proc ::altera_emif::ip_arch_nf::qdr2::get_dqs_bus_mode {} {
...
proc ::altera_emif::ip_arch_nf::qdr2::get_interface_ports {if_enum} {
   switch $if_enum {
      IF_MEM {
...
proc ::altera_emif::ip_arch_nf::qdr2::is_ctrl_sideband_interface_enabled {if_enum} {
   return 0
}

proc ::altera_emif::ip_arch_nf::qdr2::get_interface_properties {if_enum} {
   emif_ie "Interface type $if_enum not supported"
}

proc ::altera_emif::ip_arch_nf::qdr2::get_ac_pin_map_scheme {} {
   set retval [dict create]
   

   if {[::altera_emif::util::qini::ini_is_on "emif_use_internal_swap_pinout_qdr2px"]} {
      dict set retval ENUM "QDR2_AC_PM_0_1_2_SWAP"
   } elseif ([::altera_emif::util::qini::ini_is_on "emif_use_internal_swap_pinout_qdr2bl4"]) {
      dict set retval ENUM "QDR2_AC_PM_0_1_2_SWAP_2"
   } else {
...
proc ::altera_emif::ip_arch_nf::qdr2::get_resource_consumption {} {
...
proc ::altera_emif::ip_arch_nf::qdr2::alloc_mem_pins {mem_ports_name} {
...
proc ::altera_emif::ip_arch_nf::qdr2::assign_io_settings {ports_name} {
...
proc ::altera_emif::ip_arch_nf::qdr2::get_clk_ratios {} {
...
proc ::altera_emif::ip_arch_nf::qdr2::get_num_and_type_of_hmc_ports {} {
...
proc ::altera_emif::ip_arch_nf::qdr2::get_hmc_cfgs {hmc_inst} {
   set retval [dict create]
...
proc ::altera_emif::ip_arch_nf::qdr2::get_lane_cfgs {} {
   set retval        [dict create]
   ...
   if {$rl == 1.5 || $rl == 2.5} {
      dict set retval "SWAP_DQS_A_B" "true"
   } else {
...
proc ::altera_emif::ip_arch_nf::qdr2::derive_seq_param_tbl {seq_pt_enums} {
...
proc ::altera_emif::ip_arch_nf::qdr2::get_timing_params {} {
   ...
   foreach tparam_enum [enums_of_type TPARAM] {
      ...
      switch $tparam_enum {
         ...
         TPARAM_TERMINATION_LESS_THAN_120 {
            set data_in_ohm   [enum_data [get_parameter_value PHY_QDR2_DATA_IN_MODE_ENUM] OHM]
...
proc ::altera_emif::ip_arch_nf::qdr2::is_phy_tracking_enabled {} {
   return [::altera_emif::ip_arch_nf::qdrx::is_phy_tracking_enabled]
}

proc ::altera_emif::ip_arch_nf::qdr2::is_phy_shadow_register_disabled {} {
   return 0
}



proc ::altera_emif::ip_arch_nf::qdr2::_get_mem_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nf::qdr2::_get_afi_ports {} {
...
proc ::altera_emif::ip_arch_nf::qdr2::_init {} {
}

::altera_emif::ip_arch_nf::qdr2::_init

...
package provide altera_emif::ip_arch_nf::lpddr3 0.1
...
namespace eval ::altera_emif::ip_arch_nf::lpddr3:: {
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_dqs_bus_mode {} {
   return [::altera_emif::ip_arch_nf::ddrx::get_dqs_bus_mode]
}

proc ::altera_emif::ip_arch_nf::lpddr3::get_interface_ports {if_enum} {
   switch $if_enum {
      IF_MEM {
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_interface_properties {if_enum} {
   switch $if_enum {
      IF_CTRL_AMM {
...
proc ::altera_emif::ip_arch_nf::lpddr3::is_ctrl_sideband_interface_enabled {if_enum} {
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_ac_pin_map_scheme {} {
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_resource_consumption {} {
...
proc ::altera_emif::ip_arch_nf::lpddr3::alloc_mem_pins {mem_ports_name} {
...
proc ::altera_emif::ip_arch_nf::lpddr3::assign_io_settings {ports_name} {
   ...
   for {set i 0} {$i < [llength $ports]} {incr i} {
      ...
      switch $type_enum {
         ...
         PORT_MEM_DQ {
            ...
            set pkg_deskew $dqs_pkg_deskew
            set vref_mode_enum VREF_MODE_CALIBRATED_RANGE_2
         }
         PORT_MEM_DQS -
         PORT_MEM_DQS_N {
            set cal_oct $data_cal_oct
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_clk_ratios {} {
...
proc :::altera_emif::ip_arch_nf::lpddr3::check_hmc_legality {} {
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_num_and_type_of_hmc_ports {} {
   set config_enum             [get_parameter_value PHY_LPDDR3_CONFIG_ENUM]
   set ping_pong_en            0
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_lane_cfgs {} {
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_hmc_cfgs {hmc_inst} {
   ...
   set rd_ap_to_valid     [hmc_div_ceil [expr {max($trtp_cyc, 4) + $trp_cyc + $col_to_row_offset}] $phy_hmc_clk_ratio]
   ...
   foreach hmc_cfg_enum [enums_of_type HMC_CFG] {
      ...
      switch $hmc_cfg_enum {
         ...
         HMC_CFG_WRITE_ODT_CHIP {
            set val [get_parameter_value MEM_LPDDR3_CTRL_CFG_WRITE_ODT_CHIP]
         }
         HMC_CFG_READ_ODT_CHIP {
            set val [get_parameter_value MEM_LPDDR3_CTRL_CFG_READ_ODT_CHIP]
         }
         HMC_CFG_WR_ODT_ON {
         ...
         HMC_CFG_WR_ODT_PERIOD {
            set val [expr {int(($bl / 2) + 1 + ceil((3.5 - 1.75) / $mem_clk_ns))}]
         }
         ...
         HMC_CFG_RD_TO_PCH {
            set val [hmc_div_ceil [expr {max($trtp_cyc, 4) + $col_to_row_offset}] $phy_hmc_clk_ratio]
         }
         ...
         HMC_CFG_WR_TO_RD {
            set val [expr {[hmc_div_ceil [expr {$twl_cyc + ($bl / 2) + max($twtr_cyc, 4) + $wr_to_rd_extra_turnaround + $col_to_diff_col_offset}] $phy_hmc_clk_ratio] + $user_wr_to_rd_same_chip_delta_cyc}]
         }
         HMC_CFG_WR_TO_RD_DIFF_CHIP {
            set tmp_wr_to_rd_diff_chip [expr {max(int($twl_cyc - $trl_cyc + ($bl / 2)), 0)}]
         ...
         HMC_CFG_MRS_TO_VALID {
            set val [expr {($tmrd_cyc - 1)/int($phy_hmc_clk_ratio)/2 + 1}]
         }
...
proc ::altera_emif::ip_arch_nf::lpddr3::derive_seq_param_tbl {seq_pt_enums} {
   ...
   foreach seq_pt_enum $seq_pt_enums {
      switch $seq_pt_enum {
         ...
         SEQ_PT_CAL_DATA_PTR {            
            ...
            set vrefin_pct [get_parameter_value PHY_LPDDR3_STARTING_VREFIN]
...
proc ::altera_emif::ip_arch_nf::lpddr3::get_timing_params {} {
   ...
   foreach tparam_enum [enums_of_type TPARAM] {
      ...
      switch $tparam_enum {
         ...
         TPARAM_TERMINATION_LESS_THAN_120 {
            set data_in_ohm   [enum_data [get_parameter_value PHY_LPDDR3_DATA_IN_MODE_ENUM] OHM]
...
proc ::altera_emif::ip_arch_nf::lpddr3::is_phy_tracking_enabled {} {
   return [::altera_emif::ip_arch_nf::ddrx::is_phy_tracking_enabled]
}

proc ::altera_emif::ip_arch_nf::lpddr3::is_phy_shadow_register_disabled {} {
   return 0
}


proc ::altera_emif::ip_arch_nf::lpddr3::_get_mem_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_afi_ports {} {
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_ctrl_ast_properties {is_write} {
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_ctrl_ast_cmd_properties {} {
   set props [dict create]
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_ctrl_ast_cmd_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_ctrl_ast_wr_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_ctrl_ast_rd_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_ctrl_amm_properties {} {
   set props [dict create]
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_ctrl_amm_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nf::lpddr3::_get_ctrl_user_refresh_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nf::lpddr3::_init {} {
}

::altera_emif::ip_arch_nf::lpddr3::_init

...
package require altera_emif::ip_sim_checker::main
...
set_module_property NAME altera_emif_sim_checker
...
set_module_property ELABORATION_CALLBACK ::altera_emif::ip_sim_checker::main::elaboration_callback

add_fileset sim_vhdl SIM_VHDL ::altera_emif::ip_sim_checker::main::sim_vhdl_fileset_callback
set_fileset_property sim_vhdl TOP_LEVEL altera_emif_sim_checker

add_fileset sim_verilog SIM_VERILOG ::altera_emif::ip_sim_checker::main::sim_verilog_fileset_callback
set_fileset_property sim_verilog TOP_LEVEL altera_emif_sim_checker

add_fileset quartus_synth QUARTUS_SYNTH ::altera_emif::ip_sim_checker::main::quartus_synth_fileset_callback
set_fileset_property quartus_synth TOP_LEVEL altera_emif_sim_checker

add_display_item "" QSYS_GUI_FOR_INTERNAL_COMPONENTS_TEXT TEXT [get_string QSYS_GUI_FOR_INTERNAL_COMPONENTS_DESC]

::altera_emif::ip_sim_checker::main::create_parameters

...
package provide altera_emif::ip_top::phy::lpddr3 0.1
...
namespace eval ::altera_emif::ip_top::phy::lpddr3:: {
   ...
   variable m_param_prefix "PHY_LPDDR3"
}


proc ::altera_emif::ip_top::phy::lpddr3::create_parameters {is_top_level_component} {
   ...
   add_user_param     "${m_param_prefix}_MEM_CLK_FREQ_MHZ"             float     800                          ""                                         "MEGAHERTZ"  ""             ""             PHY_MEM_CLK_FREQ_MHZ
   ...
   add_user_param     "${m_param_prefix}_IO_VOLTAGE"                   float     1.2                          {"1.2:1.2V (I/O)"}                         ""           ""             ""             PHY_IO_VOLTAGE
...
proc ::altera_emif::ip_top::phy::lpddr3::set_family_specific_defaults {family_enum base_family_enum is_hps} {
   variable m_param_prefix
...
proc ::altera_emif::ip_top::phy::lpddr3::add_display_items {tabs} {
   variable m_param_prefix
   
   return 1
}

proc ::altera_emif::ip_top::phy::lpddr3::validate {} {
   variable m_param_prefix

   return 1
}

proc ::altera_emif::ip_top::phy::lpddr3::get_default_io_settings {voltage} {   
   ...
   dict set retval AC_IO_STD_ENUM           "IO_STD_HSUL_12"
   dict set retval AC_MODE_ENUM             "OUT_OCT_40_CAL"
   dict set retval AC_SLEW_RATE_ENUM        "SLEW_RATE_FAST"
   dict set retval CK_IO_STD_ENUM           "IO_STD_HSUL_12"
   dict set retval CK_MODE_ENUM             "OUT_OCT_40_CAL"
   dict set retval CK_SLEW_RATE_ENUM        "SLEW_RATE_FAST"
   dict set retval DATA_IO_STD_ENUM         "IO_STD_HSUL_12"
   dict set retval DATA_OUT_MODE_ENUM       "OUT_OCT_40_CAL"
   dict set retval DATA_IN_MODE_ENUM        "IN_OCT_INFINITE_CAL"
...
proc ::altera_emif::ip_top::phy::lpddr3::get_supported_pll_ref_clk_io_stds {voltage} {
   return [list IO_STD_LVDS IO_STD_LVDS_NO_OCT IO_STD_CMOS_12]
}

proc ::altera_emif::ip_top::phy::lpddr3::get_supported_rzq_io_stds {voltage} {
   return [list IO_STD_CMOS_12]
}

proc ::altera_emif::ip_top::phy::lpddr3::get_supported_ac_io_stds {voltage} {
   set retval [list IO_STD_SSTL_12 IO_STD_CMOS_12 IO_STD_HSUL_12]
   return $retval
}

proc ::altera_emif::ip_top::phy::lpddr3::get_supported_ck_io_stds {voltage} {
   return [list IO_STD_SSTL_12 IO_STD_HSUL_12]
}

proc ::altera_emif::ip_top::phy::lpddr3::get_supported_data_io_stds {voltage} {
   return [list IO_STD_SSTL_12 IO_STD_HSUL_12]
}


proc ::altera_emif::ip_top::phy::lpddr3::_init {} {
}

::altera_emif::ip_top::phy::lpddr3::_init

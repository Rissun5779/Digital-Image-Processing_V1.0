...
package provide altera_emif::ip_top::phy::rld2 0.1
...
namespace eval ::altera_emif::ip_top::phy::rld2:: {
   ...
   variable m_param_prefix "PHY_RLD2"
}


proc ::altera_emif::ip_top::phy::rld2::create_parameters {is_top_level_component} {
   ...
   add_user_param     "${m_param_prefix}_MEM_CLK_FREQ_MHZ"             float     533.333                      ""                                         "MEGAHERTZ"  ""             ""             PHY_MEM_CLK_FREQ_MHZ
   ...
   add_user_param     "${m_param_prefix}_IO_VOLTAGE"                   float     1.8                          {"1.8:1.8V" "1.5:1.5V"}                    ""           ""             ""             PHY_IO_VOLTAGE
...
proc ::altera_emif::ip_top::phy::rld2::set_family_specific_defaults {family_enum base_family_enum is_hps} {
   variable m_param_prefix
   
   return 1
}

proc ::altera_emif::ip_top::phy::rld2::add_display_items {tabs} {
   variable m_param_prefix
  
   return 1
}

proc ::altera_emif::ip_top::phy::rld2::validate {} {
   variable m_param_prefix

   return 1
}

proc ::altera_emif::ip_top::phy::rld2::get_default_io_settings {voltage} {   
   ...
   if {$voltage == 1.8} {
      ...
      dict set retval AC_IO_STD_ENUM           "IO_STD_HSTL_18_C2"
      dict set retval AC_MODE_ENUM             "OUT_OCT_25_CAL"
      dict set retval AC_SLEW_RATE_ENUM        "SLEW_RATE_FAST"
      dict set retval CK_IO_STD_ENUM           "IO_STD_HSTL_18_C2"
      dict set retval CK_MODE_ENUM             "OUT_OCT_25_CAL"
      dict set retval CK_SLEW_RATE_ENUM        "SLEW_RATE_FAST"
      dict set retval DATA_IO_STD_ENUM         "IO_STD_HSTL_18_C2"
      dict set retval DATA_OUT_MODE_ENUM       "OUT_OCT_25_CAL"
      ...
      dict set retval AC_IO_STD_ENUM           "IO_STD_HSTL_15_C2"
      dict set retval AC_MODE_ENUM             "OUT_OCT_25_CAL"
      dict set retval AC_SLEW_RATE_ENUM        "SLEW_RATE_FAST"
      dict set retval CK_IO_STD_ENUM           "IO_STD_HSTL_15_C2"
      dict set retval CK_MODE_ENUM             "OUT_OCT_25_CAL"
      dict set retval CK_SLEW_RATE_ENUM        "SLEW_RATE_FAST"
      dict set retval DATA_IO_STD_ENUM         "IO_STD_HSTL_15_C2"
      dict set retval DATA_OUT_MODE_ENUM       "OUT_OCT_25_CAL"
      dict set retval DATA_IN_MODE_ENUM        "IN_OCT_50_CAL"   
      dict set retval AUTO_STARTING_VREFIN_EN  true
      dict set retval STARTING_VREFIN          50   
   } else {
      emif_ie "Unsupported voltage $voltage for RLDRAM II"	
   }

   return $retval
}

proc ::altera_emif::ip_top::phy::rld2::get_supported_pll_ref_clk_io_stds {voltage} {
   if {$voltage == 1.8} {
...
proc ::altera_emif::ip_top::phy::rld2::get_supported_rzq_io_stds {voltage} {
   if {$voltage == 1.8} {
...
proc ::altera_emif::ip_top::phy::rld2::get_supported_ac_io_stds {voltage} {
    if {$voltage == 1.8} {
...
proc ::altera_emif::ip_top::phy::rld2::get_supported_ck_io_stds {voltage} {
   return [get_supported_ac_io_stds $voltage]
}

proc ::altera_emif::ip_top::phy::rld2::get_supported_data_io_stds {voltage} {
   return [get_supported_ac_io_stds $voltage]
}



proc ::altera_emif::ip_top::phy::rld2::_init {} {
}

::altera_emif::ip_top::phy::rld2::_init

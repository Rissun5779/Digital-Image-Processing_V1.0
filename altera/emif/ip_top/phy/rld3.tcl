...
package provide altera_emif::ip_top::phy::rld3 0.1
...
namespace eval ::altera_emif::ip_top::phy::rld3:: {
   ...
   variable m_param_prefix "PHY_RLD3"
}


proc ::altera_emif::ip_top::phy::rld3::create_parameters {is_top_level_component} {
   variable m_param_prefix
   
   add_user_param     "${m_param_prefix}_CONFIG_ENUM"                  string    CONFIG_PHY_ONLY              [enum_dropdown_entries CONFIG]             ""           ""             ""             PHY_CONFIG_ENUM
...
proc ::altera_emif::ip_top::phy::rld3::set_family_specific_defaults {family_enum base_family_enum is_hps} {
   variable m_param_prefix
   
   return 1
}

proc ::altera_emif::ip_top::phy::rld3::add_display_items {tabs} {
   variable m_param_prefix
  
   return 1
}

proc ::altera_emif::ip_top::phy::rld3::validate {} {
   variable m_param_prefix

   return 1
}

proc ::altera_emif::ip_top::phy::rld3::get_default_io_settings {voltage} {   
   ...
   dict set retval DATA_IO_STD_ENUM         "IO_STD_SSTL_12"
...
proc ::altera_emif::ip_top::phy::rld3::get_supported_pll_ref_clk_io_stds {voltage} {
   return [list IO_STD_LVDS IO_STD_LVDS_NO_OCT IO_STD_CMOS_12]
}

proc ::altera_emif::ip_top::phy::rld3::get_supported_rzq_io_stds {voltage} {
   return [list IO_STD_CMOS_12]
}

proc ::altera_emif::ip_top::phy::rld3::get_supported_ac_io_stds {voltage} {
   return [list IO_STD_HSTL_12_C1 IO_STD_HSTL_12_C2 IO_STD_SSTL_12]
}

proc ::altera_emif::ip_top::phy::rld3::get_supported_ck_io_stds {voltage} {
   return [get_supported_ac_io_stds $voltage]
}

proc ::altera_emif::ip_top::phy::rld3::get_supported_data_io_stds {voltage} {
   return [get_supported_ac_io_stds $voltage]
}



proc ::altera_emif::ip_top::phy::rld3::_init {} {
}

::altera_emif::ip_top::phy::rld3::_init

...
package provide altera_emif::ip_top::phy::ddr4 0.1
...
namespace eval ::altera_emif::ip_top::phy::ddr4:: {
   ...
   variable m_param_prefix "PHY_DDR4"
}


proc ::altera_emif::ip_top::phy::ddr4::create_parameters {is_top_level_component} {
   ...
   add_user_param     "${m_param_prefix}_MEM_CLK_FREQ_MHZ"             float     1200.000                     ""                                         "MEGAHERTZ"  ""             ""             PHY_MEM_CLK_FREQ_MHZ
...
proc ::altera_emif::ip_top::phy::ddr4::set_family_specific_defaults {family_enum base_family_enum is_hps} {
   variable m_param_prefix
...
proc ::altera_emif::ip_top::phy::ddr4::add_display_items {tabs} {
   variable m_param_prefix

   return 1
}

proc ::altera_emif::ip_top::phy::ddr4::validate {} {
   variable m_param_prefix

   return 1
}

proc ::altera_emif::ip_top::phy::ddr4::get_default_io_settings {voltage} {   
...
proc ::altera_emif::ip_top::phy::ddr4::get_supported_pll_ref_clk_io_stds {voltage} {
   return [list IO_STD_LVDS IO_STD_LVDS_NO_OCT IO_STD_CMOS_12]
}

proc ::altera_emif::ip_top::phy::ddr4::get_supported_rzq_io_stds {voltage} {
   return [list IO_STD_CMOS_12]
}

proc ::altera_emif::ip_top::phy::ddr4::get_supported_ac_io_stds {voltage} {
   return [list IO_STD_SSTL_12 IO_STD_SSTL_12_C1 IO_STD_SSTL_12_C2 IO_STD_CMOS_12]
}

proc ::altera_emif::ip_top::phy::ddr4::get_supported_ck_io_stds {voltage} {
   return [list IO_STD_SSTL_12 IO_STD_SSTL_12_C1 IO_STD_SSTL_12_C2]
}

proc ::altera_emif::ip_top::phy::ddr4::get_supported_data_io_stds {voltage} {
   return [list IO_STD_POD_12]
}



proc ::altera_emif::ip_top::phy::ddr4::_init {} {
}

::altera_emif::ip_top::phy::ddr4::_init

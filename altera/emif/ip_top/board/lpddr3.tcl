...
package provide altera_emif::ip_top::board::lpddr3 0.1
...
namespace eval ::altera_emif::ip_top::board::lpddr3:: {
   ...
   variable m_param_prefix "BOARD_LPDDR3"
}


proc ::altera_emif::ip_top::board::lpddr3::create_parameters {is_top_level_component} {
   ...
   set_parameter_update_callback "PHY_LPDDR3_MEM_CLK_FREQ_MHZ"       ::altera_emif::ip_top::board::lpddr3::_update_slew_rates
   set_parameter_update_callback "${m_param_prefix}_USE_DEFAULT_SLEW_RATES" ::altera_emif::ip_top::board::lpddr3::_update_slew_rates

   set_parameter_update_callback "MEM_LPDDR3_DISCRETE_CS_WIDTH"               ::altera_emif::ip_top::board::lpddr3::_update_isi_values
   set_parameter_update_callback "${m_param_prefix}_USE_DEFAULT_ISI_VALUES" ::altera_emif::ip_top::board::lpddr3::_update_isi_values
    
   set_parameter_update_callback "MEM_LPDDR3_DISCRETE_CS_WIDTH"           ::altera_emif::ip_top::board::ddr3::_grey_out_board_values

   return 1
}

proc ::altera_emif::ip_top::board::lpddr3::set_family_specific_defaults {family_enum base_family_enum is_hps} {
   variable m_param_prefix
   
   return 1
}

proc ::altera_emif::ip_top::board::lpddr3::add_display_items {tabs} {
   variable m_param_prefix
...
proc ::altera_emif::ip_top::board::lpddr3::validate {} {
   variable m_param_prefix
   ...
   set tis_ac_mv          [get_parameter_value MEM_LPDDR3_TIS_AC_MV]
   set tih_dc_mv          [get_parameter_value MEM_LPDDR3_TIH_DC_MV]
   set tds_ac_mv          [get_parameter_value MEM_LPDDR3_TDS_AC_MV]
   set tdh_dc_mv          [get_parameter_value MEM_LPDDR3_TDH_DC_MV]
   ...
   set delta_tIS_ps       [derating_table_lookup $ac_slew_rates $ck_slew_rates  $table_delta_tIS $ac_slew_rate $ck_slew_rate  MEM_LPDDR3_TIS_AC_MV]
   set delta_tIH_ps       [derating_table_lookup $ac_slew_rates $ck_slew_rates  $table_delta_tIH $ac_slew_rate $ck_slew_rate  MEM_LPDDR3_TIH_DC_MV]
   set delta_tDS_ps       [derating_table_lookup $dq_slew_rates $dqs_slew_rates $table_delta_tDS $dq_slew_rate $dqs_slew_rate MEM_LPDDR3_TDS_AC_MV]
   set delta_tDH_ps       [derating_table_lookup $dq_slew_rates $dqs_slew_rates $table_delta_tDH $dq_slew_rate $dqs_slew_rate MEM_LPDDR3_TDH_DC_MV]
...
proc ::altera_emif::ip_top::board::lpddr3::_table_ac_slew_rates {speedbin} {
   return {4.0 3.0 2.0 1.5}
}

proc ::altera_emif::ip_top::board::lpddr3::_table_ck_slew_rates {speedbin} {
   return {8.0 7.0 6.0 5.0 4.0 3.0}
}

proc ::altera_emif::ip_top::board::lpddr3::_table_dq_slew_rates {speedbin} {
   return {4.0 3.0 2.0 1.5}
}

proc ::altera_emif::ip_top::board::lpddr3::_table_dqs_slew_rates {speedbin} {
   return {8.0 7.0 6.0 5.0 4.0 3.0}
}

proc ::altera_emif::ip_top::board::lpddr3::_table_delta_tIS {speedbin io_voltage tis_ac_mv} {
   if {$io_voltage == 1.2} {
      switch $tis_ac_mv {
         150 {
            return {{   38   38   38   38   38  999} \
                    { -999   25   25   25   25   38} \
                    { -999 -999    0    0    0   13} \
                    { -999 -999 -999  -25  -25  -12}}
         }
         135 {
            return {{   34   34   34   34   34  999} \
                    { -999   23   23   23   23   34} \
                    { -999 -999    0    0    0   11} \
                    { -999 -999 -999  -23  -23  -12}}
         }
         default {
            return [list]
         }
...
proc ::altera_emif::ip_top::board::lpddr3::_table_delta_tIH {speedbin io_voltage tih_dc_mv} {
   if {$io_voltage == 1.2} {
      switch $tih_dc_mv {
         100 {
            return {{   25   25   25   25   25  999} \
                    { -999   17   17   17   17   29} \
                    { -999 -999    0    0    0   13} \
                    { -999 -999 -999  -17  -17   -4}}
         }
...
proc ::altera_emif::ip_top::board::lpddr3::_table_delta_tDS {speedbin io_voltage tds_ac_mv} {
   if {$io_voltage == 1.2} {
      switch $tds_ac_mv {
         150 {
            return {{   38   38   38   38   38  999} \
...
proc ::altera_emif::ip_top::board::lpddr3::_table_delta_tDH {speedbin io_voltage tdh_dc_mv} {
   if {$io_voltage == 1.2} {
      switch $tdh_dc_mv {
         100 {
            return {{   25   25   25   25   25  999} \
...
proc ::altera_emif::ip_top::board::lpddr3::_check_derating_table_integrity {tbl} {
...
proc ::altera_emif::ip_top::board::lpddr3::_update_slew_rates {arg} {
   variable m_param_prefix
   ...
   if {$use_default || $gui_triggered} {
      set mem_freq     [get_parameter_value "PHY_LPDDR3_MEM_CLK_FREQ_MHZ"]
...
proc ::altera_emif::ip_top::board::lpddr3::_update_isi_values {arg} {
   variable m_param_prefix
   ...
   if {$use_default || $gui_triggered} {
      ...
      set rank_string [get_parameter_value "MEM_LPDDR3_DISCRETE_CS_WIDTH"]

      set family_enum [get_device_family_enum]
      set base_family_enum [enum_data $family_enum BASE_FAMILY_ENUM]

      set wdata_isi_ns [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "LPDDR3" $format_string "tCE_DQ_DQS_WT_RANK" $rank_string]
      set rdata_isi_ns [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "LPDDR3" $format_string "tCE_DQ_DQS_RD_RANK" $rank_string]
      set wclk_isi_ns  [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "LPDDR3" $format_string "tCE_DQS_CK_RANK" $rank_string]
      set ac_isi_ns    [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "LPDDR3" $format_string "tCE_CA_CK_RANK" $rank_string]
      set rclk_isi_ns  [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "LPDDR3" $format_string "tCE_DQS_RANK" $rank_string]
...
proc ::altera_emif::ip_top::board::lpddr3::_grey_out_board_values {arg} {
   variable m_param_prefix
   
   set num_total_ranks     [get_parameter_value "MEM_LPDDR3_DISCRETE_CS_WIDTH"]
...
proc ::altera_emif::ip_top::board::lpddr3::_init {} {

   if {[emif_utest_enabled]} {   
   
      emif_utest_start "::altera_emif::ip_top::board::lpddr3"
   
      
      foreach speedbin_enum [enums_of_type LPDDR3_SPEEDBIN] {
         set speedbin    [enum_data $speedbin_enum VALUE]
         
         foreach io_voltage [enum_data $speedbin_enum ALLOWED_VOLTAGES] {
            set lpddr3_acdc_enum "LPDDR3_ACDC_LPDDR3_$speedbin"
      
            foreach allowed_val [enum_data $lpddr3_acdc_enum ALLOWED_TIS_AC] {
            ...
            foreach allowed_val [enum_data $lpddr3_acdc_enum ALLOWED_TIH_DC] {
            ...
            foreach allowed_val [enum_data $lpddr3_acdc_enum ALLOWED_TDS_AC] {
            ...
            foreach allowed_val [enum_data $lpddr3_acdc_enum ALLOWED_TDH_DC] {
...
::altera_emif::ip_top::board::lpddr3::_init

...
package provide altera_emif::ip_top::board::qdr2 0.1
...
namespace eval ::altera_emif::ip_top::board::qdr2:: {
   ...
   variable m_param_prefix "BOARD_QDR2"
}


proc ::altera_emif::ip_top::board::qdr2::create_parameters {is_top_level_component} {
   variable m_param_prefix
   
   set k_slew_rate_default       4.0
   set ac_slew_rate_default      2.0
   set rclk_slew_rate_default    4.0
   set rdata_slew_rate_default   2.0
   ...
   add_user_param     "${m_param_prefix}_USER_K_SLEW_RATE"              float     $k_slew_rate_default       {0.1:10.0}       ""              "V/ns"         ""            ""
   ...
   add_user_param     "${m_param_prefix}_IS_SKEW_WITHIN_Q_DESKEWED"     boolean   false                      ""               ""              ""             ""            ""
   add_user_param     "${m_param_prefix}_IS_SKEW_WITHIN_D_DESKEWED"     boolean   false                      ""               ""              ""             ""            ""
   add_user_param     "${m_param_prefix}_IS_SKEW_WITHIN_AC_DESKEWED"    boolean   true                       ""               ""              ""             ""            ""
   add_user_param     "${m_param_prefix}_BRD_SKEW_WITHIN_Q_NS"          float     0.020                      {0:10.0}         "nanoseconds"   ""             ""            ""
   add_user_param     "${m_param_prefix}_BRD_SKEW_WITHIN_D_NS"          float     0.020                      {0:10.0}         "nanoseconds"   ""             ""            ""
   add_user_param     "${m_param_prefix}_BRD_SKEW_WITHIN_AC_NS"         float     0.020                      {0:10.0}         "nanoseconds"   ""             ""            ""
   add_user_param     "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_Q_NS"      float     0.020                      {0:10.0}         "nanoseconds"   ""             ""            ""
   add_user_param     "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_D_NS"      float     0.020                      {0:10.0}         "nanoseconds"   ""             ""            ""
   add_user_param     "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_AC_NS"     float     0.020                      {0:10.0}         "nanoseconds"   ""             ""            ""
   add_user_param     "${m_param_prefix}_AC_TO_K_SKEW_NS"               float     0.0                        ""               "nanoseconds"   ""             ""            ""
   add_user_param     "${m_param_prefix}_MAX_K_DELAY_NS"                float     0.6                        {0:10.0}         "nanoseconds"   ""             ""            ""

   add_derived_param  "${m_param_prefix}_K_SLEW_RATE"                   float     $k_slew_rate_default       true       ""            "V/ns"        ""            "${m_param_prefix}_USER_K_SLEW_RATE"       
   ...
   add_derived_param  "${m_param_prefix}_WCLK_SLEW_RATE"                float     $k_slew_rate_default       false      ""            "V/ns"        ""            "${m_param_prefix}_USER_K_SLEW_RATE"     
   ...
   add_derived_param  "${m_param_prefix}_SKEW_WITHIN_Q_NS"              float     0                          false      ""            ""            ""            ""    
   add_derived_param  "${m_param_prefix}_SKEW_WITHIN_D_NS"              float     0                          false      ""            ""            ""            ""    
   add_derived_param  "${m_param_prefix}_SKEW_WITHIN_AC_NS"             float     0                          false      ""            ""            ""            ""    
   
   set_parameter_update_callback "${m_param_prefix}_USE_DEFAULT_SLEW_RATES" ::altera_emif::ip_top::board::qdr2::_update_slew_rates
   set_parameter_update_callback "${m_param_prefix}_USE_DEFAULT_ISI_VALUES" ::altera_emif::ip_top::board::qdr2::_update_isi_values
    
   return 1
}

proc ::altera_emif::ip_top::board::qdr2::set_family_specific_defaults {family_enum base_family_enum is_hps} {
   variable m_param_prefix
   
   return 1
}

proc ::altera_emif::ip_top::board::qdr2::add_display_items {tabs} {
   variable m_param_prefix
   ...
   add_param_to_gui $skews_grp "${m_param_prefix}_IS_SKEW_WITHIN_Q_DESKEWED"   
   add_param_to_gui $skews_grp "${m_param_prefix}_BRD_SKEW_WITHIN_Q_NS"   
   add_param_to_gui $skews_grp "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_Q_NS"   
   add_param_to_gui $skews_grp "${m_param_prefix}_IS_SKEW_WITHIN_D_DESKEWED"   
   add_param_to_gui $skews_grp "${m_param_prefix}_BRD_SKEW_WITHIN_D_NS"   
   add_param_to_gui $skews_grp "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_D_NS"   
   ...
   add_param_to_gui $skews_grp "${m_param_prefix}_AC_TO_K_SKEW_NS"  

   add_text_to_gui  $skews_grp "${m_param_prefix}_INTRABUS_SKEWS_TXT_2" "<html><br><b>Signal delays:</b><br>" 
   add_param_to_gui $skews_grp "${m_param_prefix}_MAX_K_DELAY_NS" 
   
   return 1
}

proc ::altera_emif::ip_top::board::qdr2::validate {} {
   variable m_param_prefix
   
   set speedbin_enum      [get_parameter_value "MEM_QDR2_SPEEDBIN_ENUM"]
   set speedbin           [enum_data $speedbin_enum VALUE]

   set device_data_width  [get_parameter_value "MEM_QDR2_DATA_PER_DEVICE"]
   ...
   set_parameter_property  "${m_param_prefix}_USER_K_SLEW_RATE"               VISIBLE         $default_sr
   ...
   set_parameter_property  "${m_param_prefix}_K_SLEW_RATE"                    VISIBLE         $default_sr
   ...
   set pkg_Q_deskewed      [get_parameter_value "${m_param_prefix}_IS_SKEW_WITHIN_Q_DESKEWED"]
   set pkg_D_deskewed      [get_parameter_value "${m_param_prefix}_IS_SKEW_WITHIN_D_DESKEWED"]
   set pkg_AC_deskewed     [get_parameter_value "${m_param_prefix}_IS_SKEW_WITHIN_AC_DESKEWED"]
   set_parameter_property  "${m_param_prefix}_BRD_SKEW_WITHIN_Q_NS"           VISIBLE         [expr {!$pkg_Q_deskewed}]
   set_parameter_property  "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_Q_NS"       VISIBLE         [expr {$pkg_Q_deskewed}]
   set_parameter_property  "${m_param_prefix}_BRD_SKEW_WITHIN_D_NS"           VISIBLE         [expr {!$pkg_D_deskewed}]
   set_parameter_property  "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_D_NS"       VISIBLE         [expr {$pkg_D_deskewed}]
   ...
   if { $pkg_Q_deskewed } {
      set_parameter_value      "${m_param_prefix}_SKEW_WITHIN_Q_NS"               [get_parameter_value "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_Q_NS"]
   } else {
      if { $device_data_width == 9 } {
         set_parameter_value      "${m_param_prefix}_SKEW_WITHIN_Q_NS"               [expr {[get_parameter_value "${m_param_prefix}_BRD_SKEW_WITHIN_Q_NS"] + [enum_data  "PINS_9"   PKG_SKEW]}]
      } elseif { $device_data_width == 18 } {
         set_parameter_value      "${m_param_prefix}_SKEW_WITHIN_Q_NS"               [expr {[get_parameter_value "${m_param_prefix}_BRD_SKEW_WITHIN_Q_NS"] + [enum_data  "PINS_18"   PKG_SKEW]}]
      } elseif { $device_data_width == 36 } {
         set_parameter_value      "${m_param_prefix}_SKEW_WITHIN_Q_NS"               [expr {[get_parameter_value "${m_param_prefix}_BRD_SKEW_WITHIN_Q_NS"] + [enum_data  "PINS_36"   PKG_SKEW]}]
      }
   }
   if { $pkg_D_deskewed } {
      set_parameter_value      "${m_param_prefix}_SKEW_WITHIN_D_NS"               [get_parameter_value "${m_param_prefix}_PKG_BRD_SKEW_WITHIN_D_NS"]
   } else {
      if { $device_data_width == 9 } {
         set_parameter_value      "${m_param_prefix}_SKEW_WITHIN_D_NS"               [expr {[get_parameter_value "${m_param_prefix}_BRD_SKEW_WITHIN_D_NS"] + [enum_data  "PINS_9"   PKG_SKEW]}]
      } elseif { $device_data_width == 18 } {
         set_parameter_value      "${m_param_prefix}_SKEW_WITHIN_D_NS"               [expr {[get_parameter_value "${m_param_prefix}_BRD_SKEW_WITHIN_D_NS"] + [enum_data  "PINS_18"   PKG_SKEW]}]
      } elseif { $device_data_width == 36 } {
         set_parameter_value      "${m_param_prefix}_SKEW_WITHIN_D_NS"               [expr {[get_parameter_value "${m_param_prefix}_BRD_SKEW_WITHIN_D_NS"] + [enum_data  "PINS_36"   PKG_SKEW]}]
      }
   }
   if { $pkg_AC_deskewed } {
...
proc ::altera_emif::ip_top::board::qdr2::_table_ac_slew_rates {speedbin} {
   return {2.0 1.5 1.0 0.9 0.8 0.7 0.6 0.5 0.4}
}

proc ::altera_emif::ip_top::board::qdr2::_table_k_slew_rates {speedbin} {
   return {4.0 3.0 2.0 1.8 1.6 1.4 1.2 1.0}
}

proc ::altera_emif::ip_top::board::qdr2::_table_dq_slew_rates {speedbin} {
   return {2.0 1.5 1.0 0.9 0.8 0.7 0.6 0.5 0.4}
}

proc ::altera_emif::ip_top::board::qdr2::_table_dqs_slew_rates {speedbin} {
   return {4.0 3.0 2.0 1.8 1.6 1.4 1.2 1.0}
}

proc ::altera_emif::ip_top::board::qdr2::_update_slew_rates {arg} {
   variable m_param_prefix
   ...
   if {$use_default || $gui_triggered} {
      ...
      if {$use_default} {
         set_parameter_value "${m_param_prefix}_RDATA_SLEW_RATE"       $rdata_slew_rate_default
         set_parameter_value "${m_param_prefix}_WDATA_SLEW_RATE"       $wdata_slew_rate_default
         set_parameter_value "${m_param_prefix}_K_SLEW_RATE"           $k_slew_rate_default  
         ...
         set_parameter_value "${m_param_prefix}_WCLK_SLEW_RATE"        $k_slew_rate_default
      } else {
         set_parameter_value "${m_param_prefix}_USER_RDATA_SLEW_RATE"  $rdata_slew_rate_default
         set_parameter_value "${m_param_prefix}_USER_WDATA_SLEW_RATE"  $wdata_slew_rate_default
         set_parameter_value "${m_param_prefix}_USER_K_SLEW_RATE"      $k_slew_rate_default  
         ...
         set_parameter_value "${m_param_prefix}_USER_WCLK_SLEW_RATE"   $k_slew_rate_default
      }
   } else {
      ...
      set_parameter_value "${m_param_prefix}_K_SLEW_RATE"      [get_parameter_value "${m_param_prefix}_USER_K_SLEW_RATE"]
      ...
      set_parameter_value "${m_param_prefix}_WCLK_SLEW_RATE"   [get_parameter_value "${m_param_prefix}_USER_K_SLEW_RATE"]
   }
...
proc ::altera_emif::ip_top::board::qdr2::_update_isi_values {arg} {
   variable m_param_prefix
   ...
   if {$use_default || $gui_triggered} {
      ...
      set wdata_isi_ns [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "QDR_II+" $format_string "tCE_DQ_DQS_WT_RANK" $num_devices]
      set rdata_isi_ns [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "QDR_II+" $format_string "tCE_DQ_DQS_RD_RANK" $num_devices]
      set wclk_isi_ns  [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "QDR_II+" $format_string "tCE_DQS_CK_RANK" $num_devices]
      set ac_isi_ns    [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "QDR_II+" $format_string "tCE_CA_CK_RANK" $num_devices]
      set rclk_isi_ns  [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "QDR_II+" $format_string "tCE_DQS_RANK" $num_devices]
...
proc ::altera_emif::ip_top::board::qdr2::_init {} {

   if {[emif_utest_enabled]} {   
   
      emif_utest_start "::altera_emif::ip_top::board::qdr2"
         
      emif_utest_pass 
   }   
}

::altera_emif::ip_top::board::qdr2::_init

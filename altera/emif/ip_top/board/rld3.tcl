...
package provide altera_emif::ip_top::board::rld3 0.1
...
namespace eval ::altera_emif::ip_top::board::rld3:: {
   ...
   variable m_param_prefix "BOARD_RLD3"
}


proc ::altera_emif::ip_top::board::rld3::create_parameters {is_top_level_component} {
   variable m_param_prefix
   
   set ck_slew_rate_default    4.0
   set ac_slew_rate_default    2.0
   set rclk_slew_rate_default  7.0
   set wclk_slew_rate_default  4.0
   set rdata_slew_rate_default 3.5
   ...
   add_user_param     "${m_param_prefix}_IS_SKEW_WITHIN_QK_DESKEWED"    boolean   false                      ""               ""              ""             ""            ""
   ...
   set_parameter_update_callback "PHY_RLD3_MEM_CLK_FREQ_MHZ"       ::altera_emif::ip_top::board::rld3::_update_slew_rates
   set_parameter_update_callback "${m_param_prefix}_USE_DEFAULT_SLEW_RATES" ::altera_emif::ip_top::board::rld3::_update_slew_rates

   set_parameter_update_callback "MEM_RLD3_DEVICE_DEPTH"           ::altera_emif::ip_top::board::rld3::_update_isi_values
   set_parameter_update_callback "${m_param_prefix}_USE_DEFAULT_ISI_VALUES" ::altera_emif::ip_top::board::rld3::_update_isi_values
    
   set_parameter_update_callback "MEM_RLD3_DEVICE_DEPTH"           ::altera_emif::ip_top::board::rld3::_grey_out_board_values

   return 1
}

proc ::altera_emif::ip_top::board::rld3::set_family_specific_defaults {family_enum base_family_enum is_hps} {
   variable m_param_prefix
   
   return 1
}

proc ::altera_emif::ip_top::board::rld3::add_display_items {tabs} {
   variable m_param_prefix
...
proc ::altera_emif::ip_top::board::rld3::validate {} {
   variable m_param_prefix
   ...
   set tis_ac_mv          [get_parameter_value MEM_RLD3_TIS_AC_MV]
   set tds_ac_mv          [get_parameter_value MEM_RLD3_TDS_AC_MV]
   
   set ck_slew_rates      [_table_ck_slew_rates  $tis_ac_mv]
   set ac_slew_rates      [_table_ac_slew_rates  $tis_ac_mv]
   set dqs_slew_rates     [_table_dqs_slew_rates $tds_ac_mv]
   set dq_slew_rates      [_table_dq_slew_rates  $tds_ac_mv]
   
   set table_delta_tIS    [_table_delta_tIS $speedbin $io_voltage $tis_ac_mv]
   set table_delta_tIH    [_table_delta_tIH $speedbin $io_voltage 0]
   set table_delta_tDS    [_table_delta_tDS $speedbin $io_voltage $tds_ac_mv]
   set table_delta_tDH    [_table_delta_tDH $speedbin $io_voltage $tds_ac_mv]
   
   set delta_tIS_ps       [derating_table_lookup $ac_slew_rates $ck_slew_rates  $table_delta_tIS $ac_slew_rate $ck_slew_rate  0]
   set delta_tIH_ps       [derating_table_lookup $ac_slew_rates $ck_slew_rates  $table_delta_tIH $ac_slew_rate $ck_slew_rate  0]
   set delta_tDS_ps       [derating_table_lookup $dq_slew_rates $dqs_slew_rates $table_delta_tDS $dq_slew_rate $dqs_slew_rate 0]
   set delta_tDH_ps       [derating_table_lookup $dq_slew_rates $dqs_slew_rates $table_delta_tDH $dq_slew_rate $dqs_slew_rate 0]
...
proc ::altera_emif::ip_top::board::rld3::_table_ac_slew_rates {tis_ac_mv} {
   return {2.0 1.5 1.0 0.9 0.8 0.7 0.6 0.5 0.4}
}

proc ::altera_emif::ip_top::board::rld3::_table_ck_slew_rates {tis_ac_mv} {
   return {4.0 3.0 2.0 1.8 1.6 1.4 1.2 1.0}
}

proc ::altera_emif::ip_top::board::rld3::_table_dq_slew_rates {tds_ac_mv} {
	switch $tds_ac_mv {
		150 {   
			return {2.0 1.5 1.0 0.9 0.8 0.7 0.6 0.5 0.4}
   		}
		120 {
			return {4.0 3.5 3.0 2.5 2.0 1.5 1.0 0.9 0.8}
		}
		default {
            return [list]
        }
...
proc ::altera_emif::ip_top::board::rld3::_table_dqs_slew_rates {tds_ac_mv} {
   	switch $tds_ac_mv {
		150 {
			return {4.0 3.0 2.0 1.8 1.6 1.4 1.2 1.0}
   		}
		120 {
			return {8.0 7.0 6.0 5.0 4.0 3.0 2.0 1.8}
		}
		default {
            return [list]
        }
...
proc ::altera_emif::ip_top::board::rld3::_table_delta_tIS {speedbin io_voltage tis_ac_mv} {
	switch $tis_ac_mv {
		150 {
		...
		120 {
			return {{60 60 60 68 76 84 92 100} \
					{40 40 40 48 56 64 72 80} \
					{0 0 0 8 16 24 32 40} \
					{0 0 0 8 16 24 32 40} \
					{0 0 0 8 16 24 32 40} \
					{0 0 0 8 16 24 32 40} \
...
proc ::altera_emif::ip_top::board::rld3::_table_delta_tIH {speedbin io_voltage tih_dc_mv} {
...
proc ::altera_emif::ip_top::board::rld3::_table_delta_tDS {speedbin io_voltage tds_ac_mv} {
	switch $tds_ac_mv {
		150 {  
		...
		120 {			
			return   {{30 30 30 999 999 999 999 999} \
					{26 26 26 26 999 999 999 999} \
					{20 20 20 20 20 999 999 999} \
					{-999 12 12 12 12 12 999 999} \
					{-999 -999 0 0 0 0 0 999} \
					{-999 -999 -999 -20 -20 -20 -20 -12} \
					{-999 -999 -999 -999 -60 -60 -60 -52} \
					{-999 -999 -999 -999 -999  -60 -60 -52} \
					{-999 -999 -999 -999 -999 -999 -60 -52}}
		}
		default {
            return [list]
        }
...
proc ::altera_emif::ip_top::board::rld3::_table_delta_tDH {speedbin io_voltage tds_ac_mv} {
	switch $tds_ac_mv {
		150 {     
		...
		120 {		
			return   {{25 25 25 999 999 999 999 999} \
					{22 22 22 22 999 999 999 999} \
					{17 17 17 17 17 999 999 999} \
					{-999 12 12 12 12 12 999 999} \
					{-999 -999 0 0 0 0 0 999} \
					{-999 -999 -999 -16 -16 -16 -16 -8} \
					{-999 -999 -999 -999 -50 -50 -50 -42} \
					{-999 -999 -999 -999 -999 -50 -50 -42} \
					{-999 -999 -999 -999 -999 -999 -50 -42}}
		}
		default {
            return [list]
        }
...
proc ::altera_emif::ip_top::board::rld3::_check_derating_table_integrity {tbl} {
...
proc ::altera_emif::ip_top::board::rld3::_update_slew_rates {arg} {
   variable m_param_prefix
   ...
   if {$use_default || $gui_triggered} {
      set mem_freq  [get_parameter_value "PHY_RLD3_MEM_CLK_FREQ_MHZ"]
...
proc ::altera_emif::ip_top::board::rld3::_update_isi_values {arg} {
   variable m_param_prefix
   ...
   if {$use_default || $gui_triggered} {
      ...
      set num_total_ranks     [get_parameter_value "MEM_RLD3_DEVICE_DEPTH"]
      ...
      set wdata_isi_ns [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "RLDRAM3" $format_string "tCE_DQ_DQS_WT_RANK" $num_total_ranks]
      set rdata_isi_ns [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "RLDRAM3" $format_string "tCE_DQ_DQS_RD_RANK" $num_total_ranks]
      set wclk_isi_ns  [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "RLDRAM3" $format_string "tCE_DQS_CK_RANK" $num_total_ranks]
      set ac_isi_ns    [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "RLDRAM3" $format_string "tCE_CA_CK_RANK" $num_total_ranks]
      set rclk_isi_ns  [altera_emif::util::channel_uncertainty::get_global_channel_uncertainty_value $base_family_enum "RLDRAM3" $format_string "tCE_DQS_RANK" $num_total_ranks]
...
proc ::altera_emif::ip_top::board::rld3::_grey_out_board_values {arg} {
   variable m_param_prefix
...
proc ::altera_emif::ip_top::board::rld3::_init {} {

   if {[emif_utest_enabled]} {   
   
      emif_utest_start "::altera_emif::ip_top::board::rld3"
         
      
	  foreach allowed_val [enum_data RLD3_ACDC_ALL ALLOWED_TIS_AC] {
		  set tbl [_table_delta_tIS 0 0 $allowed_val]
		  emif_assert { [llength $tbl] != 0 } \
			 "Missing derating table for tIS of $allowed_val mV"
		  _check_derating_table_integrity $tbl
	  }
      
      set tbl [_table_delta_tIH 0 0 0]
      emif_assert { [llength $tbl] != 0 } \
         "Missing derating table for tIH"
      _check_derating_table_integrity $tbl

	  foreach allowed_val [enum_data RLD3_ACDC_ALL ALLOWED_TDS_AC] {
		  set tbl [_table_delta_tDS 0 0 $allowed_val]
		  emif_assert { [llength $tbl] != 0 } \
			 "Missing derating table for tDS of $allowed_val mV"
		  _check_derating_table_integrity $tbl
	  }

	  foreach allowed_val [enum_data RLD3_ACDC_ALL ALLOWED_TDS_AC] {
		  set tbl [_table_delta_tDH 0 0 $allowed_val]
		  emif_assert { [llength $tbl] != 0 } \
			 "Missing derating table for tDH of $allowed_val mV"
		  _check_derating_table_integrity $tbl
	  }
...
::altera_emif::ip_top::board::rld3::_init

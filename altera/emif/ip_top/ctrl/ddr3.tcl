...
package provide altera_emif::ip_top::ctrl::ddr3 0.1
...
namespace eval ::altera_emif::ip_top::ctrl::ddr3:: {
   ...
   variable m_param_prefix "CTRL_DDR3"
}


proc ::altera_emif::ip_top::ctrl::ddr3::create_parameters {is_top_level_component} {
   ...
   add_user_param     "${m_param_prefix}_ADDR_ORDER_ENUM"                string    DDR3_CTRL_ADDR_ORDER_CS_R_B_C   [enum_dropdown_entries DDR3_CTRL_ADDR_ORDER]  ""    ""              ""             CTRL_DDRX_ADDR_ORDER_ENUM
...
proc ::altera_emif::ip_top::ctrl::ddr3::set_family_specific_defaults {family_enum base_family_enum is_hps} {
   variable m_param_prefix
...
proc ::altera_emif::ip_top::ctrl::ddr3::add_display_items {tabs} {
   variable m_param_prefix
...
proc ::altera_emif::ip_top::ctrl::ddr3::validate {} {
   variable m_param_prefix
...
proc ::altera_emif::ip_top::ctrl::ddr3::_init {} {
}

proc ::altera_emif::ip_top::ctrl::ddr3::_derive_protocol_agnostic_parameters {} {
   variable m_param_prefix
   
   if {[get_parameter_value "PHY_DDR3_CONFIG_ENUM"] == "CONFIG_PHY_AND_HARD_CTRL"} { 
...
::altera_emif::ip_top::ctrl::ddr3::_init

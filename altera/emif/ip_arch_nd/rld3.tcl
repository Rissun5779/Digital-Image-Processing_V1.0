...
package provide altera_emif::ip_arch_nd::rld3 0.1
...
namespace eval ::altera_emif::ip_arch_nd::rld3:: {
...
proc ::altera_emif::ip_arch_nd::rld3::get_dqs_bus_mode {} {
   return DQS_BUS_MODE_X8_X9
}

proc ::altera_emif::ip_arch_nd::rld3::get_interface_ports {if_enum} {
   switch $if_enum {
      IF_MEM {
...
proc ::altera_emif::ip_arch_nd::rld3::is_ctrl_sideband_interface_enabled {if_enum} {
   return 0
}

proc ::altera_emif::ip_arch_nd::rld3::get_interface_properties {if_enum} {
   emif_ie "Interface type $if_enum not supported by [info level 0]"
   return 0

}

proc ::altera_emif::ip_arch_nd::rld3::get_ac_pin_map_scheme {} {
...
proc ::altera_emif::ip_arch_nd::rld3::get_resource_consumption {} {
...
proc ::altera_emif::ip_arch_nd::rld3::alloc_mem_pins {mem_ports_name} {
...
proc ::altera_emif::ip_arch_nd::rld3::assign_io_settings {ports_name} {
...
proc ::altera_emif::ip_arch_nd::rld3::get_clk_ratios {} {
...
proc ::altera_emif::ip_arch_nd::rld3::get_num_and_type_of_hmc_ports {} {
...
proc ::altera_emif::ip_arch_nd::rld3::get_hmc_cfgs {hmc_inst} {
   set retval [dict create]
...
proc ::altera_emif::ip_arch_nd::rld3::get_lane_cfgs {} {
...
proc ::altera_emif::ip_arch_nd::rld3::derive_seq_param_tbl {seq_pt_enums} {
...
proc ::altera_emif::ip_arch_nd::rld3::get_timing_params {} {
...
proc ::altera_emif::ip_arch_nd::rld3::is_phy_tracking_enabled {} {
   return [::altera_emif::ip_arch_nd::rldx::is_phy_tracking_enabled]
}

proc ::altera_emif::ip_arch_nd::rld3::is_phy_shadow_register_disabled {} {
   return 0
}


proc ::altera_emif::ip_arch_nd::rld3::_get_mem_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::rld3::_get_afi_ports {} {
...
proc ::altera_emif::ip_arch_nd::rld3::_get_ctrl_ast_properties {} {
...
proc ::altera_emif::ip_arch_nd::rld3::_get_ctrl_amm_properties {} {
   set props [dict create]
...
proc ::altera_emif::ip_arch_nd::rld3::_init {} {
}

::altera_emif::ip_arch_nd::rld3::_init

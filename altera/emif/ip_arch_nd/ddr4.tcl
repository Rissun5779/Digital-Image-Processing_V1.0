...
package provide altera_emif::ip_arch_nd::ddr4 0.1
...
namespace eval ::altera_emif::ip_arch_nd::ddr4:: {
...
proc ::altera_emif::ip_arch_nd::ddr4::get_dqs_bus_mode {} {
   return [::altera_emif::ip_arch_nd::ddrx::get_dqs_bus_mode]
}

proc ::altera_emif::ip_arch_nd::ddr4::get_interface_ports {if_enum} {
   switch $if_enum {
      IF_MEM {
...
proc ::altera_emif::ip_arch_nd::ddr4::is_ctrl_sideband_interface_enabled {if_enum} {
...
proc ::altera_emif::ip_arch_nd::ddr4::get_interface_properties {if_enum} {
   switch $if_enum {
      IF_CTRL_AMM {
...
proc ::altera_emif::ip_arch_nd::ddr4::get_ac_pin_map_scheme {} {
   ...
   if {$chip_id_width > 0} {
      dict set retval ENUM "DDR4_AC_PM_0_1_2_3_3DS"
   } else {
      if {$cke_width > 2 || $odt_width > 2 || $cs_width > 2 || $ck_width > 1} {
         dict set retval ENUM "DDR4_AC_PM_0_1_2_3"
      } else {
         dict set retval ENUM "DDR4_AC_PM_0_1_2"
      }
   }
   ...
   if {[get_parameter_value MEM_DDR4_ALERT_PAR_EN]} {
      ...
      if {[dict get $alert_n_placement PLACE_IN_AC_LANE] && [dict get $alert_n_placement AC_LANE_IDX] == 3} {
         if {[dict get $retval ENUM] == "DDR4_AC_PM_0_1_2"} {
            dict set retval ENUM "DDR4_AC_PM_0_1_2_3"
         }
      }
   }
   ...
   if {$format_enum == "MEM_FORMAT_LRDIMM"} {
      dict set retval HMC_DIMM_TYPE_STR "dimm_type_lrdimm"
   } elseif {$format_enum == "MEM_FORMAT_RDIMM"} {
      dict set retval HMC_DIMM_TYPE_STR "dimm_type_rdimm"
   } elseif {$format_enum == "MEM_FORMAT_UDIMM"} {
      dict set retval HMC_DIMM_TYPE_STR "dimm_type_udimm"
   } elseif {$format_enum == "MEM_FORMAT_SODIMM" || $format_enum == "MEM_FORMAT_DISCRETE"} {
      dict set retval HMC_DIMM_TYPE_STR "dimm_type_udimm"
   } else {
      emif_ie "Unsupported DIMM type $format_enum"
   }

   return $retval
}

proc ::altera_emif::ip_arch_nd::ddr4::get_resource_consumption {} {
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_alert_n_placement_scheme {} {
...
proc ::altera_emif::ip_arch_nd::ddr4::alloc_mem_pins {mem_ports_name} {
...
proc ::altera_emif::ip_arch_nd::ddr4::assign_io_settings {ports_name} {
   ...
   for {set i 0} {$i < [llength $ports]} {incr i} {
      ...
      switch $type_enum {
         ...
         PORT_MEM_ALERT_N {
            set cal_oct 0
            set io_std_enum IO_STD_SSTL_12
...
proc ::altera_emif::ip_arch_nd::ddr4::get_clk_ratios {} {
...
proc :::altera_emif::ip_arch_nd::ddr4::check_hmc_legality {} {
...
proc ::altera_emif::ip_arch_nd::ddr4::get_num_and_type_of_hmc_ports {} {
   set config_enum             [get_parameter_value PHY_DDR4_CONFIG_ENUM]
   set ping_pong_en            [get_parameter_value PHY_DDR4_PING_PONG_EN]
...
proc ::altera_emif::ip_arch_nd::ddr4::get_lane_cfgs {} {
   set retval [dict create]
...
proc ::altera_emif::ip_arch_nd::ddr4::get_hmc_cfgs {hmc_inst} {
   ...
   set geardown                             [get_parameter_value MEM_DDR4_GEARDOWN]
   ...
   dict set in_params GEARDOWN_EN         [expr {$geardown == "DDR4_GEARDOWN_QR" ? 1 : 0}]
   ...
   set wr_to_rd_diff_chip [hmc_div_ceil [expr {max($tmp_wr_to_rd_diff_chip, 1) + 1 + $trdpre_cyc + $wr_to_rd_extra_turnaround + $col_to_diff_col_offset}] $phy_hmc_clk_ratio]
   ...
   foreach hmc_cfg_enum [enums_of_type HMC_CFG] {
      ...
      switch $hmc_cfg_enum {
         ...
         HMC_CFG_WRITE_ODT_CHIP {
            set val [get_parameter_value MEM_DDR4_CTRL_CFG_WRITE_ODT_RANK]
         }
         HMC_CFG_READ_ODT_CHIP {
            set val [get_parameter_value MEM_DDR4_CTRL_CFG_READ_ODT_RANK]
         }
         HMC_CFG_WR_ODT_ON {
            set val 0
         }
         ...
         HMC_CFG_WR_ODT_PERIOD {
            set val [expr {int(5 + $twrpre_cyc)}]
         }
         HMC_CFG_RD_ODT_PERIOD {
            set val [expr {int(5 + max($twrpre_cyc, $trdpre_cyc))}]
         }
         ...
         HMC_CFG_BANK_GROUP_ADDR_WIDTH {
            set val "bank_group_width_[get_parameter_value MEM_DDR4_BANK_GROUP_WIDTH]"
         }
         ...
         HMC_CFG_WR_TO_WR_DIFF_CHIP {
            set val [expr {[hmc_div_ceil [expr {($bl / 2) + 1 + $twrpre_cyc + $col_to_diff_col_offset}] $phy_hmc_clk_ratio] + $user_wr_to_wr_diff_chip_delta_cyc}]
         }
         ...
         HMC_CFG_MRS_TO_VALID {
            set val [expr {int(($tmod_cyc - 1) / ($phy_hmc_clk_ratio / 2) / 2 + 1)}]
         }
         ...
         HMC_CFG_DDR4_MPS_ADDRMIRROR {
            set val [enum_data $hmc_cfg_enum DEFAULT]
         }
         HMC_CID_ADDR_WIDTH {
            set val [get_parameter_value MEM_DDR4_CHIP_ID_WIDTH]
         }
         HMC_CHIP_ID {
            set val [bin2num "100_010_001"]
         }
         HMC_3DS_EN {
            set val [expr {[get_parameter_value MEM_DDR4_CHIP_ID_WIDTH] > 0 ? "enable" : "disable"}]
         }
         HMC_3DS_REF2REF_DLR {
            set mem_if_3ds_trfc_dlr 0
            set val [hmc_div_ceil [expr {$mem_if_3ds_trfc_dlr + $sideband_offset}] $phy_hmc_clk_ratio]
         }
         HMC_3DS_LR_NUM0 -
         HMC_3DS_LR_NUM1 -
         HMC_3DS_LR_NUM2 -
         HMC_3DS_LR_NUM3 -
         HMC_3DS_PR_STAG_ENABLE -
         HMC_3DSREF_ACK_ON_DONE {
            set val [enum_data $hmc_cfg_enum DEFAULT]
         }         
         default {
            set val [enum_data $hmc_cfg_enum DEFAULT]
...
proc ::altera_emif::ip_arch_nd::ddr4::derive_seq_param_tbl {seq_pt_enums} {
...
proc ::altera_emif::ip_arch_nd::ddr4::get_timing_params {} {
...
proc ::altera_emif::ip_arch_nd::ddr4::is_phy_tracking_enabled {} {
   return [::altera_emif::ip_arch_nd::ddrx::is_phy_tracking_enabled]
}

proc ::altera_emif::ip_arch_nd::ddr4::is_phy_shadow_register_disabled {} {
   set format_enum    [get_parameter_value MEM_DDR4_FORMAT_ENUM]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_mem_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_afi_ports {} {
   set ports [list]
   ...
   set format_enum      [get_parameter_value MEM_DDR4_FORMAT_ENUM]
   set tpl_cyc          [enum_data [get_parameter_value MEM_DDR4_AC_PARITY_LATENCY] VALUE]
   set par_en           [expr {($tpl_cyc > 0) || ($format_enum == "MEM_FORMAT_LRDIMM") || ($format_enum == "MEM_FORMAT_RDIMM")}]
   ...
   lappend ports {*}[create_port  $par_en     PORT_AFI_PAR                      $sdr_ratio           ]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_ctrl_ast_properties {is_write} {
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_ctrl_ast_cmd_properties {} {
   set props [dict create]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_ctrl_ast_cmd_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_ctrl_ast_wr_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_ctrl_ast_rd_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_ctrl_amm_properties {} {
   set props [dict create]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_ctrl_amm_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr4::_get_ctrl_user_refresh_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr4::_init {} {
}

::altera_emif::ip_arch_nd::ddr4::_init

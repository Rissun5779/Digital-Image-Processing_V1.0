...
package provide altera_emif::ip_arch_nd::ddr3 0.1
...
namespace eval ::altera_emif::ip_arch_nd::ddr3:: {
...
proc ::altera_emif::ip_arch_nd::ddr3::get_dqs_bus_mode {} {
   return [::altera_emif::ip_arch_nd::ddrx::get_dqs_bus_mode]
}

proc ::altera_emif::ip_arch_nd::ddr3::get_interface_ports {if_enum} {
   switch $if_enum {
      IF_MEM {
...
proc ::altera_emif::ip_arch_nd::ddr3::get_interface_properties {if_enum} {
   switch $if_enum {
      IF_CTRL_AMM {
...
proc ::altera_emif::ip_arch_nd::ddr3::is_ctrl_sideband_interface_enabled {if_enum} {
...
proc ::altera_emif::ip_arch_nd::ddr3::get_ac_pin_map_scheme {} {
   ...
   if {$format_enum == "MEM_FORMAT_RDIMM"} {
      ...
      if {$format_enum == "MEM_FORMAT_DISCRETE"} {
         ...
         dict set retval HMC_DIMM_TYPE_STR "dimm_type_sodimm"
      } else {
...
proc ::altera_emif::ip_arch_nd::ddr3::get_resource_consumption {} {
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_alert_n_placement_scheme {} {
...
proc ::altera_emif::ip_arch_nd::ddr3::alloc_mem_pins {mem_ports_name} {
...
proc ::altera_emif::ip_arch_nd::ddr3::assign_io_settings {ports_name} {
...
proc ::altera_emif::ip_arch_nd::ddr3::get_clk_ratios {} {
...
proc :::altera_emif::ip_arch_nd::ddr3::check_hmc_legality {} {
...
proc ::altera_emif::ip_arch_nd::ddr3::get_num_and_type_of_hmc_ports {} {
   set config_enum             [get_parameter_value PHY_DDR3_CONFIG_ENUM]
   set ping_pong_en            [get_parameter_value PHY_DDR3_PING_PONG_EN]
...
proc ::altera_emif::ip_arch_nd::ddr3::get_lane_cfgs {} {
...
proc ::altera_emif::ip_arch_nd::ddr3::get_hmc_cfgs {hmc_inst} {
   ...
   foreach hmc_cfg_enum [enums_of_type HMC_CFG] {
      ...
      switch $hmc_cfg_enum {
         ...
         HMC_CFG_WRITE_ODT_CHIP {
            set val [get_parameter_value MEM_DDR3_CTRL_CFG_WRITE_ODT_RANK]
         }
         HMC_CFG_READ_ODT_CHIP {
            set val [get_parameter_value MEM_DDR3_CTRL_CFG_READ_ODT_RANK]
         }
         HMC_CFG_WR_ODT_ON {
            set val 0
         }
...
proc ::altera_emif::ip_arch_nd::ddr3::derive_seq_param_tbl {seq_pt_enums} {
...
proc ::altera_emif::ip_arch_nd::ddr3::get_timing_params {} {
...
proc ::altera_emif::ip_arch_nd::ddr3::is_phy_tracking_enabled {} {
   return [::altera_emif::ip_arch_nd::ddrx::is_phy_tracking_enabled]
}

proc ::altera_emif::ip_arch_nd::ddr3::is_phy_shadow_register_disabled {} {
   return 0
}


proc ::altera_emif::ip_arch_nd::ddr3::_get_mem_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_afi_ports {} {
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_ctrl_ast_properties {is_write} {
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_ctrl_ast_cmd_properties {} {
   set props [dict create]
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_ctrl_ast_cmd_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_ctrl_ast_wr_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_ctrl_ast_rd_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_ctrl_amm_properties {} {
   set props [dict create]
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_ctrl_amm_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr3::_get_ctrl_user_refresh_ports {} {
   set ports [list]
...
proc ::altera_emif::ip_arch_nd::ddr3::_init {} {
}

::altera_emif::ip_arch_nd::ddr3::_init

...
package provide altera_emif::ip_arch_nd::seq_param_tbl 0.1
...
namespace eval ::altera_emif::ip_arch_nd::seq_param_tbl:: {
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::derive_contents {mem_ports mem_pins_alloc} {
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::set_skip_cal {contents_varname skip_cal_on} {
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::set_sim_opts {contents_varname} {
   ...
   set skip_dcd_cal_val [expr {[enum_data SEQ_CONST_CALIB_SKIP_PIN_DCD_CK] |
                               [enum_data SEQ_CONST_CALIB_SKIP_PIN_DCD_DQS_OUT] |
                               [enum_data SEQ_CONST_CALIB_SKIP_PIN_DCD_DQS_IN] |
                               [enum_data SEQ_CONST_CALIB_SKIP_PIN_DCD_DQSB_IN] |
                               [enum_data SEQ_CONST_CALIB_SKIP_PIN_DCD_DQ_DM_CA_OUT] |
                               [enum_data SEQ_CONST_CALIB_SKIP_PIN_DCD_DQ_DBI_IN]}]
   ...
   dict set contents SEQ_GPT SEQ_GPT_GLOBAL_SKIP_STEPS [expr {[enum_data SEQ_CONST_GLOBAL_SKIP_RECEIVING_PARAM_TABLE VALUE] |
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::set_synth_opts {contents_varname} {
   ...
   dict set contents SEQ_GPT SEQ_GPT_GLOBAL_SKIP_STEPS [expr {[enum_data SEQ_CONST_GLOBAL_SKIP_PLL_DCC_CAL VALUE]}]
}

proc ::altera_emif::ip_arch_nd::seq_param_tbl::set_max_nios_freq_and_clk_divide {contents_varname is_sim} {
   upvar 1 $contents_varname contents
   if {$is_sim} {
      set val [expr {int(floor(1000000000.0 / [get_parameter_value SEQ_SIM_NIOS_PERIOD_PS]))}]
      dict set contents SEQ_GPT SEQ_GPT_NIOS_CLK_FREQ_KHZ $val
      
      set val [get_parameter_value SEQ_SIM_CAL_CLK_DIVIDE]
      dict set contents SEQ_GPT SEQ_GPT_SLAVE_CLK_DIVIDER $val
   } else {
      dict set contents SEQ_GPT SEQ_GPT_NIOS_CLK_FREQ_KHZ [enum_data SEQ_CONST_NOMINAL_NIOS_CLK_FREQ_KHZ VALUE]
      
      set val [get_parameter_value SEQ_SYNTH_CAL_CLK_DIVIDE]
      dict set contents SEQ_GPT SEQ_GPT_SLAVE_CLK_DIVIDER $val
   }
}

proc ::altera_emif::ip_arch_nd::seq_param_tbl::set_extra_configs_overrides {contents_varname is_sim} {
   ...
   if {[dict exists $extra_configs SEQ_GLOBAL_SKIP_STEPS_ADD]} {
      set orig [dict get $contents SEQ_GPT SEQ_GPT_GLOBAL_SKIP_STEPS]
      set curr [expr {$orig | [dict get $extra_configs SEQ_GLOBAL_SKIP_STEPS_ADD]}]
      dict set contents SEQ_GPT SEQ_GPT_GLOBAL_SKIP_STEPS $curr
   }
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::generate_sim_files {top_level contents} {
   set sim_params_filename [::altera_emif::ip_arch_nd::util::get_sim_params_hex_filename $top_level]
   return [altera_emif::arch_common::seq_param_tbl::generate_files $sim_params_filename $contents]
}

proc ::altera_emif::ip_arch_nd::seq_param_tbl::generate_synth_files {top_level contents} {
   set synth_params_filename [::altera_emif::ip_arch_nd::util::get_synth_params_hex_filename $top_level]
   return [altera_emif::arch_common::seq_param_tbl::generate_files $synth_params_filename $contents]
}

proc ::altera_emif::ip_arch_nd::seq_param_tbl::get_cal_data_common_section {} {
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::_derive_seq_glob_param_tbl {param_tbl_addr} {
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::_derive_seq_param_tbl {extra_data_addr mem_ports mem_pins_alloc} {
   ...
   foreach seq_pt_enum [enums_of_type SEQ_PT] {
      ...
      switch $seq_pt_enum {
         ...
         SEQ_PT_CAL_CONFIG {
            ...
            if {[::altera_emif::ip_arch_nd::protocol_expert::is_phy_shadow_register_disabled]} {
            ...
            if {[::altera_emif::ip_arch_nd::protocol_expert::is_phy_tracking_enabled]} {
                set val [expr {$val | [enum_data SEQ_CONST_CAL_ENABLE_PHY_TRACKING VALUE] }]
            }

            set val    [expr {$val | ([::altera_emif::ip_arch_nd::util::get_cal_config_silicon_rev] << [enum_data SEQ_SILICON_REV_SHIFT_ND VALUE])}]
         }
         SEQ_PT_DBG_CONFIG {
   ...
   set protocol_seq_param_tbl [::altera_emif::ip_arch_nd::protocol_expert::derive_seq_param_tbl $protocol_seq_params]
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::_get_tids {mem_pins_alloc ac_lanes data_lanes ping_pong_en} {
   ...
   lappend retval [dict create \
      ...
      VALUE     [::altera_emif::ip_arch_nd::util::get_center_tid $ac_tile_i] \
      ]
   incr tile_arr_index
   ...
   if {$ping_pong_en} {
      ...
      lappend retval [dict create \
         ...
         VALUE     [::altera_emif::ip_arch_nd::util::get_center_tid $sec_ac_tile_i] \
         ]
      incr tile_arr_index
   ...
   foreach tile_i [dict keys $mem_pins_alloc] {
      if {$tile_i != $ac_tile_i && $tile_i != $sec_ac_tile_i} {
         ...
         lappend retval [dict create \
            ...
            VALUE     [::altera_emif::ip_arch_nd::util::get_center_tid $tile_i] \
            ]
         incr tile_arr_index
      }
   }
   ...
   foreach ac_lane $ac_lanes {
      ...
      lappend retval [dict create \
         ...
         VALUE     [::altera_emif::ip_arch_nd::util::get_lane_tid $tile_i $lane_i] \
         ]
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::_get_pin_addresses {protocol_enum mem_pins_alloc ac_pin_map_enum ac_lanes data_lanes} {
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::_ac_pin_can_be_in_ac_lane_or_data_lane {protocol_enum port_enum} {
   set retval 0
...
proc ::altera_emif::ip_arch_nd::seq_param_tbl::_init {} {

   if {[emif_utest_enabled]} {

      emif_utest_start "::altera_emif::ip_arch_nd::seq_param_tbl"
...
::altera_emif::ip_arch_nd::seq_param_tbl::_init

...
package provide altera_emif::ip_arch_nd::protocol_expert 0.1
...
foreach protocol_enum [::altera_emif::util::enums::enums_of_type PROTOCOL] {
   ...
   set package_name "altera_emif::ip_arch_nd::${protocol_module}"
   set rc [catch {set version [package require $package_name]} result options]
}

namespace eval ::altera_emif::ip_arch_nd::protocol_expert:: {
...
proc ::altera_emif::ip_arch_nd::protocol_expert::run_elab_time_utests {} {
...
proc ::altera_emif::ip_arch_nd::protocol_expert::get_num_of_interfaces_used {if_enum} {
   set retval 0
...
proc ::altera_emif::ip_arch_nd::protocol_expert::get_interface_ports {if_enum} {
   set ports [list]
   ...
   switch $if_enum {
      ...
      IF_CAL_DEBUG_OUT {
         ...
         lappend ports {*}[create_port  $enabled    PORT_CAL_DEBUG_OUT_ADDRESS        32                 ]
      ...
      IF_CAL_MASTER {
         ...
         lappend ports {*}[create_port  $enabled    PORT_CAL_MASTER_ADDRESS           32                 ]
...
proc ::altera_emif::ip_arch_nd::protocol_expert::get_interface_properties {if_enum} {
   set func_name [_get_func_name "get_interface_properties"]
   return [$func_name $if_enum]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::get_ac_pin_map_scheme {} {
   set func_name [_get_func_name "get_ac_pin_map_scheme"]
   return [$func_name]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::get_resource_consumption {} {
   set func_name [_get_func_name "get_resource_consumption"]
   return [$func_name]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::alloc_mem_pins {mem_ports_name} {
   upvar 1 $mem_ports_name mem_ports
   set func_name [_get_func_name "alloc_mem_pins"]
   return [$func_name mem_ports]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::assign_io_settings {ports_name} {
   upvar 1 $ports_name ports
   set func_name [_get_func_name "assign_io_settings"]
   return [$func_name ports]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::get_dqs_bus_mode {} {
   set func_name [_get_func_name "get_dqs_bus_mode"]
   return [$func_name]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::get_clk_ratios {} {
   set func_name [_get_func_name "get_clk_ratios"]
   return [$func_name]
}

proc :::altera_emif::ip_arch_nd::protocol_expert::check_hmc_legality {} {
   set func_name [_get_func_name "check_hmc_legality"]
   return [$func_name]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::get_num_and_type_of_hmc_ports {} {
   set func_name [_get_func_name "get_num_and_type_of_hmc_ports"]
   return [$func_name]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::get_hmc_cfgs {hmc_inst} {
   set func_name [_get_func_name "get_hmc_cfgs"]
   return [$func_name $hmc_inst]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::is_ctrl_sideband_interface_enabled {if_enum} {
   set func_name [_get_func_name "is_ctrl_sideband_interface_enabled"]
   return [$func_name $if_enum]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::get_lane_cfgs {} {
   set func_name [_get_func_name "get_lane_cfgs"]
   return [$func_name]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::derive_seq_param_tbl {seq_pt_enums} {
   set func_name [_get_func_name "derive_seq_param_tbl"]
   return [$func_name $seq_pt_enums]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::get_timing_params {} {
   set func_name [_get_func_name "get_timing_params"]
   return [$func_name]
}

proc ::altera_emif::ip_arch_nd::protocol_expert::is_phy_tracking_enabled {} {
   set extra_configs_str [get_parameter_value "DIAG_EXTRA_CONFIGS"]
   set extra_configs     [parse_extra_configs $extra_configs_str]
...
proc ::altera_emif::ip_arch_nd::protocol_expert::is_phy_shadow_register_disabled {} {
   set extra_configs_str [get_parameter_value "DIAG_EXTRA_CONFIGS"]
   set extra_configs     [parse_extra_configs $extra_configs_str]
...
proc ::altera_emif::ip_arch_nd::protocol_expert::needs_emif_usr_half_clk {} {
...
proc ::altera_emif::ip_arch_nd::protocol_expert::_get_func_name {base_name {forced_protocol_enum ""}} {
   ...
   set protocol_module [::altera_emif::util::enums::enum_data $protocol_enum MODULE_NAME]
   set full_module "::altera_emif::ip_arch_nd::${protocol_module}"
...
proc ::altera_emif::ip_arch_nd::protocol_expert::_init {} {
}

::altera_emif::ip_arch_nd::protocol_expert::_init

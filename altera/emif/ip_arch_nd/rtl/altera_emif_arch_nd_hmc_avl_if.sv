...
module altera_emif_arch_nd_hmc_avl_if #(
   ...
   generate
      ...
      if (HMC_AVL_PROTOCOL_ENUM == "CTRL_AVL_PROTOCOL_MM") begin : amm
         ...
         // Port 0
         assign core2ctl_avl_0[0]            = (HMC_READY_LATENCY == 0 ? amm_read_0  : amm_read_0 & amm_ready_0); 
         assign core2ctl_avl_0[1]            = (HMC_READY_LATENCY == 0 ? amm_write_0 : amm_write_0 & amm_ready_0); 
         assign core2ctl_avl_0[36:2]         = amm_address_padded_0;
         assign core2ctl_avl_0[44:37]        = amm_burstcount_padded_0;
         assign core2ctl_avl_0[45]           = ctrl_user_priority_hi_0;
         assign core2ctl_avl_0[46]           = ctrl_auto_precharge_req_0;
         ...
         // AMM ready signal pipeline stages
         altera_emif_arch_nd_regs # (
            .REGISTER (HMC_READY_LATENCY),
            .WIDTH (1)
         ) amm_ready_0_regs (
            .clk (emif_usr_clk),
            .reset_n (emif_usr_reset_n),
            .data_in (ctl2core_avl_cmd_ready_0),
            .data_out (amm_ready_0)
         );
         
         // Port 1
         assign core2ctl_avl_1[0]            = (HMC_READY_LATENCY == 0 ? amm_read_1  : amm_read_1 & amm_ready_1); 
         assign core2ctl_avl_1[1]            = (HMC_READY_LATENCY == 0 ? amm_write_1 : amm_write_1 & amm_ready_1); 
         assign core2ctl_avl_1[36:2]         = amm_address_padded_1;
         assign core2ctl_avl_1[44:37]        = amm_burstcount_padded_1;
         assign core2ctl_avl_1[45]           = ctrl_user_priority_hi_1;
         assign core2ctl_avl_1[46]           = ctrl_auto_precharge_req_1;
         ...
         altera_emif_arch_nd_regs # (
            ...
            .clk (emif_usr_clk),
            .reset_n (emif_usr_reset_n),
            .data_in (ctl2core_avl_cmd_ready_1),
            .data_out (amm_ready_1)
         );

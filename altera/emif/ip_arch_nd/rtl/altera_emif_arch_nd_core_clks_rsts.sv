...
// altera message_off 10036
 ...
 module altera_emif_arch_nd_core_clks_rsts #(
   ...
   generate
      ...
      begin : slave
         ...
         assign global_reset_n_slave_in               = clks_sharing_slave_in[2];
         assign phy_reset_n_slave_in                  = clks_sharing_slave_in[3];
         ...
         assign cal_slave_clk_slave_in                = clks_sharing_slave_in[16];
...
`endif
         ...
         assign clks_sharing_master_out[2]  = global_reset_n_int;
         assign clks_sharing_master_out[3]  = phy_reset_n_int;
         ...
         assign clks_sharing_master_out[16] = cal_slave_clk;

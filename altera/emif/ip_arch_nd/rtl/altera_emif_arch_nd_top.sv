...
//
///////////////////////////////////////////////////////////////////////////////
module altera_emif_arch_nd_top #(
   ...
   // Output/input clock/reset intended for core logic that interacts with the sequencer CPU
   ...
   // Nios Debug
   input  logic [PORT_VJI_IR_IN_WIDTH-1:0]                    vji_ir_in,
   output logic [PORT_VJI_IR_OUT_WIDTH-1:0]                   vji_ir_out,
   ...
   initial begin
      ...
      assert(DB_PINS_PROC_MODE_AUTOGEN_WCNT           == 64) else $fatal("DB_PINS_PROC_MODE_AUTOGEN_WCNT != 64 - Parameter definitions in RTL and Tcl generation code are out of sync!");
      ...
      assert(DBC_PIPE_LATS_AUTOGEN_WCNT               == 5) else $fatal("DBC_PIPE_LATS_AUTOGEN_WCNT != 5 - Parameter definitions in RTL and Tcl generation code are out of sync!");
      assert(DB_PTR_PIPELINE_DEPTHS_AUTOGEN_WCNT      == 5) else $fatal("DB_PTR_PIPELINE_DEPTHS_AUTOGEN_WCNT != 5 - Parameter definitions in RTL and Tcl generation code are out of sync!");
      assert(DB_SEQ_RD_EN_FULL_PIPELINES_AUTOGEN_WCNT == 5) else $fatal("DB_SEQ_RD_EN_FULL_PIPELINES_AUTOGEN_WCNT != 5 - Parameter definitions in RTL and Tcl generation code are out of sync!");
   ...
   logic [PINS_IN_RTL_TILES-1:0]                                                            l2b_e_a;          
   logic [PINS_IN_RTL_TILES-1:0]                                                            l2b_e_b;          
...
`endif
   ...
   // synthesis translate_off
      if (DIAG_FAST_SIM) begin : gen_fast_sim
         altera_emif_arch_nd_pll_fast_sim # (
   ...
   altera_emif_arch_nd_pll_extra_clks # (
   ...
   generate
   if (IS_HPS) begin : hps
      altera_emif_arch_nd_hps_clks_rsts # (
         .IS_VID                              (IS_VID),
      ...
      altera_emif_arch_nd_core_clks_rsts # (
         .PHY_CONFIG_ENUM                     (PHY_CONFIG_ENUM),
   ...
   ////////////////////////////////////////////////////////////////////////////
   altera_emif_arch_nd_hmc_avl_if # (
      .NUM_OF_HMC_PORTS                     (NUM_OF_HMC_PORTS),
      .HMC_AVL_PROTOCOL_ENUM                (HMC_AVL_PROTOCOL_ENUM),
   ...
   ////////////////////////////////////////////////////////////////////////////
   altera_emif_arch_nd_hmc_sideband_if # (
      .PHY_PING_PONG_EN                     (PHY_PING_PONG_EN),
      .LANES_PER_TILE                       (LANES_PER_TILE),
      .NUM_OF_RTL_TILES                     (NUM_OF_RTL_TILES),
      .PRI_AC_TILE_INDEX                    (PRI_AC_TILE_INDEX),
   ...
   ////////////////////////////////////////////////////////////////////////////
   altera_emif_arch_nd_hmc_mmr_if # (
   ...
   begin : hmc
      ...
      begin : amm
         ...
         altera_emif_arch_nd_hmc_amm_data_if # (
            .PINS_PER_LANE                        (PINS_PER_LANE),
            .LANES_PER_TILE                       (LANES_PER_TILE),
            .NUM_OF_RTL_TILES                     (NUM_OF_RTL_TILES),
            .NUM_OF_HMC_PORTS                     (NUM_OF_HMC_PORTS),
      ...
      begin : hmc_ast
         altera_emif_arch_nd_hmc_ast_data_if # (
            .PINS_PER_LANE                        (PINS_PER_LANE),
            .LANES_PER_TILE                       (LANES_PER_TILE),
            .NUM_OF_RTL_TILES                     (NUM_OF_RTL_TILES),
            .NUM_OF_HMC_PORTS                     (NUM_OF_HMC_PORTS),

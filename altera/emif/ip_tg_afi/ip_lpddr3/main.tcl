...
package provide altera_emif::ip_tg_afi::ip_lpddr3::main 0.1
...
namespace eval ::altera_emif::ip_tg_afi::ip_lpddr3::main:: {
...
proc ::altera_emif::ip_tg_afi::ip_lpddr3::main::create_parameters {} {
   ...
   set_parameter_property MEM_LPDDR3_TRL_CYC                 HDL_PARAMETER true
   set_parameter_property MEM_LPDDR3_TWL_CYC                 HDL_PARAMETER true
   set_parameter_property MEM_LPDDR3_CTRL_CFG_READ_ODT_CHIP  HDL_PARAMETER true
   set_parameter_property MEM_LPDDR3_CTRL_CFG_WRITE_ODT_CHIP HDL_PARAMETER true

   return 1
}

proc ::altera_emif::ip_tg_afi::ip_lpddr3::main::elaboration_callback {} {
...
proc ::altera_emif::ip_tg_afi::ip_lpddr3::main::sim_vhdl_fileset_callback {top_level} {
   ::altera_emif::ip_tg_afi::util::sim_vhdl_fileset_callback $top_level [_generate_verilog_fileset]
}

proc ::altera_emif::ip_tg_afi::ip_lpddr3::main::sim_verilog_fileset_callback {top_level} {
   ::altera_emif::ip_tg_afi::util::sim_verilog_fileset_callback $top_level [_generate_verilog_fileset]
}

proc ::altera_emif::ip_tg_afi::ip_lpddr3::main::quartus_synth_fileset_callback {top_level} {
   ::altera_emif::ip_tg_afi::util::quartus_synth_fileset_callback $top_level [_generate_verilog_fileset]
}


proc ::altera_emif::ip_tg_afi::ip_lpddr3::main::_generate_verilog_fileset {} {
   
   set qdir $::env(QUARTUS_ROOTDIR)
	set common_dir "${qdir}/../ip/altera/emif/ip_tg_afi/common/rtl"
   
   set file_list [list \
      rtl/altera_emif_tg_afi_lpddr3_top.sv
   ]
 
   return $file_list
}

proc ::altera_emif::ip_tg_afi::ip_lpddr3::main::_init {} {
}

::altera_emif::ip_tg_afi::ip_lpddr3::main::_init

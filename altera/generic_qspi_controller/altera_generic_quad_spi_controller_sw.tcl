...
# Create a new driver
create_driver altera_generic_quad_spi_controller

# Associate it with some hardware known as "altera_generic_quad_spi_controller"
set_sw_property hw_class_name altera_generic_quad_spi_controller
...
# Header files
add_sw_property include_source HAL/inc/altera_generic_quad_spi_controller.h
add_sw_property include_source inc/altera_generic_quad_spi_controller_regs.h

# C/C++ source files
add_sw_property c_source HAL/src/altera_generic_quad_spi_controller.c

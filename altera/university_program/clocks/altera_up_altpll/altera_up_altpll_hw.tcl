...
add_parameter video_in string "5MP Digital Camera (THDB_D5M)"
set_parameter_property video_in DISPLAY_NAME "Video In"
set_parameter_property video_in GROUP "Settings"
set_parameter_property video_in UNITS None
set_parameter_property video_in AFFECTS_ELABORATION true
set_parameter_property video_in ALLOWED_RANGES {"5MP Digital Camera (THDB_D5M)" "8MP Digital Camera (D8M-GPIO)"}
set_parameter_property video_in VISIBLE true
set_parameter_property video_in ENABLED true
...
set_parameter_property video_out ALLOWED_RANGES {"2.4\" LCD on LT24" "4.3\" LCD (TRDB_LTM)" "8\" LCD on TPad/VEEK" "7\" LCD on VEEK-MT and MTL/MTL2 Modules"}
...
#	set num_clocks		[ get_parameter_value "num_clocks" ]
	...
	set video_in			[ get_parameter_value "video_in" ]
	...
	if { $type == "Video" } {
		...
		if { $video_in == "8MP Digital Camera (D8M-GPIO)" } {
			set_parameter_value "OUTCLK0_MULT" 2
			set_parameter_value "OUTCLK0_DIV" 5
        }

        if { $video_out == "8\" LCD on TPad/VEEK" } {
			set_parameter_value "OUTCLK2_MULT" 4
			set_parameter_value "OUTCLK2_DIV" 5
		} elseif { $video_out == "7\" LCD on VEEK-MT and MTL/MTL2 Modules" } {
			set_parameter_value "OUTCLK2_MULT" 2
			set_parameter_value "OUTCLK2_DIV" 3
		} elseif { $video_out == "2.4\" LCD on LT24" } {
			set_parameter_value "OUTCLK2_MULT" 3
			set_parameter_value "OUTCLK2_DIV" 10
		}
	...
	} elseif { [ string match -nocase "Max 10*" $gui_device_family ] } {
		set_parameter_value "OUTCLK0_MULT" 2
		set_parameter_value "OUTCLK0_DIV" 1
		set_parameter_value "OUTCLK1_MULT" 2
		set_parameter_value "OUTCLK1_DIV" 1
		set_parameter_value "OUTCLK2_MULT" 2
		set_parameter_value "OUTCLK2_DIV" 1
	...
	if {  [ string match -nocase "Cyclone III*" $gui_device_family ] } {
		...
		set_parameter_value "DEVICE_FAMILY" "MAX 10"
...
proc elaborate {} {
	...
	if { $type == "Video" } {
		...
		if { $video_out == "8\" LCD on TPad/VEEK" } {
			...
			set_interface_property outclk2 clockRate 15000000
		} else {
		...
		set_interface_property outclk0 clockRate 100000000
		set_interface_property outclk1 clockRate 100000000
		set_interface_property outclk2 clockRate 100000000

...
# | 
set_module_property DESCRIPTION "PS/2 controller for the DE-Series boards"
...
set_module_property DISPLAY_NAME "PS/2 Controller"
...
proc generate {} {
	...
	set cc_for_101us	[ format "CLOCK_CYCLES_FOR_101US:%.0f" [ expr $ref_clk_freq * 0.000101 ] ]
	set dw_for_101us	[ format "DATA_WIDTH_FOR_101US:%.0f" [ expr ceil (log($ref_clk_freq * 0.000101) / (log (2))) ] ]
	set cc_for_15ms	[ format "CLOCK_CYCLES_FOR_15MS:%.0f" [ expr $ref_clk_freq * 0.015 ] ]
	set dw_for_15ms	[ format "DATA_WIDTH_FOR_15MS:%.0f" [ expr ceil (log($ref_clk_freq * 0.015) / (log (2))) ] ]
	set cc_for_2ms		[ format "CLOCK_CYCLES_FOR_2MS:%.0f" [ expr $ref_clk_freq * 0.002 ] ]
	set dw_for_2ms		[ format "DATA_WIDTH_FOR_2MS:%.0f" [ expr ceil (log($ref_clk_freq * 0.002) / (log (2))) ] ]
...
add_documentation_link "User Guide" file:///ip/altera/university_program/communication/altera_up_avalon_rs232/doc/RS232.pdf

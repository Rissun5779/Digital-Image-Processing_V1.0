...
proc generate {} {
	...
	set baud_tick_count				[ format "BAUD_TICK_COUNT:%.0f" [ expr $ref_clk_freq / $baud ] ]
	set half_baud_tick_increment	[ format "HALF_BAUD_TICK_COUNT:%.0f" [ expr $ref_clk_freq / ($baud * 2) ] ]

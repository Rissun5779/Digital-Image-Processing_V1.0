...
add_file "hdl/altera_up_av_config_auto_init_ob_de2i_150.v" {SYNTHESIS SIMULATION}
add_file "hdl/altera_up_av_config_auto_init_ob_de10_standard.v" {SYNTHESIS SIMULATION}
...
set_parameter_property board ALLOWED_RANGES {"DE10-Standard" "DE1-SoC" "DE2-115" "DE2i-150"}
...
set_parameter_property sampling_rate ALLOWED_RANGES {"8 kHz" "32 kHz" "48 kHz" "96 kHz"}
...
proc validate {} {
	...
	if { ($device == "On-Board Peripherals") } {
		...
		if { $eai } {
			...
			if { $sampling_rate == "8 kHz" } {
				set_parameter_value "sr_register" 3
			} elseif { $sampling_rate == "32 kHz" } {
...
#	set use_ob_av_mode	[ format "USE_OB_AV_MODE:%d" [ string match "On-Board - Audio and Video (DE2)" $device ] ]
	...
	if { $eai } {
		...
		set use_ob_de2i_150_ai		[ format "USE_OB_DE2I_150_AUTO_INIT:%d" [ string match "DE2i-150" $board ] ]
		set use_ob_de1_soc_ai		[ format "USE_OB_DE1_SOC_AUTO_INIT:%d" [ string match "DE1-SoC" $board ] ]
		set use_ob_de10_standard_ai	[ format "USE_OB_DE10_STANDARD_AUTO_INIT:%d" [ string match "DE10-Standard" $board ] ]
		...
		set ai_sections "$use_ai;$use_ob_ai;$use_ob_de1_ai;$use_ob_de2_ai;$use_ob_de2_70_ai;$use_ob_de2_115_ai;$use_ob_de2i_150_ai;$use_ob_de1_soc_ai;$use_ob_de10_standard_ai;$use_dc2_ai;$use_d5m_ai;$use_lcm_ai;$use_ltm_ai"
	} else {
		set ai_sections "USE_AUTO_INIT:0;USE_OB_AUTO_INIT:0;USE_OB_DE1_AUTO_INIT:0;USE_OB_DE2_35_AUTO_INIT:0;USE_OB_DE2_70_AUTO_INIT:0;USE_OB_DE2_115_AUTO_INIT:0;USE_OB_DE2I_150_AUTO_INIT:0;USE_OB_DE1_SOC_AUTO_INIT:0;USE_OB_DE10_STANDARD_AUTO_INIT:0;USE_DC2_AUTO_INIT:0;USE_D5M_AUTO_INIT:0;USE_LCM_AUTO_INIT:0;USE_LTM_AUTO_INIT:0"
	}
...
add_documentation_link "User Guide" file://ip/altera/university_program/audio_video/altera_up_avalon_audio_and_video_config/doc/Audio_and_Video_Config.pdf

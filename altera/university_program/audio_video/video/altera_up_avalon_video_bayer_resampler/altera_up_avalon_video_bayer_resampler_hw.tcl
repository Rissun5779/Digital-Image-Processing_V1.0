...
add_parameter device string "5MP Digital Camera (THDB_D5M)"
...
set_parameter_property device ALLOWED_RANGES {"1.3MP Digital Camera (TRDB_DC2)" "5MP Digital Camera (THDB_D5M)" "8MP Digital Camera (D8M-GPIO)"}
#set_parameter_property device ALLOWED_RANGES {"Custom" "1.3MP Digital Camera (TRDB_DC2)" "5MP Digital Camera (THDB_D5M)"}
...
proc validate {} {
	...
	} elseif { $device == "8MP Digital Camera (D8M-GPIO)" } {
		set_parameter_property width_in VISIBLE true
		set_parameter_property height_in VISIBLE true
		set_parameter_value width_in "3264"
		set_parameter_value height_in "2448"
		send_message info "Change in Resolution: 3264 x 2448 -> 1632 x 1224"
	} elseif { $device == "5MP Digital Camera (THDB_D5M)" } {
		set_parameter_property width_in VISIBLE true
		set_parameter_property height_in VISIBLE true
...
proc generate {} {
	...
	set use_gr_line_first "USE_GREEN_RED_LINE_FIRST:0"
	set use_bg_line_first "USE_BLUE_GREEN_LINE_FIRST:0"
	set use_gb_line_first "USE_GREEN_BLUE_LINE_FIRST:0"
	if { $device == "1.3MP Digital Camera (TRDB_DC2)" } {
		set use_gr_line_first "USE_GREEN_RED_LINE_FIRST:1"
	}
	if { $device == "5MP Digital Camera (THDB_D5M)" } {
 		set use_gb_line_first "USE_GREEN_BLUE_LINE_FIRST:1"
	}
	if { $device == "8MP Digital Camera (D8M-GPIO)" } {
		set use_bg_line_first "USE_BLUE_GREEN_LINE_FIRST:1"
	}

	# set arguments
	set params "$ww;$width"
	set sections "$use_rg_line_first;$use_gr_line_first;$use_bg_line_first;$use_gb_line_first"

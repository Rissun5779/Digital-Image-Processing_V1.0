...
set_parameter_property video_source ALLOWED_RANGES {"On-board Video In (NTSC or PAL)" "1.3MP Digital Camera (TRDB_DC2)" "5MP Digital Camera (THDB_D5M)" "8MP Digital Camera (D8M-GPIO)"}
#set_parameter_property video_source ALLOWED_RANGES {"On-board Video In (NTSC or PAL)" "5MP Digital Camera (THDB_D5M)" "8MP Digital Camera (D8M-GPIO)"}
...
#		add_interface_port avalon_decoder_source stream_out_empty empty Output 1
		...
		if { $video_source == "5MP Digital Camera (THDB_D5M)" } {
...
#	set decoder_file "Altera_UP_Camera_Decoder_Bayer.v"
	...
	set sections "$use_onboard_video;$use_5mp_camera"

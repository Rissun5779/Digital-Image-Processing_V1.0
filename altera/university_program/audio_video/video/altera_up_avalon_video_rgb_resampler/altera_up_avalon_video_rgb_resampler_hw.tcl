...
# +-----------------------------------
# | connection point avalon_rgb_slave
# | 
add_interface avalon_rgb_slave avalon end 
set_interface_property avalon_rgb_slave associatedClock clk
set_interface_property avalon_rgb_slave associatedReset reset
set_interface_property avalon_rgb_slave addressAlignment DYNAMIC
set_interface_property avalon_rgb_slave bridgesToMaster ""
set_interface_property avalon_rgb_slave burstOnBurstBoundariesOnly false
#set_interface_property avalon_rgb_slave explicitAddressSpan 16
set_interface_property avalon_rgb_slave holdTime 0
set_interface_property avalon_rgb_slave isBigEndian  false
set_interface_property avalon_rgb_slave isFlash false
set_interface_property avalon_rgb_slave isMemoryDevice false
set_interface_property avalon_rgb_slave isNonVolatileStorage false
set_interface_property avalon_rgb_slave linewrapBursts false
set_interface_property avalon_rgb_slave maximumPendingReadTransactions 0
set_interface_property avalon_rgb_slave minimumUninterruptedRunLength 1
set_interface_property avalon_rgb_slave printableDevice false
set_interface_property avalon_rgb_slave readLatency 1
set_interface_property avalon_rgb_slave readWaitTime 0
set_interface_property avalon_rgb_slave setupTime 0
set_interface_property avalon_rgb_slave timingUnits cycles
set_interface_property avalon_rgb_slave writeWaitTime 0

#add_interface_port avalon_rgb_slave slave_address address Input 2
#add_interface_port avalon_rgb_slave slave_byteenable byteenable Input 4
add_interface_port avalon_rgb_slave slave_read read Input 1
#add_interface_port avalon_rgb_slave slave_write write Input 1
#add_interface_port avalon_rgb_slave slave_writedata writedata Input 32
add_interface_port avalon_rgb_slave slave_readdata readdata Output 32
# | 
# +-----------------------------------
...
proc generate {} {
	...
	set status_in_value	"STATUS_IN:16'h0000"
	if { $input_type == "1-bit Black/White" } {
		set status_in_value	"STATUS_IN:16'h0000"
	} elseif { $input_type == "8-bit Grayscale" } {
		set status_in_value	"STATUS_IN:16'h0007"
	} elseif { $input_type == "8-bit RGB" } {
		set status_in_value	"STATUS_IN:16'h0011"
	} elseif { $input_type == "9-bit RGB" } {
		set status_in_value	"STATUS_IN:16'h0012"
	} elseif { $input_type == "16-bit RGB" } {
		set status_in_value	"STATUS_IN:16'h0014"
	} elseif { $input_type == "24-bit RGB" } {
		set status_in_value	"STATUS_IN:16'h0017"
	} elseif { $input_type == "30-bit RGB" } {
		set status_in_value	"STATUS_IN:16'h0019"
	} elseif { $input_type == "12-bit RGBA" } {
		set status_in_value	"STATUS_IN:16'h0032"
	} elseif { $input_type == "16-bit RGBA" } {
		set status_in_value	"STATUS_IN:16'h0033"
	} elseif { $input_type == "24-bit RGBA" } {
		set status_in_value	"STATUS_IN:16'h0037"
	} elseif { $input_type == "40-bit RGBA" } {
		set status_in_value	"STATUS_IN:16'h0039"
	}

	set status_out_value	"STATUS_OUT:16'h0000"
	if { $output_type == "1-bit Black/White" } {
		set status_out_value	"STATUS_OUT:16'h0000"
	} elseif { $output_type == "8-bit Grayscale" } {
		set status_out_value	"STATUS_OUT:16'h0007"
	} elseif { $output_type == "8-bit RGB" } {
		set status_out_value	"STATUS_OUT:16'h0011"
	} elseif { $output_type == "9-bit RGB" } {
		set status_out_value	"STATUS_OUT:16'h0012"
	} elseif { $output_type == "16-bit RGB" } {
		set status_out_value	"STATUS_OUT:16'h0014"
	} elseif { $output_type == "24-bit RGB" } {
		set status_out_value	"STATUS_OUT:16'h0017"
	} elseif { $output_type == "30-bit RGB" } {
		set status_out_value	"STATUS_OUT:16'h0019"
	} elseif { $output_type == "12-bit RGBA" } {
		set status_out_value	"STATUS_OUT:16'h0032"
	} elseif { $output_type == "16-bit RGBA" } {
		set status_out_value	"STATUS_OUT:16'h0033"
	} elseif { $output_type == "24-bit RGBA" } {
		set status_out_value	"STATUS_OUT:16'h0037"
	} elseif { $output_type == "40-bit RGBA" } {
		set status_out_value	"STATUS_OUT:16'h0039"
	}
	...
	# set arguments
	set params "$input_dw;$output_dw;$input_ew;$output_ew;$alpha_value;$status_in_value;$status_out_value"

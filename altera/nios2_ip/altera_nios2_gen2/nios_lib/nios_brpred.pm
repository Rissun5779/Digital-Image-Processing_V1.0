...
gen_static_brpred_frontend
{
    ...
    e_assign->adds(
      ...
      [["${ps}_br_cond_pred_taken", 1], 
        $cdx_present ? "${ps}_iw_imm16[15] | ${ps}_ctrl_br_always_pred_taken | ( ${ps}_ctrl_narrow & ${ps}_iw_t1i7_imm7[6])" :
...
gen_static_brpred_backend
{
    ...
    e_assign->adds(
      ...
      [["E_br_cond_pred_taken", 1], 
        $cdx_present ? "E_iw_imm16[15] | E_ctrl_br_always_pred_taken | (E_ctrl_narrow & E_iw_t1i7_imm7[6])" :

...
elaborate_nios_infos
{
    ...
    my $fa_info = manditory_hash($nios_infos, "fa_info");
    ...
    $elaborated_infos->{nios_isa_info} = 
      nios_isa::validate_and_elaborate($local_mmu_present, $local_mpu_present);

    my $local_fa_present = manditory_bool($fa_info,"fa_present");

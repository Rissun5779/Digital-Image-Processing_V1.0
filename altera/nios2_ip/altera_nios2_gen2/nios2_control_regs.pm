...
@EXPORT = qw(
    ...
    $cdsr_reg_regnum $cdsr_reg_sz $cdsr_reg_lsb $cdsr_reg_msb
    ...
    $eccinj_reg_dcwb $eccinj_reg_dcwb_sz $eccinj_reg_dcwb_lsb $eccinj_reg_dcwb_msb
    ...
    $mpuacc_reg_perm $mpuacc_reg_perm_sz $mpuacc_reg_perm_lsb 
      $mpuacc_reg_perm_msb
    $mpuacc_reg_mt $mpuacc_reg_mt_sz $mpuacc_reg_mt_lsb $mpuacc_reg_mt_msb
    $mpuacc_reg_s $mpuacc_reg_s_sz $mpuacc_reg_s_lsb $mpuacc_reg_s_msb
    ...
    $cdsr_reg_status $cdsr_reg_status_sz $cdsr_reg_status_lsb 
      $cdsr_reg_status_msb
);
...
our $eccinj_reg_dcwb_sz;
our $eccinj_reg_dcwb_lsb;
our $eccinj_reg_dcwb_msb;
...
our $mpuacc_reg_mt_sz;
our $mpuacc_reg_mt_lsb;
our $mpuacc_reg_mt_msb;
our $mpuacc_reg_s_sz;
our $mpuacc_reg_s_lsb;
our $mpuacc_reg_s_msb;
...
our $cdsr_reg_status_sz;
our $cdsr_reg_status_lsb;
our $cdsr_reg_status_msb;
...
create_control_reg_args_from_infos
{
    ...
    my $control_reg_args = {
      ...
      victim_buf_ram => (not_empty_scalar($dcache_info, "cache_dcache_victim_buf_impl") eq "ram"),
      mpx_present => manditory_bool($misc_info, "mpx_present"),
      
      oci_version => manditory_int($debug_info, "oci_version"),
    };
...
create_control_reg_args_max_configuration
{
    my $control_reg_args = {
      ...
      mpu_present => 1,
        mpu_min_inst_region_size_log2 => 8,
        mpu_min_data_region_size_log2 => 8,
...
convert_to_c
{
    ...
    foreach my $control_reg (@$control_regs) {
        if (!defined(
          convert_control_reg_to_c($control_reg, $c_lines, $h_lines, $prefix))) {
            return undef;
        }
    }
...
create_control_regs
{
    ...
    my $mpx_present = manditory_bool($args, "mpx_present");
    ...
    my $victim_buf_ram = manditory_bool($args, "victim_buf_ram");
    ...
    my $is_oci_version2 = (manditory_int($args, "oci_version") == 2);
    ...
    if ($ecc_present) {
        ...
        if (manditory_bool($args, "dc_ecc_present")) {
            ...
            if (manditory_bool($args, "victim_buf_ram")) { 
                $eccinj_reg_dcwb = add_control_reg_field($eccinj_reg, 
                  { name => "dcwb", lsb => 20, sz => 2 });
            }
        }
    ...
    if ($mpu_present) {
        ...
        $mpuacc_reg_mt = add_control_reg_field($mpuacc_reg, 
          { name => "mt", lsb => 5, sz => 2 });
        $mpuacc_reg_s = add_control_reg_field($mpuacc_reg, 
          { name => "s", lsb => 7, sz => 1 });
    ...
    $cdsr_reg = add_control_reg($control_regs, 
      { name => "cdsr", num => 31 });
    
    $cdsr_reg_status = add_control_reg_field($cdsr_reg, 
      { name => "status", lsb => 0, sz => 32 });

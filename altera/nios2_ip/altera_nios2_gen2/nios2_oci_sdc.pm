...
sub make_nios2_oci_sdc
{
  ...
  print SDC_FILE "set \t" . $cpu ."_wrapper \t" . $cpu .  "_debug_slave_wrapper:the_" . $cpu .  "_debug_slave_wrapper\n";
  print SDC_FILE "set \t" . $cpu ."_jtag_tck \t" . $cpu .  "_debug_slave_tck:the_" . $cpu .  "_debug_slave_tck\n";
  print SDC_FILE "set \t" . $cpu ."_jtag_sysclk \t" . $cpu .  "_debug_slave_sysclk:the_" . $cpu .  "_debug_slave_sysclk\n";
  ...
  print SDC_FILE "set_false_path -from [get_keepers *\$".$cpu."_oci_itrace_path|debugack] -to [get_keepers *\$".$cpu."_jtag_sr*]\n";
  }

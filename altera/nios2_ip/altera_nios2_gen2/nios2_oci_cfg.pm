...
@EXPORT = qw(
    ...
    $BREAK_STATUS_DBRK0_POS          
    $BREAK_STATUS_DBRK1_POS          
    $BREAK_STATUS_DBRK2_POS          
    $BREAK_STATUS_DBRK3_POS          
    $BREAK_STATUS_XBRK0_POS          
    $BREAK_STATUS_XBRK1_POS          
    $BREAK_STATUS_XBRK2_POS          
    $BREAK_STATUS_XBRK3_POS          
    $BREAK_STATUS_TS_POS             
    
    $XBRK_CONTROL_BRK_POS
    $XBRK_CONTROL_TOUT_POS
    $XBRK_CONTROL_TOFF_POS 
    $XBRK_CONTROL_TON_POS 
    $XBRK_CONTROL_ARM0_POS
    $XBRK_CONTROL_ARM1_POS 
    $XBRK_CONTROL_GOTO0_POS 
    $XBRK_CONTROL_GOTO1_POS 
    
    $DBRK_CONTROL_PAIR_POS 
    $DBRK_CONTROL_ST_POS 
    $DBRK_CONTROL_LD_POS 
    $DBRK_CONTROL_AU_POS 
    $DBRK_CONTROL_DU_POS 
    $DBRK_CONTROL_BRK_POS 
    $DBRK_CONTROL_TOUT_POS 
    $DBRK_CONTROL_TOFF_POS 
    $DBRK_CONTROL_TON_POS 
    $DBRK_CONTROL_TME_POS 
    $DBRK_CONTROL_ARM0_POS 
    $DBRK_CONTROL_ARM1_POS 
    $DBRK_CONTROL_GOTO0_POS 
    $DBRK_CONTROL_GOTO1_POS 
    
    $TRACE_STATUS_TRCACQADDR_MSB_POS 
    $TRACE_STATUS_TRCACQADDR_LSB_POS 
    $TRACE_STATUS_TRCACQADDR_BITS    
                                     
    $TRACE_STATUS_TW_POS             
    $TRACE_STATUS_ON_POS             
    
    $TRACE_CONTROL_ENB_POS     
    $TRACE_CONTROL_ON_OFF_POS  
    $TRACE_CONTROL_SYN_LSB_POS 
    $TRACE_CONTROL_SYN_MSB_POS 
    $TRACE_CONTROL_SYN_POS     
    $TRACE_CONTROL_TX_POS      
    $TRACE_CONTROL_TD_LSB_POS  
    $TRACE_CONTROL_TD_MSB_POS  
    $TRACE_CONTROL_TD_POS      
    $TRACE_CONTROL_OFC_POS     
    $TRACE_CONTROL_DB_POS      
    $TRACE_CONTROL_FULL_POS    
    $TRACE_CONTROL_TWR_POS      
    $TRACE_CONTROL_TAAR_POS      
...
our $CFGROM_ADDRESS_OFFSET = 0x100;
...
our $BREAK_STATUS_DBRK0_POS           = 0;
our $BREAK_STATUS_DBRK1_POS           = 1;
our $BREAK_STATUS_DBRK2_POS           = 2;
our $BREAK_STATUS_DBRK3_POS           = 3;
our $BREAK_STATUS_XBRK0_POS           = 4;
our $BREAK_STATUS_XBRK1_POS           = 5;
our $BREAK_STATUS_XBRK2_POS           = 6;
our $BREAK_STATUS_XBRK3_POS           = 7;
our $BREAK_STATUS_TS_POS              = 8;

our $XBRK_CONTROL_BRK_POS          = 0;
our $XBRK_CONTROL_TOUT_POS         = 1;
our $XBRK_CONTROL_TOFF_POS         = 2;
our $XBRK_CONTROL_TON_POS          = 3;
our $XBRK_CONTROL_ARM0_POS         = 4;
our $XBRK_CONTROL_ARM1_POS         = 5;
our $XBRK_CONTROL_GOTO0_POS        = 6;
our $XBRK_CONTROL_GOTO1_POS        = 7;

our $DBRK_CONTROL_PAIR_POS         = 0;
our $DBRK_CONTROL_ST_POS           = 1;
our $DBRK_CONTROL_LD_POS           = 2;
our $DBRK_CONTROL_AU_POS           = 3;
our $DBRK_CONTROL_DU_POS           = 4;
our $DBRK_CONTROL_BRK_POS          = 5;
our $DBRK_CONTROL_TOUT_POS         = 6;
our $DBRK_CONTROL_TOFF_POS         = 7;
our $DBRK_CONTROL_TON_POS          = 8;
our $DBRK_CONTROL_TME_POS          = 9;
our $DBRK_CONTROL_ARM0_POS         = 10;
our $DBRK_CONTROL_ARM1_POS         = 11;
our $DBRK_CONTROL_GOTO0_POS        = 12;
our $DBRK_CONTROL_GOTO1_POS        = 13;

our $TRACE_STATUS_TRCACQADDR_MSB_POS = 15;
our $TRACE_STATUS_TRCACQADDR_LSB_POS = 2;
our $TRACE_STATUS_TRCACQADDR_BITS    = "$TRACE_STATUS_TRCACQADDR_MSB_POS : 
                                        $TRACE_STATUS_TRCACQADDR_LSB_POS";
our $TRACE_STATUS_TW_POS             = 1;
our $TRACE_STATUS_ON_POS             = 0;

our $TRACE_CONTROL_ENB_POS      = 0;
our $TRACE_CONTROL_ON_OFF_POS   = 1;
our $TRACE_CONTROL_SYN_LSB_POS  = 2;
our $TRACE_CONTROL_SYN_MSB_POS  = 3;
our $TRACE_CONTROL_SYN_POS      = "$TRACECTRL_SYN_MSB_POS : $TRACECTRL_SYN_LSB_POS";
our $TRACE_CONTROL_TX_POS       = 4;
our $TRACE_CONTROL_TD_LSB_POS   = 5;
our $TRACE_CONTROL_TD_MSB_POS   = 7;
our $TRACE_CONTROL_TD_POS       = "$TRACECTRL_TD_MSB_POS : $TRACECTRL_TD_LSB_POS";
our $TRACE_CONTROL_OFC_POS      = 8;
our $TRACE_CONTROL_DB_POS       = 9;
our $TRACE_CONTROL_FULL_POS     = 10;
our $TRACE_CONTROL_TWR_POS      = 11;
our $TRACE_CONTROL_TAAR_POS     = 12;

...
//---------------------------------------------------------------------------
   ...
   begin
     if (rst) fmt_err = 1'b1;
	 else if (mode_dl) begin                      //CASE:212658 - Dual link mode when TX is sending 1080p30, RX can receive 2x 1080pi60
	   if (tx_format == 4'b1100 & rx_format == 4'b0100) fmt_err = 1'b0;
	   else if (tx_format == 4'b1101 & rx_format == 4'b0101) fmt_err = 1'b0;
	   else if (tx_format == rx_format) fmt_err = 1'b0;
	   else fmt_err = 1'b1;
	 end
     else begin

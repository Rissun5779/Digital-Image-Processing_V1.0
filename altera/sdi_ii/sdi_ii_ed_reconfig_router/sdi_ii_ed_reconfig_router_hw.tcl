...
proc elaboration_callback {} {
  ...
  if { $vid_std == "tr" || $vid_std == "ds" } {
    ...
    common_add_optional_conduit sdi_rx_std_du_ch0                 export  input  3   true
    if { $dir == "du" } {
      ...
      common_add_optional_conduit sdi_rx_std_du_ch1               export  input  3   true
    } else {
      ...
      common_add_optional_conduit sdi_rx_std_rx_ch1               export  input  3   true
    }  
    ...
    common_add_optional_conduit sdi_rx_std_to_mgmt            export  output  3*NUM_CHS   true
  }

...
(
  ...
  // --------------------------------------------------------------------------
  input  [2:0]                                  sdi_rx_std_rx_ch1,
  input  [2:0]                                  sdi_rx_std_du_ch1,
  input                                         sdi_tx_pll_sel_tx_ch1,
  input                                         sdi_tx_pll_sel_du_ch1,
  input  [2:0]                                  sdi_rx_std_du_ch0,
  // --------------------------------------------------------------------------
  ...
  output [NUM_CHS*3-1:0]                        sdi_rx_std_to_mgmt,
  ...
  localparam ch1_reconfig_interfaces = XCVR_TX_PLL_SEL == 1   ? 3 : 2;
  ...
  generate if (VIDEO_STANDARD == "dl" & DIRECTION == "du")
     begin : rcfg_fr_xcvr_gen
        assign reconfig_from_xcvr = {reconfig_from_xcvr_du_ch1_b, reconfig_from_xcvr_du_ch1, reconfig_from_xcvr_du_ch0_b, reconfig_from_xcvr_du_ch0};

     end else if (VIDEO_STANDARD == "dl" & DIRECTION != "du" & ~RX_EN_A2B_CONV) begin
        assign reconfig_from_xcvr = {reconfig_from_xcvr_tx_ch1_b, reconfig_from_xcvr_tx_ch1, reconfig_from_xcvr_rx_ch1_b,
                                       reconfig_from_xcvr_rx_ch1, reconfig_from_xcvr_du_ch0_b, reconfig_from_xcvr_du_ch0};

     end else if (VIDEO_STANDARD == "dl" & DIRECTION != "du" & RX_EN_A2B_CONV) begin
        assign reconfig_from_xcvr = {reconfig_from_xcvr_tx_smpte372, reconfig_from_xcvr_rx_smpte372, reconfig_from_xcvr_tx_ch1_b, reconfig_from_xcvr_tx_ch1, 
                                       reconfig_from_xcvr_rx_ch1_b, reconfig_from_xcvr_rx_ch1, reconfig_from_xcvr_du_ch0_b, reconfig_from_xcvr_du_ch0};

     end else if (VIDEO_STANDARD != "dl" & DIRECTION == "du") begin
        assign reconfig_from_xcvr = {reconfig_from_xcvr_du_ch1, reconfig_from_xcvr_du_ch0};

     end else if (VIDEO_STANDARD != "dl" & DIRECTION != "du" & ~RX_EN_A2B_CONV) begin
        assign reconfig_from_xcvr = {reconfig_from_xcvr_tx_ch1, reconfig_from_xcvr_rx_ch1, reconfig_from_xcvr_du_ch0};

     end else if (VIDEO_STANDARD != "dl" & DIRECTION != "du" & ~RX_EN_A2B_CONV) begin
        assign reconfig_from_xcvr = {reconfig_from_xcvr_rx_smpte372_b, reconfig_from_xcvr_tx_smpte372, reconfig_from_xcvr_rx_smpte372_b, reconfig_from_xcvr_rx_smpte372, 
  ...
  input integer XCVR_TX_PLL_SEL;
    begin
      select_width = ( XCVR_TX_PLL_SEL == 1 ) ? 3 : 2;
    end
  endfunction

...
proc compose_arria_10 {dir config device video_std 2xhd txpll xcvr_tx_pll_sel insert_vpid extract_vpid crc_err a2b b2a atxpll_data_rate hd_frequency} {
...
# |
   ...
   if { $video_std == "hd" | $video_std == "dl" | $video_std == "threeg" } {
      set req_os 0
   } else {
      set req_os 1
   }
   ...
   if { $tx_component } {
      ...
      if { $gen_proto } {
         ...
         if { $req_os } {
            ...
            tx_protocol__add_export_interface u_tx_protocol proto $insert_vpid  $video_std
         }
      }
      ...
      if { $req_os } {
         ...
         add_tx_clk_rst_connection proto  $dir  $video_std  $device $hd_frequency
      }
   }

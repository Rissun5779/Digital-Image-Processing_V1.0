...
proc generate_files {name} {
  if {1} {
   ...
   #add_fileset_file mentor/src_hdl/sdi_anctrack.v           VERILOG_ENCRYPT PATH "mentor/src_hdl/sdi_ii_anctrack.v"                         {MENTOR_SPECIFIC}
    ...
    add_fileset_file mentor/src_hdl/sdi_ii_rx_prealign.v     VERILOG_ENCRYPT PATH "mentor/src_hdl/sdi_ii_rx_prealign.v"                      {MENTOR_SPECIFIC}
    add_fileset_file mentor/src_hdl/sdi_ii_sync_bit_rmv.v    VERILOG_ENCRYPT PATH "mentor/src_hdl/sdi_ii_sync_bit_rmv.v"                      {MENTOR_SPECIFIC}
  }
  if {1} {
   ...
   #add_fileset_file aldec/src_hdl/sdi_anctrack.v            VERILOG_ENCRYPT PATH "aldec/src_hdl/sdi_ii_anctrack.v"                          {ALDEC_SPECIFIC}
    ...
    add_fileset_file aldec/src_hdl/sdi_ii_rx_prealign.v      VERILOG_ENCRYPT PATH "aldec/src_hdl/sdi_ii_rx_prealign.v"                       {ALDEC_SPECIFIC}
    add_fileset_file aldec/src_hdl/sdi_ii_sync_bit_rmv.v     VERILOG_ENCRYPT PATH "aldec/src_hdl/sdi_ii_sync_bit_rmv.v"                       {ALDEC_SPECIFIC}
  }
  if {1} {
   ...
   add_fileset_file cadence/src_hdl/sdi_ii_rx_prealign.v    VERILOG_ENCRYPT PATH "cadence/src_hdl/sdi_ii_rx_prealign.v"                     {CADENCE_SPECIFIC}
   add_fileset_file cadence/src_hdl/sdi_ii_sync_bit_rmv.v   VERILOG_ENCRYPT PATH "cadence/src_hdl/sdi_ii_sync_bit_rmv.v"                    {CADENCE_SPECIFIC}
  }
  if {1} {
   ...
   #add_fileset_file synopsys/src_hdl/sdi_anctrack.v         VERILOG_ENCRYPT PATH "synopsys/src_hdl/sdi_ii_anctrack.v"                       {SYNOPSYS_SPECIFIC}
    ...
    add_fileset_file synopsys/src_hdl/sdi_ii_fifo_retime.v   VERILOG_ENCRYPT PATH "synopsys/src_hdl/sdi_ii_fifo_retime.v"                    {SYNOPSYS_SPECIFIC}
    add_fileset_file synopsys/src_hdl/sdi_ii_rx_prealign.v   VERILOG_ENCRYPT PATH "synopsys/src_hdl/sdi_ii_rx_prealign.v"                    {SYNOPSYS_SPECIFIC}
    add_fileset_file synopsys/src_hdl/sdi_ii_sync_bit_rmv.v  VERILOG_ENCRYPT PATH "synopsys/src_hdl/sdi_ii_sync_bit_rmv.v"                   {SYNOPSYS_SPECIFIC}
  }
}
...
proc generate_ed_files {name} {
   ...
   add_fileset_file sdi_ii_rx_prealign.v      	VERILOG PATH src_hdl/sdi_ii_rx_prealign.v
   add_fileset_file sdi_ii_sync_bit_rmv.v       VERILOG PATH src_hdl/sdi_ii_sync_bit_rmv.v
...
proc elaboration_callback {} {
  ...
  if { $b2a | $video_std == "dl" } {
      add_hdl_instance              sdi_rxptc_rst_sync  altera_reset_controller
      set_instance_parameter_value  sdi_rxptc_rst_sync  NUM_RESET_INPUTS    1
  }
  ...
  common_add_optional_conduit rx_f                          export  output 1*$num_streams true
  common_add_optional_conduit rx_v                          export  output 1*$num_streams true
  common_add_optional_conduit rx_h                          export  output 1*$num_streams true
  common_add_optional_conduit rx_ap                         export  output 1*$num_streams true
  common_add_optional_conduit rx_format                     export  output 4*$num_streams true
  common_add_optional_conduit rx_std_in                     export  input  3 true
  common_add_optional_conduit rx_std                        export  output 3 true
  common_add_optional_conduit rx_align_locked               export  output 1 true
  common_add_optional_conduit rx_trs_locked                 export  output 1*$num_streams true
  common_add_optional_conduit rx_frame_locked               export  output 1 true
  common_add_optional_conduit rx_crc_error_c                export  output 1*$num_streams true
  common_add_optional_conduit rx_crc_error_y                export  output 1*$num_streams true
  common_add_optional_conduit rx_crc_error_c_b              export  output 1*$num_streams true
  common_add_optional_conduit rx_crc_error_y_b              export  output 1*$num_streams true
  common_add_optional_conduit rx_ln                         export  output 11*$num_streams true
  common_add_optional_conduit rx_ln_b                       export  output 11*$num_streams true
  common_add_optional_conduit rx_vpid_byte1                 export  output 8*$num_streams true
  common_add_optional_conduit rx_vpid_byte2                 export  output 8*$num_streams true
  common_add_optional_conduit rx_vpid_byte3                 export  output 8*$num_streams true
  common_add_optional_conduit rx_vpid_byte4                 export  output 8*$num_streams true
  common_add_optional_conduit rx_vpid_valid                 export  output 1*$num_streams true
  common_add_optional_conduit rx_vpid_checksum_error        export  output 1*$num_streams true
  common_add_optional_conduit rx_line_f0                    export  output 11*$num_streams true
  common_add_optional_conduit rx_line_f1                    export  output 11*$num_streams true
  common_add_optional_conduit rx_vpid_byte1_b               export  output 8*$num_streams true
  common_add_optional_conduit rx_vpid_byte2_b               export  output 8*$num_streams true
  common_add_optional_conduit rx_vpid_byte3_b               export  output 8*$num_streams true
  common_add_optional_conduit rx_vpid_byte4_b               export  output 8*$num_streams true
  common_add_optional_conduit rx_vpid_valid_b               export  output 1*$num_streams true
  common_add_optional_conduit rx_vpid_checksum_error_b      export  output 1*$num_streams true
  common_add_optional_conduit rx_eav                        export  output 1*$num_streams true
  common_add_optional_conduit rx_trs                        export  output 1*$num_streams true
  common_add_optional_conduit rx_trs_loose_lock_out         export  output 1*$num_streams true
  ...
  if { !($video_std == "dl" & $a2b) & !(($video_std == "tr" | $video_std == "threeg") & $b2a) } {
    terminate_port          rx_clkin_smpte372         input
  }

  if { !($video_std == "dl" & !$a2b) & !(($video_std == "threeg" | $video_std == "tr") & $b2a) } {
  ...
  if { $video_std != "threeg" & $video_std != "ds" & $video_std != "tr" & $video_std != "mr" } {
    terminate_port          rx_std_in                 input
    terminate_port          rx_std                    output
  }
  
  if { !$crc_err } {
    terminate_port          rx_crc_error_c            output
    terminate_port          rx_crc_error_y            output
  }

  if { (!$crc_err) | ($video_std != "threeg" & $video_std != "dl" & $video_std != "tr" & $video_std != "mr") } {
    terminate_port          rx_crc_error_c_b          output
    terminate_port          rx_crc_error_y_b          output
  }  
  
  if { $video_std == "sd" } {
    terminate_port          rx_ln                     output
  }
  if { $video_std != "threeg" & $video_std != "dl" & $video_std != "tr" & $video_std != "mr" } {
    terminate_port          rx_ln_b                   output
  }

  if { $device == "Arria 10" } {
     terminate_port         rx_clkout                 output 
     terminate_port         rx_clkout_b               output 
  }

  if { !$extract_vpid } {
    terminate_port          rx_vpid_byte1             output
    terminate_port          rx_vpid_byte2             output
    terminate_port          rx_vpid_byte3             output
    terminate_port          rx_vpid_byte4             output 
    terminate_port          rx_vpid_valid             output
    terminate_port          rx_vpid_checksum_error    output 
    terminate_port          rx_line_f0                output 
    terminate_port          rx_line_f1                output 
  }

  if { !$extract_vpid | ($video_std != "dl" & $video_std != "threeg" & $video_std != "tr" & $video_std != "mr") } {
    terminate_port          rx_vpid_byte1_b             output
    terminate_port          rx_vpid_byte2_b             output 
  ...
  if { $video_std != "dl" } {
    terminate_port          rx_clkin_b                   input 
    terminate_port          rx_rst_proto_in_b            input
    terminate_port          rx_datain_b                  input
    terminate_port          rx_datain_valid_b            input
    terminate_port          rx_align_locked_b            output
    terminate_port          rx_trs_locked_b              output
    terminate_port          rx_frame_locked_b            output
    terminate_port          rx_trs_loose_lock_out_b      output
    terminate_port          rx_dl_locked                 output
    terminate_port          rx_clkout_b                  output 
  }
}

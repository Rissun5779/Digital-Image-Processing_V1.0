...
module sdi_ii_ed_reconfig_mgmt # (
  ...
  //===========================================================================
  generate if ( VIDEO_STANDARD == "tr" | VIDEO_STANDARD == "ds" | XCVR_TX_PLL_SEL != 0 ) 
    begin: reconfig_logic_gen
      sdi_ii_reconfig_logic #(
         ...
         .XCVR_TX_PLL_SEL(XCVR_TX_PLL_SEL)
      ) u_reconfig_logic (
      ...
      assign sdi_tx_reconfig_done    = 1'b0;
      assign sdi_rx_reconfig_done    = 1'b0;

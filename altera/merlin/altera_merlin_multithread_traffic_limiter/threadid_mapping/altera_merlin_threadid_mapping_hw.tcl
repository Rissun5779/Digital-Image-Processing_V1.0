...
# $Id: //acds/rel/18.1std/ip/merlin/altera_merlin_multithread_traffic_limiter/threadid_mapping/altera_merlin_threadid_mapping_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
add_fileset sim_vhdl_fileset     SIM_VHDL    synth_callback_procedure_verilog

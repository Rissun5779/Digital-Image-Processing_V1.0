...
# $Id: //acds/rel/18.1std/ip/merlin/altera_merlin_multithread_traffic_limiter/sc_fifo_limiter/altera_merlin_sc_fifo_limiter_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
proc compose {} {
	...
	add_instance merlin_traffic_limiter_0 altera_merlin_traffic_limiter 18.1
	...
	if { $no_fifo == 0 } {
	# add in sc fifo
	add_instance sc_fifo_0 altera_avalon_sc_fifo 18.1

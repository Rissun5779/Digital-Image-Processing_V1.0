...
# $Id: //acds/rel/18.1std/ip/merlin/altera_merlin_multithread_traffic_limiter/threadid_splitter/altera_merlin_threadid_splitter_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
proc compose {} {
	...
	add_instance cmd_demultiplexer altera_merlin_demultiplexer 18.1
	...
	add_instance cmd_multiplexer altera_merlin_multiplexer 18.1
	...
	add_instance rsp_demultiplexer altera_merlin_demultiplexer 18.1
	...
	add_instance rsp_multiplexer altera_merlin_multiplexer 18.1
	...
	for { set i 0 } { $i < $num_threads } { incr i } {
		add_instance merlin_sc_fifo_limiter_${i} altera_merlin_sc_fifo_limiter 18.1

...
# $Id: //acds/rel/18.1std/ip/merlin/altera_merlin_multithread_traffic_limiter/multithread_limiter/altera_merlin_multithread_traffic_limiter_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
proc compose {} {
	...
	add_instance in_clk altera_clock_bridge 18.1
	...
	add_instance in_reset altera_reset_bridge 18.1
	...
	add_instance merlin_threadid_mapping_rsp altera_merlin_threadid_mapping 18.1
	...
	add_instance merlin_threadid_splitter_0 altera_merlin_threadid_splitter 18.1
	...
	add_instance merlin_threadid_mapping_cmd altera_merlin_threadid_mapping 18.1
	...
	if {$cmd_sink_pipeline == 1} {
		add_instance avl_st_pipeline_stage_cmd_sink altera_avalon_st_pipeline_stage 18.1
	...
	if {$rsp_sink_pipeline == 1} {
		add_instance avl_st_pipeline_stage_rsp_sink altera_avalon_st_pipeline_stage 18.1
	...
	if {$rsp_source_pipeline == 1} {
		add_instance avl_st_pipeline_stage_rsp_source altera_avalon_st_pipeline_stage 18.1

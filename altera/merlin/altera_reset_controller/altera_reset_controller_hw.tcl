...
proc synth_callback_procedure { entity_name } {
	...
	set file_type [ipri_extension_filter "SDC" "MERLIN"]
   ...
   if {[string equal $file_type "SDC_ENTITY_NOPROMO"]} {
      set file_type "SDC_ENTITY"
      add_fileset_file altera_reset_controller.sdc $file_type PATH "altera_reset_controller.sdc" {NO_AUTO_INSTANCE_DISCOVERY NO_SDC_PROMOTION}
   } else {
      add_fileset_file altera_reset_controller.sdc $file_type PATH "altera_reset_controller.sdc"
   }
}
...
set_parameter_property SYNC_DEPTH ALLOWED_RANGES "2:16"

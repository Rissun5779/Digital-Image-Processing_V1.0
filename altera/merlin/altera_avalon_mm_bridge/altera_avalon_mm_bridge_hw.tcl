...
set_module_property DATASHEET_URL http://www.altera.com/literature/hb/qts/qsys_system_components.pdf
# | 
# +-----------------------------------
...
set_fileset_property synth   TOP_LEVEL altera_avalon_mm_bridge
add_fileset_file altera_avalon_mm_bridge.v VERILOG PATH altera_avalon_mm_bridge.v

add_fileset          sim     SIM_VERILOG
set_fileset_property sim     TOP_LEVEL altera_avalon_mm_bridge
add_fileset_file altera_avalon_mm_bridge.v VERILOG PATH altera_avalon_mm_bridge.v

add_fileset          simvhdl SIM_VHDL
set_fileset_property simvhdl TOP_LEVEL altera_avalon_mm_bridge
add_fileset_file altera_avalon_mm_bridge.v VERILOG PATH altera_avalon_mm_bridge.v
# | 
# +-----------------------------------
...
add_parameter USE_RESPONSE INTEGER 0
set_parameter_property USE_RESPONSE DEFAULT_VALUE 0
set_parameter_property USE_RESPONSE DISPLAY_NAME "Use Avalon Transaction Responses"
set_parameter_property USE_RESPONSE DESCRIPTION {When enabled, the Avalon response signal role will be added to both the master and slave interfaces on this bridge.}
set_parameter_property USE_RESPONSE TYPE INTEGER
set_parameter_property USE_RESPONSE UNITS None
set_parameter_property USE_RESPONSE DISPLAY_HINT "boolean"
set_parameter_property USE_RESPONSE AFFECTS_GENERATION false
...
add_display_item "Response" USE_RESPONSE parameter
# | 
# +-----------------------------------
...
set_port_property s0_response VHDL_TYPE STD_LOGIC_VECTOR
...
proc elaborate { } {
    ...
    set use_response [ get_parameter_value USE_RESPONSE ]
    ...
    if { $use_response == 0 } {
        set_port_property m0_response TERMINATION 1
        set_port_property m0_response TERMINATION_VALUE 0

        set_port_property s0_response TERMINATION 1
    }

...
# $Id: //acds/rel/18.1std/ip/merlin/altera_merlin_std_arbitrator/altera_merlin_std_arbitrator_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
proc generate {output_name} {
    ...
    set template_file "altera_merlin_std_arbitrator.sv.terp"
    ...
    add_fileset_file altera_merlin_std_arbitrator_core.sv SYSTEM_VERILOG PATH altera_merlin_std_arbitrator_core.sv
}

...
set_parameter_property LIST_ASRT_DELAY DISPLAY_NAME "ASRT Delay Cycle#"
...
set_parameter_property LIST_DSRT_DELAY DISPLAY_NAME "DSRT Delay Cycle# / Deglitch#"
...
add_display_item "Sequence Setup" id0 text "- ASRT Seq#   - Determine the sequence order of reset assertion"
add_display_item "Sequence Setup" id1 text "- ASRT Cycle# - Number of cycles to wait before assertion of this reset"
add_display_item "Sequence Setup" id2 text "- DSRT Seq#   - Determine the sequence order of reset de-assertion"
add_display_item "Sequence Setup" id3 text "- DSRT Cycle# - Number of cycles to wait before deasserting this reset"
add_display_item "Sequence Setup" id4 text "- When USE_DSRT_QUAL==1. DSRT Cycle# refers to the # of cycles to deglitch the input qual signal"
...
add_display_item "Sequence Setup" id5 text "Please check below for expected generated sequence :"
...
proc elaborate {} {
    ...
    ##
    ## Assertion delays
    ## - Delays are absolute, and follows the Seq# it's assigned to
    ## - REMAP follows the order it is assigned
    ##
    set chk_asrt 0
    ...
    ## - Delays are absolute, and follows the Seq# it's assigned to
    ## - REMAP follows the order it is assigned
    ## - QUAL_CNT follows the associated reset_out# in which USE_DSRT_QUAL is set
    ##
    set chk_dsrt 0
    ...
    if { ![get_parameter_value ENABLE_ASSERTION_SEQUENCE] } {
        set_parameter_value ASRT_SEQ_MSG "SEQUENCE DISABLED (All Delays are 0)"
    ...
    if { ![get_parameter_value ENABLE_DEASSERTION_SEQUENCE] } {
        set_parameter_value DSRT_SEQ_MSG "SEQUENCE DISABLED (All Delays are 0 and no USE_DSRT_QUAL is set)"
    } else {

...
set_fileset_property synth   TOP_LEVEL altera_customins_slave_translator
add_fileset_file altera_customins_slave_translator.sv SYSTEM_VERILOG PATH altera_customins_slave_translator.sv

add_fileset          sim     SIM_VERILOG
set_fileset_property sim     TOP_LEVEL altera_customins_slave_translator
add_fileset_file altera_customins_slave_translator.sv SYSTEM_VERILOG PATH altera_customins_slave_translator.sv

add_fileset          simvhdl SIM_VHDL
set_fileset_property simvhdl TOP_LEVEL altera_customins_slave_translator
add_fileset_file altera_customins_slave_translator.sv SYSTEM_VERILOG PATH altera_customins_slave_translator.sv
...
proc elaborate {} {
    ...
    set_port_property ci_master_n WIDTH_EXPR $n_width
    if { $use_n == 0 } {

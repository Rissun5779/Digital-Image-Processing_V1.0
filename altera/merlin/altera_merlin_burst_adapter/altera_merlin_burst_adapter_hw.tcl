...
# $Id: //acds/rel/18.1std/ip/merlin/altera_merlin_burst_adapter/altera_merlin_burst_adapter_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
proc synth_callback_procedure { entity_name } {
    ...
    add_fileset_file altera_merlin_burst_adapter_uncmpr.sv SYSTEM_VERILOG PATH "altera_merlin_burst_adapter_uncmpr.sv"
    add_fileset_file altera_merlin_burst_adapter_13_1.sv   SYSTEM_VERILOG PATH "13_1_source/altera_merlin_burst_adapter_13_1.sv"
    add_fileset_file altera_merlin_burst_adapter_new.sv    SYSTEM_VERILOG PATH "new_source/altera_merlin_burst_adapter_new.sv"
    add_fileset_file altera_incr_burst_converter.sv        SYSTEM_VERILOG PATH "new_source/altera_incr_burst_converter.sv"
    add_fileset_file altera_wrap_burst_converter.sv        SYSTEM_VERILOG PATH "new_source/altera_wrap_burst_converter.sv"
    add_fileset_file altera_default_burst_converter.sv     SYSTEM_VERILOG PATH "new_source/altera_default_burst_converter.sv"
    ...
    add_fileset_file altera_avalon_st_pipeline_stage.sv    SYSTEM_VERILOG PATH "../../avalon_st/altera_avalon_st_pipeline_stage/altera_avalon_st_pipeline_stage.sv"
...
proc synth_callback_procedure_vhdl { entity_name } {
    if {1} {
        add_fileset_vhdl_simulation mentor MENTOR_SPECIFIC
    }
    if {1} {
        add_fileset_vhdl_simulation aldec ALDEC_SPECIFIC
    }
    if {1} {
        add_fileset_vhdl_simulation cadence CADENCE_SPECIFIC
    }
    if {1} {
        add_fileset_vhdl_simulation synopsys SYNOPSYS_SPECIFIC
    }
}

proc add_fileset_vhdl_simulation {simulator_name simulator_specific_type} {
        add_fileset_file $simulator_name/altera_merlin_burst_adapter_13_1.sv   SYSTEM_VERILOG_ENCRYPT PATH "$simulator_name/13_1_source/altera_merlin_burst_adapter_13_1.sv" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_merlin_burst_adapter_new.sv    SYSTEM_VERILOG_ENCRYPT PATH "$simulator_name/new_source/altera_merlin_burst_adapter_new.sv" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_merlin_burst_adapter.sv        SYSTEM_VERILOG_ENCRYPT PATH "$simulator_name/altera_merlin_burst_adapter.sv" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_merlin_burst_adapter_uncmpr.sv SYSTEM_VERILOG_ENCRYPT PATH "$simulator_name/altera_merlin_burst_adapter_uncmpr.sv" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_incr_burst_converter.sv        SYSTEM_VERILOG_ENCRYPT PATH "$simulator_name/new_source/altera_incr_burst_converter.sv" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_wrap_burst_converter.sv        SYSTEM_VERILOG_ENCRYPT PATH "$simulator_name/new_source/altera_wrap_burst_converter.sv" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_default_burst_converter.sv     SYSTEM_VERILOG_ENCRYPT PATH "$simulator_name/new_source/altera_default_burst_converter.sv" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_avalon_st_pipeline_base.v      SYSTEM_VERILOG_ENCRYPT PATH "../../avalon_st/altera_avalon_st_pipeline_stage/$simulator_name/altera_avalon_st_pipeline_base.v" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_avalon_st_pipeline_stage.sv  SYSTEM_VERILOG_ENCRYPT PATH "../../avalon_st/altera_avalon_st_pipeline_stage/$simulator_name/altera_avalon_st_pipeline_stage.sv" \{$simulator_specific_type\}
        add_fileset_file $simulator_name/altera_merlin_address_alignment.sv  SYSTEM_VERILOG_ENCRYPT PATH "../altera_merlin_axi_master_ni/$simulator_name/altera_merlin_address_alignment.sv" \{$simulator_specific_type\} 
    }

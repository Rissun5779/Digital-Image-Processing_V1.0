...
# $Id: //acds/rel/18.1std/ip/merlin/altera_tristate_controller_aggregator/altera_tristate_controller_aggregator_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_fileset_property synth     TOP_LEVEL altera_tristate_controller_aggregator
add_fileset_file altera_tristate_controller_aggregator.sv SYSTEM_VERILOG PATH altera_tristate_controller_aggregator.sv

add_fileset          sim       SIM_VERILOG
set_fileset_property sim       TOP_LEVEL altera_tristate_controller_aggregator
add_fileset_file altera_tristate_controller_aggregator.sv SYSTEM_VERILOG PATH altera_tristate_controller_aggregator.sv

add_fileset          simvhdl   SIM_VHDL
set_fileset_property simvhdl   TOP_LEVEL altera_tristate_controller_aggregator
add_fileset_file altera_tristate_controller_aggregator.sv SYSTEM_VERILOG PATH altera_tristate_controller_aggregator.sv
...
proc elaborate {} {
    ...
    set_port_property tcm0_address VHDL_TYPE std_logic_vector
    ...
    set_port_property tcm0_byteenable VHDL_TYPE std_logic_vector
    set_port_property tcm0_byteenable_n VHDL_TYPE std_logic_vector
    ...
    set_port_property tcm0_writebyteenable VHDL_TYPE std_logic_vector
    set_port_property tcm0_writebyteenable_n VHDL_TYPE std_logic_vector
    ...
    set_port_property tcm0_writedata VHDL_TYPE std_logic_vector
    ...
    set_port_property tcm0_readdata VHDL_TYPE std_logic_vector

...
# $Id: //acds/rel/18.1std/ip/merlin/altera_tristate_controller_translator/altera_tristate_controller_translator_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_fileset_property synth     TOP_LEVEL altera_tristate_controller_translator
add_fileset_file altera_tristate_controller_translator.sv SYSTEM_VERILOG PATH altera_tristate_controller_translator.sv

add_fileset          sim       SIM_VERILOG
set_fileset_property sim       TOP_LEVEL altera_tristate_controller_translator
add_fileset_file altera_tristate_controller_translator.sv SYSTEM_VERILOG PATH altera_tristate_controller_translator.sv

add_fileset          simvhdl   SIM_VHDL
set_fileset_property simvhdl   TOP_LEVEL altera_tristate_controller_translator
add_fileset_file altera_tristate_controller_translator.sv SYSTEM_VERILOG PATH altera_tristate_controller_translator.sv

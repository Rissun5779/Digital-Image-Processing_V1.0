...
set_module_property NAME altera_avalon_sc_fifo_w_ecc
set_module_property DISPLAY_NAME "ECC Protected Avalon-ST Single Clock FIFO "
...
add_fileset sim_vlog SIM_VERILOG generate_sim_ver
add_fileset sim_vhd SIM_VHDL generate_sim_ver
set_fileset_property synth TOP_LEVEL altera_avalon_sc_fifo_w_ecc
set_fileset_property sim_vlog TOP_LEVEL altera_avalon_sc_fifo_w_ecc
set_fileset_property sim_vhd  TOP_LEVEL altera_avalon_sc_fifo_w_ecc
...
set_parameter_property USE_FILL_LEVEL    DESCRIPTION  "Enables the fill level logic"
...
set_parameter_property USE_MEMORY_BLOCKS DESCRIPTION  "Enables the implementation that infers memory blocks. Registers may still be used for shallow depths"
set_parameter_property USE_STORE_FORWARD   DISPLAY_NAME "Use store and forward"
set_parameter_property USE_STORE_FORWARD   DESCRIPTION  "Enables store and forward mode"

set_parameter_property USE_ALMOST_FULL_IF  DISPLAY_NAME "Use almost full status"
set_parameter_property USE_ALMOST_FULL_IF  DESCRIPTION  "Enables a single-bit almost-full status streaming interface"
set_parameter_property USE_ALMOST_EMPTY_IF DISPLAY_NAME "Use almost empty status"
set_parameter_property USE_ALMOST_EMPTY_IF  DESCRIPTION  "Enables a single-bit almost-empty status streaming interface"
...
set_parameter_property ECC_ENABLE                 DISPLAY_NAME "Use ECC Protection"
set_parameter_property ECC_ENABLE                 DESCRIPTION  "Enables ECC Protection for the FIFO Memory Element"
...
set_parameter_property ECC_ENABLE          AFFECTS_GENERATION true
set_parameter_property ECC_ENABLE          AFFECTS_VALIDATION true
...
proc validate {} {
    ...
    set ecc_enable     [ get_parameter_value "ECC_ENABLE" ]
    ...
    if { $error_width == 0 } {
        if { $ecc_enable == 1} {
            send_message "error" "ECC Protection requires an error width of at least 1 bit."
        }
    } 
}
...
proc elaboration_callback {} {
    ...
    ## Adding HDL instance of Altera Avalon SC FIFO
    add_hdl_instance avl_sc_fifo altera_avalon_sc_fifo
    set_instance_parameter_value avl_sc_fifo SYMBOLS_PER_BEAT $symbols_per_beat
    set_instance_parameter_value avl_sc_fifo BITS_PER_SYMBOL $bits_per_symbol
    set_instance_parameter_value avl_sc_fifo FIFO_DEPTH "false"
    set_instance_parameter_value avl_sc_fifo CHANNEL_WIDTH $channel_width
    set_instance_parameter_value avl_sc_fifo ERROR_WIDTH $error_width 
    set_instance_parameter_value avl_sc_fifo USE_PACKETS $use_packets 
    set_instance_parameter_value avl_sc_fifo USE_FILL_LEVEL $use_fill_level
    set_instance_parameter_value avl_sc_fifo EMPTY_LATENCY "32"
    set_instance_parameter_value avl_sc_fifo USE_MEMORY_BLOCKS "32"
    set_instance_parameter_value avl_sc_fifo USE_STORE_FORWARD $use_store_forward 
    set_instance_parameter_value avl_sc_fifo USE_ALMOST_FULL_IF $use_almost_full 
    set_instance_parameter_value avl_sc_fifo USE_ALMOST_EMPTY_IF $use_almost_empty 
    set_instance_parameter_value avl_sc_fifo ENABLE_EXPLICIT_MAXCHANNEL $override_maxchannel
    set_instance_parameter_value avl_sc_fifo EXPLICIT_MAXCHANNEL $override_value
 
    ## Adding HDL instance of ECC Encode/Decode
    add_hdl_instance altera_avalon_ecc_enc altecc
  #    set_instance_parameter_value altera_avalon_ecc_enc DEVICE_FAMILY "Arria 10"
    set_instance_parameter_value altera_avalon_ecc_enc GUI_USE_ACLR "false"
    set_instance_parameter_value altera_avalon_ecc_enc GUI_USE_CLKEN "false"
    set_instance_parameter_value altera_avalon_ecc_enc GUI_USE_SYN_E "false"
    set_instance_parameter_value altera_avalon_ecc_enc LPM_PIPELINE 0
    set_instance_parameter_value altera_avalon_ecc_enc MODULE_TYPE "ALTECC_ENCODER"
    set_instance_parameter_value altera_avalon_ecc_enc WIDTH_CODEWORD "39"
    set_instance_parameter_value altera_avalon_ecc_enc WIDTH_DATAWORD "32"

    add_hdl_instance altera_avalon_ecc_dec altecc
  #    set_instance_parameter_value altera_avalon_ecc_dec DEVICE_FAMILY "Arria 10"
    set_instance_parameter_value altera_avalon_ecc_dec GUI_USE_ACLR "false"
    set_instance_parameter_value altera_avalon_ecc_dec GUI_USE_CLKEN "false"
    set_instance_parameter_value altera_avalon_ecc_dec GUI_USE_SYN_E "false"
    set_instance_parameter_value altera_avalon_ecc_dec LPM_PIPELINE 0
    set_instance_parameter_value altera_avalon_ecc_dec MODULE_TYPE "ALTECC_DECODER"
    set_instance_parameter_value altera_avalon_ecc_dec WIDTH_CODEWORD "39"
    set_instance_parameter_value altera_avalon_ecc_dec WIDTH_DATAWORD "32"
}
# +-----------------------------------
# | generate callbacks
# |
proc generate_synth {output_name} {
    add_fileset_file altera_avalon_sc_fifo_w_ecc.v VERILOG PATH altera_avalon_sc_fifo_w_ecc.v
    add_fileset_file altera_avalon_ecc_encoder.v VERILOG PATH altera_avalon_ecc_encoder.v
    add_fileset_file altera_avalon_ecc_decoder.v VERILOG PATH altera_avalon_ecc_decoder.v
}

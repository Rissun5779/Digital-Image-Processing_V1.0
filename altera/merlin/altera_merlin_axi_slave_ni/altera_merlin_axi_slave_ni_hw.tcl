...
set_fileset_property synth       TOP_LEVEL altera_merlin_axi_slave_ni

add_fileset          sim_verilog SIM_VERILOG   generate
set_fileset_property sim_verilog TOP_LEVEL altera_merlin_axi_slave_ni

add_fileset          sim_vhdl    SIM_VHDL      generate
set_fileset_property sim_vhdl    TOP_LEVEL altera_merlin_axi_slave_ni

proc generate {output_name} {
    add_fileset_file altera_merlin_axi_slave_ni.sv       SYSTEM_VERILOG PATH altera_merlin_axi_slave_ni.sv
    add_fileset_file altera_merlin_burst_uncompressor.sv SYSTEM_VERILOG PATH [file join .. altera_merlin_slave_agent altera_merlin_burst_uncompressor.sv]
    add_fileset_file altera_avalon_sc_fifo.v             VERILOG        PATH [file join .. .. sopc_builder_ip altera_avalon_sc_fifo altera_avalon_sc_fifo.v]
    add_fileset_file altera_merlin_address_alignment.sv  SYSTEM_VERILOG PATH [file join .. altera_merlin_axi_master_ni altera_merlin_address_alignment.sv]
}
# | 
# +-----------------------------------
...
set_port_property read_cp_channel VHDL_TYPE std_logic_vector
...
set_port_property write_cp_channel VHDL_TYPE std_logic_vector
# | 
# +-----------------------------------
...
proc add_axi3_interface { axi_slave_id_width addr_width wdata_width rdata_width data_user addr_user wstrb_width resp_width } {
    ...
    declare_common_axi_std_logic_vectors
...
proc declare_common_axi_std_logic_vectors { } {

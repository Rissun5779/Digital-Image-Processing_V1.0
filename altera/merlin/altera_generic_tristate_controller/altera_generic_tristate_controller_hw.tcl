...
# $Id: //acds/rel/18.1std/ip/merlin/altera_generic_tristate_controller/altera_generic_tristate_controller_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
add_display_item "" sizeAssignmentBlurb text "<html>Note: For memory devices, the module assignment <b>embeddedsw.CMacro.SIZE</b> = <b><i>Memory Size in Bytes</i></b> <br>must be defined and it must equal the size of the memory. Value should be an unsigned integer.</html>"
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/mwh1409960181641/mwh1409959350459 

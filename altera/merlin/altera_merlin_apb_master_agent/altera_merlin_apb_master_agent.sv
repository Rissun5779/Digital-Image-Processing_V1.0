...
// $Id: //acds/rel/18.1std/ip/merlin/altera_merlin_apb_master_agent/altera_merlin_apb_master_agent.sv#1 $
// $Revision: #1 $
// $Date: 2018/07/18 $
// $Author: psgswbuild $
...
module altera_merlin_apb_master_agent 
  #(
   ...
   (
    ...
    localparam PKT_BURST_SIZE_W  = PKT_BURST_SIZE_H - PKT_BURST_SIZE_L + 1;
    localparam BURST_SIZE        = clogb2(NUMSYMBOLS);
    
    wire [31:0] bytecount_value_int  = NUMSYMBOLS;
    wire [PKT_BURST_SIZE_W-1:0]  burst_size = BURST_SIZE[PKT_BURST_SIZE_W-1:0];
    wire [31:0] id_int               = ID;
    ...
    always_comb 
        begin
            ...
            cp_data[PKT_BURSTWRAP_H:PKT_BURSTWRAP_L  ]         = '1;

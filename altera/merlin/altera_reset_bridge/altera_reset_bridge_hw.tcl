...
set_module_property GROUP "Basic Functions/Bridges and Adaptors/Reset"
...
set_parameter_property USE_RESET_REQUEST DISPLAY_NAME "Use reset request signal"
set_parameter_property USE_RESET_REQUEST DESCRIPTION "When enabled reset request is available."
set_parameter_property USE_RESET_REQUEST UNITS None
...
proc elaborate {} {
   ...
   set use_req    [ get_parameter_value USE_RESET_REQUEST ]
   ...
   if { $use_req == 1 } {
      add_interface_port in_reset in_reset_req reset_req Input 1   
      add_interface_port out_reset out_reset_req reset_req Output 1
      set_port_property out_reset_req DRIVEN_BY in_reset_req
   }
   ...
   for { set i 1 } { $i < $num_resets } { incr i } {
      ...
      if { $use_req == 1 } {
         add_interface_port out_reset_${i} out_reset_req_${i} reset_req Output 1
         set_port_property out_reset_req_${i} DRIVEN_BY in_reset_req
      }

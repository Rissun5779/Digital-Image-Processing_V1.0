...
set_fileset_property synth   TOP_LEVEL altera_customins_master_translator
add_fileset_file altera_customins_master_translator.v VERILOG PATH altera_customins_master_translator.v

add_fileset          sim     SIM_VERILOG
set_fileset_property sim     TOP_LEVEL altera_customins_master_translator
add_fileset_file altera_customins_master_translator.v VERILOG PATH altera_customins_master_translator.v

add_fileset          simvhdl SIM_VHDL
set_fileset_property simvhdl TOP_LEVEL altera_customins_master_translator
add_fileset_file altera_customins_master_translator.v VERILOG PATH altera_customins_master_translator.v

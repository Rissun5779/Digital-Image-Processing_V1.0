...
# Common procedure of declaring an merlin module property
proc init_merlin_module_property {} {
...
# This is a procedure to add merlin packet related parameters
#  to be reused in merlin components with ST interface

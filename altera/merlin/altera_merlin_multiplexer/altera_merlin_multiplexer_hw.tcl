...
# $Id: //acds/rel/18.1std/ip/merlin/altera_merlin_multiplexer/altera_merlin_multiplexer_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
proc generate {output_name} {
    ...
    set template_file "altera_merlin_multiplexer.sv.terp"
    ...
    add_fileset_file altera_merlin_arbitrator.sv SYSTEM_VERILOG PATH altera_merlin_arbitrator.sv
}

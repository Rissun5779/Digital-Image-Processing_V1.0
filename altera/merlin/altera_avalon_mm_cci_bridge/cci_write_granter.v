...
assign write_tag_ready = fifo_init_done & ~fifo_empty;
assign fifo_rd = write_tag_valid;
assign write_tag = fifo_out;
assign write_pending = ~fifo_full;

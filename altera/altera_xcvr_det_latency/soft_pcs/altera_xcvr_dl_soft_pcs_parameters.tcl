...
proc detlat_add_common_parameters {} {
  ...
  add_parameter gui_pcs_pma_width STRING 8
  set_parameter_property gui_pcs_pma_width DEFAULT_VALUE 8
  ...
  add_parameter tx_pma_clk_div INTEGER 1
  set_parameter_property tx_pma_clk_div DEFAULT_VALUE 1
  set_parameter_property tx_pma_clk_div HDL_PARAMETER true
  set_parameter_property tx_pma_clk_div DERIVED true
  set_parameter_property tx_pma_clk_div VISIBLE false
...
#  set_parameter_property pll_feedback_path VISIBLE false
  ...
  # adding ref_design. Reference design should be 0 if using UI for detlatency soft PCS.
  add_parameter ref_design INTEGER 0
  set_parameter_property ref_design DEFAULT_VALUE 0
  set_parameter_property ref_design VISIBLE false
# set_parameter_property ref_design DERIVED true
  set_parameter_property ref_design HDL_PARAMETER true

  # adding ser_words_pma_size. the value should be ceil of log2 ser_words on PMA side
  add_parameter ser_words_pma_size INTEGER 3
  set_parameter_property ser_words_pma_size DEFAULT_VALUE 3
  set_parameter_property ser_words_pma_size HDL_PARAMETER true
  set_parameter_property ser_words_pma_size VISIBLE true
  set_parameter_property ser_words_pma_size DISPLAY_NAME "Log2 SER_WORDS"
  set_parameter_property ser_words_pma_size DESCRIPTION "The ceil of log2 ser_words on PMA side."
  add_display_item "General" ser_words_pma_size parameter

  # adding data_width_pma_size. the value should be log2 of pcs_pma_width
  add_parameter data_width_pma_size INTEGER 7
  set_parameter_property data_width_pma_size DEFAULT_VALUE 7
  set_parameter_property data_width_pma_size HDL_PARAMETER true
  set_parameter_property data_width_pma_size VISIBLE true
  set_parameter_property data_width_pma_size DISPLAY_NAME "Log2 PCS_PMA_WIDTH"
  set_parameter_property data_width_pma_size DESCRIPTION "The ceil of log2 pcs_pma_width."
  add_display_item "General" data_width_pma_size parameter
...
#  set_parameter_property word_aligner_mode DESCRIPTION "Select the type of word alignment mode. Choose Deterministic latency state machine to enable word alignment with deterministic latency in the RX path without reliance on compensation in TX path. Choose manual mode to use bit position reporting of RX word aligner output to compensate for latency variation on the TX; backward compatible with Stratix IV and Arria II GX features."
  ...
  set_parameter_property tx_bitslip_enable HDL_PARAMETER false
...
#  add_string_parameter_as_boolean use_8b10b "false" {NoTag} "Enable 8B/10B encoder/decoder" "" "Protocol Setting"
  ...
  # adding tx_fifo_depth
  add_parameter tx_fifo_depth INTEGER 4
  set_parameter_property tx_fifo_depth DEFAULT_VALUE 4
  set_parameter_property tx_fifo_depth DISPLAY_NAME "The depth of the tx phase measuring FIFO"
  set_parameter_property tx_fifo_depth HDL_PARAMETER true
  add_display_item "Additional Options" tx_fifo_depth parameter

  # adding rx_fifo_depth
  add_parameter rx_fifo_depth INTEGER 4
  set_parameter_property rx_fifo_depth DEFAULT_VALUE 4
  set_parameter_property rx_fifo_depth DISPLAY_NAME "The depth of the rx phase measuring FIFO"
  set_parameter_property rx_fifo_depth HDL_PARAMETER true
  add_display_item "Additional Options" rx_fifo_depth parameter

  # initially enable all TX and RX options
  common_set_parameter_group {TX RX} ENABLED true

  # adding number of channels aka lanes
  add_parameter cdr_reconfig INTEGER 0
  set_parameter_property cdr_reconfig DEFAULT_VALUE 0
  set_parameter_property cdr_reconfig DISPLAY_NAME "Allow CDR reconfiguration only"
  set_parameter_property cdr_reconfig DISPLAY_HINT boolean
  set_parameter_property cdr_reconfig HDL_PARAMETER true
  set_parameter_property cdr_reconfig DESCRIPTION "CDR reconfiguration."
  add_display_item "Reconfiguration" cdr_reconfig parameter
  ...
  # add cdr_refclk_freq parameter (GUI parameter is declared uner Options tab)
  add_parameter cdr_refclk_freq STRING "62.5 MHz"
  set_parameter_property cdr_refclk_freq DEFAULT_VALUE "62.5 MHz"
  set_parameter_property cdr_refclk_freq VISIBLE false
  set_parameter_property cdr_refclk_freq DERIVED true
  set_parameter_property cdr_refclk_freq HDL_PARAMETER true
  ...
  # add cdr_refclk_cnt parameter
  add_parameter cdr_refclk_cnt INTEGER
  set_parameter_property cdr_refclk_cnt VISIBLE false
  set_parameter_property cdr_refclk_cnt DEFAULT_VALUE 1
  set_parameter_property cdr_refclk_cnt HDL_PARAMETER true
  set_parameter_property cdr_refclk_cnt DERIVED true
}
...
proc detlat_add_device_parameters {} {
  ...
  set_parameter_property device_family DESCRIPTION "Arria V devices are supported."
...
#	set fams [::alt_xcvr::utils::device::list_s5_style_hssi_families]
	set fams [::alt_xcvr::utils::device::list_a5_style_hssi_families]

...
#  set protocol_hint [custom_map_parameter_rules_to_protocol_hint $parameter_rules]
  ...
  # pcs_pma_width
  set pcs_pma_width $gui_pcs_pma_width
  
  if { $pcs_pma_width != 8 && $pcs_pma_width != 10 && $pcs_pma_width != 16 && $pcs_pma_width != 20 && $pcs_pma_width != 80} {
...
#  ::alt_xcvr::utils::rbc::validate_pcs_data_rate $device_family $data_rate_int $op_mode $protocol_hint $deser_factor "EIGHT_G_PCS" $pcs_dw $base_factor "dis_pcs_bypass"
  ...
  set_parameter_value cdr_refclk_freq   [::alt_xcvr::gui::pll_reconfig::get_refclk_freq_string]
  ...
  set_parameter_value tx_pma_clk_div    [expr $base_data_rate/$data_rate_int]

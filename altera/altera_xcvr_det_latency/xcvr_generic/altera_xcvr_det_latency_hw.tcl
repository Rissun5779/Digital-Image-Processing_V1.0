...
# | $Header: //acds/rel/18.1std/ip/altera_xcvr_det_latency/xcvr_generic/altera_xcvr_det_latency_hw.tcl#1 $
# | 
# +-----------------------------------
...
source altera_xcvr_det_latency_common.tcl
source altera_xcvr_det_latency_parameters.tcl	;# parameter definitions and validation
source altera_xcvr_det_latency_val_params.tcl	;# parameter definitions and validation
source altera_xcvr_det_latency_ports.tcl		    ;# port and interface functions
# |
# +---------------------------------------------
...
set_module_property DISPLAY_NAME "Deterministic Latency PHY Intel FPGA IP"
set_module_property EDITABLE true
set_module_property GROUP "Interface Protocols/Transceiver PHY"
set_module_property AUTHOR "Altera Corporation"
set_module_property DESCRIPTION "Deterministic Latency PHY IP"
...
set_fileset_property synth2 TOP_LEVEL altera_xcvr_det_latency
set_fileset_property sim_verilog TOP_LEVEL altera_xcvr_det_latency
set_fileset_property sim_vhdl TOP_LEVEL altera_xcvr_det_latency

...
set_module_property NAME altera_phylite_arch_nf
...
set_module_property ELABORATION_CALLBACK ::altera_phylite::ip_arch_nf::main::elaboration_callback

add_fileset sim_vhdl SIM_VHDL ::altera_phylite::ip_arch_nf::main::sim_vhdl_fileset_callback

add_fileset sim_verilog SIM_VERILOG ::altera_phylite::ip_arch_nf::main::sim_verilog_fileset_callback

add_fileset quartus_synth QUARTUS_SYNTH ::altera_phylite::ip_arch_nf::main::quartus_synth_fileset_callback

::altera_phylite::ip_arch_nf::main::create_parameters

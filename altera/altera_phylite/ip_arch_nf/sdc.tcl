...
package provide altera_phylite::ip_arch_nf::sdc 0.1

package require altera_phylite::ip_arch_nf::main

namespace eval ::altera_phylite::ip_arch_nf::sdc:: {
...
proc ::altera_phylite::ip_arch_nf::sdc::generate_sdc_file {phylite_inst_name} {
   set sdc_content ""

   set num_grps [get_parameter_value PHYLITE_NUM_GROUPS]

   append sdc_content [::altera_phylite::ip_arch_nf::sdc::_generate_header]
   append sdc_content [::altera_phylite::ip_arch_nf::sdc::_generate_user_variables $phylite_inst_name]
   append sdc_content [::altera_phylite::ip_arch_nf::sdc::_generate_sdc_flow_check]
   append sdc_content [::altera_phylite::ip_arch_nf::sdc::_generate_common_clocks]

   append sdc_content [::altera_phylite::ip_arch_nf::sdc::_generate_phy_clocks 0]

   append sdc_content [::altera_phylite::ip_arch_nf::sdc::_cut_paths]

   return $sdc_content
}


proc ::altera_phylite::ip_arch_nf::sdc::_generate_header {} {
   set sdc_content ""
...
proc ::altera_phylite::ip_arch_nf::sdc::_generate_user_variables {phylite_inst_name} {
   set sdc_content ""
...
proc ::altera_phylite::ip_arch_nf::sdc::_generate_sdc_flow_check {} {
   set sdc_content ""
...
proc ::altera_phylite::ip_arch_nf::sdc::_generate_common_clocks {} {
...
proc ::altera_phylite::ip_arch_nf::sdc::_generate_ref_clock {} {
   set sdc_content ""
...
proc ::altera_phylite::ip_arch_nf::sdc::_generate_phy_clocks {grp_idx} {
   set sdc_content ""
...
proc ::altera_phylite::ip_arch_nf::sdc::_cut_paths {} {
   set sdc_content ""
...
proc ::altera_phylite::ip_arch_nf::sdc::_cut_c2p_paths {grp_idx} {
   set sdc_content ""

   set num_lanes [::altera_phylite::ip_arch_nf::sdc::_get_num_lanes_in_grp $grp_idx]
...
proc ::altera_phylite::ip_arch_nf::sdc::_get_num_lanes_in_grp {grp_idx} {
   set num_data_pins [get_parameter_value "GROUP_${grp_idx}_PIN_WIDTH"]
   set num_strobes   [::altera_phylite::ip_arch_nf::main::get_num_strobes_in_grp $grp_idx]

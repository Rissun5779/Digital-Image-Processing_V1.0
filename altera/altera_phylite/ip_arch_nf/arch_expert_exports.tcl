...
proc ::altera_phylite::ip_arch_nf::arch_expert_exports::get_legal_write_latencies {} {
   return [altera_phylite::ip_arch_nf::main::get_legal_write_latencies]
}

proc ::altera_phylite::ip_arch_nf::arch_expert_exports::get_max_num_groups {} {
   return [altera_phylite::ip_arch_nf::main::get_max_num_groups]
}

proc ::altera_phylite::util::arch_expert::get_pll_vco_to_mem_clk_freq_ratio {mem_clk_freq_mhz} {
   return [::altera_phylite::ip_arch_nf::pll::get_pll_vco_to_mem_clk_freq_ratio ]
}

proc ::altera_phylite::util::arch_expert::get_pll_output_clocks_info {mem_clk_freq_mhz} {
   return [::altera_phylite::ip_arch_nf::pll::get_pll_output_clocks_info $mem_clk_freq_mhz]
}

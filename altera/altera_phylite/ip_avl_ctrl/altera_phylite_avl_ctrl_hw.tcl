...
package require altera_phylite::ip_avl_ctrl::main
...
set_module_property NAME altera_phylite_avl_ctrl
...
set_module_property ELABORATION_CALLBACK ::altera_phylite::ip_avl_ctrl::main::elaboration_callback

add_fileset sim_vhdl SIM_VHDL ::altera_phylite::ip_avl_ctrl::main::sim_vhdl_fileset_callback
set_fileset_property sim_vhdl TOP_LEVEL altera_phylite_avl_ctrl

add_fileset sim_verilog SIM_VERILOG ::altera_phylite::ip_avl_ctrl::main::sim_verilog_fileset_callback
set_fileset_property sim_verilog TOP_LEVEL altera_phylite_avl_ctrl

add_fileset quartus_synth QUARTUS_SYNTH ::altera_phylite::ip_avl_ctrl::main::quartus_synth_fileset_callback
set_fileset_property quartus_synth TOP_LEVEL altera_phylite_avl_ctrl

add_display_item "" QSYS_GUI_FOR_INTERNAL_COMPONENTS_TEXT TEXT [get_string QSYS_GUI_FOR_INTERNAL_COMPONENTS_DESC]

::altera_phylite::ip_avl_ctrl::main::create_parameters

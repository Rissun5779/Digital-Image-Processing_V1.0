...
package require altera_phylite::ip_driver::main
...
set_module_property NAME altera_phylite_driver
...
set_module_property ELABORATION_CALLBACK ::altera_phylite::ip_driver::main::elaboration_callback

add_fileset sim_vhdl SIM_VHDL ::altera_phylite::ip_driver::main::sim_vhdl_fileset_callback

add_fileset sim_verilog SIM_VERILOG ::altera_phylite::ip_driver::main::sim_verilog_fileset_callback

add_fileset quartus_synth QUARTUS_SYNTH ::altera_phylite::ip_driver::main::quartus_synth_fileset_callback

add_display_item "" QSYS_GUI_FOR_INTERNAL_COMPONENTS_TEXT TEXT [get_string QSYS_GUI_FOR_INTERNAL_COMPONENTS_DESC]

::altera_phylite::ip_driver::main::create_parameters

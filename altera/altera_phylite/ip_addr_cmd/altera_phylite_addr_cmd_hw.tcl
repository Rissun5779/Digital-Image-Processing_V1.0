...
package require altera_phylite::ip_addr_cmd::main
...
set_module_property NAME altera_phylite_addr_cmd
...
set_module_property ELABORATION_CALLBACK ::altera_phylite::ip_addr_cmd::main::elaboration_callback

add_fileset sim_vhdl SIM_VHDL ::altera_phylite::ip_addr_cmd::main::sim_vhdl_fileset_callback
set_fileset_property sim_vhdl TOP_LEVEL phylite_addr_cmd

add_fileset sim_verilog SIM_VERILOG ::altera_phylite::ip_addr_cmd::main::sim_verilog_fileset_callback
set_fileset_property sim_verilog TOP_LEVEL phylite_addr_cmd

add_fileset quartus_synth QUARTUS_SYNTH ::altera_phylite::ip_addr_cmd::main::quartus_synth_fileset_callback
set_fileset_property quartus_synth TOP_LEVEL phylite_addr_cmd

add_display_item "" QSYS_GUI_FOR_INTERNAL_COMPONENTS_TEXT TEXT [get_string QSYS_GUI_FOR_INTERNAL_COMPONENTS_DESC]

::altera_phylite::ip_addr_cmd::main::create_parameters

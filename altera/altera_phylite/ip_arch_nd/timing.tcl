...
package provide altera_phylite::ip_arch_nd::timing 0.1
...
package require altera_phylite::ip_arch_nd::enum_defs_timing_params
package require altera_emif::ip_arch_nd::util


namespace eval ::altera_phylite::ip_arch_nd::timing:: {
...
proc ::altera_phylite::ip_arch_nd::timing::generate_files {top_level} {
...
proc ::altera_phylite::ip_arch_nd::timing::_generate_ip_params_tcl {module ifile_name ofile_prefix} {
...
proc ::altera_phylite::ip_arch_nd::timing::_get_hpath_patterns_to_buffers {} {
   ...
   for { set i_grp_idx 0 } { $i_grp_idx < $num_grps } { incr i_grp_idx} {
      ...
      if {$i_pin_type == "INPUT" || $i_pin_type == "BIDIR"} {
         if {$i_strobe_config == "SINGLE_ENDED"} {
            lappend rclk "core|arch_inst|u_phylite_io_bufs|strobe_io_buf_gen\[${i_grp_idx}\].u_fourteennm_io_ibuf|i"
         ...
         for { set i_pin_idx 0 } { $i_pin_idx < $i_pin_width } { incr i_pin_idx } {
            if {$i_data_config == "SGL_ENDED"} {
               lappend rdata "core|arch_inst|u_phylite_io_bufs|data_io_buf_gen_grp\[${i_grp_idx}\].data_io_ibuf_gen\[${i_pin_idx}\].u_fourteennm_io_ibuf|i"
            } else {
...
proc ::altera_phylite::ip_arch_nd::timing::_generate_from_template {module ifile_name ofile_prefix} {
...
proc ::altera_phylite::ip_arch_nd::timing::_init {} {
}

::altera_phylite::ip_arch_nd::timing::_init

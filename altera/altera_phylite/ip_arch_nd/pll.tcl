...
package provide altera_phylite::ip_arch_nd::pll 0.1
...
namespace eval ::altera_phylite::ip_arch_nd::pll:: {
...
proc ::altera_phylite::ip_arch_nd::pll::add_pll_parameters {} {
   ...
   add_derived_hdl_param PLL_M_COUNTER_BYPASS_EN          boolean          false
   add_derived_hdl_param PLL_M_COUNTER_EVEN_DUTY_EN       boolean          false
   ...
   add_derived_hdl_param PLL_PHYCLK_0_BYPASS_EN           boolean          true
   ...
   add_derived_hdl_param PLL_PHYCLK_1_BYPASS_EN           boolean          true
   ...
   add_derived_hdl_param PLL_PHYCLK_FB_BYPASS_EN          boolean          true
   ...
   add_derived_hdl_param PLL_PHY_CLK_VCO_PHASE_PS_STR     string           "0 ps"   
}

proc ::altera_phylite::ip_arch_nd::pll::get_legal_pll_ref_clk_freqs_mhz {mem_clk_freq_mhz clk_ratios max_entries} {
...
proc ::altera_phylite::ip_arch_nd::pll::get_pll_vco_to_mem_clk_freq_ratio {} {
      	set family             [enum_data [get_device_family_enum] MEGAFUNC_NAME]
	set speedgrade         [get_parameter_value PHYLITE_PLL_SPEED_GRADE]
...
proc ::altera_phylite::ip_arch_nd::pll::get_pll_vco_min {} {
      	set family             [enum_data [get_device_family_enum] MEGAFUNC_NAME]
	set speedgrade         [get_parameter_value PHYLITE_PLL_SPEED_GRADE]
	set compensation_mode  direct
	set type               IOPLL
...
proc ::altera_phylite::ip_arch_nd::pll::get_pll_vco_max {} {
      	set family             [enum_data [get_device_family_enum] MEGAFUNC_NAME]
	set speedgrade         [get_parameter_value PHYLITE_PLL_SPEED_GRADE]
	set compensation_mode  direct
	set type               IOPLL
...
proc ::altera_phylite::ip_arch_nd::pll::derive_pll_parameters {mem_clk_freq_mhz ref_clk_freq_mhz clk_ratios} {
...
proc ::altera_phylite::ip_arch_nd::pll::get_pll_settings {mem_clk_freq_mhz ref_clk_freq_mhz clk_ratios} {
   ...
   set vco_min [get_pll_vco_min]
   set vco_max [get_pll_vco_max]
   
   emif_assert {$vco_freq_mhz >= $vco_min}
   emif_assert {$vco_freq_mhz <= $vco_max}
   
   return $retval
}

proc ::altera_phylite::ip_arch_nd::pll::has_user_half_clk {config_enum} {
...
proc ::altera_phylite::ip_arch_nd::pll::_get_legal_pll_ref_clk_freqs_mhz {
   max_entries \
   pfd_fmax_mhz \
   pfd_fmin_mhz \
   min_vco_div \
...
proc ::altera_phylite::ip_arch_nd::pll::_get_pll_settings {\
   mem_clk_freq_mhz \
   ref_clk_freq_mhz \
   clk_ratios \
   vco_to_mem_clk_freq_ratio
   ...
   if {$vco_freq_mhz > 933} {
      set phy_clk_vco_phase 4
   } else {
      set phy_clk_vco_phase 0
   }
   set phy_clk_vco_phase_ps [expr {int(round($vco_freq_ps * 1.0 * $phy_clk_vco_phase / 8))}]
   dict set retval PLL_PHY_CLK_VCO_PHASE $phy_clk_vco_phase
   dict set retval PLL_PHY_CLK_VCO_PHASE_PS_STR "$phy_clk_vco_phase_ps ps"
   ...
   lappend clks_list $phyclk_1_freq
   lappend clks_list $phy_clk_vco_phase_ps
   lappend clks_list 50
   
   lappend clks_list $phyclk_0_freq
   lappend clks_list $phy_clk_vco_phase_ps
   lappend clks_list 50
   					
   lappend clks_list $phyclk_fb_freq
   lappend clks_list $phy_clk_vco_phase_ps
   lappend clks_list 50
...
proc ::altera_phylite::ip_arch_nd::pll::_get_counter_settings {counter_val} {
   set retval [dict create]
...
proc ::altera_phylite::ip_arch_nd::pll::_get_mem_clk_to_slowest_phy_clk_freq_ratio {clk_ratios} {
   return [dict get $clk_ratios C2P_P2C]
}

proc ::altera_phylite::ip_arch_nd::pll::get_pll_output_clocks_info {mem_clk_freq_mhz} {
   ...
   set phy_hmc_clk_ratio  $user_afi_ratio
   set c2p_p2c_clk_ratio  $user_afi_ratio
   set slowest_clk_ratio  $user_afi_ratio
   set phyclk_0_counter   [expr {$vco_to_mem_clk_freq_ratio * $phy_hmc_clk_ratio}]
   set phyclk_0_freq      [expr {$vco_freq_mhz / $phyclk_0_counter}]
   set phyclk_1_counter   [expr {$vco_to_mem_clk_freq_ratio * $c2p_p2c_clk_ratio}]
   set phyclk_1_freq      [expr {$vco_freq_mhz / $phyclk_1_counter}]
   ...
   lappend reference_list $phyclk_1_freq
   lappend reference_list $phy_clk_vco_phase_ps
   lappend reference_list 50
   
   lappend reference_list $phyclk_0_freq
   lappend reference_list $phy_clk_vco_phase_ps
   lappend reference_list 50
   					
   lappend reference_list $phyclk_fb_freq
   lappend reference_list $phy_clk_vco_phase_ps
   lappend reference_list 50
...
proc ::altera_phylite::ip_arch_nd::pll::_init {} {
}

::altera_phylite::ip_arch_nd::pll::_init

...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  EMIF IOPLL instantiation for 14nm families
//
...
module pll #(
   ...
   localparam pll_clkin_0_src = (PLL_USE_CORE_REF_CLK == 1) ? "PLL_CLKIN_SRC_CORECLKIN" : "PLL_CLKIN_SRC_REFCLKIN";
   localparam pll_clkin_1_src = (PLL_USE_CORE_REF_CLK == 1) ? "PLL_CLKIN_SRC_CORECLKIN" : "PLL_CLKIN_SRC_REFCLKIN";
   ...
   fourteennm_iopll # (
      ...
      .csr_out                                    (),
      .dprio_clk                                  (1'b0),
      .dprio_rst_n                                (global_reset_n_int),
      .dprio_address                              (9'b0),
      .scan_mode_n                                (1'b1),
      .scan_shift_n                               (1'b1),
      .write                                      (1'b0),

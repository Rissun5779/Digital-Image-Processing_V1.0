...
///////////////////////////////////////////////////////////////////////////////
// Top-level wrapper of 14nm PHYLite component.
//
///////////////////////////////////////////////////////////////////////////////
module phylite_core_14 #(
	...
	parameter PHYLITE_USE_CPA_LOCK                    = 1,
    ...
    parameter A_FILTER_CODE                           = "freq_12ghz",
	...
	parameter pll_clk_out_en_0                        = "true",
	parameter pll_clk_out_en_1                        = "true",
	parameter pll_clk_out_en_2                        = "true",
	parameter pll_clk_out_en_3                        = "true",
	parameter pll_clk_out_en_4                        = "true",
	parameter pll_clk_out_en_5                        = "true",
	parameter pll_clk_out_en_6                        = "true",
	parameter pll_clk_out_en_7                        = "true",
	parameter pll_clk_out_en_8                        = "true",
    ...
    parameter [5:0]  GROUP_0_DQS_ENABLE_DELAY                = 1                ,
    parameter [12:0] GROUP_0_DQS_ENABLE_PHASE_SHIFT_A        = 275              ,	
    parameter [12:0] GROUP_0_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_0_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_0_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_0_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_0_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_0_READ_VALID_DELAY                = 12               ,
	parameter        GROUP_0_READ_LATENCY                    = 4,    
	parameter        GROUP_0_CAPTURE_PHASE_SHIFT             = 90,
	parameter        GROUP_0_USE_INTERNAL_CAPTURE_STROBE     = 0,
	parameter [12:0] GROUP_0_OUTPUT_DATA_PHASE               = 384              ,
	parameter        GROUP_0_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_0_OUTPUT_STROBE_PHASE_DER             = 640,
    ...
    parameter [5:0]  GROUP_1_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_1_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_1_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_1_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_1_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_1_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_1_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_1_READ_VALID_DELAY                = 12               ,
	parameter        GROUP_1_READ_LATENCY                    = 4,
	parameter        GROUP_1_CAPTURE_PHASE_SHIFT             = 90,
	parameter        GROUP_1_USE_INTERNAL_CAPTURE_STROBE     = 0,
	parameter [12:0] GROUP_1_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_1_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_1_OUTPUT_STROBE_PHASE_DER             = 512,
    ...
    parameter [5:0]  GROUP_2_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_2_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_2_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_2_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_2_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_2_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_2_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_2_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_2_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_2_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_2_OUTPUT_STROBE_PHASE_DER             = 90,
    ...
    parameter [5:0]  GROUP_3_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_3_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_3_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_3_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_3_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_3_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_3_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_3_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_3_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_3_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_3_OUTPUT_STROBE_PHASE_DER             = 90,
    ...
    parameter [5:0]  GROUP_4_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_4_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_4_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_4_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_4_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_4_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_4_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_4_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_4_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_4_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_4_OUTPUT_STROBE_PHASE_DER             = 90,
    ...
    parameter [5:0]  GROUP_5_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_5_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_5_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_5_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_5_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_5_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_5_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_5_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_5_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_5_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_5_OUTPUT_STROBE_PHASE_DER             = 90,
    ...
    parameter [5:0]  GROUP_6_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_6_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_6_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_6_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_6_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_6_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_6_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_6_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_6_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_6_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_6_OUTPUT_STROBE_PHASE_DER             = 90,
    ...
    parameter [5:0]  GROUP_7_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_7_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_7_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_7_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_7_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_7_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_7_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_7_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_7_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_7_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_7_OUTPUT_STROBE_PHASE_DER             = 90,
    ...
    parameter [5:0]  GROUP_8_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_8_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_8_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_8_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_8_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_8_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_8_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_8_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_8_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_8_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_8_OUTPUT_STROBE_PHASE_DER             = 90,
    ...
    parameter [5:0]  GROUP_9_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_9_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_9_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_9_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_9_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_9_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_9_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_9_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_9_OUTPUT_DATA_PHASE               = 256              ,
	parameter        GROUP_9_USE_OUTPUT_STROBE               = 1,
	parameter [12:0] GROUP_9_OUTPUT_STROBE_PHASE_DER             = 90,
    ...
    parameter [5:0]  GROUP_10_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_10_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_10_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_10_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_10_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_10_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_10_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_10_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_10_OUTPUT_DATA_PHASE              = 256              ,
	parameter        GROUP_10_USE_OUTPUT_STROBE              = 1,
	parameter [12:0] GROUP_10_OUTPUT_STROBE_PHASE_DER            = 512,
    ...
    parameter [5:0]  GROUP_11_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_11_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_11_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_11_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_11_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_11_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_11_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_11_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_11_OUTPUT_DATA_PHASE              = 256              ,
	parameter        GROUP_11_USE_OUTPUT_STROBE              = 1,
	parameter [12:0] GROUP_11_OUTPUT_STROBE_PHASE_DER            = 512,
    ...
    parameter [5:0]  GROUP_12_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_12_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_12_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_12_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_12_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_12_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_12_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_12_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_12_OUTPUT_DATA_PHASE              = 256              ,
	parameter        GROUP_12_USE_OUTPUT_STROBE              = 1,
	parameter [12:0] GROUP_12_OUTPUT_STROBE_PHASE_DER            = 512,
    ...
    parameter [5:0]  GROUP_13_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_13_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_13_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_13_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_13_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_13_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_13_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_13_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_13_OUTPUT_DATA_PHASE              = 256              ,
	parameter        GROUP_13_USE_OUTPUT_STROBE              = 1,
	parameter [12:0] GROUP_13_OUTPUT_STROBE_PHASE_DER            = 512,
    ...
    parameter [5:0]  GROUP_14_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_14_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_14_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_14_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_14_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_14_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_14_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_14_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_14_OUTPUT_DATA_PHASE              = 256              ,
	parameter        GROUP_14_USE_OUTPUT_STROBE              = 1,
	parameter [12:0] GROUP_14_OUTPUT_STROBE_PHASE_DER            = 512,
    ...
    parameter [5:0]  GROUP_15_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_15_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_15_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_15_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_15_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_15_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_15_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_15_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_15_OUTPUT_DATA_PHASE              = 256              ,
	parameter        GROUP_15_USE_OUTPUT_STROBE              = 1,
	parameter [12:0] GROUP_15_OUTPUT_STROBE_PHASE_DER            = 512,
    ...
    parameter [5:0]  GROUP_16_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_16_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_16_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_16_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_16_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_16_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_16_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_16_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_16_OUTPUT_DATA_PHASE              = 256              ,
	parameter        GROUP_16_USE_OUTPUT_STROBE              = 1,
	parameter [12:0] GROUP_16_OUTPUT_STROBE_PHASE_DER            = 512,
    ...
    parameter [5:0]  GROUP_17_DQS_ENABLE_DELAY                = 2                ,
    parameter [12:0] GROUP_17_DQS_ENABLE_PHASE_SHIFT_A        = 140              ,	
    parameter [12:0] GROUP_17_DQS_ENABLE_PHASE_SHIFT_B        = 140              ,
    parameter string GROUP_17_DQS_A_CAPTURE                   = "dqs_diff_1"     ,
    parameter string GROUP_17_DQS_B_CAPTURE                   = "dqs_constant"   ,
    parameter [9:0]  GROUP_17_DQS_DELAY_A                     = 512              ,
    parameter [9:0]  GROUP_17_DQS_DELAY_B                     = 0                ,
    parameter [6:0]  GROUP_17_READ_VALID_DELAY                = 12               ,
	...
	parameter [12:0] GROUP_17_OUTPUT_DATA_PHASE              = 256              ,
	parameter        GROUP_17_USE_OUTPUT_STROBE              = 1,
	parameter [12:0] GROUP_17_OUTPUT_STROBE_PHASE_DER            = 512,
	...
	localparam integer GROUP_DQS_ENABLE_DELAY [0:17] = '{ GROUP_0_DQS_ENABLE_DELAY	,
							GROUP_1_DQS_ENABLE_DELAY	,
							GROUP_2_DQS_ENABLE_DELAY	,
							GROUP_3_DQS_ENABLE_DELAY	,
							GROUP_4_DQS_ENABLE_DELAY	,
							GROUP_5_DQS_ENABLE_DELAY	,
							GROUP_6_DQS_ENABLE_DELAY	,
							GROUP_7_DQS_ENABLE_DELAY	,
							GROUP_8_DQS_ENABLE_DELAY	,
							GROUP_9_DQS_ENABLE_DELAY	,
							GROUP_10_DQS_ENABLE_DELAY	,
							GROUP_11_DQS_ENABLE_DELAY	,
							GROUP_12_DQS_ENABLE_DELAY	,
							GROUP_13_DQS_ENABLE_DELAY	,
							GROUP_14_DQS_ENABLE_DELAY	,
							GROUP_15_DQS_ENABLE_DELAY	,
							GROUP_16_DQS_ENABLE_DELAY	,
							GROUP_17_DQS_ENABLE_DELAY	};

	localparam integer GROUP_DQS_ENABLE_PHASE_SHIFT_A [0:17] = '{ GROUP_0_DQS_ENABLE_PHASE_SHIFT_A	,
									GROUP_1_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_2_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_3_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_4_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_5_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_6_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_7_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_8_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_9_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_10_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_11_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_12_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_13_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_14_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_15_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_16_DQS_ENABLE_PHASE_SHIFT_A ,
									GROUP_17_DQS_ENABLE_PHASE_SHIFT_A };

	localparam integer GROUP_DQS_ENABLE_PHASE_SHIFT_B [0:17] = '{ GROUP_0_DQS_ENABLE_PHASE_SHIFT_B	,
									GROUP_1_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_2_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_3_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_4_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_5_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_6_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_7_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_8_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_9_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_10_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_11_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_12_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_13_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_14_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_15_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_16_DQS_ENABLE_PHASE_SHIFT_B ,
									GROUP_17_DQS_ENABLE_PHASE_SHIFT_B };
	...
	localparam [12:0] GROUP_OUTPUT_DATA_PHASE [0:17] =    '{ GROUP_0_OUTPUT_DATA_PHASE ,
	                                                         GROUP_1_OUTPUT_DATA_PHASE ,
	                                                         GROUP_2_OUTPUT_DATA_PHASE ,
	                                                         GROUP_3_OUTPUT_DATA_PHASE ,
	                                                         GROUP_4_OUTPUT_DATA_PHASE ,
	                                                         GROUP_5_OUTPUT_DATA_PHASE ,
	                                                         GROUP_6_OUTPUT_DATA_PHASE ,
	                                                         GROUP_7_OUTPUT_DATA_PHASE ,
	                                                         GROUP_8_OUTPUT_DATA_PHASE ,
	                                                         GROUP_9_OUTPUT_DATA_PHASE ,
	                                                         GROUP_10_OUTPUT_DATA_PHASE,
	                                                         GROUP_11_OUTPUT_DATA_PHASE,
	                                                         GROUP_12_OUTPUT_DATA_PHASE,
	                                                         GROUP_13_OUTPUT_DATA_PHASE,
	                                                         GROUP_14_OUTPUT_DATA_PHASE,
	                                                         GROUP_15_OUTPUT_DATA_PHASE,
	                                                         GROUP_16_OUTPUT_DATA_PHASE,
	                                                         GROUP_17_OUTPUT_DATA_PHASE};
	...
	localparam [12:0] GROUP_OUTPUT_STROBE_PHASE [0:17] =  '{ GROUP_0_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_1_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_2_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_3_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_4_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_5_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_6_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_7_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_8_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_9_OUTPUT_STROBE_PHASE_DER ,
	                                                         GROUP_10_OUTPUT_STROBE_PHASE_DER,
	                                                         GROUP_11_OUTPUT_STROBE_PHASE_DER,
	                                                         GROUP_12_OUTPUT_STROBE_PHASE_DER,
	                                                         GROUP_13_OUTPUT_STROBE_PHASE_DER,
	                                                         GROUP_14_OUTPUT_STROBE_PHASE_DER,
	                                                         GROUP_15_OUTPUT_STROBE_PHASE_DER,
	                                                         GROUP_16_OUTPUT_STROBE_PHASE_DER,
	                                                         GROUP_17_OUTPUT_STROBE_PHASE_DER};
	...
	wire [47:0] emif_phy_out_a[0:PHYLITE_NUM_GROUPS-1];
	wire [47:0] emif_phy_out_b[0:PHYLITE_NUM_GROUPS-1];
	...
	////////////////////////////////////////////////////////////////////////////
	// Locked signal
	assign interface_locked = groups_locked; 
   ...
   generate
		if (PHYLITE_USE_CPA_LOCK == 0 && PHYLITE_USE_CPA == 1) begin
            altera_std_synchronizer_nocut #(.depth(3)) lock_sync_inst (
                .clk(core_clk_out), 
                .reset_n(reset_n), 
                .din(groups_locked_wire), 
                .dout(groups_locked)
            );
		end else begin
	...
	pll # (
		...
		.pll_cp_setting                      ("pll_cp_setting0"), 
	...
	generate
		if (PHYLITE_USE_DYNAMIC_RECONFIGURATION == 1) begin : io_aux_ctrl
			...
			fourteennm_io_aux #(
				...
				.nios_exception_vector_word_addr (16'h0000                ),
	...
	generate
		...
		for(grp_num = 0; grp_num < PHYLITE_NUM_GROUPS; grp_num = grp_num + 1) begin : group_gen
			...
			phylite_group_tile_14 #(
                ...
                .DQS_ENABLE_DELAY             (GROUP_DQS_ENABLE_DELAY             [grp_num]),
                .DQS_ENABLE_PHASE_SHIFT_A     (GROUP_DQS_ENABLE_PHASE_SHIFT_A     [grp_num]),	
                .DQS_ENABLE_PHASE_SHIFT_B     (GROUP_DQS_ENABLE_PHASE_SHIFT_B     [grp_num]),
	            .OUTPUT_DATA_PHASE            (GROUP_OUTPUT_DATA_PHASE           [grp_num]),
				...
				.emif_phy_out_a       (emif_phy_out_a[grp_num]),
				.emif_phy_out_b       (emif_phy_out_b[grp_num]),
	...
	phylite_io_bufs #(
		...
		.emif_phy_in_a (emif_phy_out_a),
		.emif_phy_in_b (emif_phy_out_b),
	...
	assign core_clk_buffered = pa_core_clks[0];

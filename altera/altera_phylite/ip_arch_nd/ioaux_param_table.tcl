...
package provide altera_phylite::ip_arch_nd::ioaux_param_table 0.1
...
namespace eval ::altera_phylite::ip_arch_nd::ioaux_param_table:: {
...
proc ::altera_phylite::ip_arch_nd::ioaux_param_table::add_parameters {} {

}

proc ::altera_phylite::ip_arch_nd::ioaux_param_table::derive_parameters {} {

}

proc ::altera_phylite::ip_arch_nd::ioaux_param_table::get_param_table_filename_parameter_name { } {

   return "PARAM_TABLE_HEX_FILENAME"

}

proc ::altera_phylite::ip_arch_nd::ioaux_param_table::get_param_table_filename { top_level } {
...
proc ::altera_phylite::ip_arch_nd::ioaux_param_table::generate_ioaux_files { top_level } {
...
proc ::altera_phylite::ip_arch_nd::ioaux_param_table::_generate_ioaux_table { top_level } {
...
proc ::altera_phylite::ip_arch_nd::ioaux_param_table::_generate_gpt {gpt_size pt_size data_size} {
...
proc ::altera_phylite::ip_arch_nd::ioaux_param_table::_generate_pt {gpt_size} {
   ...
   for { set i 0 } { $i < ${num_grps} } {incr i } {
      set num_pins    [get_parameter_value "GROUP_${i}_PIN_WIDTH"]
...
proc ::altera_phylite::ip_arch_nd::ioaux_param_table::_generate_lane_assignments {} {
...
proc ::altera_phylite::ip_arch_nd::ioaux_param_table::_generate_pin_assignments {} {
...
proc ::altera_phylite::ip_arch_nd::ioaux_param_table::_generate_ioaux_headers {} {

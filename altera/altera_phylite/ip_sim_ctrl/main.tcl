...
proc ::altera_phylite::ip_sim_ctrl::main::create_parameters {} {
   ...
   add_derived_hdl_param USE_ADDR_CMD_GEN integer 0
   ...
   set_parameter_property USE_ADDR_CMD_GEN 		      HDL_PARAMETER true
...
proc ::altera_phylite::ip_sim_ctrl::main::elaboration_callback {} {
   ...
   set family [get_parameter_value SYS_INFO_DEVICE_FAMILY]
	   ...
	   set_parameter_property USE_ADDR_CMD_GEN HDL_PARAMETER false
	   set_parameter_property USE_ADDR_CMD_GEN ENABLED false
   ...
   add_interface_port dut_lock_conduit_end dut_locked start Input 1

   add_interface addr_cmd_lock_conduit_end conduit end
   set_interface_property addr_cmd_lock_conduit_end ENABLED true
   add_interface_port addr_cmd_lock_conduit_end addr_cmd_locked locked Input 1

   _elaborate_core_interface
   _elaborate_cfg_ctrl_interface
...
proc ::altera_phylite::ip_sim_ctrl::main::_elaborate_side_interface {} {
   ...
   add_interface_port $side_interface side_readaddr       side_readaddr        Output 4
   add_interface_port $side_interface agent_select        agent_select         Output $num_grps
   set_port_property agent_select VHDL_TYPE STD_LOGIC_VECTOR
...
proc ::altera_phylite::ip_sim_ctrl::main::_elaborate_core_cmd_interface {} {
   ...
   set_port_property core_cmd_clk_oe VHDL_TYPE STD_LOGIC_VECTOR
}
...
proc ::altera_phylite::ip_sim_ctrl::main::_elaborate_mem_cmd_interface {} {
   ...
   add_interface_port $cmd_interface mem_cmd_clk io_strobe_out Input 1

}

proc ::altera_phylite::ip_sim_ctrl::main::_elaborate_cfg_ctrl_interface {} {

   set use_dyn_cfg [get_parameter_value PHYLITE_USE_DYNAMIC_RECONFIGURATION]

   add_interface cfg_clk_rst_conduit_end conduit end
   set_interface_property cfg_clk_rst_conduit_end ENABLED true
   add_interface_port cfg_clk_rst_conduit_end cfg_ctrl_clk core_clk Output 1
   add_interface_port cfg_clk_rst_conduit_end cfg_ctrl_rst_n reset_n Output 1

   add_interface cfg_ctrl_conduit_end conduit end
   set_interface_property cfg_ctrl_conduit_end ENABLED true
   add_interface_port cfg_ctrl_conduit_end cfg_ctrl_rdy      cfg_ctrl_rdy      Input  1
   add_interface_port cfg_ctrl_conduit_end cfg_start_write   cfg_start_write   Output 1
   add_interface_port cfg_ctrl_conduit_end cfg_start_read    cfg_start_read    Output 1
   add_interface_port cfg_ctrl_conduit_end cfg_start_read_en cfg_start_read_en Output 1
   add_interface_port cfg_ctrl_conduit_end cfg_done          cfg_done          Input  1
   add_interface_port cfg_ctrl_conduit_end cfg_grp           cfg_grp           Output 5
   add_interface_port cfg_ctrl_conduit_end cfg_interface     cfg_interface     Output 4
   add_interface_port cfg_ctrl_conduit_end cfg_strbs         cfg_strbs         Output 3
   ...
   add_interface_port cfg_ctrl_conduit_end sim_ctrl_write_and_readback         sim_ctrl_write_and_readback         Input  1
   add_interface_port cfg_ctrl_conduit_end sim_ctrl_write_and_readback_done    sim_ctrl_write_and_readback_done    Output 1
   add_interface_port cfg_ctrl_conduit_end sim_ctrl_write_and_readback_success sim_ctrl_write_and_readback_success Output 1
   add_interface_port cfg_ctrl_conduit_end sim_ctrl_read                       sim_ctrl_read                       Input  1
   add_interface_port cfg_ctrl_conduit_end sim_ctrl_read_done                  sim_ctrl_read_done                  Output 1
   add_interface_port cfg_ctrl_conduit_end sim_ctrl_read_success               sim_ctrl_read_success               Output 1
   add_interface_port cfg_ctrl_conduit_end sim_ctrl_read_bit0_success          sim_ctrl_read_bit0_success          Output 1

   if {[string compare -nocase $use_dyn_cfg "false"] == 0} {
      set_port_property cfg_ctrl_clk                        TERMINATION true
      set_port_property cfg_ctrl_rdy                        TERMINATION true
      set_port_property cfg_start_write                     TERMINATION true
      set_port_property cfg_start_read                      TERMINATION true
      set_port_property cfg_start_read_en                   TERMINATION true
      set_port_property cfg_done                            TERMINATION true
      set_port_property cfg_grp                             TERMINATION true
      set_port_property cfg_interface                       TERMINATION true
      set_port_property cfg_strbs                           TERMINATION true
      set_port_property sim_ctrl_write_and_readback         TERMINATION true
      set_port_property sim_ctrl_write_and_readback_done    TERMINATION true
      set_port_property sim_ctrl_write_and_readback_success TERMINATION true
      set_port_property sim_ctrl_read                       TERMINATION true
      set_port_property sim_ctrl_read_done                  TERMINATION true
      set_port_property sim_ctrl_read_success               TERMINATION true
      set_port_property sim_ctrl_read_bit0_success          TERMINATION true
   }

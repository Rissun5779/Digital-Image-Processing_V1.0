...
proc create_constants {} {
	...
	SDC_CREATE_EMAC_CLOCK  "create_clock -name %%s -period %%s [get_keepers {*|fpga_interfaces|peripheral_emac%%s~internal_clock}] -add"
	MHZ_TO_HZ              "1000000.0"
...
proc peripherals_in_group {group_name} {
    ...
    if {[string compare $group_name "Quad SPI Flash Controller"] == 0}        { return {QSPI}                    }
    if {[string compare $group_name "SD/MMC Controller"] == 0}                { return {SDIO}                    }

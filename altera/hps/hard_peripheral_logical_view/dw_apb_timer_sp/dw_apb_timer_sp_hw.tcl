...
#
# module dw-apb-timer-sp
#
hps_utils_add_component_boiler_plate dw-apb-timer-sp {Synopsys SP Timer}
#
# file sets
#
#
...
set_module_assignment embeddedsw.dts.compatible {snps,dw-apb-timer-sp}
set_module_assignment embeddedsw.dts.group timer
set_module_assignment embeddedsw.dts.name dw-apb-timer-sp

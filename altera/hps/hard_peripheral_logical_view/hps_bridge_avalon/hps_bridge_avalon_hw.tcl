...
hps_utils_add_axi_slave axi_h2f    axi_sig0 29 16
...
#hps_utils_add_axi_master axi_f2s axi_f2s_master_sig clock_sink reset_sink 1 32 32 4
...
proc elaborate {} {
    ...
    set_interface_property      f2h readDataReorderingDepth 16
...
proc add_port {registers_var index type_id width instance_name} {
	...
	#set_interface_property $data_name bridgesToMaster axi_f2s
}

...
#
hps_utils_add_component_boiler_plate dw_wd_timer {Synopsys WatchDog Timer}
#
# file sets
#
#
...
set_module_assignment embeddedsw.dts.compatible {snps,dw-wdt}
set_module_assignment embeddedsw.dts.group timer
set_module_assignment embeddedsw.dts.name dw-wdt

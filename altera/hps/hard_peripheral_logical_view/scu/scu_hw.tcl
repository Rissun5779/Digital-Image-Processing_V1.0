...
# module fpgamgr
#
hps_utils_add_component_boiler_plate scu {ARM Snoop Control Unit}
...
set_module_assignment embeddedsw.dts.group scu
set_module_assignment embeddedsw.dts.name {corex-a9-scu}
set_module_assignment embeddedsw.dts.vendor arm
set_module_assignment embeddedsw.dts.compatible {arm,cortex-a9-scu}
# 
# display items
# 

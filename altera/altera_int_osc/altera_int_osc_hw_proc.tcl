...
# +-----------------------------------
# | 
# | $Header: //acds/rel/18.1std/ip/altera_int_osc/altera_int_osc_hw_proc.tcl#1 $
# | 
# +-----------------------------------
...
proc update_display_message {} {
	...
	} elseif {($get_device_family == "Cyclone III") || ($get_device_family == "Cyclone III LS") || ($get_device_family == "Cyclone IV E") || ($get_device_family == "Cyclone IV GX") || ($get_device_family == "Cyclone 10 LP")} {

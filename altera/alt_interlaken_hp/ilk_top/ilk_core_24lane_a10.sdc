...
set_cross_clk_sdc {tx_usr_clk} {*g_xcvr_native_insts[12]*tx_pma_clk}

set_cross_clk_sdc {*g_xcvr_native_insts[12]*tx_pma_clk} {tx_usr_clk}
...
set_cross_clk_sdc {*g_xcvr_native_insts[12]*rx_pma_clk} {rx_usr_clk}

set_cross_clk_sdc {rx_usr_clk} {*g_xcvr_native_insts[12]*rx_pma_clk}

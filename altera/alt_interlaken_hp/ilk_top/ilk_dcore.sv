...
module ilk_dcore #(
   ...
   input                               itx_eob,
   input       [CALENDAR_PAGES*16-1:0] itx_calendar,        // 0 is XOFF, 1 is XON
   ...
   input                               tx_pll_locked,     
   input                               pll_ref_clk,          // 300Mhz user clock.
   input                               reset_n,
    ...
    input      [NUM_LANES-1:0]          sync_locked_pcsclk,     //from phy     
    input      [NUM_LANES-1:0]          word_locked_pcsclk,     //from phy     
    input      [NUM_LANES-1:0]          crc32_err_pcsclk,       //from phy     
    ...
    input                               tx_digitalreset_0,      //from reset ctrl
    input                               rx_digitalreset_0       //from reset ctrl
);
...
*/
// 06-21-2015 The error handling will align crc24 error at the end of the burst which is taking care of at the regroup logic

...
set_false_path -from [get_clocks {*pcs_assembly_a10*g_xcvr_native_insts*twentynm_xcvr_native*twentynm_pma|ch*gen_twentynm_hssi_pma_tx_cgb*twentynm_hssi_pma_tx_cgb*cpulse_out_bus[*]}] -to [get_clocks {tx_usr_clk}]

# set_false_path -from [get_clocks {*inst_sv_pcs*inst_sv_pcs_ch*hssi_10g_tx_pcs*txclkout}] -to [get_clocks {mm_clk}]

set_false_path -from [get_clocks {*pcs_assembly_a10*np*g_xcvr_native_insts*twentynm_xcvr_native*twentynm_pma_ch*twentynm_hssi_pma_rx_deser*clkdiv}] -to [get_clocks {mm_clk}]

set_false_path -from [get_clocks {*pcs_assembly_a10*g_xcvr_native_insts*twentynm_xcvr_native*inst_twentynm_hssi_pma_tx_cgb*cpulse_out_bus[*]}] -to [get_clocks {mm_clk}]
...
set_false_path -from [get_clocks {mm_clk}] -to  [get_clocks {*pcs_assembly_a10*g_xcvr_native_insts*twentynm_xcvr_native*inst_twentynm_hssi_pma_tx_cgb*cpulse_out_bus[*]}] 
...
set_false_path -from [get_clocks {*pcs_assembly_a10*np*g_xcvr_native_insts*twentynm_xcvr_native_inst*twentynm_pma_ch*twentynm_hssi_pma_rx_deser*clkdiv}] -to [get_clocks {rx_usr_clk}]
...
#}
###
set_false_path -through [get_pins -compatibility_mode {*pcs_assembly_a10*xcvr_native*hssi_rx_pld_pcs_interface*pld_10g_rx_crc32_err*} ] -to [get_registers {*din_toggle*}]
set_false_path -through [get_pins -compatibility_mode {*pcs_assembly_a10*xcvr_native*hssi_rx_pld_pcs_interface**pld_10g_rx_crc32_err*} ] -to [get_registers {*din_r*}]

...
# $File: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_skid_buffer/alt_hiconnect_skid_buffer_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_module_property NAME alt_hiconnect_skid_buffer
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property GROUP "Qsys Interconnect/Memory-Mapped Alpha"
set_module_property DISPLAY_NAME "Avalon-ST Skid Buffer"
...
set_fileset_property synthesis_fileset TOP_LEVEL alt_hiconnect_skid_buffer

add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL alt_hiconnect_skid_buffer

add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_skid_buffer

proc synth_callback_procedure { entity_name } {
    add_fileset_file alt_hiconnect_skid_buffer.sv SYSTEM_VERILOG PATH "alt_hiconnect_skid_buffer.sv"
    add_fileset_file alt_hiconnect_pipeline_base.v SYSTEM_VERILOG PATH "alt_hiconnect_pipeline_base.v"
}

...
set_module_property NAME alt_hiconnect_axi_slv_agent
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Qsys Interconnect/Memory-Mapped Alpha"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "AXI Slave Agent"
...
set_fileset_property synthesis_fileset TOP_LEVEL alt_hiconnect_axi_slv_agent

add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL alt_hiconnect_axi_slv_agent

add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_axi_slv_agent

proc synth_callback_procedure { entity_name } {
    add_fileset_file alt_hiconnect_axi_slv_agent.sv SYSTEM_VERILOG PATH "alt_hiconnect_axi_slv_agent.sv"

...
module alt_hiconnect_axi_slv_agent
#(
    // -----------------------------------------------
...
(
    ...
    localparam  RD_RSP_FIFO_WIDTH   = ST_DATA_W + 2; // two extra bits to store single_cycle_transfer, read_cp_endofpacket
    ...
    wire [RD_RSP_FIFO_WIDTH-1:0]        read_rsp_fifo_indata;  
    wire [RD_RSP_FIFO_WIDTH-1:0]        read_rsp_fifo_outdata;
    ...
    wire                                single_cycle_transfer;    
    wire                                read_rsp_fifo_single_cycle_transfer;
    ...
    begin
        ...
        write_rp_data[PKT_DATA_H:PKT_DATA_L]                        = '0;
    ...
    assign single_cycle_transfer    = (read_cmd_bytecount == NUMSYMBOLS);
    ...
    assign read_rsp_fifo_indata = {single_cycle_transfer, read_cp_endofpacket, read_cp_data_for_fifo}; 
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
    ...
    assign read_rsp_fifo_single_cycle_transfer = read_rsp_fifo_outdata[RD_RSP_FIFO_WIDTH-1];
    assign read_rsp_fifo_outdata_eop           = read_rsp_fifo_outdata[RD_RSP_FIFO_WIDTH-2];
    ...
    alt_hiconnect_burst_uncompressor #(
        .ADDR_W         (ADDR_WIDTH),
        .BURSTWRAP_W    (BURSTWRAP_W),
        ...
        .sink_single_cycle_transfer (read_rsp_fifo_single_cycle_transfer),
    ...
    alt_hiconnect_sc_fifo #(
        .IMPL                ("reg"),
        .SYMBOLS_PER_BEAT    (1),
        .BITS_PER_SYMBOL     (ST_DATA_W + 1),  // one extra bit for write_cp_endofpacket
    ...
    alt_hiconnect_sc_fifo #(
        .IMPL                ("reg"),
        .SYMBOLS_PER_BEAT    (1),
        .BITS_PER_SYMBOL     (RD_RSP_FIFO_WIDTH),

...
# $Id: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_axi_mstr_agent/alt_hiconnect_axi_mstr_agent_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_module_property NAME alt_hiconnect_axi_mstr_agent
set_module_property DESCRIPTION "Converts AXI transactions to Qsys packets"
set_module_property VERSION 18.1
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Qsys Interconnect/Memory-Mapped Alpha"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "AXI Master Agent"
...
set_fileset_property synthesis_fileset TOP_LEVEL alt_hiconnect_axi_mstr_agent
add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL alt_hiconnect_axi_mstr_agent
add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_axi_mstr_agent

proc synth_callback_procedure { entity_name } {
    add_fileset_file alt_hiconnect_axi_mstr_agent.sv SYSTEM_VERILOG PATH "alt_hiconnect_axi_mstr_agent.sv"
    add_fileset_file alt_hiconnect_address_alignment.sv SYSTEM_VERILOG PATH "alt_hiconnect_address_alignment.sv"
}
...
set_parameter_property ID_WIDTH DESCRIPTION "Controls the width for all transaction ID signals"
...
add_parameter BURST_LENGTH_WIDTH INTEGER 4
set_parameter_property BURST_LENGTH_WIDTH DISPLAY_NAME "AXI master burst length width"
...
set_parameter_property BURST_LENGTH_WIDTH DESCRIPTION "AXI burst length width"
...
add_parameter LOCK_WIDTH INTEGER 2
set_parameter_property LOCK_WIDTH DISPLAY_NAME "AXI master lock width"
...
set_parameter_property LOCK_WIDTH DESCRIPTION "AXI lock signals width"
...
set_parameter_property WRITE_ISSUING_CAPABILITY DESCRIPTION "The number of outstanding write transactions that the master can issue"
...
set_parameter_property READ_ISSUING_CAPABILITY DESCRIPTION "The number of outstanding read transactions that the master can issue"
...
add_display_item "AXI Master Interface " BURST_LENGTH_WIDTH PARAMETER ""
add_display_item "AXI Master Interface " LOCK_WIDTH PARAMETER ""
...
# Write request port
add_interface write_req avalon_streaming start
set_interface_property write_req associatedClock clk
set_interface_property write_req associatedReset clk_reset
set_interface_property write_req dataBitsPerSymbol 108
set_interface_property write_req errorDescriptor ""
set_interface_property write_req firstSymbolInHighOrderBits true
set_interface_property write_req maxChannel 0
set_interface_property write_req readyLatency 0
set_interface_property write_req ENABLED true

add_interface_port write_req write_req_valid valid Output 1
add_interface_port write_req write_req_data data Output 108
add_interface_port write_req write_req_startofpacket startofpacket Output 1
add_interface_port write_req write_req_endofpacket endofpacket Output 1
...
# Read request port
add_interface read_req avalon_streaming start
set_interface_property read_req associatedClock clk
set_interface_property read_req associatedReset clk_reset
set_interface_property read_req dataBitsPerSymbol 108
set_interface_property read_req errorDescriptor ""
set_interface_property read_req firstSymbolInHighOrderBits true
set_interface_property read_req maxChannel 0
set_interface_property read_req readyLatency 0
set_interface_property read_req ENABLED true

add_interface_port read_req read_req_valid valid Output 1
add_interface_port read_req read_req_data data Output 108
add_interface_port read_req read_req_startofpacket startofpacket Output 1
add_interface_port read_req read_req_endofpacket endofpacket Output 1
...
proc elaborate {} {
    ...
    set lock_width    [ get_parameter_value LOCK_WIDTH ]
    ...
    if { $axi_version == "AXI4" } {
        ...
        # Instead of adding the wid port to the axi4 interface and terminating
        # it, the authors have decided to create a separate conduit for the
        # wid port and terminate it there, keeping the axi4 interface "pure".
        #
        # This strategy for VHDL support (all entity ports must be in the
        # instantiation) is followed elsewhere in this component.
        ...
        # See previous comment about the wid port on AXI4 and VHDL support
        ...
        add_interface_port my_export wuser wuser input $data_user
        set_port_property wuser vhdl_type std_logic_vector
        set_port_property wuser TERMINATION true
        add_interface_port my_export ruser ruser output $data_user
        set_port_property ruser vhdl_type std_logic_vector
        set_port_property ruser TERMINATION true
        add_interface_port my_export buser buser output $data_user
        set_port_property buser vhdl_type std_logic_vector
    ...
    set_port_property write_req_data WIDTH_EXPR $st_data_width
    set_port_property write_req_data vhdl_type std_logic_vector
    set_port_property write_cp_data WIDTH_EXPR $st_data_width
    set_port_property write_cp_data vhdl_type std_logic_vector
    set_port_property read_req_data WIDTH_EXPR $st_data_width
    set_port_property read_req_data vhdl_type std_logic_vector
    ...
    set_interface_property write_req dataBitsPerSymbol $st_data_width
    set_interface_property write_cp  dataBitsPerSymbol $st_data_width
    set_interface_property read_req  dataBitsPerSymbol $st_data_width
    ...
    set_packet_format write_req
    set_packet_format write_cp
    set_packet_format write_rp
    set_packet_format read_req

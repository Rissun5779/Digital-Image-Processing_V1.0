...
//-----------------------------------------
// Address alignment: 
// This component will align input address with input size.
// Support address increment with burst type and burstwrap value.
//-----------------------------------------
`timescale 1 ns / 1 ns

module alt_hiconnect_address_alignment
#( 
   parameter 
            ADDR_W            = 12,
            BURSTWRAP_W       = 12,

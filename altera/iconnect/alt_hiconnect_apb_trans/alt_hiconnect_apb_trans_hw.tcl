...
# $Id: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_apb_trans/alt_hiconnect_apb_trans_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
# 
...
set_module_property NAME alt_hiconnect_apb_trans
set_module_property DESCRIPTION "APB translator: sets default values for optional signals"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL alt_hiconnect_apb_trans
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file alt_hiconnect_apb_trans.sv SYSTEM_VERILOG PATH alt_hiconnect_apb_trans.sv

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL alt_hiconnect_apb_trans
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file alt_hiconnect_apb_trans.sv SYSTEM_VERILOG PATH alt_hiconnect_apb_trans.sv

add_fileset vhdl_fileset SIM_VHDL "" ""
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_apb_trans
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file alt_hiconnect_apb_trans.sv SYSTEM_VERILOG PATH alt_hiconnect_apb_trans.sv

...
// $Id: //acds/prototype/mm_s10/ip/merlin/altera_merlin_traffic_limiter/altera_merlin_reorder_memory.sv#4 $
// $Revision: #4 $
// $Date: 2015/06/24 $
// $Author: nkrueger $
...
module alt_hiconnect_reorder_memory
#(
   parameter  DATA_W         = 32,
...
(
    ...
    // --------------------------------------------
    input wire [ADDR_H_W - 1 : 0]  wr_segment,
    input wire [ADDR_H_W - 1 : 0]  rd_segment
...
(
    ...
    // -------------------------------
	output wire [ADDR_W - 1 : 0] wr_pointer,
	output wire [ADDR_W - 1 : 0] rd_pointer,
    output wire [ADDR_W - 1 : 0] next_rd_pointer
);

...
# $Id: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_av_mstr_trans/alt_hiconnect_av_mstr_trans_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_module_property NAME alt_hiconnect_av_mstr_trans
...
set_fileset_property synthesis_fileset TOP_LEVEL alt_hiconnect_av_mstr_trans

add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL alt_hiconnect_av_mstr_trans

add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_av_mstr_trans

proc synth_callback_procedure { entity_name } {
    add_fileset_file alt_hiconnect_av_mstr_trans.sv SYSTEM_VERILOG PATH "alt_hiconnect_av_mstr_trans.sv"
}

...
// $Id: //acds/prototype/mm_s10/ip/merlin/altera_merlin_master_translator/altera_merlin_master_translator.sv#2 $
// $Revision: #2 $
// $Date: 2015/05/15 $
// $Author: jyeap $
...
module alt_hiconnect_av_mstr_trans #(
   parameter
      // widths
      AV_ADDRESS_W                = 32,
      AV_DATA_W                   = 32,
   ...
   // ------------------------------------------------------------
   // Pipeline the synchronous reset
   // ------------------------------------------------------------
   reg internal_sclr;

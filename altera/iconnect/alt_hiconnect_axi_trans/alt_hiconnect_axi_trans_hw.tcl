...
# $Id: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_axi_trans/alt_hiconnect_axi_trans_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
#
set_module_property NAME alt_hiconnect_axi_trans
...
set_fileset_property synthesis_fileset TOP_LEVEL alt_hiconnect_axi_trans

add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL alt_hiconnect_axi_trans

add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_axi_trans

proc synth_callback_procedure { entity_name } {
    add_fileset_file alt_hiconnect_axi_trans.sv SYSTEM_VERILOG PATH "alt_hiconnect_axi_trans.sv"
}
...
proc elaborate {} {
    ...
    set_port_property ${slave_name}_awaddr vhdl_type std_logic_vector
    ...
    set_port_property ${slave_name}_araddr vhdl_type std_logic_vector
    ...
    set_port_property ${slave_name}_wdata vhdl_type std_logic_vector
    set_port_property ${slave_name}_rdata WIDTH_EXPR $data_width
    set_port_property ${slave_name}_rdata vhdl_type std_logic_vector

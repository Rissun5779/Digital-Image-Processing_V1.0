...
( 
    ...
    input wire [2:0]                 in_command_size_data
);
   ...
   generate
      ...
      if (OUT_NUMSYMBOLS > IN_NUMSYMBOLS)  begin
         ...
         wire burst_uncomp_sink_single_cycle_transfer;
        ...
        reg [9:0]   size_ratio;
         ...
         assign burst_uncomp_sink_single_cycle_transfer = (p0_byte_cnt_field == IN_NUMSYMBOLS);
         ...
         #(
            ...
            .sink_single_cycle_transfer (burst_uncomp_sink_single_cycle_transfer),

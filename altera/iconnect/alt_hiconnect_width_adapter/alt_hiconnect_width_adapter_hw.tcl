...
# $Id: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_width_adapter/alt_hiconnect_width_adapter_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_module_property NAME alt_hiconnect_width_adapter
...
set_fileset_property synthesis_fileset TOP_LEVEL alt_hiconnect_width_adapter 
add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL alt_hiconnect_width_adapter
add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_width_adapter

proc synth_callback_procedure { entity_name } {
    add_fileset_file alt_hiconnect_width_adapter.sv SYSTEM_VERILOG PATH "alt_hiconnect_width_adapter.sv"
    ...
    add_fileset_file alt_hiconnect_burst_uncompressor.sv SYSTEM_VERILOG PATH "../alt_hiconnect_av_slv_agent/alt_hiconnect_burst_uncompressor.sv"
}
...
add_parameter IN_PKT_TRANS_WRITE INTEGER 64
set_parameter_property IN_PKT_TRANS_WRITE DISPLAY_NAME {Input packet write transaction field index}
set_parameter_property IN_PKT_TRANS_WRITE UNITS None
set_parameter_property IN_PKT_TRANS_WRITE ALLOWED_RANGES 0:2147483647
set_parameter_property IN_PKT_TRANS_WRITE DISPLAY_HINT ""
set_parameter_property IN_PKT_TRANS_WRITE HDL_PARAMETER true
set_parameter_property IN_PKT_TRANS_WRITE AFFECTS_GENERATION false
set_parameter_property IN_PKT_TRANS_WRITE DESCRIPTION {Input packet write transaction field index}
...
add_parameter ENABLE_ADDRESS_ALIGNMENT INTEGER 1
set_parameter_property ENABLE_ADDRESS_ALIGNMENT DISPLAY_NAME "Address alignment"
set_parameter_property ENABLE_ADDRESS_ALIGNMENT DESCRIPTION "Address alignment can be turned off (an optimisation) if all connected masters only issue aligned addresses."
set_parameter_property ENABLE_ADDRESS_ALIGNMENT ALLOWED_RANGES 0:1
set_parameter_property ENABLE_ADDRESS_ALIGNMENT UNITS None
set_parameter_property ENABLE_ADDRESS_ALIGNMENT AFFECTS_GENERATION false
set_parameter_property ENABLE_ADDRESS_ALIGNMENT HDL_PARAMETER true
# | 
# +-----------------------------------

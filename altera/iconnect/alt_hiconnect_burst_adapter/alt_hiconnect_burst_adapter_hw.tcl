...
# $Id: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_burst_adapter/alt_hiconnect_burst_adapter_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
# +-----------------------------------
# | 
set_module_property NAME alt_hiconnect_burst_adapter
...
set_fileset_property synthesis_fileset TOP_LEVEL alt_hiconnect_burst_adapter

add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL alt_hiconnect_burst_adapter

add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_burst_adapter

proc synth_callback_procedure { entity_name } {
    add_fileset_file alt_hiconnect_burst_adapter.sv        SYSTEM_VERILOG PATH "alt_hiconnect_burst_adapter.sv"
    add_fileset_file alt_hiconnect_burst_adapter_uncmpr.sv SYSTEM_VERILOG PATH "alt_hiconnect_burst_adapter_uncmpr.sv"
    add_fileset_file alt_hiconnect_burst_adapter_new.sv    SYSTEM_VERILOG PATH "new_source/alt_hiconnect_burst_adapter_new.sv"
    add_fileset_file alt_incr_burst_converter.sv           SYSTEM_VERILOG PATH "new_source/alt_incr_burst_converter.sv"
    add_fileset_file alt_wrap_burst_converter.sv           SYSTEM_VERILOG PATH "new_source/alt_wrap_burst_converter.sv"
    add_fileset_file alt_default_burst_converter.sv        SYSTEM_VERILOG PATH "new_source/alt_default_burst_converter.sv"
    add_fileset_file alt_hiconnect_address_alignment.sv    SYSTEM_VERILOG PATH "../alt_hiconnect_axi_mstr_agent/alt_hiconnect_address_alignment.sv"
    add_fileset_file alt_hiconnect_skid_buffer.sv          SYSTEM_VERILOG PATH "../alt_hiconnect_skid_buffer/alt_hiconnect_skid_buffer.sv"
    add_fileset_file alt_hiconnect_pipeline_base.v         SYSTEM_VERILOG PATH "../alt_hiconnect_skid_buffer/alt_hiconnect_pipeline_base.v"
    add_fileset_file alt_hiconnect_addr_mangler.sv         SYSTEM_VERILOG PATH "../alt_hiconnect_addr_mangler/alt_hiconnect_addr_mangler.sv"
}
# | 
# +-----------------------------------
...
set_parameter_property PIPE_INPUTS DISPLAY_HINT boolean
...
set_parameter_property NO_WRAP_SUPPORT DISPLAY_HINT boolean
set_parameter_property NO_WRAP_SUPPORT AFFECTS_GENERATION false
set_parameter_property NO_WRAP_SUPPORT HDL_PARAMETER false
set_parameter_property NO_WRAP_SUPPORT DESCRIPTION {No wrapping calculations will be done once this is set.}

add_parameter INCOMPLETE_WRAP_SUPPORT INTEGER 1
set_parameter_property INCOMPLETE_WRAP_SUPPORT DISPLAY_NAME {In-completed wrap calculation support}
set_parameter_property INCOMPLETE_WRAP_SUPPORT UNITS None
set_parameter_property INCOMPLETE_WRAP_SUPPORT DISPLAY_HINT boolean
set_parameter_property INCOMPLETE_WRAP_SUPPORT AFFECTS_GENERATION false
set_parameter_property INCOMPLETE_WRAP_SUPPORT HDL_PARAMETER true
set_parameter_property INCOMPLETE_WRAP_SUPPORT DESCRIPTION {No in-completed wrapping calculations will be done once this is set.}
...
add_parameter ADAPTER_VERSION STRING "13.1"
set_parameter_property ADAPTER_VERSION DEFAULT_VALUE "13.1"
set_parameter_property ADAPTER_VERSION DISPLAY_NAME "Select burst adapter version"
set_parameter_property ADAPTER_VERSION DESCRIPTION "Burst adapter version"
set_parameter_property ADAPTER_VERSION ALLOWED_RANGES "13.1,new"
set_parameter_property ADAPTER_VERSION AFFECTS_GENERATION false
set_parameter_property ADAPTER_VERSION HDL_PARAMETER true
...
add_parameter CONVERT_UNCOMP_TRANS INTEGER 1
set_parameter_property CONVERT_UNCOMP_TRANS DEFAULT_VALUE 1
set_parameter_property CONVERT_UNCOMP_TRANS DISPLAY_NAME "Burst adapter converts uncompressed transactions including uncompressed reads and write bursts"
set_parameter_property CONVERT_UNCOMP_TRANS AFFECTS_GENERATION false
set_parameter_property CONVERT_UNCOMP_TRANS HDL_PARAMETER true

add_parameter CONVERT_COMP_TRANS INTEGER 1
set_parameter_property CONVERT_COMP_TRANS DEFAULT_VALUE 1
set_parameter_property CONVERT_COMP_TRANS DISPLAY_NAME "Burst adapter converts compressed transactions aka read bursts"
set_parameter_property CONVERT_COMP_TRANS AFFECTS_GENERATION false
set_parameter_property CONVERT_COMP_TRANS HDL_PARAMETER true

add_parameter DISABLE_DEFAULT_CONVERTER INTEGER 0
set_parameter_property DISABLE_DEFAULT_CONVERTER DEFAULT_VALUE 0
set_parameter_property DISABLE_DEFAULT_CONVERTER DISPLAY_NAME "Prevent creation of the default converter (and associated control logic) if set."
set_parameter_property DISABLE_DEFAULT_CONVERTER AFFECTS_GENERATION false
set_parameter_property DISABLE_DEFAULT_CONVERTER HDL_PARAMETER true

add_parameter DISABLE_INCR_CONVERTER INTEGER 0
set_parameter_property DISABLE_INCR_CONVERTER DEFAULT_VALUE 0
set_parameter_property DISABLE_INCR_CONVERTER DISPLAY_NAME "Prevent creation of the incr converter (and associated control logic) if set."
set_parameter_property DISABLE_INCR_CONVERTER AFFECTS_GENERATION false
set_parameter_property DISABLE_INCR_CONVERTER HDL_PARAMETER true

add_parameter DISABLE_WRAP_CONVERTER INTEGER 0
set_parameter_property DISABLE_WRAP_CONVERTER DEFAULT_VALUE 0
set_parameter_property DISABLE_WRAP_CONVERTER DISPLAY_NAME "Prevent creation of the wrap converter (and associated control logic) if set."
set_parameter_property DISABLE_WRAP_CONVERTER AFFECTS_GENERATION false
set_parameter_property DISABLE_WRAP_CONVERTER HDL_PARAMETER true
# | 
# +-----------------------------------

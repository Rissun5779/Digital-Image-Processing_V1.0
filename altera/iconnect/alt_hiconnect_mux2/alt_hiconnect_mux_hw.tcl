...
# $Id: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_mux2/alt_hiconnect_mux_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_module_property NAME alt_hiconnect_mux2
set_module_property VERSION 18.1
set_module_property GROUP "Qsys Interconnect/Memory-Mapped Alpha"
set_module_property DISPLAY_NAME "Multiplexer"
...
proc synth_callback_procedure { output_name } {
    ...
    set template_file [ file join $this_dir "alt_hiconnect_mux.sv.terp" ]

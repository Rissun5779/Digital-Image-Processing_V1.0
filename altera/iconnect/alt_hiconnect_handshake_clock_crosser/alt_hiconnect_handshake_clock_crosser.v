...
// $File: //acds/prototype/mm_s10/ip/avalon_st/altera_avalon_st_handshake_clock_crosser/altera_avalon_st_handshake_clock_crosser.v $
// $Revision: #2 $
// $Date: 2015/06/10 $
// $Author: nkrueger $
//------------------------------------------------------------------------------
...
module alt_hiconnect_handshake_clock_crosser
#(
...
(
    input wire in_clk,
    input wire in_reset,   // This signal is synchronized internally in the altera_avalon_st_clock_crosser
    input wire out_clk,
    input wire out_reset,  // This signal is synchronized internally in the altera_avalon_st_clock_crosser
    ...
    output wire [(EMPTY_WIDTH ? (EMPTY_WIDTH - 1) : 0) : 0] out_empty
);

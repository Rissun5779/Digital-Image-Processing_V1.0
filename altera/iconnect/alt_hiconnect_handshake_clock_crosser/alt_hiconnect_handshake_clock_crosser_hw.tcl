...
# $File: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_handshake_clock_crosser/alt_hiconnect_handshake_clock_crosser_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_module_property NAME alt_hiconnect_handshake_clock_crosser
...
set_fileset_property synthesis_fileset TOP_LEVEL alt_hiconnect_handshake_clock_crosser
add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL alt_hiconnect_handshake_clock_crosser
add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL alt_hiconnect_handshake_clock_crosser

proc synth_callback_procedure { entity_name } {
    add_fileset_file alt_hiconnect_handshake_clock_crosser.v SYSTEM_VERILOG PATH "alt_hiconnect_handshake_clock_crosser.v"
    add_fileset_file alt_hiconnect_clock_crosser.v SYSTEM_VERILOG PATH "alt_hiconnect_clock_crosser.v"
...
set_interface_property in_clk_reset synchronousEdges BOTH
...
proc elaborate {} {
  ...
  if { $use_channel } {
      ...
      set_port_property in_channel WIDTH_EXPR 1
      set_port_property out_channel WIDTH_EXPR 1
  }

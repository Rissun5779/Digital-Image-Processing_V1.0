...
(
    ...
    always @(posedge clk) begin
        ...
        else if (increment_top_priority) begin
            top_priority_reg <= {grant[NUM_REQUESTERS-2:0], grant[NUM_REQUESTERS-1]};
        end
    end
...
// ----------------------------------------------
module alt_hiconnect_rr_arb_adder
#(
    parameter WIDTH = 8
)
(

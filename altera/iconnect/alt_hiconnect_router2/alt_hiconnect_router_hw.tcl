...
# $Id: //acds/rel/18.1std/ip/iconnect/alt_hiconnect_router2/alt_hiconnect_router_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_module_property NAME alt_hiconnect_router2
...
set_parameter_property DESTINATION_ID AFFECTS_GENERATION true
...
set_parameter_property TYPE_OF_TRANSACTION AFFECTS_GENERATION true
...
set_parameter_property END_ADDRESS AFFECTS_GENERATION true
...
set_parameter_property NON_SECURED_TAG AFFECTS_GENERATION true
...
set_parameter_property SECURED_RANGE_PAIRS AFFECTS_GENERATION true
...
set_parameter_property SECURED_RANGE_LIST AFFECTS_GENERATION true
...
set_parameter_property SPAN_OFFSET AFFECTS_GENERATION true
...
set_parameter_property PKT_ADDR_H AFFECTS_GENERATION true
...
set_parameter_property PKT_ADDR_L AFFECTS_GENERATION true
...
set_parameter_property PKT_PROTECTION_H AFFECTS_GENERATION true
...
set_parameter_property PKT_PROTECTION_L AFFECTS_GENERATION true
...
set_parameter_property PKT_DEST_ID_H AFFECTS_GENERATION true
...
set_parameter_property PKT_DEST_ID_L AFFECTS_GENERATION true
...
set_parameter_property PKT_TRANS_WRITE AFFECTS_GENERATION true
...
set_parameter_property PKT_TRANS_READ AFFECTS_GENERATION true
...
set_parameter_property PKT_TRANS_POSTED AFFECTS_GENERATION true
set_parameter_property PKT_TRANS_POSTED HDL_PARAMETER false
...
set_parameter_property SLAVES_INFO AFFECTS_GENERATION true
set_parameter_property SLAVES_INFO VISIBLE false
set_parameter_property SLAVES_INFO DERIVED true

# Decode Type 0: Command Network, Decode Type 1: Response Network
...
set_parameter_property DECODER_TYPE AFFECTS_GENERATION true
...
set_parameter_property DEFAULT_CHANNEL AFFECTS_GENERATION true
...
set_parameter_property DEFAULT_WR_CHANNEL AFFECTS_GENERATION true
...
set_parameter_property DEFAULT_RD_CHANNEL AFFECTS_GENERATION true
...
set_parameter_property DEFAULT_DESTID AFFECTS_GENERATION true
...
set_parameter_property MEMORY_ALIASING_DECODE AFFECTS_GENERATION true
set_parameter_property MEMORY_ALIASING_DECODE HDL_PARAMETER false

add_parameter PREVENT_HAZARDS INTEGER 0
set_parameter_property PREVENT_HAZARDS AFFECTS_ELABORATION true
set_parameter_property PREVENT_HAZARDS HDL_PARAMETER false
set_parameter_property PREVENT_HAZARDS DISPLAY_HINT BOOLEAN
set_parameter_property PREVENT_HAZARDS DESCRIPTION {Prevent hazards resulting from mixed AV, AXI systems}
...
proc synth_callback_procedure { entity_name } {
    ...
    set template_file [ file join $this_dir "alt_hiconnect_router.sv.terp" ]
    ...
    set params(pkt_trans_posted) [ get_parameter_value PKT_TRANS_POSTED ]
    ...
    set params(prevent_hazards) [ get_parameter_value PREVENT_HAZARDS ]
...
proc elaborate {} {
    ...
    set decoder_type  [ get_parameter_value DECODER_TYPE ]
    
    if { $decoder_type == 0 } {
        set_interface_property src dataBitsPerSymbol 2
        set_port_property src_data WIDTH_EXPR 2
    } else {

...
(
    ...
    // Grants
    // --------------------------------------
    output wire [NUM_REQUESTERS-1:0] grant,

    // --------------------------------------
    // Control Signals
    // --------------------------------------
    input wire                  increment_top_priority,
    input wire                  save_top_priority
);
...
// ----------------------------------------------
module alt_hiconnect_arb_adder
#(
    parameter WIDTH = 8
)
(

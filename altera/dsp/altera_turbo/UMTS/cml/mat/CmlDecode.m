...
if (code_param.coded)
    ...
    for bicm_iter=1:bicm_iterations   
        ...
        elseif (( sim_param.code_configuration == 1) | ( sim_param.code_configuration == 4)) % PCCC or UMTS
            if (sim_param.rtl_simulation == 1)
              	[detected_data, turbo_errors, output_decoder_c, output_decoder_u ] = SWTurboDecode_fxp_rtl( input_decoder_c, data, turbo_iterations, sim_param.decoder_type, code_param.code_interleaver, code_param.pun_pattern, code_param.tail_pattern, sim_param.g1, sim_param.nsc_flag1, sim_param.g2, sim_param.nsc_flag2, sim_param.num_engines, sim_param.sldwin_size, sim_param.fxp_data_width, input_decoder_u, sim_param);
            elseif (length(sim_param.fxp_data_width) > 0) % fixed point model
            	[detected_data, turbo_errors, output_decoder_c, output_decoder_u ] = SWTurboDecode_fxp( input_decoder_c, data, turbo_iterations, sim_param.decoder_type, code_param.code_interleaver, code_param.pun_pattern, code_param.tail_pattern, sim_param.g1, sim_param.nsc_flag1, sim_param.g2, sim_param.nsc_flag2, sim_param.num_engines, sim_param.sldwin_size, sim_param.fxp_data_width, input_decoder_u, sim_param);
            elseif (isfield(sim_param,'num_engines') && sim_param.num_engines >= 1)
           		[detected_data, turbo_errors, output_decoder_c, output_decoder_u ] = SWTurboDecode( input_decoder_c, data, turbo_iterations, sim_param.decoder_type, code_param.code_interleaver, code_param.pun_pattern, code_param.tail_pattern, sim_param.g1, sim_param.nsc_flag1, sim_param.g2, sim_param.nsc_flag2, sim_param.num_engines, sim_param.sldwin_size, input_decoder_u, sim_param);
            else
            ...
            if (turbo_errors(turbo_iterations)==0 | (sim_param.rtl_simulation == 1))
                return;
            else

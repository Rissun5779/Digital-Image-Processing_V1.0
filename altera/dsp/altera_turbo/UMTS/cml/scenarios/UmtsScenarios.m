...
record = 100;
sim_param(record).comment = 'Ideal Floating Point Performance';
sim_param(record).SNR = 0:0.1:1.0;
sim_param(record).framesize = 5114;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 3;
...
record = 200;
sim_param(record).comment = '8 iterations, 5114 bits, max-log-MAP';
sim_param(record).SNR = 0:0.1:1.0;
sim_param(record).framesize = 5114;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 1;
...
record = 201;
sim_param(record).comment = '5 iterations, 5114 bits, max-log-MAP';
sim_param(record).SNR = 0:0.1:1.0;
sim_param(record).framesize = 5114;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 1;
...
record = 202;
sim_param(record).comment = '6 iterations, 5114 bits, max-log-MAP';
sim_param(record).SNR = 0:0.1:1.0;
sim_param(record).framesize = 5114;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 1;
sim_param(record).max_iterations = 6;
sim_param(record).plot_iterations = sim_param(record).max_iterations;
sim_param(record).linetype = 'r:';
sim_param(record).sim_type = 'coded';
sim_param(record).code_configuration = 1;
...
record = 210;
sim_param(record).comment = '8 iterations, 5114 bits, log-MAP';
sim_param(record).SNR = 0:0.1:1.0;
sim_param(record).framesize = 5114;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 3;
sim_param(record).max_iterations = 14;
sim_param(record).plot_iterations = 8;
sim_param(record).linetype = 'k-';
sim_param(record).sim_type = 'coded';
sim_param(record).code_configuration = 1;
sim_param(record).SNR_type = 'Eb/No in dB';
...
record = 211;
sim_param(record).comment = '5 iterations, 5114 bits, log-MAP';
sim_param(record).SNR = 0:0.1:1.0;
sim_param(record).framesize = 5114;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 3;
sim_param(record).max_iterations = 14;
sim_param(record).plot_iterations = 5;
sim_param(record).linetype = 'k--';
sim_param(record).sim_type = 'coded';
sim_param(record).code_configuration = 1;
sim_param(record).SNR_type = 'Eb/No in dB';
...
record = 212;
sim_param(record).comment = '6 iterations, 5114 bits, log-MAP';
sim_param(record).SNR = 0:0.1:1.0;
sim_param(record).framesize = 5114;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 3;
sim_param(record).max_iterations = 14;
sim_param(record).plot_iterations = 6;
sim_param(record).linetype = 'k:';
sim_param(record).sim_type = 'coded';
sim_param(record).code_configuration = 1;
sim_param(record).SNR_type = 'Eb/No in dB';
...
record = 307;
sim_param(record).comment = 'UMTS-TC, BPSK, AWGN, 530 bits, s-max-log-MAP';
sim_param(record).SNR = 0:0.2:2.2;
sim_param(record).framesize = 530;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 1;
...
sim_param(record).tail_pattern2 = sim_param(record).tail_pattern1;
sim_param(record).filename = strcat( data_directory, ...
    strcat( 'umts', int2str(record),int2str(sim_param(record).framesize ), sim_param(record).channel, int2str( sim_param(record).decoder_type ), '.mat') );
sim_param(record).reset = 0;
sim_param(record).max_trials = 1000001*ones( size(sim_param(record).SNR) );
sim_param(record).minBER = 1e-6; 
sim_param(record).max_frame_errors = 40*ones( 1, length(sim_param(record).SNR) );

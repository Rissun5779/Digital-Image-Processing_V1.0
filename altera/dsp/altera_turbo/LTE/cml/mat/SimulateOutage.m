...
%
%     Copyright (C) 2005-2006, Tarik Ghanim and Matthew C. Valenti
%
%     Last updated on June 6, 2006
%
%     Function OutageSimulate is part of the Iterative Solutions Coded Modulation
%     Library (ISCML).
%
...
if(sim_param.mod_order > 0)
    input_file = load(sim_param.input_filename); 
...
for snrpoint = 1:size(EsNo,2)
    ...
    while (( sim_state.trials( snrpoint ) < sim_param.max_trials( snrpoint ) )...
        ...
        % Generate i.i.d. exponential SNRs 

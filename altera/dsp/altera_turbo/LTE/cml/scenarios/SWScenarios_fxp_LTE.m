...
% AWGN
record = 1;
sim_param(record).comment = '160 bits, SW-logMAP, 8/32';
...
sim_param(record).filename = strcat( data_directory, ...
    strcat( 'fxp',int2str(record),  int2str(sim_param(record).framesize ), sim_param(record).channel, int2str( sim_param(record).num_engines ), int2str( sim_param(record).sldwin_size ),'_',sprintf('%d',sim_param(record).fxp_data_width(1:end)),int2str(sim_param(record).decoder_type),'.mat') );
...
record = 2;
sim_param(record).comment = '640 bits, SW-logMAP, 8/32';
sim_param(record).SNR = 0.0:0.25:2.0;
...
record = 3;
sim_param(record).comment = '384 bits, SW-logMAP, 8/16';
sim_param(record).SNR = 0.0:0.25:2.0;
...
record = 4;
sim_param(record).comment = '160 bits, SW-logMAP, 8/32, 4it';
sim_param(record).SNR =0.0:0.25:2.0;
sim_param(record).framesize = 160;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
sim_param(record).sldwin_size = 32;
sim_param(record).fxp_data_width = [6 2 10 2];
sim_param(record).max_iterations = 4;
sim_param(record).plot_iterations = sim_param(record).max_iterations;
sim_param(record).linetype = 'b:';
sim_param(record).sim_type = 'coded';
sim_param(record).code_configuration = 1;
...
record = 5;
sim_param(record).comment = '640 bits, SW-logMAP, 8/32, 4it';
sim_param(record).SNR = 0.0:0.25:2.0;
sim_param(record).framesize = 640;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 6;
sim_param(record).comment = '384 bits, SW-logMAP, 8/16, 4it';
sim_param(record).SNR = 0.0:0.25:2.0;
sim_param(record).framesize = 384;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 111;
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-SW-logMAP, 8/32, 5-8');
sim_param(record).SNR = 0:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 3;
...
record = 112;
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-SW-const-logMAP, 8/32,5-8');
sim_param(record).SNR = 0.0:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2; % constant logMAP
sim_param(record).num_engines = 8;
sim_param(record).sldwin_size = 32;
sim_param(record).fxp_data_width = [6 2 10 2];
sim_param(record).max_iterations = 8;
...
record = 114;
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-pSW-logMAP, 8/32, 6/9');
%sim_param(record).comment =  'LTE, 6144 bits, fxp-SW-logMAP, 8/32, 6-9');
sim_param(record).SNR = 0.0:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
...
record = 115;
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-pSW-scaling-max-logMAP, 8/32, 6/9');
%sim_param(record).comment =  'LTE, 6144 bits, fxp-SW-S-max-logMAP, 8/32, 6-9');
sim_param(record).SNR = 0.0:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
...
record = 116;
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-SW-const-logMAP, 8/32, 6-9');
%sim_param(record).comment =  'LTE, 6144 bits, fxp-pSW-constant-logMAP, 8/32, 6/9';
sim_param(record).SNR = 0.0:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2; % constant-logMAP
...
record = 117;
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-SW-max-logMAP, 8/32, 5-8');
sim_param(record).SNR = 0.0:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
...
record = 118;
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-pSW-max-logMAP, 8/32, 6-9');
%sim_param(record).comment =  'LTE, 6144 bits, fxp-SW-max-logMAP, 8/32, 6/9';
sim_param(record).SNR = 0.0:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 1; % max-logMAP
...
record = 203;
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-SW-const-logMAP, 8/16, 6-9');
%sim_param(record).comment =  'LTE, 6144 bits, fxp-pSW-constant-logMAP, 8/32, 6/9';
sim_param(record).SNR = 0.0:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
...
sim_param(record).comment =  strcat(int2str(record), ': 6144 bits, fxp-SW-const-logMAP, 8/16, 6-9');
%sim_param(record).comment =  'LTE, 6144 bits, fxp-pSW-constant-logMAP, 8/32, 6/9';
sim_param(record).SNR = 0.7:0.1:1.0;
sim_param(record).framesize = 6144;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2; % constant-logMAP
sim_param(record).num_engines = 8;
...
record = 301;
sim_param(record).comment = '160 bits, SW-logMAP, 8/32, QPSK';
...
record = 302;
sim_param(record).comment = '640 bits, SW-logMAP, 8/32, QPSK';
sim_param(record).SNR = 0.0:0.25:2.0;
sim_param(record).framesize = 640;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
sim_param(record).SNR = 0.0:0.5:10;
sim_param(record).framesize = 160;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
sim_param(record).num_engines = 8;
...
record = 304;
sim_param(record).comment = '640 bits, SW-logMAP, 8/32, 16QAM';
sim_param(record).SNR = 0.0:0.5:10;
sim_param(record).framesize = 640;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 305;
sim_param(record).comment = '160 bits, SW-logMAP, 8/32, 64QAM';
sim_param(record).SNR = 0.0:0.5:10;
sim_param(record).framesize = 160;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 306;
sim_param(record).comment = '640 bits, SW-logMAP, 8/32, 64QAM';
sim_param(record).SNR = 0.0:0.5:10;
sim_param(record).framesize = 640;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 307;
sim_param(record).comment = '160 bits, SW-logMAP, 8/32, QPSK, 4it';
sim_param(record).SNR = 0.0:0.25:2.0;
sim_param(record).framesize = 160;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 308;
sim_param(record).comment = '640 bits, SW-logMAP, 8/32, QPSK, 4it';
sim_param(record).SNR = 0.0:0.25:2.0;
sim_param(record).framesize = 640;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 309;
sim_param(record).comment = '160 bits, SW-logMAP, 8/32, 16QAM, 4it';
sim_param(record).SNR = 0.0:0.5:10;
sim_param(record).framesize = 160;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 310;
sim_param(record).comment = '640 bits, SW-logMAP, 8/32, 16QAM, 4it';
sim_param(record).SNR = 0.0:0.5:10;
sim_param(record).framesize = 640;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 311;
sim_param(record).comment = '160 bits, SW-logMAP, 8/32, 64QAM, 4it';
sim_param(record).SNR = 0.0:0.5:10;
sim_param(record).framesize = 160;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;
...
record = 312;
sim_param(record).comment = '640 bits, SW-logMAP, 8/32, 64QAM, 4it';
sim_param(record).SNR = 0.0:0.5:10;
sim_param(record).framesize = 640;
sim_param(record).channel = 'awgn';
sim_param(record).decoder_type = 2;

...
source "altera_ldpc_nasa_enc_utilities.tcl"
# |
# +-----------------------------------
...
set_module_property NAME altera_ldpc_nasa_enc
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property GROUP "DSP/LDPC"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "LDPC NASA Encoder"
...
# | files
# | 
add_filesets altera_ldpc_nasa_enc
...
proc generate {type entity} {
    ...
    add_encrypted_file $type altera_ldpc_nasa_enc_mat.sv
    add_encrypted_file $type altera_ldpc_nasa_enc.sv
    add_encrypted_file $type altera_ldpc_nasa_enc.ocp
}
# | 
# +-----------------------------------
...
dsp_set_interface_property in dataBitsPerSymbol $in_data_width
...
add_interface_port in in_ready ready Output 1
    ...
    dsp_add_interface_port in in_data data Input $in_data_width $fraglist_in

...
# | 
set_module_property DESCRIPTION "Altera LDPC DVB MSA"
set_module_property NAME altera_ldpc_dvb_msa
set_module_property VERSION 14.0
set_module_property INTERNAL true
set_module_property GROUP "DSP/LDPC/Submodules"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "LDPC  Min-Sum Algorithm"
...
add_filesets altera_ldpc_dvb_msa
...
proc generate {type} {
    ...
    add_encrypted_file $type altera_ldpc_dvb_dec_mat.sv    
    add_encrypted_file $type altera_ldpc_dvb_msa.sv
    add_encrypted_file $type altera_ldpc_dvb_msa.ocp
}
...
proc elaborate {} {
    ...
    if {$channel_width > 0} {
        add_interface_port cw_in cw_in_channel channel Input $channel_width
        add_interface_port cw_out cw_out_channel channel Output $channel_width

...
# | 
set_module_property DESCRIPTION "Altera LDPC NASA MSA"
set_module_property NAME altera_ldpc_nasa_msa
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property GROUP "DSP/LDPC/Submodules"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "LDPC NASA Decoder"
...
add_filesets altera_ldpc_nasa_msa
...
proc generate {type entity} {
    ...
    #add_ldpc_package $type "../../.."
    add_encrypted_file $type "altera_ldpc_pkg.sv" "../../../lib" 
    add_encrypted_file $type altera_ldpc_nasa_mat.sv 
    if {$nasafull==0} {
        if {$islayered==0} {
            add_encrypted_file $type altera_ldpc_nasa_msa_notstreaming.sv
        } else {
            add_encrypted_file $type altera_ldpc_nasa_layer_notstreaming.sv
        }
    } else {
        if {$islayered==0} {
            add_encrypted_file $type altera_ldpc_nasa_msa_streaming.sv
        } else {
            add_encrypted_file $type altera_ldpc_nasa_layer_streaming.sv
        }
    }
    add_encrypted_file $type altera_ldpc_nasa_msa.ocp
}
...
proc elaborate {} {
    ...
    dsp_set_interface_property cw_in dataBitsPerSymbol $in_data_width
    #dsp_set_interface_property cw_in maxChannel $max_channel_nb
    ...
    add_interface_port cw_in cw_in_data data Input $in_data_width

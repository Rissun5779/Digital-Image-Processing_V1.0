...
set MODE_WIDTH [lindex $argv 14]
set ComplexConstant [lindex $argv 15]
...
proc print_vhd_port {out InWidth PhysChanIn OutWidth PhysChanOut Log2_ChansPerPhyOut ChansPerPhyIn ChansPerPhyOut}  {
    ...
    puts $out "    ast_sink_data : in STD_LOGIC_VECTOR( ($bankInWidth + $InWidth) * $PhysChanIn + $MODE_WIDTH - 1 downto 0);"
...
# Verilog
    ...
    puts $out "  input \[($bankInWidth + $InWidth) * $PhysChanIn + $MODE_WIDTH - 1 : 0\] ast_sink_data,"

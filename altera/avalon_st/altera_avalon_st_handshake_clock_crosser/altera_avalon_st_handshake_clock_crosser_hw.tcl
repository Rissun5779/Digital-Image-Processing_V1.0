...
# $File: //acds/rel/18.1std/ip/avalon_st/altera_avalon_st_handshake_clock_crosser/altera_avalon_st_handshake_clock_crosser_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
# | module 
# | 
set_module_property DESCRIPTION "Connects streams that operate at different frequencies using a hand-shaking protocol to propagate transfer control signals and responses across the clock boundary and responses in the other direction."
...
#
# Note: ip/sld/usb/altera_usb_debug_fifos depends on this IP's files, but not through HW.TCL. If changing file list, update that IP.
#
proc synth_callback_procedure { entity_name } {
    ...
    add_fileset_file altera_std_synchronizer_nocut.v SYSTEM_VERILOG PATH "../../primitives/altera_std_synchronizer/altera_std_synchronizer_nocut.v"
    add_fileset_file altera_avalon_st_handshake_clock_crosser.sdc SDC PATH "altera_avalon_st_handshake_clock_crosser.sdc"
}

...
# $File: //acds/rel/18.1std/ip/avalon_st/altera_avalon_st_delay/altera_avalon_st_delay_hw.tcl $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
#------------------------------------------------------------------------------
...
set_fileset_property synth   TOP_LEVEL altera_avalon_st_delay
add_fileset_file altera_avalon_st_delay.sv SYSTEM_VERILOG PATH altera_avalon_st_delay.sv

add_fileset          sim     SIM_VERILOG
set_fileset_property sim     TOP_LEVEL altera_avalon_st_delay
add_fileset_file altera_avalon_st_delay.sv SYSTEM_VERILOG PATH altera_avalon_st_delay.sv

add_fileset          simvhdl SIM_VHDL
set_fileset_property simvhdl TOP_LEVEL altera_avalon_st_delay
add_fileset_file altera_avalon_st_delay.sv SYSTEM_VERILOG PATH altera_avalon_st_delay.sv
# | 
# +-----------------------------------
...
proc elaborate {} {
   ...
   set_port_property in0_data VHDL_TYPE STD_LOGIC_VECTOR
   ...
   set_port_property out0_data VHDL_TYPE STD_LOGIC_VECTOR
   ...
   if { $use_packets_value == 0 } {
      ...
      set_port_property in0_empty VHDL_TYPE STD_LOGIC_VECTOR
      ...
      set_port_property out0_empty VHDL_TYPE STD_LOGIC_VECTOR
   ...
   if { $use_channel_value == 0 } {
      ...
      set_port_property in0_channel VHDL_TYPE STD_LOGIC_VECTOR

      add_interface_port out out0_channel channel Output 1
      set_interface_property out maxChannel 0
      set_port_property out0_channel TERMINATION 1
      set_port_property out0_channel VHDL_TYPE STD_LOGIC_VECTOR
   ...
   if { $use_error_value == 0 } {
      ...
      set_port_property in0_error VHDL_TYPE STD_LOGIC_VECTOR

      add_interface_port out out0_error error Output 1
      set_port_property out0_error TERMINATION 1
      set_port_property out0_error VHDL_TYPE STD_LOGIC_VECTOR
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/sfo1400787952932/iga1401398857652

...
# $Id: //acds/rel/18.1std/ip/avalon_st/altera_avalon_st_adapter/altera_avalon_st_adapter_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
# -------------------------------------------------------------------------------
...
set_parameter_property inMaxChannel DISPLAY_NAME "Source Max Channel"
...
set_parameter_property outMaxChannel DISPLAY_NAME "Sink Max Channel"
...
proc read_parameters_value {} {
   ...
   set invalidInDataWidth [expr $inDataWidth_value % $inBitsPerSymbol_value]
   set invalidOutDataWidth [expr $outDataWidth_value % $inBitsPerSymbol_value]
   if {$invalidInDataWidth > 0 || $invalidOutDataWidth > 0} {
      send_message Error "Data width must be multiple of symbol width"
   }
}
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/mwh1409960181641/mwh1409958906734

...
set_fileset_property synth   TOP_LEVEL altera_avalon_st_splitter
add_fileset_file altera_avalon_st_splitter.sv SYSTEM_VERILOG PATH altera_avalon_st_splitter.sv

add_fileset          sim     SIM_VERILOG
set_fileset_property sim     TOP_LEVEL altera_avalon_st_splitter
add_fileset_file altera_avalon_st_splitter.sv SYSTEM_VERILOG PATH altera_avalon_st_splitter.sv

add_fileset          simvhdl SIM_VHDL
set_fileset_property simvhdl TOP_LEVEL altera_avalon_st_splitter
add_fileset_file altera_avalon_st_splitter.sv SYSTEM_VERILOG PATH altera_avalon_st_splitter.sv
# | 
# +-----------------------------------
...
proc setAsVector { pName } {
    set_port_property $pName VHDL_TYPE std_logic_vector
}


## Add documentation links for user guide and/or release notes
add_documentation_link "User Guide" https://documentation.altera.com/#/link/sfo1400787952932/iga1401399241593 

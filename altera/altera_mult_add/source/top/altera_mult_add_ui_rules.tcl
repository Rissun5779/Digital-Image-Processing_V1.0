...
# +-----------------------------------
# | 
# | $Header: //acds/rel/18.1std/ip/altera_mult_add/source/top/altera_mult_add_ui_rules.tcl#1 $
# | 
# +-----------------------------------
...
proc validation_param_visibility {} {
	...
	if {$get_representation_a eq "VARIABLE"} {
		...
		set_parameter_property gui_register_signa_sclr VISIBLE false
	}
	if {$get_representation_a eq "VARIABLE" && $is_use_register_signa == "true"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_register_signa_sclr VISIBLE true
	...
	if {$get_representation_b eq "VARIABLE"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_register_signb_sclr VISIBLE false
	}
	if {$get_representation_b eq "VARIABLE" && $is_use_register_signb == "true"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_register_signb_sclr VISIBLE true
	} else {
		set_parameter_property gui_register_signb_clock VISIBLE false
		set_parameter_property gui_register_signb_aclr VISIBLE false
		#Added for SCLR SUPPORT
	...
	if {$is_use_output_register == "true"} {
		...
		set_parameter_property gui_output_register_sclr VISIBLE true
	} else {
		...
		set_parameter_property gui_output_register_sclr VISIBLE false
	}
	...
	if {$get_number_of_multiplier > 1 && $get_multiplier1_direction eq "VARIABLE"} {
		...
		#SCLR SUPPORT
		set_parameter_property gui_addnsub_multiplier_sclr1 VISIBLE false
	}
	if {$get_number_of_multiplier > 1 && $get_multiplier1_direction eq "VARIABLE" && $is_use_addnsub_multiplier_register1 == "true"} {
		...
		#SCLR SUPPORT
		set_parameter_property gui_addnsub_multiplier_sclr1 VISIBLE true
	} else {
		set_parameter_property gui_addnsub_multiplier_register1_clock VISIBLE false
		set_parameter_property gui_addnsub_multiplier_aclr1 VISIBLE false
		#SCLR SUPPORT
	...
	if {$get_number_of_multiplier == 4 && $get_multiplier3_direction eq "VARIABLE"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_addnsub_multiplier_sclr3 VISIBLE false
	}
	if {$get_number_of_multiplier == 4 && $get_multiplier3_direction eq "VARIABLE" && $is_use_addnsub_multiplier_register3 == "true"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_addnsub_multiplier_sclr3 VISIBLE true
	} else {
		set_parameter_property gui_addnsub_multiplier_register3_clock VISIBLE false
		set_parameter_property gui_addnsub_multiplier_aclr3 VISIBLE false
		#Added for SCLR SUPPORT
	...
	if {$is_use_input_register_a == "true"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_input_register_a_sclr VISIBLE true
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_input_register_a_sclr VISIBLE false
	}
	if {$is_use_input_register_b == "true"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_input_register_b_sclr VISIBLE true
	} else {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_input_register_b_sclr VISIBLE false
	}
	if {$get_number_of_multiplier > 1} {
	...
	if {$get_number_of_multiplier > 1 && $get_multiplier_a_input eq "Scan chain input"} {
		...
		#Added SCLR SUPPORT
		set_parameter_property gui_scanouta_register_sclr VISIBLE false
	}
	if {$get_number_of_multiplier > 1 && $get_multiplier_a_input eq "Scan chain input" && $is_use_scanouta_register == "true"} {
		...
		#Added SCLR SUPPORT
		set_parameter_property gui_scanouta_register_sclr VISIBLE true
	} else {
		set_parameter_property gui_scanouta_register_clock VISIBLE false
		set_parameter_property gui_scanouta_register_aclr VISIBLE false
		#Added SCLR SUPPORT
	...
	if {$is_use_multiplier_register == "true"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_multiplier_register_sclr VISIBLE true
	} else {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_multiplier_register_sclr VISIBLE false
	}
	#Preadder
	...
	if {($get_preadder_mode eq "COEF" || $get_preadder_mode eq "CONSTANT") && $get_coef_register == true} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_coef_register_sclr VISIBLE true
	} else {
		set_parameter_property gui_coef_register_clock VISIBLE false
		set_parameter_property gui_coef_register_aclr VISIBLE false
		#Added for SLCR SUPPORT
		set_parameter_property gui_coef_register_sclr VISIBLE false
	}
	...
	if {$get_preadder_mode eq "INPUT" && $get_datac_input_register == "true"} {
		...
		#Added for sclr support
		set_parameter_property gui_datac_input_register_sclr VISIBLE true
	} else {
		...
		#Added for sclr support
		set_parameter_property gui_datac_input_register_sclr VISIBLE false
	}
	#Accumulator/Preload
	...
	if {$get_accumulator eq "YES" && $get_ena_preload_const == "true"} {
		...
		#Added for sclr support
		set_parameter_property gui_accum_sload_register_sclr VISIBLE true
	} else {
		...
		#Added for sclr support
		set_parameter_property gui_accum_sload_register_sclr VISIBLE false
	}
	if {$get_accumulator eq "YES"} {
	...
	#chainout_adder_s10 only-to be removed
	#if {$get_device == "Stratix 10"} {
		#set_parameter_property negate_sclr VISIBLE true
	#} else {
		#set_parameter_property negate_sclr VISIBLE false
	#}
	...
	if {($get_number_of_multiplier == 4 || $get_number_of_multiplier == 2) && $is_use_systolic_register == "true"} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_systolic_delay_sclr VISIBLE true
	} else {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_systolic_delay_sclr VISIBLE false
	}
	...
	if {$get_pipelining == 0} {
		...
		#Added for SCLR SUPPORT
		set_parameter_property gui_input_latency_sclr VISIBLE false
		...
		#Added for-SCLR SUPPORT
		set_parameter_property gui_input_latency_sclr VISIBLE true
	}	
}

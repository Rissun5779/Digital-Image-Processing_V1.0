...
set_global_assignment -name TOP_LEVEL_ENTITY mst_sv_dp_demo

# add files to the project
set_global_assignment -name VERILOG_FILE mst_sv_dp_demo.v
set_global_assignment -name VERILOG_FILE rx_clk_buf.v
set_global_assignment -name VERILOG_FILE bitec_reconfig_alt_sv.v
# set_global_assignment -name QIP_FILE rx_clk_buf.qip
set_global_assignment -name QIP_FILE sv_xcvr_pll.qip
set_global_assignment -name QIP_FILE video_pll_sv.qip
set_global_assignment -name QIP_FILE ./clkrec/clkrec_pll_sv.qip
...
# set_global_assignment -name QIP_FILE bitec_reconfig_alt_sv.qip
...
# ==========================
set_location_assignment PIN_AE12 -to AUX_RX_DRV_IN
set_location_assignment PIN_M9 -to AUX_TX_DRV_IN
set_location_assignment PIN_AE9 -to RX_SENSE_N
set_location_assignment PIN_AD9 -to RX_SENSE_P
set_location_assignment PIN_AH22 -to clk100
set_location_assignment PIN_AN6 -to clk50
...
set_instance_assignment -name PLL_BANDWIDTH_PRESET AUTO -to *cmu_pll.tx_pll

...
// URL            : $URL: svn://nas-bitec-fi/dp/trunk/demo/bitec_reconfig_alt_sv.v $
// *********************************************************************
// Description
// 
// This module implements Altera RX/TX transceivers reconfiguration
// for Altera Stratix V GX:
...
localparam  FEAT_RX_REFCLK1 = 4'd0,
            FEAT_TX_VOD = 4'd1,
            FEAT_TX_EMP = 4'd2,
            FEAT_TX_REFCLK1 = 4'd3,
            FEAT_TX_REFCLK2 = 4'd4,
            FEAT_TX_REFCLK3 = 4'd5;
      ...
      begin
        ...
        case(feature_idx)
          ...
          begin
            ...
            if(tx_hdmi_busy)
              rcnf_data <= 16'h80D4; // <<<--- THIS VALUE STILL TBD!
          ...
          begin
            ...
            begin
              ...
              rcnf_feature_offset <= 16'h000C;
              if(tx_hdmi_busy)
              rcnf_data <= 16'h7401; // <<<--- THIS VALUE STILL TBD!
              else if(tx_link_rate_mem == 2'b00)
                rcnf_data <= 16'h9801;
              else if(tx_link_rate_mem == 2'b01)
                rcnf_data <= 16'h5801;
          ...
          begin
            ...
            begin
              ...
              if(tx_hdmi_busy)
                rcnf_data <= (HDMI_CLKX2 == 0) ? 16'h0D60 : 16'h0D60; // TBD!!!
              else if(tx_link_rate_mem == 2'b00)
                rcnf_data <= 16'h0D68;
              else if(tx_link_rate_mem == 2'b01)
                rcnf_data <= 16'h0D60;

...
BYTE rx_edid[256] =
{
  ...
  0x05,0x94,0x4e,0x40,0x4d,0x56,0x55,0x41,
  ...
  0x30,0x30,0x00,0x00,0x00,0xfc,0x00,0x41,
  0x4c,0x54,0x45,0x52,0x41,0x20,0x43,0x56,
  0x0a,0x20,0x20,0x20,0x00,0x00,0x00,0xfd,
  0x00,0x38,0x4b,0x1e,0x53,0x08,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x8e,
  0x02,0x03,0x12,0x71,0x29,0x0f,0x7f,0x07,
  0x15,0x06,0x55,0x3d,0x1f,0xc0,0x83,0x4f,
...
int main()
{
  ...
  bitec_dptx_init();
  {
    ...
    {
      btc_dprx_edid_set(0,0,rx_edid,sizeof(rx_edid)/128);
    }
#else
      btc_dprx_edid_set(0,0,rx_edid,sizeof(rx_edid)/128);
#endif

                            ...
                            case(index) 
                                ...
                                begin
                                    ...
                                    case (tx_link_rate)
                                        ...
                                        HBR :   value = 16'h5801;
                                        HBR2 :  value = 16'h7401;
                                        default : value = 16'h9801;
                                    endcase
                                end
                                4'd1 :  // PMA TX (PLL section) word 3
                                begin
                                    offset  = 6'h0e;
                                    case (tx_link_rate)
                                        RBR :   value = 16'hd68;
                            ...
                            case(index) 
                                ...
                                begin
                                    ...
                                    case (rx_link_rate)
                                        ...
                                        HBR :   value = 16'h1540;
                                        HBR2 :  value = 16'h1500;
                                        default : value = 16'h2580;
                                    endcase
                                end
                                4'd1 :  // PMA RX (PLL section) word 4
                                begin
                                    offset  = 6'h10;
                                    case (rx_link_rate)
                                        RBR :   value = 16'h8410;
                                        HBR :   value = 16'h8450;
                                        HBR2 :  value = 16'h8450;
                                        default : value = 16'h8410;
                                    endcase
                                end
                                4'd2 :  // PMA RX (PLL section) word 5
                                begin
                                    offset  = 6'h12;
                                    case (rx_link_rate)
                                        RBR :   value = 16'h1100;

...
//Link Rate Change End 2	    
		...
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd4 } | (1<<19) | (8'h0a<<21) ); // Send Idle Pattern
		avalon_write (DPTX0_MSA_COLOUR, {29'd0, bpc});
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd0 } | (1<<19) | (8'h0a<<21) ); // Turn on video

...
qmegawiz -silent av_native_phy_tx.v
qmegawiz -silent av_native_phy_rx.v

# Merge the msim_setup.tcl files
ip-make-simscript --spd=./av_xcvr_reconfig.spd --spd=./av_dp.spd --spd=./av_native_phy_tx.spd --spd=./av_native_phy_rx.spd 

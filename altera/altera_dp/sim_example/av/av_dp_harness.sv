...
reg freq_measure6=0, freq_measure7=0;
...
freq_check freq_check(
        ...
        .region3        (freq_measure6 & ~freq_measure7),
        .refclk (refclk),
...
//Link Rate Change Start 0	    
		$display("Testing Link HBR2 Rate (RX reconfig)" );
		// wait for TX ready 
		ready_to_tx = 0; 
		while(~ready_to_tx)
		begin
		...
		$display("Testing Link HBR2 Rate (TX reconfig)" );
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd0 } | (1<<19) | (8'h14<<21) );
		...
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd1 } | (1<<19) | (8'h14<<21));
...
freq_measure0=1;
		...
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
		 avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd2 } | (1<<19) | (8'h14<<21) );
...
//Link Rate Change Start 1	    
		...
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd0 } | (1<<19) | (8'h0a<<21) );
		...
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd1 } | (1<<19) | (8'h0a<<21));
...
freq_measure2=1;
		...
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
		 avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd2 } | (1<<19) | (8'h0a<<21) );
...
//Link Rate Change Start 2	    
		...
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd0 } | (1<<19) | (8'h06<<21) );
		...
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
	avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd1 } | (1<<19) | (8'h06<<21) );
...
freq_measure4=1;
		...
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
        avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd2 } | (1<<19) | (8'h06<<21) );
...
freq_measure6=1;
        // Send Test pattern 2
		$display("Testing Link HBR2 Rate Training Pattern 3" );
		//bit[18:17]=00 RBR, =01 HBR, =10 HBR2        bits[28:21]=8h06 RBR, =8h0a HBR, =8h14 HBR2
        avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd3 } | (1<<19) | (8'h14<<21) );
...
//Link Rate Change End 3	    
		...
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd4 } | (1<<19) | (8'h14<<21) ); // Send Idle Pattern
		avalon_write (DPTX0_MSA_COLOUR, {29'd0, bpc});
		avalon_write (DPTX_TX_CONTROL, {22'd0, lane_count, 1'b0, 4'd0 } | (1<<19) | (8'h14<<21) ); // Turn on video

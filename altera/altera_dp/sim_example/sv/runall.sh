...
qmegawiz -silent sv_native_phy_tx.v
qmegawiz -silent sv_native_phy_rx.v

# Merge the msim_setup.tcl files
ip-make-simscript --spd=./sv_xcvr_reconfig.spd --spd=./sv_dp.spd --spd=./sv_native_phy_tx.spd --spd=./sv_native_phy_rx.spd

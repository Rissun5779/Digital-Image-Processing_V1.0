...
// Revision       : $Revision: #1 $
// URL            : $URL: svn://nas-bitec-fi/dp/trunk/software/btc_dptx_syslib/btc_dptx_syslib.h $
//
// Description:
//
// ********************************************************************************
...
#define BTC_DPTX_SYSLIB_VER "X.X.X"
#endif
...
int btc_dptx_mst_vcptab_addvc(BYTE tx_idx,BYTE vc_size,BYTE vc_id);
...
//********** btc_dptx_hdcp.c *********//
int btc_dptx_cp_irq(BYTE tx_idx);
void btc_dptx_hdcp1_authenticate(BYTE tx_idx,BYTE *An);
void btc_dptx_hdcp2_authenticate(BYTE tx_idx,BYTE use_stored_km);
int btc_dptx_hdcp_encryption_enable(BYTE tx_idx,BYTE strm_idx,BYTE enabled);
void btc_dptx_hdcp_status(BYTE tx_idx,BTC_HDCPTX_STAT *pstat);
int btc_dptx_hdcp_repeaterauth_stream_manage(BYTE tx_idx,BYTE cstype);

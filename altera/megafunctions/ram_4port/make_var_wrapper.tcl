...
proc make_var_wrapper {params_ref} {
   ...
   # set eccencparity_width	[expr {$params(width_eccencparity) -1}]
    ...
    # ip_name = altsyncram or altera_syncram #
        ...
        # port_map_list #
        set ports_list_all_in   {"aclr1" "sclr" "address_a" "address2_a" "address_b" "byteena_a" "clock0" "clocken0" "data_a" "rden_a" "wren_a" "aclr0" "address2_b" "addressstall_a" "addressstall_b" "byteena_b" "clock1" "clocken1" "clocken2" "clocken3" "data_b" "rden_b" "wren_b" "eccstatus" "eccencbypass" "eccencparity"}
	...
	if {$params(force_to_zero)} {
	    ...
	    lappend params_list "read_during_write_mode_mixed_ports"
            lappend params_list "\"NEW_A_OLD_B\""      
        }

...
proc make_var_wrapper {params_ref} {
    ...
    if {$params(module_name) eq "altdpram"} {
		...
		"eccencparity" {
		    lappend module_port_list	"IN"	$eccencparity_width -1
		}
		"eccencbypass" {
		    lappend module_port_list	"IN"	0	0
		}
                "eccstatus" {
                    lappend module_port_list    "OUT"   $eccstatus_width    -1    
                }
                "q"     -
                "q_b"   {
                    lappend module_port_list    "OUT"   $q_width    -1
		...
		"sclr"		-
                ...
                "byteena_a" -
                "byteena_b" {
                    lappend module_port_list    "IN"    $byte_width 2
                }
                default     {
                    lappend module_port_list    "IN"    -1  1
                }
	...
	lappend params_list "outdata_sclr"      ;# outdata_sclr
        ...
        if {($params(device_family) ne "MAX II")&&($params(device_family) ne "MAX V")} {
		    ...
		    if {$params(ram_block_type) eq "MLAB"} {
			if {$params(constrained_dont_care)} {
    ...
    # ip_name = altsyncram or altera_syncram #
        ...
        # port_map_list #
        set ports_list_all_in   {"aclr1" "sclr" "address_a" "address2_a" "byteena_a" "clock0" "clocken0" "data_a" "rden_a" "wren_a" "aclr0" "address_b" "address2_b" "addressstall_a" "addressstall_b" "byteena_b" "clock1" "clocken1" "clocken2" "clocken3" "data_b" "rden_b" "wren_b"}
        set ports_list_all_out  {"q_b" "q_a" "eccstatus" "eccencbypass" "eccencparity"}

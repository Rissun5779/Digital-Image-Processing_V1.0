...
# +-----------------------------------
# | 
# | $Header: //acds/rel/18.1std/ip/altchip_id/source/altchip_id_hw.tcl#1 $
# | 
# +-----------------------------------
...
set_module_property DISPLAY_NAME "Unique Chip ID Intel FPGA IP"
...
set all_supported_device_families_list {"MAX 10" "Cyclone V" "Arria V GZ" "Arria V" "Stratix V"}
...
# ID_VALUE in string. In MAX10, we use string to store id_value instead of hex to avoid mixed language (vhdl/verilog) compilation issue in vcs simulator
add_parameter ID_VALUE_STR STRING
set_parameter_property ID_VALUE_STR DEFAULT_VALUE "ffffffffffffffff"
set_parameter_property ID_VALUE_STR VISIBLE false
set_parameter_property ID_VALUE_STR ENABLED false
set_parameter_property ID_VALUE_STR HDL_PARAMETER false
set_parameter_property ID_VALUE_STR DERIVED true

...
// ----------------------------------------------------------------------------
   // Signal tx_ready synchronizer to tx_clk domain
    altera_std_synchronizer_nocut tx_ready_meta_sync_2 (
        .clk(tx_clk), 
   ...
   // Signal tx_ready synchronizer
    altera_std_synchronizer_nocut tx_ready_meta_sync_1 (
        .clk(clk), 
        .reset_n(rst_n), 
        .din(tx_ready), 
   ...
   // Signal lane_sync synchronizer
    ...
    generate
        ...
        begin : meta_sync
            altera_std_synchronizer_nocut lanes_sync_meta_sync (
                                        .clk(clk), 
                                        .reset_n(rst_n), 
                                        .din(rx_syncstatus[i]), 
                                        .dout(rx_syncstatus_hard[i])
                                        );
        end
    endgenerate
    ...
    // Signal two_lanes_aligned synchronizer
     altera_std_synchronizer_nocut two_lanes_aligned_meta_sync (
        .clk(clk), 
        .reset_n(rst_n), 
    ...
    altera_std_synchronizer_nocut four_lanes_aligned_meta_sync (
        .clk(clk), 
        .reset_n(rst_n), 

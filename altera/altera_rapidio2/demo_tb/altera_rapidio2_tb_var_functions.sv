...
parameter XCVR_RECONFIG = 1;
parameter XCVR_ADME    = 1'b0;
parameter GUI_XCVR_RCFG_SHARED    = 1'b0;
parameter XCVR_CAPABILITY_REG_EN    =1'b0;
parameter XCVR_SET_USER_IDENTIFIER   =0;
parameter XCVR_CSR_SOFT_LOG_EN    =1'b0;
parameter XCVR_PRBS_SOFT_LOG_EN    =1'b0;
parameter XCVR_RCFG_SHARED    = 1'b0;
endpackage

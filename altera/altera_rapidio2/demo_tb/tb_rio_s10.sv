...
//This tb is for Stratix 10, not applicable to previous families. 
...
//----------------------------
  ...
  //logic  [(LSIZE*11)-1:0] reconfig_address;
...
//----------------------------------------------------------------------------  
  ...
  // Maintenance Module User visible Avalon-MM Slave Interface
    ...
    .reconfig_address   ({LSIZE{11'b0}}),//(reconfig_address),

...
//----------------------------
  ...
  logic          external_io_error_response_set;
  ...
  //logic  [LSIZE-1:0]      reconfig_write;
  //logic  [LSIZE-1:0]      reconfig_read;
  //logic  [(LSIZE*10)-1:0] reconfig_address;
  //logic  [(LSIZE*32)-1:0] reconfig_writedata;
  logic pll_cal_busy;
...
//----------------------------------------------------------------------------
  ...
  logic         i_external_io_error_response_set;
...
//----------------------------------------------------------------------------
  ...
  initial begin
    ...
    i_external_io_error_response_set = 0;
...
//----------------------------------------------------------------------------  
  ...
  assign  external_io_error_response_set = i_external_io_error_response_set;
  ...
  altera_rapidio2_top_with_reset_ctrl_pll 
  ...
  (
     ...
     //----------------------------
      ...
      .external_io_error_response_set                      (external_io_error_response_set),
  ...
  // Maintenance Module User visible Avalon-MM Slave Interface
    ...
    .reconfig_write     ({RSIZE{1'b0}}),//(reconfig_write),
    .reconfig_read      ({RSIZE{1'b0}}),//(reconfig_read),
    .reconfig_address   ({(RSIZE*(10+ASIZE)){1'b0}}),//(reconfig_address),
    .reconfig_writedata ({RSIZE{32'b0}}),//(reconfig_writedata),
    .reconfig_readdata    (),
...
//-----------------------------------------------------------------
 ...
 //------- CAR Inputs ---------
  ...
  logic          sis_external_io_error_response_set;
  ...
  logic               sis_rx_clkout;                         
  logic               sis_tx_clkout;                         
  logic                   sis_reconfig_clk;
  logic                   sis_reconfig_reset;
  //logic  [LSIZE-1:0]      sis_reconfig_write;
  //logic  [LSIZE-1:0]      sis_reconfig_read;
  //logic  [(LSIZE*10)-1:0] sis_reconfig_address;
  //logic  [(LSIZE*32)-1:0] sis_reconfig_writedata;
  logic               sis_pll_cal_busy;
 //------------------
 // Interrupt Signals
 //------------------
...
//----------------------------------------------------------------------------
  ...
  logic         sis_i_external_io_error_response_set;
 ...
 //---------------------------------------------------------------------
  ...
  altera_rapidio2_top_with_reset_ctrl_pll #( //Parameters passed in from tb_hookup.sv (from parameters.v)
    .DEVICE_FAMILY (DEVICE_FAMILY) 
   ,.SUPPORT_4X (SUPPORT_4X)
   ,.SUPPORT_2X (SUPPORT_2X)
   ,.SUPPORT_1X (SUPPORT_1X)
   ...
   ,.IO_SLAVE(IO_SLAVE)
	...
	,.ERROR_MANAGEMENT_EXTENSION(ERROR_MANAGEMENT_EXTENSION)
     ...
     //----------------------------
      ...
      .external_io_error_response_set                         (sis_external_io_error_response_set),
  ...
  // Maintenance Module User visible Avalon-MM Slave Interface
    ...
    // Reconfig Signals
    //------------------
    .reconfig_clk       (sis_reconfig_clk),
    .reconfig_reset     (sis_reconfig_reset),
    .reconfig_write     ({RSIZE{1'b0}}),//(sis_reconfig_write),
    .reconfig_read      ({RSIZE{1'b0}}),//(sis_reconfig_read),
    .reconfig_address   ({(RSIZE*(10+ASIZE)){1'b0}}),//(sis_reconfig_address),
    .reconfig_writedata ({RSIZE{32'b0}}),//(sis_reconfig_writedata),
    .reconfig_readdata    (),
    .reconfig_waitrequest (),
    //------------------
    // PLL Signals
    //------------------
    .pll_cal_busy (sis_pll_cal_busy)
    );
  ...
  initial begin
    ...
    sis_i_external_io_error_response_set = 0;
  ...
  assign  sis_external_io_error_response_set = sis_i_external_io_error_response_set;
...
initial
  begin
   sis_reconfig_clk = 1'b0;
   forever
   begin
       #10000;
        sis_reconfig_clk = !sis_reconfig_clk;
   end
  end
 ...
 begin 
    ...
    sister_rst_n = 1'b0;
    reconfig_reset = 1'b1;
    sis_reconfig_reset = 1'b1;
    #200000;
    rst_n = 1'b1;
    sister_rst_n = 1'b1;
    reconfig_reset = 1'b0;
    sis_reconfig_reset = 1'b0;
 ...
 //--------------------------------------------------------------------------------------
      ...
      reg_wr_data = {reg_rd_data[31:9], promiscuous, reg_rd_data[7:0]};
      ...
      exp_reg_data = {SUPPORT_2X,SUPPORT_4X,init_port_width,3'b000,1'b0,1'b0,1'b0,1'b0,1'b1,1'b1,1'b1,1'b1,2'b00,2'b00,3'b0,1'b1,7'b0,1'b1};

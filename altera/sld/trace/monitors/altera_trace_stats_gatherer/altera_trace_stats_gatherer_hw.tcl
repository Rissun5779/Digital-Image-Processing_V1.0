...
# $Id: //acds/rel/18.1std/ip/sld/trace/monitors/altera_trace_stats_gatherer/altera_trace_stats_gatherer_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
# 
...
proc generate { instance_name } {
  ...
  set sc_fifo_filename altera_avalon_sc_fifo.v
  set sc_fifo_path [file join $::env(QUARTUS_ROOTDIR) .. ip altera sopc_builder_ip altera_avalon_sc_fifo $sc_fifo_filename]
  add_fileset_file $sc_fifo_filename VERILOG PATH ${sc_fifo_path}
}

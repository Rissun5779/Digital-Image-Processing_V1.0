...
# module properties
set_module_property NAME altera_avst_tmon_mlab
set_module_property DISPLAY_NAME "AvST Throughput Monitor_mlab"
...
proc compose { } {
    ...
    add_instance if_reset altera_reset_bridge 14.0
    ...
    add_instance if_clock altera_clock_bridge 14.0

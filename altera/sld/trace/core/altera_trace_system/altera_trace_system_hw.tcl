...
proc compose {} {
	...
	for { set i 0 } { $i < $inputs } { incr i } {
		lappend settings "trace_width $capture_width addr_width 6 read_latency 0 clock clk clock_rate_clk $clock_rate"
	}
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/bhc1411020596507/bhc1411020431690

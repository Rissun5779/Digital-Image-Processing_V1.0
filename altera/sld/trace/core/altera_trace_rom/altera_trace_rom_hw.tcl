...
proc_add_parameter  REG_VALUE_STRING          STRING   "03020100" true     true      true       ""           "Register values"               "register values as a string"

proc_add_parameter  DEBUG_TYPE_NAME           STRING   ""         false    false     false      ""           "Debug type"                    ""
...
proc elaborate {} {
	set type_name [get_parameter_value DEBUG_TYPE_NAME]

	if {$type_name != ""} {
		set_interface_assignment rom debug.typeName $type_name
	}
}

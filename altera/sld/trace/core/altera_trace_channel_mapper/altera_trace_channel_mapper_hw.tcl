...
# $Id: //acds/rel/18.1std/ip/sld/trace/core/altera_trace_channel_mapper/altera_trace_channel_mapper_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
add_fileset sim sim_verilog generate "Sim Verilog"

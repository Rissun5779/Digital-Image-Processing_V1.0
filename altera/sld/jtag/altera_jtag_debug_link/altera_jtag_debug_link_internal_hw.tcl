...
proc compose {} {
	...
	set_instance_parameter_value jtag EXPORT_JTAG $export_jtag
	...
	if {$export_jtag} {
		...
		set_interface_property tck export_of jtag.tck
		add_interface node conduit end
		set_interface_property node export_of jtag.node
		
		set_interface_assignment node debug.hostConnection {type jtag id 110:132}
		#set_interface_assignment node debug.providesServices sld 
		set_interface_assignment h2t debug.controlledBy node
	} else {

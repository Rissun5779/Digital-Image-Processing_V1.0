...
# 
# altera_avalon_st_debug_agent_endpoint_tieoff "altera_avalon_st_debug_agent_endpoint_tieoff" v1.0
# 
...
# 
# module altera_avalon_st_debug_agent_endpoint_tieoff
# 
set_module_property NAME altera_avalon_st_debug_agent_endpoint_tieoff
set_module_property AUTHOR "Altera Corporation"
set_module_property GROUP "Verification/Debug & Performance"
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property DISPLAY_NAME altera_avalon_st_debug_agent_endpoint_tieoff
...
set_port_property reset driven_by 0
...
set_port_property h2t_valid driven_by 0
set_port_property h2t_data driven_by 0
set_port_property h2t_startofpacket driven_by 0
set_port_property h2t_endofpacket driven_by 0
...
set_port_property t2h_ready driven_by 0
...
proc elaborate {} {
    ...
    if {$CHANNEL_WIDTH > 0} {
        ...
        add_interface_port h2t h2t_channel channel Output $CHANNEL_WIDTH
        set_port_property h2t_channel driven_by 0
        set_interface_property t2h maxChannel [expr {(1 << $CHANNEL_WIDTH) - 1} ]
        add_interface_port t2h t2h_channel channel Input $CHANNEL_WIDTH
        set_interface_property mgmt maxChannel [expr {(1 << $CHANNEL_WIDTH) - 1} ]
    }

    if {$DATA_WIDTH > 8} {
        add_interface_port h2t h2t_empty empty Output [expr {[log2 $DATA_WIDTH] - 3} ]
        set_port_property h2t_empty driven_by 0
        add_interface_port t2h t2h_empty empty Input [expr {[log2 $DATA_WIDTH] - 3} ]
    }

    if {$CHANNEL_WIDTH > 0 && $HAS_MGMT != 0} {
        set_interface_property mgmt ENABLED true
        add_interface_port mgmt mgmt_valid valid Output 1
        set_port_property mgmt_valid driven_by 0
        add_interface_port mgmt mgmt_data data Output 1
        set_port_property mgmt_data driven_by 0
        add_interface_port mgmt mgmt_channel channel Output $CHANNEL_WIDTH
        set_port_property mgmt_channel driven_by 0
    }
}

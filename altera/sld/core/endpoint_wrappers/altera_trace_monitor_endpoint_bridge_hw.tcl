...
set_parameter_property TRACE_WIDTH ALLOWED_RANGES {8 16 32 64 128}
...
set_interface_assignment int_capture debug.controlledBy ext_capture
...
set_interface_property int_control bridgesToMaster ext_control
set_interface_assignment ext_control debug.controlledBy int_control
...
proc elaborate {} {
    ...
    if {$TRACE_WIDTH > 8} {
        add_interface_port int_capture int_capture_empty empty Output [expr {[log2 $TRACE_WIDTH] - 3} ]
        add_interface_port ext_capture ext_capture_empty empty Input [expr {[log2 $TRACE_WIDTH] - 3} ]

...
set_fileset_property SIM_VERILOG TOP_LEVEL altera_trace_monitor_endpoint_wrapper
...
set_port_property capture_empty termination true
...
proc elaborate {} {
    ...
    if {$TRACE_WIDTH > 8} {
        ...
        set_port_property capture_empty termination false
    }

...
add_file $::env(QUARTUS_ROOTDIR)/../ip/altera/avalon_st/altera_avalon_st_handshake_clock_crosser/altera_avalon_st_handshake_clock_crosser.sdc  {SYNTHESIS}
add_file $::env(QUARTUS_ROOTDIR)/../ip/altera/primitives/altera_std_synchronizer/altera_std_synchronizer_nocut.v                    {SYNTHESIS SIMULATION}

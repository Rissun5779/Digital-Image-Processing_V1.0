...
# $Id: //acds/rel/18.1std/ip/sld/st/altera_streaming_sld_hub_controller/altera_streaming_sld_hub_controller_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
proc compose {} {
  ...
  # Core instance
  add_instance core altera_streaming_sld_hub_controller_core

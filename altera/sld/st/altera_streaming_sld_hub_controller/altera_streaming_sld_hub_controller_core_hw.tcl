...
# $Id: //acds/rel/18.1std/ip/sld/st/altera_streaming_sld_hub_controller/altera_streaming_sld_hub_controller_core_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
# | 
set_module_property NAME altera_streaming_sld_hub_controller_core
set_module_property AUTHOR "Altera Corporation"
set_module_property GROUP "Basic Functions/Simulation; Debug and Verification/Debug and Performance"
set_module_property DISPLAY_NAME "SLD Hub Controller core"
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property DISPLAY_NAME altera_streaming_sld_hub_controller_core
set_module_property TOP_LEVEL_HDL_FILE altera_streaming_sld_hub_controller_core.sv
set_module_property TOP_LEVEL_HDL_MODULE altera_streaming_sld_hub_controller_core
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property ANALYZE_HDL FALSE
set_module_property STATIC_TOP_LEVEL_MODULE_NAME altera_streaming_sld_hub_controller_core
...
# | files
# | 
add_file altera_streaming_sld_hub_controller_core.sv {SYNTHESIS SIMULATION}

...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Stream Cleaner                                                               --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_stream_cleaner

# Common files (base VipCore and logger)
add_common_software_files

# Stream Cleaner files
add_sw_property include_source ../../drivers/vip/inc/Stream_Cleaner.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Stream_Cleaner.cpp

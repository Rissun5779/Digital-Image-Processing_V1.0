...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Component Library Interlacer (Interlacer 2)                              --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_interlacer

# Common files (base VipCore and logger)
add_common_software_files
    
# Interlacer files
add_sw_property include_source ../../drivers/vip/inc/Interlacer.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Interlacer.cpp

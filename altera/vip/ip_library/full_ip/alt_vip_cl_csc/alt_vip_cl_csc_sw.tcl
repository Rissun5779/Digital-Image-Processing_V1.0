...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Color Space Converter (2)                                                    --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_csc
...
# Color Space Converter files
add_sw_property include_source ../../drivers/vip/inc/Color_Space_Converter.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Color_Space_Converter.cpp

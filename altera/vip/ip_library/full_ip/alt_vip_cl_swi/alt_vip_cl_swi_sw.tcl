...
declare_general_software_driver_info alt_vip_cl_swi

# Common files (base VipCore and logger)
add_common_software_files
    
# Switch files
add_sw_property include_source ../../drivers/vip/inc/Switch.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Switch.cpp

...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Gamma Corrector (2)                                                          --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_gamma_corrector

# Common files (base VipCore and logger)
add_common_software_files
    
# Clocked Video Input files
add_sw_property include_source ../../drivers/vip/inc/Gamma_Corrector.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Gamma_Corrector.cpp

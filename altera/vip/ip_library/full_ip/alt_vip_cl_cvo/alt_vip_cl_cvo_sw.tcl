...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Clocked Video Output (2)                                                     --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_cvo

# Common files (base VipCore and logger)
add_common_software_files
    
# Clocked Video Output files
add_sw_property include_source ../../drivers/vip/inc/Clocked_Video_Output.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Clocked_Video_Output.cpp

...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Component Library Clipper (Clipper 2)                                        --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_clp

# Common files (base VipCore and logger)
add_common_software_files
    
# Clipper files
add_sw_property include_source ../../drivers/vip/inc/Clipper.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Clipper.cpp

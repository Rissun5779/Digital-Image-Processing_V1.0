...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Component Library Deinterlacer (Deinterlacer 2)                              --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_dil

# Common files (base VipCore and logger)
add_common_software_files
    
# Deinterlacer files
add_sw_property include_source ../../drivers/vip/inc/Deinterlacer.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Deinterlacer.cpp

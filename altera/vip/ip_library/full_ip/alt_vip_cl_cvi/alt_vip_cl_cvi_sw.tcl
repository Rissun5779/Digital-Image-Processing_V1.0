...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Clocked Video Input (2)                                                      --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_cvi

# Common files (base VipCore and logger)
add_common_software_files
    
# Clocked Video Input files
add_sw_property include_source ../../drivers/vip/inc/Clocked_Video_Input.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Clocked_Video_Input.cpp

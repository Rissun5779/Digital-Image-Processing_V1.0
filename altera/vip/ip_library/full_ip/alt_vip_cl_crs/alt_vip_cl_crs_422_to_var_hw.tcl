...
set_module_property  NAME           alt_vip_cl_crs_422_to_var
set_module_property  DISPLAY_NAME   "Chroma Resampler (4:2:2 to variable)"
...
proc composition_cb {} {
   ...
   if { $color_planes_are_in_parallel > 0 } {
      set   input_data_width                 [expr $bits_per_symbol * 2]
      set   middle_data_width                [expr $bits_per_symbol * 3]
      set   colours_in                       2
      set   colours_out                      3
   } else {
   ...
   if { $enable_vib_cmd > 0 } {
      ...
      set_instance_parameter_value  video_in_cmd      NUMBER_OF_COLOR_PLANES        2
   ...
   if { $enable_444 > 0 } {  
      ...
      if { $enable_444_or_user_or_422 > 1 } {
         add_connection    middle_demux.av_st_dout_0        horiz_upsample.av_st_din
      } else {
         add_connection    pip_other.av_st_dout             horiz_upsample.av_st_din
      }
   }
   ...
   if { $enable_422 > 0 } {
      ...
      set_instance_parameter_value  pad_422     PIXELS_IN_PARALLEL            $pixels_in_parallel_out
      ...
      if { $enable_444_or_user_or_422 > 1 } {
         if { $enable_444 > 0 } {
            ...
            add_connection    middle_demux.av_st_dout_0     pad_422.av_st_din
         }
      } else {
         add_connection    pip_other.av_st_dout             pad_422.av_st_din
      }
   }
   ...
   if { $enable_user > 0 } {
      ...
      set_instance_parameter_value  symbol_conv PIXELS_IN_PARALLEL_IN         $pixels_in_parallel_out
      set_instance_parameter_value  symbol_conv PIXELS_IN_PARALLEL_OUT        $pixels_in_parallel_out
      ...
      if { $enable_444_or_user_or_422 > 1 } {
         ...
         add_connection    pip_other.av_st_dout             symbol_conv.av_st_din
      }
   }
   ...
   if { $enable_444_or_user_or_422 > 1 } {
      ...
      if { $enable_444 } {
         add_connection    horiz_upsample.av_st_dout     middle_mux.av_st_din_0
      }
      if { $enable_422 } {
         if { $enable_444 } {
            add_connection    pad_422.av_st_dout         middle_mux.av_st_din_1
         } else {
   ...
   if { $enable_420 > 0 } {
      ...
      set_instance_parameter_value  pip_420_in  PIXEL_WIDTH                [expr $input_data_width * $num_lines]
      ...
      if { $enable_444_or_user_or_422_and_420 > 0 } {
         ...
         if { $enable_vib_cmd > 0 } {
            ...
            set_interface_property  av_st_din   export_of   line_buffer.av_st_din
         }
      }
   ...
   if { $enable_444_or_user_or_422_and_420 > 0 } {
      ...
      if { $enable_444_or_user_or_422 > 1 } {
         add_connection    middle_mux.av_st_dout         output_mux.av_st_din_1 
      } else {
         if { $enable_444 > 0 } {
            add_connection horiz_upsample.av_st_dout     output_mux.av_st_din_1 
         } else {
            if { $enable_422 > 0 } {
               add_connection pad_422.av_st_dout         output_mux.av_st_din_1 
            } else {
               add_connection symbol_conv.av_st_dout     output_mux.av_st_din_1 
            }
         }
      }
      ...
      if { $enable_420 } {
         ...
         if { $enable_444_or_user_or_422 > 1 } {
            set_interface_property  av_st_dout  export_of    middle_mux.av_st_dout
         } else {

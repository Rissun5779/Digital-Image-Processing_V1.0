...
set_module_property  NAME           alt_vip_cl_crs_var_to_422
set_module_property  DISPLAY_NAME   "Chroma Resampler (variable to 4:2:2)"
...
set_parameter_property  ENABLE_444                    DISPLAY_NAME         "Enable 4:4:4 input"
...
set_parameter_property  ENABLE_422                    DISPLAY_NAME         "Enable 4:2:2 input"
...
set_parameter_property  ENABLE_420                    DISPLAY_NAME         "Enable 4:2:0 input"
...
proc composition_cb {} {
   ...
   if { $pixels_in_parallel_out == 1 } {
      set   pixels_in_parallel_middle        1
   } else {
      set   pixels_in_parallel_middle        [expr $pixels_in_parallel_out / 2]
   }
   ...
   set   enable_vib_cmd                      [expr $enable_444 + $enable_420 + $enable_422 + $enable_user + $enable_discard]
   if { $enable_vib_cmd > 1 } {
      set   enable_vib_cmd                   1
   } else {
      set   enable_vib_cmd                   0
   }
   set   enable_444_or_user_or_422           [expr $enable_444 + $enable_user + $enable_422]
   set   enable_444_or_user_or_422_and_420   [expr $enable_444_or_user_or_422 * $enable_420]
   set   enable_444_and_422                  [expr $enable_444 * $enable_422]
   ...
   if { $enable_444_or_user_or_422 > 1 } {
      ...
      set_instance_parameter_value   middle_demux     DATA_WIDTH                    $input_data_width
      set_instance_parameter_value   middle_demux     PIXELS_IN_PARALLEL            $pixels_in_parallel_in
      set_instance_parameter_value   middle_demux     NUM_OUTPUTS                   $enable_444_or_user_or_422
      ...
      if { $enable_444_or_user_or_422_and_420 > 0 } {
         add_connection    input_demux.av_st_dout_1         middle_demux.av_st_din
      } else {
         if { $enable_vib_cmd > 0 } {
            add_connection video_in_cmd.av_st_dout          middle_demux.av_st_din
         } else {
            set_interface_property  av_st_din   export_of   middle_demux.av_st_din
         }
      }
   }
   ...
   if { $enable_444 > 0 } {  
      ...
      if { $enable_444_or_user_or_422 > 1 } {
         add_connection    middle_demux.av_st_dout_0        horiz_downsample.av_st_din
      } else {
         if { $enable_444_or_user_or_422_and_420 > 0 } {
            add_connection    input_demux.av_st_dout_1         horiz_downsample.av_st_din
         } else {
            if { $enable_vib_cmd > 0 } {
   ...
   if { $enable_422 > 0 } {
      add_instance   drop_422          alt_vip_crs_422_drop_pad         $isVersion
      
      set_instance_parameter_value  drop_422    PAD_MODE                      0
      set_instance_parameter_value  drop_422    BITS_PER_SYMBOL               $bits_per_symbol
      set_instance_parameter_value  drop_422    COLOR_PLANES_ARE_IN_PARALLEL  $color_planes_are_in_parallel
      set_instance_parameter_value  drop_422    PIXELS_IN_PARALLEL            $pixels_in_parallel_in
      set_instance_parameter_value  drop_422    SRC_WIDTH                     8
      set_instance_parameter_value  drop_422    DST_WIDTH                     8
      set_instance_parameter_value  drop_422    CONTEXT_WIDTH                 8
      set_instance_parameter_value  drop_422    TASK_WIDTH                    8
      
      add_connection    av_st_clk_bridge.out_clk         drop_422.main_clock
      add_connection    av_st_reset_bridge.out_reset     drop_422.main_reset
      
      if { $enable_444_or_user_or_422 > 1 } {
         if { $enable_444 > 0 } {
            add_connection    middle_demux.av_st_dout_1     drop_422.av_st_din
         } else {
            add_connection    middle_demux.av_st_dout_0     drop_422.av_st_din
         }
      } else {
         add_connection    input_demux.av_st_dout_1      drop_422.av_st_din
      }
   }
   
   if { $enable_user > 0 } {
      add_instance   symbol_conv           alt_vip_cpp_converter     $isVersion
      
      set_instance_parameter_value  symbol_conv BITS_PER_SYMBOL               $bits_per_symbol
      set_instance_parameter_value  symbol_conv NUMBER_OF_COLOR_PLANES_IN     $colours_in
      set_instance_parameter_value  symbol_conv NUMBER_OF_COLOR_PLANES_OUT    $colours_out
      set_instance_parameter_value  symbol_conv PIXELS_IN_PARALLEL_IN         $pixels_in_parallel_in
      set_instance_parameter_value  symbol_conv PIXELS_IN_PARALLEL_OUT        $pixels_in_parallel_in
      set_instance_parameter_value  symbol_conv PIPELINE_READY                $pipeline_ready
      set_instance_parameter_value  symbol_conv SRC_WIDTH                     8
      set_instance_parameter_value  symbol_conv DST_WIDTH                     8
      set_instance_parameter_value  symbol_conv CONTEXT_WIDTH                 8
      set_instance_parameter_value  symbol_conv TASK_WIDTH                    8
      
      add_connection    av_st_clk_bridge.out_clk         symbol_conv.main_clock
      add_connection    av_st_reset_bridge.out_reset     symbol_conv.main_reset
      
      if { $enable_444_or_user_or_422 > 1 } {
         if { $enable_444_and_422 > 0 } {
            add_connection    middle_demux.av_st_dout_2     symbol_conv.av_st_din
         } else {
            add_connection    middle_demux.av_st_dout_1     symbol_conv.av_st_din
         }
      } else {
         add_connection    input_demux.av_st_dout_1         symbol_conv.av_st_din
      }
   }
   ...
   if { $enable_444_or_user_or_422 > 1 } {
      ...
      set_instance_parameter_value   middle_mux    DATA_WIDTH                    $middle_data_width
      set_instance_parameter_value   middle_mux    PIXELS_IN_PARALLEL            $pixels_in_parallel_in
      set_instance_parameter_value   middle_mux    NUM_INPUTS                    $enable_444_or_user_or_422
      ...
      if { $enable_444 } {
         add_connection    horiz_downsample.av_st_dout   middle_mux.av_st_din_0
      }
      if { $enable_422 } {
         if { $enable_444 } {
            add_connection    drop_422.av_st_dout        middle_mux.av_st_din_1
         } else {
            add_connection    drop_422.av_st_dout        middle_mux.av_st_din_0
         }
      }
      if { $enable_user } {
         if { $enable_444_or_user_or_422 > 2 } {
            add_connection    symbol_conv.av_st_dout     middle_mux.av_st_din_2
         } else {
            add_connection    symbol_conv.av_st_dout     middle_mux.av_st_din_1
         }
      }
   }
   
   if { $enable_444_or_user_or_422 > 0 } {
      add_instance   pip_other_out  alt_vip_pip_converter_core       $isVersion
      
      set_instance_parameter_value  pip_other_out  PIXEL_WIDTH                   $middle_data_width
      set_instance_parameter_value  pip_other_out  PIXELS_IN_PARALLEL_IN         $pixels_in_parallel_in 
      set_instance_parameter_value  pip_other_out  PIXELS_IN_PARALLEL_OUT        $pixels_in_parallel_out
      set_instance_parameter_value  pip_other_out  FIFO_DEPTH                    0
      set_instance_parameter_value  pip_other_out  PIPELINE_READY                $pipeline_ready
      set_instance_parameter_value  pip_other_out  SRC_WIDTH                     8
      set_instance_parameter_value  pip_other_out  DST_WIDTH                     8
      set_instance_parameter_value  pip_other_out  CONTEXT_WIDTH                 8
      set_instance_parameter_value  pip_other_out  TASK_WIDTH                    8
      
      add_connection    av_st_clk_bridge.out_clk         pip_other_out.main_clock
      add_connection    av_st_reset_bridge.out_reset     pip_other_out.main_reset
      
      if { $enable_444_or_user_or_422 > 1 } {
         add_connection    middle_mux.av_st_dout         pip_other_out.av_st_din
      } else {
         if { $enable_444 > 0 } {
            add_connection horiz_downsample.av_st_dout   pip_other_out.av_st_din
         } else {
            if { $enable_422 > 0 } {
               add_connection drop_422.av_st_dout        pip_other_out.av_st_din
            } else {
               add_connection symbol_conv.av_st_dout     pip_other_out.av_st_din
            }
         }
      }
   }
   ...
   if { $enable_420 > 0 } {
      ...
      add_instance   vert_upsample     alt_vip_crs_v_up_core            $isVersion
      add_instance   pip_420_out       alt_vip_pip_converter_core       $isVersion
      
      set_instance_parameter_value  pip_420_in  PIXEL_WIDTH                $input_data_width
      ...
      set_instance_parameter_value  line_buffer    PIXEL_WIDTH             $input_data_width
      set_instance_parameter_value  line_buffer    PIXELS_IN_PARALLEL      $pixels_in_parallel_middle
      ...
      set_instance_parameter_value  line_buffer    KERNEL_CENTER_0         $centre
      ...
      set_instance_parameter_value  vert_upsample     BITS_PER_SYMBOL      $bits_per_symbol
      set_instance_parameter_value  vert_upsample     ALGORITHM            [get_parameter_value VERT_ALGORITHM]
      set_instance_parameter_value  vert_upsample     CO_SITING            [get_parameter_value VERT_CO_SITING]
      set_instance_parameter_value  vert_upsample     ENABLE_LUMA_ADAPT    [get_parameter_value VERT_ENABLE_LUMA_ADAPT]
      set_instance_parameter_value  vert_upsample     PIXELS_IN_PARALLEL   [expr 2 * $pixels_in_parallel_middle]
      set_instance_parameter_value  vert_upsample     PIPELINE_READY       $pipeline_ready
      set_instance_parameter_value  vert_upsample     SRC_WIDTH            8
      set_instance_parameter_value  vert_upsample     DST_WIDTH            8
      set_instance_parameter_value  vert_upsample     CONTEXT_WIDTH        8
      set_instance_parameter_value  vert_upsample     TASK_WIDTH           8
      set_instance_parameter_value  vert_upsample     SOURCE_ID            0

      set_instance_parameter_value  pip_420_out PIXEL_WIDTH                $middle_data_width
      set_instance_parameter_value  pip_420_out PIXELS_IN_PARALLEL_IN      [expr 2 * $pixels_in_parallel_middle]
      ...
      set_interface_property  av_st_vert_cmd          export_of      vert_upsample.av_st_cmd
      ...
      add_connection    av_st_clk_bridge.out_clk         vert_upsample.main_clock
      add_connection    av_st_reset_bridge.out_reset     vert_upsample.main_reset
      ...
      if { $enable_444_or_user_or_422_and_420 > 0 } {
         add_connection          input_demux.av_st_dout_0   pip_420_in.av_st_din
      } else {
         if { $enable_vib_cmd > 0 } {
            add_connection       video_in_cmd.av_st_dout    pip_420_in.av_st_din
         } else {
            set_interface_property  av_st_din   export_of   pip_420_in.av_st_din
         }
      }
      add_connection    pip_420_in.av_st_dout         line_buffer.av_st_din
      add_connection    line_buffer.av_st_dout_0      vert_upsample.av_st_din
      add_connection    vert_upsample.av_st_dout      pip_420_out.av_st_din
   ...
   if { $enable_444_or_user_or_422_and_420 > 0 } {
      ...
      set_instance_parameter_value   output_mux    DATA_WIDTH                    $middle_data_width
      ...
      add_connection    pip_other_out.av_st_dout         output_mux.av_st_din_1           
   } else {
      if { $enable_420 } {
         set_interface_property  av_st_dout  export_of   pip_420_out.av_st_dout
      } else {
         set_interface_property  av_st_dout  export_of   pip_other_out.av_st_dout
      }
   }

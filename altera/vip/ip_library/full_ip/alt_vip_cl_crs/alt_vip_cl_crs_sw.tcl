...
# ---------------------------------------------------------------------------------------------------
# --                                                                                               --
# -- _sw.tcl file for Chroma Resampler (2)                                                         --
# --                                                                                               --
# ---------------------------------------------------------------------------------------------------
...
declare_general_software_driver_info alt_vip_cl_crs

# Common files (base VipCore and logger)
add_common_software_files
    
# Chroma Resampler files
add_sw_property include_source ../../drivers/vip/inc/Chroma_Resampler.hpp
add_sw_property cpp_source     ../../drivers/vip/src/Chroma_Resampler.cpp

...
# +--------------------------------------------------------------------------------------------------------------------
# |
# | Name:        alt_vip_av_st_message_format.tcl
# |
...
# |
# +--------------------------------------------------------------------------------------------------------------------
package provide alt_vip_av_st_message_format 1.0
...
# +--------------------------------------------------------------------------------------------------------------------
namespace eval ::alt_vip_av_st_message_format {
...
# |
# | The interface assignment alt_vip_av_st_message_format.version is used for this job.
# +--------------------------------------------------------------------------------------------------------------------

# Mark an interface as validated
proc ::alt_vip_av_st_message_format::_mark_as_validated {interfaceName} {
    set_interface_assignment $interfaceName alt_vip_av_st_message_format.version 1.0
}

# Check whether an interface is validated
proc ::alt_vip_av_st_message_format::_is_already_validated {interfaceName} {
    set x [get_interface_assignment $interfaceName alt_vip_av_st_message_format.version]
    if {$x == ""} {
        return false
    }
    return true
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::set_message_property {interfaceName propertyName value} {
    ...
    # Store the property
    set_interface_assignment $interfaceName "alt_vip_av_st_message_format.$propertyName" $value
}
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::get_message_property {interfaceName propertyName} {
    variable valid_message_properties
    variable message_property_defaults
    ...
    set value [get_interface_assignment $interfaceName "alt_vip_av_st_message_format.$propertyName"]
    if {$value == ""} {
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_is_valid_subfield {subfieldName {hdlPort 0}} {
...
# | value             The value of the property
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::set_message_subfield_property {interfaceName subfieldName propertyName value} {
    variable valid_message_control_fields
    ...
    # Store the property
    set_interface_assignment $interfaceName "alt_vip_av_st_message_format.$subfieldName.$propertyName" $value
}
...
# | Returns the value of the property
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::get_message_subfield_property {interfaceName subfieldName propertyName} {
    variable valid_message_control_fields
    variable valid_message_subfield_properties
    variable message_subfield_property_defaults
    ...
    set value [get_interface_assignment $interfaceName "alt_vip_av_st_message_format.$subfieldName.$propertyName"]
    if {$value == ""} {
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::set_message_subfield_hdl_port {interfaceName subfieldName portString} {
    variable valid_message_control_fields
    variable valid_message_subfield_properties
    ...
    # Store the property
    set_interface_assignment $interfaceName "alt_vip_av_st_message_format.$subfieldName.HDL_PORT" $portString
}



# Private helper function that retrieves the HDL port string
proc ::alt_vip_av_st_message_format::_get_message_subfield_hdl_port {interfaceName subfieldName} {
    return [get_interface_assignment $interfaceName "alt_vip_av_st_message_format.$subfieldName.HDL_PORT"]
}
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_validate_interface_ports {interfaceName parentDataPort parentDataPortWidth} {
    ...
    set dataPortWidth [get_port_property $dataPort WIDTH_VALUE]
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_get_data_params {interfaceName parentSubfieldArray} {
    variable valid_message_control_fields
    variable valid_message_subfield_properties
    variable message_subfield_property_defaults
    ...
    foreach assignment [get_interface_assignments $interfaceName] {
        if { [regexp {alt_vip_av_st_message_format\.([0-9a-zA-Z_]+)\.([0-9a-zA-Z_]+)} $assignment dummy matchedSubfield matchedProperty] } {
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_dump_subfield_array {parentSubfieldArray } {
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_log2ceil {num} {
    set val 0
    set i 1
    while {$i < $num} {
        set val [expr $val + 1]
...
# | LEFT and RIGHT.
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_set_data_bit_ranges {interfaceName parentSubfieldArray parentDataPortWidth} {
    upvar 1 $parentSubfieldArray subfieldArray
    upvar 1 $parentDataPortWidth dataPortWidth
    variable valid_message_control_fields
...
# | populated.
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_check_for_overlap {interfaceName parentSubfieldArray parentDataPortWidth parentUnusedList} {
    upvar 1 $parentSubfieldArray subfieldArray
    upvar 1 $parentDataPortWidth dataPortWidth
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_requires_fragment_list {interfaceName parentSubfieldArray parentUnusedList} {
    upvar 1 $parentSubfieldArray subfieldArray
    upvar 1 $parentUnusedList unusedList
    variable valid_message_control_fields
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_set_fragment_list {interfaceName parentSubfieldArray parentDataPort parentUnusedList} {
    upvar 1 $parentSubfieldArray subfieldArray
    upvar 1 $parentDataPort dataPort
    upvar 1 $parentUnusedList unusedList
    variable valid_message_control_fields
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_drive_unused_and_unbound_fragments {interfaceName parentSubfieldArray parentUnusedList} {
    upvar 1 $parentSubfieldArray subfieldArray
    upvar 1 $parentUnusedList unusedList
    variable valid_message_control_fields
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_terminate_unconnected_ports {interfaceName parentSubfieldArray} {
    upvar 1 $parentSubfieldArray subfieldArray
    variable valid_message_control_fields
...
# | Unbound subfields exist in the data but have no HDL ports assigned.
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_terminate_unused_and_unbound_fragments {interfaceName parentSubfieldArray parentUnusedList} {
    upvar 1 $parentSubfieldArray subfieldArray
    upvar 1 $parentUnusedList unusedList
    variable valid_message_control_fields
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::_drive_unconnected_ports {interfaceName parentSubfieldArray} {
    upvar 1 $parentSubfieldArray subfieldArray
    variable valid_message_control_fields
...
# +--------------------------------------------------------------------------------------------------------------------
proc ::alt_vip_av_st_message_format::validate_and_create {interfaceName} {

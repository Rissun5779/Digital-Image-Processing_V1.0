...
set_module_property  NAME                 alt_vip_crs_h_up_core
set_module_property  DISPLAY_NAME         "Chroma resampler core: 4:2:2 to 4:4:4"
set_module_property  DESCRIPTION          "Upsamples 4:2:2 video lines to 4:4:4"
...
add_static_sv_file src_hdl/alt_vip_crs_h_up_core.sv
add_static_sv_file src_hdl/alt_vip_crs_h_up_core_nn.sv
add_static_sv_file src_hdl/alt_vip_crs_h_up_core_bl.sv
add_static_sv_file src_hdl/alt_vip_crs_h_up_core_ft.sv
add_static_sv_file src_hdl/alt_vip_crs_h_up_core_la.sv

add_static_misc_file src_hdl/alt_vip_crs_h_up_core.ocp

setup_filesets alt_vip_crs_h_up_core
...
set_parameter_property  CO_SITING   DISPLAY_NAME         "Horizontal chroma siting"
...
add_parameter           ENABLE_LUMA_ADAPT INTEGER              0
set_parameter_property  ENABLE_LUMA_ADAPT DISPLAY_NAME         "Enable luma adaptive resampling"
set_parameter_property  ENABLE_LUMA_ADAPT ALLOWED_RANGES       0:1
set_parameter_property  ENABLE_LUMA_ADAPT DISPLAY_HINT         BOOLEAN
set_parameter_property  ENABLE_LUMA_ADAPT AFFECTS_ELABORATION  false
set_parameter_property  ENABLE_LUMA_ADAPT HDL_PARAMETER        true
...
add_parameter           CYCLONE_STYLE     INTEGER              0
set_parameter_property  CYCLONE_STYLE     DERIVED              true
set_parameter_property  CYCLONE_STYLE     HDL_PARAMETER        true

add_parameter           V_SERIES_STYLE    INTEGER              0
set_parameter_property  V_SERIES_STYLE    DERIVED              true
set_parameter_property  V_SERIES_STYLE    HDL_PARAMETER        true
...
proc elaboration_cb {} {
   ...
   set_parameter_value  V_SERIES_STYLE $v_style;
   set_parameter_value  CYCLONE_STYLE  $cyclone_style;

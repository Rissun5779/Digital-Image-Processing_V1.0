...
set_module_property   NAME alt_vip_motion_detect
set_module_property   DISPLAY_NAME   "Motion detect core"
set_module_property   DESCRIPTION    "Receives motion detect commands (on the cmd interface), reads the video data on the video and motion interfaces and sources motion vectors on the motion and dout interfaces"
...
add_static_sv_file src_hdl/alt_vip_motion_detect.sv

setup_filesets alt_vip_motion_detect
...
proc motion_detect_elaboration_callback {} {
    ...
    set motion_dwidth           16
    set algo_motion_dwidth       8
    ...
    add_av_st_data_source_port  av_st_algo_motion_out  $algo_motion_dwidth 1 $dst_width $src_width $task_width $context_width 0 main_clock $src_id

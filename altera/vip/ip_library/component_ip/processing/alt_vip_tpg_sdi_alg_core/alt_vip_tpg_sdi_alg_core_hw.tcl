...
set_module_property NAME alt_vip_tpg_sdi_alg_core
set_module_property DISPLAY_NAME "Test Pattern Generator Core (SDI pathological)"
...
add_static_sv_file src_hdl/alt_vip_tpg_sdi_alg_core.sv

add_static_misc_file  src_hdl/alt_vip_tpg_sdi_alg_core.ocp

setup_filesets alt_vip_tpg_sdi_alg_core
...
set_parameter_property NUMBER_OF_COLOR_PLANES ALLOWED_RANGES 2:3

add_parameter           TPG_CS         STRING               YCbCr_422
set_parameter_property  TPG_CS         DISPLAY_NAME         "Test pattern colour space"
set_parameter_property  TPG_CS         ALLOWED_RANGES       {RGB_444 YCbCr_444 YCbCr_422 YCbCr_420}

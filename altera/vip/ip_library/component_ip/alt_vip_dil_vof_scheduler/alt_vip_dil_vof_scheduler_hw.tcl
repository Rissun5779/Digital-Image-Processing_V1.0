...
add_static_sv_file src_hdl/alt_vip_dil_vof_scheduler.sv

add_static_misc_file src_hdl/alt_vip_dil_vof_scheduler.ocp

setup_filesets alt_vip_dil_vof_scheduler
...
set_parameter_property   SWAP_F0_F1   DISPLAY_NAME              "Set this param if f0 and f1 field labelling has been swapped"

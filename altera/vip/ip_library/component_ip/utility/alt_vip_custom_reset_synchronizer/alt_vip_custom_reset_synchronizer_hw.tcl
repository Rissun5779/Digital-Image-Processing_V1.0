...
#---------------------------------------------------------------------------------------------------
#--                                                                                               --
#-- alt_vip_custom_reset_synchronizer_hw.tcl file for the custom_reset_synchronizer component     --
#-- This block will synchronize an asynchronous active low reset to a clock domain and pipeline   --
#-- the output so that the logic can be duplicated and moved around in the floorplan.             --
#-- JCJB             2015.11.16.13:31:56
#-- Multimedia team  2017
#--                                                                                               --
#---------------------------------------------------------------------------------------------------
...
set_module_property  NAME                 alt_vip_custom_reset_synchronizer
...
add_fileset_file reset_sync_block.v VERILOG PATH src_hdl/reset_sync_block.v TOP_LEVEL_FILE
...
add_fileset_file reset_sync_block.v VERILOG PATH src_hdl/reset_sync_block.v

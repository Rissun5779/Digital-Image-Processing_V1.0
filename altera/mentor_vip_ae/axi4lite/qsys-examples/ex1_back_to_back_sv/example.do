...
if {![info exists env(MENTOR_VIP_AE)]} {
  ...
  vlog -work work -sv \
    ...
    $env(MENTOR_VIP_AE)/axi4lite/bfm/mgc_axi4lite_inline_monitor.sv \
    $env(MENTOR_VIP_AE)/axi4/bfm/mgc_axi4_master.sv \
    $env(MENTOR_VIP_AE)/axi4lite/bfm/mgc_axi4lite_master.sv \
    $env(MENTOR_VIP_AE)/axi4/bfm/mgc_axi4_slave.sv \
    $env(MENTOR_VIP_AE)/axi4lite/bfm/mgc_axi4lite_slave.sv

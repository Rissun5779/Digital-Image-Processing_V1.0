...
vhdlan -xlrm \
  ...
  $MENTOR_VIP_AE/axi4lite/bfm/mgc_axi4lite_inline_monitor.vhd \
  $MENTOR_VIP_AE/axi4/bfm/mgc_axi4_slave.vhd \
  $MENTOR_VIP_AE/axi4lite/bfm/mgc_axi4lite_slave.vhd \
  $MENTOR_VIP_AE/axi4/bfm/mgc_axi4_master.vhd \
  $MENTOR_VIP_AE/axi4lite/bfm/mgc_axi4lite_master.vhd

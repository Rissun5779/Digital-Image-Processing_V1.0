...
# +-----------------------------------
# |
# | mgc_axi4lite_inline_monitor_bfm "MGC AXI4-Lite Inline Monitor BFM" 10.4c
# | Mentor Graphics 16.1
# | AXI4-Lite Inline Monitor BFM
# |
...
# +-----------------------------------
# | module mgc_axi4lite_inline_monitor
# |
set_module_property DESCRIPTION        "Mentor Graphics AXI4-Lite Inline Monitor BFM (Altera Edition)"
set_module_property NAME               mgc_axi4lite_inline_monitor
...
set_module_property DISPLAY_NAME       "Mentor Graphics AXI4-Lite Inline Monitor BFM (Altera Edition)"
...
set_fileset_property sim_verilog top_level   mgc_axi4lite_inline_monitor

add_fileset          sim_vhdl    SIM_VHDL    proc_sim_vhdl
set_fileset_property sim_vhdl    top_level   mgc_axi4lite_inline_monitor_vhd
...
# | Documentation links
# |
add_documentation_link "AXI4-Lite Inline Monitor BFM Reference Guide" https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/ug/mentor-vip-axi4lite-ae-usr.pdf
# |
# +-----------------------------------
...
set_parameter_property READ_ACCEPTANCE_CAPABILITY DESCRIPTION "Maximum Number of Outstanding Reads. It will set readIssuingCapability on master interface and readAcceptanceCapability on slave interface"
...
set_parameter_property WRITE_ACCEPTANCE_CAPABILITY DESCRIPTION "Maximum Number of Outstanding Writes. It will set writeIssuingCapability on master interface and writeAcceptanceCapability on slave interface"
...
# +-----------------------------------
# | connection point altera_axi4lite_master and altera_axi4lite_slave
# |
...
add_interface_port altera_axi4lite_master master_AWVALID    awvalid    Output 1
add_interface_port altera_axi4lite_master master_AWPROT     awprot     Output 3
add_interface_port altera_axi4lite_master master_AWREADY    awready    Input  1
add_interface_port altera_axi4lite_master master_ARVALID    arvalid    Output 1
add_interface_port altera_axi4lite_master master_ARPROT     arprot     Output 3
add_interface_port altera_axi4lite_master master_ARREADY    arready    Input  1
add_interface_port altera_axi4lite_master master_RVALID     rvalid     Input  1
add_interface_port altera_axi4lite_master master_RRESP      rresp      Input  2
add_interface_port altera_axi4lite_master master_RREADY     rready     Output 1
add_interface_port altera_axi4lite_master master_WVALID     wvalid     Output 1
add_interface_port altera_axi4lite_master master_WREADY     wready     Input  1
add_interface_port altera_axi4lite_master master_BVALID     bvalid     Input  1
add_interface_port altera_axi4lite_master master_BRESP      bresp      Input  2
add_interface_port altera_axi4lite_master master_BREADY     bready     Output 1
...
add_interface_port altera_axi4lite_slave slave_AWVALID    awvalid    Input  1
add_interface_port altera_axi4lite_slave slave_AWPROT     awprot     Input  3
add_interface_port altera_axi4lite_slave slave_AWREADY    awready    Output 1
add_interface_port altera_axi4lite_slave slave_ARVALID    arvalid    Input  1
add_interface_port altera_axi4lite_slave slave_ARPROT     arprot     Input  3
add_interface_port altera_axi4lite_slave slave_ARREADY    arready    Output 1
add_interface_port altera_axi4lite_slave slave_RVALID     rvalid     Output 1
add_interface_port altera_axi4lite_slave slave_RRESP      rresp      Output 2
add_interface_port altera_axi4lite_slave slave_RREADY     rready     Input  1
add_interface_port altera_axi4lite_slave slave_WVALID     wvalid     Input  1
add_interface_port altera_axi4lite_slave slave_WREADY     wready     Output 1
add_interface_port altera_axi4lite_slave slave_BVALID     bvalid     Output 1
add_interface_port altera_axi4lite_slave slave_BRESP      bresp      Output 2
add_interface_port altera_axi4lite_slave slave_BREADY     bready     Input  1
# |
# +-----------------------------------
...
proc my_elaborate {} {
  ...
  set_interface_property altera_axi4lite_master readIssuingCapability $READ_ACCEPTANCE_CAPABILITY
  set_interface_property altera_axi4lite_master writeIssuingCapability $WRITE_ACCEPTANCE_CAPABILITY
  set_interface_property altera_axi4lite_master combinedIssuingCapability $COMBINED_ACCEPTANCE_CAPABILITY

  add_interface_port altera_axi4lite_master master_AWADDR     awaddr     Output $AXI4_ADDRESS_WIDTH
  add_interface_port altera_axi4lite_master master_ARADDR     araddr     Output $AXI4_ADDRESS_WIDTH
  add_interface_port altera_axi4lite_master master_RDATA      rdata      Input  $AXI4_RDATA_WIDTH
  add_interface_port altera_axi4lite_master master_WDATA      wdata      Output $AXI4_WDATA_WIDTH
  add_interface_port altera_axi4lite_master master_WSTRB      wstrb      Output [ expr ($AXI4_WDATA_WIDTH / 8) ]

  add_interface_port altera_axi4lite_slave slave_AWADDR     awaddr     Input  $AXI4_ADDRESS_WIDTH
  add_interface_port altera_axi4lite_slave slave_ARADDR     araddr     Input  $AXI4_ADDRESS_WIDTH
  add_interface_port altera_axi4lite_slave slave_RDATA      rdata      Output $AXI4_RDATA_WIDTH
  add_interface_port altera_axi4lite_slave slave_WDATA      wdata      Input  $AXI4_WDATA_WIDTH
  add_interface_port altera_axi4lite_slave slave_WSTRB      wstrb      Input  [ expr ($AXI4_WDATA_WIDTH / 8) ]
}

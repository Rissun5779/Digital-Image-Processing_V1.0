...
(
  ...
  task automatic handle_write_addr_ready;
    ...
    begin
      ...
      while ((tmp_config_num_outstanding_wr_phase >= bfm.get_config(AXI4_CONFIG_MAX_OUTSTANDING_WR)) && (bfm.get_config(AXI4_CONFIG_MAX_OUTSTANDING_WR) > 0))
      begin
  ...
  task automatic handle_read_addr_ready;
    ...
    begin
      ...
      while ((tmp_config_num_outstanding_rd_phase >= bfm.get_config(AXI4_CONFIG_MAX_OUTSTANDING_RD)) && (bfm.get_config(AXI4_CONFIG_MAX_OUTSTANDING_RD) > 0))
      begin
        bfm.wait_on(AXI4_CLOCK_POSEDGE);
        tmp_config_num_outstanding_rd_phase = bfm.get_config(AXI4_CONFIG_NUM_OUTSTANDING_RD_PHASE);
      end

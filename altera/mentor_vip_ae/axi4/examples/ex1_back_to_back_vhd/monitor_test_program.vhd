...
begin
  ...
  begin
    ...
    loop
      create_monitor_transaction(write_trans, index, axi4_tr_if_0(index));
      set_read_or_write(AXI4_TRANS_WRITE, write_trans, index, axi4_tr_if_0(index));
  ...
  begin
    loop  
      ...
      get_write_response_phase(write_trans, index, AXI4_PATH_2, axi4_tr_if_2(index));
      report "=======================";
      report "MONITOR: WRITE";
      print(write_trans, index, AXI4_PATH_2, axi4_tr_if_2(index));
      report "=======================";
    end loop;
    wait;
  end process;
  ...
  begin
    ...
    loop
      create_monitor_transaction(read_trans, index, AXI4_PATH_3, axi4_tr_if_3(index));
      set_read_or_write(AXI4_TRANS_READ, read_trans, index, AXI4_PATH_3, axi4_tr_if_3(index));
  ...
  begin
    loop
      ...
      loop_i := 0;
      while(done = 0) loop
        get_read_data_phase(read_trans, loop_i, last, index, AXI4_PATH_4, axi4_tr_if_4(index));
        get_transaction_done(done, read_trans, index, AXI4_PATH_4, axi4_tr_if_4(index));
        loop_i := loop_i + 1; 
      end loop;
      report "=======================";
      report "MONITOR: READ";
      print(read_trans, index, AXI4_PATH_4, axi4_tr_if_4(index));
      report "=======================";
    end loop;  
    wait;
  end process;

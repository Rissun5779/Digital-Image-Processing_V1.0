...
architecture top_a of top is
  ...
  signal RUSER   : std_logic_vector(7 downto 0);
  signal RREADY  : std_logic;
  signal WVALID  : std_logic;
  signal WDATA   : std_logic_vector(31 downto 0);
  signal WSTRB   : std_logic_vector(3 downto 0);
  signal WLAST   : std_logic;
  signal WUSER   : std_logic_vector(7 downto 0);
  signal WREADY  : std_logic;
  signal BVALID  : std_logic; 
  signal BRESP   : std_logic_vector(1 downto 0); 
  signal BID     : std_logic_vector(17 downto 0);
  signal BUSER   : std_logic_vector(7 downto 0);
 ...
 port(
    ...
    WLAST   : out std_logic;
    WUSER   : out std_logic_vector(((AXI4_USER_WIDTH) - 1) downto 0);
    WREADY  : in std_logic;
    BVALID  : in std_logic; 
  ...
  port(
    ...
    RUSER   : out std_logic_vector(((AXI4_USER_WIDTH) - 1) downto 0);
    RREADY  : in std_logic;
    WVALID  : in std_logic;
    ...
    BUSER           : out std_logic_vector(((AXI4_USER_WIDTH) - 1) downto 0);
    BREADY  : in std_logic
   );
 end component;

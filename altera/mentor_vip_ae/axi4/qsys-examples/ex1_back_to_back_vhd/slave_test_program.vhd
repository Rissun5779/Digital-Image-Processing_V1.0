...
architecture slave_test_program_a of slave_test_program is
  ...
  -- Variable : tmp_max_outstanding_write
  shared variable tmp_max_outstanding_write : integer := 0;
...
begin
  ...
  begin
    get_config(AXI4_CONFIG_MAX_OUTSTANDING_WR, tmp_max_outstanding_write, index, axi4_tr_if_0(index));
    loop
  ...
  begin
    loop
      while (tmp_config_num_outstanding_wr_phase >= tmp_max_outstanding_write) loop
  ...
  process
    variable tmp_ready_delay : integer;
    variable tmp_max_outstanding_read : integer;
  begin
    get_config(AXI4_CONFIG_MAX_OUTSTANDING_RD, tmp_max_outstanding_read, index, axi4_tr_if_6(index));
    loop
      while (tmp_config_num_outstanding_rd_phase >= tmp_max_outstanding_read) loop

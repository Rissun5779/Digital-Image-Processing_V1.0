...
(
    ...
    output [((AXI4_USER_WIDTH) - 1):0]  RUSER,
    input  RREADY,
    input  WVALID,
    ...
    output [((AXI4_USER_WIDTH) - 1):0]  BUSER,
    input  BREADY
...
`define call_for_axi4_bfm(XXX) axi4.XXX
    ...
    begin
        ...
        `call_for_axi4_bfm(set_config_read_data_reordering_depth)(READ_DATA_REORDERING_DEPTH);

...
interface mgc_axi4_inline_monitor #(
...
(
    ...
    input  [((AXI4_USER_WIDTH) - 1):0]  master_RUSER,
    ...
    output master_WLAST,
    output [((AXI4_USER_WIDTH) - 1):0]  master_WUSER,
    input  master_WREADY,
    input  master_BVALID,
    input  [1:0] master_BRESP,
    input  [((AXI4_ID_WIDTH) - 1):0]  master_BID,
    input  [((AXI4_USER_WIDTH) - 1):0]  master_BUSER,
...
`endif
    ...
    mgc_axi4_monitor #(AXI4_ADDRESS_WIDTH,
                       AXI4_RDATA_WIDTH,
                       AXI4_WDATA_WIDTH,
                       AXI4_ID_WIDTH,
                       AXI4_USER_WIDTH,

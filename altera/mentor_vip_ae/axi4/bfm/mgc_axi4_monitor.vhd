...
entity mgc_axi4_monitor_vhd is
    generic(
...
end mgc_axi4_monitor_vhd;

architecture monitor_a of mgc_axi4_monitor_vhd is

component mgc_axi4_monitor
    generic(
            AXI4_ADDRESS_WIDTH : integer := 64;
            AXI4_RDATA_WIDTH : integer := 1024;
            AXI4_WDATA_WIDTH : integer := 1024;
...
begin
  ...
  mgc_axi4_monitor_inst: mgc_axi4_monitor
    generic map(

...
entity mgc_axi4stream_slave_vhd is
    generic(
...
end mgc_axi4stream_slave_vhd;

architecture slave_a of mgc_axi4stream_slave_vhd is

component mgc_axi4stream_slave
    generic(
            AXI4_ID_WIDTH : integer := 8;
            AXI4_USER_WIDTH : integer := 8;
            AXI4_DEST_WIDTH : integer := 18;
...
begin
  ...
  mgc_axi4stream_slave_inst: mgc_axi4stream_slave
    generic map(

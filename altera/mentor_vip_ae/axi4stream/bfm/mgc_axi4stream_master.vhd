...
entity mgc_axi4stream_master_vhd is
    generic(
...
end mgc_axi4stream_master_vhd;

architecture master_a of mgc_axi4stream_master_vhd is

component mgc_axi4stream_master
    generic(
            AXI4_ID_WIDTH : integer := 8;
            AXI4_USER_WIDTH : integer := 8;
            AXI4_DEST_WIDTH : integer := 18;
...
begin
  ...
  mgc_axi4stream_master_inst: mgc_axi4stream_master
    generic map(

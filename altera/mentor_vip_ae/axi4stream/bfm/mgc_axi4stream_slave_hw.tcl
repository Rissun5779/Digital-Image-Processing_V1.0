...
# +-----------------------------------
# |
# | mgc_axi4stream_slave_bfm "MGC AXI4STREAM Slave BFM" 10.4c
# | Mentor Graphics 16.1
# | AXI4STREAM Slave BFM
# |
# | ./mgc_axi4stream_slave.sv sim
# |
# +-----------------------------------
...
# +-----------------------------------
# | module mgc_axi4stream_slave
# |
set_module_property DESCRIPTION        "Mentor Graphics AXI4STREAM Slave BFM (Altera Edition)"
set_module_property NAME               mgc_axi4stream_slave
...
set_module_property DISPLAY_NAME       "Mentor Graphics AXI4STREAM Slave BFM (Altera Edition)"
...
set_fileset_property sim_verilog top_level   mgc_axi4stream_slave

add_fileset          sim_vhdl    SIM_VHDL    proc_sim_vhdl
set_fileset_property sim_vhdl    top_level   mgc_axi4stream_slave_vhd
...
# | Documentation links
# |
add_documentation_link "AXI4STREAM Slave BFM Reference Guide" https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/ug/mentor-vip-axi4-stream-ae-usr.pdf
# |
# +-----------------------------------
...
# +-----------------------------------
# | connection point altera_axi4stream_slave
# |
...
add_interface_port altera_axi4stream_slave TVALID     tvalid     Input  1
add_interface_port altera_axi4stream_slave TLAST      tlast      Input  1
add_interface_port altera_axi4stream_slave TREADY     tready     Output 1
# |
# +-----------------------------------
...
proc my_elaborate {} {
  ...
  add_interface_port altera_axi4stream_slave TDATA      tdata      Input  $AXI4_DATA_WIDTH
  add_interface_port altera_axi4stream_slave TSTRB      tstrb      Input  [ expr ($AXI4_DATA_WIDTH / 8) ]
  add_interface_port altera_axi4stream_slave TKEEP      tkeep      Input  [ expr ($AXI4_DATA_WIDTH / 8) ]
  add_interface_port altera_axi4stream_slave TID        tid        Input  $AXI4_ID_WIDTH
  add_interface_port altera_axi4stream_slave TUSER      tuser      Input  $AXI4_USER_WIDTH
  add_interface_port altera_axi4stream_slave TDEST      tdest      Input  $AXI4_DEST_WIDTH
}

...
# +-----------------------------------
# |
# | mgc_axi4stream_master_bfm "MGC AXI4STREAM Master BFM" 10.4c
# | Mentor Graphics 16.1
# | AXI4STREAM Master BFM
# |
# | ./mgc_axi4stream_master.sv sim
# |
# +-----------------------------------
...
# +-----------------------------------
# | module mgc_axi4stream_master
# |
set_module_property DESCRIPTION        "Mentor Graphics AXI4STREAM Master BFM (Altera Edition)"
set_module_property NAME               mgc_axi4stream_master
...
set_module_property DISPLAY_NAME       "Mentor Graphics AXI4STREAM Master BFM (Altera Edition)"
...
set_fileset_property sim_verilog top_level   mgc_axi4stream_master

add_fileset          sim_vhdl    SIM_VHDL    proc_sim_vhdl
set_fileset_property sim_vhdl    top_level   mgc_axi4stream_master_vhd
...
# | Documentation links
# |
add_documentation_link "AXI4STREAM Master BFM Reference Guide" https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/ug/mentor-vip-axi4-stream-ae-usr.pdf
# |
# +-----------------------------------
...
# +-----------------------------------
# | connection point altera_axi4stream_master
# |
...
add_interface_port altera_axi4stream_master TVALID     tvalid     Output 1
add_interface_port altera_axi4stream_master TLAST      tlast      Output 1
add_interface_port altera_axi4stream_master TREADY     tready     Input  1
# |
# +-----------------------------------
...
proc my_elaborate {} {
  ...
  add_interface_port altera_axi4stream_master TDATA      tdata      Output $AXI4_DATA_WIDTH
  add_interface_port altera_axi4stream_master TSTRB      tstrb      Output [ expr ($AXI4_DATA_WIDTH / 8) ]
  add_interface_port altera_axi4stream_master TKEEP      tkeep      Output [ expr ($AXI4_DATA_WIDTH / 8) ]
  add_interface_port altera_axi4stream_master TID        tid        Output $AXI4_ID_WIDTH
  add_interface_port altera_axi4stream_master TUSER      tuser      Output $AXI4_USER_WIDTH
  add_interface_port altera_axi4stream_master TDEST      tdest      Output $AXI4_DEST_WIDTH
}

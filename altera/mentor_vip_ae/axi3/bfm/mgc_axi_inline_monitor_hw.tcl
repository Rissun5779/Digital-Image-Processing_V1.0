...
# +-----------------------------------
# |
# | mgc_axi_inline_monitor_bfm "MGC AXI Inline Monitor BFM" 10.4c
...
# | Documentation links
# |
add_documentation_link "AXI Inline Monitor BFM Reference Guide" https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/ug/mentor-vip-axi34-ae-usr.pdf
# |
# +-----------------------------------
...
proc my_elaborate {} {
  ...
  set_interface_property altera_axi_slave readAcceptanceCapability $READ_ACCEPTANCE_CAPABILITY
  set_interface_property altera_axi_slave writeAcceptanceCapability $WRITE_ACCEPTANCE_CAPABILITY
  set_interface_property altera_axi_slave combinedAcceptanceCapability $COMBINED_ACCEPTANCE_CAPABILITY
  
  set_interface_property altera_axi_master readIssuingCapability $READ_ACCEPTANCE_CAPABILITY
  set_interface_property altera_axi_master writeIssuingCapability $WRITE_ACCEPTANCE_CAPABILITY
  set_interface_property altera_axi_master combinedIssuingCapability $COMBINED_ACCEPTANCE_CAPABILITY

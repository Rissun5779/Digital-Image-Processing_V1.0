...
# +-----------------------------------
# |
# | mgc_axi_master_bfm "MGC AXI Master BFM" 10.4c
...
# | Documentation links
# |
add_documentation_link "AXI Master BFM Reference Guide" https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/ug/mentor-vip-axi34-ae-usr.pdf
# |
# +-----------------------------------
...
proc my_elaborate {} {
  ...
  set_interface_property altera_axi_master readIssuingCapability $READ_ISSUING_CAPABILITY
  set_interface_property altera_axi_master writeIssuingCapability $WRITE_ISSUING_CAPABILITY
  set_interface_property altera_axi_master combinedIssuingCapability $COMBINED_ISSUING_CAPABILITY

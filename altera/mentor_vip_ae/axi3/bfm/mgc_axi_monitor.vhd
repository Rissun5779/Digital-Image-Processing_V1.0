...
--
-- *****************************************************************************
-- dvc           Version: 20140122_Questa_10.2c
-- *****************************************************************************

-- Title: axi_monitor_bfm
--
...
end mgc_axi_monitor_vhd;

architecture monitor_a of mgc_axi_monitor_vhd is

component mgc_axi_monitor
    generic(
            AXI_ADDRESS_WIDTH : integer := 64;
            AXI_RDATA_WIDTH : integer := 1024;
            AXI_WDATA_WIDTH : integer := 1024;
...
begin
  ...
  --  Parallel path 5
  req_p5                                              <= axi_tr_if_5(index).req;
  transaction_id_in_p5                                <= axi_tr_if_5(index).transaction_id;
  value_in0_p5                                        <= axi_tr_if_5(index).value_0;
  value_in1_p5                                        <= axi_tr_if_5(index).value_1;
  value_in2_p5                                        <= axi_tr_if_5(index).value_2;
  value_in3_p5                                        <= axi_tr_if_5(index).value_3;
  value_in_max_p5                                     <= axi_tr_if_5(index).value_max;
  axi_tr_adv_if_local(index)(AXI_PATH_5).ack              <= ack_p5;
  axi_tr_adv_if_local(index)(AXI_PATH_5).transaction_id   <= transaction_id_out_p5;
  axi_tr_adv_if_local(index)(AXI_PATH_5).value_0          <= value_out0_p5;
  axi_tr_adv_if_local(index)(AXI_PATH_5).value_1          <= value_out1_p5;
  axi_tr_adv_if_local(index)(AXI_PATH_5).value_max        <= value_out_max_p5;

  --  Parallel path 6
  req_p6                                              <= axi_tr_if_6(index).req;
  transaction_id_in_p6                                <= axi_tr_if_6(index).transaction_id;
  value_in0_p6                                        <= axi_tr_if_6(index).value_0;
  value_in1_p6                                        <= axi_tr_if_6(index).value_1;
  value_in2_p6                                        <= axi_tr_if_6(index).value_2;
  value_in3_p6                                        <= axi_tr_if_6(index).value_3;
  value_in_max_p6                                     <= axi_tr_if_6(index).value_max;
  axi_tr_adv_if_local(index)(AXI_PATH_6).ack              <= ack_p6;
  axi_tr_adv_if_local(index)(AXI_PATH_6).transaction_id   <= transaction_id_out_p6;
  axi_tr_adv_if_local(index)(AXI_PATH_6).value_0          <= value_out0_p6;
  axi_tr_adv_if_local(index)(AXI_PATH_6).value_1          <= value_out1_p6;
  axi_tr_adv_if_local(index)(AXI_PATH_6).value_max        <= value_out_max_p6;

  --  Parallel path 7
  req_p7                                              <= axi_tr_if_7(index).req;
  transaction_id_in_p7                                <= axi_tr_if_7(index).transaction_id;
  value_in0_p7                                        <= axi_tr_if_7(index).value_0;
  value_in1_p7                                        <= axi_tr_if_7(index).value_1;
  value_in2_p7                                        <= axi_tr_if_7(index).value_2;
  value_in3_p7                                        <= axi_tr_if_7(index).value_3;
  value_in_max_p7                                     <= axi_tr_if_7(index).value_max;
  axi_tr_adv_if_local(index)(AXI_PATH_7).ack              <= ack_p7;
  axi_tr_adv_if_local(index)(AXI_PATH_7).transaction_id   <= transaction_id_out_p7;
  axi_tr_adv_if_local(index)(AXI_PATH_7).value_0          <= value_out0_p7;
  axi_tr_adv_if_local(index)(AXI_PATH_7).value_1          <= value_out1_p7;
  axi_tr_adv_if_local(index)(AXI_PATH_7).value_max        <= value_out_max_p7;

  -- Instantiation of the SystemVerilog BFM:
  mgc_axi_monitor_inst: mgc_axi_monitor
    generic map(

...
# +-----------------------------------
# |
# | mgc_axi_slave_bfm "MGC AXI Slave BFM" 10.4c
...
# | Documentation links
# |
add_documentation_link "AXI Slave BFM Reference Guide" https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/ug/mentor-vip-axi34-ae-usr.pdf
# |
# +-----------------------------------
...
proc my_elaborate {} {
  ...
  set_interface_property altera_axi_slave readDataReorderingDepth $READ_DATA_REORDERING_DEPTH

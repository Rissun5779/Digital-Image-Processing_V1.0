...
module top ();
    ...
    mgc_axi_master #(.AXI_ADDRESS_WIDTH(AXI_ADDRESS_WIDTH), .AXI_RDATA_WIDTH(AXI_RDATA_WIDTH), .AXI_WDATA_WIDTH(AXI_WDATA_WIDTH), .AXI_ID_WIDTH(AXI_ID_WIDTH), .READ_ISSUING_CAPABILITY(READ_ISSUING_CAPABILITY), .WRITE_ISSUING_CAPABILITY(WRITE_ISSUING_CAPABILITY), .COMBINED_ISSUING_CAPABILITY(COMBINED_ISSUING_CAPABILITY)) bfm_master
    (
    ...
    mgc_axi_slave #(.AXI_ADDRESS_WIDTH(AXI_ADDRESS_WIDTH), .AXI_RDATA_WIDTH(AXI_RDATA_WIDTH), .AXI_WDATA_WIDTH(AXI_WDATA_WIDTH), .AXI_ID_WIDTH(AXI_ID_WIDTH), .READ_ACCEPTANCE_CAPABILITY(READ_ACCEPTANCE_CAPABILITY), .WRITE_ACCEPTANCE_CAPABILITY(WRITE_ACCEPTANCE_CAPABILITY), .COMBINED_ACCEPTANCE_CAPABILITY(COMBINED_ACCEPTANCE_CAPABILITY), .READ_DATA_REORDERING_DEPTH(READ_DATA_REORDERING_DEPTH)) bfm_slave
    (
        .ACLK(ACLK), .ARESETn(ARESETn), 
        .AWVALID(AWVALID), .AWADDR(AWADDR), .AWLEN(AWLEN), .AWSIZE(AWSIZE), .AWBURST(AWBURST), .AWLOCK(AWLOCK), .AWCACHE(AWCACHE), .AWPROT(AWPROT), .AWID(AWID), .AWREADY(AWREADY), .AWUSER(AWUSER),
        .ARVALID(ARVALID), .ARADDR(ARADDR), .ARLEN(ARLEN), .ARSIZE(ARSIZE), .ARBURST(ARBURST), .ARLOCK(ARLOCK), .ARCACHE(ARCACHE), .ARPROT(ARPROT), .ARID(ARID), .ARREADY(ARREADY), .ARUSER(ARUSER),
    ...
    mgc_axi_monitor #(.AXI_ADDRESS_WIDTH(AXI_ADDRESS_WIDTH), .AXI_RDATA_WIDTH(AXI_RDATA_WIDTH), .AXI_WDATA_WIDTH(AXI_WDATA_WIDTH), .AXI_ID_WIDTH(AXI_ID_WIDTH), .READ_ACCEPTANCE_CAPABILITY(READ_ACCEPTANCE_CAPABILITY), .WRITE_ACCEPTANCE_CAPABILITY(WRITE_ACCEPTANCE_CAPABILITY), .COMBINED_ACCEPTANCE_CAPABILITY(COMBINED_ACCEPTANCE_CAPABILITY)) bfm_monitor
    (
        .ACLK(ACLK), .ARESETn(ARESETn), 
        .AWVALID(AWVALID), .AWADDR(AWADDR), .AWLEN(AWLEN), .AWSIZE(AWSIZE), .AWBURST(AWBURST), .AWLOCK(AWLOCK), .AWCACHE(AWCACHE), .AWPROT(AWPROT), .AWID(AWID), .AWREADY(AWREADY), .AWUSER(AWUSER),
        .ARVALID(ARVALID), .ARADDR(ARADDR), .ARLEN(ARLEN), .ARSIZE(ARSIZE), .ARBURST(ARBURST), .ARLOCK(ARLOCK), .ARCACHE(ARCACHE), .ARPROT(ARPROT), .ARID(ARID), .ARREADY(ARREADY), .ARUSER(ARUSER),

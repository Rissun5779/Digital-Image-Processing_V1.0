...
# Create a new driver
create_driver altera_epcq_controller2_driver

# Associate it with some hardware known as "altera_epcq_controller"
set_sw_property hw_class_name altera_epcq_controller2
...
# Header files
add_sw_property include_source HAL/inc/altera_epcq_controller2.h
add_sw_property include_source inc/altera_epcq_controller2_regs.h

# C/C++ source files
add_sw_property c_source HAL/src/altera_epcq_controller2.c

...
# $Id: //acds/rel/18.1std/ip/pgm/altera_s10_mailbox_pro_client_lite/altera_s10_mailbox_pro_client_lite_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
# 
# \altera_s10_mailbox_pro_client_lite "Altera Config Debug Agent Bridge" v100.99.98.97
#  2016.04.03.15:59:28
# 
# 
...
set_module_property NAME altera_s10_mailbox_pro_client_lite
set_module_property VERSION 18.1
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Basic Functions/Configuration and Programming"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME "Altera S10 Mailbox Programmable Header Input Argument"
...
set_parameter_property CMD_WIDTH DISPLAY_NAME "Number Channels - Width of cmd_data, one-hot coding"
...
add_parameter NUMB_ARG INTEGER 1
set_parameter_property NUMB_ARG DISPLAY_NAME "Number Argument - of SDM command packet"
set_parameter_property NUMB_ARG AFFECTS_ELABORATION true
set_parameter_property NUMB_ARG AFFECTS_GENERATION true
set_parameter_property NUMB_ARG HDL_PARAMETER true
set_parameter_property NUMB_ARG VISIBLE true
...
source altera_s10_mailbox_pro_client_lite_ui.tcl
...
add_interface_port cmd cmd_startofpacket startofpacket Input 1
add_interface_port cmd cmd_endofpacket endofpacket Input 1
...
proc synth_callback_procedure { entity_name } {
    ...
    set template_file [ file join $this_dir "altera_s10_mailbox_pro_client_lite.sv.terp" ]
...
proc validate {} {
    ...
    for {set i 0} {$i < 1} {incr i} {
        #Edit from the Programmable client IP which supports 16
        ...
        lappend id_list         [ get_parameter_value ID_$i ]
        ...
        set id($i)               [dec2bin [ get_parameter_value ID_$i ] 4]
    ...
    for {set k 0} {$k < $num_command} {incr k} {
        ...
        if  {$this_cmd_length == 0} {
            lappend edited_cmd_info 32'b[lindex $this_cmd_detail 0]
        } else {
            for {set l 0} {$l < $numb_words_in_this_cmd} {incr l} {
                ...
                if {$l == 0} {
                    lappend edited_cmd_info 32'b[lindex $this_cmd_detail $l]
                } elseif {$l == [expr $numb_words_in_this_cmd - 1]} {
                    lappend edited_cmd_info 32'h$zeropad[lindex $this_cmd_detail $l]
                } else {
                    lappend edited_cmd_info 32'h$zeropad[lindex $this_cmd_detail $l]
                }
            }
...
proc elaborate {} {
    ...
    set numb_args  [get_parameter_value NUMB_ARG]
    if {$numb_args == 1} {
        set_port_property cmd_startofpacket termination true
        set_port_property cmd_startofpacket termination_value 0x1
        set_port_property cmd_endofpacket termination true
        set_port_property cmd_endofpacket termination_value 0x1
    }

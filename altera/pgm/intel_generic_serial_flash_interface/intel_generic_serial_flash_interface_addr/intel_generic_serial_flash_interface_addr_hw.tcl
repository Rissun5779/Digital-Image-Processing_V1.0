...
# 
set_module_property NAME intel_generic_serial_flash_interface_addr
...
set_fileset_property synthesis_fileset TOP_LEVEL intel_generic_serial_flash_interface_addr 
add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL intel_generic_serial_flash_interface_addr
add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL intel_generic_serial_flash_interface_addr

proc synth_callback_procedure { entity_name } {
    add_fileset_file intel_generic_serial_flash_interface_addr.sv SYSTEM_VERILOG PATH "intel_generic_serial_flash_interface_addr.sv"
}
...
set_interface_assignment avl_mem embeddedsw.configuration.isNonVolatileStorage true

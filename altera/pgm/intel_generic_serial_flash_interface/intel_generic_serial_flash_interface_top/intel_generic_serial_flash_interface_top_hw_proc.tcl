...
# +-----------------------------------
# | 
# | $Header: //acds/rel/18.1std/ip/pgm/intel_generic_serial_flash_interface/intel_generic_serial_flash_interface_top/intel_generic_serial_flash_interface_top_hw_proc.tcl#1 $
# | 
# +-----------------------------------
...
proc compose { } {
    ...
    add_instance csr_controller intel_generic_serial_flash_interface_csr 18.1
    ...
    add_instance xip_controller intel_generic_serial_flash_interface_xip 18.1

    add_instance xip_addr_adaption intel_generic_serial_flash_interface_addr 18.1
    ...
    add_instance merlin_demultiplexer_0 altera_merlin_demultiplexer 18.1
    ...
    add_instance multiplexer altera_merlin_multiplexer 18.1
    ...
    if {$pipe_csr == 1} {
        add_instance csr_ctrl_pipeline altera_avalon_st_pipeline_stage 18.1
    ...
    if {$pipe_xip == 1} {
        add_instance xip_ctrl_pipeline altera_avalon_st_pipeline_stage 18.1
...
switch $debug_option {
    0 {
        ...
        if {$pipe_cmd_gen_cmd ==1} {
            add_instance cmd_gen_pipe_cmd altera_avalon_st_pipeline_stage 18.1
        ...
        if {$pipe_mux_cmd ==1} {
            add_instance mux_output_pipe altera_avalon_st_pipeline_stage 18.1

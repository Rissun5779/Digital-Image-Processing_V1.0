...
# $Id: //acds/rel/18.1std/ip/pgm/altera_s10_voltage_sensor/altera_s10_voltage_sensor_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
...
set_module_property NAME altera_s10_voltage_sensor
set_module_property VERSION 18.1
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Basic Functions/Configuration and Programming"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME "Altera S10 Voltage Sensor"
...
# parameters
# 
add_parameter CMD_WIDTH INTEGER 16
...
add_parameter           CLIENT  INTEGER             0
...
add_parameter           COMMAND_CODE  INTEGER             24
...
set_fileset_property synthesis_fileset TOP_LEVEL altera_s10_voltage_sensor 
add_fileset simulation_fileset SIM_VERILOG synth_callback_procedure
set_fileset_property simulation_fileset TOP_LEVEL altera_s10_voltage_sensor
add_fileset vhdl_fileset SIM_VHDL synth_callback_procedure
set_fileset_property vhdl_fileset TOP_LEVEL altera_s10_voltage_sensor

proc synth_callback_procedure { entity_name } {
    add_fileset_file altera_s10_voltage_sensor.sv SYSTEM_VERILOG PATH "altera_s10_voltage_sensor.sv"
}

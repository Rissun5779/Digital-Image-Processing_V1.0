...
# +-----------------------------------
# | 
# | $Header: //acds/rel/18.1std/ip/pgm/altera_asmi_parallel2/asmi_top/altera_asmi_parallel2_hw_proc.tcl#1 $
# | 
# +-----------------------------------
...
proc compose { } {
    ...
    add_instance csr_controller altera_asmi2_csr_controller 18.1
    ...
    add_instance xip_controller altera_asmi2_xip_controller 18.1

...
function logic [(FRAME_WIDTH*2)-1:0] FRAME_LUT(
	...
	begin
	  ...
	  else if (frame_in <= 1781) begin framelut_addr_start = 1117; framelut_addr_end = 1781; end
	  else if (frame_in <= 2330) begin framelut_addr_start = 1782; framelut_addr_end = 2330; end
	  else if (frame_in <= 3040) begin framelut_addr_start = 2331; framelut_addr_end = 3040; end
	  else if (frame_in <= 3705) begin framelut_addr_start = 3041; framelut_addr_end = 3705; end
	  else if (frame_in <= 4370) begin framelut_addr_start = 3706; framelut_addr_end = 4370; end
	  else if (frame_in <= 5080) begin framelut_addr_start = 4371; framelut_addr_end = 5080; end
	  else if (frame_in <= 5624) begin framelut_addr_start = 5081; framelut_addr_end = 5624; end
	  else if (frame_in <= 6294) begin framelut_addr_start = 5625; framelut_addr_end = 6294; end
	  else if (frame_in <= 6702) begin framelut_addr_start = 6295; framelut_addr_end = 6702; end
	  else if (frame_in <= 7419) begin framelut_addr_start = 6703; framelut_addr_end = 7419; end

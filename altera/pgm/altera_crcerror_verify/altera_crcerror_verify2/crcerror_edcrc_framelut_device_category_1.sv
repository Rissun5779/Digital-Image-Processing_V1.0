...
function logic [(FRAME_WIDTH*2)-1:0] FRAME_LUT(
	...
	begin
	  ...
	  else if (frame_in <= 1827) begin framelut_addr_start =  754; framelut_addr_end = 1827; end
	  else if (frame_in <= 2497) begin framelut_addr_start = 1828; framelut_addr_end = 2497; end
	  else if (frame_in <= 3207) begin framelut_addr_start = 2498; framelut_addr_end = 3207; end
	  else if (frame_in <= 3872) begin framelut_addr_start = 3208; framelut_addr_end = 3872; end
	  else if (frame_in <= 4537) begin framelut_addr_start = 3873; framelut_addr_end = 4537; end
	  else if (frame_in <= 5247) begin framelut_addr_start = 4538; framelut_addr_end = 5247; end
	  else if (frame_in <= 5912) begin framelut_addr_start = 5248; framelut_addr_end = 5912; end
	  else if (frame_in <= 6991) begin framelut_addr_start = 5913; framelut_addr_end = 6991; end
	  else if (frame_in <= 7753) begin framelut_addr_start = 6992; framelut_addr_end = 7753; end

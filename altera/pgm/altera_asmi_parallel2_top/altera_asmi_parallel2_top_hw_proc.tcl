...
# +-----------------------------------
# | 
# $Id: //acds/rel/18.1std/ip/pgm/altera_asmi_parallel2_top/altera_asmi_parallel2_top_hw_proc.tcl#1 $
# $Revision: #1 $
# $Date: 2018/07/18 $
# $Author: psgswbuild $
# | 
...
proc compose { } {
    ...
    add_instance clk_asmi2_core clock_source 18.1
    ...
    add_instance asmi2_core altera_asmi_parallel2 18.1
    ...
    add_instance asmi2_addr_adaption avl_mem_addr_adaption 18.1

...
end entity altera_pfl2_pgm_sm;

architecture structure of altera_pfl2_pgm_sm is
...
--	signal scfifo_usedw			: STD_LOGIC_VECTOR(log2(FIFO_SIZE)-1 downto 0);
	...
	component altera_pfl2_pgm_status_register
		PORT
		(
			enable			: IN STD_LOGIC ;
			clk				: in STD_LOGIC;
...
--			usedw	: OUT STD_LOGIC_VECTOR (lpm_widthu-1 DOWNTO 0);
	...
	component altera_pfl2_pgm_fifo_sm
		generic
		(
			DATA_WIDTH			: natural	:= 16;
			ADDR_WIDTH			: natural	:= 20;
	...
	component altera_pfl2_pgm_flash_sm
		generic 
		(
...
begin
	...
	status_reg : altera_pfl2_pgm_status_register
		PORT MAP (
...
--			usedw		=> scfifo_usedw,
	...
	fifo_sm : altera_pfl2_pgm_fifo_sm
		generic map
		(
	...
	flash_sm : altera_pfl2_pgm_flash_sm
		generic map
		(
			ADDR_WIDTH		=> ADDR_WIDTH,
			DATA_WIDTH		=> DATA_WIDTH

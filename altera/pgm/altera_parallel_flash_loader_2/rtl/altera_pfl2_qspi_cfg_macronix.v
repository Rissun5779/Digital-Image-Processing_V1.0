...
module altera_pfl2_qspi_cfg_macronix
(
	// FPGA IOs
	nreset,
	clk,
	...
	always @ (posedge clk or negedge nreset) begin
		...
		else if (current_state == BURST_WAIT) begin
	...
	always @ (posedge clk) begin
		...
		if (~data_request || current_state == BURST_INIT || current_state == BURST_WAIT) begin
			ncs = 1'b1;
			scking = 1'b0;
			shiftin = 1'b1;
			counter_data = 5'd6;
	...
	assign wait_done = static_wait_count_q[FLASH_STATIC_WAIT_WIDTH-1];

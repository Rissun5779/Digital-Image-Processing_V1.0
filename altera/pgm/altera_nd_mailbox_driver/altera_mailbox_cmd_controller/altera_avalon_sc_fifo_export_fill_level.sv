...
// light version from Avalon-ST FIFO
// -----------------------------------------------------------
...
module altera_avalon_sc_fifo_export_fill_level
#(
    // --------------------------------------------------
    // Parameters
    // --------------------------------------------------
...
(
    ...
    output  [ADDR_WIDTH : 0]    out_fifo_fill_level 
);
    ...
    // is enabled.
    // --------------------------------------------------
    assign out_fifo_fill_level = fill_level;

...
#
# altera_avalon_i2c_sw.tcl
#

# Create a new driver
create_driver altera_avalon_i2c_driver

# Associate it with some hardware known as "modular_sgdma_dispatcher"
set_sw_property hw_class_name altera_avalon_i2c 
...
set_sw_property min_compatible_hw_version 16.0
...
# C/C++ source files
add_sw_property c_source HAL/src/altera_avalon_i2c.c

# Include files
add_sw_property include_source HAL/inc/altera_avalon_i2c.h
add_sw_property include_source inc/altera_avalon_i2c_regs.h

...
# | $Header: //acds/rel/18.1std/ip/altera_pcie_pipe/xcvr_generic/altera_xcvr_pipe_hw.tcl#1 $
# | 
# +-----------------------------------
...
set_module_property DISPLAY_NAME "PHY for PCI Express (PIPE) Intel FPGA IP" 
...
set_module_property SUPPORTED_DEVICE_FAMILIES {{Stratix V} {Arria V} {Cyclone V}} 
# | 
# +-----------------------------------
...
#{PLAIN MENTOR MSIM_SCRIPT}
	} elseif {[::alt_xcvr::utils::device::has_a5_style_hssi $device_family] || [::alt_xcvr::utils::device::has_c5_style_hssi $device_family]} {
		common_add_fileset_files {A5 C5 ALL_HDL ALL_SIM ALTERA_XCVR_RESET_CONTROL ALT_XCVR_CSR} [concat PLAIN [common_fileset_tags_all_simulators] ] 
#{PLAIN MENTOR MSIM_SCRIPT}
	}
}
...
proc generate_synth {name} {
	...
	if {[::alt_xcvr::utils::device::has_s5_style_hssi $device_family]} {
		...
		common_add_fileset_files {A5 C5 ALL_HDL ALTERA_XCVR_RESET_CONTROL ALT_XCVR_CSR} {PLAIN QIP}
	}
}

...
# | 
set_module_property NAME alt_ntrlkn_hsio_bank_bpcs_3g
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property DISPLAY_NAME alt_ntrlkn_hsio_bank_bpcs_3g
set_module_property TOP_LEVEL_HDL_FILE alt_ntrlkn_hsio_bank_bpcs_3g.v
set_module_property TOP_LEVEL_HDL_MODULE alt_ntrlkn_hsio_bank_bpcs_3g
set_module_property STATIC_TOP_LEVEL_MODULE_NAME alt_ntrlkn_hsio_bank_bpcs_3g
set_module_property EDITABLE false
set_module_property ANALYZE_HDL false
set_module_property AUTHOR "Altera Corporation"
set_module_property DESCRIPTION "Altera Interlaken HSIO Bank 3G"

# add_fileset synth2 QUARTUS_SYNTH generate_synth
# set_fileset_property synth2 TOP_LEVEL alt_ntrlkn_hsio_bank_bpcs_3g

add_fileset simulation_verilog SIM_VERILOG sim_ver
set_fileset_property simulation_verilog TOP_LEVEL alt_ntrlkn_hsio_bank_bpcs_3g
...
# +----------------------------------
# | 
add_file alt_ntrlkn_gxb_bpcs_3g.v {SYNTHESIS}
add_file alt_ntrlkn_reconfig_bpcs_3g.v {SYNTHESIS}
add_file alt_ntrlkn_frequency_monitor_bpcs_3g.v {SYNTHESIS}
add_file alt_ntrlkn_hsio_bank_bpcs_3g.v {SYNTHESIS}
set hsio_files {"alt_ntrlkn_gxb_bpcs_3g.v" "alt_ntrlkn_reconfig_bpcs_3g.v" "alt_ntrlkn_frequency_monitor_bpcs_3g.v" "alt_ntrlkn_hsio_bank_bpcs_3g.v"}

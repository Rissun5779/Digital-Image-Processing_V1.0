...
# | 
set_module_property NAME alt_ntrlkn_hsio_bank_pmad5
set_module_property VERSION 18.1
set_module_property INTERNAL true 
set_module_property DISPLAY_NAME alt_ntrlkn_hsio_bank_pmad5
set_module_property TOP_LEVEL_HDL_FILE alt_ntrlkn_hsio_bank_pmad5.v
set_module_property TOP_LEVEL_HDL_MODULE alt_ntrlkn_hsio_bank_pmad5
set_module_property STATIC_TOP_LEVEL_MODULE_NAME alt_ntrlkn_hsio_bank_pmad5
...
# set_fileset_property synth2 TOP_LEVEL alt_ntrlkn_hsio_bank_pmad5

add_fileset simulation_verilog SIM_VERILOG sim_ver
set_fileset_property simulation_verilog TOP_LEVEL alt_ntrlkn_hsio_bank_pmad5
...
# +----------------------------------
# | 
add_file alt_ntrlkn_gxb_pmad5.v {SYNTHESIS}
add_file alt_ntrlkn_pma_fifo_pmad5.v {SYNTHESIS}
add_file alt_ntrlkn_reconfig_pmad5.v {SYNTHESIS}
add_file alt_ntrlkn_frequency_monitor_pmad5.v {SYNTHESIS}
add_file alt_ntrlkn_hsio_bank_pmad5.v {SYNTHESIS}

set hsio_files {"alt_ntrlkn_gxb_pmad5.v" "alt_ntrlkn_reconfig_pmad5.v" "alt_ntrlkn_pma_fifo_pmad5.v" "alt_ntrlkn_frequency_monitor_pmad5.v"  "alt_ntrlkn_hsio_bank_pmad5.v"}
...
add_parameter LANES INTEGER 5
set_parameter_property LANES ALLOWED_RANGES {5}

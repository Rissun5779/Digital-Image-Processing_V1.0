...
# | 
set_module_property NAME alt_ntrlkn_8l_6g
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property DISPLAY_NAME altera_interlaken_8lane_6g
set_module_property TOP_LEVEL_HDL_FILE alt_ntrlkn_8l_6g_xcvr_8lane.v
set_module_property TOP_LEVEL_HDL_MODULE alt_ntrlkn_8l_6g_xcvr_8lane
set_module_property STATIC_TOP_LEVEL_MODULE_NAME alt_ntrlkn_8l_6g_xcvr_8lane
...
#set_fileset_property synth2 TOP_LEVEL alt_ntrlkn_8l_6g_xcvr_8lane

add_fileset simulation_verilog SIM_VERILOG sim_ver
set_fileset_property simulation_verilog TOP_LEVEL alt_ntrlkn_8l_6g_xcvr_8lane
#+-----------------------------------
#|
#| files
add_file alt_ntrlkn_8l_6g_align_dcf.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_align_fifo.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_alignment_pipe.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_arbiter.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_avalon_to_ilk_adapter_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_buffer_1_to_2.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_buffer_2_to_1.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_buffered_read_scheduler_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_channel_fifo.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_compact_words_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_dat64.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_dat64_factor.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_dat64_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_dat64_only_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_multiple_upto2.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_multiple_upto3.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_multiple_upto4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_multiple_upto5.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_zer64_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_zer64x10_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_zer64x2_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_zer64x3_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_zer64x4_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc24_zer64x5_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_dat64.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_dat64_factor.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_dat64_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_dat64_only.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_dat64_only_factor.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_dat64_only_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_zer64.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_zer64_factor.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_crc32c_zer64_flat.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_dec_67_64.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_enc_64_67.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_fifo_36_to_72.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_fifo_72_to_36.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_frame_sync_control.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_gearbox_20_67.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_gearbox_67_20.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lal_cfifo.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lal_dcfifo.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lal_dfifo_auto.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lane_alignment.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lane_alignment_nav.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lane_alignment_ram.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lane_rx.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lane_rx_crc.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lane_status_monitor.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lane_tx.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_lane_tx_crc.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_packet_annotate.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_packet_regroup_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_pipelined_any_flag.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_ram_navigate.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_read_calendar_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_read_calendar_single_page_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_read_scheduler_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_ready_skid.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_regroup_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_routing_pipe.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_rx_8lane.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_rx_buffer_fifo_2.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_rx_channel_filter_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_rx_crc24_check_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_rx_datapath_8lane.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_rx_stripe_adapter.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_scrambler_lfsr.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_sim_packet_client.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_six_three_comp.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_sum_of_3bit_pair.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_synchronizer.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_ternary_add.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_twelve_four_comp.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_2channel_arbiter.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_4channel_arbiter.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_8lane.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_buffer_fifo_8word.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_buffer_fifo_nav.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_buffer_fifo_ram.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_buffer_fifo_ram_loose.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_control_insertion_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_crc24_insertion_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_datapath_8lane.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_flow_adapter.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_tx_stripe_adapter.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_wide_word_ram.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_wide_word_ram_4.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_word_align_control.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_xcvr_8lane.v {SYNTHESIS}
add_file alt_ntrlkn_8l_6g_xor6.v {SYNTHESIS}
add_file ../alt_interlaken_sdc_files/alt_ntrlkn_8l_6g.sdc {SDC}
...
set_parameter_property LANES ALLOWED_RANGES {8}
...
#cannot pass GUI parameter to RTL, therefore had to derive a new one
...
proc add_interfaces {} {
	...
	send_message error "Number of lanes should be 8"
    }
...
proc add_avln_iface {name type assc_clk is_enabled dir width sym_per_beat} {
 ...
 set unencrypted_files {"alt_ntrlkn_8l_6g_crc32c_dat64_factor.v" "alt_ntrlkn_8l_6g_crc32c_dat64_flat.v" "alt_ntrlkn_8l_6g_crc32c_dat64_only_factor.v"	"alt_ntrlkn_8l_6g_crc32c_dat64_only_flat.v" "alt_ntrlkn_8l_6g_crc32c_dat64_only.v" "alt_ntrlkn_8l_6g_crc32c_dat64.v" "alt_ntrlkn_8l_6g_crc32c_zer64_factor.v" "alt_ntrlkn_8l_6g_crc32c_zer64_flat.v" "alt_ntrlkn_8l_6g_crc32c_zer64.v" "alt_ntrlkn_8l_6g_arbiter.v" "alt_ntrlkn_8l_6g_buffered_read_scheduler_4.v" "alt_ntrlkn_8l_6g_lane_status_monitor.v" "alt_ntrlkn_8l_6g_packet_annotate.v" "alt_ntrlkn_8l_6g_read_scheduler_4.v" "alt_ntrlkn_8l_6g_ready_skid.v" "alt_ntrlkn_8l_6g_tx_2channel_arbiter.v" "alt_ntrlkn_8l_6g_tx_4channel_arbiter.v" "alt_ntrlkn_8l_6g_avalon_to_ilk_adapter_4.v" "alt_ntrlkn_8l_6g_compact_words_4.v" "alt_ntrlkn_8l_6g_crc24_dat64_factor.v" "alt_ntrlkn_8l_6g_crc24_dat64_flat.v" "alt_ntrlkn_8l_6g_crc24_dat64_only_flat.v" "alt_ntrlkn_8l_6g_crc24_dat64.v" "alt_ntrlkn_8l_6g_crc24_multiple_upto2.v" "alt_ntrlkn_8l_6g_crc24_multiple_upto3.v" "alt_ntrlkn_8l_6g_crc24_multiple_upto4.v" "alt_ntrlkn_8l_6g_crc24_multiple_upto5.v" "alt_ntrlkn_8l_6g_crc24_zer64_flat.v" "alt_ntrlkn_8l_6g_crc24_zer64x10_flat.v" "alt_ntrlkn_8l_6g_crc24_zer64x2_flat.v" "alt_ntrlkn_8l_6g_crc24_zer64x3_flat.v" "alt_ntrlkn_8l_6g_crc24_zer64x4_flat.v" "alt_ntrlkn_8l_6g_crc24_zer64x5_flat.v"	"alt_ntrlkn_8l_6g_packet_regroup_4.v" "alt_ntrlkn_8l_6g_regroup_4.v" "alt_ntrlkn_8l_6g_rx_channel_filter_4.v" "alt_ntrlkn_8l_6g_wide_word_ram_4.v" "alt_ntrlkn_8l_6g_rx_8lane.v" "alt_ntrlkn_8l_6g_tx_8lane.v" "alt_ntrlkn_8l_6g_xcvr_8lane.v"}

 set encrypted_files { "alt_ntrlkn_8l_6g_align_dcf.v" "alt_ntrlkn_8l_6g_align_fifo.v" "alt_ntrlkn_8l_6g_alignment_pipe.v" "alt_ntrlkn_8l_6g_buffer_1_to_2.v" "alt_ntrlkn_8l_6g_buffer_2_to_1.v" "alt_ntrlkn_8l_6g_channel_fifo.v" "alt_ntrlkn_8l_6g_dec_67_64.v" "alt_ntrlkn_8l_6g_enc_64_67.v" "alt_ntrlkn_8l_6g_fifo_36_to_72.v" "alt_ntrlkn_8l_6g_fifo_72_to_36.v" "alt_ntrlkn_8l_6g_frame_sync_control.v" "alt_ntrlkn_8l_6g_gearbox_20_67.v" "alt_ntrlkn_8l_6g_gearbox_67_20.v" "alt_ntrlkn_8l_6g_lal_cfifo.v" "alt_ntrlkn_8l_6g_lal_dcfifo.v" "alt_ntrlkn_8l_6g_lal_dfifo_auto.v" "alt_ntrlkn_8l_6g_lane_alignment.v" "alt_ntrlkn_8l_6g_lane_alignment_nav.v" "alt_ntrlkn_8l_6g_lane_alignment_ram.v" "alt_ntrlkn_8l_6g_lane_rx.v" "alt_ntrlkn_8l_6g_lane_rx_crc.v" "alt_ntrlkn_8l_6g_lane_tx.v" "alt_ntrlkn_8l_6g_lane_tx_crc.v" "alt_ntrlkn_8l_6g_pipelined_any_flag.v" "alt_ntrlkn_8l_6g_ram_navigate.v" "alt_ntrlkn_8l_6g_read_calendar_4.v" "alt_ntrlkn_8l_6g_read_calendar_single_page_4.v"  "alt_ntrlkn_8l_6g_routing_pipe.v" "alt_ntrlkn_8l_6g_rx_buffer_fifo_2.v" "alt_ntrlkn_8l_6g_rx_crc24_check_4.v" "alt_ntrlkn_8l_6g_rx_datapath_8lane.v" "alt_ntrlkn_8l_6g_rx_stripe_adapter.v" "alt_ntrlkn_8l_6g_scrambler_lfsr.v" "alt_ntrlkn_8l_6g_sim_packet_client.v" "alt_ntrlkn_8l_6g_six_three_comp.v" "alt_ntrlkn_8l_6g_sum_of_3bit_pair.v" "alt_ntrlkn_8l_6g_synchronizer.v" "alt_ntrlkn_8l_6g_ternary_add.v" "alt_ntrlkn_8l_6g_twelve_four_comp.v" "alt_ntrlkn_8l_6g_tx_buffer_fifo_8word.v" "alt_ntrlkn_8l_6g_tx_buffer_fifo_nav.v" "alt_ntrlkn_8l_6g_tx_buffer_fifo_ram.v" "alt_ntrlkn_8l_6g_tx_buffer_fifo_ram_loose.v" "alt_ntrlkn_8l_6g_tx_control_insertion_4.v" "alt_ntrlkn_8l_6g_tx_crc24_insertion_4.v" "alt_ntrlkn_8l_6g_tx_datapath_8lane.v" "alt_ntrlkn_8l_6g_tx_flow_adapter.v" "alt_ntrlkn_8l_6g_tx_stripe_adapter.v" "alt_ntrlkn_8l_6g_wide_word_ram.v"  "alt_ntrlkn_8l_6g_word_align_control.v"  "alt_ntrlkn_8l_6g_xor6.v"}

...
set_module_property DISPLAY_NAME "Write Master Intel FPGA IP"
...
add_fileset_file write_master.v VERILOG PATH write_master.v TOP_LEVEL_FILE
add_fileset_file byte_enable_generator.v VERILOG PATH byte_enable_generator.v 
add_fileset_file ST_to_MM_Adapter.v VERILOG PATH ST_to_MM_Adapter.v 
add_fileset_file write_burst_control.v VERILOG PATH write_burst_control.v 

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL write_master
...
set_fileset_property SIM_VHDL TOP_LEVEL write_master

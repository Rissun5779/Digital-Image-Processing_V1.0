...
proc add_module_parametersNENC {} {
add_parameter NENC STRING "Up to 255"
set_parameter_property NENC DISPLAY_NAME "Number of symbols per codeword"
set_parameter_property NENC ENABLED true
set_parameter_property NENC UNITS None
set_parameter_property NENC DESCRIPTION "The number of symbols per codeword is controlled asserting sop/eop"
set_parameter_property NENC DERIVED true
}
...
set_parameter_property CHECK DESCRIPTION "Number of check symbols per codeword"
...
set_parameter_property GENSTART DISPLAY_NAME "First root of the generator polynomial"
set_parameter_property GENSTART ENABLED true
set_parameter_property GENSTART DESCRIPTION "Exponent of first root of the generator polynomial"
set_parameter_property GENSTART HDL_PARAMETER true

add_parameter ROOTSPACE INTEGER 1
set_parameter_property ROOTSPACE DISPLAY_NAME "Root spacing in the generator polynomial"
set_parameter_property ROOTSPACE ENABLED true
set_parameter_property ROOTSPACE DESCRIPTION "Spacing between roots in the generator polynomial"
...
set_parameter_property ERASURE DESCRIPTION "Decoder supports erasure correction"
...
set_parameter_property ERASURE GROUP "Options"
}

# =========  VARIABLE ENCODING ===========#

proc add_module_parametersVARN {} {
add_parameter VARN INTEGER 0
set_parameter_property VARN DISPLAY_NAME "Variable codeword length"
set_parameter_property VARN DESCRIPTION "Decoder supports variable codeword sizes."
set_parameter_property VARN DISPLAY_HINT boolean
set_parameter_property VARN HDL_PARAMETER true
set_parameter_property VARN LONG_DESCRIPTION "<html> The codeword length of each codeword
can be changed using either the signal numn or the signals sop/eop.
</html>"
set_parameter_property VARN GROUP "Options"
}

proc add_module_parametersUSENUMN {} {
add_parameter USENUMN INTEGER 0
set_parameter_property USENUMN DISPLAY_NAME "           - controlled by "
set_parameter_property USENUMN DESCRIPTION "Select how to pass the codeword length to the core"
set_parameter_property USENUMN ALLOWED_RANGES {"0:sop/eop signals" "1:in_numn signal"}
set_parameter_property USENUMN HDL_PARAMETER true
set_parameter_property USENUMN GROUP "Options"
}

proc add_module_parametersOPTIMIZE_LATENCY {} {
add_parameter OPTIMIZE_LATENCY INTEGER 0
set_parameter_property OPTIMIZE_LATENCY DISPLAY_NAME "           - optimize "
set_parameter_property OPTIMIZE_LATENCY DESCRIPTION "when you select optimize resource, the latency always corresponds to that of the largest possible codeword"
set_parameter_property OPTIMIZE_LATENCY ALLOWED_RANGES {"0:resource" "1:latency"}
set_parameter_property OPTIMIZE_LATENCY HDL_PARAMETER true
set_parameter_property OPTIMIZE_LATENCY GROUP "Options"
}

proc add_module_parametersOPTIONS_DISPLAY {} {
add_parameter ERASURE_ENC INTEGER 0
set_parameter_property ERASURE_ENC DISPLAY_NAME "Erasures-supporting decoder"
set_parameter_property ERASURE_ENC DESCRIPTION "Decoder supports erasure correction"
set_parameter_property ERASURE_ENC DISPLAY_HINT boolean
set_parameter_property ERASURE_ENC ENABLED false
set_parameter_property ERASURE_ENC GROUP "Options"

add_parameter USENUMN_DISPLAY INTEGER 0
set_parameter_property USENUMN_DISPLAY DISPLAY_NAME "           - controlled by "
set_parameter_property USENUMN_DISPLAY DESCRIPTION "Codeword length must be controlled using the in_numn signal"
set_parameter_property USENUMN_DISPLAY ALLOWED_RANGES {"0:in_numn signal"  "1:in_numn signal"}
set_parameter_property USENUMN_DISPLAY HDL_PARAMETER false
set_parameter_property USENUMN_DISPLAY ENABLED false
set_parameter_property USENUMN_DISPLAY GROUP "Options"

add_parameter VARN_ENC INTEGER 1
set_parameter_property VARN_ENC DISPLAY_NAME "Variable codeword length"
set_parameter_property VARN_ENC DESCRIPTION "Encoder variable codeword size is naturally controlled by sop/eop"
set_parameter_property VARN_ENC DISPLAY_HINT boolean
set_parameter_property VARN_ENC ENABLED false
set_parameter_property VARN_ENC GROUP "Options"
}



proc add_module_parametersVARCHECK {} {
add_parameter VARCHECK INTEGER 0
set_parameter_property VARCHECK DISPLAY_NAME "Variable number of check symbols"
set_parameter_property VARCHECK DESCRIPTION "Encoder or Decoder supports variable number of check symbols"
set_parameter_property VARCHECK DISPLAY_HINT boolean
set_parameter_property VARCHECK HDL_PARAMETER true
set_parameter_property VARCHECK LONG_DESCRIPTION "The number of check symbols
is controlled using the signal numcheck."
set_parameter_property VARCHECK GROUP "Options"
}

proc add_module_parametersMINN {} {
add_parameter MIN_N INTEGER 3
set_parameter_property MIN_N DISPLAY_NAME "Minimun N value"
set_parameter_property MIN_N DESCRIPTION "(Optional) Minimun N value"
set_parameter_property MIN_N HDL_PARAMETER true
set_parameter_property MIN_N GROUP "Variable Parameter Options"
}

proc add_module_parametersBMADVANCEDPARAM {} {
add_parameter USEROM INTEGER 0
set_parameter_property USEROM DISPLAY_NAME "Use ROM"
set_parameter_property USEROM DESCRIPTION "when you select optimize latency, you can chose wether to use ROM to implement the additional resource"
set_parameter_property USEROM ALLOWED_RANGES {0:No 1:Yes}
set_parameter_property USEROM HDL_PARAMETER true
set_parameter_property USEROM GROUP "Variable Parameter Options"

add_parameter BMFIXEDLATENCY INTEGER 1
set_parameter_property BMFIXEDLATENCY DISPLAY_NAME "BM module latency"
set_parameter_property BMFIXEDLATENCY DESCRIPTION "Latency of the BM module is function of the number of error in the decoded codeword. By selecting fixed latency, the latency become function of only the number of check symbols."
set_parameter_property BMFIXEDLATENCY ALLOWED_RANGES {0:Variable 1:Fixed}
set_parameter_property BMFIXEDLATENCY HDL_PARAMETER true
set_parameter_property BMFIXEDLATENCY GROUP "Advanced Options"
}

proc add_module_parametersMINCHECK {} {
add_parameter MINCHECK INTEGER 2
set_parameter_property MINCHECK DISPLAY_NAME "Minimun CHECK value"
set_parameter_property MINCHECK DESCRIPTION "(Optional) Minimun CHECK value"
set_parameter_property MINCHECK HDL_PARAMETER true
set_parameter_property MINCHECK GROUP "Variable Parameter Options"
}

proc add_module_parametersEVENCHECK {} {
add_parameter EVENCHECK INTEGER 2
set_parameter_property EVENCHECK DISPLAY_NAME "Use even numbers of check symbols"
set_parameter_property EVENCHECK DESCRIPTION "Use only even numbers of check symbols"
set_parameter_property EVENCHECK HDL_PARAMETER true
set_parameter_property EVENCHECK DISPLAY_HINT boolean
set_parameter_property EVENCHECK VISIBLE false
set_parameter_property EVENCHECK GROUP "Variable Parameter Options"
}

# =========  STATUS SIGNALS ===========#
proc add_module_parametersSTATUS_DISPLAY {} {
add_parameter ERRORSYMB_ENC INTEGER 0
set_parameter_property ERRORSYMB_ENC DISPLAY_NAME "Error values"
set_parameter_property ERRORSYMB_ENC DESCRIPTION "Decoder returns the error values of the erroneous symbols"
set_parameter_property ERRORSYMB_ENC DISPLAY_HINT boolean
set_parameter_property ERRORSYMB_ENC ENABLED false
set_parameter_property ERRORSYMB_ENC GROUP "Decoder Status Signals"

add_parameter ERRORSYMBCOUNT_ENC INTEGER 0
set_parameter_property ERRORSYMBCOUNT_ENC DISPLAY_NAME "Error symbol count"
set_parameter_property ERRORSYMBCOUNT_ENC DESCRIPTION "Decoder returns the number of erroneous symbols per codeword"
set_parameter_property ERRORSYMBCOUNT_ENC DISPLAY_HINT boolean
set_parameter_property ERRORSYMBCOUNT_ENC ENABLED false
set_parameter_property ERRORSYMBCOUNT_ENC GROUP "Decoder Status Signals"

add_parameter ERRORBITCOUNT_ENC INTEGER 0
set_parameter_property ERRORBITCOUNT_ENC DISPLAY_NAME "Error bit count"
set_parameter_property ERRORBITCOUNT_ENC DISPLAY_HINT boolean
set_parameter_property ERRORBITCOUNT_ENC ENABLED false
set_parameter_property ERRORBITCOUNT_ENC GROUP "Decoder Status Signals"

}

proc add_module_parametersSTATUS {} {
add_parameter ERRORSYMB INTEGER 0
set_parameter_property ERRORSYMB DISPLAY_NAME "Error values"
set_parameter_property ERRORSYMB DESCRIPTION "Decoder returns the error values of the erroneous symbols"
...
add_parameter ERRORSYMBCOUNT INTEGER 0
...
add_parameter ERRORBITCOUNT INTEGER 0
...
set_parameter_property BITCOUNTTYPE DISPLAY_NAME "     Error bit count format"
...
# =========  DUAL BASIS ===========#
proc add_module_parametersDUAL {} {
add_parameter USEDUALBASIS INTEGER 0
set_parameter_property USEDUALBASIS DISPLAY_NAME "Use Dual basis representation"
set_parameter_property USEDUALBASIS DESCRIPTION "input and output are represented in the trace-orthogonal basis."
set_parameter_property USEDUALBASIS ALLOWED_RANGES {"0:No" "1:Yes"}
set_parameter_property USEDUALBASIS LONG_DESCRIPTION "<html>In the standard representation, elements are represented in the basis {&alpha}={1,&alpha,&alpha<sup>2</sup>,...,&alpha<sup>m-1</sup>} as:
<ul> a = u0.&alpha<sup>0</sup>+u1.&alpha<sup>1</sup>+u2.&alpha<sup>2</sup>+...um-1&alpha<sup>m-1</sup></ul> where &alpha is root of the field polynomial. More generally an elemenents can
 be represented in the standard base of any primitive element &beta=&alpha<sup>d</sup>.

In the dual basis of a standard base {&beta}, elements are represented in the basis  {&lambda<sub>0</sub>,&lambda<sub>1</sub>,&lambda<sub>2</sub>,...,&lambda<sub>m-1</sub>}
<ul> a = v0.&lambda<sub>0</sub>+v1.&lambda<sub>1</sub>+v2.&lambda<sub>2</sub>+...vm-1&lambda<sub>m-1</sub> </ul> such that:
<ul> Trace(&beta<sup>i</sup>.&lambda<sub>j</sub>=1 if i=j and 0 otherwise</ul>
</html>"
set_parameter_property USEDUALBASIS GROUP "CCSDS Options"
set_parameter_property USEDUALBASIS HDL_PARAMETER true

add_parameter DUALBASISOF INTEGER 1
set_parameter_property DUALBASISOF DISPLAY_NAME "Dual basis of the primitive element"
set_parameter_property DUALBASISOF DESCRIPTION "input and output are represented in the trace-orthogonal basis."
set_parameter_property DUALBASISOF GROUP "CCSDS Options"
set_parameter_property DUALBASISOF HDL_PARAMETER false
}
...
proc add_module_parametersSEARCH {} {
    add_module_parametersCORRECT 
    add_module_parametersIRRPOL
    add_module_parametersN 
    add_module_parametersROOT 
    add_module_parametersVARN 
    add_module_parametersOPTIMIZE_LATENCY
    add_module_parametersDUAL
}
...
proc add_module_parametersBM {} {
    ...
    add_module_parametersN
    add_module_parametersROOT    
    add_module_parametersVARCHECK
    add_module_parametersVARN 
    add_module_parametersOPTIMIZE_LATENCY
    add_module_parametersMINN
    add_module_parametersBMADVANCEDPARAM
}
proc add_module_parametersSYN {} {
    add_module_parametersCORRECT 
    add_module_parametersIRRPOL
    add_module_parametersN 
    add_module_parametersVARCHECK
...
proc add_module_parametersENC {} {
    ...
    add_module_parametersDUAL
    add_module_parametersROOT
    add_module_parametersVARENC
}

proc add_module_parametersVARENC {} {
    add_module_parametersVARCHECK
    add_module_parametersMINCHECK    
}

proc add_module_parametersCONVERTOR {} {
    add_module_parametersCORRECT
    add_module_parametersN
    add_module_parametersVARCHECK
    add_module_parametersUSENUMN
...
proc add_module_parametersTOP {} {
    ...
    add_module_parametersM
    add_module_parametersN
    add_module_parametersNENC
    add_module_parametersCHECK
    add_module_parametersIRRPOL
    add_module_parametersGENPOLTYPE
    add_module_parametersROOT
    add_module_parametersERASURE
    add_module_parametersSTATUS_DISPLAY
    add_module_parametersSTATUS
    add_module_parametersVARN
    add_module_parametersUSENUMN
    add_module_parametersOPTIONS_DISPLAY
    add_module_parametersOPTIMIZE_LATENCY
    add_module_parametersBMADVANCEDPARAM
    add_module_parametersMINN     
    add_module_parametersVARENC 
...
proc validateCORRECT {} {
    ...
    set min_check 2
    set max_check [expr int(pow(2,$bits_per_symbol))-1-1]                       
...
proc validateTOP {} {
    ...
    set optimize_latency    [ get_parameter_value OPTIMIZE_LATENCY ]
    set use_dual_basis      [ get_parameter_value USEDUALBASIS ]
    set dual_basis_of       [ get_parameter_value DUALBASISOF ]


    set_parameter_value NENC "Up to [expr 2**$bitspersymbol-1]"
    ...
    if {[string equal $rs "Encoder"]} {   
        ...
        set_parameter_property NENC VISIBLE true
        set_parameter_property ERRORSYMB VISIBLE false
        set_parameter_property ERRORBITCOUNT VISIBLE false
        set_parameter_property ERRORSYMBCOUNT VISIBLE false
        set_parameter_property ERRORSYMB_ENC VISIBLE true
        set_parameter_property ERRORBITCOUNT_ENC VISIBLE true
        set_parameter_property ERRORSYMBCOUNT_ENC VISIBLE true
        set_parameter_property BITCOUNTTYPE VISIBLE false
        validateENC
    } else {
        set_parameter_property ERASURE ENABLED true
        set_parameter_property N ENABLED true
        set_parameter_property N VISIBLE true
        set_parameter_property NENC VISIBLE false
        set_parameter_property ERRORSYMB VISIBLE true
        set_parameter_property ERRORBITCOUNT VISIBLE true
        set_parameter_property ERRORSYMBCOUNT VISIBLE true
        set_parameter_property ERRORSYMB_ENC VISIBLE false
        set_parameter_property ERRORBITCOUNT_ENC VISIBLE false
        set_parameter_property ERRORSYMBCOUNT_ENC VISIBLE false
        if {$errorbitcount==0} {set_parameter_property BITCOUNTTYPE VISIBLE false} else {set_parameter_property BITCOUNTTYPE VISIBLE true}
        validateDEC
    }
    
    if {[string equal $rs "Encoder"]} {  
        set_parameter_property ERASURE_ENC VISIBLE false
        set_parameter_property ERASURE     VISIBLE false
    } else {
        set_parameter_property ERASURE_ENC VISIBLE false
        set_parameter_property ERASURE     VISIBLE true        
    }


    set_parameter_property VARCHECK ENABLED true
    if {[string equal $rs "Encoder"]} {  
        set_parameter_property VARN VISIBLE false
        set_parameter_property VARN_ENC VISIBLE true
    } else {
        set_parameter_property VARN VISIBLE true
        set_parameter_property VARN_ENC VISIBLE false        
    }

    if {[string equal $rs "Encoder"]} {
        set_parameter_property USENUMN VISIBLE false
        set_parameter_property OPTIMIZE_LATENCY VISIBLE false
        set_parameter_property USENUMN_DISPLAY VISIBLE false
    } else {
        if {$varn} {
            if {$erasure} {
                set_parameter_property USENUMN_DISPLAY VISIBLE true
                set_parameter_property USENUMN VISIBLE false
            } else {
                set_parameter_property USENUMN_DISPLAY VISIBLE false
                set_parameter_property USENUMN VISIBLE true
            }
            set_parameter_property OPTIMIZE_LATENCY VISIBLE true
        } else {
            set_parameter_property USENUMN_DISPLAY VISIBLE false
            set_parameter_property USENUMN VISIBLE false
            set_parameter_property OPTIMIZE_LATENCY VISIBLE false
    ...
    if {[string equal $genpoltype "CCSDS-like"]} {
        set_parameter_property USEDUALBASIS VISIBLE true
        set_parameter_property DUALBASISOF VISIBLE true
        if {$use_dual_basis} {
            set_parameter_property DUALBASISOF ENABLED true
            
            set exception_list [get_dualbasis_exception_list $bitspersymbol]
            set expt_list_max [expr [llength $exception_list]-1]
            set indi 0
            set dualbasis_valid_list [list ]
            for {set ii 1} {$ii < (1<<$bitspersymbol)-1} {incr ii} {
                if {$ii == [lindex $exception_list $indi]} {
                    if {$indi != $expt_list_max} {incr indi}
                } else {
                    lappend dualbasis_valid_list  $ii:alpha^$ii
                }
            }
            set_parameter_property DUALBASISOF ALLOWED_RANGES $dualbasis_valid_list
        } else {
            set_parameter_property DUALBASISOF ENABLED false
            set_parameter_property DUALBASISOF ALLOWED_RANGES [list $dual_basis_of]
        }
    } else {
        set_parameter_property USEDUALBASIS VISIBLE false
        set_parameter_property DUALBASISOF VISIBLE false
        set_parameter_property DUALBASISOF ALLOWED_RANGES [list $dual_basis_of]
    }
    ...
    ## ADVANCED SETTING
    set use_advanced_setting 0
    
    set_parameter_property MIN_N VISIBLE false
    set_parameter_property MINCHECK VISIBLE false
    set_parameter_property USEROM VISIBLE false
    set_parameter_property BMFIXEDLATENCY VISIBLE false
    
    if  {$use_advanced_setting} {
        if {$varcheck & [string equal $rs "Encoder"]} {
            set_parameter_property MINCHECK VISIBLE true
            if {$mincheck>$check} {send_message error "MINCHECK has to be inferior or equal to CHECK=$check"}
        }  
        
        set_parameter_property MIN_N VISIBLE false
        if {($varn & [string equal $rs "Decoder"] & ($erasure | $optimize_latency)) } {
            set_parameter_property MIN_N VISIBLE true
            if {$minn>$n} {send_message error "MIN_N has to be inferior or equal to N=$n"}
            send_message warning "MIN_N is $minn"
        }
        
        if {($varn|$varcheck) & $channel>1 } {send_message warning "Codewords on all channels must have the same N and CHECK" }
        
        set_parameter_property USEROM VISIBLE false
        if {$varn & [string equal $rs "Decoder"] & $optimize_latency } {
            set_parameter_property USEROM VISIBLE true
        }
        
        set_parameter_property BMFIXEDLATENCY VISIBLE true
...
proc get_dualbasis_exception_list {bits_per_symbol} {
    ...
    set dual [ list \
                        ...
                        [ list 5 10 ] \
                        null \
                        [ list 9 18 21 27 36 42 45 56 ] \
                        null \
                        [ list 17 34 51 68 85 102 119 136 153 170 187 204 221 238] \
                        [ list 73 146 219 292] \
                        [ list 33 66 99 132 165 198 231 264 297 330 363 396 429 462 495 528 561 594 627 660 693 726 759 792 825 858 891 924 957 990 ] \
                        null \
                        [ list  65 130 195 260 273  325 390 455 520 546 585 650 715 780 819 845 910 975 1040 1092 1105 1170 1235 1300 1365 1365 1430 1495 1560 \
                                1625 1638 1690 1755 1820 1885 1911 1950 2015 2080 2145 2184 2210 2275 2340 2405 2457 2470 2535 2600 2665 2730 2730 2795 2860 2925 \
                                2990 3003 3055 3120 3185 3250 3276 3315 3380 3445 3510 3549 3575 3640 3705 3770 3822 3835 3900 3965 4030 ] \
                    ]
    return [lindex $dual $bits_per_symbol]
}
...
proc generate_quartus_synth {entity} {
    generate synth $entity VERILOG
}

proc generate_sim_verilog {entity} {
    generate sim $entity VERILOG
}

proc generate_sim_vhdl {entity} {
    generate sim $entity VHDL
}
...
proc get_lists_of_alphas {AlphatoHEXVar InvofHEXVar m P} {
    upvar $AlphatoHEXVar            AlphatoHEX
    upvar $InvofHEXVar              InvofHEX
    
    set Alphato                     [list]
    for {set ii 0} {$ii < [expr {2**$m}]} {incr ii} {lappend Alphato 1}
    set Indexof                     $Alphato
    set Invof                       $Alphato
    
    for {set ii 1} {$ii < [expr 2**$m]} {incr ii} {
        set prevAlphato             [lindex $Alphato [expr $ii-1]]
        set newAlphato              [expr ($prevAlphato<<1) ^  ((($prevAlphato>>($m-1))==1)*$P)  ]
        lset Alphato $ii            $newAlphato
        lset Indexof $newAlphato    $ii
    }
    for {set ii 1} {$ii < [expr 2**$m]} {incr ii} {
        lset Invof $ii              [lindex $Alphato [expr 2**$m-1-[lindex $Indexof $ii]]]
    }    
    
    set AlphatoHEX                  ""
    set InvofHEX                    ""
    
    set bytesPerWord                [expr {($m - 1) / 8 + 1}]
    set HEXcharPerWord              [expr {($m - 1) / 4 + 1}]
    
    for {set ii 0} {$ii < [expr 2**$m]} {incr ii} {
        set currentAlphato          [lindex $Alphato $ii]
        if {$ii==0} {set currentInvof 1} else {set currentInvof  [lindex $Alphato [expr 2**$m-1-[lindex $Indexof $ii]]]}
        

        append AlphatoHEX           [format "%0[expr $HEXcharPerWord]X\n"  $currentAlphato]
        append InvofHEX             [format "%0[expr $HEXcharPerWord]X\n"  $currentInvof]
    }

    
}

proc get_lists_of_alphas_and_roots {AlphatoHEXVar InvofHEXVar LocrootsHEXVar EvalrootsHEXVar m P rgen rspace nbsymb n minn} {
    upvar $AlphatoHEXVar             AlphatoHEX
    upvar $InvofHEXVar               InvofHEX
    upvar $LocrootsHEXVar            LocrootsHEX
    upvar $EvalrootsHEXVar           EvalrootsHEX
    ...
    set bytesPerWord                [expr {($m - 1) / 8 + 1}]
    set HEXcharPerWord              [expr {($m - 1) / 4 + 1}]
    set HEXcharPerPoly              [expr {($nbsymb*$m - 1) / 4 + 1}]
    
    for {set ii 0} {$ii < [expr 1<<$m]} {incr ii} {
        ...
        if {$ii>$minn-1 && $ii<$n+1} {
            set LocrootsHEX_list         [list ]
            set EvalrootsHEX_list        [list ]
            set ini_shift 0
            
            for {set jj 0} {$jj < $nbsymb} {incr jj} {
                set currentLocroots          [lindex $Alphato  [expr (($max_n-$ii+1)*$rspace*($jj+1))%$max_n]]
                set currentEvalroots         [lindex $Alphato  [expr (($max_n-$ii+1)*($rgen+$jj*$rspace))%$max_n]]
                set nextLocroots             [lindex $Alphato  [expr (($max_n-$ii+1)*$rspace*($jj+1+1))%$max_n]]
                set nextEvalroots            [lindex $Alphato  [expr (($max_n-$ii+1)*($rgen+($jj+1)*$rspace))%$max_n]]

                
                set currentm [ expr $m-$ini_shift]
                set currentHEXcharPerWord  [expr $currentm/ 4 ]

                set shiftedLocrootsValue     [expr $currentLocroots>>$ini_shift]
                set shiftedEvalrootsValue     [expr $currentEvalroots>>$ini_shift]
                
                if {$m>3} {  
                    for {set kk 0} {$kk < $currentHEXcharPerWord} {incr kk} {
                        lappend LocrootsHEX_list [format "%X" [expr $shiftedLocrootsValue & 0xf]]  
                        lappend EvalrootsHEX_list [format "%X" [expr $shiftedEvalrootsValue & 0xf]]
                        set shiftedLocrootsValue     [expr $shiftedLocrootsValue>>4]
                        set shiftedEvalrootsValue     [expr $shiftedEvalrootsValue>>4]    
                    }
                ...
                set ini_shift 0
                if {($currentm%4)!=0} {
                    set ini_shift [expr 4-($currentm%4)]
                    
                    if {$jj<$nbsymb-1} {
                        set shiftedLocrootsValue  [expr $shiftedLocrootsValue + (($nextLocroots & ((1<<$ini_shift)-1 ) )<<($currentm%4))]
                        set shiftedEvalrootsValue  [expr $shiftedEvalrootsValue + (($nextLocroots & ((1<<$ini_shift)-1 ) )<<($currentm%4))]
                    }
                    lappend LocrootsHEX_list [format "%X" $shiftedLocrootsValue]
                    lappend EvalrootsHEX_list [format "%X" $shiftedEvalrootsValue]
                }

            }
            
            if {$HEXcharPerPoly%2!=0} {
                lappend LocrootsHEX_list 0
                incr HEXcharPerPoly
            }
            set LocrootsHEX_line  ""
            set EvalrootsHEX_line ""
            for {set jj 0} {$jj < $HEXcharPerPoly} {incr jj} {
                append LocrootsHEX_line [lindex $LocrootsHEX_list [expr $HEXcharPerPoly-1-$jj] ]
                append EvalrootsHEX_line [lindex $EvalrootsHEX_list [expr $HEXcharPerPoly-1-$jj] ]
            }     
            
            set nb_byte [format %02X [expr $HEXcharPerPoly>>1] ]
            set address [format %04X [expr $ii-$minn] ] 
            set record_type "00"
            set data  $LocrootsHEX_line
            set crc [format %02X [ihex_crc  [regexp -all -inline .. $nb_byte$address$record_type$LocrootsHEX_line]] ] 
            append LocrootsHEX ":${nb_byte}${address}${record_type}${data}${crc}"
            
            set data $EvalrootsHEX_line
            set crc [format %02X [ihex_crc   [regexp -all -inline .. $nb_byte$address$record_type$EvalrootsHEX_line]]  ]
            append EvalrootsHEX ":${nb_byte}${address}${record_type}${data}${crc}"
    ...
    append LocrootsHEX ":00000001FF"
    append EvalrootsHEX ":00000001FF"  
    
    
}

proc get_lists_of_alphas_and_dualbasis {AlphatoHEXVar InvofHEXVar TranferHEXMat InvTranferHEXMat m P w dualtostandard} {
    upvar $AlphatoHEXVar            AlphatoHEX
    upvar $InvofHEXVar              InvofHEX
    upvar $TranferHEXMat             TranferHEX
    upvar $InvTranferHEXMat          InvTranferHEX

 
    
    set TwoPowM   [expr (1<<$m)]
    set max_n     [expr $TwoPowM-1] 
    ...
    # Alphas and Inv of Alpha
    for {set ii 1} {$ii < $TwoPowM} {incr ii} {
        set prevAlphato             [lindex $Alphato [expr $ii-1]]
        set newAlphato              [expr ($prevAlphato<<1) ^  ((($prevAlphato>>($m-1))==1)*$P)  ]
        lset Alphato $ii            $newAlphato
        lset Indexof $newAlphato    $ii
    ...
    # Dual basis
    set TraceOfBase [list]
    if {$m%2==0} {lappend TraceOfBase 0} else {lappend TraceOfBase 1}
    for {set ii 1} {$ii < $m} {incr ii} {
        set trace 0
        for {set jj 0} {$jj < $m} {incr jj} {
            set indice [expr ($ii*(1<<$jj))%$max_n]
            set trace  [expr $trace ^ [lindex $Alphato  $indice]  ]
        }
        lappend TraceOfBase $trace
    }

    for {set ii 0} {$ii < $max_n} {incr ii} {
    
        set trace 0
        for {set jj 0} {$jj < $m} {incr jj} {
            set trace  [expr $trace ^ (([lindex $Alphato $ii]>>$jj) & [lindex $TraceOfBase $jj])  ]
        }
        if {$trace==1} {
            for {set jj 0} {$jj < $m} {incr jj} {
                set indi  [expr ($max_n+$ii-$w*$jj)%$max_n]
                set old_value [lindex $Dualbase  $indi ]
                set increment [expr  $trace<<($m-1-$jj)]
                set updated_value  [expr $old_value + $increment]
                
                lset Dualbase  $indi  [expr $old_value + ($trace<<($m-1-$jj))]
            }
        }
    }

    
    # writing into HEX format
    set AlphatoHEX                  ""
    set InvofHEX                    ""
    set TranferHEX                  ""
    ...
    for {set ii 0} {$ii < [expr 1<<$m]} {incr ii} {    
        ...
        #search the dual basis
        if {$dualtostandard} {
            set currentAlphatoDual      [lindex $Dualbase $ii]
            for {set jj 0} {$jj < $m} {incr jj} {
                if {$currentAlphatoDual == (1<<$jj) } {
                    lset InvTranfer $jj $currentAlphato
                }
            }
        }
    }
    ...
    for {set ii 0} {$ii < [expr $m]} {incr ii} {
        append TranferHEX           [format "%0[expr $HEXcharPerWord]X\n"  [lindex $Dualbase $ii]]
        if {$dualtostandard} {
            append InvTranferHEX        [format "%0[expr $HEXcharPerWord]X\n"  [lindex $InvTranfer $ii]]        
        }
    }
...
proc add_rs_hex_wrapper {type entity lang name extra_port {extra_code ""} {forced_vector ""}} {

    set submodule_extras [list ]

    foreach p $extra_port {
        set pname [lindex $p 0]
        set ptext [lindex $p 1]

        if {[string equal "$pname" "Inv_of"]} {
            lappend submodule_extras [list "INV_FILE_NAME" "${entity}_inverse.hex" STRING quoted]
            add_fileset_file "${entity}_inverse.hex"  HEX TEXT $ptext
        }
        if {[string equal "$pname" "Alpha_to"]} {
            lappend submodule_extras [list "ALPHA_FILE_NAME" "${entity}_alphas.hex" STRING quoted]
            add_fileset_file "${entity}_alphas.hex"  HEX TEXT $ptext
        }
        if {[string equal "$pname" "Locroot"]} {
            lappend submodule_extras [list "LOCROOTLIST_FILE_NAME" "${entity}_locroots.hex" STRING quoted]
            add_fileset_file "${entity}_locroots.hex"  HEX TEXT $ptext
        }
        if {[string equal "$pname" "Evalroots"]} {
            lappend submodule_extras [list "EVALROOTLIST_FILE_NAME" "${entity}_evalroots.hex" STRING quoted]
            add_fileset_file "${entity}_evalroots.hex"  HEX TEXT $ptext
        }
        if {[string equal "$pname" "ToStd"]} {
            lappend submodule_extras [list "TO_STD_FILE_NAME" "${entity}_TtoStd.hex" STRING quoted]
            add_fileset_file "${entity}_TtoStd.hex"  HEX TEXT $ptext
        }
        if {[string equal "$pname" "ToDual"]} {
            lappend submodule_extras [list "TO_DUAL_FILE_NAME" "${entity}_TtoDual.hex" STRING quoted]
            add_fileset_file "${entity}_TtoDual.hex"  HEX TEXT $ptext
        }
    }
    

    set wrapper_file [altera_hdl_wrapper::generate_wrapper $entity $name $lang $submodule_extras $extra_code $forced_vector]

    if {[string equal $lang "VERILOG"]} {
        add_fileset_file "$entity.v" $lang TEXT $wrapper_file
    } else {
        add_fileset_file "$entity.vhd" $lang TEXT $wrapper_file
    }

...
module altera_jesd204_transport_tx_top #(
   ...
   parameter DATA_BUS_WIDTH    = (N_PRIME==12) ? 480 : (F==8)? (8*8*L*N/N_PRIME) : (F==4)? (8*4*L*N/N_PRIME) : (F==2) ? (F2_FRAMECLK_DIV*8*2*L*N/N_PRIME) : (F==1) ? (F1_FRAMECLK_DIV*8*1*L*N/N_PRIME)  : 1,
   ...
   begin
      ...
      altera_jesd204_assembler_nprime12 #(
         .L              (L),
         .F              (F),
         .N              (N),
         .CS             (CS),

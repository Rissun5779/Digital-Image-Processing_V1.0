Altera JESD204B Example Design Simulation Notes 
===========================================
...
--<example_design_directory_name>
         ...
         |--ed_sim
           |--testbench
               |--README_EXAMPLE_DESIGN_SIMULATION.txt
               ...
               |--testbench
                 ...
                 |--synopsys
                 |--transport_layer
                 |--xcvr_atx_pll_sim       (only available in example design targeted on Arria 10 FPGA device)
                 |--XCVR_reconfig_sim      (only available in example design targeted on V series FPGA device)

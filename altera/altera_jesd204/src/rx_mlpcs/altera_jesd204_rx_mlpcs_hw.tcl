...
##########################
set_module_property NAME altera_jesd204_rx_mlpcs
...
set_module_property DISPLAY_NAME "JESD204B RX MLPCS"
...
set_fileset_property synth2 TOP_LEVEL altera_jesd204_rx_mlpcs
set_fileset_property sim_verilog TOP_LEVEL altera_jesd204_rx_mlpcs
set_fileset_property sim_vhdl TOP_LEVEL altera_jesd204_rx_mlpcs
...
::altera_jesd204::gui_params::params_rx_mlpcs_hw
...
#  common_add_optional_conduit    { port_name   signal_type   port_dir   width  vhdl_type  used   terminate }    
   common_add_optional_conduit 	rxlink_clk 		export 	input 1  std  true 0
   common_add_optional_conduit 	rxlink_rst_n 		export 	input 1  std  true 0
   ...
   common_add_optional_conduit 	patternalign_en	        export 	input $d_L  vector true 0

   common_add_optional_conduit 	jesd204_rx_pcs_data 		export 	output $d_L*32  vector  true 0
   common_add_optional_conduit 	jesd204_rx_pcs_data_valid	export 	output $d_L     vector  true 0
   common_add_optional_conduit  jesd204_rx_pcs_kchar_data	export 	output $d_L*4   vector  true 0
   common_add_optional_conduit 	jesd204_rx_pcs_errdetect	export 	output $d_L*4   vector  true 0
   common_add_optional_conduit 	jesd204_rx_pcs_disperr 		export 	output $d_L*4   vector  true 0
	
   #PHY interfaces
   if {[param_matches PCS_CONFIG "JESD_PCS_CFG1" ]} {
      common_add_optional_conduit     rxphy_clk 	      [expr {[device_is_vseries] ? "rx_std_clkout" : "export"}]     input  $d_L  vector true 0
      common_add_optional_conduit     rx_parallel_data        rx_parallel_data         input $d_L*$d_PMA_WIDTH  vector  true 0
      common_add_optional_conduit     phy_kchar_data          rx_datak                 input $d_L*$d_SER_SIZE   vector  true 0
      common_add_optional_conduit     phy_code_err            rx_errdetect             input $d_L*$d_SER_SIZE   vector  true 0
      common_add_optional_conduit     phy_rd_err              rx_disperr               input $d_L*$d_SER_SIZE   vector  true 0
      common_add_optional_conduit     phy_sync_status         rx_syncstatus            input $d_L*$d_SER_SIZE   vector  true 0
      common_add_optional_conduit     phy_lane_polarity       [expr {[device_is_vseries] ? "rx_std_polinv" : "rx_polinv"}]  output $d_L   vector  true 0
      common_add_optional_conduit     phy_bit_reversal        rx_std_bitrev_ena        output $d_L   vector  true 0
      common_add_optional_conduit     phy_byte_reversal       rx_std_byterev_ena       output $d_L   vector  true 0
      common_add_optional_conduit     phy_patternalign_en     rx_std_wa_patternalign   output $d_L   vector  true 0
      ...
      common_add_optional_conduit     rxphy_clk 	      [expr {[device_is_vseries] ? "rx_10g_clkout" : "export"}]      input $d_L   vector  true 0
      common_add_optional_conduit     rx_parallel_data        rx_parallel_data         input $d_L*$d_PMA_WIDTH   vector  true 0
      common_add_optional_conduit     phy_kchar_data          rx_datak                 input $d_L*$d_SER_SIZE    vector  true 1
      common_add_optional_conduit     phy_code_err            rx_errdetect             input $d_L*$d_SER_SIZE    vector  true 1
      common_add_optional_conduit     phy_rd_err              rx_disperr               input $d_L*$d_SER_SIZE    vector  true 1
      common_add_optional_conduit     phy_sync_status         rx_syncstatus            input $d_L*$d_SER_SIZE    vector  true 1
      common_add_optional_conduit     phy_lane_polarity       rx_std_polinv            output $d_L   vector  true 1
      common_add_optional_conduit     phy_bit_reversal        rx_std_bitrev_ena        output $d_L   vector  true 1
      common_add_optional_conduit     phy_byte_reversal       rx_std_byterev_ena       output $d_L   vector  true 1
      common_add_optional_conduit     phy_patternalign_en     rx_std_wa_patternalign   output $d_L   vector  true 1
      common_add_optional_conduit     csr_pcfifo_full         export                   output $d_L   vector  true 1
      common_add_optional_conduit     csr_pcfifo_empty        export                   output $d_L   vector  true 1 
      ...
      common_add_optional_conduit     rxphy_clk 	      [expr {[device_is_vseries] ? "rx_pma_clkout" : "export"}]      input $d_L   vector  true 0
      common_add_optional_conduit     rx_parallel_data        rx_pma_parallel_data         input $d_L*$d_PMA_WIDTH   vector  true 0
      common_add_optional_conduit     phy_kchar_data          rx_datak                 input $d_L*$d_SER_SIZE    vector  true 1
      common_add_optional_conduit     phy_code_err            rx_errdetect             input $d_L*$d_SER_SIZE    vector  true 1
      common_add_optional_conduit     phy_rd_err              rx_disperr               input $d_L*$d_SER_SIZE    vector  true 1
      common_add_optional_conduit     phy_sync_status         rx_syncstatus            input $d_L*$d_SER_SIZE    vector  true 1
...
proc common_fileset {language gensim simulator} {
   ...
   if {[string compare -nocase ${simulator} synopsys] == 0} {
    ...
    add_fileset_file ${simulator_path}/altera_jesd204_rx_mlpcs.v      $filekind PATH ${tmpdir}/${simulator_path}/altera_jesd204_rx_mlpcs.v $simulator_specific  

    # source files for jesd204 rx
    add_fileset_file ${simulator_path}/altera_jesd204_8b10b_dec.v     $filekind PATH ${tmpdir}/${simulator_path}/altera_jesd204_8b10b_dec.v    $simulator_specific   
    add_fileset_file ${simulator_path}/altera_jesd204_rx_pcs.v        $filekind PATH ${tmpdir}/${simulator_path}/altera_jesd204_rx_pcs.v       $simulator_specific
    add_fileset_file ${simulator_path}/altera_jesd204_wa.v            $filekind PATH ${tmpdir}/${simulator_path}/altera_jesd204_wa.v           $simulator_specific  
    ...
    add_fileset_file ${simulator_path}/altera_jesd204_xn_8b10b_dec.v  $filekind PATH ${tmpdir}/${simulator_path}/altera_jesd204_xn_8b10b_dec.v $simulator_specific
    if {[ get_parameter_value DATA_PATH ] == "RX"} {
    ...
    if {[param_matches wrapper_opt "phy"] || [param_matches wrapper_opt "base_phy"]  } {
	  ...
	  # OCP file
          add_fileset_file altera_jesd204_rx_mlpcs.ocp OTHER PATH ${tmpdir}/${simulator_path}/altera_jesd204_rx_mlpcs.ocp $simulator_specific
       }
   }

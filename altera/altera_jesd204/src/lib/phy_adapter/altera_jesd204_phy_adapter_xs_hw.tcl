...
##########################
set_module_property NAME altera_jesd204_phy_adapter_xs
...
set_module_property DISPLAY_NAME "JESD204B PHY Adapter XS"
...
set_fileset_property synth2       TOP_LEVEL altera_jesd204_phy_adapter_xs
set_fileset_property sim_verilog  TOP_LEVEL altera_jesd204_phy_adapter_xs
set_fileset_property sim_vhdl     TOP_LEVEL altera_jesd204_phy_adapter_xs
...
proc xseries_avmm_adapter { enable } {
   set d_L [get_parameter_value "L"]
   common_add_optional_conduit   phy_reconfig_clk    clk       output   1   std   true   !$enable
   common_add_optional_conduit   phy_reconfig_reset  reset     output   1   std   true   !$enable
   ...
   add_interface_port         phy_reconfig_avmm       phy_reconfig_avmm_read 	        read 		output 	1
   add_interface_port         phy_reconfig_avmm       phy_reconfig_avmm_readdata	readdata 	input 	32
   add_interface_port         phy_reconfig_avmm       phy_reconfig_avmm_waitrequest	waitrequest 	input 	1
   add_interface_port         phy_reconfig_avmm       phy_reconfig_avmm_write 	        write 		output 	1
   add_interface_port         phy_reconfig_avmm       phy_reconfig_avmm_writedata	writedata 	output 	32

   common_add_clock 	      reconfig_clk 	  clock   input   1   std   true  [expr {!$enable}]
#   common_add_reset 	      reconfig_reset      input   reconfig_clk  [expr {!$enable}]
   add_interface          reconfig_reset   reset               sink
   set_interface_property reconfig_reset   ASSOCIATED_CLOCK    reconfig_clk
   ...
   set_interface_property     reconfig_avmm       ASSOCIATED_CLOCK              reconfig_clk
   ...
   add_interface_port         reconfig_avmm       reconfig_avmm_read 		read 		Input 	1
   add_interface_port         reconfig_avmm       reconfig_avmm_readdata	readdata 	Output 	32
   add_interface_port         reconfig_avmm       reconfig_avmm_waitrequest	waitrequest 	Output 	1
   add_interface_port         reconfig_avmm       reconfig_avmm_write 		write 		Input 	1
   add_interface_port         reconfig_avmm       reconfig_avmm_writedata	writedata 	Input 	32
...
proc common_fileset {language gensim simulator} {
   ...
   if {[string compare -nocase ${simulator} synopsys] == 0} {
    ...
    # Add Verilog files
    add_fileset_file ${simulator_path}/altera_jesd204_phy_adapter_xs.v  $filekind PATH ${tmpdir}/${simulator_path}/altera_jesd204_phy_adapter_xs.v $simulator_specific   
}

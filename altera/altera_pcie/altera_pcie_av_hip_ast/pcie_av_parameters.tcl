...
#   set_display_item_property ${group_tab_name} display_hint tab
   ...
   set_parameter_property vsec_id_hwtcl GROUP $group_tab_name
   ...
   set_parameter_property vsec_rev_hwtcl GROUP $group_tab_name
   ...
   set_parameter_property user_id_hwtcl GROUP $group_tab_name

...
//module ${output_name} # (
module altpcie_a10_hip_hwtcl_noterp_check # (
...
localparam bar1_prefetchable = (bar0_type == "bar1_32bit_prefetch_mem")?  "true" : "false";
...
localparam bar2_io_space = (bar0_type == "bar2_io_addr_space")?  "true" : "false";
localparam bar2_prefetchable = (bar0_type == "bar2_32bit_prefetch_mem")?  "true" : "false";
...
localparam bar4_io_space = (bar0_type == "bar4_io_addr_space")?  "true" : "false";
...
altpcie_a10_hip_pipen1b # (
      ...
      .cseb_cpl_tag_checking                                         ((cseb_config_bypass=="enable")?cseb_cpl_tag_checking:(extended_tag_support_hwtcl== 1)? "disable" : "enable"        ),
      ...
      .xcvr_reconfig_clk                                              (xcvr_reconfig_clk                                                   ),
      ...
      .tx_cred_fc_hip_cons                                            (tx_cred_fc_hip_cons                                                 ),//output [5 : 0]
...
generate begin: g_sriov_2
  ...
  if (include_sriov_hwtcl==1 && sriov2_en==1) begin : sriov2
      ...
      altera_pcie_sriov2_bridge                #(
         ...
         .ASPM_L0S_SUPPORT                         (enable_l0s_aspm                           ),
         .ASPM_L1_SUPPORT                          (enable_l1_aspm                            ),

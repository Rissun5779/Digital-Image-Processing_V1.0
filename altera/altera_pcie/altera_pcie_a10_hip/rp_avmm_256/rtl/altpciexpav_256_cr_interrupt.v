...
// 
module altpciexpav_256_cr_interrupt
...
#(
  ...
  endgenerate
     ...
     begin
        if (CraRstn_i == 1'b0)
          ...
          begin
             ...
             PciNonpDataDiscardErr_q3 <= PciNonpDataDiscardErr_i ;
             PciMstrWriteFail_q3 <= PciMstrWriteFail_i ;
             PciMstrReadFail_q3 <= PciMstrReadFail_i ;
   ...
   always @(PciNonpDataDiscardErr_q3 or PciNonpDataDiscardErr_i or
            PciMstrWriteFail_q3 or PciMstrWriteFail_i or
            PciMstrReadFail_q3 or PciMstrReadFail_i or
     ...
     end // always @ (PciNonpDataDiscardErr_q3 or PciNonpDataDiscardErr_i or...

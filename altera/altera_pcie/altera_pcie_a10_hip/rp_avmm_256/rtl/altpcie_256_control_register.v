...
module altpcie_256_control_register
  #(
  ...
  (
   ...
   altpciexpav_256_cr_avalon i_avalon
   (
    .CraClk_i(CraClk_i),
    .CraRstn_i(CraRstn_i),
  ...
  /// Config Status    
  altpciexpav_256_cfg_status i_cfg_stat
     (
      .CraClk_i(CraClk_i),
      .CraRstn_i(CraRstn_i),
 ...
 generate if (port_type_hwtcl == "Root port" )
  begin
     altpcie_256_rp_cr rp_registers

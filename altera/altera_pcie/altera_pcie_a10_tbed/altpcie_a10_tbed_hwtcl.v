...
localparam IS_DUT_ROOTPORT= (port_type_hwtcl == "Root port" && apps_type_hwtcl != 15)?1:0; //apps_type_hwtcl = 15 is Dynamic Root Port mode with Avalon-MM
...
generate begin : g_bfm
   ...
   // RP BFM
   localparam port_type_hwtcl_t = (apps_type_hwtcl != 15 ) ? "Root port" : "Native endpoint";
      ...
      altpcietb_bfm_top_rp  # (
         ...
         .port_type_hwtcl             (port_type_hwtcl_t            ),
         .serial_sim_hwtcl            (1                          )
      ) altpcietb_bfm_top_rp (
         .refclk                   (refclk                    ),
         .npor                     (npor                      ),

...
tri0 lane_rate;
   ...
   generate begin :  g_bfm
      if (((gen123_lane_rate_mode_hwtcl=="Gen3 (8.0 Gbps)") && (USE_CONFIG_BYPASS_HWTCL == 0)) || apps_type_hwtcl == 15)  begin
      ...
      end else if ((gen123_lane_rate_mode_hwtcl=="Gen3 (8.0 Gbps)") && (USE_CONFIG_BYPASS_HWTCL == 1))  begin

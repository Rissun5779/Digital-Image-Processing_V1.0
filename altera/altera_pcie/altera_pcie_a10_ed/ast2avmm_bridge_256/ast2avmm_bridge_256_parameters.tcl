...
proc add_parameters_ui_system_settings {} {
   ...
   set_parameter_property SRIOV_EN DESCRIPTION "Enables Access to SRIOV Functions Connected to RXM Port"
         ...
         # CUSTOM_FEATURE
   add_parameter          CUSTOM_FEATURE integer 0
   set_parameter_property CUSTOM_FEATURE DISPLAY_NAME "Enable Custom Feature Testing for SRIOV"
   set_parameter_property CUSTOM_FEATURE DISPLAY_HINT boolean
   set_parameter_property CUSTOM_FEATURE GROUP $group_name
   set_parameter_property CUSTOM_FEATURE VISIBLE false
   set_parameter_property CUSTOM_FEATURE HDL_PARAMETER true
   set_parameter_property CUSTOM_FEATURE DESCRIPTION "Custom Feature Signals will be driven active high"
   ...
   set_parameter_property ENABLE_TXS DISPLAY_NAME "Enable TX Slave Interface (TXS)"
   ...
   set_parameter_property TX_S_ADDR_WIDTH ALLOWED_RANGES { 32 64 }
   ...
   set_parameter_property PF_COUNT ALLOWED_RANGES {1 2 3 4 5 6 7 8}

 ...
 <parameter name="bonusData"><![CDATA[bonusData 
{
 ...
 <interface name="npor" internal="DUT.npor" type="conduit" dir="end" />
 <interface name="refclk" internal="DUT.refclk" type="clock" dir="end" />
 <module
   name="APPS"
   kind="altera_pcie_target_sriov_ed"
   version="15.1"
   enabled="1">
  <parameter name="INTENDED_DEVICE_FAMILY" value="Arria 10" />
  <parameter name="PF0_VF_COUNT" value="64" />
  <parameter name="PF1_VF_COUNT" value="64" />
  <parameter name="TOTAL_PF_COUNT" value="2" />
  <parameter name="TOTAL_VF_COUNT" value="128" />
  ...
  <parameter name="pld_clockrate_hwtcl" value="250000000" />
 ...
 <module name="DUT" kind="altera_pcie_a10_hip" version="15.1" enabled="1">
  ...
  <parameter name="ari_support_hwtcl" value="1" />
  ...
  <parameter name="bar2_type_hwtcl" value="Disabled" />
  ...
  <parameter name="class_code_hwtcl" value="2" />
  ...
  <parameter name="cseb_config_bypass_hwtcl" value="1" />
  ...
  <parameter name="interface_type_hwtcl">Avalon-ST with SR-IOV</parameter>
  ...
  <parameter name="pf0_bar2_present_hwtcl" value="1" />
  <parameter name="pf0_bar2_size_hwtcl" value="14" />
  ...
  <parameter name="pf0_bar4_present_hwtcl" value="1" />
  ...
  <parameter name="pf0_msix_pba_offset_hwtcl" value="8192" />
  <parameter name="pf0_msix_table_bir_hwtcl" value="0" />
  <parameter name="pf0_msix_table_offset_hwtcl" value="4096" />
  <parameter name="pf0_msix_table_size_hwtcl" value="32" />
  <parameter name="pf0_subclass_code_hwtcl" value="0" />
  <parameter name="pf0_vf_bar0_prefetchable_hwtcl" value="1" />
  <parameter name="pf0_vf_bar0_present_hwtcl" value="1" />
  ...
  <parameter name="pf0_vf_bar2_present_hwtcl" value="1" />
  ...
  <parameter name="pf0_vf_bar4_present_hwtcl" value="1" />
  ...
  <parameter name="pf0_vf_count_user_hwtcl" value="64" />
  <parameter name="pf0_vf_device_id_hwtcl" value="51966" />
  <parameter name="pf0_vf_msix_pba_bir_hwtcl" value="0" />
  <parameter name="pf0_vf_msix_pba_offset_hwtcl" value="8192" />
  <parameter name="pf0_vf_msix_tbl_bir_hwtcl" value="0" />
  <parameter name="pf0_vf_msix_tbl_offset_hwtcl" value="4096" />
  <parameter name="pf0_vf_msix_tbl_size_hwtcl" value="32" />
  <parameter name="pf1_bar0_prefetchable_hwtcl" value="1" />
  <parameter name="pf1_bar0_present_hwtcl" value="1" />
  ...
  <parameter name="pf1_bar2_present_hwtcl" value="1" />
  <parameter name="pf1_bar2_size_hwtcl" value="14" />
  ...
  <parameter name="pf1_msix_pba_offset_hwtcl" value="8192" />
  <parameter name="pf1_msix_table_bir_hwtcl" value="0" />
  <parameter name="pf1_msix_table_offset_hwtcl" value="4096" />
  <parameter name="pf1_msix_table_size_hwtcl" value="32" />
  ...
  <parameter name="pf1_vf_bar0_present_hwtcl" value="1" />
  ...
  <parameter name="pf1_vf_bar2_present_hwtcl" value="1" />
  ...
  <parameter name="pf1_vf_count_user_hwtcl" value="64" />
  <parameter name="pf1_vf_device_id_hwtcl" value="0" />
  <parameter name="pf1_vf_msix_pba_bir_hwtcl" value="0" />
  <parameter name="pf1_vf_msix_pba_offset_hwtcl" value="8192" />
  <parameter name="pf1_vf_msix_tbl_bir_hwtcl" value="0" />
  <parameter name="pf1_vf_msix_tbl_offset_hwtcl" value="4096" />
  <parameter name="pf1_vf_msix_tbl_size_hwtcl" value="32" />
  <parameter name="pf_enable_function_msix_support_hwtcl" value="1" />
  ...
  <parameter name="sr_iov_support_hwtcl" value="1" />
  ...
  <parameter name="total_pf_count_hwtcl" value="2" />
  <parameter name="track_rxfc_cplbuf_ovf_hwtcl" value="0" />
  ...
  <parameter name="vf_msix_cap_present_hwtcl" value="1" />
 ...
 <connection kind="conduit" version="15.1" start="DUT.flr" end="APPS.flr">
  <parameter name="endPort" value="" />
  <parameter name="endPortLSB" value="0" />
  <parameter name="startPort" value="" />
  <parameter name="startPortLSB" value="0" />
 ...
 <connection kind="conduit" version="15.1" start="DUT.hip_rst" end="APPS.hip_rst">
  <parameter name="endPort" value="" />
  <parameter name="endPortLSB" value="0" />
  <parameter name="startPort" value="" />
  <parameter name="startPortLSB" value="0" />
 ...
 <connection kind="conduit" version="15.1" start="DUT.int_msi" end="APPS.int_msi">
  <parameter name="endPort" value="" />
  <parameter name="endPortLSB" value="0" />
  <parameter name="startPort" value="" />
  <parameter name="startPortLSB" value="0" />
 ...
 <connection kind="conduit" version="15.1" start="DUT.lmi" end="APPS.lmi">
  <parameter name="endPort" value="" />
  <parameter name="endPortLSB" value="0" />
  <parameter name="startPort" value="" />
  <parameter name="startPortLSB" value="0" />
 ...
 <connection kind="conduit" version="15.1" start="APPS.tx_cred" end="DUT.tx_cred">
  <parameter name="endPort" value="" />
  <parameter name="endPortLSB" value="0" />
  <parameter name="startPort" value="" />
  <parameter name="startPortLSB" value="0" />

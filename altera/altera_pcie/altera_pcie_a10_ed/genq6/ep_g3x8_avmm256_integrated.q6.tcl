 ...
 <parameter name="bonusData"><![CDATA[bonusData 
{
 ...
 <interface
   name="dk_board"
   internal="altpcie_devkit_0.dk_board"
   type="conduit"
   dir="end" />
 ...
 <module name="DUT" kind="altera_pcie_a10_hip" version="15.1" enabled="1">
  ...
  <parameter name="enable_devkit_conduit_hwtcl" value="1" />
 ...
 <connection kind="avalon" version="15.1" start="DUT.rd_dcm_master" end="DUT.txs">
  <parameter name="arbitrationPriority" value="1" />
  <parameter name="baseAddress" value="0x0000" />
  <parameter name="defaultConnection" value="false" />
 </connection>
 ...
 <connection kind="avalon" version="15.1" start="DUT.wr_dcm_master" end="DUT.txs">
  <parameter name="arbitrationPriority" value="1" />
  <parameter name="baseAddress" value="0x0000" />
  <parameter name="defaultConnection" value="false" />
 </connection>
 ...
 <connection
   ...
   version="15.1"
   start="DUT.coreclkout_hip"
   end="altpcie_devkit_0.clock" />
 <connection
   kind="conduit"
   version="15.1"
   start="DUT.dk_hip"
   end="altpcie_devkit_0.dk_hip">

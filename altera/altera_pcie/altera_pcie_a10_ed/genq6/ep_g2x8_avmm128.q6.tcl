 ...
 <parameter name="bonusData"><![CDATA[bonusData 
{
   ...
   element reset_bridge_duplicate
   {
      datum _sortIndex
      {
         value = "7";
 ...
 <parameter name="device" value="10AX115H4F34I3SP" />
 ...
 <module name="DUT" kind="altera_pcie_a10_hip" version="15.1" enabled="1">
  ...
  <parameter name="app_interface_width_hwtcl" value="128-bit" />
  ...
  <parameter name="slave_address_map_0_hwtcl" value="12" />
 ...
 <module name="dma_0" kind="altera_avalon_dma" version="15.1" enabled="1">
  ...
  <parameter name="readSlaveDataWidthMax" value="128" />
  ...
  <parameter name="writeSlaveDataWidthMax" value="128" />
 </module>
 <module
   name="mm_bridge_0"
 ...
 <module
   name="reset_bridge_duplicate"
   kind="altera_reset_bridge"
   version="15.1"
   enabled="1">
  <parameter name="ACTIVE_LOW_RESET" value="0" />
  <parameter name="AUTO_CLK_CLOCK_RATE" value="250000000" />
  <parameter name="NUM_RESET_OUTPUTS" value="6" />
 ...
 <connection kind="avalon" version="15.1" start="mm_bridge_1.m0" end="DUT.cra">
  <parameter name="arbitrationPriority" value="1" />
 ...
 <connection
   kind="avalon"
   version="15.1"
   start="mm_bridge_2.m0"
   end="onchip_memory2_1.s1">
  <parameter name="arbitrationPriority" value="1" />
  <parameter name="baseAddress" value="0x0000" />
  <parameter name="defaultConnection" value="false" />
 </connection>
 <connection kind="avalon" version="15.1" start="mm_bridge_0.m0" end="DUT.txs">
  <parameter name="arbitrationPriority" value="1" />
  <parameter name="baseAddress" value="0x0000" />
  <parameter name="defaultConnection" value="false" />
 </connection>
 ...
 <connection
   ...
   version="15.1"
   start="DUT.coreclkout_hip"
   end="reset_bridge_duplicate.clk" />
 <connection
   kind="clock"
   version="15.1"
   start="DUT.coreclkout_hip"
 ...
 <connection kind="interrupt" version="15.1" start="DUT.rxm_irq" end="dma_0.irq">
 ...
 <connection
   ...
   end="reset_bridge_duplicate.in_reset" />
 <connection
   kind="reset"
   version="15.1"
   start="reset_bridge_duplicate.out_reset"
   end="mm_bridge_2.reset" />
 <connection
   kind="reset"
   version="15.1"
   start="reset_bridge_duplicate.out_reset_1"
   end="onchip_memory2_1.reset1" />
 <connection
   kind="reset"
   version="15.1"
   start="reset_bridge_duplicate.out_reset_2"
   end="mm_bridge_1.reset" />
 <connection
   kind="reset"
   version="15.1"
   start="reset_bridge_duplicate.out_reset_3"
   end="mm_bridge_0.reset" />
 <connection
   kind="reset"
   version="15.1"
   start="reset_bridge_duplicate.out_reset_4"
   end="dma_0.reset" />
 <connection
   kind="reset"
   version="15.1"
   start="reset_bridge_duplicate.out_reset_5"

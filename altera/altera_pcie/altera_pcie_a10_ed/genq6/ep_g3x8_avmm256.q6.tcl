 ...
 <parameter name="bonusData"><![CDATA[bonusData 
{
   ...
   element dma_control_0.RdDCS_slave
   {
      datum baseAddress
      {
         value = "0";
   ...
   element dma_control_0.RdDTS_slave
   {
      datum baseAddress
      {
         value = "16777216";
   ...
   element dma_control_0.WrDCS_slave
   {
      datum baseAddress
      {
         value = "256";
   ...
   element dma_control_0.WrDTS_slave
   {
      datum baseAddress
      {
         value = "16785408";
 ...
 <module name="DUT" kind="altera_pcie_a10_hip" version="15.1" enabled="1">
  ...
  <parameter name="bar4_type_hwtcl">64-bit prefetchable memory</parameter>
  ...
  <parameter name="cg_enable_advanced_interrupt_hwtcl" value="1" />
  ...
  <parameter name="slave_address_map_0_hwtcl" value="9" />
  ...
  <parameter name="slave_address_map_4_hwtcl" value="15" />
 ...
 <module name="dma_control_0" kind="dma_control" version="15.1" enabled="1">
 ...
 <connection
   kind="avalon"
   version="15.1"
   start="dma_control_0.RdDCM_Master"
   end="DUT.txs">
 ...
 <connection
   kind="avalon"
   version="15.1"
   start="dma_control_0.WrDCM_Master"
   end="DUT.txs">
  <parameter name="arbitrationPriority" value="1" />
  <parameter name="baseAddress" value="0x0000" />
  <parameter name="defaultConnection" value="false" />
 ...
 <connection
   kind="avalon"
   version="15.1"
   start="DUT.dma_rd_master"
   end="dma_control_0.RdDTS_slave">
  <parameter name="arbitrationPriority" value="1" />
 ...
 <connection
   ...
   version="15.1"
   start="dma_control_0.RdDMA_Tx"
   end="DUT.rd_ast_rx" />
 <connection
   kind="avalon_streaming"
   version="15.1"
   start="dma_control_0.WrDMA_Tx"
   end="DUT.wr_ast_rx" />
 <connection
   kind="avalon_streaming"
   version="15.1"
   start="DUT.rd_ast_tx"
   end="dma_control_0.RdDMA_Rx" />
 <connection
   kind="avalon_streaming"
   version="15.1"
   start="DUT.wr_ast_tx"
   end="dma_control_0.WrDMA_Rx" />
 <connection
   kind="clock"
   version="15.1"
 ...
 <connection
   ...
   version="15.1"
   start="DUT.coreclkout_hip"
   end="dma_control_0.clock" />
 <connection
   kind="conduit"
   version="15.1"
   start="DUT.msi_intfc"
   end="dma_control_0.MsiInterface">

 ...
 <parameter name="bonusData"><![CDATA[bonusData 
{
 ...
 <interface name="board_pins" internal="DEVKIT.dk_board" type="conduit" dir="end" />
 <interface
   name="currentspeed"
   internal="DUT.currentspeed"
   type="conduit"
   dir="end" />
 <interface name="dk_pins" internal="DEVKIT.devkit_pins" />
 ...
 <interface name="pipe_sim_only" internal="DUT.hip_pipe" type="conduit" dir="end" />
 ...
 <interface name="xcvr" internal="DUT.hip_serial" type="conduit" dir="end" />
 ...
 <module name="DEVKIT" kind="altpcie_devkit" version="15.1" enabled="1">
  <parameter name="INTENDED_DEVICE_FAMILY" value="Arria 10" />
 </module>
 <module name="DUT" kind="altera_pcie_a10_hip" version="15.1" enabled="1">
  ...
  <parameter name="link_width_hwtcl" value="x1" />
 ...
 <connection kind="conduit" version="15.1" start="DEVKIT.dk_hip" end="DUT.dk_hip">
  <parameter name="endPort" value="" />
  <parameter name="endPortLSB" value="0" />
  <parameter name="startPort" value="" />
  <parameter name="startPortLSB" value="0" />

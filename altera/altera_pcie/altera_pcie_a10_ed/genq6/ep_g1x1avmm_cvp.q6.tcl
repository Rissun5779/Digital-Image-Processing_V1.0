 ...
 <parameter name="bonusData"><![CDATA[bonusData 
{
 ...
 <parameter name="device" value="10AX115S1F45I1SG" />
 ...
 <module name="DUT" kind="altera_pcie_a10_hip" version="15.1" enabled="1">
  ...
  <parameter name="adme_enable_hwtcl" value="1" />
  ...
  <parameter name="cvp_enable_hwtcl" value="1" />
  ...
  <parameter name="rx_buffer_credit_alloc_hwtcl" value="Balanced" />
  ...
  <parameter name="slave_address_map_2_hwtcl" value="12" />
  <parameter name="slave_address_map_3_hwtcl" value="0" />
  <parameter name="slave_address_map_4_hwtcl" value="12" />

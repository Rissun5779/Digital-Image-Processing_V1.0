...
proc add_rdpcie_parameters_ui {} {
   ...
   add_parameter           device_family_hwtcl  string "Arria 10"
   set_parameter_property  device_family_hwtcl  DISPLAY_NAME "Targeted Device Family"
   set_parameter_property  device_family_hwtcl  ALLOWED_RANGES {"Arria 10"}
   ...
   # RX St BE
   add_parameter          use_rx_st_be_hwtcl integer 1
   ...
   add_parameter          enable_avst_reset_hwtcl integer 0
   set_parameter_property enable_avst_reset_hwtcl DISPLAY_NAME "Enable Avalon-ST reset input port"
   set_parameter_property enable_avst_reset_hwtcl DISPLAY_HINT boolean
   set_parameter_property enable_avst_reset_hwtcl GROUP $group_name
   set_parameter_property enable_avst_reset_hwtcl VISIBLE true
   set_parameter_property enable_avst_reset_hwtcl HDL_PARAMETER true
   set_parameter_property enable_avst_reset_hwtcl DESCRIPTION "When On, Enable Avalon-ST reset input port."
   ...
   add_parameter          enable_lmi_hwtcl integer 0
   set_parameter_property enable_lmi_hwtcl DISPLAY_NAME "Enable local management interface (LMI)"
   set_parameter_property enable_lmi_hwtcl DISPLAY_HINT boolean
   set_parameter_property enable_lmi_hwtcl GROUP $group_name
   set_parameter_property enable_lmi_hwtcl VISIBLE false
   set_parameter_property enable_lmi_hwtcl HDL_PARAMETER false
   set_parameter_property enable_lmi_hwtcl DESCRIPTION "Enables or disables local management interface ports."
   ...
   # DEPRECTAED parameters
   add_parameter          enable_fpga_devkit_board_hwtcl integer 0
   set_parameter_property enable_fpga_devkit_board_hwtcl DISPLAY_HINT boolean
   set_parameter_property enable_fpga_devkit_board_hwtcl VISIBLE false
   set_parameter_property enable_fpga_devkit_board_hwtcl HDL_PARAMETER true

   add_parameter          enable_fpga_devkit_cbb_hwtcl integer 0
   set_parameter_property enable_fpga_devkit_cbb_hwtcl DISPLAY_HINT boolean
   set_parameter_property enable_fpga_devkit_cbb_hwtcl VISIBLE false
   set_parameter_property enable_fpga_devkit_cbb_hwtcl HDL_PARAMETER true

}

proc add_rdpcie_hip_parameters_hidden {} {

   send_message debug "proc:add_rdpcie_hip_parameters_hidden"

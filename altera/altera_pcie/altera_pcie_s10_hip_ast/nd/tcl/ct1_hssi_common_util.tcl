...
proc ::ct1_hip::parameters::intersect { param_values constraints } {
...
proc ::ct1_hip::parameters::exclude { param_values constraints } {
   if {[llength $param_values] == 0} {return {}}
   if {[llength $constraints] == 0} {return {}}
...
proc ::ct1_hip::parameters::split_range { value } {
...
proc ::ct1_hip::parameters::union { values } {
   if { [llength $values] > 1 } {
      set union_list {}
...
proc ::ct1_hip::parameters::compare_lt { legal_range_values constraint_value } {
   set new_list {}
...
proc ::ct1_hip::parameters::compare_le { legal_range_values constraint_value } {
   set new_list {}
...
proc ::ct1_hip::parameters::compare_gt { legal_range_values constraint_value } {
   set new_list {}
...
proc ::ct1_hip::parameters::compare_ge { legal_range_values constraint_value } {
   set new_list {}
...
proc ::ct1_hip::parameters::compare_eq { legal_range_values constraint_value } {
   set new_list {}
...
proc ::ct1_hip::parameters::compare_ne { legal_range_values constraint_value } {
   set new_list {}
...
proc ::ct1_hip::parameters::compare_inside { legal_range_values constraint_values } {
   set new_list {}

...
module altera_pcie_s10_hip_ast # (
...
//-------------------------------
        ...
        parameter                      pf0_bar0_address_width_hwtcl                                                                          = 0,
...
//Used only in BFM PIPE Simulations
  ...
  //Reconfig Interface
   ...
   input    [9:0]     rx_cpl_buffer_limit
    ...
    //synthesis translate_off
    localparam ALTPCIE_S10_HIP_AST_HWTCL_SIM_ONLY  = 1;
    //synthesis translate_on

    //synthesis read_comments_as_HDL on
    //localparam ALTPCIE_S10_HIP_AST_HWTCL_SIM_ONLY  = 0;
    ...
    localparam [63:0] pf0_bar01_size_mask                   =  get_bar_size_mask((pf0_bar0_type=="pf0_bar0_mem64")?1:0,pf0_bar0_address_width_hwtcl, pf0_bar1_address_width_hwtcl)            ;
    localparam [30:0] pf0_pci_type0_bar0_mask_31_1          =  pf0_bar01_size_mask[31:1]                                                                                                      ;
    localparam [30:0] pf0_pci_type0_bar1_mask_31_1          =  pf0_bar01_size_mask[63:33]                                                                                                     ;
    localparam virtual_pf0_bar1_mask_bit0                   = (pf0_bar0_type=="pf0_bar0_mem64")? ((pf0_bar01_size_mask[32]==1'b1) ?"true":"false"):"false"                                    ;

    localparam [63:0] pf0_bar23_size_mask                   =  get_bar_size_mask((pf0_bar2_type=="pf0_bar0_mem64")?1:0,pf0_bar2_address_width_hwtcl, pf0_bar3_address_width_hwtcl)            ;
    localparam [30:0] pf0_pci_type0_bar2_mask_31_1          =  pf0_bar23_size_mask[31:1]                                                                                                      ;
    localparam [30:0] pf0_pci_type0_bar3_mask_31_1          =  pf0_bar23_size_mask[63:33]                                                                                                     ;
    localparam virtual_pf0_bar3_mask_bit0                   = (pf0_bar2_type=="pf0_bar2_mem64")?((pf0_bar23_size_mask[32]==1'b1) ?"true":"false"):"false"                                     ;

    localparam [63:0] pf0_bar45_size_mask                   =  get_bar_size_mask((pf0_bar4_type=="pf0_bar0_mem64")?1:0,pf0_bar4_address_width_hwtcl, pf0_bar5_address_width_hwtcl) ;
    localparam [30:0] pf0_pci_type0_bar4_mask_31_1          =  pf0_bar45_size_mask[31:1]                                                                                                      ;
    localparam [30:0] pf0_pci_type0_bar5_mask_31_1          =  pf0_bar45_size_mask[63:33]                                                                                                     ;
    localparam virtual_pf0_bar5_mask_bit0                   = (pf0_bar4_type=="pf0_bar4_mem64")?((pf0_bar45_size_mask[32]==1'b1) ?"true":"false"):"false"                                     ;

    localparam [20:0] pf0_rom_mask                          = get_expansion_base_addr_mask(pf0_expansion_base_address_register_hwtcl)                                                         ;

    //For now PF1 masks are same as PF0
    localparam [63:0] pf1_bar01_size_mask                   =  get_bar_size_mask((pf1_bar0_type=="pf1_bar0_mem64")?1:0,pf1_bar0_address_width_mux_hwtcl, pf1_bar1_address_width_mux_hwtcl)    ;
    localparam [30:0] pf1_pci_type0_bar0_mask_31_1          =  pf1_bar01_size_mask[31:1]                                                                                                      ;
    localparam [30:0] pf1_pci_type0_bar1_mask_31_1          =  pf1_bar01_size_mask[63:33]                                                                                                     ;
    localparam virtual_pf1_bar1_mask_bit0                   = (pf1_bar0_type=="pf1_bar0_mem64")?((pf1_bar01_size_mask[32]==1'b1) ?"true":"false"):"false"                                     ;

    localparam [63:0] pf1_bar23_size_mask                   =  get_bar_size_mask((pf1_bar2_type=="pf1_bar0_mem64")?1:0,pf1_bar2_address_width_mux_hwtcl, pf1_bar3_address_width_mux_hwtcl)    ;
    localparam [30:0] pf1_pci_type0_bar2_mask_31_1          =  pf1_bar23_size_mask[31:1]                                                                                                      ;
    localparam [30:0] pf1_pci_type0_bar3_mask_31_1          =  pf1_bar23_size_mask[63:33]                                                                                                     ;
    localparam virtual_pf1_bar3_mask_bit0                   = (pf1_bar2_type=="pf1_bar2_mem64")?((pf1_bar23_size_mask[32]==1'b1) ?"true":"false"):"false"                                     ;

    localparam [63:0] pf1_bar45_size_mask                   =  get_bar_size_mask((pf1_bar4_type=="pf1_bar0_mem64")?1:0,pf1_bar4_address_width_mux_hwtcl, pf1_bar5_address_width_mux_hwtcl)    ;
    localparam [30:0] pf1_pci_type0_bar4_mask_31_1          =  pf1_bar45_size_mask[31:1]                                                                                                      ;
    localparam [30:0] pf1_pci_type0_bar5_mask_31_1          =  pf1_bar45_size_mask[63:33]                                                                                                     ;
    localparam virtual_pf1_bar5_mask_bit0                   = (pf1_bar4_type=="pf1_bar4_mem64")?((pf1_bar45_size_mask[32]==1'b1) ?"true":"false"):"false"                                     ;

    localparam [20:0] pf1_rom_mask                          = get_expansion_base_addr_mask(pf1_expansion_base_address_register_hwtcl)                                                         ;

//String to Binary Conversion
    localparam      lcl_int_cvp_jtag0                      =   str_2_bin (  cvp_jtag0                   ) ;
    localparam      lcl_int_cvp_jtag1                      =   str_2_bin (  cvp_jtag1                   ) ;
    localparam      lcl_int_cvp_jtag2                      =   str_2_bin (  cvp_jtag2                   ) ;
    localparam      lcl_int_cvp_jtag3                      =   str_2_bin (  cvp_jtag3                   ) ;
    localparam      lcl_int_pf0_cardbus_cis_pointer        =   str_2_bin (  pf0_cardbus_cis_pointer     ) ;
    localparam      lcl_int_pf0_mask_radm_2                =   str_2_bin (  pf0_mask_radm_2             ) ;
    localparam      lcl_int_pf0_sn_ser_num_reg_1_dw        =   str_2_bin (  pf0_sn_ser_num_reg_1_dw     ) ;
    localparam      lcl_int_pf0_sn_ser_num_reg_2_dw        =   str_2_bin (  pf0_sn_ser_num_reg_2_dw     ) ;
    localparam      lcl_int_pf0_sriov_sup_page_size        =   str_2_bin (  pf0_sriov_sup_page_size     ) ;
    localparam      lcl_int_pf0_sriov_vf_bar0_mask         =   str_2_bin (  pf0_sriov_vf_bar0_mask      ) ;
    localparam      lcl_int_pf0_sriov_vf_bar1_mask         =   str_2_bin (  pf0_sriov_vf_bar1_mask      ) ;
    localparam      lcl_int_pf0_sriov_vf_bar2_mask         =   str_2_bin (  pf0_sriov_vf_bar2_mask      ) ;
    localparam      lcl_int_pf0_sriov_vf_bar3_mask         =   str_2_bin (  pf0_sriov_vf_bar3_mask      ) ;
    localparam      lcl_int_pf0_sriov_vf_bar4_mask         =   str_2_bin (  pf0_sriov_vf_bar4_mask      ) ;
    localparam      lcl_int_pf0_sriov_vf_bar5_mask         =   str_2_bin (  pf0_sriov_vf_bar5_mask      ) ;
    localparam      lcl_int_pf1_cardbus_cis_pointer        =   str_2_bin (  pf1_cardbus_cis_pointer     ) ;
    localparam      lcl_int_pf1_sn_ser_num_reg_1_dw        =   str_2_bin (  pf1_sn_ser_num_reg_1_dw     ) ;
    localparam      lcl_int_pf1_sn_ser_num_reg_2_dw        =   str_2_bin (  pf1_sn_ser_num_reg_2_dw     ) ;
    localparam      lcl_int_pf1_sriov_sup_page_size        =   str_2_bin (  pf1_sriov_sup_page_size     ) ;
    localparam      lcl_int_pf1_sriov_vf_bar0_mask         =   str_2_bin (  pf1_sriov_vf_bar0_mask      ) ;
    localparam      lcl_int_pf1_sriov_vf_bar1_mask         =   str_2_bin (  pf1_sriov_vf_bar1_mask      ) ;
    localparam      lcl_int_pf1_sriov_vf_bar2_mask         =   str_2_bin (  pf1_sriov_vf_bar2_mask      ) ;
    localparam      lcl_int_pf1_sriov_vf_bar3_mask         =   str_2_bin (  pf1_sriov_vf_bar3_mask      ) ;
    localparam      lcl_int_pf1_sriov_vf_bar4_mask         =   str_2_bin (  pf1_sriov_vf_bar4_mask      ) ;
    localparam      lcl_int_pf1_sriov_vf_bar5_mask         =   str_2_bin (  pf1_sriov_vf_bar5_mask      ) ;
    localparam      lcl_int_test_in_hi                     =   str_2_bin (  test_in_hi                  ) ;
    localparam      lcl_int_test_in_lo                     =   str_2_bin (  test_in_lo                  ) ;




//rx_buffer_limit_ports
    wire   [6:0] rx_p_buffer_limit_int  ;
    wire   [6:0] rx_np_buffer_limit_int ;
    wire   [9:0] rx_cpl_buffer_limit_int ;
    generate begin :rx_buffer_limit_ports
        if ( enable_rx_buffer_limit_ports_hwtcl ==1) begin
             assign rx_p_buffer_limit_int = rx_p_buffer_limit;
             assign rx_np_buffer_limit_int = rx_np_buffer_limit;
             assign rx_cpl_buffer_limit_int = rx_cpl_buffer_limit;
        end
            else begin
             assign rx_p_buffer_limit_int = 7'h7e;
             assign rx_np_buffer_limit_int = 7'h7e;
             assign rx_cpl_buffer_limit_int = 10'h3fe;
            end
    end
    endgenerate
...
altera_pcie_s10_hip_ast_pipen1b # (
       ...
       .cvp_jtag0                                                                                               (  lcl_int_cvp_jtag0                                                                                     ) ,
       .cvp_jtag1                                                                                               (  lcl_int_cvp_jtag1                                                                                     ) ,
       .cvp_jtag2                                                                                               (  lcl_int_cvp_jtag2                                                                                     ) ,
       .cvp_jtag3                                                                                               (  lcl_int_cvp_jtag3                                                                                     ) ,
       ...
       .pf0_cardbus_cis_pointer                                                                                 (  lcl_int_pf0_cardbus_cis_pointer                                                                               ) ,
       ...
       .pf0_mask_radm_2                                                                                         (  lcl_int_pf0_mask_radm_2                                                                                       ) ,
       ...
       .pf0_sn_ser_num_reg_1_dw                                                                                 (  lcl_int_pf0_sn_ser_num_reg_1_dw                                                                       ) ,
       .pf0_sn_ser_num_reg_2_dw                                                                                 (  lcl_int_pf0_sn_ser_num_reg_2_dw                                                                       ) ,
       ...
       .pf0_sriov_sup_page_size                                                                                 (  lcl_int_pf0_sriov_sup_page_size                                                                       ) ,
       .pf0_sriov_vf_bar0_mask                                                                                  (  lcl_int_pf0_sriov_vf_bar0_mask                                                                        ) ,
       ...
       .pf0_sriov_vf_bar1_mask                                                                                  (  lcl_int_pf0_sriov_vf_bar1_mask                                                                        ) ,
       ...
       .pf0_sriov_vf_bar2_mask                                                                                  (  lcl_int_pf0_sriov_vf_bar2_mask                                                                        ) ,
       ...
       .pf0_sriov_vf_bar3_mask                                                                                  (  lcl_int_pf0_sriov_vf_bar3_mask                                                                        ) ,
       ...
       .pf0_sriov_vf_bar4_mask                                                                                  (  lcl_int_pf0_sriov_vf_bar4_mask                                                                        ) ,
       ...
       .pf0_sriov_vf_bar5_mask                                                                                  (  lcl_int_pf0_sriov_vf_bar5_mask                                                                        ) ,
       ...
       .pf1_cardbus_cis_pointer                                                                                 (  lcl_int_pf1_cardbus_cis_pointer                                                                       ) ,
       ...
       .pf1_sn_ser_num_reg_1_dw                                                                                 (  lcl_int_pf1_sn_ser_num_reg_1_dw                                                                       ) ,
       .pf1_sn_ser_num_reg_2_dw                                                                                 (  lcl_int_pf1_sn_ser_num_reg_2_dw                                                                       ) ,
       ...
       .pf1_sriov_sup_page_size                                                                                 (  lcl_int_pf1_sriov_sup_page_size                                                                       ) ,
       .pf1_sriov_vf_bar0_mask                                                                                  (  lcl_int_pf1_sriov_vf_bar0_mask                                                                        ) ,
       ...
       .pf1_sriov_vf_bar1_mask                                                                                  (  lcl_int_pf1_sriov_vf_bar1_mask                                                                        ) ,
       ...
       .pf1_sriov_vf_bar2_mask                                                                                  (  lcl_int_pf1_sriov_vf_bar2_mask                                                                        ) ,
       ...
       .pf1_sriov_vf_bar3_mask                                                                                  (  lcl_int_pf1_sriov_vf_bar3_mask                                                                        ) ,
       ...
       .pf1_sriov_vf_bar4_mask                                                                                  (  lcl_int_pf1_sriov_vf_bar4_mask                                                                        ) ,
       ...
       .pf1_sriov_vf_bar5_mask                                                                                  (  lcl_int_pf1_sriov_vf_bar5_mask                                                                        ) ,
       ...
       .sup_mode                                                                                                (  sup_mode                                                                                              ) ,
       .test_in_hi                                                                                              (  lcl_int_test_in_hi                                                                                    ) ,
       .test_in_lo                                                                                              (  lcl_int_test_in_lo                                                                                    ) ,
...
altera_pcie_s10_hip_ast_pipen1b_inst
    (
  .refclk                                      (   refclk                                            ) ,    //input
  ...
  .clr_st                                      (   clr_st                                            ) ,    //output
  .pld_warm_rst_rdy                            (   pld_warm_rst_rdy                                  ) ,    //input//TODO
  .link_req_rst_n                              (   link_req_rst_n                                    ) ,    //output

  .rx_st_ready                                 (   rx_st_ready                                       ) ,    //input
  .rx_st_sop                                   (   rx_st_sop                                         ) ,    //output
  .rx_st_eop                                   (   rx_st_eop                                         ) ,    //output
  .rx_st_data                                  (   rx_st_data                                        ) ,    //output
  .rx_st_parity                                (   rx_st_parity                                      ) ,    //output
  .rx_st_valid                                 (   rx_st_valid                                       ) ,    //output
  .rx_st_bar_range                             (   rx_st_bar_range                                   ) ,    //output
  .rx_st_empty                                 (   rx_st_empty                                       ) ,    //output

  .tx_st_sop                                   (   tx_st_sop                                         ) ,    //input
  .tx_st_eop                                   (   tx_st_eop                                         ) ,    //input
  .tx_st_data                                  (   tx_st_data                                        ) ,    //input
  .tx_st_parity                                (   tx_st_parity                                      ) ,    //input
  .tx_st_valid                                 (   tx_st_valid                                       ) ,    //input
  .tx_st_err                                   (   tx_st_err                                         ) ,    //input
  .tx_st_ready                                 (   tx_st_ready                                       ) ,    //output

  .tx_cdts_type                                (   tx_cdts_type                                      ) ,    //output
  .tx_data_cdts_consumed                       (   tx_data_cdts_consumed                             ) ,    //output
  .tx_hdr_cdts_consumed                        (   tx_hdr_cdts_consumed                              ) ,    //output
  .tx_cdts_data_value                          (   tx_cdts_data_value                                ) ,    //output
  .tx_pd_cdts                                  (   tx_pd_cdts                                        ) ,    //output
  .tx_npd_cdts                                 (   tx_npd_cdts                                       ) ,    //output
  .tx_cpld_cdts                                (   tx_cpld_cdts                                      ) ,    //output
  .tx_ph_cdts                                  (   tx_ph_cdts                                        ) ,    //output
  .tx_nph_cdts                                 (   tx_nph_cdts                                       ) ,    //output
  .tx_cplh_cdts                                (   tx_cplh_cdts                                      ) ,    //output

  .user_avmm_rst_n                             (   hip_reconfig_rst_n                                ) ,    //input
  .user_avmm_waitrequest                       (   hip_reconfig_waitrequest                          ) ,    //output
  .user_avmm_read                              (   hip_reconfig_read                                 ) ,    //input
  .user_avmm_addr                              (   hip_reconfig_address                              ) ,    //input
  .user_avmm_write                             (   hip_reconfig_write                                ) ,    //input
  .user_avmm_writedata                         (   hip_reconfig_writedata                            ) ,    //input
  .user_avmm_clk                               (   hip_reconfig_clk                                  ) ,    //input
  .user_avmm_readdatavalid                     (   hip_reconfig_readdatavalid                        ) ,    //output
  .user_avmm_readdata                          (   hip_reconfig_readdata                             ) ,    //output

  .app_msi_req                                 (   app_msi_req                                       ) ,    //input
  .app_msi_ack                                 (   app_msi_ack                                       ) ,    //output
  .app_msi_tc                                  (   app_msi_tc                                        ) ,    //input
  .app_msi_num                                 (   app_msi_num                                       ) ,    //input
  .app_int_0                                   (   app_int_sts                                       ) ,    //input
  .int_status_pf0                              (   int_status                                        ) ,    //output
  .int_status_common                           (   int_status_common                                 ) ,    //output

  .tl_cfg_func                                 (   tl_cfg_func                                       ) ,    //output
  .tl_cfg_add                                  (   tl_cfg_add                                        ) ,    //output
  .tl_cfg_ctl                                  (   tl_cfg_ctl                                        ) ,    //output

  .serr_out_0                                  (   serr_out                                          ) ,    //output
  .app_err_valid                               (   app_err_valid                                     ) ,    //input
  .app_err_hdr                                 (   app_err_hdr                                       ) ,    //input
  .app_err_info                                (   app_err_info                                      ) ,    //input
  ...
  .ltssm_state                                 (   ltssmstate                                        ) ,    //output
  .currentspeed                                (   currentspeed                                      ) ,    //output
  .lane_act                                    (   lane_act                                          ) ,    //output

  .ceb_req                                     (   ceb_req                                           ) ,    //output
  .ceb_ack                                     (   ceb_ack                                           ) ,    //input
  .ceb_addr                                    (   ceb_addr                                          ) ,    //output
  .ceb_din                                     (   ceb_din                                           ) ,    //input
  .ceb_dout                                    (   ceb_dout                                          ) ,    //output
  .ceb_wr                                      (   ceb_wr                                            ) ,    //output

  .pm_linkst_in_l1                             (   pm_linkst_in_l1                                   ) ,    //output
  .pm_linkst_in_l0s                            (   pm_linkst_in_l0s                                  ) ,    //output
  .pm_state                                    (   pm_state                                          ) ,    //output
  .pm_dstate_0                                 (   pm_dstate                                         ) ,    //output
  .apps_pm_xmt_pme_0                           (   apps_pm_xmt_pme                                   ) ,    //input
  .apps_ready_entr_l23                         (   apps_ready_entr_l23                               ) ,    //input
  .apps_pm_xmt_turnoff                         (   apps_pm_xmt_turnoff                               ) ,    //input
  .app_init_rst                                (   app_init_rst                                      ) ,    //input
  .app_xfer_pending                            (   app_xfer_pending                                  ) ,    //input

  .pipe32_sim_only                             ((ALTPCIE_S10_HIP_AST_HWTCL_SIM_ONLY==0)?1'b0:simu_mode_pipe         ),//input
  ...
  .sim_pipe_rate                               (   sim_pipe_rate                                     ) ,    //output
  .sim_ltssmstate                              (   sim_ltssmstate                                    ) ,    //output

  .txdata0                                     (   txdata0                                           ) ,    //output
  .txdata1                                     (   txdata1                                           ) ,    //output
  .txdata2                                     (   txdata2                                           ) ,    //output
  .txdata3                                     (   txdata3                                           ) ,    //output
  .txdata4                                     (   txdata4                                           ) ,    //output
  .txdata5                                     (   txdata5                                           ) ,    //output
  .txdata6                                     (   txdata6                                           ) ,    //output
  .txdata7                                     (   txdata7                                           ) ,    //output
  .txdata8                                     (   txdata8                                           ) ,    //output
  .txdata9                                     (   txdata9                                           ) ,    //output
  .txdata10                                    (   txdata10                                          ) ,    //output
  .txdata11                                    (   txdata11                                          ) ,    //output
  .txdata12                                    (   txdata12                                          ) ,    //output
  .txdata13                                    (   txdata13                                          ) ,    //output
  .txdata14                                    (   txdata14                                          ) ,    //output
  .txdata15                                    (   txdata15                                          ) ,    //output
  ...
  .txdatak8                                    (   txdatak8                                          ) ,    //output
  .txdatak9                                    (   txdatak9                                          ) ,    //output
  .txdatak10                                   (   txdatak10                                         ) ,    //output
  .txdatak11                                   (   txdatak11                                         ) ,    //output
  .txdatak12                                   (   txdatak12                                         ) ,    //output
  .txdatak13                                   (   txdatak13                                         ) ,    //output
  .txdatak14                                   (   txdatak14                                         ) ,    //output
  .txdatak15                                   (   txdatak15                                         ) ,    //output
  ...
  .powerdown0                                  (   powerdown0                                        ) ,    //output
  .powerdown1                                  (   powerdown1                                        ) ,    //output
  .powerdown2                                  (   powerdown2                                        ) ,    //output
  .powerdown3                                  (   powerdown3                                        ) ,    //output
  .powerdown4                                  (   powerdown4                                        ) ,    //output
  .powerdown5                                  (   powerdown5                                        ) ,    //output
  .powerdown6                                  (   powerdown6                                        ) ,    //output
  .powerdown7                                  (   powerdown7                                        ) ,    //output
  .powerdown8                                  (   powerdown8                                        ) ,    //output
  .powerdown9                                  (   powerdown9                                        ) ,    //output
  .powerdown10                                 (   powerdown10                                       ) ,    //output
  .powerdown11                                 (   powerdown11                                       ) ,    //output
  .powerdown12                                 (   powerdown12                                       ) ,    //output
  .powerdown13                                 (   powerdown13                                       ) ,    //output
  .powerdown14                                 (   powerdown14                                       ) ,    //output
  .powerdown15                                 (   powerdown15                                       ) ,    //output

  .txmargin0                                   (   txmargin0                                         ) ,    //output
  .txmargin1                                   (   txmargin1                                         ) ,    //output
  .txmargin2                                   (   txmargin2                                         ) ,    //output
  .txmargin3                                   (   txmargin3                                         ) ,    //output
  .txmargin4                                   (   txmargin4                                         ) ,    //output
  .txmargin5                                   (   txmargin5                                         ) ,    //output
  .txmargin6                                   (   txmargin6                                         ) ,    //output
  .txmargin7                                   (   txmargin7                                         ) ,    //output
  .txmargin8                                   (   txmargin8                                         ) ,    //output
  .txmargin9                                   (   txmargin9                                         ) ,    //output
  .txmargin10                                  (   txmargin10                                        ) ,    //output
  .txmargin11                                  (   txmargin11                                        ) ,    //output
  .txmargin12                                  (   txmargin12                                        ) ,    //output
  .txmargin13                                  (   txmargin13                                        ) ,    //output
  .txmargin14                                  (   txmargin14                                        ) ,    //output
  .txmargin15                                  (   txmargin15                                        ) ,    //output
  ...
  .txsynchd0                                   (   txsynchd0                                         ) ,    //output
  .txsynchd1                                   (   txsynchd1                                         ) ,    //output
  .txsynchd2                                   (   txsynchd2                                         ) ,    //output
  .txsynchd3                                   (   txsynchd3                                         ) ,    //output
  .txsynchd4                                   (   txsynchd4                                         ) ,    //output
  .txsynchd5                                   (   txsynchd5                                         ) ,    //output
  .txsynchd6                                   (   txsynchd6                                         ) ,    //output
  .txsynchd7                                   (   txsynchd7                                         ) ,    //output
  .txsynchd8                                   (   txsynchd8                                         ) ,    //output
  .txsynchd9                                   (   txsynchd9                                         ) ,    //output
  .txsynchd10                                  (   txsynchd10                                        ) ,    //output
  .txsynchd11                                  (   txsynchd11                                        ) ,    //output
  .txsynchd12                                  (   txsynchd12                                        ) ,    //output
  .txsynchd13                                  (   txsynchd13                                        ) ,    //output
  .txsynchd14                                  (   txsynchd14                                        ) ,    //output
  .txsynchd15                                  (   txsynchd15                                        ) ,    //output
  ...
  .txdatavalid0                                (   txdataskip0                                       ) ,    //output
  .txdatavalid1                                (   txdataskip1                                       ) ,    //output
  .txdatavalid2                                (   txdataskip2                                       ) ,    //output
  .txdatavalid3                                (   txdataskip3                                       ) ,    //output
  .txdatavalid4                                (   txdataskip4                                       ) ,    //output
  .txdatavalid5                                (   txdataskip5                                       ) ,    //output
  .txdatavalid6                                (   txdataskip6                                       ) ,    //output
  .txdatavalid7                                (   txdataskip7                                       ) ,    //output
  .txdatavalid8                                (   txdataskip8                                       ) ,    //output
  .txdatavalid9                                (   txdataskip9                                       ) ,    //output
  .txdatavalid10                               (   txdataskip10                                      ) ,    //output
  .txdatavalid11                               (   txdataskip11                                      ) ,    //output
  .txdatavalid12                               (   txdataskip12                                      ) ,    //output
  .txdatavalid13                               (   txdataskip13                                      ) ,    //output
  .txdatavalid14                               (   txdataskip14                                      ) ,    //output
  .txdatavalid15                               (   txdataskip15                                      ) ,    //output
  ...
  .rate8                                       (   rate8                                             ) ,    //output
  .rate9                                       (   rate9                                             ) ,    //output
  .rate10                                      (   rate10                                            ) ,    //output
  .rate11                                      (   rate11                                            ) ,    //output
  .rate12                                      (   rate12                                            ) ,    //output
  .rate13                                      (   rate13                                            ) ,    //output
  .rate14                                      (   rate14                                            ) ,    //output
  .rate15                                      (   rate15                                            ) ,    //output
  ...
  .currentrxpreset0                            (   currentrxpreset0                                  ) ,    //output
  .currentrxpreset1                            (   currentrxpreset1                                  ) ,    //output
  .currentrxpreset2                            (   currentrxpreset2                                  ) ,    //output
  .currentrxpreset3                            (   currentrxpreset3                                  ) ,    //output
  .currentrxpreset4                            (   currentrxpreset4                                  ) ,    //output
  .currentrxpreset5                            (   currentrxpreset5                                  ) ,    //output
  .currentrxpreset6                            (   currentrxpreset6                                  ) ,    //output
  .currentrxpreset7                            (   currentrxpreset7                                  ) ,    //output
  .currentrxpreset8                            (   currentrxpreset8                                  ) ,    //output
  .currentrxpreset9                            (   currentrxpreset9                                  ) ,    //output
  .currentrxpreset10                           (   currentrxpreset10                                 ) ,    //output
  .currentrxpreset11                           (   currentrxpreset11                                 ) ,    //output
  .currentrxpreset12                           (   currentrxpreset12                                 ) ,    //output
  .currentrxpreset13                           (   currentrxpreset13                                 ) ,    //output
  .currentrxpreset14                           (   currentrxpreset14                                 ) ,    //output
  .currentrxpreset15                           (   currentrxpreset15                                 ) ,    //output

  .currentcoeff0                               (   currentcoeff0                                     ) ,    //output
  .currentcoeff1                               (   currentcoeff1                                     ) ,    //output
  .currentcoeff2                               (   currentcoeff2                                     ) ,    //output
  .currentcoeff3                               (   currentcoeff3                                     ) ,    //output
  .currentcoeff4                               (   currentcoeff4                                     ) ,    //output
  .currentcoeff5                               (   currentcoeff5                                     ) ,    //output
  .currentcoeff6                               (   currentcoeff6                                     ) ,    //output
  .currentcoeff7                               (   currentcoeff7                                     ) ,    //output
  .currentcoeff8                               (   currentcoeff8                                     ) ,    //output
  .currentcoeff9                               (   currentcoeff9                                     ) ,    //output
  .currentcoeff10                              (   currentcoeff10                                    ) ,    //output
  .currentcoeff11                              (   currentcoeff11                                    ) ,    //output
  .currentcoeff12                              (   currentcoeff12                                    ) ,    //output
  .currentcoeff13                              (   currentcoeff13                                    ) ,    //output
  .currentcoeff14                              (   currentcoeff14                                    ) ,    //output
  .currentcoeff15                              (   currentcoeff15                                    ) ,    //output
  ...
  .rxdata0                                     (   rxdata0                                           ) ,    //input
  .rxdata1                                     (   rxdata1                                           ) ,    //input
  .rxdata2                                     (   rxdata2                                           ) ,    //input
  .rxdata3                                     (   rxdata3                                           ) ,    //input
  .rxdata4                                     (   rxdata4                                           ) ,    //input
  .rxdata5                                     (   rxdata5                                           ) ,    //input
  .rxdata6                                     (   rxdata6                                           ) ,    //input
  .rxdata7                                     (   rxdata7                                           ) ,    //input
  .rxdata8                                     (   rxdata8                                           ) ,    //input
  .rxdata9                                     (   rxdata9                                           ) ,    //input
  .rxdata10                                    (   rxdata10                                          ) ,    //input
  .rxdata11                                    (   rxdata11                                          ) ,    //input
  .rxdata12                                    (   rxdata12                                          ) ,    //input
  .rxdata13                                    (   rxdata13                                          ) ,    //input
  .rxdata14                                    (   rxdata14                                          ) ,    //input
  .rxdata15                                    (   rxdata15                                          ) ,    //input
  ...
  .rxdatak8                                    (   rxdatak8                                          ) ,    //input
  .rxdatak9                                    (   rxdatak9                                          ) ,    //input
  .rxdatak10                                   (   rxdatak10                                         ) ,    //input
  .rxdatak11                                   (   rxdatak11                                         ) ,    //input
  .rxdatak12                                   (   rxdatak12                                         ) ,    //input
  .rxdatak13                                   (   rxdatak13                                         ) ,    //input
  .rxdatak14                                   (   rxdatak14                                         ) ,    //input
  .rxdatak15                                   (   rxdatak15                                         ) ,    //input
  ...
  .rxstatus0                                   (   rxstatus0                                         ) ,    //input
  .rxstatus1                                   (   rxstatus1                                         ) ,    //input
  .rxstatus2                                   (   rxstatus2                                         ) ,    //input
  .rxstatus3                                   (   rxstatus3                                         ) ,    //input
  .rxstatus4                                   (   rxstatus4                                         ) ,    //input
  .rxstatus5                                   (   rxstatus5                                         ) ,    //input
  .rxstatus6                                   (   rxstatus6                                         ) ,    //input
  .rxstatus7                                   (   rxstatus7                                         ) ,    //input
  .rxstatus8                                   (   rxstatus8                                         ) ,    //input
  .rxstatus9                                   (   rxstatus9                                         ) ,    //input
  .rxstatus10                                  (   rxstatus10                                        ) ,    //input
  .rxstatus11                                  (   rxstatus11                                        ) ,    //input
  .rxstatus12                                  (   rxstatus12                                        ) ,    //input
  .rxstatus13                                  (   rxstatus13                                        ) ,    //input
  .rxstatus14                                  (   rxstatus14                                        ) ,    //input
  .rxstatus15                                  (   rxstatus15                                        ) ,    //input
  ...
  .rxsynchd0                                   (   rxsynchd0                                         ) ,    //input
  .rxsynchd1                                   (   rxsynchd1                                         ) ,    //input
  .rxsynchd2                                   (   rxsynchd2                                         ) ,    //input
  .rxsynchd3                                   (   rxsynchd3                                         ) ,    //input
  .rxsynchd4                                   (   rxsynchd4                                         ) ,    //input
  .rxsynchd5                                   (   rxsynchd5                                         ) ,    //input
  .rxsynchd6                                   (   rxsynchd6                                         ) ,    //input
  .rxsynchd7                                   (   rxsynchd7                                         ) ,    //input
  .rxsynchd8                                   (   rxsynchd8                                         ) ,    //input
  .rxsynchd9                                   (   rxsynchd9                                         ) ,    //input
  .rxsynchd10                                  (   rxsynchd10                                        ) ,    //input
  .rxsynchd11                                  (   rxsynchd11                                        ) ,    //input
  .rxsynchd12                                  (   rxsynchd12                                        ) ,    //input
  .rxsynchd13                                  (   rxsynchd13                                        ) ,    //input
  .rxsynchd14                                  (   rxsynchd14                                        ) ,    //input
  .rxsynchd15                                  (   rxsynchd15                                        ) ,    //input
  ...
  .rxdatavalid0                                (   rxdataskip0                                       ) ,    //input
  .rxdatavalid1                                (   rxdataskip1                                       ) ,    //input
  .rxdatavalid2                                (   rxdataskip2                                       ) ,    //input
  .rxdatavalid3                                (   rxdataskip3                                       ) ,    //input
  .rxdatavalid4                                (   rxdataskip4                                       ) ,    //input
  .rxdatavalid5                                (   rxdataskip5                                       ) ,    //input
  .rxdatavalid6                                (   rxdataskip6                                       ) ,    //input
  .rxdatavalid7                                (   rxdataskip7                                       ) ,    //input
  .rxdatavalid8                                (   rxdataskip8                                       ) ,    //input
  .rxdatavalid9                                (   rxdataskip9                                       ) ,    //input
  .rxdatavalid10                               (   rxdataskip10                                      ) ,    //input
  .rxdatavalid11                               (   rxdataskip11                                      ) ,    //input
  .rxdatavalid12                               (   rxdataskip12                                      ) ,    //input
  .rxdatavalid13                               (   rxdataskip13                                      ) ,    //input
  .rxdatavalid14                               (   rxdataskip14                                      ) ,    //input
  .rxdatavalid15                               (   rxdataskip15                                      ) ,    //input

  .dirfeedback0                                (   dirfeedback0                                      ) ,    //input
  .dirfeedback1                                (   dirfeedback1                                      ) ,    //input
  .dirfeedback2                                (   dirfeedback2                                      ) ,    //input
  .dirfeedback3                                (   dirfeedback3                                      ) ,    //input
  .dirfeedback4                                (   dirfeedback4                                      ) ,    //input
  .dirfeedback5                                (   dirfeedback5                                      ) ,    //input
  .dirfeedback6                                (   dirfeedback6                                      ) ,    //input
  .dirfeedback7                                (   dirfeedback7                                      ) ,    //input
  .dirfeedback8                                (   dirfeedback8                                      ) ,    //input
  .dirfeedback9                                (   dirfeedback9                                      ) ,    //input
  .dirfeedback10                               (   dirfeedback10                                     ) ,    //input
  .dirfeedback11                               (   dirfeedback11                                     ) ,    //input
  .dirfeedback12                               (   dirfeedback12                                     ) ,    //input
  .dirfeedback13                               (   dirfeedback13                                     ) ,    //input
  .dirfeedback14                               (   dirfeedback14                                     ) ,    //input
  .dirfeedback15                               (   dirfeedback15                                     ) ,    //input
  ...
  .test_in                                     (   test_in[66:3]                                     ) ,    //input
  .aux_test_out                                (   aux_test_out                                      ) ,    //output
  .test_out                                    (   test_out                                          ) ,    //output

  .rx_np_buffer_limit                          (   rx_np_buffer_limit_int                            ) ,    //input
  .rx_p_buffer_limit                           (   rx_p_buffer_limit_int                             ) ,    //input
  .rx_cpl_buffer_limit                         (   rx_cpl_buffer_limit_int                           ) ,      //input

   //Reconfig Interface
   .xcvr_reconfig_clk                          (  xcvr_reconfig_clk                                  ) ,    //   input
   .xcvr_reconfig_reset                        (  xcvr_reconfig_reset                                ) ,    //   input
   .xcvr_reconfig_write                        (  xcvr_reconfig_write                                ) ,    //   input
   .xcvr_reconfig_read                         (  xcvr_reconfig_read                                 ) ,    //   input
   .xcvr_reconfig_address                      (  xcvr_reconfig_address                              ) ,    //   input
   .xcvr_reconfig_writedata                    (  xcvr_reconfig_writedata                            ) ,    //   input
   .xcvr_reconfig_readdata                     (  xcvr_reconfig_readdata                             ) ,    //   output
   ...
   .reconfig_pll0_write                        (  reconfig_pll0_write                                ) ,    //   input
   .reconfig_pll0_read                         (  reconfig_pll0_read                                 ) ,    //   input
   .reconfig_pll0_address                      (  reconfig_pll0_address                              ) ,    //   input
   .reconfig_pll0_writedata                    (  reconfig_pll0_writedata                            ) ,    //   input
   .reconfig_pll0_readdata                     (  reconfig_pll0_readdata                             ) ,    //   output
   ...
   .reconfig_pll1_write                        (  reconfig_pll1_write                                ) ,    //   input
   .reconfig_pll1_read                         (  reconfig_pll1_read                                 ) ,    //   input
   .reconfig_pll1_address                      (  reconfig_pll1_address                              ) ,    //   input
   .reconfig_pll1_writedata                    (  reconfig_pll1_writedata                            ) ,    //   input
   .reconfig_pll1_readdata                     (  reconfig_pll1_readdata                             ) ,    //   output
   .reconfig_pll1_waitrequest                  (  reconfig_pll1_waitrequest                          ) ,    //   output

   //Unused Multifunction Inputs
   .app_int_1                                  (  ZEROS[0]                                           ),
   .app_msi_func_num                           (  ZEROS[0]                                           ),
   .app_msi_pending                            (  ZEROS[31:0]                                        ),
   .apps_pm_xmt_pme_1                          (  ZEROS[0]                                           ),
   .app_req_retry_en                           (  ZEROS[0]                                           ),
   .app_err_vfunc_num                          (  ZEROS[6:0]                                         ),
   .app_err_func_num                           (  ZEROS[0]                                           ),
   .app_err_vfunc_active                       (  ZEROS[0]                                           ),
   .apps_req_exit_l1                           (  ZEROS[0]                                           ),
   .apps_req_entr_l1                           (  ZEROS[0]                                           ),
   .cfg_buffer_limit_byp                       (  ZEROS[2:0]                                         ),
   .diag_ctrl_bus                              (  {test_in[0],test_in[1],test_in[2] }                ),
   .pld_hip_reserved_in                        (  ZEROS[31:0]                                        ),
   .pld_ltssm_en                               (  ONES[0]                                            ),
   .pld_gp_status                              (  ZEROS[7:0]                                         ),
   .flr_vf_done_tdm                            (  ZEROS[3:0]                                         ),
   .flr_vf_done                                (  ZEROS[7:0]                                         ),
   .flr_pf_done                                (  ZEROS[1:0]                                         ),
   .sys_eml_interlock_engaged                  (  ZEROS[0]                                           ),
   .sys_cmd_cpled_int                          (  ZEROS[0]                                           ),
   .sys_pre_det_chged                          (  ZEROS[0]                                           ),
   .sys_mrl_sensor_chged                       (  ZEROS[0]                                           ),
   .sys_pwr_fault_det                          (  ZEROS[0]                                           ),
   .sys_mrl_sensor_state                       (  ZEROS[0]                                           ),
   .sys_pre_det_state                          (  ZEROS[0]                                           ),
   .sys_atten_button_pressed                   (  ZEROS[0]                                           ),
   .sys_aux_pwr_det                            (  ZEROS[0]                                           ),
   .tx_st_vf_active                            (  ZEROS[0]                                           ),

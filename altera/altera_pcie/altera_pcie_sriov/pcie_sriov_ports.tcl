...
proc add_pcie_sriov_port_clk {} {
   ...
   set_interface_property coreclkout_hip clockRateKnown 1
...
proc add_pcie_sriov_port_ast_rx {} {
   ...
   add_interface_port rx_bar_hit rx_st_mask            rx_st_mask             Input  1
...
proc add_pcie_sriov_port_interrupt {} {
   ...
   add_interface_port int_msi app_msi_status app_msi_status Output 2
   ...
   add_interface_port int_msi app_msix_req    app_msix_req    Input  1
   add_interface_port int_msi app_msix_ack    app_msix_ack    Output 1
   add_interface_port int_msi app_msix_err    app_msix_err    Output 1
   add_interface_port int_msi app_msix_addr   app_msix_addr   Input  64
   add_interface_port int_msi app_msix_data   app_msix_data   Input  32

   add_interface_port int_msi app_msi_addr_pf                 app_msi_addr_pf               Output $TOTAL_PF_COUNT*64
   add_interface_port int_msi app_msi_data_pf                 app_msi_data_pf               Output $TOTAL_PF_COUNT*16
   add_interface_port int_msi app_msi_mask_pf                 app_msi_mask_pf               Output $TOTAL_PF_COUNT*32
   add_interface_port int_msi app_msi_pending_pf              app_msi_pending_pf            Output $TOTAL_PF_COUNT*32
   add_interface_port int_msi app_msi_enable_pf               app_msi_enable_pf             Output $TOTAL_PF_COUNT
   add_interface_port int_msi app_msi_multi_msg_enable_pf     app_msi_multi_msg_enable_pf   Output $TOTAL_PF_COUNT*3

   add_interface_port int_msi app_msix_en_pf                  app_msix_en_pf                Output $TOTAL_PF_COUNT
   add_interface_port int_msi app_msix_fn_mask_pf             app_msix_fn_mask_pf           Output $TOTAL_PF_COUNT
   add_interface_port int_msi app_msix_en_vf                  app_msix_en_vf                Output $TOTAL_VF_COUNT
   add_interface_port int_msi app_msix_fn_mask_vf             app_msix_fn_mask_vf           Output $TOTAL_VF_COUNT
   ...
   add_interface_port int_msi app_int_sts_fn app_int_sts_fn     Input  1

   add_interface_port int_msi app_int_pend_status app_int_pend_status Input 2
   add_interface_port int_msi app_intx_disable app_intx_disable       Output $TOTAL_PF_COUNT

  # (new for phase2)
   add_interface_port int_msi app_msi_pending_bit_write_en    app_msi_pending_bit_write_en    Input  1
   add_interface_port int_msi app_msi_pending_bit_write_data  app_msi_pending_bit_write_data  Input  1
...
proc add_pcie_sriov_port_completion {} {
   ...
   add_interface_port hip_completion cpl_pending_pf  cpl_pending_pf Input $TOTAL_PF_COUNT
   add_interface_port hip_completion cpl_pending_vf  cpl_pending_vf Input $TOTAL_VF_COUNT
...
proc add_pcie_sriov_port_cfgstatus {} {
   ...
   add_interface_port cfg_status  bus_num_f1        bus_num_f1         Output  8
   add_interface_port cfg_status  device_num_f0     device_num_f0      Output  5
   add_interface_port cfg_status  device_num_f1     device_num_f1      Output  5
   add_interface_port cfg_status  mem_space_en_pf   mem_space_en_pf    Output  $TOTAL_PF_COUNT
   add_interface_port cfg_status  bus_master_en_pf  bus_master_en_pf   Output  $TOTAL_PF_COUNT
   add_interface_port cfg_status  mem_space_en_vf   mem_space_en_vf    Output  $TOTAL_PF_COUNT
   add_interface_port cfg_status  bus_master_en_vf  bus_master_en_vf   Output  $TOTAL_VF_COUNT
   add_interface_port cfg_status  pf0_num_vfs       pf0_num_vfs        Output  8
   add_interface_port cfg_status  pf1_num_vfs       pf1_num_vfs        Output  8
...
proc add_pcie_sriov_port_flr {} {
   ...
   add_interface_port flr  flr_active_pf     flr_active_pf     Output   $TOTAL_PF_COUNT
   add_interface_port flr  flr_active_vf     flr_active_vf     Output   $TOTAL_VF_COUNT
   add_interface_port flr  flr_completed_pf  flr_completed_pf  Input    $TOTAL_PF_COUNT
   add_interface_port flr  flr_completed_vf  flr_completed_vf  Input    $TOTAL_VF_COUNT
}

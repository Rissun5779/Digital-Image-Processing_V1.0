...
module altera_pcie_sriov_hwtcl # (
      ...
      parameter class_code_hwtcl                                  = 255,
      ...
      parameter hip_tag_checking_hwtcl                         = 0, // Disable for SRIOV to allow upto 256 tags and user must handle tag checking in their logic
      ...
      parameter PF0_VF_COUNT_USER      = 64, // Qsys user input value: Number of VFs attached to PF 0
      parameter PF1_VF_COUNT_USER      = 64, // Qsys user input value: Number of VFs attached to PF 0
      ...
      parameter sriov_flr_capability_hwtcl = 0,
   ...
   // Config Space pointers
      parameter VF_MSIX_MULTI_MSG_CAPABLE = 3'd1,
   ...
   input [6:0]            cpl_err,    // Error indications for Function 0 from user application
    ...
    input [TOTAL_PF_COUNT-1:0]  cpl_pending_pf, // Completion pending status from PF 0
    input [TOTAL_VF_COUNT-1:0]  cpl_pending_vf, // Completion pending status from VFs
    input [127:0]               log_hdr,        // TLP header for logging
   //###################################################################################
   // FLR Interface
   //###################################################################################
    output [TOTAL_PF_COUNT-1:0] flr_active_pf,    // FLR status for PF 0
    output [TOTAL_VF_COUNT-1:0] flr_active_vf, // FLR status for VFs
    input  [TOTAL_PF_COUNT-1:0] flr_completed_pf, // Indication from user to re-enable PF 0 after FLR
   ...
   input                  app_int_sts_fn, // Function Num associated with the Legacy interrupt request
   ...
   input  [1:0]           app_int_pend_status,  // Interrupt pending status from Function
   ...
   localparam MSI_64_ADDR_CAP  = (msi_64bit_addressing_capable_hwtcl == 1) ? "true" : "false";
   localparam MSI_SUPPORT      = (msi_support_hwtcl == 1) ? "true" : "false";
   localparam EXTEND_TAG_FIELD = (extend_tag_field_hwtcl == 1) ? "true" : "false";


   wire [multiple_packets_per_cycle_hwtcl:0]   dut_rx_st_sop;
   wire [multiple_packets_per_cycle_hwtcl:0]   dut_rx_st_eop;
   ...
   wire   [link2csr_width_hwtcl-1:0] cfgbp_link2csr; // bridge:cfgbp_link2csr -> DUT:cfgbp_link2csr
...
//===========================================
   ...
   altpcie_sv_hip_ast_hwtcl #(
      ...
      .msi_64bit_addressing_capable_hwtcl       (MSI_64_ADDR_CAP                          ),
      .msi_masking_capable_hwtcl                (msi_masking_capable_hwtcl                ),
      .msi_support_hwtcl                        (MSI_SUPPORT                              ),
      ...
      .use_tx_cons_cred_sel_hwtcl               (use_tx_cons_cred_sel_hwtcl              ),
      ...
      .gen123_lane_rate_mode_hwtcl      (gen123_lane_rate_mode_hwtcl),
      .lane_mask_hwtcl                  (lane_mask_hwtcl ),
      .pll_refclk_freq_hwtcl            (pll_refclk_freq_hwtcl  ), // TBD??
      .use_ast_parity                   (use_ast_parity         ),
      ...
      .slotclkcfg_hwtcl                 (slotclkcfg_hwtcl       ),
      .pf0_vendor_id_hwtcl              (vendor_id_hwtcl        ),
      .pf1_vendor_id_hwtcl              (pf1_vendor_id_hwtcl    ),
      .pf0_device_id_hwtcl              (device_id_hwtcl        ),
      .pf1_device_id_hwtcl              (pf1_device_id_hwtcl    ),
      .pf0_revision_id_hwtcl            (revision_id_hwtcl      ),
      .pf1_revision_id_hwtcl            (pf1_revision_id_hwtcl  ),
      .pf0_class_code_hwtcl             (class_code_hwtcl       ),
      .pf1_class_code_hwtcl             (pf1_class_code_hwtcl   ),
      .pf0_subsystem_vendor_id_hwtcl    (subsystem_vendor_id_hwtcl),
      .pf1_subsystem_vendor_id_hwtcl    (pf1_subsystem_vendor_id_hwtcl),
      .pf0_subsystem_device_id_hwtcl    (subsystem_device_id_hwtcl),
      ...
      .completion_timeout_hwtcl         (completion_timeout_hwtcl         ),
      .enable_completion_timeout_disable_hwtcl (enable_completion_timeout_disable_hwtcl ),
      .pf0_msi_multi_message_capable_hwtcl  (msi_multi_message_capable_hwtcl),
      ...
      .enable_function_msix_support_hwtcl   (enable_function_msix_support_hwtcl),
      .pf0_msix_table_size_hwtcl            (msix_table_size_hwtcl      ),
      .pf1_msix_table_size_hwtcl            (pf1_msix_table_size_hwtcl      ),
      .pf0_msix_table_bir_hwtcl             (msix_table_bir_hwtcl ),
      .pf1_msix_table_bir_hwtcl             (pf1_msix_table_bir_hwtcl ),
      .pf0_msix_table_offset_hwtcl          (msix_table_offset_hwtcl    ),
      .pf1_msix_table_offset_hwtcl          (pf1_msix_table_offset_hwtcl    ),
      .pf0_msix_pba_bir_hwtcl               (msix_pba_bir_hwtcl         ),
      .pf1_msix_pba_bir_hwtcl               (pf1_msix_pba_bir_hwtcl     ),
      .pf0_msix_pba_offset_hwtcl            (msix_pba_offset_hwtcl      ),
      .pf1_msix_pba_offset_hwtcl            (pf1_msix_pba_offset_hwtcl  ),
      .l0_exit_latency_sameclock_hwtcl      (l0_exit_latency_sameclock_hwtcl),
      .flr_capability_hwtcl                 (sriov_flr_capability_hwtcl ),

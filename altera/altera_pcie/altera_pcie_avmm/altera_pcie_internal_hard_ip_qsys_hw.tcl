...
set_module_property DESCRIPTION "Altera PCIe Internal Hard IP QSYS"
set_module_property NAME altera_pcie_internal_hard_ip_qsys
set_module_property VERSION 18.1
set_module_property DATASHEET_URL "https://www.altera.com/products/intellectual-property/all-ip/interface-protocols/m-alt-pcie8.html"
set_module_property AUTHOR Altera
set_module_property DISPLAY_NAME "Altera PCIe Internal Hard IP QSYS"
set_module_property TOP_LEVEL_HDL_FILE "altpcie_hip_pipen1b_qsys.v"
set_module_property TOP_LEVEL_HDL_MODULE altpcie_hip_pipen1b_qsys
set_module_property "instantiateInSystemModule" "true"
set_module_property EDITABLE false
set_module_property INTERNAL true
set_module_property HIDE_FROM_QUARTUS true
set_module_property HIDE_FROM_QSYS true
set_module_property SUPPORTED_DEVICE_FAMILIES {"Stratix IV" "ARRIA II GX" "ARRIA II GZ" "CYCLONE IV GX" }
...
set_fileset_property synth TOP_LEVEL altpcie_hip_pipen1b_qsys

# # +-----------------------------------
# # | SIM_ design files
#   |
add_fileset sim_vhdl SIM_VHDL proc_sim_vhdl
set_fileset_property sim_vhdl TOP_LEVEL altpcie_hip_pipen1b_qsys

add_fileset sim_verilog SIM_VERILOG proc_sim_verilog
set_fileset_property sim_verilog TOP_LEVEL altpcie_hip_pipen1b_qsys
...
add_interface msi_interface_export conduit end
add_interface_port msi_interface_export app_msi_req app_msi_req Input 1
add_interface_port msi_interface_export app_msi_num app_msi_num Input 5
add_interface_port msi_interface_export app_msi_ack app_msi_ack Output 1
# +-----------------------------------
...
proc add_master { master_name  rxm_data_width } {
   ...
   set rx_single_dw [ get_parameter_value CB_PCIE_RX_LITE ]
 ...
 for { set i 0 } { $i < 6 } { incr i } {
  ...
  set BarUsed        [ expr  [ string compare -nocase $value_at_index "Not used" ] == 0   ? 0 : 1 ]
  set BarPrefecth    [ expr  ( $Bar64 == 1 ) && ( $BarUsed == 1 )  ? 0 : 1 ]
  set Bar64_prev 0
   if { ( $i==1 ||$i==3 || $i ==5) && ( $Bar64_prev == 1) } {
         set BarUsed 0
      }
   if { $BarUsed == 1 } {
         add_interface          "Rxm_BAR${i}" "avalon" "master" "avalon_clk"
         ...
         set_interface_property "Rxm_BAR${i}" "maxAddressWidth" 32
         set_interface_property "Rxm_BAR${i}" "addressGroup" ${i}

         add_interface_port     "Rxm_BAR${i}"  "RxmAddress_${i}_o" "address" "output" 32
...
proc proc_quartus_synth {name} {
   ...
   add_fileset_file altpcie_hip_pipen1b_qsys.v         VERILOG PATH altpcie_hip_pipen1b_qsys.v
   add_fileset_file altera_pci_express.sdc              SDC     PATH altera_pci_express.sdc
   add_fileset_file altpciexpav_stif_a2p_addrtrans.v    VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_a2p_addrtrans.v
   add_fileset_file altpciexpav_stif_a2p_fixtrans.v     VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_a2p_fixtrans.v
   add_fileset_file altpciexpav_stif_a2p_vartrans.v     VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_a2p_vartrans.v
   add_fileset_file altpciexpav_stif_app.v              VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_app.v
   add_fileset_file altpciexpav_stif_control_register.v VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_control_register.v
   add_fileset_file altpciexpav_stif_cfg_status.v       VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_cfg_status.v
   add_fileset_file altpciexpav_stif_cr_avalon.v        VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_cr_avalon.v
   add_fileset_file altpciexpav_stif_cr_interrupt.v     VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_cr_interrupt.v
   add_fileset_file altpciexpav_stif_cr_mailbox.v       VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_cr_mailbox.v
   add_fileset_file altpciexpav_stif_p2a_addrtrans.v    VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_p2a_addrtrans.v
   add_fileset_file altpciexpav_stif_reg_fifo.v         VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_reg_fifo.v
   add_fileset_file altpciexpav_stif_rx.v               VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_rx.v
   add_fileset_file altpciexpav_stif_rx_cntrl.v         VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_rx_cntrl.v
   add_fileset_file altpciexpav_stif_rx_resp.v          VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_rx_resp.v
   add_fileset_file altpciexpav_stif_tx.v               VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_tx.v
   add_fileset_file altpciexpav_stif_tx_cntrl.v         VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_tx_cntrl.v
   add_fileset_file altpciexpav_stif_txavl_cntrl.v      VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_txavl_cntrl.v
   add_fileset_file altpciexpav_stif_txresp_cntrl.v     VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_stif_txresp_cntrl.v
   add_fileset_file altpciexpav_clksync.v               VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_stif/altpciexpav_clksync.v
   add_fileset_file altpciexpav_lite_app.v              VERILOG PATH $QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/avalon_lite/altpciexpav_lite_app.v
}
...
proc proc_sim_vhdl {name} {
    set verilog_file_common_rtl {
                         ...
                         "avalon_stif/altpciexpav_stif_a2p_addrtrans.v"
  ...
  foreach vf $verilog_file_common_rtl {
      ...
      add_fileset_file  altpcie_hip_pipen1b_qsys.v        VERILOG_ENCRYPT PATH "mentor/altpcie_hip_pipen1b_qsys.v"     {MENTOR_SPECIFIC}
      add_fileset_file  altpcie_hip_pipen1b_qsys.v        VERILOG_ENCRYPT PATH "mentor/altpcie_hip_pipen1b_qsys.v"     {ALDEC_SPECIFIC}

      if { 1 } {
      add_fileset_file  altpcie_hip_pipen1b_qsys.v        VERILOG_ENCRYPT PATH "altpcie_hip_pipen1b_qsys.v"      {CADENCE_SPECIFIC}
      }
      if { 1 } {
      add_fileset_file  altpcie_hip_pipen1b_qsys.v        VERILOG_ENCRYPT PATH "altpcie_hip_pipen1b_qsys.v"      {SYNOPSYS_SPECIFIC}
   }
...
proc proc_sim_verilog {name} {
  ...
  foreach vf $verilog_file {
      add_fileset_file mentor/${vf} VERILOG_ENCRYPT PATH "$QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/mentor/${vf}" {MENTOR_SPECIFIC}
      add_fileset_file aldec/${vf} VERILOG_ENCRYPT PATH "$QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/aldec/${vf}" {ALDEC_SPECIFIC}
      #add_fileset_file aldec/${vf} VERILOG_ENCRYPT PATH "aldec/${vf}" {ALDEC_SPECIFIC}
      if { 1 } {
         add_fileset_file cadence/${vf} VERILOG_ENCRYPT PATH "$QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/cadence/${vf}" {CADENCE_SPECIFIC}
      }
      if { 1 } {
         add_fileset_file synopsys/${vf} VERILOG_ENCRYPT PATH "$QUARTUS_ROOTDIR/../ip/altera/altera_pcie/altera_pcie_av_hip_avmm/synopsys/${vf}" {SYNOPSYS_SPECIFIC}
      }
   }

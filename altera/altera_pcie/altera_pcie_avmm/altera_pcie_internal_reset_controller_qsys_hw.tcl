...
# |
# | $Header: //acds/rel/18.1std/ip/altera_pcie/altera_pcie_avmm/altera_pcie_internal_reset_controller_qsys_hw.tcl#1 $
# |
# |
# |
# +-----------------------------------
...
set_module_property SUPPORTED_DEVICE_FAMILIES {"Stratix IV" "ARRIA II GZ" "ARRIA II GX" "Cyclone IV GX"}

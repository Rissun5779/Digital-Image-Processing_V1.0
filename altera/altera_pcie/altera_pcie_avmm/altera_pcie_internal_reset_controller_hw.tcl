...
# |
# | $Header: //acds/rel/18.1std/ip/altera_pcie/altera_pcie_avmm/altera_pcie_internal_reset_controller_hw.tcl#1 $
# |
# |
# |
# +-----------------------------------
...
set_module_property NAME altera_pcie_internal_reset_controller
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property HIDE_FROM_QUARTUS true
set_module_property HIDE_FROM_QSYS true
set_module_property GROUP "Interface Protocols/PCI Express"
set_module_property DISPLAY_NAME "altera_pcie_internal_reset_controller"
...
add_file altera_pcie_hard_ip_reset_controller.v {simulation synthesis}
add_file $qdir/../ip/altera/ip_compiler_for_pci_express/lib/altpcie_rs_serdes.v {simulation synthesis}
add_file $qdir/../ip/altera/ip_compiler_for_pci_express/lib/altpcie_pll_100_250.v {simulation synthesis}
add_file $qdir/../ip/altera/ip_compiler_for_pci_express/lib/altpcie_pll_125_250.v {simulation synthesis}
# |
# +-----------------------------------

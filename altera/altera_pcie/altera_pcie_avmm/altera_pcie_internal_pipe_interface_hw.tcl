...
# |
# | $Header: //acds/rel/18.1std/ip/altera_pcie/altera_pcie_avmm/altera_pcie_internal_pipe_interface_hw.tcl#1 $
# |
# |
# |
# +-----------------------------------
...
# |
set_module_property NAME altera_pcie_internal_pipe_interface
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property HIDE_FROM_QUARTUS true
set_module_property HIDE_FROM_QSYS true
set_module_property SUPPORTED_DEVICE_FAMILIES {"Stratix IV" }
set_module_property GROUP "Interface Protocols/PCI Express"
set_module_property DISPLAY_NAME "altera_pcie_internal_pipe_interface"
...
# | files
# |
add_file altpcie_pipe_interface.v {SYNTHESIS SIMULATION}
# |
# +-----------------------------------
...
add_interface_port pipe_interface_export pll_powerdown pll_powerdown Input 1
add_interface_port pipe_interface_export gxb_powerdown gxb_powerdown Input 1

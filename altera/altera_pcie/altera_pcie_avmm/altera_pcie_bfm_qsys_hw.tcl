...
# | altera_pcie_bfm
# |
# | $Header: //acds/rel/18.1std/ip/altera_pcie/altera_pcie_avmm/altera_pcie_bfm_qsys_hw.tcl#1 $
# |
# |
# |
# +-----------------------------------
...
set_module_property NAME altera_pcie_bfm_qsys
set_module_property VERSION 18.1
set_module_property INTERNAL true
set_module_property HIDE_FROM_QUARTUS true
set_module_property HIDE_FROM_QSYS true
set_module_property SUPPORTED_DEVICE_FAMILIES {"Stratix IV" "Cyclone IV"}
set_module_property GROUP "Interface Protocols/PCI Express"
set_module_property AUTHOR Altera
set_module_property DISPLAY_NAME "altera_pcie_bfm_qsys"
...
set_fileset_property sim_verilog TOP_LEVEL altera_pcie_bfm
...
proc proc_sim_verilog {name} {
 ...
 add_fileset_file altera_pcie_bfm.v                    VERILOG PATH altera_pcie_bfm.v
 add_fileset_file altera_pcie_bfm_components.v         VERILOG PATH testbench/verilog/common/altera_pcie_bfm_components.v
 add_fileset_file altpcietb_bfm_driver.v               VERILOG PATH  testbench/verilog/qsys/altpcietb_bfm_driver.v
 add_fileset_file stratixiv_hssi_atoms.v               VERILOG PATH  $QUARTUS_ROOTDIR/eda/sim_lib/stratixiv_hssi_atoms.v
 add_fileset_file stratixiv_pcie_hip_atoms.v           VERILOG PATH  $QUARTUS_ROOTDIR/eda/sim_lib/stratixiv_pcie_hip_atoms.v
 add_fileset_file cycloneiv_hssi_atoms.v               VERILOG PATH  $QUARTUS_ROOTDIR/eda/sim_lib/cycloneiv_hssi_atoms.v
 add_fileset_file cycloneiv_pcie_hip_atoms.v           VERILOG PATH  $QUARTUS_ROOTDIR/eda/sim_lib/cycloneiv_pcie_hip_atoms.v
...
add_interface_port powerdown gxb_powerdown gxb_powerdown Output 1
add_interface_port powerdown pll_powerdown pll_powerdown Output 1

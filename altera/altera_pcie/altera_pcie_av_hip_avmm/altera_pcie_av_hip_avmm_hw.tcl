...
source pcie_av_avmm_parameters.tcl
source pcie_av_avmm_port.tcl
...
# | module PCI Express
# |
set_module_property NAME altera_pcie_av_hip_avmm
set_module_property DESCRIPTION "Avalon-MM Arria V Hard IP for PCI Express Intel FPGA IP"
set_module_property VERSION 18.1
set_module_property GROUP "Interface Protocols/PCI Express"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Avalon-MM Arria V Hard IP for PCI Express Intel FPGA IP"
set_module_property HIDE_FROM_QUARTUS true
set_module_property HIDE_FROM_QSYS false
set_module_property INTERNAL false
set_module_property SUPPORTED_DEVICE_FAMILIES {"ARRIA V"}
...
# # | Global parameters
#   |
add_parameter INTENDED_DEVICE_FAMILY String "ARRIA V"
...
set_fileset_property synth TOP_LEVEL altpcie_av_hip_avmm_hwtcl

# # +-----------------------------------
# # | SIM_ design files
#   |
add_fileset sim_vhdl SIM_VHDL proc_sim_vhdl
set_fileset_property sim_vhdl TOP_LEVEL altpcie_av_hip_avmm_hwtcl

add_fileset sim_verilog SIM_VERILOG proc_sim_verilog
set_fileset_property sim_verilog TOP_LEVEL altpcie_av_hip_avmm_hwtcl
...
proc elaboration_callback { } {
   ...
   for { set i 0 } { $i < 6 } { incr i } {
      ...
      if { [ regexp endpoint $port_type_hwtcl ] } {
         ...
         set_module_assignment embeddedsw.dts.params.device_type "pci"
...
proc proc_quartus_synth {name} {
   add_fileset_file altpcie_av_hip_avmm_hwtcl.v         VERILOG PATH altpcie_av_hip_avmm_hwtcl.v
   ...
   add_fileset_file altpciexpav_stif_a2p_addrtrans.v    VERILOG PATH avalon_stif/altpciexpav_stif_a2p_addrtrans.v
   add_fileset_file altpciexpav_stif_a2p_fixtrans.v     VERILOG PATH avalon_stif/altpciexpav_stif_a2p_fixtrans.v
   add_fileset_file altpciexpav_stif_a2p_vartrans.v     VERILOG PATH avalon_stif/altpciexpav_stif_a2p_vartrans.v
   add_fileset_file altpciexpav_stif_app.v              VERILOG PATH avalon_stif/altpciexpav_stif_app.v
   add_fileset_file altpciexpav_stif_control_register.v VERILOG PATH avalon_stif/altpciexpav_stif_control_register.v
   add_fileset_file altpciexpav_stif_cr_avalon.v        VERILOG PATH avalon_stif/altpciexpav_stif_cr_avalon.v
   add_fileset_file altpciexpav_stif_cr_interrupt.v     VERILOG PATH avalon_stif/altpciexpav_stif_cr_interrupt.v
   add_fileset_file altpciexpav_stif_cr_rp.v            VERILOG PATH avalon_stif/altpciexpav_stif_cr_rp.v
   add_fileset_file altpciexpav_stif_cfg_status.v       VERILOG PATH avalon_stif/altpciexpav_stif_cfg_status.v
   add_fileset_file altpciexpav_stif_cr_mailbox.v       VERILOG PATH avalon_stif/altpciexpav_stif_cr_mailbox.v
   add_fileset_file altpciexpav_stif_p2a_addrtrans.v    VERILOG PATH avalon_stif/altpciexpav_stif_p2a_addrtrans.v
   add_fileset_file altpciexpav_stif_reg_fifo.v         VERILOG PATH avalon_stif/altpciexpav_stif_reg_fifo.v
   add_fileset_file altpciexpav_stif_rx.v               VERILOG PATH avalon_stif/altpciexpav_stif_rx.v
   add_fileset_file altpciexpav_stif_rx_cntrl.v         VERILOG PATH avalon_stif/altpciexpav_stif_rx_cntrl.v
   add_fileset_file altpciexpav_stif_rx_resp.v          VERILOG PATH avalon_stif/altpciexpav_stif_rx_resp.v
   add_fileset_file altpciexpav_stif_tx.v               VERILOG PATH avalon_stif/altpciexpav_stif_tx.v
   add_fileset_file altpciexpav_stif_tx_cntrl.v         VERILOG PATH avalon_stif/altpciexpav_stif_tx_cntrl.v
   add_fileset_file altpciexpav_stif_txavl_cntrl.v      VERILOG PATH avalon_stif/altpciexpav_stif_txavl_cntrl.v
   add_fileset_file altpciexpav_stif_txresp_cntrl.v     VERILOG PATH avalon_stif/altpciexpav_stif_txresp_cntrl.v
   add_fileset_file altpciexpav_clksync.v               VERILOG PATH avalon_stif/altpciexpav_clksync.v
   add_fileset_file altpciexpav128_a2p_addrtrans.v      VERILOG PATH avalon_mm_128/altpciexpav128_a2p_addrtrans.v
   add_fileset_file altpciexpav128_a2p_fixtrans.v       VERILOG PATH avalon_mm_128/altpciexpav128_a2p_fixtrans.v
   add_fileset_file altpciexpav128_a2p_vartrans.v       VERILOG PATH avalon_mm_128/altpciexpav128_a2p_vartrans.v
   add_fileset_file altpciexpav128_app.v                VERILOG PATH avalon_mm_128/altpciexpav128_app.v
   add_fileset_file altpciexpav128_clksync.v            VERILOG PATH avalon_mm_128/altpciexpav128_clksync.v
   add_fileset_file altpciexpav128_control_register.v   VERILOG PATH avalon_mm_128/altpciexpav128_control_register.v
   add_fileset_file altpciexpav128_cr_rp.v              VERILOG PATH avalon_mm_128/altpciexpav128_cr_rp.v
   add_fileset_file altpciexpav128_cfg_status.v         VERILOG PATH avalon_mm_128/altpciexpav128_cfg_status.v
   add_fileset_file altpciexpav128_cr_avalon.v          VERILOG PATH avalon_mm_128/altpciexpav128_cr_avalon.v
   add_fileset_file altpciexpav128_cr_interrupt.v       VERILOG PATH avalon_mm_128/altpciexpav128_cr_interrupt.v
   add_fileset_file altpciexpav128_cr_mailbox.v         VERILOG PATH avalon_mm_128/altpciexpav128_cr_mailbox.v
   add_fileset_file altpciexpav128_p2a_addrtrans.v      VERILOG PATH avalon_mm_128/altpciexpav128_p2a_addrtrans.v
   add_fileset_file altpciexpav128_rx.v                 VERILOG PATH avalon_mm_128/altpciexpav128_rx.v
   add_fileset_file altpciexpav128_rx_cntrl.v           VERILOG PATH avalon_mm_128/altpciexpav128_rx_cntrl.v
   add_fileset_file altpciexpav128_fifo.v               VERILOG PATH avalon_mm_128/altpciexpav128_fifo.v
   add_fileset_file altpciexpav128_rxm_adapter.v        VERILOG PATH avalon_mm_128/altpciexpav128_rxm_adapter.v
   add_fileset_file altpciexpav128_rx_resp.v            VERILOG PATH avalon_mm_128/altpciexpav128_rx_resp.v
   add_fileset_file altpciexpav128_tx.v                 VERILOG PATH avalon_mm_128/altpciexpav128_tx.v
   add_fileset_file altpciexpav128_tx_cntrl.v           VERILOG PATH avalon_mm_128/altpciexpav128_tx_cntrl.v
   add_fileset_file altpciexpav128_txavl_cntrl.v        VERILOG PATH avalon_mm_128/altpciexpav128_txavl_cntrl.v
   add_fileset_file altpciexpav128_txresp_cntrl.v       VERILOG PATH avalon_mm_128/altpciexpav128_txresp_cntrl.v
   add_fileset_file altpciexpav128_underflow_adapter.v  VERILOG PATH avalon_mm_128/altpciexpav128_underflow_adapter.v
   add_fileset_file altpciexpav_lite_app.v              VERILOG PATH avalon_lite/altpciexpav_lite_app.v
...
proc proc_sim_vhdl {name} {
     set verilog_file_common_rtl  {"avalon_stif/altpciexpav_stif_a2p_addrtrans.v"
                        ...
                        "avalon_stif/altpciexpav_stif_cfg_status.v"
                        ...
                        "avalon_mm_128/altpciexpav128_cfg_status.v"
  ...
  foreach vf $verilog_file_common_rtl {
      ...
      add_fileset_file mentor/altpcie_av_hip_avmm_hwtcl.v        VERILOG_ENCRYPT PATH "mentor/altpcie_av_hip_avmm_hwtcl.v"                                                        {MENTOR_SPECIFIC}
      ...
      add_fileset_file aldec/altpcie_av_hip_avmm_hwtcl.v         VERILOG_ENCRYPT PATH "altpcie_av_hip_avmm_hwtcl.v"                                                        {MENTOR_SPECIFIC}
      add_fileset_file aldec/altpcie_av_hip_ast_hwtcl.v          VERILOG_ENCRYPT PATH "../altera_pcie_av_hip_ast/altpcie_av_hip_ast_hwtcl.v"                               {MENTOR_SPECIFIC}
      add_fileset_file aldec/altpcie_av_hip_128bit_atom.v        VERILOG_ENCRYPT PATH "../altera_pcie_av_hip_ast/altpcie_av_hip_128bit_atom.v"                             {MENTOR_SPECIFIC}
      add_fileset_file aldec/altpcie_rs_hip.v                    VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_ast/altpcie_rs_hip.v"                                         {MENTOR_SPECIFIC}
      add_fileset_file aldec/altpcie_rs_serdes.v                 VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_ast/altpcie_rs_serdes.v"                                      {MENTOR_SPECIFIC}
      add_fileset_file aldec/altpcierd_hip_rs.v                  VERILOG_ENCRYPT PATH "../altera_pcie_hip_ast_ed/example_design/verilog/chaining_dma/altpcierd_hip_rs.v"   {MENTOR_SPECIFIC}


      if { 1 } {
      add_fileset_file  altpcie_av_hip_avmm_hwtcl.v        VERILOG_ENCRYPT PATH "altpcie_av_hip_avmm_hwtcl.v"                                                        {CADENCE_SPECIFIC}
      ...
      if { 1 } {
      add_fileset_file  altpcie_av_hip_avmm_hwtcl.v        VERILOG_ENCRYPT PATH "altpcie_av_hip_avmm_hwtcl.v"                                                        {SYNOPSYS_SPECIFIC}
...
proc proc_sim_verilog {name} {
  ...
  foreach vf $verilog_file {
      add_fileset_file ${vf} VERILOG PATH "../altera_pcie_av_hip_avmm/${vf}"
   }
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/lbl1415396714643/nik1410905278518

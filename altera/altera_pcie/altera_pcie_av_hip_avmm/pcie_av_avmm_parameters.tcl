...
#   set_display_item_property ${group_name} display_hint tab
   ...
   set_parameter_property user_id_hwtcl DISPLAY_NAME "User Device or Board Type ID register from the Vendor Specific Extended Capability"
   ...
   set_parameter_property user_id_hwtcl VISIBLE false

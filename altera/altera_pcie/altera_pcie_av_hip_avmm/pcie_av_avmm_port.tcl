...
proc add_pcie_hip_port_interrupt {} {
   ...
   set_interface_assignment MSI_Interface "ui.blockdiagram.direction" "OutPut"

   add_interface MSI_Control      conduit end
   add_interface_port MSI_Control    MsiControl_o msi_control Output 16
   set_interface_assignment MSI_Control "ui.blockdiagram.direction" "OutPut"

   add_interface MSIX_Interface      conduit end
   add_interface_port MSIX_Interface    MsixIntfc_o msix_intfc Output 16
   set_interface_assignment MSIX_Interface "ui.blockdiagram.direction" "Output"
...
proc add_pcie_hip_status_ext {} {
    ...
    add_to_no_connect hpg_ctrler 5 In
}

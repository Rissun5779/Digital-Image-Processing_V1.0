...
source ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_avmm/pcie_sv_avmm_parameters.tcl
source ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_avmm/pcie_sv_avmm_port.tcl
source ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_avmm/pcie_parameters_validation.tcl
...
# | module PCI Express
# |
set_module_property NAME altera_pcie_avgz_hip_avmm
set_module_property DESCRIPTION "Avalon-MM Arria V GZ Hard IP for PCI Express Intel FPGA IP"
set_module_property VERSION 18.1
set_module_property GROUP "Interface Protocols/PCI Express"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Avalon-MM Arria V GZ Hard IP for PCI Express Intel FPGA IP"
...
proc proc_quartus_synth {name} {
   ...
   add_fileset_file altpcie_sv_hip_avmm_hwtcl.v         VERILOG PATH ../altera_pcie_sv_hip_avmm/altpcie_sv_hip_avmm_hwtcl.v
...
proc proc_sim_vhdl {name} {
   ...
   add_fileset_file mentor/altpcie_sv_hip_avmm_hwtcl.v         VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_avmm/mentor/altpcie_sv_hip_avmm_hwtcl.v"                                                        {MENTOR_SPECIFIC}
   ...
   add_fileset_file aldec/altpcie_sv_hip_avmm_hwtcl.v         VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_avmm/altpcie_sv_hip_avmm_hwtcl.v"                                                        {ALDEC_SPECIFIC}
   ...
   if { 1 } {
      add_fileset_file  altpcie_sv_hip_avmm_hwtcl.v        VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_avmm/altpcie_sv_hip_avmm_hwtcl.v"                                                        {CADENCE_SPECIFIC}
   ...
   if { 1 } {
      add_fileset_file  altpcie_sv_hip_avmm_hwtcl.v        VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_avmm/altpcie_sv_hip_avmm_hwtcl.v"                                                        {SYNOPSYS_SPECIFIC}
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/lbl1415317521608/nik1410905278518

...
# Parity error
if { $INTENDED_DEVICE_FAMILY == "Stratix V" || $INTENDED_DEVICE_FAMILY == "Arria V GZ" } {
  ...
  add_to_no_connect dlup 1 Out
  add_to_no_connect rx_par_err 1 Out
  add_to_no_connect tx_par_err 2 Out
  add_to_no_connect cfg_par_err 1 Out
}
...
proc add_pcie_hip_port_avmm_rxmaster {} {
   ...
   set  rxm_burst_hwtcl [ get_parameter_value enable_rxm_burst_hwtcl ]
   ...
   for { set i 0 } { $i < 6 } { incr i } {
      ...
      if { ( $i==1 ||$i==3 || $i ==5) && ( $Bar64_prev == 1) } {
         set BarUsed 0
      } elseif { $bar_type > 1 } {
         if { $internal_controller_hwtcl == 1 && $i == 0 } {
          set BarUsed 0
         } else {
          set BarUsed 1
         }
...
## Port HP Rxm Master use BAR2-3

proc add_pcie_hip_port_avmm_hprxmaster {} {
   ...
   set  bar_size_mask_hwtcl(4) [ get_parameter_value bar4_size_mask_hwtcl ]
   set  bar_size_mask_hwtcl(5) [ get_parameter_value bar5_size_mask_hwtcl ]
   set  hprxm_data_width [ get_parameter_value DMA_WIDTH ]
   set  internal_controller_hwtcl [ get_parameter_value internal_controller_hwtcl ]
   set  bar2_type [ get_parameter_value "bar2_type_hwtcl" ]
   set  rxm_burst_hwtcl [ get_parameter_value enable_rxm_burst_hwtcl ]
   set  rxm_burst_count_width [ get_parameter_value DMA_BRST_CNT_W ]
  

   if {$rxm_burst_hwtcl == 1 && $bar2_type > 1} {

   add_interface          "Rxm_BAR2" "avalon" "master" "coreclkout"
   set_interface_property "Rxm_BAR2" "interleaveBursts" "false"
   set_interface_property "Rxm_BAR2" "doStreamReads" "false"
   set_interface_property "Rxm_BAR2" "doStreamWrites" "false"
   set_interface_property "Rxm_BAR2" "maxAddressWidth"  $bar2_type
   set_interface_property "Rxm_BAR2" "addressGroup" 2
   send_message info " High Performance BAR 2 size mask is $bar_size_mask_hwtcl(2)"
   add_interface_port     "Rxm_BAR2"  "HPRxmAddress_o" "address" "output"  $bar2_type
   add_interface_port     "Rxm_BAR2"  "HPRxmRead_o" "read" "output" 1
   add_interface_port     "Rxm_BAR2"  "HPRxmWaitRequest_i" "waitrequest" "input" 1
   add_interface_port     "Rxm_BAR2"  "HPRxmWrite_o" "write" "output" 1
   add_interface_port     "Rxm_BAR2"  "HPRxmReadDataValid_i" "readdatavalid" "input" 1
   add_interface_port     "Rxm_BAR2"  "HPRxmReadData_i" "readdata" "input" $hprxm_data_width
   add_interface_port     "Rxm_BAR2"  "HPRxmWriteData_o" "writedata" "output" $hprxm_data_width
   add_interface_port     "Rxm_BAR2"  "HPRxmBurstCount_o" "burstcount" "output" $rxm_burst_count_width
   add_interface_port     "Rxm_BAR2"  "HPRxmByteEnable_o" "byteenable" "output" [ expr $hprxm_data_width/8 ]
 }
...
proc add_pcie_hip_port_avmm_rd_master {} {
         ...
         set rd_data_width [ get_parameter_value DMA_WIDTH ]
         set rd_burst_count [ get_parameter_value DMA_BRST_CNT_W ]
         ...
         add_interface_port     "dma_rd_master" "RdDmaBurstCount_o" "burstcount" "output" $rd_burst_count
...
proc add_pcie_hip_port_avmm_wr_master {} {
         ...
         set wr_data_width [ get_parameter_value DMA_WIDTH ]
         set wr_burst_count [ get_parameter_value DMA_BRST_CNT_W ]
         ...
         add_interface_port     "dma_wr_master" "WrDmaBurstCount_o" "burstcount" "output" $wr_burst_count
         ...
         if { $wr_data_width == 256 } {
            add_interface_port     "dma_wr_master" "WrDmaByteEnable_o" "byteenable" "output" [ expr $wr_data_width/8 ]
         }
}

####################################################################################################
#
# Avalon-MM DCM Master
#

proc add_pcie_hip_port_avmm_dcm_master {} {
      set internal_controller_hwtcl [ get_parameter_value internal_controller_hwtcl ]
      if { $internal_controller_hwtcl == 1 } {
         add_interface          "wr_dcm_master" "avalon" "master" "coreclkout"
         set_interface_property "wr_dcm_master" "interleaveBursts" "false"
         set_interface_property "wr_dcm_master" "doStreamReads" "false"
         set_interface_property "wr_dcm_master" "doStreamWrites" "false"
         set_interface_property "wr_dcm_master" "maxAddressWidth" 64
         set_interface_property "wr_dcm_master" "addressGroup" 0

         add_interface          "rd_dcm_master" "avalon" "master" "coreclkout"
         set_interface_property "rd_dcm_master" "interleaveBursts" "false"
         set_interface_property "rd_dcm_master" "doStreamReads" "false"
         set_interface_property "rd_dcm_master" "doStreamWrites" "false"
         set_interface_property "rd_dcm_master" "maxAddressWidth" 64
         set_interface_property "rd_dcm_master" "addressGroup" 0


         add_interface_port rd_dcm_master  RdDCMAddress_o address output 64
         add_interface_port rd_dcm_master  RdDCMWrite_o write     output 1
         add_interface_port rd_dcm_master  RdDCMWriteData_o writedata output 32
         add_interface_port rd_dcm_master  RdDCMRead_o read           output 1
         add_interface_port rd_dcm_master  RdDCMByteEnable_o byteenable output 4
         add_interface_port rd_dcm_master  RdDCMWaitRequest_i waitrequest input 1
         add_interface_port rd_dcm_master  RdDCMReadData_i readdata       input 32
         add_interface_port rd_dcm_master  RdDCMReadDataValid_i readdatavalid input 1
         add_interface_port wr_dcm_master  WrDCMAddress_o address output 64
         add_interface_port wr_dcm_master  WrDCMWrite_o write     output 1
         add_interface_port wr_dcm_master  WrDCMWriteData_o writedata output 32
         add_interface_port wr_dcm_master  WrDCMRead_o read           output 1
         add_interface_port wr_dcm_master  WrDCMByteEnable_o byteenable output 4
         add_interface_port wr_dcm_master  WrDCMWaitRequest_i waitrequest input 1
         add_interface_port wr_dcm_master  WrDCMReadData_i readdata       input 32
         add_interface_port wr_dcm_master  WrDCMReadDataValid_i readdatavalid input 1
     } else {
         add_to_no_connect RdDCMAddress_o 64 Output
         add_to_no_connect RdDCMWrite_o 1 Output
         add_to_no_connect RdDCMWriteData_o 32 Output
         add_to_no_connect RdDCMRead_o 1 Output
         add_to_no_connect RdDCMByteEnable_o 4 Output
         add_to_no_connect RdDCMWaitRequest_i 1 Input
         add_to_no_connect RdDCMReadData_i 32 Input
         add_to_no_connect RdDCMReadDataValid_i 1 Input
         add_to_no_connect WrDCMAddress_o 64 output
         add_to_no_connect WrDCMWrite_o 1 output
         add_to_no_connect WrDCMWriteData_o 32 output
         add_to_no_connect WrDCMRead_o 1 output
         add_to_no_connect WrDCMByteEnable_o 4 output
         add_to_no_connect WrDCMWaitRequest_i 1 Input
         add_to_no_connect WrDCMReadData_i 32 Input
         add_to_no_connect WrDCMReadDataValid_i 1 Input
     }
...
proc add_pcie_hip_port_avmm_dts_slave {} {
      set internal_controller_hwtcl [ get_parameter_value internal_controller_hwtcl ]
      if { $internal_controller_hwtcl == 1 } {
         add_interface          "wr_dts_slave" "avalon" "slave" "coreclkout"
         add_interface          "rd_dts_slave" "avalon" "slave" "coreclkout"
         add_interface_port "rd_dts_slave" RdDTSChipSelect_i chipselect input 1
         add_interface_port "rd_dts_slave" RdDTSWrite_i      write input 1
         add_interface_port "rd_dts_slave" RdDTSBurstCount_i burstcount input 5
         add_interface_port "rd_dts_slave" RdDTSAddress_i    address input 8
         add_interface_port "rd_dts_slave" RdDTSWriteData_i  writedata input 256
         add_interface_port "rd_dts_slave" RdDTSWaitRequest_o waitrequest output 1

         add_interface_port "wr_dts_slave" WrDTSChipSelect_i chipselect input 1
         add_interface_port "wr_dts_slave" WrDTSWrite_i      write      input 1
         add_interface_port "wr_dts_slave" WrDTSBurstCount_i burstcount input 5
         add_interface_port "wr_dts_slave" WrDTSAddress_i    address    input 8
         add_interface_port "wr_dts_slave" WrDTSWriteData_i  writedata  input 256
         add_interface_port "wr_dts_slave" WrDTSWaitRequest_o waitrequest output 1
      } else {
         add_to_no_connect RdDTSChipSelect_i 1 Input
         add_to_no_connect RdDTSWrite_i      1 Input
         add_to_no_connect RdDTSBurstCount_i 5 Input
         add_to_no_connect RdDTSAddress_i    8 Input
         add_to_no_connect RdDTSWriteData_i  256 Input
         add_to_no_connect RdDTSWaitRequest_o 1 output

         add_to_no_connect WrDTSChipSelect_i 1 Input
         add_to_no_connect WrDTSWrite_i      1 Input
         add_to_no_connect WrDTSBurstCount_i 5 Input
         add_to_no_connect WrDTSAddress_i    8 Input
         add_to_no_connect WrDTSWriteData_i  256 Input
         add_to_no_connect WrDTSWaitRequest_o 1 output
      }
}
...
if { $internal_controller_hwtcl != 1 } {
 ...
 set_interface_property rd_ast_rx readyLatency 3
 ...
 add_to_no_connect RdDmaRxValid_i 1 Input
 add_to_no_connect RdDmaRxData_i 160 Input
 add_to_no_connect RdDmaRxReady_o 1 Output
 add_to_no_connect RdDmaTxData_o 32 Output
 add_to_no_connect RdDmaTxValid_o 1 Output
}
...
if { $internal_controller_hwtcl != 1 } {
 ...
 set_interface_property wr_ast_rx readyLatency 3
 ...
 add_to_no_connect WrDmaRxValid_i 1 Input
 add_to_no_connect WrDmaRxData_i 160 Input
 add_to_no_connect WrDmaRxReady_o 1 Output
 add_to_no_connect WrDmaTxData_o 32 Output
 add_to_no_connect WrDmaTxValid_o 1 Output
}
}
...
proc add_pcie_hip_port_avmm_cra {} {
 ...
 if { $enable_cra_hwtcl == 1 } {
   ...
   add_interface_port     Cra "CraAddress_i" "address" "input" 14

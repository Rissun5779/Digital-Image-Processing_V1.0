...
proc add_ed_sriov_port_cfgstatus {} {
   ...
   add_interface_port cfg_status  mem_space_en_pf   mem_space_en_pf    Input  $TOTAL_PF_COUNT
   add_interface_port cfg_status  bus_master_en_pf  bus_master_en_pf   Input  $TOTAL_PF_COUNT
   add_interface_port cfg_status  mem_space_en_vf   mem_space_en_vf    Input  $TOTAL_PF_COUNT
   add_interface_port cfg_status  bus_master_en_vf  bus_master_en_vf   Input  $TOTAL_VF_COUNT
   add_interface_port cfg_status  pf0_num_vfs       pf0_num_vfs        Input  8
   add_interface_port cfg_status  pf1_num_vfs       pf1_num_vfs        Input  8

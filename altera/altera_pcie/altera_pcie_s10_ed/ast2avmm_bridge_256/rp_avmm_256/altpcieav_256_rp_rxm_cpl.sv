...
endgenerate
   ...
   generate if(SRIOV_EN) begin
     assign pf_number  = PndgRdFifoDato_i[PFCNT_WD+57-1:57];
     assign vf_number  = PndgRdFifoDato_i[VFCNT_WD+PFCNT_WD+57-1:PFCNT_WD+57];
     assign vf_active  = PndgRdFifoDato_i[VFCNT_WD+PFCNT_WD+57]; 
...
assign bytes_to_RCB = 9'h100 - rd_addr[7:0];

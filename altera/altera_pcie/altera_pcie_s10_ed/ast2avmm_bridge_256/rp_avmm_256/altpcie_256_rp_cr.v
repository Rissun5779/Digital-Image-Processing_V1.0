...
// Detect EOP write from HOST and Write 256 bit into fifo
   ...
   //Mux to select specific slice of register
   //Mux select lines are controlled by counter
   ...
   always @ *
     begin
       case (tx_reg_wr_cnt_reg)
         ...
         3'b110  : tx_reg_slice_sel <= 6'b100000; //Hold Selector To previous value till fifo write completion

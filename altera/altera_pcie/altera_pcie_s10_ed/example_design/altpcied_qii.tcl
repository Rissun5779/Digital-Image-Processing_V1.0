...
if { $ipGenerate > 0 } {
   ...
   puts "qsys-generate --component-file=${project_name}.qsys  --submodule-naming-pattern=%o --output-directory=pcie_lib --file-set=QUARTUS_SYNTH --report-file=qip:${project_name}.qip --report-file=sopcinfo:${project_name}.sopcinfo --report-file=html:${project_name}.html"
   if { [ catch { exec qsys-generate --component-file=${project_name}.qsys  --submodule-naming-pattern=%o --output-directory=pcie_lib --file-set=QUARTUS_SYNTH --report-file=qip:${project_name}.qip --report-file=sopcinfo:${project_name}.sopcinfo --report-file=html:${project_name}.html } msg ] } {

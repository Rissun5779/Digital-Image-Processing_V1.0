...
set_module_property DESCRIPTION "Stratix V Hard IP for PCI Express Intel FPGA IP"
set_module_property VERSION 18.1
set_module_property GROUP "Interface Protocols/PCI Express"
set_module_property AUTHOR "Altera Corporation"
set_module_property DISPLAY_NAME "Stratix V Hard IP for PCI Express Intel FPGA IP"
...
set_parameter_property ACDS_VERSION_HWTCL DERIVED TRUE
...
proc validation_parameter_prj_setting {} {
   ...
   if { [string compare -nocase $INTENDED_DEVICE_FAMILY "Stratix V"] != 0 } {
      send_message error "Selected device family: $INTENDED_DEVICE_FAMILY is not supported"
   }
   send_message info "Stratix V Hard IP for PCI Express Intel FPGA IP v18.1"
}
...
proc elaboration_callback { } {
   ...
   set_parameter_value ACDS_VERSION_HWTCL "18.1"
}
...
proc proc_quartus_synth {name} {
   ...
   if { [regexp NATIVE $design_environment_hwtcl] } {
      add_fileset_file alt_xcvr_reconfig_h.sv            SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../../alt_xcvr_reconfig/alt_xcvr_reconfig/alt_xcvr_reconfig_h.sv
      add_fileset_file altpcie_reconfig_driver.sv        SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../altera_pcie_hip_ast_ed/altpcie_reconfig_driver.sv
   }
   ...
   if { $hip_reconfig_hwtcl == 1} {
      add_fileset_file altera_pcie_sv_hip_ast_hip_reconfig.sdc       SDC     PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/altera_pcie_sv_hip_ast_hip_reconfig.sdc
   }
}
...
proc proc_sim_vhdl {name} {
   ...
   if { [regexp NATIVE $design_environment_hwtcl] } {
      if {1} {
         add_fileset_file mentor/alt_xcvr_reconfig_h.sv            SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../../alt_xcvr_reconfig/alt_xcvr_reconfig/mentor/alt_xcvr_reconfig_h.sv     MENTOR_SPECIFIC
         add_fileset_file mentor/altpcie_reconfig_driver.sv        SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../altera_pcie_hip_ast_ed/mentor/altpcie_reconfig_driver.sv                 MENTOR_SPECIFIC

      }
      add_fileset_file synopsys/alt_xcvr_reconfig_h.sv          SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../../alt_xcvr_reconfig/alt_xcvr_reconfig/alt_xcvr_reconfig_h.sv            SYNOPSYS_SPECIFIC
      add_fileset_file synopsys/altpcie_reconfig_driver.sv      SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../altera_pcie_hip_ast_ed/altpcie_reconfig_driver.sv                        SYNOPSYS_SPECIFIC
      add_fileset_file cadence/alt_xcvr_reconfig_h.sv           SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../../alt_xcvr_reconfig/alt_xcvr_reconfig/alt_xcvr_reconfig_h.sv            CADENCE_SPECIFIC
      add_fileset_file cadence/altpcie_reconfig_driver.sv       SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../altera_pcie_hip_ast_ed/altpcie_reconfig_driver.sv                        CADENCE_SPECIFIC
      add_fileset_file aldec/alt_xcvr_reconfig_h.sv             SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../../alt_xcvr_reconfig/alt_xcvr_reconfig/alt_xcvr_reconfig_h.sv            ALDEC_SPECIFIC
      add_fileset_file aldec/altpcie_reconfig_driver.sv         SYSTEMVERILOG PATH ${QUARTUS_ROOTDIR}/../ip/altera/altera_pcie/altera_pcie_sv_hip_ast/../altera_pcie_hip_ast_ed/altpcie_reconfig_driver.sv                        ALDEC_SPECIFIC
   }
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/lbl1414176323401/nik1410905278518

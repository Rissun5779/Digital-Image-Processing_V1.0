...
# | module PCI Express
# |
set_module_property DESCRIPTION "Example : Application for Avalon-Streaming hard IP for PCI Express"
...
set_module_property DISPLAY_NAME "Example : Application Avalon-Streaming Hard IP for PCI Express"
...
proc proc_sim_vhdl {name} {
   ...
   if { $use_ep_simple_downstream_apps_hwtcl == 1 } {
      ...
      add_fileset_file synopsys/altpcied_sv_hwtcl.sv VERILOG PATH altpcied_sv_hwtcl.sv SYNOPSYS_SPECIFIC
      add_fileset_file cadence/altpcied_sv_hwtcl.sv  VERILOG PATH altpcied_sv_hwtcl.sv CADENCE_SPECIFIC
      add_fileset_file aldec/altpcied_sv_hwtcl.sv    VERILOG PATH altpcied_sv_hwtcl.sv ALDEC_SPECIFIC

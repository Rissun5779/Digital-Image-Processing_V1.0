...
set_module_property DISPLAY_NAME "Example : Config-Bypass App Example"
...
#   set group_name "Design example parameters"
   ...
   add_parameter          link2csr_width_hwtcl integer 13
   ...
   #lmi_width_hwtcl
   add_parameter          lmi_width_hwtcl integer 32
   set_parameter_property lmi_width_hwtcl VISIBLE false
   set_parameter_property lmi_width_hwtcl DERIVED true
   set_parameter_property lmi_width_hwtcl HDL_PARAMETER true
#}
...
proc elaboration_callback { } {
  ...
  #send_message info "Simulation Config-Bypass Example with apps_type_hwtcl = $set_bfm_driver_to_config_bypass"
...
proc add_rdpcie_port_lmi {} {
   ...
   add_interface_port lmi lmi_din  lmi_din   Output lmi_width_hwtcl
   ...
   add_interface_port lmi lmi_dout lmi_dout  Input  lmi_width_hwtcl
}
...
proc add_cfgbp_port_io {} {
   ...
   add_interface_port config_bypass    cfgbp_link2csr               cfgbp_link2csr                Output link2csr_width_hwtcl
...
proc validation_parameter_system_setting {} {
   ...
   if { $dev_family == "Stratix V" || $dev_family == "Arria V GZ" } {
      ...
      set_parameter_value  lmi_width_hwtcl 32
   } else {
      set_parameter_value  link2csr_width_hwtcl 16
      set_parameter_value  lmi_width_hwtcl 8
   }
}

...
proc add_tbed_pcie_parameters_ui {} {
   ...
   # SV or AV/CV DUT
   add_parameter          use_stratixv_tb_device string "false"
   set_parameter_property use_stratixv_tb_device ALLOWED_RANGES {"true" "false"}
   set_parameter_property use_stratixv_tb_device GROUP $group_name
   set_parameter_property use_stratixv_tb_device VISIBLE false
   set_parameter_property use_stratixv_tb_device HDL_PARAMETER false
   ...
   set_parameter_property enable_tl_only_sim_hwtcl AFFECTS_GENERATION true

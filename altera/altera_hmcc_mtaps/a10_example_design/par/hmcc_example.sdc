...
create_clock -name {altera_reserved_tck} -period 20 -waveform {0.0 10.0} [get_ports {altera_reserved_tck}]

# Set clock groups instead of setting false paths
set_clock_groups -logically_exclusive -group {clk_50} -group {altera_reserved_tck}

 ...
 output logic        responses_ok
   ...
   dp_response [0:15] expected_responses = '{ 
               //    valid tag                size    cmd    sop   eop   error data
                  '{ 1'b1, 9'd0 + TAG_OFFSET, 3'b000, 6'h39, 1'b1, 1'b1, 1'b0, 512'h0 }, // Write 16 bytes
                  '{ 1'b1, 9'd1 + TAG_OFFSET, 3'b000, 6'h39, 1'b1, 1'b1, 1'b0, 512'h0 }, // Write 32 bytes
                  '{ 1'b1, 9'd2 + TAG_OFFSET, 3'b000, 6'h39, 1'b1, 1'b1, 1'b0, 512'h0 }, // Write 64 bytes
                  '{ 1'b1, 9'd3 + TAG_OFFSET, 3'b000, 6'h39, 1'b1, 1'b1, 1'b0, 512'h0 }, // Write 128 bytes
                  '{ 1'b1, 9'd4 + TAG_OFFSET, 3'b000, 6'h38, 1'b1, 1'b1, 1'b0, 512'h0123_0123__0123_0123___0123_0123__0123_0123 }, // Read 16 bytes
                  '{ 1'b1, 9'd5 + TAG_OFFSET, 3'b001, 6'h38, 1'b1, 1'b1, 1'b0, 512'h4567_89AB__4567_89AB___4567_89AB__4567_89AB___4567_89AB__4567_89AB___4567_89AB__4567_89AB }, // Read 32 bytes
                  '{ 1'b1, 9'd6 + TAG_OFFSET, 3'b011, 6'h38, 1'b1, 1'b1, 1'b0, 512'h0123_4567__89AB_CDEF___0123_4567__89AB_CDEF___0123_4567__89AB_CDEF___0123_4567__89AB_CDEF___0123_4567__89AB_CDEF___0123_4567__89AB_CDEF___0123_4567__89AB_CDEF___0123_4567__89AB_CDEF }, // Read 64 bytes
                  '{ 1'b1, 9'd7 + TAG_OFFSET, 3'b111, 6'h38, 1'b1, 1'b0, 1'b0, 512'hFEDC_BA98__7654_3210___FEDC_BA98__7654_3210___FEDC_BA98__7654_3210___FEDC_BA98__7654_3210___FEDC_BA98__7654_3210___FEDC_BA98__7654_3210___FEDC_BA98__7654_3210___FEDC_BA98__7654_3210 }, // Read 128 bytes (1 of 2)
                  '{ 1'b1, 9'd7 + TAG_OFFSET, 3'b111, 6'h38, 1'b0, 1'b1, 1'b0, 512'hDEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D }, // Read 128 bytes (2 of 2)
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 6'h00, 1'b0, 1'b0, 1'b0, 512'h0 }, // Not expected.
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 6'h00, 1'b0, 1'b0, 1'b0, 512'h0 }, // Not expected.
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 6'h00, 1'b0, 1'b0, 1'b0, 512'h0 }, // Not expected.
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 6'h00, 1'b0, 1'b0, 1'b0, 512'h0 }, // Not expected.
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 6'h00, 1'b0, 1'b0, 1'b0, 512'h0 }, // Not expected.

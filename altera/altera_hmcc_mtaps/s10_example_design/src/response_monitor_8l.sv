 ...
 output logic        responses_ok
   ...
   dp_response [0:15] expected_responses = '{ 
               //    valid tag                size    sop   eop   type  error data
                  '{ 1'b1, 9'd0 + TAG_OFFSET, 3'b000, 1'b1, 1'b1, 1'b0, 1'b0, 256'h0 }, // Write 16 bytes
                  '{ 1'b1, 9'd1 + TAG_OFFSET, 3'b000, 1'b1, 1'b1, 1'b0, 1'b0, 256'h0 }, // Write 32 bytes
                  '{ 1'b1, 9'd2 + TAG_OFFSET, 3'b000, 1'b1, 1'b1, 1'b0, 1'b0, 256'h0 }, // Write 64 bytes
                  '{ 1'b1, 9'd3 + TAG_OFFSET, 3'b000, 1'b1, 1'b1, 1'b0, 1'b0, 256'h0 }, // Write 128 bytes
                  '{ 1'b1, 9'd4 + TAG_OFFSET, 3'b000, 1'b1, 1'b1, 1'b1, 1'b0, 256'h0123_0123__0123_0123___0123_0123__0123_0123 }, // Read 16 bytes
                  '{ 1'b1, 9'd5 + TAG_OFFSET, 3'b001, 1'b1, 1'b1, 1'b1, 1'b0, 256'h4567_89AB__4567_89AB___4567_89AB__4567_89AB___4567_89AB__4567_89AB___4567_89AB__4567_89AB }, // Read 32 bytes
                  '{ 1'b1, 9'd6 + TAG_OFFSET, 3'b011, 1'b1, 1'b0, 1'b1, 1'b0, 256'h0123_4567__89AB_CDEF___0123_4567__89AB_CDEF___0123_4567__89AB_CDEF___0123_4567__89AB_CDEF }, // Read 64 bytes (1 of 2)
                  '{ 1'b1, 9'd6 + TAG_OFFSET, 3'b011, 1'b0, 1'b1, 1'b1, 1'b0, 256'hFDEC_BA98__7654_3210___FEDC_BA98__7654_3210___FDEC_BA98__7654_3210___FEDC_BA98__7654_3210 }, // Read 64 bytes (2 of 2)
                  '{ 1'b1, 9'd7 + TAG_OFFSET, 3'b111, 1'b1, 1'b0, 1'b1, 1'b0, 256'h0246_8ACE__1357_9BDF___0246_8ACE__1357_9BDF___0246_8ACE__1357_9BDF___0246_8ACE__1357_9BDF }, // Read 128 bytes (1 of 4)
                  '{ 1'b1, 9'd7 + TAG_OFFSET, 3'b111, 1'b0, 1'b0, 1'b1, 1'b0, 256'hFDB0_7531__ECA8_6420___FDB0_7531__ECA8_6420___FDB0_7531__ECA8_6420___FDB0_7531__ECA8_6420 }, // Read 128 bytes (2 of 4)
                  '{ 1'b1, 9'd7 + TAG_OFFSET, 3'b111, 1'b0, 1'b0, 1'b1, 1'b0, 256'hDEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D___DEAD_BEEF__1337_F00D }, // Read 128 bytes (3 of 4)
                  '{ 1'b1, 9'd7 + TAG_OFFSET, 3'b111, 1'b0, 1'b1, 1'b1, 1'b0, 256'h0ECE_2014__0175_ECE1___0ECE_2014__0175_ECE1___0ECE_2014__0175_ECE1___0ECE_2014__0175_ECE1 }, // Read 128 bytes (4 of 4)
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 1'b0, 1'b0, 1'b0, 1'b0, 256'h0 }, // Not expected.
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 1'b0, 1'b0, 1'b0, 1'b0, 256'h0 }, // Not expected.
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 1'b0, 1'b0, 1'b0, 1'b0, 256'h0 }, // Not expected.
                  '{ 1'b0, 9'd0 + TAG_OFFSET, 3'b000, 1'b0, 1'b0, 1'b0, 1'b0, 256'h0 }  // Not expected.
                                         };

...
set_module_property DISPLAY_NAME "PLL Intel FPGA IP"
set_module_property DESCRIPTION "Intel Phase-Locked Loop"
set_module_property DATASHEET_URL "http://www.altera.com/literature/ug/altera_pll.pdf"
set_module_property EDITABLE true
set_module_property SUPPORTED_DEVICE_FAMILIES {"STRATIX V" "ARRIA V" "ARRIA V GZ" "CYCLONE V"}
...
set_parameter_property gui_device_speed_grade DEFAULT_VALUE "1"
...
set_parameter_property number_of_cascade_counters AFFECTS_GENERATION true
...
set_parameter_property number_of_cascade_counters ENABLED false
...
set_parameter_property gui_en_phout_ports DESCRIPTION "Turn on this parameter to enable the PLL DPA output port"
...
add_parameter pll_slf_rst STRING "false"
set_parameter_property pll_slf_rst DEFAULT_VALUE "false"
set_parameter_property pll_slf_rst ALLOWED_RANGES {"false" "true"}
set_parameter_property pll_slf_rst UNITS None
set_parameter_property pll_slf_rst AFFECTS_GENERATION true
set_parameter_property pll_slf_rst IS_HDL_PARAMETER false
set_parameter_property pll_slf_rst VISIBLE false
set_parameter_property pll_slf_rst DERIVED true
set_parameter_property pll_slf_rst ENABLED false
lappend five_series_phys_params_list [list pll_slf_rst "PLL Auto Reset" "FRACTIONAL_PLL_PLL_SLF_RST"]
...
proc my_parameter_upgrade {ip_core_type version parameters} {
	...
	foreach { name value } $parameters {
		...
		} elseif { $name == "gui_auto_validate" || $name == "AUTO_REFCLK_CLOCK_RATE" || $name == "gui_en_lvds_ports"} {
			# no op
...
add_documentation_link "User Guide" https://documentation.altera.com/#/link/mcn1401782837027/mcn1401784468028

...
proc ::altera_gpio::common::add_gpio_parameters { is_driver is_top } {
	...
	# | GUI Parameters
	# | 
	add_parameter PIN_TYPE_GUI STRING "Output"
	set_parameter_property PIN_TYPE_GUI DEFAULT_VALUE "Output"
	set_parameter_property PIN_TYPE_GUI DISPLAY_NAME "Data Direction"
	set_parameter_property PIN_TYPE_GUI ALLOWED_RANGES {"Input" "Output" "Bidir"}
	set_parameter_property PIN_TYPE_GUI AFFECTS_GENERATION true
	set_parameter_property PIN_TYPE_GUI DESCRIPTION "Specifies the data direction for the GPIO"
	set_parameter_property PIN_TYPE_GUI HDL_PARAMETER false
	add_display_item "General" PIN_TYPE_GUI parameter
	...
	set_parameter_property SIZE ALLOWED_RANGES {1:128}
	...
	add_parameter gui_enable_migratable_port_names BOOLEAN false ""
	set_parameter_property gui_enable_migratable_port_names DISPLAY_NAME "Use legacy top-level port names"
	set_parameter_property gui_enable_migratable_port_names DEFAULT_VALUE "false"
	set_parameter_property gui_enable_migratable_port_names AFFECTS_GENERATION true
	set_parameter_property gui_enable_migratable_port_names HDL_PARAMETER false
	set_parameter_property gui_enable_migratable_port_names VISIBLE true
	set_parameter_property gui_enable_migratable_port_names ENABLED true
	set_parameter_property gui_enable_migratable_port_names DESCRIPTION "Use V-series family IP names for GPIO"
	add_display_item "General" gui_enable_migratable_port_names parameter
	...
	set_parameter_property gui_pseudo_diff_off_shadow DERIVED true
	...
	set_parameter_property gui_pseudo_diff_on_shadow DERIVED true
	...
	set_parameter_property gui_bus_hold_shadow DERIVED true
	...
	set_parameter_property gui_open_drain_shadow DERIVED true
	add_display_item "Buffer" gui_open_drain_shadow parameter

	add_parameter gui_use_oe BOOLEAN false ""
	set_parameter_property gui_use_oe DISPLAY_NAME "Enable output enable port"
	set_parameter_property gui_use_oe AFFECTS_GENERATION true
	set_parameter_property gui_use_oe DESCRIPTION "Specifies whether the output buffer will have the output enable port exposed"
	...
	set_parameter_property gui_use_oe_off_shadow DISPLAY_NAME "Enable output enable port"
	set_parameter_property gui_use_oe_off_shadow AFFECTS_GENERATION true
	set_parameter_property gui_use_oe_off_shadow DESCRIPTION "Specifies whether the output buffer will have the output enable port exposed"
	...
	set_parameter_property gui_use_oe_off_shadow DERIVED true
	add_display_item "Buffer" gui_use_oe_off_shadow parameter

	add_parameter gui_use_oe_on_shadow BOOLEAN true ""
	set_parameter_property gui_use_oe_on_shadow DISPLAY_NAME "Enable output enable port"
	set_parameter_property gui_use_oe_on_shadow AFFECTS_GENERATION true
	set_parameter_property gui_use_oe_on_shadow DESCRIPTION "Specifies whether the output buffer will have the output enable port exposed"
	...
	set_parameter_property gui_use_oe_on_shadow DERIVED true
	...
	set_parameter_property gui_io_reg_mode DESCRIPTION "Specifies the register mode for the GPIO"
	...
	set_parameter_property gui_sreset_mode DISPLAY_NAME "Enable synchronous clear / preset port"
	...
	set_parameter_property gui_sreset_mode DESCRIPTION "Specifies how to implement synchronous reset port"
	...
	set_parameter_property gui_sreset_mode_off_shadow DISPLAY_NAME "Enable synchronous clear / preset port"
	...
	set_parameter_property gui_sreset_mode_off_shadow DESCRIPTION "Specifies how to implement synchronous reset port"
	...
	set_parameter_property gui_sreset_mode_off_shadow DERIVED true
	...
	set_parameter_property gui_areset_mode DISPLAY_NAME "Enable asynchronous clear / preset port"
	...
	set_parameter_property gui_areset_mode DESCRIPTION "Specifies how to implement asynchronous reset port"
	...
	set_parameter_property gui_areset_mode_off_shadow DISPLAY_NAME "Enable asynchronous clear / preset port"
	...
	set_parameter_property gui_areset_mode_off_shadow DESCRIPTION "Specifies how to implement asynchronous reset port"
	...
	set_parameter_property gui_areset_mode_off_shadow DERIVED true
	...
	set_parameter_property gui_enable_cke_off_shadow DERIVED true
	...
	add_parameter gui_separate_io_clks_off_shadow BOOLEAN false ""
	set_parameter_property gui_separate_io_clks_off_shadow DISPLAY_NAME "Separate input/output Clocks"
	set_parameter_property gui_separate_io_clks_off_shadow AFFECTS_GENERATION true
	set_parameter_property gui_separate_io_clks_off_shadow DESCRIPTION "Specifies whether the GPIO uses separate clocks for input and output"
	set_parameter_property gui_separate_io_clks_off_shadow HDL_PARAMETER false
	set_parameter_property gui_separate_io_clks_off_shadow VISIBLE false
	set_parameter_property gui_separate_io_clks_off_shadow ENABLED false
	set_parameter_property gui_separate_io_clks_off_shadow DERIVED true
	add_display_item "Registers" gui_separate_io_clks_off_shadow parameter
	...
	set_parameter_property PIN_TYPE VISIBLE false
	set_parameter_property PIN_TYPE DERIVED true
	...
	set_parameter_property ARESET_MODE DEFAULT_VALUE "none"
	...
	set_parameter_property SRESET_MODE DEFAULT_VALUE "none"
	...
	add_parameter ENABLE_OE STRING "false"
	set_parameter_property ENABLE_OE DEFAULT_VALUE "false"
	set_parameter_property ENABLE_OE ALLOWED_RANGES {"false" "true"}
	set_parameter_property ENABLE_OE AFFECTS_GENERATION true
	set_parameter_property ENABLE_OE HDL_PARAMETER $has_hdl_parameters
	set_parameter_property ENABLE_OE VISIBLE false
	set_parameter_property ENABLE_OE DERIVED true	
	
	add_parameter ENABLE_CKE STRING "false"
	set_parameter_property ENABLE_CKE DEFAULT_VALUE "false"
	set_parameter_property ENABLE_CKE ALLOWED_RANGES {"false" "true"}
	set_parameter_property ENABLE_CKE AFFECTS_GENERATION true
	set_parameter_property ENABLE_CKE HDL_PARAMETER $has_hdl_parameters
	set_parameter_property ENABLE_CKE VISIBLE false
	set_parameter_property ENABLE_CKE DERIVED true	

	add_parameter ENABLE_TERM STRING "false"
	set_parameter_property ENABLE_TERM DEFAULT_VALUE "false"
	set_parameter_property ENABLE_TERM ALLOWED_RANGES {"false" "true"}
	set_parameter_property ENABLE_TERM AFFECTS_GENERATION true
	set_parameter_property ENABLE_TERM HDL_PARAMETER $has_hdl_parameters
	set_parameter_property ENABLE_TERM VISIBLE false
	set_parameter_property ENABLE_TERM DERIVED true	
	...
	# | Secret Parameters
	# | 
	add_parameter EXT_DRIVER_PARAM BOOLEAN false ""
	set_parameter_property EXT_DRIVER_PARAM DEFAULT_VALUE "false"
	set_parameter_property EXT_DRIVER_PARAM AFFECTS_GENERATION true
	set_parameter_property EXT_DRIVER_PARAM HDL_PARAMETER false
	set_parameter_property EXT_DRIVER_PARAM VISIBLE false
	set_parameter_property EXT_DRIVER_PARAM DERIVED false

	add_parameter GENERATE_SDC_FILE BOOLEAN false ""
	set_parameter_property GENERATE_SDC_FILE DEFAULT_VALUE "false"
	set_parameter_property GENERATE_SDC_FILE AFFECTS_GENERATION true
	set_parameter_property GENERATE_SDC_FILE HDL_PARAMETER false
	set_parameter_property GENERATE_SDC_FILE VISIBLE false
	set_parameter_property GENERATE_SDC_FILE DERIVED false
	
	add_parameter IP_MIGRATE_PORT_MAP_FILE STRING false "altddio_bidir_port_map.csv"
	set_parameter_property IP_MIGRATE_PORT_MAP_FILE DEFAULT_VALUE "altddio_bidir_port_map.csv"
	set_parameter_property IP_MIGRATE_PORT_MAP_FILE AFFECTS_GENERATION true
	set_parameter_property IP_MIGRATE_PORT_MAP_FILE HDL_PARAMETER false
	set_parameter_property IP_MIGRATE_PORT_MAP_FILE VISIBLE false
	set_parameter_property IP_MIGRATE_PORT_MAP_FILE DERIVED false
...
proc ::altera_gpio::common::validate {} {
    set data_dir [get_parameter_value PIN_TYPE_GUI]
    ...
    if {[safe_string_compare $data_dir "Input"]} {
	    	set_parameter_value PIN_TYPE "input"
		#set_parameter_property gui_separate_io_clks ENABLED false
		set_parameter_property gui_separate_io_clks VISIBLE false
		set_parameter_property gui_separate_io_clks_off_shadow VISIBLE true		
		set_parameter_value SEPARATE_I_O_CLOCKS "false"
    } elseif {[safe_string_compare $data_dir "Output"]} {
	    	set_parameter_value PIN_TYPE "output"
		#set_parameter_property gui_separate_io_clks ENABLED false
		set_parameter_property gui_separate_io_clks VISIBLE false
		set_parameter_property gui_separate_io_clks_off_shadow VISIBLE true			
		set_parameter_value SEPARATE_I_O_CLOCKS "false"
    } elseif {[safe_string_compare $data_dir "Bidir"] && (([safe_string_compare $io_reg_mode "DDIO"]) || ([safe_string_compare $io_reg_mode "Simple register"]))} {
		set_parameter_property gui_separate_io_clks ENABLED true
		set_parameter_property gui_separate_io_clks VISIBLE true
		set_parameter_property gui_separate_io_clks_off_shadow VISIBLE false
	    	set_parameter_value PIN_TYPE "bidir"
    ...
    } elseif {[safe_string_compare $data_dir "Bidir"] && ([safe_string_compare $io_reg_mode "none"])} {
		set_parameter_property gui_separate_io_clks VISIBLE false
		set_parameter_property gui_separate_io_clks_off_shadow VISIBLE true	
		#set_parameter_property gui_separate_io_clks ENABLED false
		set_parameter_value SEPARATE_I_O_CLOCKS "false"
	...
	if {$data_dir == "Output"} {
		...
		set_parameter_property gui_use_oe_off_shadow VISIBLE false
		set_parameter_property gui_use_oe_on_shadow VISIBLE false
		set_parameter_value ENABLE_OE [get_parameter_value gui_use_oe]
		...
		set_parameter_property gui_use_oe_on_shadow VISIBLE false
		set_parameter_value ENABLE_OE "false"
	} else {
		set_parameter_property gui_use_oe VISIBLE false
		set_parameter_property gui_use_oe_off_shadow VISIBLE false
    ...
    if {$io_reg_mode == "DDIO"} {
	    set_parameter_property gui_areset_mode VISIBLE true
	    set_parameter_property gui_areset_mode_off_shadow VISIBLE false
	    set areset_mode [get_parameter_value gui_areset_mode]
	    if {[safe_string_compare $areset_mode "None"]} {
		    set_parameter_value ARESET_MODE "none"
	    } elseif {[safe_string_compare $areset_mode "Preset"]} {
		     set_parameter_value ARESET_MODE "preset"
	    } else {
		    set_parameter_value ARESET_MODE "clear"
	    }
    } else {
    ...
    if {$io_reg_mode == "DDIO"} {
	    set_parameter_property gui_sreset_mode VISIBLE true
	    set_parameter_property gui_sreset_mode_off_shadow VISIBLE false
	    set sreset_mode [get_parameter_value gui_sreset_mode]
	    if {[safe_string_compare $sreset_mode "None"]} {
		    set_parameter_value SRESET_MODE "none"
	    } elseif {[safe_string_compare $sreset_mode "Preset"]} {
		     set_parameter_value SRESET_MODE "preset"
	    } else {
		    set_parameter_value SRESET_MODE "clear"
	    }
	...
	if {[safe_string_compare $io_reg_mode "DDIO"]} { 
		set_parameter_property gui_enable_cke VISIBLE true
		set_parameter_property gui_enable_cke_off_shadow VISIBLE false
		set_parameter_value ENABLE_CKE [get_parameter_value gui_enable_cke]		
	} else {
		set_parameter_property gui_enable_cke VISIBLE false
		set_parameter_property gui_enable_cke_off_shadow VISIBLE true
		set_parameter_value ENABLE_CKE "false"		
	}
	
	set_parameter_value ENABLE_TERM [get_parameter_value gui_enable_termination_ports]	
...
#
#
proc ::altera_gpio::common::_update_qip {} {
...
proc ::altera_gpio::common::set_pad_interface { is_driver } {
	...
	set_interface_assignment pad_io "ui.blockdiagram.direction" bidir
	set_interface_assignment pad_io_b "ui.blockdiagram.direction" bidir
	...
	set_interface_assignment pad_in "ui.blockdiagram.direction" input
	set_interface_assignment pad_in_b "ui.blockdiagram.direction" input
	...
	set_interface_assignment pad_out "ui.blockdiagram.direction" output
	set_interface_assignment pad_out_b "ui.blockdiagram.direction" output
...
proc ::altera_gpio::common::set_data_interface { is_driver } {
    ...
    set data_dir [get_parameter_value PIN_TYPE_GUI]
    # The legacy IP split out the data bus, so do the same if we want migratable port names
    set split_data_bus [get_parameter_value gui_enable_migratable_port_names]
	...
	add_interface dataout_h conduit end
	add_interface dataout_l conduit end
	add_interface din conduit end
	add_interface datain_h conduit end
	add_interface datain_l conduit end
	add_interface oe conduit end
	set_interface_assignment dout "ui.blockdiagram.direction" output
	set_interface_assignment dataout_h "ui.blockdiagram.direction" output
	set_interface_assignment dataout_l "ui.blockdiagram.direction" output
	set_interface_assignment din "ui.blockdiagram.direction" input
	set_interface_assignment datain_h "ui.blockdiagram.direction" input
	set_interface_assignment datain_l "ui.blockdiagram.direction" input
	set_interface_assignment oe "ui.blockdiagram.direction" input
	set_interface_property dout ENABLED false
	set_interface_property dataout_h ENABLED false
	set_interface_property dataout_l ENABLED false
	set_interface_property din ENABLED false
	set_interface_property datain_h ENABLED false
	set_interface_property datain_l ENABLED false
	set_interface_property oe ENABLED false
	
	if {[safe_string_compare $io_reg_mode ddr]} {
		# Always create this port, except in the specific case when we're going to be splitting it up into dataout_l/dataout_h for legacy port naming reasons
		if {!([safe_string_compare $split_data_bus true] && ([safe_string_compare $data_dir Input] || [safe_string_compare $data_dir Bidir]))} {
			if {[safe_string_compare $half_rate true]} {
	...
	if {[safe_string_compare $data_dir Input] || [safe_string_compare $data_dir Bidir]} {
		if {[safe_string_compare $io_reg_mode ddr] && [safe_string_compare $split_data_bus true]} {
			if {[safe_string_compare $half_rate true]} {
				set dataout_width [expr $data_size * 2]
			} else {
				set dataout_width $data_size
			}
			add_interface_port dataout_h dataout_h fragment $gpio_output_driver_input $dataout_width
			add_interface_port dataout_l dataout_l fragment $gpio_output_driver_input $dataout_width
			set_port_property dataout_h FRAGMENT_LIST "dout([expr $dataout_width * 2 - 1]:$dataout_width)"
			set_port_property dataout_l FRAGMENT_LIST "dout([expr $dataout_width - 1]:0)"
			set_port_property dataout_h VHDL_TYPE std_logic_vector
			set_port_property dataout_l VHDL_TYPE std_logic_vector
			set_interface_property dataout_h ENABLED true
			set_interface_property dataout_l ENABLED true
	...
	if {[safe_string_compare $io_reg_mode ddr]} {
		...
		# Always create this port, except in the specific case when we're going to be splitting it up into datain_l/datain_h for legacy port naming reasons
		if {!([safe_string_compare $split_data_bus true] && ([safe_string_compare $data_dir Output] || [safe_string_compare $data_dir Bidir]))} {
			if {[safe_string_compare $half_rate true]} {
	...
	if {[safe_string_compare $data_dir Output] || [safe_string_compare $data_dir Bidir]} {
		if {[safe_string_compare $io_reg_mode ddr] && [safe_string_compare $split_data_bus true]} {
			if {[safe_string_compare $half_rate true]} {
				set datain_width [expr $data_size * 2]
			} else {
				set datain_width $data_size
			}
			add_interface_port datain_h datain_h fragment $gpio_input_driver_output $datain_width
			add_interface_port datain_l datain_l fragment $gpio_input_driver_output $datain_width
			set_port_property datain_h FRAGMENT_LIST "din([expr $datain_width * 2 - 1]:$datain_width)"
			set_port_property datain_l FRAGMENT_LIST "din([expr $datain_width - 1]:0)"
			set_port_property datain_h VHDL_TYPE std_logic_vector
			set_port_property datain_l VHDL_TYPE std_logic_vector
			set_interface_property datain_h ENABLED true
			set_interface_property datain_l ENABLED true
		} else {
...
proc ::altera_gpio::common::set_termination_interface { is_driver } {
	...
	set_interface_assignment seriesterminationcontrol "ui.blockdiagram.direction" input
	...
	set_interface_assignment parallelterminationcontrol "ui.blockdiagram.direction" input
...
proc ::altera_gpio::common::set_reset_cke_interface { is_driver } {
	...
	set enable_cke [get_parameter_value ENABLE_CKE]
	...
	set_interface_assignment aclr "ui.blockdiagram.direction" input
	...
	set_interface_assignment aset "ui.blockdiagram.direction" input
	...
	set_interface_assignment sclr "ui.blockdiagram.direction" input
	...
	set_interface_assignment sset "ui.blockdiagram.direction" input

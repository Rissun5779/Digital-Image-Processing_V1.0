...
set note_nondqs_tan_will_do_resync      "Resync margin will be analyzed correctly by Quartus Prime (PLL 'capture' clock  to PLL 'resync' clock )" 
...
puts        "REPORT\tQuartus Prime assignment       DQS Delay\t$dqs_delay_cyclone\t ps"

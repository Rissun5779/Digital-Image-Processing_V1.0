...
puts  $post_summary_id  "${extrainfo_tag_pretty} This means that the constraints may have not been correctly applied to your design before you compiled in Quartus Prime and the design may not meet timing or the verify-timing script may not run."

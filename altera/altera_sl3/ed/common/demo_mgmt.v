...
//`define  DEMO_MGMT_SNK_MF_CRC_ERRORS_BASE_L1_OFFSET      9'b0011_00001     // Byte offset = 0x184
...
//   reg         [31:0]            sink_loss_of_alignment_init_errors_csr;
   ...
   wire                          source_comb_reset;
   wire                          sink_comb_reset;
   ...
   demo_mgmt_clk_reset_sync 
     (
     .clk(demo_mgmt_clk), 
     .reset_n(~demo_mgmt_clk_reset), 
     .din(1'b0), 
     .dout(sync_demo_mgmt_clk_reset)
   );
   ...
   //
   wire [8:0] demo_mgmt_address_decoded;
   assign demo_mgmt_address_decoded = (demo_mgmt_address > `DEMO_MGMT_SNK_MF_CRC_ERRORS_BASE_OFFSET && demo_mgmt_address <= (`DEMO_MGMT_SNK_MF_CRC_ERRORS_BASE_OFFSET+lanes-1))? `DEMO_MGMT_SNK_MF_CRC_ERRORS_BASE_OFFSET:demo_mgmt_address;

   always @* begin

      demo_ctrl_dec  = 1'b0;

      case (demo_mgmt_address_decoded)
...
//         `DEMO_MGMT_SNK_MF_CRC_ERRORS_BASE_L1_OFFSET:       begin demo_ctrl_dec = 1'b0; source_read_req_n = 1'b1; sink_read_req_n = 1'b0; end
...
//            `DEMO_MGMT_SNK_MF_CRC_ERRORS_BASE_L1_OFFSET:       demo_mgmt_readdata <= sink_csr_capture;
//            `DEMO_MGMT_SNK_UNDERFLOW_ERRORS_OFFSET:            demo_mgmt_readdata <= sink_csr_capture;
   ...
   always @(*) begin
         ...
         case (demo_mgmt_address_decoded)
            ...
            `DEMO_MGMT_SNK_BURST_COUNT_OFFSET:                 sink_csr_mux_data = {5'd0, tc_burst_count};
...
//            `DEMO_MGMT_SNK_LOSS_ALIGN_INIT_ERRORS_OFFSET:      sink_csr_mux_data = sink_loss_of_alignment_init_errors_csr;
            ...
            `DEMO_MGMT_SNK_MF_CRC_ERRORS_BASE_OFFSET:          sink_csr_mux_data = sink_meta_frame_crc_errors_csr[lane_num] ;
//            `DEMO_MGMT_SNK_MF_CRC_ERRORS_BASE_L1_OFFSET:       sink_csr_mux_data = sink_meta_frame_crc_errors_csr[1] ;
//                case(lane_num)

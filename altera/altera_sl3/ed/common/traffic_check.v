...
//   );
   ...
   always @(posedge user_clock or posedge user_clock_reset) begin
      ...
      if (user_clock_reset == 1'b1) begin
         ...
         tc_burst_count             <= ((valid == 1'b1) && (tc_words_received == 64'd0)) ? 27'd1 :
                                       ((valid == 1'b1) && (start_of_burst == 1'b1))  ? tc_burst_count + 27'd1 : tc_burst_count;
   ...
   generate
      ...
      for (lane = 0; lane < LANES; lane = lane + 1) begin : lane_traffic_check_inst
         ...
         // Fixed at lane 0
         assign lane_a_data = data[63:0] & 64'h07FFFFFFFFFFFFFF ;
         ...
         always @(posedge user_clock or posedge user_clock_reset) begin
            ...
            if (user_clock_reset == 1'b1) begin
               ...
               if ((last_valid_lane_data_valid == 1'b1) && (valid == 1'b1) && (data_sample_number != last_valid_lane_data_sample_number + 32'd1) && (tc_enable == 1'b1)) begin
                ...
                else if ((valid == 1'b1) && (start_of_burst == 1'b1) && (data_burst_number != tc_burst_count + 27'd1) && (tc_enable == 1'b1)) begin
...
`ifdef SIMULATION
   ...
   wire     [7:0]             burst_descr_sync_value;
   wire     [7:0]             burst_descr_empty_value;
   ...
   assign burst_descr_sync_value             = burst_descr[47:40];
   assign burst_descr_empty_value            = burst_descr[39:32];
            ...
            case (burst_descr_type)
               ...
               `BURST_DESCR_START_END: begin
                  ...
                  if ((start_of_burst == 1'b1) && (end_of_burst == 1'b1) && (valid == 1'b1)) begin
                     ...
                     $write("                    Empty value %0d\n",          burst_descr_empty_value);
                     ...
                     if (burst_descr_empty_value != empty) begin

                        $write("\n");
                        $write("   Traffic Checker: *** ERROR *** Empty value verification error at time %0t\n", $time);
                        $write("                    Expected empty value %0d got empty value %0d on incoming burst\n", burst_descr_empty_value, empty);
               ...
               `BURST_DESCR_START: begin
                  ...
                  // Wait for the next end of burst and check consistency
                  if ((start_of_burst == 1'b1) && (valid == 1'b1)) begin
               ...
               `BURST_DESCR_END: begin
                  ...
                  // Wait for the next end of burst and check consistency
                  if ((end_of_burst == 1'b1) && (valid == 1'b1)) begin
         ...
         if (burst_descr_ready == 1'b1) begin
            ...
            case (burst_descr_type)
               ...
               `BURST_DESCR_START_END: begin
                  ...
                  // Wait for the next end of burst and check consistency
                  burst_descr_read  = ((start_of_burst == 1'b1) && (end_of_burst == 1'b1) && (valid == 1'b1)) ? 1'b1 : 1'b0;
               ...
               `BURST_DESCR_START: begin
                  ...
                  // Wait for the next end of burst and check consistency
                  burst_descr_read  = ((start_of_burst == 1'b1) && (valid == 1'b1)) ? 1'b1 : 1'b0;
               ...
               `BURST_DESCR_END: begin
                  ...
                  // Wait for the next end of burst and check consistency
                  burst_descr_read  = ((end_of_burst == 1'b1) && (valid == 1'b1)) ? 1'b1 : 1'b0;

...
`ifdef SIMULATION
   ...
   always @* begin
      ...
      if ((start_of_burst == 1'b1) && (end_of_burst == 1'b1) && (valid == 1'b1)) begin
         ...
         next_unbuf_burst_descr     = {`BURST_DESCR_START_END, next_inter_burst_count, sync, empty, tg_words_transferred[31:0]};
         next_unbuf_burst_descr_wr  = 1'b1;

      end else if ((start_of_burst == 1'b1) && (valid == 1'b1)) begin

         next_unbuf_burst_descr     = {`BURST_DESCR_START, 8'd0, sync, empty, tg_words_transferred[31:0]};
         next_unbuf_burst_descr_wr  = 1'b1;

      end else if ((end_of_burst == 1'b1) && (valid == 1'b1)) begin

         next_unbuf_burst_descr     = {`BURST_DESCR_END, next_inter_burst_count, sync, empty, tg_words_transferred[31:0]};
         next_unbuf_burst_descr_wr  = 1'b1;

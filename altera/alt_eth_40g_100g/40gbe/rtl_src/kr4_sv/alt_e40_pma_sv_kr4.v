...
(* ALTERA_ATTRIBUTE = "disable_da_rule=\"d101,d103\"; -name MESSAGE_DISABLE 332056; -name SDC_STATEMENT \"foreach_in_collection pin [get_pins -compatibility_mode {*GEN_KR4_SV.pma|altera_pll_156M*|divclk}] {create_clock -period {156.25 MHz} $pin}\"; -name SDC_STATEMENT \"foreach_in_collection pin [get_pins -compatibility_mode {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*xcvr_native_insts[0]*|*rx_pma_deser|clk33pcs}] {create_clock -period {156.25 MHz} $pin}\"; -name SDC_STATEMENT \"foreach_in_collection pin [get_pins -compatibility_mode {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*xcvr_native_insts[1]*|*rx_pma_deser|clk33pcs}] {create_clock -period {156.25 MHz} $pin}\"; -name SDC_STATEMENT \"foreach_in_collection pin [get_pins -compatibility_mode {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*xcvr_native_insts[2]*|*rx_pma_deser|clk33pcs}] {create_clock -period {156.25 MHz} $pin}\"; -name SDC_STATEMENT \"foreach_in_collection pin [get_pins -compatibility_mode {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*xcvr_native_insts[3]*|*rx_pma_deser|clk33pcs}] {create_clock -period {156.25 MHz} $pin}\"; -name SDC_STATEMENT \"foreach_in_collection pin [get_pins -compatibility_mode {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*rx_pma_deser|clk90b}] {create_clock -period {161.132813 MHz} $pin}\"; -name SDC_STATEMENT \"foreach_in_collection pin [get_pins -compatibility_mode {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*tx_pma_ch.tx_cgb|pclk[1]}] {create_clock -period {161.132813 MHz} $pin}\"; -name SDC_STATEMENT \"set_clock_groups -exclusive -group {*GEN_KR4_SV.pma|altera_pll_156M*|divclk} -group {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*tx_pma_ch.tx_cgb|pclk[1]}\"; -name SDC_STATEMENT \"set_clock_groups -exclusive -group {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*xcvr_native_insts[0]*|*rx_pma_deser|clk33pcs} -group {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*xcvr_native_insts[1]*|*rx_pma_deser|clk33pcs} -group {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*xcvr_native_insts[2]*|*rx_pma_deser|clk33pcs} -group {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*xcvr_native_insts[3]*|*rx_pma_deser|clk33pcs} -group {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*rx_pma_deser|clk90b}\"; -name SDC_STATEMENT \"set_clock_groups -asynchronous -group {*GEN_KR4_SV.pma|altera_pll_156M*|divclk  *GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*rx_pma_deser|clk33pcs *GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*rx_pma_deser|clk90b *GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*tx_pma_ch.tx_cgb|pclk[1]}\"; -name SDC_STATEMENT \"set_false_path -from [get_keepers {*GEN_KR4_SV.pma|*alt_e40_kr4_lane*|*lt_top*}] -to [get_clocks {*GEN_KR4_SV.pma|alt_e40_native_e4x10_inst|*rx_pma_deser|clk90b}]\"" *)
module alt_e40_pma_sv_kr4 #(
    ...
    parameter MGMT_CLK_IN_KHZ    = 100000,     // clk_status rate in Khz
    ...
    reg [15:0] status_addr_r_a;
    assign status_addr_r = status_addr_r_a[7:0];
    ...
    always @(posedge clk_status or posedge pma_arst) begin
        if (pma_arst) begin
            ...
            status_addr_r_a <= 16'b0;
        end
        else if(!waitrequest) begin
            status_read_r <= status_read;
            status_write_r <= status_write && (status_addr[15:8]==PHY_ADDR_PREFIX[9:2]);
            status_writedata_r <= status_writedata;
            status_addr_r_a <= status_addr;
        end
    end

    // block PHY addresses below 0x40 to make room for 40G PCS legacy memory map
    assign common_status_read = status_read_r && (status_addr_r_a[15:6]==PHY_ADDR_PREFIX[9:0]);
    assign common_status_write = status_write_r && (status_addr_r_a[15:6]==PHY_ADDR_PREFIX[9:0]);
    ...
    assign status_readdata_valid = ( (status_addr_r_a >= {PHY_ADDR_PREFIX[9:2],8'h80}) && (status_addr_r_a <= {PHY_ADDR_PREFIX[9:2],8'hEB})
                                     || common_status_read ) 

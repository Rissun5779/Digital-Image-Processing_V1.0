...
module alt_e40_top  #(
	...
	parameter OPTIONAL_RXEQ = 0             //  Enable RX Equalization through link training
		...
		// Phy Only IF
		output wire          rx_mii_valid_phy,          //       rx_mii_valid.export
		output wire [127:0]  rx_mii_d_phy,              //           rx_mii_d.export
		output wire [15:0]   rx_mii_c_phy,              //           rx_mii_c.export
		output wire          lanes_deskewed_phy,        //     lanes_deskewed.export
		input  wire [127:0]  tx_mii_d_phy,              //           tx_mii_d.export
		input  wire [15:0]   tx_mii_c_phy,              //           tx_mii_c.export
		input  wire          tx_mii_valid_phy,          //       tx_mii_valid.export
		output wire          tx_mii_ready_phy,          //       tx_mii_ready.export
		output wire          tx_lanes_stable_phy,       //    tx_lanes_stable.export
		// Phy Only IF END
		// Phy Signals End
		// MAC Only MII
		output wire [127:0] tx_mii_d_mac,              //        tx_mii_d.export
		output wire [15:0]  tx_mii_c_mac,              //        tx_mii_c.export
		output wire         tx_mii_valid_mac,          //    tx_mii_valid.export
		input  wire         tx_mii_ready_mac,          //    tx_mii_ready.export
		input  wire         tx_lanes_stable_mac,       // tx_lanes_stable.export
		input  wire [127:0] rx_mii_d_mac,              //        rx_mii_d.export
		input  wire [15:0]  rx_mii_c_mac,              //        rx_mii_c.export
		input  wire         rx_mii_valid_mac,          //    rx_mii_valid.export
		input  wire         lanes_deskewed_mac,        //  lanes_deskewed.export
		// MAC Only MII End
   ...
   assign l8_tx_ready = 1'b0;
	...
	if (HAS_PHY == 0) assign rx_recovered_clk = 1'b0; // tie off recovered clock output during mac only
	...
	.OPTIONAL_RXEQ (OPTIONAL_RXEQ)
		...
		.pma_clk_rx_clk        (rx_recovered_clk),
		.miitx_rev_d           (mac_miitx_rev_d_export),       //        miitx_rev_d.export
		.miitx_rev_c           (mac_miitx_rev_c_export),       //        miitx_rev_c.export
		.miitx_valid           (mac_miitx_valid_export),       //        miitx_valid.export
		.din_ready             (phy_din_ready_export),         //          din_ready.export

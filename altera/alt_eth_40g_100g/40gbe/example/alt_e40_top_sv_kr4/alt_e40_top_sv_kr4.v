...
parameter TERM_STYLE_JTAG = 1'b0; // vs sys console
...
sv_rcn_bundle #(
    ...
    .ENA_RECONFIG_CONTROLLER_CTLE_RCFG(0), // ADCE not needed
...
if (!SIM_NO_JTAG) begin
    ...
    if (TERM_STYLE_JTAG) begin
       ...
       alt_e40_jtag_avalon jtag_master (
        .clk_1_clk             (clk_status),
        .reset_1_reset            (~sp100_locked),
        .jtag_avalon_reset_reset    (), 
        .jtag_avalon_byteenable        (byteenable),
        .jtag_avalon_address          (av_addr),
        .jtag_avalon_read         (status_read), 
        .jtag_avalon_readdata        (status_readdata), 
        .jtag_avalon_readdatavalid    (status_readdata_valid),
        .jtag_avalon_waitrequest     (status_waitrequest),
        .jtag_avalon_write         (status_write),
        .jtag_avalon_writedata         (status_writedata)    
        );
    end    
end 
else begin : sim

...
proc ::alt_e40_e100::fileset::declare_files { {path "./"} } {
 ...
 # Declare encrypted common KR files
  ...
  #KR4 ocp files
  ::alt_xcvr::utils::fileset::common_fileset_group ./kr4_sv/common_src "$path/40gbe/rtl_src/kr4_sv/common_src" OTHER {
	alt_e40_an_top.ocp
	alt_e40_lt_top.ocp
  } {ALT_E40_KR4_SV_OCP} {QENCRYPT}
  ...
  #KR4 ocp files
  ::alt_xcvr::utils::fileset::common_fileset_group ./kr4_sv "$path/40gbe/rtl_src/kr4_sv" OTHER {
	alt_e40_fec_valid_gen.ocp
	alt_e40_seq_reco_n.ocp
  } {ALT_E40_KR4_SV_OCP} {QENCRYPT}
  ...
  #KR4 ocp files
  ::alt_xcvr::utils::fileset::common_fileset_group ./kr4_sv/sv_fec "$path/40gbe/rtl_src/kr4_sv/sv_fec" OTHER {
	alt_e40_krfec_top_wrapper.ocp
  } {ALT_E40_KR4_SV_OCP} {QENCRYPT}
	  ...
	  if {$CORE_OPTION == "MAC & PHY" || $CORE_OPTION == "PHY only"} {
		 ...
		 if {$VARIANT == 1} {
			...
			if {$ENA_KR4 && [::alt_xcvr::utils::device::has_s5_style_hssi $DEVICE_FAMILY]} {
				...
				common_add_fileset_files {ALT_E40_KR4_SV_OCP} {QENCRYPT}
			}
		 }
	  }  
  }

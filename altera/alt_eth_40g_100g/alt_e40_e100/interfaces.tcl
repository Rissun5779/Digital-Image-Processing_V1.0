...
namespace eval ::alt_e40_e100::interfaces:: {
  ...
  set interfaces {\
	...
	{rx_recovered_clk                  output    output       1                   clk                        "MAC_ONLY_IF || !en_synce_support || !FULL_DUP_IF"                           NOVAL                   NOVAL                 NOVAL       NOVAL               rx_recovered_clk                     conduit                end             false   NOVAL                 }\
...
proc ::alt_e40_e100::interfaces::term_in_port {port_name width direction} {
	...
	if {$width  == 1} {
        ip_set "port.${port_name}.VHDL_TYPE" STD_LOGIC
    } else {
